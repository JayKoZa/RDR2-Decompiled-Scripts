...
int func_57(int iParam0, vector3 vParam1, int iParam4)
{
	...
	while (iVar2 < iVar1)
	{
		...
		iVar4 = MISC::_0xEE04C0AFD4EFAF0E(uVar3);
...
{
	if ((((!TASK::PED_HAS_USE_SCENARIO_TASK(Global_34) && uParam0->f_163) && !PED::_0xA911EE21EDF69DAF(Global_34)) && !func_54(4)) && !WEAPON::_0x0DE0944ECCB3DF5D(Global_34))
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_141))
		{
			...
			case -727924611: /* GXTEntry: "Wardrobe" */
				...
				else
				{
					...
					else
					{
						...
						if (!WEAPON::_0xC853230E76A152DF(func_36(Global_34, 1, 0, 0)))
						{
...
int func_133(int iParam0)
{
	...
	if (WEAPON::GET_CURRENT_PED_WEAPON(Global_34, &iVar0, true, iParam0, false))
	{
		if (func_90(iVar0, 0))
		{
			if (WEAPON::_0x0556E9D2ECF39D01(iVar0) || func_250(iVar0))
			{
				return 1;
			}
		}
					...
					if (uParam0->f_85 != 0)
					{
						if ((uParam0->f_85 == 1186037675 && ENTITY::HAS_ANIM_EVENT_FIRED(Global_34, -1011038463)) || (uParam0->f_85 != 1186037675 && ENTITY::HAS_ANIM_EVENT_FIRED(Global_34, 2024314131)))
						{
							...
							if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_81))
							{
								...
								{
									uParam0->f_81 = WEAPON::_0x9888652B8BA77F73(func_193(uParam0->f_73, 0), 1, Global_35, 1, 1065353216);
...
int func_424(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (func_78(0))
	{
		...
		func_425(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_219(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			else if (WEAPON::_0x959383DCD42040DA(iVar0))
			{
				...
				{
					func_424(iVar0, WEAPON::_0xD3750CCC00635FC2(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
int func_520()
{
	...
	if (iVar1 == joaat("weapon_unarmed"))
	{
		...
		else if ((((WEAPON::IS_WEAPON_VALID(iVar0) && WEAPON::_0x0556E9D2ECF39D01(iVar0)) && !func_250(iVar0)) && !PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_34, true)) && !(PED::IS_PED_IN_ANY_VEHICLE(Global_34, false) && !CAM::_0xA24C1D341C6E0D53(1, 0, 0)))
		{
			return 3;
		}
		...
		else if ((WEAPON::IS_WEAPON_VALID(iVar0) && func_250(iVar0)) || WEAPON::_0x6E4E1A82081EABED(iVar0))
		{
			return 1;
		}
		else
...
void func_655(int iParam0, int iParam1)
{
	...
	{
		iVar2 = func_588(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
float func_718(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			fVar2 = PED::_0xCB42AFE2B613EE55(Global_34);
			iVar0 = 8;
			break;
		case 2:
...
int func_904(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_0xC6258F41D86676E0(iParam0, func_970(iParam1), BUILTIN::CEIL(fParam2));
	return 1;
}
