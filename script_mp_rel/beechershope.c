...
int func_13()
{
	uLocal_23 = ((*Global_1887327)[39 /*36*/])->f_5;
	VOLUME::_0xB469CFD9E065EB99(uLocal_23, 9);
...
void func_107(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_6 = func_166(uParam1, vParam2, uParam5, 0, 0, 0);
