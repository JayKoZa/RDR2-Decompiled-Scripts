...
int func_26(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_57(iParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_58(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_58(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
void func_34(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (!func_66(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	sVar21 = func_75(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, iVar18), iVar1), iVar13);
	if (iParam1 == 1)
	{
	...
	{
		sVar21 = MISC::_CREATE_VAR_STRING(0, func_76(iParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		...
		{
			sVar21 = func_79(func_78(cVar22), joaat("COLOR_PURE_WHITE"));
		}
	}
...
bool func_37(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_57(iParam0, joaat("DEFAULT"));
	if (iVar0 != 0)
	{
...
struct<5> func_38(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CLOTHING"):
			Var0 = { func_89(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_92(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_92(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_93(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("DOG"):
			...
			{
				Var0 = { func_89(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_39(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_58(bParam0));
}
...
bool func_41(var uParam0)
{
	...
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_42))
	{
		...
		if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_42, false) && func_100(uParam0->f_42))
		{
			return true;
		}
	}
...
void func_42(int iParam0)
{
	...
	if (func_23(iParam0) == joaat("CONSUMABLE"))
	{
		...
		while (iVar29 < Var0)
		{
			...
			{
				fVar33 = func_105(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_106(0, fVar33, 1, 1, bVar37);
				bVar39 = true;
			}
			else if (1857353317 == Var22.f_1)
			{
				fVar34 = func_105(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_106(2, fVar34, 1, 1, bVar37);
				bVar38 = true;
			}
			else if (1681823811 == Var22.f_1)
			{
				fVar35 = func_105(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_106(1, fVar35, 1, 1, bVar37);
			}
			else if (2062242710 == Var22.f_1)
			{
				fVar36 = func_107(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
			...
			{
				func_109(BUILTIN::TO_FLOAT(Var22.f_2), 1);
			}
			iVar29++;
		}
		if (bVar39 || func_60(iParam0, -537818634))
		{
			func_110(func_82(joaat("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_60(iParam0, -1457797660))
		{
			func_110(func_82(joaat("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar38)
		{
			func_110(func_82(joaat("DEADEYE_ITEMS_USED")), 1);
		}
		switch (iParam0)
		{
...
void func_44(int iParam0, int iParam1)
{
	...
	if (func_81() == 0)
	{
		...
		if (((func_60(iParam0, joaat("CI_TAG_ITEM_MEAT_ANIMAL")) || func_60(iParam0, -839724752)) || func_60(iParam0, 1264218912)) || iParam0 == joaat("CONSUMABLE_OFFAL"))
		{
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_58(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_68(int iParam0)
{
	...
	{
		if (((func_115(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_ALBINO")) || func_115(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_MELANISTIC"))) || func_115(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_PATTERNED"))) || func_115(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_RED_BLONDE")))
		{
			return true;
		}
	}
...
int func_72(int iParam0)
{
	...
	if (func_119(Var1, &iVar11, &iVar12, 0))
	{
		...
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_0x8750F69A720C2E41(iVar11, iVar13, &iVar14) && func_120(iVar14))
			{
				func_121(iVar11);
				return iVar14;
			}
...
char* func_79(char* sParam0, int iParam1)
{
	...
	return func_75(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_58(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_87(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_58(bParam6), uParam1, iParam3, iParam4))
	{
		return false;
	}
	return true;
...
int func_88(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_39(bParam4))
	{
		...
		while (iVar63 < iVar62)
		{
			Var65 = { func_132(iParam0, &(Var1[iVar63 /*6*/])) };
			Var65.f_12 = iParam2;
	...
	if (!INVENTORY::_0xB4158C8C9A3B5DCE(func_58(bParam4), iParam0, iParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
struct<4> func_89(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_58(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_90(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1293346 = { func_89(joaat("CHARACTER"), func_133(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346.f_12 = { func_89(joaat("CHARACTER"), func_133(), -1591664384, 0) };
			}
...
void func_102(int iParam0)
{
	...
	iVar1 = func_142(2);
	func_143(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_103(int iParam0, bool bParam1)
{
	...
	iVar0 = func_144(2);
	func_145(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
int func_129(int iParam0, var uParam1, bool bParam2)
{
	...
	{
		return func_160(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 16), iVar0, uParam1);
	}
	return -1;
}
...
bool func_131(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	*iParam1 = 0;
	...
	if (iParam3 == 0)
	{
		iParam3 = func_57(iParam2, joaat("DEFAULT"));
		if (iParam3 == 0)
		{
			return false;
		}
...
bool func_134()
{
	return (func_162(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_163(func_89(joaat("WARDROBE"), func_90(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_135(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_57(iParam0, joaat("DEFAULT")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_58(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_58(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_151(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			func_181(joaat("STATUS_EFFECT__TRACKING"));
			func_104(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_181(joaat("STATUS_EFFECT__POISON"));
			func_182(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
...
bool func_161(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	*iParam1 = 0;
	...
	while (iVar0 < 10)
	{
		...
		else if (func_197(uParam0[iVar0 /*6*/]))
		{
		}
		else
		{
...
int func_162(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_58(bParam1), iParam0, iParam3);
}
...
int func_164(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		{
			return func_201(INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iParam0), iParam1);
		}
	}
	return 0;
}
...
bool func_167(int iParam0)
{
	...
	fVar0 = (func_205(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_175(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_215(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_177(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_217(iParam1), fParam2, -1);
	}
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_233(2)));
}
...
int func_221(int iParam0)
{
	...
	if (!func_242(Global_1146212.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_243(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_244(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_245(iVar1, iParam0, iVar4);
						func_246(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_246(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_250(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
void func_226(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_252(&(Global_1293346.f_20.f_1[(Global_1293346.f_20 - 1) /*21*/]));
...
int func_245(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_259(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_260(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_261(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_262(vVar1))
		{
			if (func_263(vVar1.x, vVar1.y, vVar1.z))
			{
				func_264(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_265(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
struct<5> func_254(int iParam0)
{
	...
	Var0 = { func_255(iParam0, joaat("CHARACTER"), func_133(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
...
int func_258(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_243(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_271(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_272(iVar3);
		}
		iVar4++;
	}
...
bool func_263(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_281(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_283(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_272(int iParam0)
{
	...
	iVar0 = func_269(iParam0, 1);
	if (!func_291(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_292(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_293(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_275(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_296(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_296(iParam0));
			break;
...
int func_278(int iParam0)
{
	...
	{
		iVar64 = func_247(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_301(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_302(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_282(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_296(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::ANIMPOSTFX_PLAY(func_296(iParam0));
			break;
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_304(iParam0, 0));
			func_305(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_304(iParam0, 1));
			func_305(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_304(iParam0, 2));
			func_305(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_304(iParam0, 3));
			func_305(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_297(iParam0);
...
void func_294()
{
	...
	{
		if (!func_225(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_301(int iParam0, int iParam1)
{
	...
	if (func_259(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_277(iVar2, 1) /*3*/];
		Var4 = { func_302(iVar3) };
