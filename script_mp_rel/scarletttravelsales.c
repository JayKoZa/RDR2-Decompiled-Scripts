...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1572.349f, -1708.204f, 54f, 0f, 0f, 160f, 14.456f, 10.148f, 8.8f, "SCM TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1570.219f, -1707.457f, 54f, 0f, 0f, 160f, 3.7f, 3.7f, 4.2f, "SCM TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
