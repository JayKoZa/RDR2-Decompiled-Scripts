...
{
	uParam0->f_20 = 19;
	uParam0->f_21 = joaat("CONSUMABLE_HERB_HARRIETUM");
	uParam0->f_22 = 3;
	uParam0->f_25 = 4;
	uParam0->f_23 = 1;
	uParam0->f_24 = 1;
	uParam0->f_40 = -839537088;
}
...
int func_14(int iParam0, vector3 vParam1)
{
	...
	if (func_2() != -1)
	{
		...
		iVar0 = Global_20501;
		func_62(&(Global_20502[iVar0 /*9*/]), iParam0, vParam1, -15);
		Global_20501++;
		return iVar0;
	}
	...
	func_63(&(Global_12580[iVar1 /*9*/]), iParam0, vParam1, -15);
	Global_39.f_4666++;
	return iVar1;
}
...
void func_20(var uParam0)
{
	...
	bVar0 = false;
	if (((SCRIPTS::_GET_GLOBAL_BLOCK_CAN_BE_ACCESSED(4) && func_70()) && func_71(PLAYER::PLAYER_ID(), 1, 0)) && func_72(0) == joaat("HERBALIST"))
	{
		bVar0 = true;
	}
...
void func_21(var uParam0)
{
	...
	if (func_77(&(uParam0->f_27)) >= 1f)
	{
		...
		while (iVar0 < 10)
		{
			if (func_79(Global_17353[iVar0 /*2*/], *uParam0))
			{
...
bool func_31(var uParam0)
{
	...
	if (iLocal_16 < 4)
	{
		if (!func_57(vLocal_24[iLocal_16 /*3*/]))
		{
			if (!Global_1915662)
			{
				iVar1 = 0;
				...
				{
					iVar1 |= 2;
					vLocal_24[iLocal_16 /*3*/] = { vLocal_24[iLocal_16 /*3*/] + func_89(0f, 0.737008f, 1.81999f, uParam0->f_3) };
				}
				...
				{
					iVar1 |= 2;
					vLocal_24[iLocal_16 /*3*/] = { vLocal_24[iLocal_16 /*3*/] + func_89(0f, 0.5f, 1.81999f, uParam0->f_3) };
				}
				if (func_41(uParam0->f_26, iLocal_16))
				{
					iVar1 |= 1;
				}
				uParam0->f_15[iLocal_16] = TASK::_0x5B4BBE80AD5972DC(uParam0->f_40, vLocal_24[iLocal_16 /*3*/], func_90((uParam0->f_3 + (IntToFloat(iLocal_16) * MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, 90f)))), iVar1, &uVar0, iLocal_37[iLocal_16]);
				...
				if (uParam0->f_20 == 39)
				{
					func_92(&(uParam0->f_35[iLocal_16]), vLocal_24[iLocal_16 /*3*/], 0.15f);
				}
				iLocal_16++;
				Global_1915662 = 1;
			}
...
void func_36(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (!func_96(joaat("KIT_COLLECTORS_BAG"), 1))
	{
		return;
	}
	if (func_97(0))
	...
	if (!func_57(Global_1212889) && MISC::GET_DISTANCE_BETWEEN_COORDS(Global_1212889, vParam1, true) <= 5f)
	{
		bVar0 = true;
	}
	...
	fVar1 = func_100(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), vParam1, 1);
	fVar2 = 10f;
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_102(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != joaat("WEAPON_KIT_METAL_DETECTOR"))
						{
...
void func_52(var uParam0)
{
	...
	{
		if (TASK::IS_PED_SPRINTING(Global_34) || (func_75(&(Global_1958000.f_2)) && func_77(&(Global_1958000.f_2)) < 5f))
		{
			bVar0 = true;
		}
	}
...
Vector3 func_60(int iParam0)
{
	...
	if (func_2() != -1)
	{
		return func_123(Global_20502[iParam0 /*9*/].f_1);
	}
	return func_123(Global_12580[iParam0 /*9*/].f_1);
}
...
bool func_71(int iParam0, int iParam1, bool bParam2)
{
	...
	if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && iParam1 != -1)
	{
		...
		while (iVar1 <= 7)
		{
			if (Global_1196339.f_1[iVar1 /*26*/].f_1 == iParam1 && func_127(iVar1, 64, iVar0))
			{
				if (bParam2)
				{
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	...
	if (func_2() != -1)
	{
		func_142(&(Global_20502[iParam0 /*9*/]), iParam1, iParam2, iParam3, uParam4);
		return;
	}
	func_143(&(Global_12580[iParam0 /*9*/]), iParam1, iParam2, iParam3, uParam4);
}
...
void func_111(int iParam0, int iParam1)
{
	...
	Var0 = { func_162(joaat("EATEN"), func_108(iParam0)) };
	STATS::_STAT_ID_INCREMENT_INT(&Var0, iParam1);
	func_164(func_163(joaat("HERBS_EATEN")), iParam1);
}

void func_112(int iParam0, int iParam1)
{
	func_164(func_162(joaat("PICK"), func_108(iParam0)), iParam1);
	func_164(func_163(joaat("HERBS_PICKED_TOTAL")), iParam1);
	if (func_165(iParam0))
	{
		func_164(func_163(joaat("HERBS_PICKED_MUSHROOMS")), iParam1);
	}
}
...
void func_115(int iParam0)
{
	...
	if (func_146(iParam0) == joaat("CONSUMABLE"))
	{
		...
		while (iVar29 < Var0)
		{
			...
			{
				fVar33 = func_172(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_173(0, fVar33, 1, 1, bVar37);
				bVar39 = true;
			}
			else if (1857353317 == Var22.f_1)
			{
				fVar34 = func_172(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_173(2, fVar34, 1, 1, bVar37);
				bVar38 = true;
			}
			else if (1681823811 == Var22.f_1)
			{
				fVar35 = func_172(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_173(1, fVar35, 1, 1, bVar37);
			}
			else if (2062242710 == Var22.f_1)
			{
				fVar36 = func_174(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
			...
			{
				func_176(BUILTIN::TO_FLOAT(Var22.f_2), 1);
			}
			iVar29++;
		}
		if (bVar39 || func_167(iParam0, -537818634))
		{
			func_164(func_177(joaat("MEDICINE_ITEMS_USED")), 1);
		}
		if (func_167(iParam0, -1457797660))
		{
			func_164(func_177(joaat("PROVISION_ITEMS_USED")), 1);
		}
		if (bVar38)
		{
			func_164(func_177(joaat("DEADEYE_ITEMS_USED")), 1);
		}
		switch (iParam0)
		{
...
void func_116(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	...
	else if (!func_183(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	else if (func_146(iParam0) == joaat("CLOTHING"))
	{
	...
	sVar21 = func_192(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, iVar18), iVar1), iVar13);
	if (iParam1 == 1)
	{
	...
	{
		sVar21 = MISC::_CREATE_VAR_STRING(0, func_193(iParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		...
		{
			sVar21 = func_196(func_195(cVar22), joaat("COLOR_PURE_WHITE"));
		}
	}
	func_197(sVar21, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar16, iVar13, sVar15, sVar14, 0, 1);
}
...
{
	return func_198(Global_1196567[iParam2 /*10*/][iParam0], iParam1);
}
...
void func_169(int iParam0)
{
	...
	iVar1 = func_230(2);
	func_231(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_170(int iParam0, bool bParam1)
{
	...
	iVar0 = func_232(2);
	func_233(BUILTIN::TO_FLOAT((iParam0 * iVar0)), 0, bParam1);
}
...
void func_171(int iParam0)
{
	...
	iVar1 = func_234(2);
	func_235(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
bool func_185(int iParam0)
{
	...
	{
		if (((func_242(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_ALBINO")) || func_242(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_MELANISTIC"))) || func_242(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_PATTERNED"))) || func_242(iParam0, joaat("CI_TAG_FOLDER_ANIMAL_SAMPLES_LEGENDARY_RED_BLONDE")))
		{
			return true;
		}
	}
...
int func_189(int iParam0)
{
	...
	if (func_246(Var1, &iVar11, &iVar12, 0))
	{
		...
		while (iVar13 < iVar12)
		{
			if (ITEMDATABASE::_0x8750F69A720C2E41(iVar11, iVar13, &iVar14) && func_247(iVar14))
			{
				func_248(iVar11);
				return iVar14;
			}
...
char* func_196(char* sParam0, int iParam1)
{
	...
	return func_192(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_219(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_239(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			func_278(joaat("STATUS_EFFECT__TRACKING"));
			func_171(-1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_278(joaat("STATUS_EFFECT__POISON"));
			func_279(0, 1, 1);
			ATTRIBUTE::ENABLE_ATTRIBUTE_OVERPOWER(iVar1, iParam0, fParam1, bParam3);
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_219(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<5> func_260(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CLOTHING"):
			Var0 = { func_261(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_286(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_286(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_287(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("DOG"):
			...
			{
				Var0 = { func_261(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_266(int iParam0)
{
	...
	fVar0 = (func_293(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_272(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_294(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_274(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_296(iParam1), fParam2, -1);
	}
}
...
struct<4> func_284(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1293346 = { func_261(joaat("CHARACTER"), func_303(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346.f_12 = { func_261(joaat("CHARACTER"), func_303(), -1591664384, 0) };
			}
			return Global_1293346.f_12;
		}
	}
	return func_261(joaat("CHARACTER"), func_303(), -1591664384, bParam0);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_310(2)));
}
...
int func_300(int iParam0)
{
	...
	if (!func_312(Global_1146212.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_313(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_314(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_315(iVar1, iParam0, iVar4);
						func_316(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_316(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_320(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
bool func_304()
{
	return (func_322(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_323(func_261(joaat("WARDROBE"), func_284(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_315(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_327(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_328(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_329(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_330(vVar1))
		{
			if (func_331(vVar1.x, vVar1.y, vVar1.z))
			{
				func_332(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_333(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_326(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_313(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_340(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_341(iVar3);
		}
		iVar4++;
	}
...
bool func_331(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_350(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_352(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_341(int iParam0)
{
	...
	iVar0 = func_338(iParam0, 1);
	if (!func_361(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_362(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_363(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_344(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_366(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_366(iParam0));
			break;
...
int func_347(int iParam0)
{
	...
	{
		iVar64 = func_317(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_371(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_372(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_351(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::ANIMPOSTFX_PLAY(func_366(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::ANIMPOSTFX_PLAY(func_366(iParam0));
			break;
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_374(iParam0, 0));
			func_375(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_374(iParam0, 1));
			func_375(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_374(iParam0, 2));
			func_375(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_374(iParam0, 3));
			func_375(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_367(iParam0);
...
void func_364()
{
	...
	{
		if (!func_198(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_371(int iParam0, int iParam1)
{
	...
	if (func_327(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_346(iVar2, 1) /*3*/];
		Var4 = { func_372(iVar3) };
