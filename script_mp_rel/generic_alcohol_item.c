		...
		switch (Var0)
		{
			...
			case 2:
				if (!Var0.f_180)
				{
					...
					{
						TASK::_0xB35370D5353995CB(Global_34, func_17(Var0.f_2, iVar184), 0.25f);
						func_12(&Var0, 4);
					}
...
void func_6(var uParam0)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "GENERIC_ALCOHOL_BLOCK_AWAY_PROMPT", true, 1);
	}
	switch (uParam0->f_1)
	{
		case 0:
			...
			break;
		case 1:
			PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "GENERIC_ALCOHOL_BLOCK_CHUG_A", true, 1);
			PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "GENERIC_ALCOHOL_ALLOW_CHUG_B", true, 1);
		...
		case 2:
			PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "GENERIC_ALCOHOL_BLOCK_CHUG_A", true, 1);
			PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "GENERIC_ALCOHOL_ALLOW_CHUG_C", true, 1);
...
void func_16(int iParam0, bool bParam1)
{
	...
	switch (iParam0)
	{
		...
		case joaat("CONSUMABLE_HERB_PRAIRIE_POPPY"):
			if ((bParam1 || !func_46()) || !PED::IS_PED_ON_FOOT(Global_34))
			{
				return;
			}
...
void func_44(struct<16> Param0, int iParam16)
{
	...
	{
		if (SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&(Param0.f_10))) > 0 || func_86(&(Param0.f_10)))
		{
			return;
		}
	}
...
void func_69(int iParam0, int iParam1)
{
	...
	Var0 = { func_42(joaat("EATEN"), func_122(iParam0)) };
...
bool func_80(int iParam0)
{
	...
	return Global_1146212.f_35859.f_919[func_88(iParam0, 1) /*12*/] == -1;
}
...
int func_81(int iParam0)
{
	...
	iVar0 = func_88(iParam0, 1);
	if (!func_77(Global_1146212.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_141(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_142(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_143(iVar1, iParam0, iVar4);
						func_144(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_144(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_148(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
bool func_95(int iParam0)
{
	...
	fVar0 = (func_162(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
int func_143(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_201(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_202(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_203(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_204(vVar1))
		{
			if (func_205(vVar1.x, vVar1.y, vVar1.z))
			{
				func_206(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_207(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_150(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_201(Global_1146212.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_209(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_210(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_205(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_206(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_215(2)));
}
...
bool func_200(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_141(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_231(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_232(iVar3);
		}
		iVar4++;
	}
...
bool func_205(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_240(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_242(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_232(int iParam0)
{
	...
	iVar0 = func_229(iParam0, 1);
	if (!func_249(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_250(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_251(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_235(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_254(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_254(iParam0));
			break;
...
int func_238(int iParam0)
{
	...
	{
		iVar64 = func_145(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_258(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_259(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_252()
{
	...
	{
		if (!func_211(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_258(int iParam0, int iParam1)
{
	...
	if (func_201(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_237(iVar2, 1) /*3*/];
		Var4 = { func_259(iVar3) };
