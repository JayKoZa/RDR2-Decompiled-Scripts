		...
		switch (Var0)
		{
			...
			case 2:
				if (!Var0.f_180)
				{
					...
					{
						if (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_34) != -1177373461)
						{
...
void func_13(int iParam0)
{
	...
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_34, 1) && (TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_34) == -545460140 || TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_34) == -1177373461))
		{
	...
	{
		if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_34, 1) && TASK::_GET_SCENARIO_POINT_TYPE_PED_IS_USING(Global_34) == -1177373461)
		{
...
{
	switch (func_41(uParam0, -949239683))
	{
		case -476940445:
