...
void __EntryFunction__()
{
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(Local_16.f_1))
	{
		func_3(&Local_16);
	}
...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	uParam0->f_3 = 0;
	uParam0->f_7 = Param1;
	uParam0->f_10[0] = joaat("MP_HRLM_BRUSH_GOATHAIR");
	uParam0->f_10[1] = joaat("MP_HRLM_BRUSH_HORSEHAIR");
	uParam0->f_10[2] = joaat("MP_HRLM_BRUSH_ROSEWOOD");
	uParam0->f_10[3] = joaat("MP_HRLM_BRUSH_ROSEWOOD_NG");
	uParam0->f_10[4] = joaat("MP_HRLM_COMB_BOXWOOD");
	uParam0->f_10[5] = joaat("MP_HRLM_COMB_CHERRYWOOD");
	uParam0->f_10[6] = joaat("MP_HRLM_COMB_IVORY");
	uParam0->f_10[7] = joaat("MP_HRLM_COMB_TORTOISESHELL");
	uParam0->f_10[8] = joaat("MP_HRLM_HAIRPIN_EBONY");
	uParam0->f_10[9] = joaat("MP_HRLM_HAIRPIN_IVORY");
	uParam0->f_10[10] = joaat("MP_HRLM_HAIRPIN_JADE");
	uParam0->f_10[11] = joaat("MP_HRLM_HAIRPIN_METAL");
	uParam0->f_10[12] = joaat("MP_HRLM_HAIRPIN_WOODEN");
	uParam0->f_10[13] = joaat("MP_HRLM_BRUSH_BOAR");
	uParam0->f_10[14] = joaat("MP_HRLM_BRUSH_EBONY");
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_BOARBRISTLE");
				break;
			case 1:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_EBNY");
				break;
			case 2:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_GOAT");
				break;
			case 3:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_HORSE");
				break;
			case 4:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_NG_RSEWD");
				break;
			case 5:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_BR_RSEWD");
				break;
			case 6:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_CMB_BOXWOOD");
				break;
			case 7:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_CMB_CHRYWD");
				break;
			case 8:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_CMB_IVRY");
				break;
			case 9:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_CMB_TORTSHELL");
				break;
			case 10:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_CRVDWD");
				break;
			case 11:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_CRVDWD001");
				break;
			case 12:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_EBNY");
				break;
			case 13:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_IVRY");
				break;
			case 14:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_IVRY_EXAMPLE");
				break;
			case 15:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_JDE");
				break;
			case 16:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_MTL");
				break;
			case 17:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_MTL001");
				break;
			default:
				uParam0->f_80[iVar2] = joaat("MP005_S_HL_HP_MTL");
				break;
			...
			if (func_16(&(uParam0->f_68), &(uParam0->f_80), 1, uParam0->f_4, 1f) > 0)
			{
				...
				while (iVar2 < 10)
				{
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_68[iVar2]))
					{
						...
						MAP::_0x7563CBCA99253D1A(uParam0->f_68[iVar2], joaat("BLIP_MP_ROLE_COLLECTOR_ILO"));
...
void func_14(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	fVar1 = func_30(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), vParam1, 1);
	fVar2 = 10f;
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_32(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != joaat("WEAPON_KIT_METAL_DETECTOR"))
						{
...
{
	if (func_42(iParam0, iParam1) && (!bParam2 || Global_1071686.f_22538.f_385[iParam0 /*11*/].f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
...
bool func_39(int iParam0)
{
	...
	if (!DATAFILE::_0x603AC35FD4602C76(func_54()))
	{
		return false;
	}
	Var0 = func_54();
...
int func_48(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_65(iParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_66(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_66(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_66(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_66(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<5> func_77(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CLOTHING"):
			Var0 = { func_78(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_83(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_83(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_84(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("DOG"):
			...
			{
				Var0 = { func_78(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
struct<4> func_78(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_66(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_81(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1293346 = { func_78(joaat("CHARACTER"), func_89(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346.f_12 = { func_78(joaat("CHARACTER"), func_89(), -1591664384, 0) };
			}
			return Global_1293346.f_12;
		}
	}
	return func_78(joaat("CHARACTER"), func_89(), -1591664384, bParam0);
}
...
bool func_90()
{
	return (func_95(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_96(func_78(joaat("WARDROBE"), func_81(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_91(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_65(iParam0, joaat("DEFAULT")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_66(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_66(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_95(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_66(bParam1), iParam0, iParam3);
}
