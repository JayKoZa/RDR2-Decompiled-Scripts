...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	uParam0->f_3 = 0;
	uParam0->f_7 = Param1;
	uParam0->f_10[0] = -735391720;
	uParam0->f_10[1] = 1613328743;
	uParam0->f_10[2] = -1202418356;
	uParam0->f_10[3] = -907007035;
	uParam0->f_10[4] = -456902200;
	uParam0->f_10[5] = 149149942;
	uParam0->f_10[6] = 273203036;
	uParam0->f_10[7] = -330645385;
	uParam0->f_10[8] = -86234166;
	uParam0->f_10[9] = -1083595936;
	uParam0->f_10[10] = -487173195;
	uParam0->f_10[11] = 1357591727;
	uParam0->f_10[12] = 1849250464;
	uParam0->f_10[13] = 877778044;
	uParam0->f_10[14] = 1479448174;
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_80[iVar2] = 1161535814;
				break;
			case 1:
				uParam0->f_80[iVar2] = -2014985768;
				break;
			case 2:
				uParam0->f_80[iVar2] = 1281042957;
				break;
			case 3:
				uParam0->f_80[iVar2] = -2006507012;
				break;
			case 4:
				uParam0->f_80[iVar2] = 113392784;
				break;
			case 5:
				uParam0->f_80[iVar2] = 525317058;
				break;
			case 6:
				uParam0->f_80[iVar2] = -1489501682;
				break;
			case 7:
				uParam0->f_80[iVar2] = -1872221348;
				break;
			case 8:
				uParam0->f_80[iVar2] = 272433059;
				break;
			case 9:
				uParam0->f_80[iVar2] = 2009257216;
				break;
			case 10:
				uParam0->f_80[iVar2] = 716515216;
				break;
			case 11:
				uParam0->f_80[iVar2] = -771064261;
				break;
			case 12:
				uParam0->f_80[iVar2] = 968018790;
				break;
			case 13:
				uParam0->f_80[iVar2] = 2026187299;
				break;
			case 14:
				uParam0->f_80[iVar2] = 1249866483;
				break;
			case 15:
				uParam0->f_80[iVar2] = 585692720;
				break;
			case 16:
				uParam0->f_80[iVar2] = -287794981;
				break;
			case 17:
				uParam0->f_80[iVar2] = 1637580527;
				break;
			default:
				uParam0->f_80[iVar2] = -287794981;
				break;
...
{
	if (func_40(iParam0, iParam1) && (!bParam2 || &(Global_1070356->f_20795.f_353[iParam0 /*11*/])->f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
...
int func_35(var uParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_45(int iParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_60(&(Global_17172.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_46(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_63(iParam0, joaat("default")) != 0)
	{
...
int func_54(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_64(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_72(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1272170->f_4 = { func_76(923904168, func_79(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1272170->f_16 = { func_76(923904168, func_79(bParam0), -740156546, 0) };
		}
...
int func_74(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_64(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_75(int iParam0, bool bParam1, int iParam2)
{
	...
	switch (iVar5)
	{
		...
		case joaat("weapon"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_81(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_81(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_82(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
struct<4> func_79(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1272170 = { func_76(joaat("character"), func_87(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272170->f_12 = { func_76(joaat("character"), func_87(), -1591664384, 0) };
			}
...
bool func_81(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	return func_89(iParam0, *uParam1, iParam2, iParam3, 1, iParam4) > 0;
}
...
struct<4> func_83(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1272170->f_8 = { func_76(271701509, func_79(bParam0), 12999093, 0) };
		}
...
int func_89(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_63(iParam0, joaat("default")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
...
int func_92(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_94(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_96(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_97(uParam0, iParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
