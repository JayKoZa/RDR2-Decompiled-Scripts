...
void __EntryFunction__()
{
	...
	if (!func_2(iVar183, 0))
	{
		iVar183 = joaat("CONSUMABLE_MEAL_BEEF_STEW");
	}
	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE() && !ENTITY::IS_ENTITY_DEAD(Global_34))
	{
		...
		switch (Var0)
		{
			...
			case 2:
				iVar185 = TASK::_GET_ITEM_INTERACTION_FROM_PED(Global_34);
				PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "HIDE_STEW_DROP_PROMPT", true, 1);
				if (iVar185 == joaat("EAT_STEW_BOWL_BASE") || iVar185 == joaat("EAT_STEW_BOWL_CHAIR_BASE"))
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "HIDE_STEW_EAT_PROMPT", true, 1);
					if (iVar185 != joaat("EAT_STEW_BOWL_CHAIR_BASE"))
					{
						TASK::_0xB35370D5353995CB(Global_34, joaat("EAT_STEW_BOWL_EAT_FINISH_DISCARD_AUTO"), 0.25f);
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_34, joaat("EAT_STEW_BOWL_CHAIR_EAT_FINISH_DISCARD_AUTO"), 0.25f);
					}
					func_10(&Var0, 3);
				}
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_62());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_62());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_62());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_63(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
void func_54(int iParam0, int iParam1)
{
	...
	Var0 = { func_55(joaat("EATEN"), func_105(iParam0)) };
...
void func_57(int iParam0, int iParam1)
{
	...
	if (func_56() == 0)
	{
		...
		if (((func_17(iParam0, joaat("CI_TAG_ITEM_MEAT_ANIMAL")) || func_17(iParam0, -839724752)) || func_17(iParam0, 1264218912)) || iParam0 == joaat("CONSUMABLE_OFFAL"))
		{
...
bool func_69(int iParam0)
{
	...
	fVar0 = (func_115(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_77(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_125(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_79(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_127(iParam1), fParam2, -1);
	}
}
...
bool func_101(int iParam0)
{
	...
	return Global_1146212.f_35859.f_919[func_138(iParam0, 1) /*12*/] == -1;
}
...
int func_102(int iParam0)
{
	...
	iVar0 = func_138(iParam0, 1);
	if (!func_98(Global_1146212.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_139(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_140(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_141(iVar1, iParam0, iVar4);
						func_142(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_142(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_146(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
bool func_110(int iParam0, int iParam1)
{
	...
	{
		return func_155(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_159(2)));
}
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_172(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_173(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_174(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_175(vVar1))
		{
			if (func_176(vVar1.x, vVar1.y, vVar1.z))
			{
				func_177(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_178(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_148(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_172(Global_1146212.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_180(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_181(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_176(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_177(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_171(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_139(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_184(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_185(iVar3);
		}
		iVar4++;
	}
...
bool func_176(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_193(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_195(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_185(int iParam0)
{
	...
	iVar0 = func_182(iParam0, 1);
	if (!func_198(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_199(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_200(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_188(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_203(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_203(iParam0));
			break;
...
int func_191(int iParam0)
{
	...
	{
		iVar64 = func_143(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_207(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_208(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_194(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_210(iParam0, 0));
			func_211(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_210(iParam0, 1));
			func_211(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_210(iParam0, 2));
			func_211(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_210(iParam0, 3));
			func_211(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_204(iParam0);
...
void func_201()
{
	...
	{
		if (!func_216(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_207(int iParam0, int iParam1)
{
	...
	if (func_172(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_190(iVar2, 1) /*3*/];
		Var4 = { func_208(iVar3) };
