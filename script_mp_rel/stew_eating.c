	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE() && !ENTITY::IS_ENTITY_DEAD(Global_34))
	{
		...
		switch (Var0)
		{
			...
			case 2:
				...
				{
					PED::_0xCB9401F918CB0F75(Global_34, "HIDE_STEW_EAT_PROMPT", 1, 1);
					if (iVar185 != 1881103362)
					{
						TASK::_0xB35370D5353995CB(Global_34, -616782017, 0.25f);
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_34, -805756414, 0.25f);
					}
					func_10(&Var0, 3);
				}
...
void func_4(var uParam0)
{
	if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_179))
	{
		...
		{
			uParam0->f_179 = OBJECT::CREATE_OBJECT(-1737141731, Global_35, false, true, false, false, true);
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_179, Global_34, PED::GET_PED_BONE_INDEX(Global_34, 7966), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1, 0, 0);
...
void func_11(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_29(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (bParam2 || func_17(iParam0, -537818634))
	{
...
void func_59(int iParam0, int iParam1)
{
	...
	Var0 = { func_60(-372368982, func_114(iParam0)) };
	STATS::_0x6A0184E904CDF25E(&Var0, iParam1);
	func_57(func_115(106002964), iParam1);
}
...
void func_62(int iParam0, int iParam1)
{
	...
	if (func_61() == 0)
	{
		iVar0 = func_116(iParam0, -949239683);
