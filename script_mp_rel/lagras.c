		...
		if (MISC::GET_GAME_TIMER() > iLocal_29)
		{
			...
			switch (iLocal_28)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_31 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_28 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_30)))
					{
						...
						else
						{
							...
							func_36(iLocal_30, &Global_1896674);
							iLocal_28 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_30);
							func_21(iLocal_30, 8);
							...
							func_41(&Global_1896674, iLocal_30);
							func_42(iLocal_30);
							func_21(iLocal_30, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_30 /*36*/].f_11);
							if (Global_1887339[iLocal_30 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_30 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_30 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_30 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	...
	iLocal_19 = Global_1887339[3 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 1);
	iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.926f, -618.1368f, 42.473f, 0f, 0f, 44.5f, 10.521f, 13f, 4f, "Lagras - m_volBaitShop");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2162.323f, -619.085f, 43.189f, 0f, 0f, -44f, 2.27f, 2.954f, 2.579f, "Lagras - m_volBaitPrompt");
	VOLUME::_0xB469CFD9E065EB99(iLocal_20, 10000);
	iLocal_22 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1964.833f, -527.56f, 41.499f, 0f, 0f, 0f, 14.456f, 10.148f, 8.8f, "BAY Harriet - m_volHarriet");
	iLocal_23 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1966.679f, -527.5971f, 41.941f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "BAY Harriet - m_volHarrietPrompt");
	iLocal_24 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1963.142f, -528.919f, 41.852f, 0f, 0f, 0f, 4.045f, 4.156f, 2f, "BAY Harriet - m_volHarrietOffLimits");
	vVar0.x = iLocal_24;
	vVar0.f_2 = -1;
	AICOVERPOINT::_0x733077295AB51304(&vVar0);
	uLocal_25 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), 1964.789f, -528.676f, 41.852f, 0f, 0f, 0f, 1f, 1f, 2f);
	VOLUME::_0xBE551C2CC421185D(uLocal_25, 1);
	VOLUME::_0x5B23DFF8E0948BB2(uLocal_25, 1);
	uLocal_26 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), 1966.414f, -528.38f, 41.852f, 0f, 0f, 0f, 3.2f, 7.3f, 2f);
	VOLUME::_0xBE551C2CC421185D(uLocal_26, 1);
	VOLUME::_0x5B23DFF8E0948BB2(uLocal_26, 0);
	return true;
}
...
{
	func_58(14, iLocal_20, iParam0, iLocal_21, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_59(14, 0);
	func_58(39, iLocal_22, iParam0, iLocal_23, iLocal_24, 2097164, 1, 0, -1082130432 /* Float: -1f */, 0);
	func_60(39, 65536);
	func_60(39, 32768);
	AUDIO::SET_AMBIENT_ZONE_STATE("AZ_Naturalist_Camp", true, true);
	AUDIO::_0x3743CE6948194349("AZ_Naturalist_Camp", VOLUME::_GET_VOLUME_COORDS(iLocal_22), 0f);
	func_61(39, 4096);
}

void func_30(int iParam0)
{
	func_62(638, iLocal_20, 1);
}
...
{
	iParam0 = iParam0;
	func_64(uParam1, iLocal_19, 1);
	func_64(uParam1, iLocal_20, 2);
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_67(Global_1940258, 32768)) || func_67(Global_1940258, 16777216))
	{
		return;
	}
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_89(iParam0) || func_90(iParam0)) || func_93(Global_1896620))
			{
				func_94(Global_1896620, 0);
			}
			Global_1896620++;
			iVar2++;
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_18 = func_100(iParam2, iParam0);
	...
	Global_1051439.f_72[iParam0 /*75*/].f_63 = func_101(Global_1051439.f_72[iParam0 /*75*/].f_18);
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_105(iParam0, 16384) || func_105(iParam0, 32768)) || func_106(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
	...
	iVar0 = func_100(func_107(), iParam0);
	if ((!bParam1 && func_108(iVar0, &uVar1, &uVar2, &vVar3)) || (bParam1 && func_109(iVar0, &uVar1, &uVar2, &vVar3)))
	{
		func_110(iParam0, uVar1, vVar3, uVar2, 0);
...
{
	func_111(&(Global_1051439.f_72[iParam0 /*75*/].f_49), iParam1);
}
...
void func_61(int iParam0, int iParam1)
{
	...
	func_111(&(Global_1915715.f_3[iParam0 /*447*/].f_7), iParam1);
}
...
bool func_69()
{
	return func_67(Global_1940258, 8192);
}
...
bool func_71(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_117(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_119(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else if ((func_125(iParam1, 2) || func_126(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_65(iParam0) && func_88(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	{
		iVar4 = func_128(func_127());
		iVar5 = func_129(func_127());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_130(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_131(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_131(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_131(&cVar6, joaat("COLOR_PURE_WHITE")), func_131(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893587.f_9 = 0;
	}
	Global_1939161.f_145 = func_132(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_86(int iParam0, bool bParam1)
{
	...
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_139(Global_1896620.f_1, 16))
			{
				func_140(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
int func_94(int iParam0, bool bParam1)
{
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_114(iParam0)))
	{
...
void func_98(bool bParam0, bool bParam1)
{
	...
	if (func_106(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
		return;
	}
	if (!bParam0)
...
void func_99(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_159(iParam0) && !bParam1);
	if (!bVar0 && !func_105(iParam0, 65536))
	{
	...
	else if (func_160(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_163(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_166(iParam0, 2))
	{
...
int func_101(int iParam0)
{
	...
	{
		Global_1051439.f_4472[iParam0] = func_170(iParam0);
	}
...
bool func_108(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_171(iParam0, "sHash", uParam1, "fHeading", uParam2, "vPos", uParam3);
}

bool func_109(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_171(iParam0, "sClosedHash", uParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}

void func_110(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	Global_1051439.f_72[iParam0 /*75*/].f_6 = func_172(uParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_113(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_114(iParam0));
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_174())
	{
		return true;
	}
	if (iParam0 == 66)
...
char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893587.f_162)))
	{
		sVar0 = func_177(Global_1893587.f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_179(func_178(Global_35));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_180(iParam0) || func_181(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_122(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_182(PLAYER::PLAYER_ID()) };
...
char* func_131(char* sParam0, int iParam1)
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
	{
		return MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0);
	}
	return func_183(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_132(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	func_184(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_185(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_138(int iParam0)
{
	...
	if (func_92(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_187(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_188(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_189(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_163(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
bool func_149(struct<2> Param0)
{
	return func_196(Param0, 5, 8);
}
...
{
	if (func_198(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_205(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_208(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_170(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_210(12, func_209(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_171(int iParam0, char* sParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_211();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_209(iParam0);
...
var func_172(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
var func_177(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_183(char* sParam0, int iParam1)
{
...
{
	func_219(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
void func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_187(iParam0)) && func_220(iParam0))
	{
		return;
	}
	func_147(iParam0, 1);
...
bool func_196(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
bool func_197(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_227(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_228())
	{
		return func_227(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_227(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_210(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_231(iParam0, iParam1, &uVar0))
	{
		func_232(&uVar0, iParam0, uParam2);
	}
	else
	{
		return false;
...
bool func_212()
{
	...
	if (!func_214(Global_1051213) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_216(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;

	func_235(iParam3, &vVar0, &Var3, &uVar6);
	if (func_236(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
...
bool func_231(int iParam0, int iParam1, var uParam2)
{
	*uParam2 = Global_1139381.f_7;
	...
	uParam2->f_3 = func_240(iParam0);
	uParam2->f_4 = iParam1;
	return DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(uParam2->f_1), uParam2);
}

void func_232(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_236(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
bool func_241(struct<2> Param0, var uParam2)
{
	if (!func_214(Param0))
	{
		return false;
