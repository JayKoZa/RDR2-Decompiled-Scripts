...
bool func_3()
{
	...
	{
		iVar2 = func_13(Var0);
		if (iVar2 > 13 && !UIAPPS::_IS_APP_RUNNING_BY_HASH(joaat("LOBBIES_MENU")))
		{
			return true;
		}
	}
	...
	if (func_14() && !UIAPPS::_IS_APP_RUNNING_BY_HASH(joaat("LOBBIES_MENU")))
	{
		return true;
	}
	if (func_15() != -1)
...
bool func_9(struct<2> Param0, int iParam2, int iParam3)
{
	...
	if (func_12(Global_1051213) && !func_37(Global_1051213, Param0))
	{
...
void func_18(var uParam0)
{
	...
	while (iVar0 <= 25)
	{
		if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1296859.f_154[uParam0->f_1269]))
		{
		}
		else if (func_45(iVar0, Global_1296859.f_154[uParam0->f_1269]))
		{
			if (!MISC::IS_BIT_SET(Global_1211286.f_18[0 /*2*/].f_1, iVar0))
			{
				MISC::SET_BIT(&(Global_1211286.f_18[0 /*2*/].f_1), iVar0);
			}
		}
		iVar0++;
	}
	...
	while (iVar1 <= 8)
	{
		...
		else if (func_46(iVar1, Global_1296859.f_154[uParam0->f_1269]))
		{
			if (!MISC::IS_BIT_SET(Global_1211286.f_18[1 /*2*/].f_1, iVar1))
			{
				MISC::SET_BIT(&(Global_1211286.f_18[1 /*2*/].f_1), iVar1);
			}
		}
		iVar1++;
	}
	if (uParam0->f_1269 == 0)
	{
		...
		while (iVar0 <= 25)
		{
			...
			while (iVar5 < 32)
			{
				if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(Global_1296859.f_154[iVar5]))
				{
				}
				else if (func_45(iVar0, Global_1296859.f_154[iVar5]))
				{
		...
		iVar7 = (iVar6 && Global_1211286.f_18[0 /*2*/].f_1);
		iVar0 = 9;
		while (iVar0 <= 25)
		{
			if (MISC::IS_BIT_SET(iVar7, iVar0))
			{
				MISC::CLEAR_BIT(&(Global_1211286.f_18[0 /*2*/].f_1), iVar0);
			}
			iVar0++;
		}
		iVar5 = 0;
		...
		while (iVar1 <= 8)
		{
			...
			while (iVar5 < 32)
			{
				...
				else if (func_46(iVar1, Global_1296859.f_154[iVar5]))
				{
		...
		iVar7 = (iVar6 && Global_1211286.f_18[1 /*2*/].f_1);
		iVar1 = 1;
		while (iVar1 <= 8)
		{
			if (MISC::IS_BIT_SET(iVar7, iVar1))
			{
				MISC::CLEAR_BIT(&(Global_1211286.f_18[1 /*2*/].f_1), iVar1);
			}
			iVar1++;
		}
		if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(PLAYER::INT_TO_PLAYERINDEX(Global_1296859.f_16)))
		{
			return;
		}
		iVar0 = 9;
		...
		{
			vVar2 = { func_47(iVar0) };
			if (func_45(iVar0, PLAYER::INT_TO_PLAYERINDEX(Global_1296859.f_16)))
			{
				func_48(vVar2, 1);
			}
			else
		...
		{
			vVar2 = { func_49(iVar1) };
			if (func_46(iVar1, PLAYER::INT_TO_PLAYERINDEX(Global_1296859.f_16)))
			{
				func_48(vVar2, 1);
			}
			else
...
void func_20(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			...
			while (iVar1 < 1)
			{
				if (VOLUME::_DOES_VOLUME_EXIST(uParam0->f_4[iVar0 /*420*/].f_310[iVar1 /*15*/].f_2) && ENTITY::IS_ENTITY_IN_VOLUME(Global_1296859.f_8, uParam0->f_4[iVar0 /*420*/].f_310[iVar1 /*15*/].f_2, true, 0))
				{
					PED::SET_PED_MAX_MOVE_BLEND_RATIO(PED::GET_MOUNT(Global_1296859.f_8), 0.101f);
				}
				iVar1++;
			}
		}
...
bool func_21(var uParam0)
{
	...
	if (Global_1211286.f_25 && (MISC::GET_FRAME_COUNT() % func_55()) == 0)
	{
		return true;
	}
	if (Global_1211286.f_24)
	{
		Global_1211286.f_24 = 0;
		return true;
	}
...
void func_30(var uParam0)
{
	...
	else if (!Global_1211286.f_23)
	{
		Global_1211286.f_23 = 1;
	}
	func_58(uParam0);
	func_59(uParam0);
	func_60(uParam0);
...
bool func_44(int iParam0, int iParam1, int iParam2)
{
	...
	return (func_65(iParam0) && func_66(Global_1238240[iParam2 /*303*/][iParam0 /*23*/].f_19, iParam1));
}
...
bool func_46(int iParam0, int iParam1)
{
	...
	return MISC::IS_BIT_SET(Global_1056141[iParam1 /*471*/].f_41, iParam0);
}
...
void func_48(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < 3)
	{
		if (!func_68(Global_1211286.f_2[iVar0 /*5*/].f_2, vParam0))
		{
		}
		else
		{
...
void func_58(var uParam0)
{
	...
	while (iVar0 <= 25)
	{
		...
		else
		{
			...
			{
				fVar2 = func_75(vVar4, Global_35);
				fVar3 = (Global_1835011[iVar0 /*72*/].f_60 * Global_1835011[iVar0 /*72*/].f_60);
				fVar3 = (fVar3 * 10f);
				if (fVar2 < fVar3)
				{
					if (!MISC::IS_BIT_SET(Global_1211286.f_18[0 /*2*/], iVar0))
					{
						MISC::SET_BIT(&(Global_1211286.f_18[0 /*2*/]), iVar0);
					}
				}
				else if (MISC::IS_BIT_SET(Global_1211286.f_18[0 /*2*/], iVar0))
				{
					MISC::CLEAR_BIT(&(Global_1211286.f_18[0 /*2*/]), iVar0);
				}
			}
		}
		iVar0++;
	...
	while (iVar1 <= 8)
	{
		...
		else
		{
			...
			else
			{
				...
				if (fVar2 < fVar3)
				{
					if (!MISC::IS_BIT_SET(Global_1211286.f_18[1 /*2*/], iVar1))
					{
						MISC::SET_BIT(&(Global_1211286.f_18[1 /*2*/]), iVar1);
					}
				}
				else if (MISC::IS_BIT_SET(Global_1211286.f_18[1 /*2*/], iVar1))
				{
					MISC::CLEAR_BIT(&(Global_1211286.f_18[1 /*2*/]), iVar1);
				}
			}
		}
		iVar1++;
...
void func_59(var uParam0)
{
	...
	while (iVar0 <= 25)
	{
		...
		if (!MISC::IS_BIT_SET(Global_1211286.f_18[0 /*2*/].f_1, vVar2.y))
		{
			if (bVar5)
			{
...
void func_60(var uParam0)
{
	...
	while (iVar0 <= 8)
	{
		...
		if (!MISC::IS_BIT_SET(Global_1211286.f_18[1 /*2*/].f_1, vVar2.z))
		{
			if (bVar5)
			{
				func_79(uParam0, &vVar2, 15);
	...
	while (iVar0 < 3)
	{
		switch (uParam0->f_4[iVar0 /*420*/])
		{
			...
			default:
				...
				break;
			case 14:
				func_84(&(uParam0->f_4[iVar0 /*420*/]), Global_1211286.f_2[iVar0 /*5*/].f_1);
				func_85(&(uParam0->f_4[iVar0 /*420*/]), Global_1211286.f_2[iVar0 /*5*/].f_1);
				break;
			case 0:
				break;
		}
...
bool func_62(var uParam0, vector3 vParam1, bool bParam4)
{
	...
	Global_1211286.f_2[iVar1 /*5*/].f_1 = 1;
	return false;
}

void func_63(int iParam0)
{
	if (Global_1211286.f_25 != iParam0)
	{
		Global_1211286.f_25 = iParam0;
	}
}

bool func_64(struct<2> Param0, var uParam2)
{
	if (!func_12(Param0))
	{
		return false;
...
bool func_80(vector3 vParam0)
{
	...
	{
		case 0:
			return MISC::IS_BIT_SET(Global_1211286.f_18[vParam0.x /*2*/], vParam0.y);
		case 1:
			return MISC::IS_BIT_SET(Global_1211286.f_18[vParam0.x /*2*/], vParam0.z);
		default:
			break;
	}
	return false;
	...
	if (iVar1 < 0)
	{
		...
		while (iVar0 < 3)
		{
			...
			else
			{
				...
				Global_1211286.f_2[iVar0 /*5*/] = { Var2 };
				Global_1211286.f_2[iVar0 /*5*/].f_2 = { vParam1 };
				func_103(vParam1, 0);
				func_63(1);
			}
			else
	...
	switch (func_78(uParam0, &vParam1))
	{
		...
		case 12:
			if (func_114(&(uParam0->f_4[iVar1 /*420*/])))
			{
				...
				{
					case 0:
						bVar7 = func_45(vParam1.y, PLAYER::INT_TO_PLAYERINDEX(Global_1296859.f_16));
						break;
					case 1:
						bVar7 = func_46(vParam1.z, PLAYER::INT_TO_PLAYERINDEX(Global_1296859.f_16));
						break;
				}
...
bool func_88(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		else
		{
			...
			{
				PED::REMOVE_SCENARIO_BLOCKING_AREA(uParam0->f_127[iVar0 /*33*/].f_16, false);
			}
			iVar1++;
		}
		iVar0++;
...
void func_97(var uParam0)
{
	if (*uParam0 != -1)
	{
		if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_7))
		{
			...
			Global_1211286.f_27[uParam0->f_1] = (Global_1211286.f_27[uParam0->f_1] - 1);
		}
		if (Global_1211286.f_27[uParam0->f_1] < 1)
		{
...
void func_103(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			Global_1211286.f_2[iVar0 /*5*/] = iParam3;
		}
		else
		{
			iVar0++;
...
bool func_104(vector3 vParam0)
{
	...
	if (Global_1071686.f_28662.f_8.f_13 != 0)
	{
		return false;
	}
	if (Global_1071686.f_28662.f_58.f_6 != 0)
	{
		return false;
	}
	if (Global_1071686.f_28662.f_65.f_42 != 0)
	{
		return false;
	}
	if (Global_1071686.f_28662.f_22.f_3 != 0)
	{
		return false;
	}
	if (!func_120())
	{
		bVar3 = false;
		fVar4 = 0f;
		iVar5 = PLAYER::_GET_MOUNT_OF_PLAYER(Global_1296859.f_10);
...
bool func_106(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		else
		{
			...
			{
				if (!STREAMING::IS_MODEL_IN_CDIMAGE(uParam0->f_127[iVar0 /*33*/].f_1))
				{
					...
					else
					{
						...
						else
						{
							if (uParam0->f_127[iVar0 /*33*/].f_2 != 0)
							{
								...
								PED::_UPDATE_PED_VARIATION(uParam0->f_127[iVar0 /*33*/], false, true, true, true, false);
							}
							else if (uParam0->f_127[iVar0 /*33*/].f_3 == -1)
							{
								PED::_SET_RANDOM_OUTFIT_VARIATION(uParam0->f_127[iVar0 /*33*/], true);
							}
							else if (uParam0->f_127[iVar0 /*33*/].f_3 > 0 && uParam0->f_127[iVar0 /*33*/].f_3 <= 3)
							{
								if (uParam0->f_127[iVar0 /*33*/].f_3 <= PED::_GET_NUM_METAPED_OUTFIT_PRESETS(uParam0->f_127[iVar0 /*33*/]))
								{
									if (uParam0->f_127[iVar0 /*33*/].f_3 == 1)
									{
										PED::_SET_PED_OUTFIT_PRESET(uParam0->f_127[iVar0 /*33*/], uParam0->f_127[iVar0 /*33*/].f_4[0], false);
									}
									else
									{
										iVar4 = 0;
							...
							if (!PED::_0x91A5F9CBEBB9D936(uParam0->f_127[iVar0 /*33*/].f_16))
							{
								uParam0->f_127[iVar0 /*33*/].f_16 = PED::_0x4C39C95AE5DB1329(VOLUME::_CREATE_VOLUME_SPHERE(uParam0->f_127[iVar0 /*33*/].f_9, 0f, 0f, 0f, 6f, 6f, 6f), 0, 15);
							}
							...
							if (TASK::_GET_SCENARIO_POINT_PED_IS_USING(uParam0->f_127[iVar0 /*33*/], false) == uParam0->f_127[iVar0 /*33*/].f_15)
							{
								return false;
							}
							if (!TASK::PED_HAS_USE_SCENARIO_TASK(uParam0->f_127[iVar0 /*33*/]))
							{
								TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_127[iVar0 /*33*/], uParam0->f_127[iVar0 /*33*/].f_15, 0, 0, false, true, 0, false, -1f, false);
							}
							return false;
						}
					}
...
bool func_107(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		...
		{
			if (!PROPSET::_IS_PROPSET_VALID(uParam0->f_293[iVar0 /*8*/]))
			{
				bVar1 = false;
			}
		}
			...
			else
			{
				...
				else
				{
					...
					else
					{
						...
						if (iVar36 != -1)
						{
							VEHICLE::_SET_VEHICLE_TINT(uParam0->f_326[iVar0 /*8*/], iVar36);
						}
						iVar36 = func_135(uParam0, iVar0);
						if (iVar36 != -1)
						{
							VEHICLE::_SET_VEHICLE_LIVERY(uParam0->f_326[iVar0 /*8*/], iVar36);
						}
					}
				}
			}
...
bool func_110(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		uParam0->f_310[iVar0 /*15*/].f_1 = VOLUME::_CREATE_VOLUME_SPHERE(func_115(uParam0->f_3), 0f, 0f, 0f, 20f, 20f, 20f);
...
bool func_111(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		{
			VOLUME::_CREATE_VOLUME_SPHERE(func_115(uParam0->f_3), 0f, 0f, 0f, 40f, 40f, 40f);
...
bool func_113(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		else
		{
			...
			{
				case 0:
					uParam0->f_310[iVar0 /*15*/].f_2 = VOLUME::_CREATE_VOLUME_SPHERE(uParam0->f_310[iVar0 /*15*/].f_3, uParam0->f_310[iVar0 /*15*/].f_9, uParam0->f_310[iVar0 /*15*/].f_6);
					break;
				case 1:
...
bool func_114(var uParam0)
{
	...
	while (iVar0 < 1)
	{
		...
		if (!MISC::IS_BIT_SET(uParam0->f_388[iVar0 /*20*/], 1))
		{
			...
			else if (MISC::_IS_STRING_SPACE(&(uParam0->f_388[iVar0 /*20*/].f_3)))
			{
				MISC::SET_BIT(&(uParam0->f_388[iVar0 /*20*/]), 3);
			}
			else
			{
				if (MISC::_IS_STRING_SPACE(&(uParam0->f_388[iVar0 /*20*/].f_11)))
				{
				}
				...
				else
				{
					...
					if (!MISC::IS_BIT_SET(uParam0->f_388[iVar0 /*20*/], 2))
					{
						...
						else if (!ANIMSCENE::_IS_ANIM_SCENE_METADATA_LOADED(uParam0->f_388[iVar0 /*20*/].f_1, false))
						{
						}
						else if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_388[iVar0 /*20*/].f_1, false, true))
						{
						}
						else
						{
							...
							while (iVar2 < 5)
							{
								...
								else if (MISC::_IS_STRING_SPACE(&(uParam0->f_127[iVar2 /*33*/].f_19.f_1)))
								{
								}
								else
								{
							...
							while (iVar2 < 10)
							{
								...
								else if (MISC::_IS_STRING_SPACE(&(uParam0->f_6[iVar2 /*12*/].f_8.f_1)))
								{
								}
								else
								{
							...
							if (!MISC::IS_BIT_SET(uParam0->f_388[iVar0 /*20*/], 3))
							{
								if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_388[iVar0 /*20*/].f_1, false))
								{
...
bool func_116(var uParam0, vector3 vParam1)
{
	...
	if (STREAMING::HAS_NAMED_PTFX_ASSET_LOADED(MISC::GET_HASH_KEY(func_118(uParam0->f_1))))
	{
		...
		if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(uParam0->f_7))
		{
			Global_1211286.f_27[uParam0->f_1]++;
			return true;
		}
	}
	else
...
void func_126(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_145(0);
		func_150(&(Global_1102219.f_3849));
		...
		func_151(&(Global_1102219.f_3888));
	...
	func_152(Global_1102219.f_3849, 36);
	func_153(Global_1102219.f_3888, 36);
}
...
int func_140(int iParam0)
{
	...
	return func_162(NETWORK::GET_UNIQUE_INT_FOR_PLAYER(Global_1296859.f_154[iParam0]));
}
	...
	switch (iParam0)
	{
		...
		default:
			...
			*uParam1 = { -870.1846f, -1276.62f, 42.2367f };
			uParam1->f_3 = joaat("BLIP_MP_MISSION_HORLEY");
		...
		case 3:
			*uParam1 = { 1352.95f, -1306.359f, 75.9113f };
			uParam1->f_3 = joaat("BLIP_MP_BOUNTY_HUNTER_INTRODUCTION");
			StringCopy(&(uParam1->f_4), "FM_FLOW_ROLE_BH_INTRO_BLIP_0", 32);
			uParam1->f_8 = 100;
			return 1;
		case 4:
			*uParam1 = { 0f, 0f, 0f };
			uParam1->f_3 = joaat("BLIP_MP_TRADER_INTRODUCTION");
		...
		case 5:
			*uParam1 = { 0f, 0f, 0f };
			uParam1->f_3 = joaat("BLIP_MP_TRAVELLING_SALESWOMAN");
		...
		case 6:
			*uParam1 = { 1447.94f, 375.2851f, 88.89412f };
			uParam1->f_3 = joaat("BLIP_MP_ROLE_MOONSHINER");
			StringCopy(&(uParam1->f_4), "FM_FLOW_ROLE_M_INTRO_BLIP_0", 32);
			uParam1->f_8 = 100;
			return 1;
		case 7:
			*uParam1 = { -1810.2f, -370.5f, 162.9f };
			uParam1->f_3 = joaat("BLIP_MP_ROLE_NATURALIST");
...
bool func_144(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_164(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_139())
	{
		return func_164(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_164(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	if (func_165(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_166(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_149(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	else if (!func_169(128) && !func_170(19))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (bParam3 && func_163() == 4)
	{
		func_146(18);
	}
	func_171(1024);
...
void func_156(int iParam0, var uParam1)
{
	...
	func_172(iParam0, *uParam1);
	func_172(iParam0, uParam1->f_1);
}
...
void func_158(int iParam0, var uParam1)
{
	...
	func_172(iParam0, *uParam1);
	func_172(iParam0, uParam1->f_1);
	func_172(iParam0, uParam1->f_2);
	func_172(iParam0, uParam1->f_3);
	func_172(iParam0, uParam1->f_4);
	func_172(iParam0, uParam1->f_5);
	func_172(iParam0, uParam1->f_6);
	func_172(iParam0, uParam1->f_7);
}
...
void func_172(int iParam0, int iParam1)
{
	...
	iVar0 = iParam1;
	PED::_SET_PED_COMPONENT_ENABLED(iParam0, iVar0, false, func_174() == 0, false);
}
