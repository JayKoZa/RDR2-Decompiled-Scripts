...
void func_7()
{
	...
	uVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(-703427271);
...
bool func_15(int iParam0)
{
	...
	if (func_21(iVar1))
	{
		if (Global_1070356->f_17915.f_24 && !func_22(iParam0))
		{
			return false;
		}
...
void func_19(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_23(iParam0, 0, 0);
	if (func_24(iParam0))
	{
		...
		if (bParam3)
		{
			func_25(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_25(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_24(iParam0))
	{
