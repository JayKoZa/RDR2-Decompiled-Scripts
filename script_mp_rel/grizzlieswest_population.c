...
void func_2()
{
	iLocal_15 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-600f, 2695f, 330f, 0f, 0f, 0f, 250f, 200f, 200f, "m_volAdlerRanch_Restriction");
	func_9(iLocal_15);
	iLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volColter_Restriction");
	VOLUME::_0xBCE668AAF83608BE(iLocal_16, -1320f, 2425f, 305f, 0f, 0f, 0f, 115f, 115f, 15f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_16, -1410f, 2435f, 327.5f, 0f, 0f, 0f, 25f, 25f, 25f);
	func_9(iLocal_16);
	iLocal_17 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-411.5007f, 1732.159f, 220.7082f, 0f, 0f, 17.18846f, 71.74252f, 70.79237f, 31.05772f, "m_volChezPorter_Restriction");
	func_10(iLocal_17, 0, 0);
	iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volWinterMiningTown_Restriction");
	VOLUME::_0xBCE668AAF83608BE(iLocal_18, -1947.5f, 1332.25f, 216f, 0f, 0f, 0f, 8f, 8f, 30f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_18, -1898.5f, 1346.5f, 216f, 0f, 0f, 0f, 48f, 48f, 30f);
	func_10(iLocal_18, 0, 0);
	iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volLakeIsabella_Restriction");
	VOLUME::_0x39816F6F94F385AD(iLocal_19, -1888.756f, 1801.481f, 235.7563f, 0f, 0f, 25.73841f, 74.84248f, 98.28612f, 31.18848f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_19, -1954.793f, 1783.318f, 243.2873f, 0f, 0f, 0f, 46.64574f, 29.92818f, 11.7102f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_19, -1762.221f, 1695.654f, 241.4712f, 0f, 0f, 41.08257f, 79.25368f, 154.9331f, 19.56473f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_19, -1701.788f, 1569.332f, 236.8674f, 0f, 0f, 0f, 35.55024f, 41.68321f, 26.91513f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_19, -1778.828f, 1559.399f, 224.9684f, 0f, 0f, 52.77263f, 63.78292f, 40.76912f, 36.18432f);
	func_11(iLocal_19, 0, 0);
	iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-166.7533f, 1728.319f, 179.9066f, 0f, 0f, -50.0001f, 19.31775f, 14.36033f, 21.41382f, "m_volGranitePass_Restriction");
	POPULATION::_0xB56D41A694E42E86(iLocal_20, 2228767, 0, 0, -1, -1, 2);
	POPULATION::_0x18262CAFEBB5FBE1(iLocal_20, 2228767, 0, 0, -1, -1, 0);
	func_12();
}
...
bool func_4(int iParam0)
{
	...
	iVar0 = func_13(iParam0, 1);
	iVar1 = (iVar0 / 31);
	iVar2 = (iVar0 % 31);
	if (func_14(iVar1))
	{
		if (Global_1071686.f_19648.f_24 && !func_15(iParam0))
		{
			return false;
		}
...
void func_6()
{
	if (BUILTIN::VDIST(Global_35, -573.6422f, 2709.223f, 320.4839f) < 100f)
	{
		switch (Global_1939655.f_314)
		{
			case 0:
				Global_1939655.f_313 = ENTITY::_0x6F3068258A499E52(joaat("P_VAL_GATE_SNOW01X"), -573.6422f, 2709.223f, 320.4839f, 11);
				Global_1939655.f_314 = 1;
				break;
			case 1:
				if (ENTITY::_0x1FF441D7954F8709(Global_1939655.f_313))
				{
					ENTITY::SET_ENTITY_VISIBLE(ENTITY::_0x4735E2A4BB83D9DA(Global_1939655.f_313), false);
					ENTITY::SET_ENTITY_COMPLETELY_DISABLE_COLLISION(ENTITY::_0x4735E2A4BB83D9DA(Global_1939655.f_313), false, false);
					func_16(371690004);
					Global_1939655.f_314 = 2;
				}
				break;
			case 3:
				Global_1939655.f_314 = 1;
...
void func_7()
{
	if (ENTITY::_0x1FF441D7954F8709(Global_1939655.f_313))
	{
		ENTITY::_0xD2B9C78537ED5759(Global_1939655.f_313);
	}
	Global_1939655.f_314 = 0;
}
