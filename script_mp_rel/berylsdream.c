...
bool func_66(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_93(iParam0));
}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_101(iParam1, 2) || func_102(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_59(iParam0) && func_83(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_108(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_81(int iParam0, bool bParam1)
{
	...
	if (func_86(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_115(Global_1896620.f_1, 16))
			{
				func_116(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
