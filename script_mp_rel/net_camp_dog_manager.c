...
int func_79(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_86(var uParam0, int iParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
