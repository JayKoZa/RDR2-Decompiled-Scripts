...
void func_2()
{
	...
	POPULATION::_0xB56D41A694E42E86(iLocal_20, 2228255, 0, 0, joaat("ANIMALS_LAKESTURGEON"), -1, 2);
	POPULATION::_0x18262CAFEBB5FBE1(iLocal_20, 2228255, 0, 0, joaat("ANIMALS_LAKESTURGEON"), -1, 0);
