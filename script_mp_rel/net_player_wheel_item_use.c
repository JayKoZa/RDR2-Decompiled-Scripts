...
void __EntryFunction__()
{
	...
	uVar3 = ScriptParam_0;
	iVar4 = -1;
	if (Global_1070356->f_26843.f_11.f_72 != iVar1)
	{
	}
	else
	{
		iVar4 = Global_1070356->f_26843.f_11.f_71;
		Global_1070356->f_26843.f_11.f_71 = -1;
		Global_1070356->f_26843.f_11.f_72 = 0;
	}
...
void func_10(var uParam0, var uParam1, int iParam2)
{
	...
	if ((PED::_0x84D0BF2B21862059(Global_1275573->f_8) || PED::IS_PED_SITTING_IN_ANY_VEHICLE(Global_1275573->f_8)) || PED::IS_PED_ON_MOUNT(Global_1275573->f_8))
	{
		iVar0 = 0;
	}
	else if (*iParam2 != -1)
	...
	TASK::_TASK_EMOTE_2(Global_1275573->f_8, *uParam1, iVar0, uParam0, 0, 1, 0, 0);
}
