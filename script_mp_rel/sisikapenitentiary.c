...
bool func_13()
{
	...
	iLocal_16 = Global_1887339[33 /*36*/].f_5;
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_81(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_74()))
...
bool func_72(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_108(iParam0));
}
...
{
	func_167(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_168(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_129(int iParam0)
{
	...
	if (func_93(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_170(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_171(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_172(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_175(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_136(int iParam0, bool bParam1)
{
	...
	else if (func_185(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_175(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
...
bool func_142(int iParam0, int iParam1)
{
	...
	{
		return func_190(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_155(vector3 vParam0, var uParam3, int iParam4)
{
	...
	uVar0 = Global_1071686.f_23887.f_366[func_199(vParam0) /*272*/];
	iVar1 = func_145(uVar0);
	if (iVar1 <= 0)
	{
		return false;
...
{
	func_208(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_98(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
