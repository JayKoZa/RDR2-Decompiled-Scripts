...
void func_2()
{
	iLocal_15 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-3685.423f, -2597.155f, -10f, 0f, 0f, -24.7897f, 116.6365f, 76.68949f, 15f, "m_volArmadillo_Restriction");
	func_9(iLocal_15);
	iLocal_16 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-4800.448f, -2704.913f, 28.17212f, 0f, 0f, -47.25f, 134.75f, 95.75f, 50f, "m_VolRidgewoodFarm_Restriction");
	func_10(iLocal_16);
	iLocal_17 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-3959.882f, -2132.151f, -5.324f, 0f, 0f, 0f, 35f, 35f, 20f, "m_volTwinRocks_Restriction");
	func_10(iLocal_17);
}
...
void func_3()
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (!func_11() && !func_12())
		{
			iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardThreat");
			VOLUME::_0x39816F6F94F385AD(iLocal_20, -3960.03f, -2122.22f, -4.99f, 0f, 0f, 51f, 4.85f, 7.96f, 13.94f);
			VOLUME::_0x39816F6F94F385AD(iLocal_20, -3955.38f, -2127.12f, -4.19f, 0f, 0f, 51f, 7.61f, 7.5f, 12.32f);
			iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardRestricted");
			VOLUME::_0x6E0D3C3F828DA773(iLocal_19, iLocal_20);
			VOLUME::_0xBCE668AAF83608BE(iLocal_19, -3962.87f, -2135.84f, -5.32f, 0f, 0f, 0f, 27f, 27f, 20f);
			VOLUME::_0xBCE668AAF83608BE(iLocal_19, -3934.91f, -2138.85f, -5.32f, 0f, 0f, 0f, 10f, 10f, 20f);
			iLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volGuardRegistration");
			VOLUME::_0x6E0D3C3F828DA773(iLocal_18, iLocal_19);
			VOLUME::_0xBCE668AAF83608BE(iLocal_18, -3959.88f, -2132.15f, -5.32f, 0f, 0f, 0f, 50f, 50f, 20f);
			sLocal_25 = "TWIN_ROCKS";
			LAW::_CREATE_GUARD_ZONE(sLocal_25);
			LAW::_0x8C598A930F471938(sLocal_25, iLocal_18);
			LAW::_0x35815F372D43E1E5(sLocal_25, iLocal_19);
			LAW::_0xAD3E07C37A7C1ADC(sLocal_25, iLocal_19);
			LAW::_0xA1B0E6301E2E02A6(sLocal_25, iLocal_20);
		}
	}
}
...
void func_5()
{
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(uVar3) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_35))
			{
				func_14(-154581735);
			}
		}
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(uVar2) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_35))
			{
				func_14(-154581735);
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(uVar1) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_35))
			{
				func_14(-154581735);
	...
	{
		if (!PERSCHAR::_0xEB98B38CA60742D7(uVar0) && func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_35))
			{
				func_14(-154581735);
		...
		else if (PERSCHAR::_0xEB98B38CA60742D7(uVar0) && !func_13(-154581735))
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(-262371610, Global_35))
			{
				func_15(-154581735);
