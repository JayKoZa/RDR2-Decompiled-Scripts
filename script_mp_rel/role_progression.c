...
int func_4(int iParam0)
{
	...
	iParam0->f_125[2] = DATABINDING::_DATABINDING_ADD_DATA_BOOL_BY_HASH(&(iParam0->f_125[0]), -1137252191, 0);
	return 1;
}
...
int func_79(int* iParam0, var uParam1, int iParam2)
{
	...
	iVar2 = func_98(iVar1);
	func_133(iVar1, iVar0, &sVar3, &cVar4);
	func_135(iParam0, sVar3, cVar4, iVar0, iVar2, func_134(iVar1));
...
{
	func_139(&(iParam0->f_2.f_3.f_113), iParam1);
}
...
int func_122(int* iParam0, int iParam1, int iParam2)
{
	...
	while (iVar5 <= iVar1)
	{
		...
		if (!func_179(iParam0, iVar2, func_178(iParam1, iVar5), iVar5, uVar3, cVar4, func_98(iParam1)))
		{
		}
		else
		{
...
int func_135(int* iParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!bParam5)
	{
...
int func_165(int* iParam0, int iParam1, int iParam2)
{
	...
	if (!func_235(iParam0, &Var0, iParam2))
	{
		return 0;
	}
	return 1;
...
{
	if (!func_236(&(iParam0->f_2.f_1), iParam1))
	{
		return 0;
	}
	return 1;
...
int func_179(int* iParam0, int iParam1, int iParam2, int iParam3, var uParam4, char[4] cParam5, int iParam6)
{
	struct<13> Var0;
	...
	Var0.f_11 = -1;
	Var0.f_12 = -1;
	if (!func_239(&Var0, iParam2, iParam3, uParam4, cParam5, iParam6))
	{
		return 0;
	}
	if (!func_240(iParam0, &Var0, iParam1))
	{
		return 0;
	}
	return 1;
...
int func_183(int* iParam0, int iParam1, var uParam2)
{
	...
	iVar0 = DATABINDING::_DATABINDING_GET_ARRAY_COUNT(iParam0->f_2.f_3.f_1);
	if (iParam1 < 0 || iParam1 >= iVar0)
	{
		return 0;
	}
	*uParam2 = DATABINDING::_DATABINDING_GET_ITEM_CONTEXT_BY_INDEX(iParam0->f_2.f_3.f_1, iParam1);
	return 1;
}
...
int func_187(int* iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	struct<13> Var0;
	...
	if (!func_245(iParam0, &Var0, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_188(int* iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	struct<13> Var0;
	...
	if (!func_245(iParam0, &Var0, iParam5))
	{
		return 0;
	}
	return 1;
...
{
	if (!func_236(&(iParam0->f_2.f_3.f_2), iParam1))
	{
		return 0;
	}
	return 1;
...
int func_199(int* iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4)
{
	return func_249(&(iParam0->f_2.f_3.f_113), MISC::_CREATE_VAR_STRING(2, "RP_RANK_XP", sParam1, sParam2, sParam3), iParam4);
}
...
int func_233(int* iParam0, int iParam1, struct<4> Param2, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
	struct<17> Var0;
	...
	Var0.f_10 = iParam8;
	Var0.f_14 = iParam10;
	if (!func_279(iParam0, iParam1, &Var0, iParam9, iParam11, iParam12, iParam13))
	{
		return 0;
	}
	func_280(Var0);
...
int func_235(int* iParam0, char[4] cParam1, int iParam2)
{
	char cVar0[64];
	struct<19> Var8;
	var uVar47;
	...
	else if (func_292(iParam0, iParam2, &uVar47))
	{
		if (!func_293(uVar47, cParam1))
		{
			return 0;
		}
	}
...
int func_238(int iParam0, int iParam1, var uParam2)
{
	...
	{
		Var0.f_2 = -103652163;
		DATAFILE::_DATAFILE_GET_INT(uParam2, &Var0);
		Var0.f_2 = -465378138;
		DATAFILE::_DATAFILE_GET_INT(&(uParam2->f_1), &Var0);
		Var0.f_2 = -1685174516;
...
int func_239(var uParam0, int iParam1, int iParam2, var uParam3, char[4] cParam4, int iParam5)
{
	struct<19> Var0;
	int iVar35;
	int iVar36;
...
int func_240(int* iParam0, char[4] cParam1, int iParam2)
{
	char cVar0[64];
	var uVar8;
	var uVar38;
	...
	else if (func_183(iParam0, iParam2, &uVar38))
	{
...
int func_245(int* iParam0, char[4] cParam1, int iParam2)
{
	char cVar0[64];
	var uVar8;
	var uVar47;
	...
	else if (func_316(iParam0, iParam2, &uVar47))
	{
...
struct<4> func_260(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_267(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	*iParam3 = ITEMDATABASE::_0xF540239F9937033B(iParam0, iParam1);
	...
	if (bParam5)
	{
		func_329(iParam0, iParam1, uParam2, *iParam3);
	}
	return 1;
}
...
int func_279(int* iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iParam4 == 0)
	{
		iParam4 = func_230(iParam1, 0, 1, iParam5, iParam6);
	}
...
int func_290(var uParam0, var uParam1, char[32] cParam2, char[4] cParam10)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam1))
	{
		return 0;
	}
	func_344(uParam0, uParam1, cParam2, *cParam10);
...
int func_291(int* iParam0, var uParam1)
{
	...
	DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(iParam0->f_2.f_1, iVar0, "role_card_entry", *uParam1);
	return 1;
}
...
int func_293(var uParam0, char[4] cParam1)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam0))
	{
		return 0;
	...
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, joaat("label"), cParam1->f_18);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, joaat("description"), cParam1->f_19);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, 465265479, cParam1->f_20);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, 1655007468, cParam1->f_21);
	DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT_BY_HASH(uParam0, joaat("level"), cParam1->f_22);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, -1655402402, cParam1->f_23);
	DATABINDING::_0xA3BD6FF95E713EE5(uParam0, 1264166569, &(cParam1->f_24));
	DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT_BY_HASH(uParam0, 268579106, cParam1->f_40);
	DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT_BY_HASH(uParam0, -1920183400, cParam1->f_41);
	DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT_BY_HASH(uParam0, -1609147137, cParam1->f_42);
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, joaat("locked"), cParam1->f_43);
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, joaat("new"), cParam1->f_44);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT_BY_HASH(uParam0, 1363420511, cParam1->f_45);
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, 1254882442, cParam1->f_46);
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, 171794733, cParam1->f_47);
	DATABINDING::_0xA3BD6FF95E713EE5(uParam0, -2112506996, &(cParam1->f_48));
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, 110010667, cParam1->f_65);
	DATABINDING::_0xBFC83DA249BEFCC9(uParam0, 709508872, cParam1->f_64);
	return 1;
}
...
int func_301(var uParam0, var uParam1, char[32] cParam2, char[4] cParam10)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam1))
	{
		return 0;
...
int func_302(int* iParam0, var uParam1)
{
	...
	iVar0 = DATABINDING::_DATABINDING_GET_ARRAY_COUNT(iParam0->f_2.f_3.f_1);
	DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(iParam0->f_2.f_3.f_1, iVar0, "rank_reward_entry", *uParam1);
	return 1;
}
...
int func_304(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_129(iParam0, 0))
	{
		return func_352(func_151(iParam0), iParam1, bParam2);
	}
	if (func_353(iParam0))
	{
...
int func_314(var uParam0, var uParam1, char[32] cParam2, char[4] cParam10)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam1))
	{
		return 0;
...
int func_315(int* iParam0, var uParam1)
{
	...
	iVar0 = DATABINDING::_DATABINDING_GET_ARRAY_COUNT(iParam0->f_2.f_3.f_2);
	DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(iParam0->f_2.f_3.f_2, iVar0, "rank_kit_entry", *uParam1);
	return 1;
}
...
int func_316(int* iParam0, int iParam1, var uParam2)
{
	...
	*uParam2 = DATABINDING::_DATABINDING_GET_ITEM_CONTEXT_BY_INDEX(iParam0->f_2.f_3.f_2, iParam1);
	return 1;
}
...
{
	*iParam2 = func_370(iParam0, iParam1, 1, 0, 1, 0);
	return 1;
}
...
int func_338(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
void func_344(var uParam0, var uParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, struct<16> Param10)
{
...
int func_354(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<37> Var0;
	int iVar47;
...
int func_355(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	...
	*uParam3 = ITEMDATABASE::_0x388088BFF3681189(iParam0, iParam1);
	if (*uParam3 == 0)
	{
		if (!bParam5)
		{
...
bool func_356(int iParam0, int iParam1)
{
	...
	return ITEMDATABASE::_0x388088BFF3681189(iParam0, iParam1) > 0;
}
...
var func_359(char[4] cParam0, char[4] cParam1)
{
...
int func_370(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;

	if ((bParam4 && iParam1 == -915411861) && func_369(iParam0, 59806960))
	{
		iParam1 = 59806960;
	}
	if (func_353(iParam0))
...
int func_377(var uParam0, var uParam1, var uParam2, bool bParam3)
{
...
int func_379(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_388(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<37> Var0;
	int iVar47;
...
int func_395(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	*iParam3 = ITEMDATABASE::_0xDEE7B3C76ED664BE(iParam0, iParam1);
	...
	if (bParam4)
	{
		func_403(iParam0, iParam1, uParam2, *iParam3);
	}
	return 1;
}

int func_396(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_404(uParam0, iParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_404(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
...
var func_405(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
int func_412(struct<2> Param0, var uParam2)
{
	if (!func_407(Param0))
	{
		return 0;
