...
{
	func_144(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_145(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_114(int iParam0)
{
	...
	if (func_87(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_147(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_148(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_149(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_152(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_121(int iParam0, bool bParam1)
{
	...
	else if (func_162(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_152(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
...
{
	func_175(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_186(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
