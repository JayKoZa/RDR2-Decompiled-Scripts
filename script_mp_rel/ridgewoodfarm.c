...
int func_13()
{
	uLocal_13 = ((*Global_1887327)[131 /*36*/])->f_5;
...
int func_89(int iParam0, bool bParam1)
{
	...
	if (func_116(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_91(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_91(iParam0)))
	{
...
bool func_90(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_91(iParam0));
}
...
void func_115(int iParam0)
{
	...
	if (func_87((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_141((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
...
int func_117(int iParam0, bool bParam1)
{
	...
	func_149(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_91(iParam0));
	func_124(iParam0, 0);
	return 1;
}
