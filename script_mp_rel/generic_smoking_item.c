...
void __EntryFunction__()
{
	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE())
	{
		if (!ScriptParam_0.f_3)
		{
			...
			{
				Var0.f_180 = TASK::_0x05A0100EA714DB68(Global_34, 2120637577);
			}
		}
		if (!ScriptParam_0.f_3)
		{
...
void func_2(var uParam0, int iParam1, vector3 vParam2, vector3 vParam5)
{
	...
	ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_180, Global_34, PED::GET_PED_BONE_INDEX(Global_34, iParam1), vParam2, vParam5, 1, 1, 0, 0, 2, 1, 0, 0);
}
...
void func_20(float fParam0, bool bParam1)
{
	...
	if (func_38())
	{
		...
		if (iVar1 != iVar2)
		{
			Global_1954472->f_1331.f_107 = func_40();
			func_41(&(Global_1954472->f_1331.f_107), 0, 0, 1, 0, 0, 0, 0);
		}
...
void func_24(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
int func_38()
{
	...
	return func_66(Global_1954472->f_1331.f_107, 0);
}
...
int func_62(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_101(iParam1), BUILTIN::CEIL(fParam2));
	return 1;
}
...
int func_78(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_117(iParam0, 262144) || !Global_1904613->f_8198)
		{
			return 0;
		}
	}
...
bool func_91(int iParam0)
{
	...
	return &Global_1140484->f_30603.f_847[func_120(iParam0, 1) /*12*/] == -1;
}
...
int func_92(int iParam0)
{
	...
	iVar0 = func_120(iParam0, 1);
	if (!func_88(&(Global_1140484->f_30603.f_847[iVar0 /*12*/])))
	{
		return 1;
	}
	iVar3 = func_121(&(Global_1140484->f_30603.f_847[iVar0 /*12*/]), 1);
	iVar4 = 0;
		...
		switch (func_122(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1140484->f_30603.f_10924)
				{
					...
					{
						func_123(iVar1, iParam0, iVar4);
						func_124(Global_1140484->f_30603.f_8871[iVar5 /*3*/]);
						...
						*(Global_1140484->f_30603.f_8871[iVar5 /*3*/]) = { *(Global_1140484->f_30603.f_8871[Global_1140484->f_30603.f_10924 /*3*/]) };
						func_124(Global_1140484->f_30603.f_8871[Global_1140484->f_30603.f_10924 /*3*/]);
					}
					else
					{
						iVar5++;
			...
			func_128(Global_1140484->f_30603.f_847[iVar0 /*12*/]);
			return 1;
		}
...
{
	return func_136(&(Global_1954472->f_1465), iParam0, 1);
}
...
int func_123(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_142(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/])) && func_143(iParam0, (Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4))
	{
		vVar1 = { func_144((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4) };
		if (func_145(vVar1))
		{
			if (func_146(vVar1.x, vVar1.y, vVar1.z))
			{
				func_147((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_148((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4);
			}
		}
		else
		{
...
int func_130(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_142(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/]));
	if (bVar1 && func_150((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4))
	{
		vVar2 = { func_151((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4) };
	...
	if (func_146(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_147((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
int func_141(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_121(&(Global_1140484->f_30603.f_847[iVar0 /*12*/]), 1);
	...
	while (iVar4 < (Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_16)
	{
		...
		else
		{
			...
			(Global_1140484->f_2001[iVar5 /*192*/])->f_188 = ((Global_1140484->f_2001[iVar5 /*192*/])->f_188 - func_154((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_6[iVar4 /*3*/]));
			func_155(iVar3);
		}
		iVar4++;
	}
...
int func_146(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < (Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_28)
	{
		...
		else if (!func_163((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_17[iVar7 /*2*/]))
		{
		}
		else
		{
	...
	func_165((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_2);
	return 1;
}
...
void func_155(int iParam0)
{
	...
	iVar0 = func_152(iParam0, 1);
	if (!func_168(&(Global_1140484->f_2001[iVar0 /*192*/])))
	{
		return;
	}
	...
	if (!func_169((Global_1140484->f_2001[iVar0 /*192*/])->f_190))
	{
		return;
	}
	iVar1 = func_170((Global_1140484->f_2001[iVar0 /*192*/])->f_190, 1);
...
int func_161(int iParam0)
{
	...
	{
		iVar64 = func_125(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/]), 1);
		...
		else if (!func_177(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/]), (Global_1140484->f_30603.f_8871[iVar65 /*3*/])->f_1))
		{
		}
		else
		{
			Var1 = { func_178(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/])) };
...
int func_177(int iParam0, int iParam1)
{
	...
	if (func_142(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/])))
	{
		iVar3 = &Global_1140484->f_30603.f_8667[func_160(iVar2, 1) /*3*/];
		Var4 = { func_178(iVar3) };
	...
	switch (&Global_1140484->f_30603.f_2900[iVar0 /*31*/])
	{
		...
		case 190804938:
			...
			if (iVar1 != &Global_1275573 && !func_188(&(Global_1275573->f_154[iVar1])))
			{
				return 0;
			}
