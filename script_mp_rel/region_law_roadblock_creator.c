...
void __EntryFunction__()
{
	...
	Global_1938085->f_2 = iVar0;
	Global_1938085->f_1 = MISC::GET_GAME_TIMER();
}
...
int func_3()
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1938085->f_148))
	{
		if (func_19())
		{
			return 1;
...
void func_6()
{
	...
	switch (iLocal_18)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (func_24(Global_35, &Local_19, &bVar1, 16, 1, 45f, 25f, 100f, 180f, 0))
			{
		...
		case 4:
			...
			else
			{
				...
				MISC::_CREATE_INCIDENT_WITH_ENTITIES(8, vLocal_35, iLocal_130, -1f, &iLocal_131);
				iVar2 = 0;
				while (iVar2 < iLocal_41)
				{
					if (func_9(&(iLocal_41[iVar2]), 0))
					{
						if (iVar2 <= 1)
						{
							uVar3 = &uLocal_121[iVar2];
						}
						else if (func_30())
						{
							uVar3 = &uLocal_115[iVar2];
						}
						else
						{
							uVar3 = &uLocal_121[iVar2];
						}
						TASK::_TASK_USE_SCENARIO_POINT(&(iLocal_41[iVar2]), uVar3, 0, 0, 0, 1, 0, 0, -1082130432, 0);
					}
					iVar2++;
				}
				iLocal_18 = 5;
		...
		case 5:
			...
			while (iVar4 < iLocal_41)
			{
				if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_41[iVar4])))
				{
					...
					if (func_31(Global_34, &(iLocal_41[iVar4]), 1, 1) > 200f)
					{
						iLocal_18 = 6;
						return;
					}
...
int func_19()
{
	...
	if (func_44((Global_39.f_186[iVar0 /*12*/])->f_1) || (Global_39.f_186[iVar0 /*12*/])->f_4 < 1f)
	{
		return 0;
	}
	if (func_45(Global_34, (Global_39.f_186[iVar0 /*12*/])->f_1, ((Global_39.f_186[iVar0 /*12*/])->f_4 + 10f), 1, 1))
	{
		return 1;
	}
	return 0;
...
int func_20(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_46(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_47())
	{
		return func_46(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_46(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_24(vector3 vParam0, int iParam3, bool bParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, float fParam10, float fParam11)
{
	int iVar0;
...
void func_28()
{
	...
	while (iVar11 < iLocal_29)
	{
		...
		uVar6 = func_59(vVar0, vVar3);
		uLocal_121[iVar11] = TASK::CREATE_SCENARIO_POINT(Var7, vVar3, uVar6, 0, 0, 0);
		iVar11++;
	}
	...
	while (iVar15 < iLocal_29)
	{
		...
		uVar6 = func_59(vVar3, vVar0);
		func_55(&vVar3, 50, 10, 0, 0);
		uLocal_115[iVar15] = TASK::CREATE_SCENARIO_POINT(Var7, vVar3, uVar6, 0, 0, 0);
		iVar15++;
	}
}
