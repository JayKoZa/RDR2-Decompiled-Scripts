...
void func_16()
{
	...
	if (!func_40())
	{
		Global_1070356->f_27136.f_8.f_10 = 0;
	}
...
void func_39()
{
	Global_1070356->f_27136.f_1 = 1;
	Global_1070356->f_27136.f_62.f_30 = 1;
	Global_1070356->f_27136.f_2 = SCRIPTS::GET_ID_OF_THIS_THREAD();
}

bool func_40()
{
	return Global_1070356->f_27136.f_8.f_4;
}

bool func_41()
{
	return Global_1070356->f_27136.f_8.f_10 != 0;
}
...
void func_56()
{
	Global_1070356->f_27136.f_1 = 0;
	Global_1070356->f_27136.f_2 = 0;
}
...
{
	if (func_87(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_88(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_105((Global_1070356->f_19683.f_1[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*8*/])->f_7, iParam0))
	{
		func_106(&((Global_1070356->f_19683.f_1[PLAYER::NETWORK_PLAYER_ID_TO_INT() /*8*/])->f_7), iParam0);
	}
}
...
void func_84()
{
	if (!bLocal_181)
	{
		PED::_0xCB9401F918CB0F75(iLocal_33, "SpawnMissionIntro", 1, 20);
	...
	switch (iLocal_15)
	{
		...
		case 1:
			...
			else
			{
				...
				uVar1 = func_109(iLocal_32, 1, -1, 1);
				...
				{
					func_110(&Local_16, PLAYER::GET_PLAYER_NAME(iLocal_32), (*Global_3145728)[iLocal_41 /*8*/], " ", " ", " ", " ", uVar1);
				}
				else
				{
					func_110(&Local_16, PLAYER::GET_PLAYER_NAME(iLocal_32), " ", " ", " ", " ", " ", uVar1);
				}
				func_38(&Local_16);
				func_35(&uLocal_67, 0, 0);
...
void func_101(int iParam0)
{
	...
	else if (((iVar2 == -594562071 || iVar2 == joaat("group_rifle")) || iVar2 == joaat("group_sniper")) || (iVar2 == joaat("group_shotgun") && iVar0 != joaat("weapon_shotgun_sawedoff")))
	{
		iVar3 = 3;
	}
	...
	else if (WEAPON::_0x30E7C16B12DA8211(iVar0) || WEAPON::_0x959383DCD42040DA(iVar0))
	{
		iVar3 = 5;
	}
...
void func_102(int iParam0)
{
	...
	else if (WEAPON::_0x30E7C16B12DA8211(iVar0))
	{
		iVar3 = 5;
	}
	else if (func_117(iVar0))
...
void func_104(int iParam0, int iParam1)
{
	...
	else if (WEAPON::_0xD955FEE4B87AFA07(iVar0) || (iVar2 == joaat("group_shotgun") && iVar0 == joaat("weapon_shotgun_sawedoff")))
	{
		iVar5 = 1;
	}
	else
...
int func_109(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	if (func_105((Global_1070356->f_19683.f_1[iVar2 /*8*/])->f_7, 1024))
	{
		return -508184943;
	}
...
void func_110(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, var uParam7)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam0->f_3))
	{
		uParam0->f_3 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER_FROM_PATH("", "transitionData");
	...
	{
		DATABINDING::_DATABINDING_WRITE_DATA_INT(uParam0->f_12, uParam7);
	}
	else
	{
		uParam0->f_12 = DATABINDING::_DATABINDING_ADD_DATA_INT(uParam0->f_3, "teamNameColor", uParam7);
	}
...
{
	if (_NAMESPACE26::_0x901E0DC25080C8B9(iParam0) != Global_1275573->f_15 && !func_132())
	{
		return 636925055;
	}
	return -963477619;
...
int func_138(struct<2> Param0, var uParam2)
{
	if (!func_139(Param0))
	{
		return 0;
...
int func_140(struct<2> Param0)
{
	...
	while (iVar6 <= iVar7)
	{
		...
		func_138(*(Global_1070356->f_17817.f_1[iVar8 /*3*/]), &vVar3);
		if (vVar3.x > vVar0.x)
		{
			iVar7 = (iVar8 - 1);
		}
