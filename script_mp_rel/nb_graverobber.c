...
void func_41()
{
	...
	Local_16.f_6 = func_73(GANG::_0x4BE6C13A45CCA8EC(GANG::_0x901E0DC25080C8B9(iVar0)));
	func_90(256);
...
int func_114()
{
	...
	if (!STREAMING::_REQUEST_SCENARIO_TYPE(855887031, 15, 0, 0) || !STREAMING::_REQUEST_SCENARIO_TYPE(-1907387938, 15, 0, 0))
	{
		iVar2 = 0;
	}
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(855887031, 0) || !STREAMING::_HAS_SCENARIO_TYPE_LOADED(-1907387938, 0))
	{
		iVar2 = 0;
	}
	return iVar2;
...
void func_123()
{
	...
	Local_204.f_18.f_24 = TASK::CREATE_SCENARIO_POINT(855887031, func_200(0), func_201(0), 0, 0, 0);
	TASK::_SET_SCENARIO_POINT_FLAG(Local_204.f_18.f_24, 25, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(Local_204.f_18.f_24, 23, 1);
}
		...
		case 4:
			if (bVar0)
			{
				...
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(1)))
				{
					...
					TASK::_TASK_MOVE_IN_TRAFFIC_2(func_189(1), func_260(), 2f, 1f, 0, 0);
				...
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(2)))
				{
					...
					TASK::_TASK_MOVE_IN_TRAFFIC_2(func_189(2), func_260(), 2f, 1f, 0, 0);
			...
			if ((MISC::GET_FRAME_COUNT() % 15) == 0)
			{
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(1)))
				{
					TASK::_TASK_MOVE_IN_TRAFFIC_2(func_189(1), func_260(), 2f, fVar1, 0, 0);
				}
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(2)))
				{
					TASK::_TASK_MOVE_IN_TRAFFIC_2(func_189(2), func_260(), 2f, fVar2, 0, 0);
				}
			}
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(1)))
			{
...
bool func_216()
{
	return func_300(85134332 /* GXTEntry: "Pennington Field Shovel" */, 1);
}
...
void func_220()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (((!func_294(16384) && NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(&(Local_16.f_7.f_8[0]))) && NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar0)) && PED::_0xA0BC8FAED8CFEB3C(iVar0))
		{
			...
			PED::_UPDATE_PED_VARIATION(iVar0, 1, 1, 1, 1, 1);
			func_295(16384);
		}
		func_301(0, 0);
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT(iVar0, Local_204.f_18.f_24, 0, 0, 0, 1, 0, 0, -1082130432, 0);
		}
...
void func_223()
{
	...
	if ((func_36(Var0) && !func_21(Local_204.f_9, Var0)) || !func_289())
	{
		...
		if (!func_294(2048))
		{
			if ((!func_216() || !GANG::_0x3F59FE6F37869576(Local_16.f_7.f_17, PLAYER::GET_PLAYER_INDEX())) && func_316(Global_34, func_189(0), 35f, 0))
			{
				func_295(2048);
				func_304(810, 1);
			}
...
void func_224()
{
	...
	else
	{
		...
		func_308(&(Local_204.f_18.f_155));
		LAW::_REPORT_CRIME(PLAYER::GET_PLAYER_INDEX(), -1759599185, 0, 0, 1);
...
void func_227()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (func_231(iVar0, -76381094, 1, 0))
		{
			TASK::_TASK_USE_SCENARIO_POINT(iVar0, Local_204.f_18.f_24, 0, 0, 1, 0, 0, 0, -1082130432, 0);
		}
...
void func_287(int iParam0, int iParam1, int iParam2, char* sParam3)
{
	...
	if (iParam2 != 0)
	{
		MAP::_BLIP_SET_MODIFIER(&(Local_204.f_18.f_11[iParam0 /*2*/]), iParam2);
	}
}
...
int func_289()
{
	...
	if (Local_204.f_18 > 2 && !GANG::_0x3F59FE6F37869576(Local_16.f_7.f_17, PLAYER::GET_PLAYER_INDEX()))
	{
		return 0;
	}
	return 1;
...
int func_309(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			if (bParam5 && !GANG::_0x3F59FE6F37869576(iVar1, PLAYER::GET_PLAYER_INDEX()))
			{
				Jump @167; //curOff = 157
			}
			else
...
int func_401(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_497(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_497(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
int func_442(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_461(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_459(int iParam0, int iParam1)
{
	...
	if (!WEAPON::_IS_WEAPON_LASSO(func_523(iParam0, 1, 0, 0)) && !func_523(iParam0, 1, 0, 0) == 1151374672)
	{
		return 0;
	}
...
void func_485(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3)
{
	int iVar0;
...
struct<5> func_539(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		case joaat("clothing"):
			Var0 = { func_540(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("dog"):
			...
			{
				Var0 = { func_540(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
struct<4> func_540(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_557()
{
	return (func_569(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 0, 0) > 0 && func_570(func_540(889965687 /* GXTEntry: "Wardrobe" */, func_545(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_558(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_497(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_497(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_569(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (func_572(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_34, iParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_497(bParam1), iParam0, iParam3);
}

int func_570(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	return func_573(&uParam0, iParam4, bParam5, iParam6);
}
...
int func_573(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_576(uParam0, iParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_576(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
