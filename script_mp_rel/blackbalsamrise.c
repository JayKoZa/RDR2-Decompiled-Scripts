...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2766.68f, 1745.469f, 148.201f, 0f, 0f, 80.784f, 14.456f, 10.148f, 8.8f, "BBR TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2765.88f, 1749.306f, 148.201f, 0f, 0f, 80.784f, 3.7f, 3.7f, 4.2f, "BBR TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
...
{
	func_58(38, iLocal_19, iParam0, iLocal_20, 0, 12, 1, 0, -1082130432 /* Float: -1f */, 0);
	func_59(38, 0);
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_18 = func_95(iParam2, iParam0);
	...
	Global_1051439.f_72[iParam0 /*75*/].f_63 = func_96(Global_1051439.f_72[iParam0 /*75*/].f_18);
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_100(iParam0, 16384) || func_100(iParam0, 32768)) || func_101(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
...
bool func_66(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_107(iParam0));
}
...
void func_94(int iParam0, bool bParam1)
{
	...
	else if (func_151(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_154(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_157(iParam0, 2))
	{
...
{
	func_174(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_175(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_128(int iParam0)
{
	...
	if (func_87(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_177(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_178(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_179(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_154(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
{
	return func_198(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_161(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_200(12, func_199(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
{
	func_209(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_187(int iParam0, int iParam1)
{
	...
	{
		return func_219(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
