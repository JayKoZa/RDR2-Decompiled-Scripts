	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_68(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_80(iVar7) && !Global_26386) && iVar7 != iVar0) && !func_48(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_34, iVar7);
				}
				if (func_80(iVar7) && func_48(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1))
				{
...
void func_63(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_34, iVar0, 0, 0) && func_104(iParam0, 0, 0, 0) == 0))
		{
			if (func_28() == -1)
			{
				func_29(iVar0);
...
void func_86(int iParam0, int iParam1)
{
	...
	{
		iVar2 = func_153(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
void func_101(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		func_113(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_112(int iParam0)
{
	...
	if (!func_176(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
var func_125(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
int func_185(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_207(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_217(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_219(uParam0, iParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_219(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
