		...
		if (MISC::GET_GAME_TIMER() > iLocal_25)
		{
			...
			switch (iLocal_24)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_27 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_24 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_26)))
					{
						...
						else
						{
							...
							func_36(iLocal_26, &Global_1896674);
							iLocal_24 = 11;
							Jump @816; //curOff = 642
							func_37(iLocal_26);
							func_21(iLocal_26, 8);
							...
							func_41(&Global_1896674, iLocal_26);
							func_42(iLocal_26);
							func_21(iLocal_26, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_26 /*36*/].f_11);
							if (Global_1887339[iLocal_26 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_26 /*36*/].f_12);
							}
							Jump @816; //curOff = 793
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_26 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_26 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_86(iParam0) || func_87(iParam0)) || func_90(Global_1896620))
			{
				func_91(Global_1896620, 0);
			}
			Global_1896620++;
			iVar2++;
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_94(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_102(iParam1, 2) || func_103(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_58(iParam0) && func_85(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_109(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_83(int iParam0, bool bParam1)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_116(Global_1896620.f_1, 16))
			{
				func_117(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
bool func_88(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_131(Global_1893587.f_162);
	}
...
{
	func_138(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_139(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_89(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_141(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_142(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_143(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_146(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_122(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_154(iParam0) && !bParam1);
	...
	else if (func_156(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	if (func_156(iParam0, 16384) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_146(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_160(iParam0, 2))
	{
...
{
	func_168(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_165(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
