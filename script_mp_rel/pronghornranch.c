...
int func_13()
{
	...
	uLocal_13 = ((*Global_1887327)[22 /*36*/])->f_5;
	VOLUME::_0xB469CFD9E065EB99(uLocal_13, 5);
	return 1;
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_64(&Global_1939178, 32768)) || func_64(&Global_1939178, 16777216))
	{
		return;
	}
...
bool func_54(int iParam0)
{
	...
	if (func_87(iVar1))
	{
		if (Global_1070356->f_17915.f_24 && !func_88(iParam0))
		{
			return false;
		}
...
void func_61(var uParam0, var uParam1, int iParam2)
{
	...
	(*uParam0)[uParam0->f_61 /*3*/] = uParam1;
...
bool func_66()
{
	return func_64(&Global_1939178, 8192);
}
...
bool func_68(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_99(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_107(iParam1, 2) || func_108(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_113(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_113(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_113(&cVar6, joaat("COLOR_PURE_WHITE")), func_113(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938085->f_145 = func_114(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_93(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_122(Global_1896608->f_1, 16))
			{
				func_123(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_96(int iParam0, bool bParam1)
{
	...
	{
		func_131(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_130(iParam0)));
		if (func_45() == -1)
		{
			if (func_122(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_132(iParam0));
				func_133(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_132(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_132(iParam0)))
	{
		func_133(iParam0, 128);
		return 1;
	}
	func_131(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_130(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_132(iParam0));
	if (func_122(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_132(iParam0));
		func_133(iParam0, 2048);
...
char* func_101(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_138(Global_1893575->f_162);
	}
...
int func_104(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_143(PLAYER::PLAYER_ID()) };
...
{
	func_145((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_146((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_121(int iParam0)
{
	...
	if (func_94((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_148((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_149((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_150((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_153(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_123(int iParam0, bool bParam1)
{
	...
	func_156(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_132(iParam0));
	func_131(iParam0, 0);
	return 1;
}
...
void func_128(int iParam0)
{
	...
	if (func_161(iParam0, 262144) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_153(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_167(iParam0, 2))
	{
...
{
	func_176(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_188((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_169()
{
	...
	if (!func_171(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
