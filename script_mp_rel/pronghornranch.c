...
int func_55()
{
	...
	if ((INTERIOR::IS_VALID_INTERIOR(iVar4) && INTERIOR::_IS_INTERIOR_ENTITY_SET_VALID(iVar4, sVar0)) && !INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iVar4, sVar0))
	{
...
int func_96(int iParam0, bool bParam1)
{
	...
	if (func_122(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_132(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_132(iParam0)))
	{
...
int func_123(int iParam0, bool bParam1)
{
	...
	func_156(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_132(iParam0));
	func_131(iParam0, 0);
	return 1;
}
...
void func_128(int iParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_167(iParam0, 2))
	{
