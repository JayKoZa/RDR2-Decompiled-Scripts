...
bool func_13()
{
	...
	iLocal_13 = Global_1887339[22 /*36*/].f_5;
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_23)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_23, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_99(iParam0));
}
...
void func_119()
{
	...
	if ((INTERIOR::IS_VALID_INTERIOR(iVar4) && INTERIOR::_IS_INTERIOR_ENTITY_SET_VALID(iVar4, sVar0)) && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iVar4, sVar0))
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iVar4, sVar0, true);
	}
}

void func_120(int iParam0)
{
	func_145(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_146(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_121(int iParam0)
{
	...
	if (func_94(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_148(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_149(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_150(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
...
void func_128(int iParam0, bool bParam1)
{
	...
	else if (func_163(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_167(iParam0, 2))
	{
...
{
	func_176(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
