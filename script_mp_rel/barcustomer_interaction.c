...
void func_6()
{
	...
	if (iLocal_29 <= 1 && func_14(Global_35, TASK::_GET_SCENARIO_POINT_COORDS(iLocal_16, 1)) >= 1600f)
	{
		return;
	}
	...
	if ((iLocal_29 > 1 && iLocal_29 != 6) && Global_1938942->f_51)
	{
		func_15();
		iLocal_29 = 2;
		bLocal_38 = true;
	...
	switch (iLocal_29)
	{
		case 0:
			...
			fVar5 = TASK::_GET_SCENARIO_POINT_HEADING(iLocal_16, 1);
			iLocal_42 = TASK::CREATE_SCENARIO_POINT(iVar4, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(TASK::_GET_SCENARIO_POINT_COORDS(iLocal_16, 1), fVar5, func_21()), (fVar5 - 180f), 0, 0, 0);
			TASK::_SET_SCENARIO_POINT_HEADING(iLocal_42, (fVar5 - 180f), 1);
			...
			break;
		case 2:
			if (((!func_26() && !bVar1) && !Global_1938942->f_51) && bVar0)
			{
				iLocal_28 = 0;
				iLocal_29 = 3;
				if (bLocal_33)
...
{
	func_15();
	TASK::_0x4161648394262FDF(TASK::_GET_SCENARIO_POINT_COORDS(iLocal_16, 1), 0.15f);
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_42))
	{
...
void func_15()
{
	...
	if (!Global_1938942->f_51)
	{
		if (Global_1938942->f_50 == SCRIPTS::GET_ID_OF_THIS_THREAD())
		{
			Global_1938942->f_50 = 0;
		}
...
void func_17(bool bParam0)
{
	...
	if ((!bLocal_32 && bLocal_38) && ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_30, 864365833))
	{
		if (iLocal_17 == 817658057)
		{
			...
			{
				iLocal_53 = OBJECT::CREATE_OBJECT(joaat("p_shotglass01x"), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_42, 1), true, true, false, false, true);
			}
		...
		else
		{
			...
			{
				iLocal_54 = OBJECT::CREATE_OBJECT(joaat("p_shotglass01x"), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_42, 1), true, true, false, false, true);
			}
...
int func_18()
{
	...
	{
		case 81:
			if (func_37(func_36(0), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_16, 1)))
			{
				return 0;
			}
			else
		...
		case 127:
			return 0;
		case 5:
			if (func_37(func_36(2), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_16, 1)))
			{
				return 2;
			}
			else
...
void func_27(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		case 0:
			bVar0 = PED::_0x9C54041BB66BCF9E(iLocal_30, iLocal_16);
			...
			if (TASK::IS_PED_ACTIVE_IN_SCENARIO(iLocal_30, 0) && bVar0)
			{
				...
				if (!Global_1938942->f_51)
				{
					...
					TASK::_TASK_USE_SCENARIO_POINT(iLocal_31, iLocal_42, 0, 0, 1, 0, 0, 0, -1082130432, 0);
					iLocal_28 = 1;
				}
			}
			break;
...
int func_37(var uParam0, vector3 vParam1)
{
...
int func_41(int iParam0)
{
	...
	return PERSCHAR::_0xA00DF706C60173D1(Global_1893763[iParam0 /*3*/]);
}
...
void func_45()
{
	...
	Global_1938942->f_50 = SCRIPTS::GET_ID_OF_THIS_THREAD();
	iVar0 = func_35(iLocal_41);
	if (PERSCHAR::_0x800DF3FC913355F3(iVar0))
	{
...
int func_47()
{
	if (((!Global_1938942->f_51 && func_54(&uLocal_49) > 1250) && !TASK::_0x916B8E075ABC8B4E(iLocal_31, 1)) && (!PED::_0xC488B8C0E52560D8(iLocal_31) || ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_31, 1004907005)))
	{
		return 1;
	}
	return 0;
...
void func_48()
{
	if (!bLocal_39)
	{
		if (iLocal_17 == 817658057)
		{
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_53))
			{
				iLocal_53 = OBJECT::CREATE_OBJECT(joaat("p_bottlebeer01x"), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_42, 1), true, true, false, false, true);
		...
		{
			iLocal_53 = OBJECT::CREATE_OBJECT(joaat("p_bottlejd01x"), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_42, 1), true, true, false, false, true);
			iLocal_54 = OBJECT::CREATE_OBJECT(joaat("p_shotglass01x"), TASK::_GET_SCENARIO_POINT_COORDS(iLocal_42, 1), true, true, false, false, true);
