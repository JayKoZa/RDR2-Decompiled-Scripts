...
int func_175(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
	...
	else
	{
		switch (iParam9)
		{
			case 665633627:
				...
				break;
			case -432403087:
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_226());
				break;
			case -1612834106:
...
int func_233(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_236(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_237())
	{
		return func_236(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_236(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
