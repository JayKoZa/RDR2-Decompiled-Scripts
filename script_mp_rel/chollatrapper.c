...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-4730.623f, -2940.357f, -20.103f, 0f, 0f, -112.904f, 7.714f, 7.649f, 7.583f, "Cholla Springs Trapper - m_volTrapper");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-4729.141f, -2940.884f, -19.68f, 0f, 0f, -15.765f, 2.125f, 2.798f, 4.201f, "Cholla Springs Trapper - m_volTrapperPrompt");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-4731.572f, -2939.006f, -20.1029f, 0f, 0f, -76.588f, 2.5f, 3f, 4.201f, "Cholla Springs Trapper - m_volTrapperOfflimits");
	return true;
}
