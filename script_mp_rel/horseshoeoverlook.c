...
bool func_13()
{
	iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Horseshoe - m_volTown");
	VOLUME::_0xBCE668AAF83608BE(iLocal_21, -131.6045f, -34.30135f, 102.2093f, 0f, 0f, -24.47213f, 46.71921f, 37.52021f, 13.16044f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_21, -117.99f, -66.781f, 100f, 0f, 0f, 94f, 16.719f, 19.52f, 13.16044f);
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-380.148f, -19.541f, 42.09f, 0f, 0f, -110f, 14.456f, 10.148f, 8.8f, "HRT W TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-381.779f, -21.29f, 42.09f, 0f, 0f, -110f, 3.7f, 3.7f, 4.2f, "HRT W TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
