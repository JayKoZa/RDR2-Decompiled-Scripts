		...
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			switch (iLocal_22)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_25 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_22 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_24)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_24 /*36*/].f_11);
							if (Global_1887339[iLocal_24 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_24 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_24 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_24 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_61(Global_1940258, 32768)) || func_61(Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_74(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_67()))
...
bool func_63()
{
	return func_61(Global_1940258, 8192);
}
...
bool func_65(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_91(iParam0));
}
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_99(iParam1, 2) || func_100(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_59(iParam0) && func_82(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_106(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_80(int iParam0, bool bParam1)
{
	...
	if (func_86(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_113(Global_1896620.f_1, 16))
			{
				func_114(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
int func_83(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	...
	iVar1 = func_120(uParam0, iParam1, iVar0, iParam2);
	func_121(iVar0);
	return iVar1;
}
...
char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_130(Global_1893587.f_162);
	}
...
{
	func_137(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_138(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_112(int iParam0)
{
	...
	if (func_87(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_141(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_142(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_145(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_119(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_153(iParam0) && !bParam1);
	if (!bVar0 && !func_154(iParam0, 65536))
	{
	...
	else if (func_155(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_145(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
...
bool func_129(int iParam0, bool bParam1, bool bParam2)
{
	if (Global_1572887.f_13 != -1)
	{
...
{
	func_167(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_179(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_160()
{
	...
	if (!func_162(Global_1051213) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_164(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
