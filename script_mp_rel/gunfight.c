...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_61(&Global_1939178, 32768)) || func_61(&Global_1939178, 16777216))
	{
		return;
	}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_74(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_67()))
	...
	else if (func_45() == -1)
	{
		func_78(iLocal_26);
		func_79(iLocal_26);
		if (!func_80(iLocal_26, 0))
		{
			return 0;
		}
	}
	else if (!func_81(iLocal_26))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
bool func_63()
{
	return func_61(&Global_1939178, 8192);
}
...
bool func_65(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_91(iParam0));
}
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_99(iParam1, 2) || func_100(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_59(iParam0) && func_82(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	Global_1938085->f_145 = func_106(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_70(int iParam0, bool bParam1)
{
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_110(func_109(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_110(func_109(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_110(func_109(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_110(func_109(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_110(func_109(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_110(func_109(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_80(int iParam0, bool bParam1)
{
	...
	if (func_86(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_113(Global_1896608->f_1, 16))
			{
				func_114(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_81(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_115(iVar0) || func_116(iVar0))
		{
		}
		else
		{
...
int func_83(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	var uVar0;
	var uVar1;

	uVar0 = VOLUME::_CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	uVar1 = func_120(uParam0, iParam1, uVar0, iParam2);
	func_121(uVar0);
	return uVar1;
}
...
char* func_93(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_132(func_131(Global_35));
	}
...
struct<2> func_109(int iParam0, int iParam1)
{
	struct<2> Var0;
...
{
	func_137((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_138((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_112(int iParam0)
{
	...
	if (func_87((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_140((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_141((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_142((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_145(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_119(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_145(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_159(iParam0, 2))
	{
...
{
	func_167(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_179((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
