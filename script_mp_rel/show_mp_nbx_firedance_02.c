...
bool func_171(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_184(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_195(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_200(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_229(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_232(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_233())
	{
		return func_232(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_232(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
