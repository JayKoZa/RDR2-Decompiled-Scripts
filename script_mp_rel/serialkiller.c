		...
		if (MISC::GET_GAME_TIMER() > iLocal_21)
		{
			...
			switch (iLocal_20)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_23 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_20 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_22));
					Global_1896620 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_22)))
					{
						...
						else
						{
							...
							func_36(iLocal_22, &Global_1896674);
							iLocal_20 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_22);
							func_21(iLocal_22, 8);
							...
							func_41(&Global_1896674, iLocal_22);
							func_42(iLocal_22);
							func_21(iLocal_22, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_22 /*36*/].f_11);
							if (Global_1887339[iLocal_22 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_22 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_22 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_22 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_60(Global_1940258, 32768)) || func_60(Global_1940258, 16777216))
	{
		return;
	}
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_84(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_82(iParam0) || func_83(iParam0)) || func_86(Global_1896620))
			{
				func_87(Global_1896620, 0);
			}
			Global_1896620++;
			iVar2++;
...
bool func_62()
{
	return func_60(Global_1940258, 8192);
}
...
bool func_64(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_89(iParam0));
}
...
void func_67(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_97(iParam1, 2) || func_98(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_58(iParam0) && func_81(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_104(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_79(int iParam0, bool bParam1)
{
	...
	if (func_84(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_111(Global_1896620.f_1, 16))
			{
				func_112(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_126(Global_1893587.f_162);
	}
...
{
	func_133(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_134(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_110(int iParam0)
{
	...
	if (func_85(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_136(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_137(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_138(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_141(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_117(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_141(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_155(iParam0, 2))
	{
...
{
	func_163(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_175(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_156()
{
	...
	if (!func_158(Global_1051213) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
