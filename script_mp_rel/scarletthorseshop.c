...
void func_67(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_134(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		...
		{
			func_136(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, iParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
int func_101(int iParam0, bool bParam1)
{
	...
	{
		func_174(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_173(iParam0)));
		if (func_45() == -1)
		{
...
void func_127(int iParam0)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_204(iParam0, 2))
	{
