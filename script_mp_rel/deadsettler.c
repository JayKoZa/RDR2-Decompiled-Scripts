		...
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				case 0:
					if (Global_1901929->f_1.f_24 > 0)
					{
						iLocal_34 = (MISC::GET_GAME_TIMER() + Global_1901929->f_1.f_24);
						iLocal_31 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_33));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_33)))
					{
						...
						else
						{
							...
							func_36(iLocal_33, Global_1896662);
							iLocal_31 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_33);
							func_21(iLocal_33, 8);
							...
							func_41(Global_1896662, iLocal_33);
							func_42(iLocal_33);
							func_21(iLocal_33, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_33 /*36*/])->f_11);
							if (((*Global_1887327)[iLocal_33 /*36*/])->f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1887327)[iLocal_33 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (((*Global_1887327)[iLocal_33 /*36*/])->f_13 != 0)
						{
							PED::_0x95423627A9CA598E(((*Global_1887327)[iLocal_33 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_72(&Global_1939178, 32768)) || func_72(&Global_1939178, 16777216))
	{
		return;
	}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_33)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_84(iLocal_33, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
	...
	else if (func_45() == -1)
	{
		func_88(iLocal_33);
		func_89(iLocal_33);
		if (!func_90(iLocal_33, 0))
		{
			return 0;
		}
	}
	else if (!func_91(iLocal_33))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
bool func_62()
{
	return func_72(&Global_1939178, 8192);
}
...
void func_66()
{
	func_105(&(uLocal_13[0]), -2089787434);
	func_105(&(uLocal_13[1]), 1908325491);
	func_105(&(uLocal_13[2]), 254342877);
	func_105(&(uLocal_13[3]), -52800960);
	func_105(&(uLocal_13[4]), -1197356488);
	func_105(&(uLocal_13[5]), -1427362099);
}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_92(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	Global_1938085->f_145 = func_125(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_98(int iParam0, bool bParam1)
{
	...
	if (func_132(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_141(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_141(iParam0)))
	{
...
int func_102(var uParam0, int iParam1, var uParam2, vector3 vParam3, var uParam6)
{
	if (*uParam2)
	{
		return 0;
	...
	*uParam0 = func_144(iParam1, vParam3, uParam6, 0, 0, 0, 1, 1, 0, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam2 = 1;
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_154(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_156(func_155(Global_35));
	}
...
int func_115(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_159(PLAYER::PLAYER_ID()) };
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_160(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_161((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_162((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_96((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_164((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_165((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_166((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_169(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_133(int iParam0, bool bParam1)
{
	...
	func_172(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_141(iParam0));
	func_140(iParam0, 0);
	return 1;
}
...
void func_138(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_169(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_183(iParam0, 2))
	{
...
int func_144(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	int iVar0;
	...
	func_184(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
var func_154(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_192(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_204((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}

void func_184(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_185()
{
	...
	if (!func_187(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_189(vector3 vParam0, int iParam3)
{
	...
	func_210(iParam3, &vVar0, &Var3, &uVar6);
	if (func_211(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
...
bool func_211(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
