...
void __EntryFunction__()
{
	...
	fLocal_24 = 1f;
	iLocal_28 = 20000;
	iLocal_31 = vScriptParam_0.x;
	iLocal_29 = vScriptParam_0.z;
	bLocal_33 = false;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_30)
		{
			...
			switch (iLocal_29)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_32 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_29 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_31));
					Global_1896620 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_31)))
					{
						...
						else
						{
							...
							func_36(iLocal_31, &Global_1896674);
							iLocal_29 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_31);
							func_21(iLocal_31, 8);
							...
							func_41(&Global_1896674, iLocal_31);
							func_42(iLocal_31);
							func_21(iLocal_31, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_31 /*36*/].f_11);
							if (Global_1887339[iLocal_31 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_31 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_31 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_31 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_40(int iParam0)
{
	...
	{
		case 0:
			if ((((STREAMING::HAS_MODEL_LOADED(joaat("A_M_M_UNICORPSE_01")) && PED::_0x5E420FF293EE5472()) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_20)) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_20, true, false)) && !func_62())
			{
				iLocal_21 = 1;
			}
			break;
		...
		case 4:
			...
			break;
		case 5:
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_20) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_20, true, false)) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_20, func_54()))
			{
			...
			break;
		case 6:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_20, false))
			{
				func_70();
				func_71();
				iLocal_21 = 7;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_72(Global_1940258, 32768)) || func_72(Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_31)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_84(iLocal_31, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
...
int func_55(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_95(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_93(iParam0) || func_94(iParam0)) || func_97(Global_1896620))
			{
				func_98(Global_1896620, 0);
			}
			Global_1896620++;
			iVar2++;
...
bool func_62()
{
	return func_72(Global_1940258, 8192);
}
...
void func_69()
{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_20, true, false))
	{
		return;
	}
	iVar0 = 0;
...
bool func_75(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_110(iParam0));
}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_118(iParam1, 2) || func_119(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_60(iParam0) && func_92(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_125(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_90(int iParam0, bool bParam1)
{
	...
	if (func_95(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_132(Global_1896620.f_1, 16))
			{
				func_133(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
int func_102(var uParam0, int iParam1, var uParam2, vector3 vParam3, float fParam6)
{
	...
	*uParam0 = func_144(iParam1, vParam3, fParam6, 0, 0, 0, 1, 1, 0, 0, 1);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam2 = 1;
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_154(Global_1893587.f_162);
	}
...
{
	func_161(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_162(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_96(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_164(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_165(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_166(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_169(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_138(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_177(iParam0) && !bParam1);
	if (!bVar0 && !func_178(iParam0, 65536))
	{
	...
	else if (func_179(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	if (func_179(iParam0, 16384) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_169(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_183(iParam0, 2))
	{
...
{
	func_192(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_204(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_185()
{
	...
	if (!func_187(Global_1051213) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_189(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
