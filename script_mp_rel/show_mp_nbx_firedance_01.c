...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	if (uParam0->f_2 != -1)
	{
		uParam0->f_4 = !Global_1291035.f_3[uParam0->f_2 /*8*/].f_3;
		if (!uParam0->f_4)
		{
	...
	switch (uParam0->f_1352)
	{
		...
		case 10:
			...
			{
				if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false))
				{
					func_20(uParam0, 11);
				}
			}
		...
		case 11:
			...
			{
				if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > func_40())
				{
...
void func_5(var uParam0, var uParam1, var uParam2)
{
	...
	switch ((uParam1[uParam2->f_1 /*18*/])->f_14)
	{
		...
		case 8:
			...
			if ((func_59(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), 1) && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false)) && !func_13((uParam1[uParam2->f_1 /*18*/])->f_1, 128))
			{
...
void func_22(var uParam0, var uParam1)
{
	...
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) && !ANIMSCENE::_IS_ANIM_SCENE_LOADED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), true, false))
	{
...
bool func_24(var uParam0)
{
	...
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)))
	{
		if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), true, false))
		{
			return false;
		}
	}
...
void func_46(int iParam0)
{
	...
	if (Global_1958010.f_7[iParam0 /*31*/].f_7[0] == 0)
	{
		if (func_121() == 81)
		{
			func_122(1015669983);
	...
	while (iVar0 < 4)
	{
		iVar1 = Global_1958010.f_7[iParam0 /*31*/].f_7[iVar0];
		if (iVar1 != 0)
		{
...
void func_56(var uParam0, var uParam1, int iParam2)
{
	...
	switch (*uParam1)
	{
		...
		case 1:
			...
			break;
		case 3:
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_9) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_9, true, false)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
...
bool func_79(int iParam0, char* sParam1, char* sParam2)
{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_METADATA_LOADED(iParam0, true))
	{
		return false;
	}
...
bool func_90(var uParam0, int iParam1, vector3 vParam2)
{
...
bool func_92(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, bool bParam5)
{
...
bool func_93(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool func_94(var uParam0)
{
	...
	if ((NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(uParam0->f_1408[0]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_1408[0])) && STREAMING::HAS_CLIP_SET_LOADED("script_shows@fireperformer@act1_p1"))
	{
		...
		PED::_0x3AE3552E7C207CC5(uParam0->f_1408[0], "NMBS_SCRIPT_SHOWS_FIRE_PERFORMER", 0);
...
void func_117(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374), false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(NETWORK::_NET_TO_ANIM_SCENE(uParam0->f_1374)) > 0.978f)
			{
...
bool func_151(var uParam0, int iParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(iParam1))
	{
		return false;
...
bool func_173(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_186(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_197(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_202(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_231(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_234(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_235())
	{
		return func_234(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_234(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
