		...
		if (MISC::GET_GAME_TIMER() > iLocal_51)
		{
			...
			switch (iLocal_50)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_53 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_50 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_52));
					Global_1896620 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_52)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_52 /*36*/].f_11);
							if (Global_1887339[iLocal_52 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_52 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_52 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_52 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_52)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_52, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
bool func_68(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_101(iParam0));
}
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_132(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
		if (func_45() == -1)
		{
			if (func_124(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_133(iParam0));
				func_134(iParam0, 2048);
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_133(iParam0));
		}
		return 0;
	}
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_133(iParam0)))
	{
		func_134(iParam0, 128);
		return 1;
	}
	func_132(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_131(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_133(iParam0));
	if (func_124(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_133(iParam0));
		func_134(iParam0, 2048);
...
int func_106(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_157(PLAYER::PLAYER_ID()) };
...
{
	func_163(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_164(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_123(int iParam0)
{
	...
	if (func_89(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_166(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_167(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_168(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_171(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_125(int iParam0, bool bParam1)
{
	...
	func_174(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_133(iParam0));
	func_132(iParam0, 0);
	return 1;
}
...
void func_130(int iParam0, bool bParam1)
{
	...
	else if (func_181(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_171(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_185(iParam0, 2))
	{
...
bool func_136(int iParam0, int iParam1)
{
	...
	{
		return func_186(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_147(vector3 vParam0, var uParam3, int iParam4)
{
	...
	uVar0 = Global_1071686.f_23887.f_366[func_188(vParam0) /*272*/];
	iVar1 = func_137(uVar0);
	if (iVar1 <= 0)
	{
		return false;
...
{
	func_199(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_94(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
