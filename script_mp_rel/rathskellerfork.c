...
void func_30(int iParam0)
{
	...
	func_58(777, iLocal_15, 1);
	func_58(778, iLocal_15, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(iLocal_15, 2, 1);
	VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_59(778));
}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
	...
	else if (func_45() == -1)
	{
		func_80(iLocal_28);
		func_81(iLocal_28);
		if (!func_82(iLocal_28, 0))
		{
			return 0;
		}
	}
	else if (!func_83(iLocal_28))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938085->f_145 = func_109(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_90(int iParam0, bool bParam1)
{
	...
	if (func_116(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_59(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_59(iParam0)))
	{
...
bool func_91(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_59(iParam0));
}
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_133(func_132(Global_35));
	}
...
{
	func_138((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_139((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_88((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_141((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_142((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_143((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_146(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_117(int iParam0, bool bParam1)
{
	...
	func_149(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_59(iParam0));
	func_124(iParam0, 0);
	return 1;
}
...
void func_122(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_146(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_160(iParam0, 2))
	{
...
{
	func_168(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
