	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_26)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_76(iLocal_26, 0), 1);
					break;
			}
		}
		if (func_10(func_69()))
...
void func_115(int iParam0)
{
	...
	if (func_88(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_141(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
