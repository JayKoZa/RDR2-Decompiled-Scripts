	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_24)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_24, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
void func_62(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_97(iParam0, 0, 0);
	if (func_98(iParam0))
	{
		...
		if (bParam3)
		{
			func_99(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_99(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_98(iParam0))
	{
...
{
	func_153(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_154(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_125(int iParam0)
{
	...
	if (func_89(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_156(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_157(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_158(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_161(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_132(int iParam0, bool bParam1)
{
	...
	else if (func_171(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_161(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_175(iParam0, 2))
	{
...
{
	func_185(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_196(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
