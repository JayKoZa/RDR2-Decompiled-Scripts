...
void func_41()
{
	...
	iVar0 = (Global_1186267->f_231.f_1066[Local_90.f_12 /*17*/])->f_5;
	...
	Local_13.f_6 = func_73(GANG::_0x4BE6C13A45CCA8EC(GANG::_0x901E0DC25080C8B9(iVar0)));
	func_90(256);
...
int func_111(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_144(&(((*Global_1128435)[iVar1 /*83*/])->f_70.f_1), 1);
	}
	else
	{
		func_180(&(((*Global_1128435)[iVar1 /*83*/])->f_70.f_1), 1);
	}
	return 1;
}
...
void func_123()
{
	...
	ENTITY::_0x18FF3110CF47115D(func_177(1), 9, 0);
}
...
void func_183(struct<2> Param0)
{
	...
	{
		STATS::_0x99230691875FC218(func_199(Param0), func_201(Param0), Global_35);
	}
}
...
void func_193()
{
	...
	iVar0 = func_177(0);
	if (((ENTITY::IS_ENTITY_DEAD(iVar0) && !PED::GET_PED_CONFIG_FLAG(iVar0, 11, true)) && func_219(iVar0, Global_34)) && !func_220(4))
	{
		func_221(805, 0);
		func_222(-1399051227, PLAYER::GET_PLAYER_INDEX());
		func_217(4);
	}
	if (func_223(Global_34) == func_224(iVar0) && !func_220(8))
	{
		func_225();
...
void func_194()
{
	...
	{
		if (BUILTIN::VDIST(Global_35, ENTITY::GET_ENTITY_COORDS(iVar2, false, false)) < 20f && !func_97(32, 255))
		{
			func_229();
			func_230();
		}
...
int func_216(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1939178->f_6 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1939178->f_20 && func_247(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		if (Global_1939178->f_19)
		{
			if (func_248(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_249(Global_34, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_243(iParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_250(Global_34, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_243(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_251(Global_34, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_243(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_251(Global_34, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_243(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1939178->f_24 || Global_1939178->f_25)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_255(iParam0, Global_1939178->f_35, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_256(uParam2, iParam0)) && func_257(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_243(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_255(iParam0, Global_1939178->f_35, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_256(uParam2, iParam0)) && func_257(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_243(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (Global_1939178->f_34 == 0)
			{
				...
				{
					if (func_258(iParam0, Global_1939178->f_35))
					{
						func_259();
						*uParam3 = 2;
						func_243(iParam0, uParam2, *uParam3);
			...
			if (Global_1939178->f_36 != 0)
			{
				if (func_262())
				{
					if (func_258(iParam0, Global_1939178->f_36))
					{
						func_259();
						*uParam3 = 2;
						func_243(iParam0, uParam2, *uParam3);
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_34) && (!func_290(1, 1) || *uParam0 & 8192 != 0))
				{
...
int func_249(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_250(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_252(int iParam0, var uParam1)
{
	...
	{
		if (!func_293(iParam0, uParam1, &(Global_1939178->f_28[iVar0])) || iParam0 == &Global_1939178->f_28[iVar0])
		{
		}
		else
		{
			bVar13 = func_310(&(Global_1939178->f_28[iVar0]));
			fVar1 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(&(Global_1939178->f_28[iVar0]), false, false), vVar9);
			if (func_311(&(Global_1939178->f_28[iVar0])))
			{
				if (fVar1 < 35f)
				{
...
int func_262()
{
	...
	if ((func_261() - Global_1939178->f_37) >= 10000)
	{
		return 0;
	}
	return 1;
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_34, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, iVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_34, 17))
				{
					...
					{
						if (func_320(iVar4, Global_35, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_279(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_342(iParam0, 262144) || !Global_1904613->f_8198)
		{
			return 0;
		}
	}
...
int func_285(struct<2> Param0, var uParam2)
{
	if (!func_36(Param0))
	{
		return 0;
...
void func_288(int iParam0)
{
	...
	{
		case 0:
			func_349(&(Global_1939178->f_28), &(Global_1939178->f_33));
...
int func_316(int iParam0, int iParam1)
{
	...
	if (!WEAPON::_IS_WEAPON_LASSO(func_360(iParam0, 1, 0, 0)) && !func_360(iParam0, 1, 0, 0) == 1151374672)
	{
		return 0;
	}
...
int func_325(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (bVar0)
	{
		if (func_318(iParam0, Global_1939178->f_34, 0, 1) < 2.5f)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_34, -1f, -1f, -1f, -1f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_34, 17))
			{
				...
				{
					if (func_320(iVar1, Global_35, 1) < 5f)
					{
						return 1;
					}
				}
