	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_90(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_102(iVar7) && !Global_26386) && iVar7 != iVar0) && !func_67(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_34, iVar7);
				}
				if (func_102(iVar7) && func_67(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1))
				{
...
void func_85(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_34, iVar0, 0, 0) && func_126(iParam0, 0, 0, 0) == 0))
		{
			if (func_47() == -1)
			{
				func_48(iVar0);
...
void func_123(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_134(int iParam0)
{
	...
	if (!func_201(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
var func_147(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
int func_150(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar0 = (iVar0 + func_207(INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iParam0), iParam1));
	}
	if (bParam3)
	{
...
int func_152(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	struct<37> Var0;
...
int func_212(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_103(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
...
struct<4> func_247(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_249(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_251(uParam0, iParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
