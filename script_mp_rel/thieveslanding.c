...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 5.574f, 3.58f, 2.824f, "ThievesLanding - m_volFence");
	iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1402.731f, -2317.543f, 43.425f, 0f, 0f, 3.94f, 3.27f, 2.497f, 2.824f, "ThievesLanding - m_volFencePrompt");
...
void func_29(int iParam0)
{
	...
	{
		func_59(4, iLocal_19, iParam0, iLocal_20, 0, 44, 0, 0, -1082130432 /* Float: -1f */, 0);
		func_60(4, 0);
	}
}
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_18 = func_97(iParam2, iParam0);
	...
	Global_1051439.f_72[iParam0 /*75*/].f_63 = func_98(Global_1051439.f_72[iParam0 /*75*/].f_18);
...
void func_63()
{
	if (!Local_21.f_1)
	{
		...
		{
			Local_21.f_3 = ENTITY::_0x66B2B83B94B22458(joaat("A_WATER_LMR_L_INSIDE_SHIP"));
			if (ENTITY::DOES_ENTITY_EXIST(Local_21.f_3))
			{
				ENTITY::SET_ENTITY_VISIBLE(Local_21.f_3, false);
				Local_21.f_1 = 1;
			}
		}
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(Local_21))
	{
		func_53(&Local_21, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	}
	if (Local_21.f_2)
	{
		if (!func_109(PLAYER::PLAYER_PED_ID(), Local_21, 0, 1))
		{
	...
	else if (func_109(PLAYER::PLAYER_PED_ID(), Local_21, 0, 1))
	{
		WATER::_DISABLE_WATER_COLLISION();
		Local_21.f_2 = 1;
	}
...
void func_96(int iParam0, bool bParam1)
{
	...
	else if (func_154(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
...
void func_107(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_6 = func_166(uParam1, vParam2, uParam5, 0, 0, 0);
...
{
	func_177(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_178(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_89(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_180(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_181(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_182(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
{
	return func_201(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_164(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_203(12, func_202(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
{
	func_212(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_190(int iParam0, int iParam1)
{
	...
	{
		return func_222(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
