...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1649.094f, -2650.483f, 63.499f, 0f, 0f, 30f, 14.456f, 10.148f, 8.8f, "HEN TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1646.9f, -2649.893f, 63.499f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "HEN TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
