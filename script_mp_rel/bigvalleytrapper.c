...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Big Valley Trapper - m_volTrapper");
	VOLUME::_0x6E0D3C3F828DA773(iLocal_19, VOLUME::_CREATE_VOLUME_BOX(-2844.917f, 138.528f, 183f, 0f, 0f, 20.486f, 7.713f, 16.738f, 5.708f));
	VOLUME::_0x6E0D3C3F828DA773(iLocal_19, VOLUME::_CREATE_VOLUME_BOX(-2837.196f, 136.839f, 183f, 0f, 0f, 20.486f, 5.852f, 7.961f, 5.708f));
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2840.46f, 137.2f, 184.28f, 0f, 0f, 81.946f, 2.478f, 2.442f, 3.076f, "Big Valley Trapper - m_volTrapperPrompt");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2844.08f, 136.749f, 184.743f, 0f, 0f, 19.872f, 2.5f, 3f, 3.076f, "Big Valley Trapper - m_volTrapperOfflimits");
	return true;
}
