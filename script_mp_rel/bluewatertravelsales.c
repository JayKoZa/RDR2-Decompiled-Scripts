...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2522.768f, -155.069f, 44.02f, 0f, 0f, 160f, 14.456f, 10.148f, 8.8f, "BLU TravellingSalesman - m_volTravellingSalesman");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2526.436f, -155.022f, 44.02f, 0f, 0f, 160f, 3.7f, 3.7f, 4.2f, "BLU TravellingSalesman - m_volTravellingSalesmanPrompt");
	return true;
}
