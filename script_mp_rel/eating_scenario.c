...
void func_14(int iParam0)
{
	...
	if (func_27(iParam0) == joaat("CONSUMABLE"))
	{
		...
		while (iVar29 < Var0)
		{
			...
			{
				fVar33 = func_32(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_12(0, fVar33, 1, 1, bVar37);
				bVar39 = true;
			}
			else if (1857353317 == Var22.f_1)
			{
				fVar34 = func_32(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_12(2, fVar34, 1, 1, bVar37);
				bVar38 = true;
			}
			else if (1681823811 == Var22.f_1)
			{
				fVar35 = func_32(BUILTIN::TO_FLOAT(Var22.f_2), Var22.f_5);
				func_12(1, fVar35, 1, 1, bVar37);
			}
			else if (2062242710 == Var22.f_1)
			{
				fVar36 = func_33(BUILTIN::TO_FLOAT(Var22.f_3), Var22.f_4);
...
bool func_46(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_81(iParam1), BUILTIN::CEIL(fParam2));
	return true;
}
...
void func_48(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_83(iParam1), fParam2, -1);
	}
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_100(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_95(int iParam0)
{
	...
	fVar0 = (func_110(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_113(2)));
}
...
int func_112(int iParam0)
{
	...
	iVar3 = func_116(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_117(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_118(iVar1, iParam0, iVar4);
						func_119(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_119(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_123(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
int func_118(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_127(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_128(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_129(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_130(vVar1))
		{
			if (func_131(vVar1.x, vVar1.y, vVar1.z))
			{
				func_132(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_133(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_126(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_116(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_138(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_139(iVar3);
		}
		iVar4++;
	}
...
bool func_131(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_148(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_150(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
void func_139(int iParam0)
{
	...
	iVar0 = func_136(iParam0, 1);
	if (!func_158(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_159(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_160(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_142(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_163(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_163(iParam0));
			break;
...
int func_145(int iParam0)
{
	...
	{
		iVar64 = func_120(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_168(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_169(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
void func_149(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("SLIPPERY_BASTARD_VFX"):
			...
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_171(iParam0, 0));
			func_172(iVar2, 0, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_171(iParam0, 1));
			func_172(iVar2, 1, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_171(iParam0, 2));
			func_172(iVar2, 2, 1, iVar3, 0);
			iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(iVar0, func_171(iParam0, 3));
			func_172(iVar2, 2, 1, iVar3, 0);
			break;
		case joaat("MOMENT_TO_RECUPERATE_VFX"):
			iVar2 = func_164(iParam0);
...
void func_161()
{
	...
	{
		if (!func_177(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_168(int iParam0, int iParam1)
{
	...
	if (func_127(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_144(iVar2, 1) /*3*/];
		Var4 = { func_169(iVar3) };
