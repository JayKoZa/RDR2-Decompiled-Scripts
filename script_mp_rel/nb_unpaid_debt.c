...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar17 = 255;
	MISC::_COPY_MEMORY(&Local_501, &uParam0, 5);
	iVar19 = func_30(&bVar18, Local_501.f_1, Local_501.f_2);
	if (bVar18 || iVar19 == -1)
	{
		return;
	}
	Local_501.f_12 = iVar19;
	iVar17 = (Global_1186267->f_231.f_1066[iVar19 /*17*/])->f_5;
	func_31(&Var0, Local_501.f_1, Local_501.f_2, Local_501.f_3, iVar17);
	Local_501.f_9 = { func_32(Var0.f_5, 8) };
	Local_501.f_14 = Var0.f_5;
	Local_501.f_15 = { Var0.f_11 };
	func_33();
	func_34();
}
...
void func_41()
{
	...
	iVar0 = (Global_1186267->f_231.f_1066[Local_501.f_12 /*17*/])->f_5;
...
void func_51()
{
	...
	if (!func_96(1, 255))
	{
		...
		else
		{
			...
			if (!func_93(Local_501.f_11))
			{
				func_94(&(Local_501.f_11));
			}
			if (func_95(Local_501.f_11) >= iVar1)
			{
				func_112(6);
			}
		}
...
void func_52()
{
	...
	if (!func_96(2, 255))
	{
		...
		else
		{
			...
			if (func_119(Local_501.f_11) >= iVar0)
			{
				func_112(6);
			}
		}
...
void func_58()
{
	...
	func_134(Local_501.f_9, iVar0, 0);
	func_111(4);
	if (bVar1)
	{
		func_135(Local_501.f_1, Local_501.f_2);
	}
}

bool func_59(int iParam0)
{
	return func_136(Local_501.f_7, iParam0);
}
...
bool func_96(int iParam0, int iParam1)
{
	...
	return func_136(&(Local_20[iParam1 /*15*/]), iParam0);
}
...
void func_109(int iParam0)
{
	if (func_59(iParam0))
	{
		func_162(&(Local_501.f_7), iParam0);
	}
}
...
void func_111(int iParam0)
{
	if (!func_59(iParam0))
	{
		func_155(&(Local_501.f_7), iParam0);
	}
}
...
void func_115(int iParam0)
{
	...
	{
		func_155(Local_20[NETWORK::PARTICIPANT_ID_TO_INT() /*15*/], iParam0);
	}
}
...
void func_130()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			Local_501.f_5 = (Local_501.f_5 || Local_20[iVar0 /*15*/]) // PointerArith;
			Local_501.f_6 = (Local_501.f_6 && Local_20[iVar0 /*15*/]) // PointerArith;
		}
		iVar0++;
	}
}
...
{
	return func_136(Local_501.f_5, iParam0);
}

bool func_161(int iParam0)
{
	return func_136(Local_501.f_6, iParam0);
}
...
{
	if (func_136(&(Local_20[NETWORK::PARTICIPANT_ID_TO_INT() /*15*/]), iParam0))
	{
		func_162(Local_20[NETWORK::PARTICIPANT_ID_TO_INT() /*15*/], iParam0);
	}
}
