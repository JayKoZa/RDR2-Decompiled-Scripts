...
{
	if (func_128(Global_34, uParam0->f_9, 1, 0))
	{
	...
	if (func_128(Global_34, uParam0->f_10, 1, 0))
	{
...
bool func_91(var uParam0, int iParam1, vector3 vParam2)
{
...
bool func_93(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, bool bParam5)
{
...
bool func_94(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
bool func_153(var uParam0, int iParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(iParam1))
	{
		return false;
...
bool func_154(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
bool func_174(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
bool func_187(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_189(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
bool func_198(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_200(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
bool func_203(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_205(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
bool func_232(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_235(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_236())
	{
		return func_235(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_235(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
