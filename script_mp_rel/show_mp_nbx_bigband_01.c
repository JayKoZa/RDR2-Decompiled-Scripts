...
void func_126(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_158(iParam0))
	{
		...
		if (bParam3)
		{
			func_165(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_174(var uParam0, var uParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_232(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_235(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_236())
	{
		return func_235(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_235(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
