...
bool func_13()
{
	iLocal_16 = Global_1887339[62 /*36*/].f_5;
...
bool func_67(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_92(iParam0));
}
...
{
	func_136(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_137(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_113(int iParam0)
{
	...
	if (func_87(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_139(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_140(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_141(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_144(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_120(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_144(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_158(iParam0, 2))
	{
...
{
	func_166(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
