		...
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_34 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_31 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_33)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_33 /*36*/].f_11);
							if (Global_1887339[iLocal_33 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_33 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_33 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_33 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_60()
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (INTERIOR::IS_INTERIOR_READY(iLocal_16[iVar0]) && (INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34) != iLocal_16[iVar0] || CAM::IS_SCREEN_FADED_OUT()))
			{
...
void func_114(int iParam0)
{
	...
	if (func_88(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_140(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
