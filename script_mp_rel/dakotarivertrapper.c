...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1007.375f, -542.224f, 98f, 0f, 0f, 8.306f, 13.464f, 12.135f, 4f, "Dakota River Trapper - m_volTrapper");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1007.35f, -544.42f, 98.65f, 0f, 0f, 13.277f, 3f, 3f, 4.419f, "Dakota River Trapper - m_volTrapperPrompt");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1008.018f, -541.155f, 100.546f, 0f, 0f, 13.277f, 2.5f, 3f, 4.419f, "Dakota River Trapper - m_volTrapperOfflimits");
	return true;
}
