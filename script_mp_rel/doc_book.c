...
void func_29(var uParam0, var uParam1)
{
	...
	switch (TASK::_0x804425C4BBD00883(Global_34))
	{
		case 2129073771:
			...
			TXD::_REQUEST_STREAMED_TXD(iLocal_27, 0);
			break;
...
int func_93(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_156(bParam0));
}
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_165(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_149(iVar7) && !Global_26386) && iVar7 != iVar0) && !func_41(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1)) && bParam4)
				{
...
void func_160(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_34, iVar0, 0, 0) && func_82(iParam0, 0, 0, 0) == 0))
		{
			if (func_3() == -1)
			{
				func_92(iVar0);
