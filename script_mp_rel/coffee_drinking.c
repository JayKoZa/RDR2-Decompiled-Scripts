	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE())
	{
		...
		switch (Var0)
		{
			...
			case 1:
				...
				{
					PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "BLOCK_COFFEE_DISCARD_PROMPT", true, 1);
					PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "SHOW_COFFEE_KNEEL_DISCARD_PROMPT", true, 1);
				}
				...
				break;
			case 2:
				PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "BLOCK_COFFEE_DRINK_PROMPT", true, 1);
				PED::_SET_PED_BLACKBOARD_BOOL(Global_34, "BLOCK_COFFEE_DISCARD_PROMPT", true, 1);
				...
				else
				{
					if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_34, 0) && ((PED::_0x569F1E1237508DEB(Global_34) == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_ARTHUR") || PED::_0x569F1E1237508DEB(Global_34) == joaat("WORLD_PLAYER_DYNAMIC_KNEEL_MP_FEMALE_A")) || PED::_0x569F1E1237508DEB(Global_34) == joaat("WORLD_PLAYER_DYNAMIC_CAMP_FIRE_KNEEL_ARTHUR")))
					{
						TASK::_0xB35370D5353995CB(Global_34, joaat("DRINK_COFFEE_PUT_AWAY_KNEELING"), 1048576000 /* Float: 0.25f */);
					}
					else
					{
						TASK::_0xB35370D5353995CB(Global_34, joaat("DRINK_COFFEE_PUT_AWAY"), 1048576000 /* Float: 0.25f */);
					}
					func_5(&Var0, 3);
...
{
	func_13((Global_1940085.f_9 + fParam0), bParam1);
}
...
void func_13(float fParam0, bool bParam1)
{
	if (PED::IS_PED_ON_MOUNT(Global_34) || PED::IS_PED_IN_ANY_VEHICLE(Global_34, false))
	{
		if (fParam0 >= func_28())
		{
			Global_1940085.f_9 = (func_28() - 0.01f);
			return;
		}
	}
	if (fParam0 < 0f)
...
{
	if (iParam2 || func_14(iParam0, -537818634))
	{
...
bool func_40()
{
	...
	return func_66(Global_1956200.f_1431.f_107, 0);
}
...
void func_41(float fParam0, int iParam1)
{
	...
	iVar1 = func_68(fVar0);
	fVar0 = (fVar0 + fParam0);
	fVar0 = func_69(fVar0, 0f, 100f);
	iVar2 = func_68(fVar0);
	if (iVar1 != iVar2)
	{
		Global_1956200.f_1431.f_107 = func_55();
		func_70(&(Global_1956200.f_1431.f_107), 0, 0, 1, 0, 0, 0, 0);
	}
	func_71(13, fVar0, 2);
...
void func_51(int iParam0, int iParam1)
{
	...
	if (func_50() == 0)
	{
		iVar0 = func_92(iParam0, -949239683);
...
bool func_54(int iParam0)
{
	...
	fVar0 = (func_95(iParam0) - PLAYER::_0xDF66A37936D5F3D9(iParam0));
	return fVar0 <= 1f;
}
...
bool func_73(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1900736.f_67 && !func_115(iParam0, 1)) || func_116(32768))
	{
		if (!func_115(iParam0, 262144) || !Global_1904651.f_8686)
		{
			return false;
		}
	}
...
bool func_86(int iParam0)
{
	...
	return Global_1146212.f_35859.f_919[func_118(iParam0, 1) /*12*/] == -1;
}
...
int func_87(int iParam0)
{
	...
	iVar0 = func_118(iParam0, 1);
	if (!func_83(Global_1146212.f_35859.f_919[iVar0 /*12*/]))
	{
		return 1;
	}
	iVar3 = func_119(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	iVar4 = 0;
		...
		switch (func_120(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1146212.f_35859.f_11700)
				{
					...
					{
						func_121(iVar1, iParam0, iVar4);
						func_122(&(Global_1146212.f_35859.f_9503[iVar5 /*3*/]));
						...
						func_122(&(Global_1146212.f_35859.f_9503[Global_1146212.f_35859.f_11700 /*3*/]));
					}
					else
					{
						iVar5++;
			...
			func_126(&(Global_1146212.f_35859.f_919[iVar0 /*12*/]));
			return 1;
		}
...
{
	return func_135(&(Global_1956200.f_1565), iParam0, 1);
}
...
{
	return (PLAYER::_0x592F58BC4D2A2CF3(iParam0, 0) - IntToFloat(func_136(2)));
}
...
int func_121(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_149(Global_1146212.f_35859.f_3116[iVar0 /*31*/]) && func_150(iParam0, Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar1 = { func_151(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
		if (func_152(vVar1))
		{
			if (func_153(vVar1.x, vVar1.y, vVar1.z))
			{
				func_154(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_155(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4);
			}
		}
		else
		{
...
int func_128(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_149(Global_1146212.f_35859.f_3116[iVar0 /*31*/]);
	if (bVar1 && func_157(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4))
	{
		vVar2 = { func_158(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4) };
	...
	if (func_153(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_154(Global_1146212.f_35859.f_3116[iVar0 /*31*/].f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
bool func_148(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_119(Global_1146212.f_35859.f_919[iVar0 /*12*/], 1);
	...
	while (iVar4 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_16)
	{
		...
		else
		{
			...
			Global_1146212.f_2169[iVar5 /*205*/].f_201 = (Global_1146212.f_2169[iVar5 /*205*/].f_201 - func_161(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_6[iVar4 /*3*/])));
			func_162(iVar3);
		}
		iVar4++;
	}
...
bool func_153(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_28)
	{
		...
		else if (!func_170(&(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_17[iVar7 /*2*/])))
		{
		}
		else
		{
	...
	func_172(Global_1146212.f_35859.f_3116[iVar1 /*31*/].f_2);
	return true;
}
...
float func_161(var uParam0)
{
	...
	if (uParam0->f_2 != 0)
	{
		fVar0 = func_174(794259616, uParam0->f_2, uParam0->f_1, "");
		return fVar0;
	}
	return uParam0->f_1;
}
...
void func_162(int iParam0)
{
	...
	iVar0 = func_159(iParam0, 1);
	if (!func_175(Global_1146212.f_2169[iVar0 /*205*/]))
	{
		return;
	}
	...
	if (!func_176(Global_1146212.f_2169[iVar0 /*205*/].f_203))
	{
		return;
	}
	iVar1 = func_177(Global_1146212.f_2169[iVar0 /*205*/].f_203, 1);
...
void func_165(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("TRAIL_EFFECT"):
			...
			GRAPHICS::_0xC5CB91D65852ED7E(func_180(iParam0));
			break;
		case joaat("DRAIN_EFFECT"):
			GRAPHICS::_0xC5CB91D65852ED7E(func_180(iParam0));
			break;
...
int func_168(int iParam0)
{
	...
	{
		iVar64 = func_123(Global_1146212.f_35859.f_9503[iVar65 /*3*/], 1);
		...
		else if (!func_184(Global_1146212.f_35859.f_9503[iVar65 /*3*/], Global_1146212.f_35859.f_9503[iVar65 /*3*/].f_1))
		{
		}
		else
		{
			Var1 = { func_185(Global_1146212.f_35859.f_9503[iVar65 /*3*/]) };
...
bool func_170(var uParam0)
{
	...
	if (uParam0->f_1 != 0)
	{
		bVar0 = func_186(794259616, uParam0->f_1, 1, "");
		return bVar0;
	}
	return true;
}
...
void func_178()
{
	...
	{
		if (!func_193(Global_1298536[Global_1296859 /*87*/].f_86, 1))
		{
			bVar1 = true;
		}
	}
...
bool func_184(int iParam0, int iParam1)
{
	...
	if (func_149(Global_1146212.f_35859.f_3116[iVar0 /*31*/]))
	{
		iVar3 = Global_1146212.f_35859.f_9286[func_167(iVar2, 1) /*3*/];
		Var4 = { func_185(iVar3) };
	...
	switch (Global_1146212.f_35859.f_3116[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != Global_1296859 && !func_196(Global_1296859.f_154[iVar1]))
			{
				return false;
			}
...
bool func_195()
{
	...
	if (func_201(Global_524288.f_40400))
	{
		return true;
	}
	return false;
