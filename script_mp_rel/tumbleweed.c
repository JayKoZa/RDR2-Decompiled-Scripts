		...
		if (MISC::GET_GAME_TIMER() > iLocal_47)
		{
			...
			switch (iLocal_46)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_49 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_46 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_48));
					Global_1896620 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_48)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_48 /*36*/].f_11);
							if (Global_1887339[iLocal_48 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_48 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_48 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_48 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = Global_1887339[121 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 28);
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5507.549f, -2965.196f, -0.228844f, 0f, 0f, 14.50012f, 5.533408f, 8.440951f, 3.311345f, "Tumbleweed - m_volGunsmith");
	iLocal_23 = VOLUME::_CREATE_VOLUME_BOX(-5508.212f, -2964.63f, -0.4536f, 0f, 0f, 15.48608f, 1.15206f, 1.211619f, 2.44214f);
	iLocal_24 = VOLUME::_CREATE_VOLUME_BOX(-5506.212f, -2964.24f, -0.546059f, 0f, 0f, 15.38209f, 1.208323f, 1.559606f, 2.24757f);
	iLocal_22 = VOLUME::_CREATE_VOLUME_BOX(-5508.861f, -2960.149f, -0.730614f, 0f, 0f, 14.06083f, 5.590748f, 1.871594f, 1.963433f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_21, 10108);
	iLocal_25 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Armadillo - m_volGeneral Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_25, -5486.925f, -2936.908f, -0.632f, 0f, 0f, 37.506f, 12.127f, 6.213f, 4.544f);
	VOLUME::_0x39816F6F94F385AD(iLocal_25, -5479.758f, -2933.356f, -0.464321f, 0f, 0f, 37.59521f, 2.825781f, 2.131215f, 1.882721f);
	iLocal_26 = VOLUME::_CREATE_VOLUME_BOX(-5487.416f, -2939.017f, -0.416119f, 0f, 0f, 36.36512f, 1.251111f, 3.269273f, 2.026726f);
	iLocal_28 = VOLUME::_CREATE_VOLUME_BOX(-5485.543f, -2937.639f, -0.416119f, 0f, 0f, 36.36512f, 2.087f, 2.06f, 2.027f);
	iLocal_27 = VOLUME::_CREATE_VOLUME_BOX(-5492.82f, -2941.371f, -0.730614f, 0f, 0f, 127.4349f, 6.522694f, 1.871594f, 1.963433f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_25, 10107);
	iLocal_20 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5514.454f, -2910.941f, 0.196263f, 0f, 0f, 28.00368f, 12.9595f, 18.61485f, 9.427321f, "Tumbleweed - m_volBartender");
	iLocal_33 = VOLUME::_CREATE_VOLUME_BOX(-5507.816f, -2947.645f, -1.491075f, 0f, 0f, -17.45158f, 8.984022f, 7.283852f, 4.458558f);
	iLocal_34 = VOLUME::_CREATE_VOLUME_BOX(-5507.615f, -2947.708f, -1.491075f, 0f, 0f, -17.45158f, 1.750185f, 2.572302f, 2.75889f);
	iLocal_35 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5539.533f, -3039.824f, 2.031336f, 0f, 0f, 3.990272f, 17.4913f, 32.03522f, 11.8878f, "Tumbleweed - m_volHorseShopPen");
	iLocal_32 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5602.326f, -2982.253f, 2.901444f, 0f, 0f, 141.0062f, 3.082703f, 10.21471f, 4.224741f, "Tumbleweed - m_volHomeStable");
	if (func_45() == -1)
	{
		iLocal_30 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5519.228f, -3044.427f, -1.508f, 0f, 0f, 0f, 14.36317f, 12.10584f, 4.473f, "Tumbleweed Horse Shop - m_volHorseShop");
		iLocal_31 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5510.71f, -3044.394f, -1.897282f, 0f, 0f, 0f, 4.170004f, 4.757886f, 3.852559f, "Tumbleweed Horse Shop - m_volHorseShopOutsideDoor");
		func_53(9, iLocal_31);
		VOLUME::_0xB469CFD9E065EB99(iLocal_30, 10109);
	}
	else
	{
		iLocal_30 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5519.228f, -3044.427f, -1.40419f, 0f, 0f, 0f, 14.36317f, 12.10584f, 4.472662f, "Tumbleweed Horse Shop - m_volHorseShop");
		VOLUME::_0xB469CFD9E065EB99(iLocal_30, 10109);
	}
	iLocal_36 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Tumbleweed - JAIL");
	VOLUME::_0x39816F6F94F385AD(iLocal_36, -5529.713f, -2927.539f, -1.328089f, 0f, 0f, 24.83998f, 6.747131f, 6.870256f, 6.016601f);
	VOLUME::_0x39816F6F94F385AD(iLocal_36, -5534.146f, -2922.72f, -1.771596f, 0f, 0f, 24.83998f, 10.62026f, 7.054735f, 6.016601f);
...
{
	func_60(3, iLocal_25, iParam0, iLocal_26, iLocal_28, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	...
	func_64();
	func_65(105);
	func_60(6, iLocal_21, iParam0, iLocal_23, iLocal_24, 20, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_61(6, 1880285656, 0, 0, 0);
	func_63(6, 0);
	ENTITY::CREATE_MODEL_HIDE(-5479.709f, -2932.554f, -1.3902f, 1f, joaat("P_BLOUSEGROUND01X"), false);
	func_60(10, iLocal_33, iParam0, iLocal_34, 0, 460, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_62(10, 536870912);
	func_63(10, 0);
	func_60(9, iLocal_30, iParam0, 0, 0, 2, 1, 0, -1082130432 /* Float: -1f */, 0);
	func_62(9, 536870912);
	func_62(9, 16384);
	func_62(9, 32768);
	func_62(9, 1);
	...
	if (!func_66() && func_67())
	{
		func_61(9, joaat("TUM_BARN_INT_DOOR_01"), 0, 0, 0);
		func_61(9, joaat("TUM_BARN_INT_DOOR_02"), 0, 0, 0);
	}
	else
	{
		func_61(9, joaat("TUM_BARN_INT_DOOR_01"), 1f, 1, 1);
		func_61(9, joaat("TUM_BARN_INT_DOOR_02"), -1f, 1, 1);
	}
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_48)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_88(iLocal_48, 0), 1);
					break;
			}
		}
		if (func_10(func_81()))
...
void func_59(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1940018.f_5[iParam0 /*11*/].f_6 = func_105(iParam5, iParam0);
}
...
void func_61(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	if (func_117(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0]))
	{
		...
		{
			func_119(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
{
	func_120(&(Global_1051439.f_72[iParam0 /*75*/].f_49), iParam1);
}
...
int func_63(int iParam0, bool bParam1)
{
	...
	if ((func_121(iParam0, 16384) || func_121(iParam0, 32768)) || func_103(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
...
void func_65(int iParam0)
{
	...
	if (func_123(Global_1051439.f_3634[iVar0 /*19*/], &uVar1, &uVar2, &vVar3))
	{
		Global_1051439.f_3634[iVar0 /*19*/].f_6 = func_130(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	iVar6 = func_131(Global_1051439.f_3634[iVar0 /*19*/]);
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		...
		{
			Global_1051439.f_3634[iVar0 /*19*/].f_13 = func_130(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	Global_1051439.f_3634[iVar0 /*19*/].f_5 = func_111(Global_1051439.f_3634[iVar0 /*19*/]);
	if (!func_132(30, 4))
	{
		func_113(30, 4);
		func_114(30);
...
{
	func_169(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_170(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_109(int iParam0, bool bParam1)
{
	...
	else if (func_132(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_186(iParam0, 2))
	{
...
void func_125(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_6 = func_130(uParam1, vParam2, uParam5, 0, 0, 0);
...
void func_159(int iParam0)
{
	...
	if (func_100(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_208(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_209(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_210(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
...
{
	func_216(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_227(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_188(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_229(12, func_228(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
var func_201(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_217(int iParam0, int iParam1)
{
	...
	{
		return func_246(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
