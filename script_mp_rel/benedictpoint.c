...
bool func_13()
{
	iLocal_19 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-5220.2f, -3472.4f, -20.6f, 0f, 0f, 0f, 100f, 125f, 70f, "m_volBenedictPoint");
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volBenedictPostOffice Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -5226.037f, -3468.296f, -19.99f, 0f, 0f, 0f, 6.727f, 3.065f, 3.5f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -5227.384f, -3470.978f, -19.99f, 0f, 0f, 0f, 2.011f, 2.184f, 3.5f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -5230.431f, -3468.341f, -20.375f, 0f, 0f, 0f, 2.753f, 2.804f, 4f);
	iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volBenedictPostOfficePrompt Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -5227.361f, -3470.487f, -20.226f, 0f, 0f, 0f, 1.695f, 1.082f, 3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -5229.832f, -3468.299f, -20.656f, 0f, 0f, 0f, 1.109f, 2.187f, 3.106f);
	iLocal_22 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-5226.061f, -3468.279f, -21.52f, 0f, 0f, 0f, 6.85f, 3.25f, 4f, "m_volBenedictPostOfficeOffLimits");
	if (func_45() != -1)
	{
	}
	iLocal_24 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Benedict Point - m_volTrainStation Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_24, -5226.061f, -3471.827f, -21.52f, 0f, 0f, 0f, 7.421f, 10.471f, 4f);
	VOLUME::_0x39816F6F94F385AD(iLocal_24, -5230.431f, -3468.341f, -20.375f, 0f, 0f, 0f, 2.753f, 2.804f, 4f);
	return true;
}
...
void func_29(int iParam0)
{
	if (func_45() != -1)
	{
		func_58(2, iLocal_20, iParam0, iLocal_21, 0, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
		func_59(2, joaat("DOOR_BEN_TRAIN_INT_2"), 0, 0, 0);
		func_59(2, joaat("DOOR_BEN_TRAIN_INT_4"), 0, 0, 0);
		func_60(2, 0);
	}
	else
	{
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_69(Global_1940258, 32768)) || func_69(Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_82(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_75()))
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_63 = func_103(Global_1051439.f_72[iParam0 /*75*/].f_18);
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0] = func_108(iParam1, 0, 0);
	if (func_109(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_110(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0]))
		{
			func_111(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_112(iParam0, 16384) || func_112(iParam0, 32768)) || func_113(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
...
void func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	func_127(Global_1915715.f_3[iParam0 /*447*/].f_9);
	func_128(iParam0, 16);
	func_129(iParam0, 4);
...
{
	Global_1959375.f_129[iParam0 /*3*/] = { vParam1 };
...
bool func_73(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_138(iParam0));
}
...
void func_101(int iParam0, bool bParam1)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_181(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_184(iParam0, 2))
	{
...
void func_111(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_108(iParam0, 0, 0);
	if (func_109(iParam0))
	{
...
{
	return func_197(Global_1915715.f_3[iParam0 /*447*/].f_5, iParam1);
}
...
void func_121(int iParam0)
{
	...
	if (func_94(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_198(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_199(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_200(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_181(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
bool func_122(int iParam0, int iParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915715.f_3[iParam0 /*447*/].f_25))
	{
		...
		func_64(iParam1, Global_1915715.f_3[iParam0 /*447*/].f_25, 1);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1915715.f_3[iParam0 /*447*/].f_28))
	{
		...
		func_64(iParam1, Global_1915715.f_3[iParam0 /*447*/].f_28, 1);
...
{
	func_217(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_218(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
{
	return func_197(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_188(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_235(12, func_234(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
bool func_224(int iParam0, int iParam1)
{
	...
	{
		return func_250(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
