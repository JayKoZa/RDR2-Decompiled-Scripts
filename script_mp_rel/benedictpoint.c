...
void func_59(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_109(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		...
		{
			func_111(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, iParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
int func_96(int iParam0, bool bParam1)
{
	...
	{
		func_165(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_164(iParam0)));
		if (func_45() == -1)
		{
...
bool func_131(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_132(iParam0));
}
