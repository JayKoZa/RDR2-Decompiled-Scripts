...
bool func_13()
{
	iLocal_19 = Global_1887339[116 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 26);
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volGeneralStore Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volArtistOwner Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_20, 10106);
	if (func_45() != -1)
	{
	}
	return true;
...
void func_30(int iParam0)
{
	...
	func_58(721, iLocal_20, 1);
	func_58(722, iLocal_20, 0);
	func_58(723, iLocal_20, 0);
	func_58(724, iLocal_20, 0);
	func_58(719, iLocal_21, 1);
	func_58(720, iLocal_21, 0);
}
...
{
	iParam0 = iParam0;
	func_60(uParam1, iLocal_19, 1);
	func_60(uParam1, iLocal_20, 2);
}
...
bool func_82(int iParam0, bool bParam1)
{
	...
	if (func_87(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_117(Global_1896620.f_1, 16))
			{
				func_118(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
char* func_97(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_132(Global_1893587.f_162);
	}
...
{
	func_139(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_140(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_116(int iParam0)
{
	...
	if (func_88(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_142(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_143(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_144(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_147(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_123(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_155(iParam0) && !bParam1);
	if (!bVar0 && !func_156(iParam0, 65536))
	{
	...
	else if (func_157(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_147(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_161(iParam0, 2))
	{
...
{
	func_169(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_180(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
bool func_162()
{
	...
	if (!func_164(Global_1051213) && Global_1572887.f_7 & 1 != 0)
	{
		return true;
	}
	return false;
...
bool func_166(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
