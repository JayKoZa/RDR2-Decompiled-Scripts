...
bool func_13()
{
	iLocal_16 = Global_1887339[37 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_16, 8);
	iLocal_17 = POPULATION::_CREATE_POPZONE_FROM_VOLUME(iLocal_16);
	POPULATION::SET_POPZONE_POPULATION_SET(iLocal_17, joaat("OFW_ENLISTED_MIX"));
	POPULATION::_0x7E6BC0B94F5928F0(iLocal_17, 19, 19);
	POPULATION::_0x08892122769770D5(iLocal_17, true);
	POPULATION::_0x0F1861101C9A9944(iLocal_17, true);
	return true;
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_60(iParam0) && func_85(iParam0, 16777216)) && !Global_1893587.f_9)
	{
...
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
	if (POPULATION::_IS_POPZONE_VALID(iLocal_17))
	{
		POPULATION::_DELETE_SCRIPT_POPZONE(iLocal_17);
	}
}
...
void func_117(int iParam0)
{
	...
	if (func_89(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_150(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_155(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
void func_124(int iParam0, bool bParam1)
{
	...
	if (!bVar0 && !func_164(iParam0, 65536))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_155(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_169(iParam0, 2))
	{
...
{
	return func_189(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
