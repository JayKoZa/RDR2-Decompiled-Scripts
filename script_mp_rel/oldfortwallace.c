...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938085->f_145 = func_111(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
{
	func_58(0.775f, 0.2f, 0.025f, 0f);
	if (POPULATION::_IS_POPZONE_VALID(iLocal_19))
	{
		POPULATION::_DELETE_SCRIPT_POPZONE(iLocal_19);
	}
}
...
void func_95(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_131(iParam0))
	{
		...
		if (bParam3)
		{
			func_132(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
...
{
	func_147((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_148((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_117(int iParam0)
{
	...
	if (func_89((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_150((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_151((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_152((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_155(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_124(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_155(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_169(iParam0, 2))
	{
...
{
	func_178(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_189((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
