				...
				if ((((((iVar8 == -1136843638 || iVar8 == -732326901) || iVar8 == 786205940) || iVar8 == -1141771998) || iVar8 == 364689687) || iVar8 == -842117252) || iVar8 == -1610298873)
				{
					if (uParam0->f_85 != 0)
					{
						if ((uParam0->f_85 == 1186037675 && ENTITY::HAS_ANIM_EVENT_FIRED(Global_34, -1011038463)) || (uParam0->f_85 != 1186037675 && ENTITY::HAS_ANIM_EVENT_FIRED(Global_34, 2024314131)))
						{
							...
							if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_81))
							{
								...
								{
									uParam0->f_81 = WEAPON::_0x9888652B8BA77F73(func_72(uParam0->f_73, 0), 1, Global_35, 1, 1065353216);
					...
					if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_34, 966057053))
					{
						...
						if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_81))
						{
							...
							{
								uParam0->f_81 = WEAPON::_0x9888652B8BA77F73(joaat("weapon_thrown_throwing_knives"), 1, Global_35, 1, 1065353216);
							}
							else if (iVar8 == -1141771998)
							{
								uParam0->f_81 = WEAPON::_0x9888652B8BA77F73(joaat("weapon_thrown_tomahawk"), 1, Global_35, 1, 1065353216);
							}
							else if (iVar8 == -842117252)
							{
...
void func_403(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_465() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 2))
			{
			...
			break;
		case 3:
			if (func_465() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 3))
			{
			...
			break;
		case 4:
			if (func_465() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 4))
			{
			...
			break;
		case 5:
			if (func_465() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 5))
			{
	...
	else
	{
		switch (iParam9)
		{
			case 665633627:
				...
				break;
			case -432403087:
				iVar8 = VOLUME::_0x10157BC3247FF3BA(vParam0, vParam3, vParam6, func_483());
				break;
			case -1612834106:
...
int func_494(int iParam0, int iParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return func_526(INVENTORY::_0x13D234A2A3F66E63(iParam0), iParam1);
	}
	return 0;
}
...
int func_505(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		iVar0 = (iVar0 + func_526(INVENTORY::_0x13D234A2A3F66E63(iParam0), iParam1));
	}
	if (bParam3)
	{
...
{
	return func_550(INVENTORY::_0x13D234A2A3F66E63(iParam0), iParam1, iParam2, bParam3, iParam4);
}
