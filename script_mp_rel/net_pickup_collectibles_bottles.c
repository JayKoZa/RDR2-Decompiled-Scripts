...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	uParam0->f_3 = 0;
	uParam0->f_7 = Param1;
	uParam0->f_10[0] = joaat("MP_BOTTLE_CARIB_RUM");
	uParam0->f_10[1] = joaat("MP_BOTTLE_COGNAC");
	uParam0->f_10[2] = joaat("MP_BOTTLE_CYPRUS_BRANDY");
	uParam0->f_10[3] = joaat("MP_BOTTLE_IRISH_WHISKEY");
	uParam0->f_10[4] = joaat("MP_BOTTLE_LONDRY_GIN");
	uParam0->f_10[5] = joaat("MP_BOTTLE_OLDTOM_GIN");
	uParam0->f_10[6] = joaat("MP_BOTTLE_PLYMOUTH_GIN");
	uParam0->f_10[7] = joaat("MP_BOTTLE_SCOTCH_WHISKEY");
	uParam0->f_10[8] = joaat("MP_BOTTLE_TENN_WHISKEY");
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_C");
				break;
			case 1:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_CB");
				break;
			case 2:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_CR");
				break;
			case 3:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_IW");
				break;
			case 4:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_LDG");
				break;
			case 5:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_OTG");
				break;
			case 6:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_PG");
				break;
			case 7:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_SW");
				break;
			case 8:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_TW");
				break;
			default:
				uParam0->f_80[iVar2] = joaat("MP005_S_AWB_TW");
				break;
