...
void func_2()
{
	iLocal_15 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2395f, -2410f, 35f, 0f, 0f, 0f, 150f, 120f, 50f, "m_volMacFarlanesRanch_Restriction");
	func_7(iLocal_15);
	iLocal_16 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1405.399f, -2279.227f, 70f, 0f, 0f, 7f, 65f, 107.5f, 40f, "m_volThievesLanding_Restriction");
	func_8(iLocal_16, 0, 0);
	iLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("m_volStillwaterCreek_Aquatic_Restriction");
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1747.279f, -2431.148f, 38f, 0f, 0f, -18f, 20f, 50f, 20f);
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1800.653f, -2314.105f, 38f, 0f, 0f, 15f, 60f, 25f, 20f);
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1787.128f, -2348.89f, 38f, 0f, 0f, -36f, 20f, 20f, 20f);
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1668.215f, -2341.46f, 38f, 0f, 0f, 25f, 25f, 15f, 20f);
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1671.046f, -2320.505f, 38f, 0f, 0f, 6f, 20f, 20f, 20f);
	VOLUME::_0x39816F6F94F385AD(iLocal_17, -1666.093f, -2360.316f, 38f, 0f, 0f, 25f, 20f, 15f, 20f);
	func_9(iLocal_17);
}
...
void func_4()
{
	...
	if (((((PERSCHAR::_0xEB98B38CA60742D7(uVar0) && PERSCHAR::_0xEB98B38CA60742D7(uVar1)) && PERSCHAR::_0xEB98B38CA60742D7(uVar2)) && PERSCHAR::_0xEB98B38CA60742D7(uVar3)) && PERSCHAR::_0xEB98B38CA60742D7(uVar4)) && PERSCHAR::_0xEB98B38CA60742D7(uVar5))
	{
		...
		{
			if (!STREAMING::_IS_POSITION_INSIDE_IMAP_STREAMING_EXTENTS(1736386364, Global_35))
			{
				func_11(1167397384);
			}
		}
...
bool func_10(int iParam0)
{
	...
	if (func_15(iVar1))
	{
		if (Global_1071686.f_19648.f_24 && !func_16(iParam0))
		{
			return false;
		}
