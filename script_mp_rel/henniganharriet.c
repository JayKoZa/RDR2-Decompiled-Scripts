...
bool func_13()
{
	...
	iLocal_19 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2183.916f, -2135.043f, 75.907f, 0f, 0f, 130f, 14.456f, 10.148f, 8.8f, "HEN Harriet - m_volHarriet");
	iLocal_20 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2185.63f, -2132.347f, 75.0567f, 0f, 0f, 30f, 3.7f, 3.7f, 4.2f, "HEN Harriet - m_volHarrietPrompt");
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2182.134f, -2134.707f, 73.87f, 0f, 0f, 130f, 3.364f, 3.818f, 2f, "HEN Harriet - m_volHarrietOffLimits");
	vVar0.x = iLocal_21;
	vVar0.f_2 = -1;
	AICOVERPOINT::_0x733077295AB51304(&vVar0);
	uLocal_22 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), -2183.285f, -2133.454f, 73.87f, 0f, 0f, 130f, 1f, 1f, 2f);
	VOLUME::_0xBE551C2CC421185D(uLocal_22, 1);
	VOLUME::_0x5B23DFF8E0948BB2(uLocal_22, 1);
	uLocal_23 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLBOX"), -2184.635f, -2132.268f, 73.87f, 0f, 0f, 130f, 3.2f, 7.3f, 2f);
