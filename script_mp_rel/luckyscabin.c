...
void func_61()
{
	...
	{
		case 0:
			if (INTERIOR::IS_VALID_INTERIOR(iLocal_27) && iLocal_27 == INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34))
			{
			...
			break;
		case 1:
			if (!INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34)) || iLocal_27 != INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34))
			{
				if (NETWORK::NETWORK_IS_IN_MP_CUTSCENE())
				{
