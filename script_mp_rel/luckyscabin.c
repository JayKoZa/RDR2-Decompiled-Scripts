...
void __EntryFunction__()
{
	...
	fLocal_13 = 1f;
	fLocal_14 = 1f;
	iLocal_17 = joaat("P_STRONGBOX01X");
		...
		if (MISC::GET_GAME_TIMER() > iLocal_33)
		{
			...
			switch (iLocal_32)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_35 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_32 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_34));
					Global_1896620 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_34)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_34 /*36*/].f_11);
							if (Global_1887339[iLocal_34 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_34 /*36*/].f_12);
							}
							Jump @850; //curOff = 827
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_34 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_34 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_34)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_34, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
...
void func_60()
{
	switch (iLocal_26)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_17) && STREAMING::HAS_ANIM_DICT_LOADED("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				func_91();
				if (NETWORK::_0xFBE782B3165AC8EC(-448258490))
				{
					iLocal_18 = OBJECT::CREATE_OBJECT(joaat("P_STRONGBOX01X"), vLocal_19, false, false, false, true, true);
				}
				...
				{
					iLocal_18 = OBJECT::CREATE_OBJECT(joaat("P_STRONGBOX01X"), vLocal_19, false, false, false, false, true);
				}
				DECORATOR::DECOR_SET_BOOL(iLocal_18, "chest_local_only", true);
				ENTITY::SET_ENTITY_ROTATION(iLocal_18, vLocal_22, 2, true);
				ENTITY::FREEZE_ENTITY_POSITION(iLocal_18, true);
				if (NETWORK::_0xFBE782B3165AC8EC(-448258490))
				{
					TASK::_0x188F8071F244B9B8(iLocal_18, 1);
					ENTITY::PLAY_ENTITY_ANIM(iLocal_18, "base_lockbox", "MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A", 1f, false, true, false, 0f, 0);
					iLocal_26 = 2;
				}
				else if (!UNLOCK::_UNLOCK_IS_UNLOCKED(joaat("PROMO_GTAO_GATING_NAVY_REVOLVER")))
				{
...
void func_61()
{
	if (!INTERIOR::IS_VALID_INTERIOR(iLocal_25))
	{
		iLocal_25 = INTERIOR::GET_INTERIOR_AT_COORDS(vLocal_19);
	}
	switch (iLocal_27)
	{
		case 0:
			if (INTERIOR::IS_VALID_INTERIOR(iLocal_25) && iLocal_25 == INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34))
			{
			...
			break;
		case 1:
			if (!INTERIOR::IS_VALID_INTERIOR(INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34)) || iLocal_25 != INTERIOR::GET_INTERIOR_FROM_ENTITY(Global_34))
			{
				if (NETWORK::NETWORK_IS_IN_MP_CUTSCENE())
				{
...
void func_78(int iParam0)
{
	...
	if (DECORATOR::DECOR_EXIST_ON(iLocal_18, "chest_local_only"))
	{
		DECORATOR::DECOR_REMOVE(iLocal_18, "chest_local_only");
	}
...
void func_91()
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_16))
	{
		...
		vVar6 = { 7f, 8f, 5f };
		iLocal_16 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "LuckysCabin");
		NETWORK::_0xEEB7818B1D307212(iLocal_16);
	}
}
...
void func_115(int iParam0)
{
	...
	if (func_87(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_142(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
...
{
	return func_183(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
