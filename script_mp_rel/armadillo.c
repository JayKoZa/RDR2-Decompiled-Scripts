		...
		if (MISC::GET_GAME_TIMER() > iLocal_37)
		{
			...
			switch (iLocal_36)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_39 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_36 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_38)))
					{
						...
						else
						{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_38 /*36*/].f_11);
							if (Global_1887339[iLocal_38 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_38 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_38 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_38 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_19 = Global_1887339[127 /*36*/].f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 29);
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Armadillo - m_volGeneral Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3686.114f, -2623.858f, -12.89814f, 0f, 0f, 0f, 5.86845f, 3.98367f, 3.717603f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3681.782f, -2626.667f, -12.97999f, 0f, 0f, 0f, 3.247781f, 3.506042f, 3.000762f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3685.422f, -2627.413f, -12.92333f, 0f, 0f, 0f, 4.057125f, 5.521852f, 3.439446f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3683.131f, -2624.525f, -13.041f, 0f, 0f, 44.914f, 3.072f, 3.99f, 2.949f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3689.379f, -2628.766f, -12.813f, 0f, 0f, 0f, 3.741f, 5.57f, 3.389f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -3688.071f, -2623.283f, -9.7791f, 0f, 0f, 0f, 2.257698f, 2.906237f, 3.016091f);
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX(-3685.352f, -2623.258f, -13.4981f, 0f, 0f, 0f, 1.100183f, 2.220348f, 1.996734f);
	iLocal_22 = VOLUME::_CREATE_VOLUME_BOX(-3687.81f, -2623.527f, -13.30467f, 0f, 0f, 0f, 2.162535f, 3.2466f, 2.122298f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_20, 10111);
	iLocal_23 = VOLUME::_CREATE_VOLUME_BOX(-3701.056f, -2595.456f, -14.37373f, 0f, 0f, 0f, 21.94766f, 22.09092f, 14.36038f);
	iLocal_24 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3732.708f, -2597.881f, -12.7227f, 0f, 0f, 0f, 2.649177f, 2.373272f, 2.514402f, "m_volPostOffice");
	iLocal_25 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3732.708f, -2597.881f, -12.7227f, 0f, 0f, 0f, 2.649177f, 2.373272f, 2.514402f, "m_volPostOfficePrompt");
	iLocal_28[0] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3715.032f, -2610.383f, -14.5792f, 0f, 0f, 0f, 6f, 6f, 5f, "Fire 1 blocking volume");
	iLocal_28[1] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3635.024f, -2587.306f, -14.9224f, 0f, 0f, 0f, 6f, 6f, 5f, "Fire 2 blocking volume");
	...
	PATHFIND::_0x19C7567D2F2287D6(iLocal_28[0], 7);
	PATHFIND::_0x19C7567D2F2287D6(iLocal_28[1], 7);
	PATHFIND::_0x19C7567D2F2287D6(iLocal_28[2], 7);
	iLocal_26 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3640.015f, -2777.934f, -13.33529f, 0.011471f, 0.064168f, 10.13543f, 7.095184f, 8.285556f, 4.615525f, "vol_Armadillo_OldManJones");
	iLocal_27 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3640.015f, -2777.934f, -13.33529f, 0.011471f, 0.064168f, 10.13543f, 7.095184f, 8.285556f, 4.615525f, "vol_Armadillo_OldManJonesPrompt");
	iLocal_33 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3730.346f, -2604.482f, -12.723f, 0f, 0f, 0f, 5.896f, 17.555f, 2.514f, "Armadillo - m_volTrainStation");
	return true;
}
...
{
	func_59(3, iLocal_20, iParam0, iLocal_21, iLocal_22, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_59(2, iLocal_24, iParam0, iLocal_25, 0, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_61(2, 0);
	func_59(35, iLocal_26, iParam0, iLocal_27, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_61(35, 0);
	func_62();
	func_63(110);
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_71(Global_1940258, 32768)) || func_71(Global_1940258, 16777216))
	{
		return;
	}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_38)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_84(iLocal_38, 0), 1);
					break;
			}
		}
		if (func_10(func_77()))
...
void func_58(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	Global_1940018.f_5[iParam0 /*11*/].f_6 = func_101(iParam5, iParam0);
}
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_18 = func_107(iParam2, iParam0);
	...
	Global_1051439.f_72[iParam0 /*75*/].f_63 = func_108(Global_1051439.f_72[iParam0 /*75*/].f_18);
...
{
	func_112(&(Global_1051439.f_72[iParam0 /*75*/].f_49), iParam1);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_113(iParam0, 16384) || func_113(iParam0, 32768)) || func_99(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
...
void func_63(int iParam0)
{
	...
	if (func_115(Global_1051439.f_3634[iVar0 /*19*/], &uVar1, &uVar2, &vVar3))
	{
		Global_1051439.f_3634[iVar0 /*19*/].f_6 = func_122(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	iVar6 = func_123(Global_1051439.f_3634[iVar0 /*19*/]);
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		...
		{
			Global_1051439.f_3634[iVar0 /*19*/].f_13 = func_122(uVar1, vVar3, uVar2, 0, 0, 0);
	...
	Global_1051439.f_3634[iVar0 /*19*/].f_5 = func_108(Global_1051439.f_3634[iVar0 /*19*/]);
	if (!func_124(30, 4))
	{
		func_110(30, 4);
		func_111(30);
...
bool func_75(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_132(iParam0));
}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_146(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_146(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_146(&cVar6, joaat("COLOR_PURE_WHITE")), func_146(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_87(int iParam0)
{
	...
	{
		if (VOLUME::_DOES_VOLUME_EXIST(iLocal_28[iVar0]))
		{
			PATHFIND::_0x2C87C3E1C7B96EE2(iLocal_28[iVar0]);
			VOLUME::_DELETE_VOLUME(iLocal_28[iVar0]);
		}
		iVar0++;
	}
	...
	if (iVar1 != 0)
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iVar1, "arm_sheriff_int_normal_mp", true);
	}
...
int func_98(int iParam0, bool bParam1)
{
	...
	if (func_152(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_159(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_159(iParam0)))
	{
...
{
	func_162(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_163(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_106(int iParam0, bool bParam1)
{
	...
	else if (func_124(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_178(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_180(iParam0, 2))
	{
...
void func_117(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_6 = func_122(uParam1, vParam2, uParam5, 0, 0, 0);
...
struct<2> func_130(int iParam0)
{
	...
	return func_150(joaat("VISITED"), iVar0);
}
...
char* func_134(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
void func_151(int iParam0)
{
	...
	if (func_96(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_202(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_203(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_204(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_178(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
int func_153(int iParam0, bool bParam1)
{
	...
	func_209(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_159(iParam0));
	func_158(iParam0, 0);
	return 1;
}
...
{
	func_210(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
{
	return func_222(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_182(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_224(12, func_223(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
bool func_212(int iParam0, int iParam1)
{
	...
	{
		return func_243(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
