...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_18 = func_100(iParam2, iParam0);
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_64 = func_101((Global_1051388->f_69[iParam0 /*76*/])->f_18);
...
void func_59(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0] = func_106(iParam1, 0, 0);
	if (func_107(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		if (!func_108(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
		{
			func_109(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, iParam2, bParam3, 1, 0, 0, 0);
		}
	}
	(Global_1051388->f_69[iParam0 /*76*/])->f_48++;
}

void func_60(int iParam0, int iParam1)
{
	func_110(&((Global_1051388->f_69[iParam0 /*76*/])->f_50), iParam1);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_111(iParam0, 16384) || func_111(iParam0, 32768)) || func_112((Global_1051388->f_69[iParam0 /*76*/])->f_3))
	{
	...
	if ((!bParam1 && func_114(iVar0, &uVar1, &uVar2, &vVar3)) || (bParam1 && func_115(iVar0, &uVar1, &uVar2, &vVar3)))
	{
		func_116(iParam0, uVar1, vVar3, uVar2, 0);
...
void func_66(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_121(Global_34, iParam1, 1, 0))
		{
			func_123(func_122(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_121(Global_34, iParam1, 1, 0))
	{
		*uParam2 = 0;
	}
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938085->f_145 = func_139(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_94(int iParam0, bool bParam1)
{
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_118(iParam0)))
	{
...
void func_98(bool bParam0, bool bParam1)
{
	...
	func_163(Global_1099294->f_516, 36);
	func_164(Global_1099294->f_555, 36);
}
...
void func_99(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_168(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_171(iParam0, 2))
	{
...
int func_101(int iParam0)
{
	...
	{
		Global_1051388->f_4360[iParam0] = func_175(iParam0);
	}
...
void func_109(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_107(iParam0))
	{
		...
		if (bParam3)
		{
			func_177(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_114(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_182(iParam0, "sHash", uParam1, "fHeading", uParam2, "vPos", uParam3);
}

bool func_115(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_182(iParam0, "sClosedHash", uParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}

void func_116(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
...
bool func_117(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_118(iParam0));
}
...
char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_191(func_190(Global_35));
	}
...
{
	func_196((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_197((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_144(int iParam0)
{
	...
	if (func_92((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_199((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_200((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_201((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_168(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	if (func_210(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_217(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_219((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_175(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1132968->f_7) && !func_221(12, func_220(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_177(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_107(iParam0))
	{
...
int func_182(int iParam0, char* sParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_183(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
var func_189(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_230(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
