		...
		if (MISC::GET_GAME_TIMER() > iLocal_27)
		{
			...
			switch (iLocal_26)
			{
				case 0:
					if (Global_1901947.f_1.f_26 > 0)
					{
						iLocal_29 = (MISC::GET_GAME_TIMER() + Global_1901947.f_1.f_26);
						iLocal_26 = 1;
					}
					else
					{
				...
				case 7:
					if (func_10(func_9(iLocal_28)))
					{
						...
						else
						{
							...
							func_36(iLocal_28, &Global_1896674);
							iLocal_26 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_28);
							func_21(iLocal_28, 8);
							...
							func_41(&Global_1896674, iLocal_28);
							func_42(iLocal_28);
							func_21(iLocal_28, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1887339[iLocal_28 /*36*/].f_11);
							if (Global_1887339[iLocal_28 /*36*/].f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1887339[iLocal_28 /*36*/].f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (Global_1887339[iLocal_28 /*36*/].f_13 != 0)
						{
							PED::_0x95423627A9CA598E(Global_1887339[iLocal_28 /*36*/].f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
bool func_13()
{
	iLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficePrompt Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1301.158f, 398.81f, 95.65845f, 0f, 0f, 61.99999f, 1.32f, 1.421f, 3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_20, -1299.192f, 402.038f, 95.658f, 0f, 0f, 61.99999f, 1.537f, 2.022f, 3f);
	iLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volPostOfficeOwner");
	VOLUME::_0x39816F6F94F385AD(iLocal_19, -1301.045f, 400.748f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 5f, 3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_19, -1301.309f, 398.458f, 95.8015f, 0f, 0f, 61.99999f, 2.173f, 2.006f, 3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_19, -1298.877f, 402.661f, 95.8015f, 0f, 0f, 61.99999f, 3.035f, 2.644f, 3f);
	VOLUME::_0xB469CFD9E065EB99(iLocal_19, 10047);
	iLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("WalStn-m_volGeneralShop Agg");
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -1303.001f, 395.221f, 95.824f, 0f, 0f, 62f, 13.808f, 6.791f, 3f);
	VOLUME::_0x39816F6F94F385AD(iLocal_21, -1296.65f, 397.28f, 95.553f, 0f, 0f, 62f, 3.882f, 2.263f, 2.603f);
	iLocal_22 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1303.289f, 394.199f, 95.824f, 0f, 0f, 62f, 2.042f, 1.5f, 3f, "WalStn-m_volGeneralShopPrompt");
	iLocal_23 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1301.095f, 393.546f, 95.824f, 0f, 0f, 60f, 3.235947f, 2.050864f, 3f, "WalStn-m_volGeneralShopOff");
	VOLUME::_0xB469CFD9E065EB99(iLocal_21, 10112);
	return true;
}
...
{
	func_58(3, iLocal_21, iParam0, iLocal_22, iLocal_23, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_59(3, 96424206, 0, 0, 0);
	func_59(3, 381066979, 0, 0, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_58(2, iLocal_19, iParam0, iLocal_20, 0, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_59(2, 96424206, 0, 0, 0);
	func_59(2, 381066979, 0, 0, 0);
	func_61(2, 0);
}

void func_30(int iParam0)
{
	func_62(796, iLocal_19, 1);
	func_62(797, iLocal_21, 1);
}
...
{
	func_63(uParam1, iLocal_21, 2);
	func_63(uParam1, iLocal_19, 10);
}
...
{
	func_66(100, iLocal_19, &uLocal_24);
	return false;
}
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 136:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_80(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_73()))
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0] = func_106(iParam1, 0, 0);
	if (func_107(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0]))
	{
		if (!func_108(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0]))
		{
			func_109(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar0], 0, fParam2, bParam3, 1, 0, bParam4, 0);
		}
	}
...
{
	func_110(&(Global_1051439.f_72[iParam0 /*75*/].f_49), iParam1);
}
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((func_111(iParam0, 16384) || func_111(iParam0, 32768)) || func_112(Global_1051439.f_72[iParam0 /*75*/].f_3))
	{
...
bool func_71(int iParam0)
{
	...
	return ((Global_1887339[iParam0 /*36*/].f_21 == 1 || Global_1887339[iParam0 /*36*/].f_21 == 2) && !func_124(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_132(iParam1, 2) || func_133(iParam4, 2)) && !Global_1893587.f_9)
	{
	...
	else if ((func_64(iParam0) && func_88(iParam0, 16777216)) && !Global_1893587.f_9)
	{
	...
	Global_1939161.f_145 = func_139(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
bool func_86(int iParam0, bool bParam1)
{
	...
	if (func_91(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_145(Global_1896620.f_1, 16))
			{
				func_146(Global_1896620.f_1, 0);
			}
			Global_1896620.f_1++;
			iVar2++;
...
void func_98(bool bParam0, bool bParam1)
{
	...
	else
	{
		...
		func_160(0);
		func_161(&(Global_1102219.f_3849));
		...
		func_162(&(Global_1102219.f_3888));
	...
	func_163(Global_1102219.f_3849, 36);
	func_164(Global_1102219.f_3888, 36);
}
...
void func_99(int iParam0, bool bParam1)
{
	...
	bVar0 = (func_165(iParam0) && !bParam1);
	if (!bVar0 && !func_111(iParam0, 65536))
	{
	...
	else if (func_166(iParam0, 67108864) && ENTITY::DOES_ENTITY_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_21))
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_168(Global_1051439.f_72[iParam0 /*75*/].f_31[iVar2]);
	...
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1051439.f_72[iParam0 /*75*/].f_24) && func_171(iParam0, 2))
	{
...
int func_101(int iParam0)
{
	...
	{
		Global_1051439.f_4472[iParam0] = func_175(iParam0);
	}
...
void func_116(int iParam0, var uParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	Global_1051439.f_72[iParam0 /*75*/].f_6 = func_183(uParam1, vParam2, uParam5, 0, 0, 0);
...
struct<2> func_122(int iParam0)
{
	...
	return func_142(joaat("VISITED"), iVar0);
}
...
char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_189(Global_1893587.f_162);
	}
...
{
	func_196(Global_1940018.f_5[iParam0 /*11*/].f_6, 1);
	func_197(Global_1940018.f_5[iParam0 /*11*/].f_6, 0);
...
void func_144(int iParam0)
{
	...
	if (func_92(Global_1915715.f_3[iParam0 /*447*/].f_21) && func_199(Global_1915715.f_3[iParam0 /*447*/].f_21))
	{
		func_200(Global_1915715.f_3[iParam0 /*447*/].f_21, 0, 1, 0, 0);
	}
	...
	func_201(Global_1915715.f_3[iParam0 /*447*/].f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_168(Global_1915715.f_3[iParam0 /*447*/].f_318[iVar0 /*6*/]);
...
{
	if (func_210(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_217(&(Global_1102219.f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_219(Global_1051439.f_72[iParam0 /*75*/].f_50, iParam1);
}
...
int func_175(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1139381.f_7) && !func_221(12, func_220(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
{
	func_230(&(Global_1940018.f_5[iParam0 /*11*/].f_7), iParam1);
}
...
bool func_209(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_239(&(Global_1102219.f_4), iVar0, 5);
	}
	if (iParam1 == func_240())
	{
		return func_239(&(Global_1102219.f_4), iVar0, 5);
	...
	{
		return func_239(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
bool func_221(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_242(iParam0, iParam1, &uVar0))
	{
...
void func_246(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		...
		case 20:
			...
			*uParam3 = 51f;
			Jump @2718; //curOff = 1313
			*uParam1 = { -3543.512f, -3032.038f, -13.674f };
			*uParam2 = { 40f, 40f, 70f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1358
			*uParam1 = { -4348.655f, -2427.582f, -13.674f };
			*uParam2 = { 40f, 40f, 70f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1403
			*uParam1 = { -391.586f, 922.337f, 137.604f };
			*uParam2 = { 31f, 30f, 40f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1448
			*uParam1 = { -2656.999f, 153.667f, 189.043f };
			*uParam2 = { 177f, 126f, 102f };
			*uParam3 = 52f;
			Jump @2718; //curOff = 1497
			*uParam1 = { 156.109f, 425.799f, 120f };
			*uParam2 = { 249f, 112f, 120f };
			*uParam3 = -36f;
			Jump @2718; //curOff = 1546
			*uParam1 = { -5868.5f, -2752.441f, -13.674f };
			*uParam2 = { 40f, 40f, 70f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1591
			*uParam1 = { 898.505f, -335.252f, 48.403f };
			*uParam2 = { 56f, 152f, 70f };
			*uParam3 = -36f;
			Jump @2718; //curOff = 1640
			*uParam1 = { -889.947f, -171.356f, 90.537f };
			*uParam2 = { 180f, 95f, 100f };
			*uParam3 = 29f;
			Jump @2718; //curOff = 1689
			*uParam1 = { 571.454f, 1968.615f, 122.93f };
			*uParam2 = { 32f, 49f, 140f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1734
			*uParam1 = { -2769.681f, -3210.99f, 25f };
			*uParam2 = { 25f, 25f, 45f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1779
			*uParam1 = { -5409.034f, -3657.266f, -14.496f };
			*uParam2 = { 36f, 30f, 30f };
			*uParam3 = -24f;
			Jump @2718; //curOff = 1828
			*uParam1 = { 2453.293f, 290.68f, 69.615f };
			*uParam2 = { 35f, 42f, 19f };
			*uParam3 = -4f;
			Jump @2718; //curOff = 1877
			*uParam1 = { -643.042f, 278.359f, 95.5f };
			*uParam2 = { 70f, 67f, 65f };
			*uParam3 = -109f;
			Jump @2718; //curOff = 1926
			*uParam1 = { -118.339f, -24.853f, 96.907f };
			*uParam2 = { 84f, 69f, 37f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 1971
			*uParam1 = { -2863.456f, -2723.259f, 93.195f };
			*uParam2 = { 196f, 157f, 85f };
			*uParam3 = -18f;
			Jump @2718; //curOff = 2020
			*uParam1 = { -3484.814f, -3466.383f, -0.849f };
			*uParam2 = { 12f, 12f, 70f };
			*uParam3 = 0f;
			Jump @2718; //curOff = 2065
