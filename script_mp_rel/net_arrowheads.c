...
int func_8(var uParam0)
{
	...
	{
		if ((MISC::GET_FRAME_COUNT() % 5) == 0 && func_29(Global_34, uParam0->f_6, 3f, 1, 1))
		{
			if (!func_30(uParam0))
			{
				func_18(*uParam0, uParam0->f_1);
	...
	switch (func_31(uParam0))
	{
			...
			if (func_34(uParam0->f_14))
			{
				...
				if (func_50(uParam0->f_14, 1))
				{
					if (func_51(*uParam0, uParam0->f_1, 32))
					{
						...
						WEAPON::_HIDE_PED_WEAPONS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 2, 0);
						func_27(1);
						func_23(*uParam0, uParam0->f_1, 32);
						func_33(uParam0, 7);
					}
		...
		case 8:
			...
			break;
		case 9:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_11, 0))
			{
				func_33(uParam0, 10);
			}
			break;
		case 10:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_11, 0) || !ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_11, 0))
			{
				if (!func_59(uParam0))
				{
					return 0;
...
{
	if (func_71(*Global_1201104, vParam0))
	{
...
void func_22(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		Var8.f_4 = 103;
		func_74(Var8, func_73(Global_35, 0f, 0f, 0f, 300f, 300f, 300f, -432403087, 0, 8), 0, 0);
	}
	func_75(&Var1, &uVar0);
}
...
{
	func_76((*(*Global_1201108)[iParam0 /*1909*/])[iParam1 /*9*/], iParam2);
}
...
int func_32(int iParam0)
{
	...
	if (fVar2 > 0f)
	{
		...
		{
			if (!func_66((*Global_1201108)[((*Global_1200815)[iVar4 /*9*/])->f_1 /*1909*/][((*Global_1200815)[iVar4 /*9*/])->f_2 /*9*/], 1))
			{
				func_67((*(*Global_1201108)[((*Global_1200815)[iVar4 /*9*/])->f_1 /*1909*/])[((*Global_1200815)[iVar4 /*9*/])->f_2 /*9*/], 1);
			}
			return 1;
		}
		if (!func_66((*Global_1201108)[((*Global_1200815)[iVar4 /*9*/])->f_1 /*1909*/][((*Global_1200815)[iVar4 /*9*/])->f_2 /*9*/], 32))
		{
			func_67((*(*Global_1201108)[((*Global_1200815)[iVar4 /*9*/])->f_1 /*1909*/])[((*Global_1200815)[iVar4 /*9*/])->f_2 /*9*/], 32);
		}
	}
	return 0;
}
...
void func_37(var uParam0, vector3 vParam1)
{
	...
	if (func_83(*Global_1201104))
	{
		*Global_1201104 = { vParam1 };
	}
	else if (!func_71(*Global_1201104, vParam1))
	{
...
void func_38(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	...
	if (!func_83(*Global_1201104) && MISC::GET_DISTANCE_BETWEEN_COORDS(*Global_1201104, vParam1, true) <= 5f)
	{
		bVar0 = true;
	}
...
int func_44(int iParam0, var uParam1, int iParam2)
{
	...
	if (!func_95(iParam0))
	{
		...
		PLAYER::_0x6ECFC621A168424C(iParam0, uParam1, iParam2);
...
int func_46(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 60)
	{
		if (func_97(iVar0, 2))
		{
			if (func_98(vParam2, ((*Global_1949759)[iVar0 /*23*/])->f_6, 0.01f, 1) && iParam1 == ((*Global_1949759)[iVar0 /*23*/])->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
...
{
	return func_66((*Global_1201108)[iParam0 /*1909*/][iParam1 /*9*/], iParam2);
}
	...
	else
	{
		switch (iParam9)
		{
			case 665633627:
				...
				break;
			case -432403087:
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_111());
				break;
			case -1612834106:
	...
	if (!bParam20)
	{
		if (Param0.f_18)
		{
			if (bParam21)
			{
				...
				func_116(&(Global_1070356->f_21258), Var0);
				return;
			}
		}
	}
...
{
	if (func_118(iParam0, iParam1) && (!bParam2 || &(Global_1070356->f_20795.f_353[iParam0 /*11*/])->f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
...
void func_101(int iParam0, int iParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1949759)[iParam0 /*23*/])->f_3))
	{
		if (((*Global_1949759)[iParam0 /*23*/])->f_5 == 5 && !func_97(iParam0, 8))
		{
...
bool func_122(int iParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_146(&(Global_17172.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_123(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_149(iParam0, joaat("default")) != 0)
	{
...
struct<4> func_130(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1272170 = { func_156(joaat("character"), func_155(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272170->f_12 = { func_156(joaat("character"), func_155(), -1591664384, 0) };
			}
...
int func_131(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	...
	if (!bParam3 && func_149(iParam0, joaat("default")) == 0)
	{
		bParam3 = true;
	}
	if (func_160(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		Var0 = { func_161(0) };
		Var4.f_9 = -1591664384;
		if (!func_162(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
		{
			return 0;
		}
		else if (func_163(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
		{
			return 0;
		}
		if (func_164(iParam0, 1))
		{
			if (!func_162(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
			{
				return 0;
			}
			else if (func_163(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
			{
				return 0;
			}
		}
...
int func_135(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_171(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_172())
	{
		return func_171(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_171(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_140(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_150(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
{
	return func_120(iParam0) == joaat("weapon");
}
...
struct<4> func_161(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1272170->f_4 = { func_156(923904168, func_130(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1272170->f_16 = { func_156(923904168, func_130(bParam0), -740156546, 0) };
		}
...
int func_165(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (!bParam2 && func_149(iParam0, joaat("default")) == 0)
	{
		bParam2 = true;
	}
	if (bParam2)
...
int func_166(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_149(iParam0, joaat("default")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
...
int func_179(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_150(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_180(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	switch (iVar5)
	{
		...
		case joaat("weapon"):
			...
			if (bParam2 && func_164(iParam0, 1))
			{
				...
				else if (!func_162(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_163(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
struct<4> func_187(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1272170->f_8 = { func_156(271701509, func_130(bParam0), 12999093, 0) };
		}
