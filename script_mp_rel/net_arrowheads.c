...
bool func_8(var uParam0)
{
	...
	{
		if ((MISC::GET_FRAME_COUNT() % 5) == 0 && func_29(Global_34, uParam0->f_7, 3f, 1, 1))
		{
			if (!func_30(uParam0))
			{
				func_16(*uParam0, uParam0->f_1);
	...
	func_40(uParam0->f_7, *uParam0, uParam0->f_1, 1092616192 /* Float: 10f */);
	switch (func_31(uParam0))
	{
		...
		case 5:
			if (func_45(uParam0, 1097859072 /* Float: 15f */))
			{
				if (!func_34(uParam0->f_15))
				{
					uParam0->f_15 = func_46("UC_CLT_DIG", joaat("INPUT_CONTEXT_X"), uParam0->f_7, 1070386381 /* Float: 1.6f */, 3, 1, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
				}
				func_33(uParam0, 6);
			}
			break;
		...
		case 9:
			...
			break;
		case 10:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_12, false) || !ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_12, false))
			{
				if (!func_58(uParam0))
				{
					return false;
...
int func_11(var uParam0)
{
	...
	switch (uParam0->f_1)
	{
		...
		case 5:
			...
			break;
		case 15:
			iVar0 = joaat("MP005_P_DIRTPILE_GRI_MINES_BURIED");
			break;
		case 16:
		...
		case 14:
			...
			break;
		case 30:
			iVar0 = joaat("MP005_P_DIRTPILE_BIG02_MINE_BURIED");
			break;
		case 31:
			iVar0 = joaat("MP005_P_DIRTPILE_SCA03_BURIED");
			break;
...
int func_13(var uParam0)
{
	...
	{
		case 0:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_AGATE");
			break;
		case 1:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_AGATE");
			break;
		case 2:
			...
			break;
		case 3:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_BONE");
			break;
		case 4:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_BONE");
			break;
		case 5:
			...
			break;
		case 6:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_CHIPPED");
			break;
		case 7:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_CHIPPED");
			break;
		case 8:
			...
			break;
		case 9:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_CRUDE");
			break;
		case 10:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_CRUDE");
			break;
		case 11:
			...
			break;
		case 12:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_FELDSPAR");
			break;
		case 13:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_FELDSPAR");
			break;
		case 14:
			...
			break;
		case 15:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_FLINT");
			break;
		case 16:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_FLINT");
			break;
		case 17:
			...
			break;
		case 18:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_OBSIDIAN");
			break;
		case 19:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_OBSIDIAN");
			break;
		case 20:
			...
			break;
		case 21:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_QUARTZ");
			break;
		case 22:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_QUARTZ");
			break;
		case 23:
			...
			break;
		case 24:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_RAW");
			break;
		case 25:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_RAW");
			break;
		case 26:
			...
			break;
		case 27:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_ROUGH");
			break;
		case 28:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_ROUGH");
			break;
		case 29:
			...
			break;
		case 30:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_SLATE");
			break;
		case 31:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_SLATE");
			break;
		case 32:
			...
			break;
		case 33:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_SPLINTERED");
			break;
		case 34:
			iVar0 = joaat("COLLECTIBLE_ARROWHEAD_SPLINTERED");
			break;
...
void func_22(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		Var8.f_4 = 103;
		func_73(Var8, func_72(Global_35, 0f, 0f, 0f, 300f, 300f, 300f, joaat("VOLSPHERE"), 0, 8), 0, 0);
	}
	func_74(&Var1, &uVar0);
}
...
bool func_32(int iParam0)
{
	...
	if (fVar2 > 0f)
	{
		if (Global_1296859.f_154[Global_1296859] != Global_1296859.f_154[iVar3])
		{
			...
			{
				func_81(&(Global_1212893[Global_1212600[iVar4 /*9*/].f_1 /*2251*/][Global_1212600[iVar4 /*9*/].f_2 /*9*/]), 1);
			}
			return true;
		}
		if (!func_69(Global_1212893[Global_1212600[iVar4 /*9*/].f_1 /*2251*/][Global_1212600[iVar4 /*9*/].f_2 /*9*/], 32))
		{
			func_81(&(Global_1212893[Global_1212600[iVar4 /*9*/].f_1 /*2251*/][Global_1212600[iVar4 /*9*/].f_2 /*9*/]), 32);
		}
	}
	return false;
}
...
void func_38(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (!func_82(joaat("KIT_COLLECTORS_BAG"), 1))
	{
		return;
	}
	if (func_84(0))
	...
	if (!func_83(Global_1212889) && MISC::GET_DISTANCE_BETWEEN_COORDS(Global_1212889, vParam1, true) <= 5f)
	{
		bVar0 = true;
	}
	...
	fVar1 = func_53(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), vParam1, 1);
	fVar2 = 10f;
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_55(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != joaat("WEAPON_KIT_METAL_DETECTOR"))
						{
...
void func_39(int iParam0)
{
	...
	if (func_34(iParam0))
	{
		...
		if ((((((((PED::_IS_PED_CARRYING(Global_1296859.f_8) || TASK::IS_PED_GETTING_UP(Global_1296859.f_8)) || PED::IS_PED_RAGDOLL(Global_1296859.f_8)) || !func_92()) || Global_1102219.f_3664) || ENTITY::DOES_ENTITY_EXIST(iVar0)) || PED::IS_PED_JUMPING(Global_1296859.f_8)) || PED::IS_PED_CLIMBING(Global_1296859.f_8)) || PED::IS_PED_FALLING(Global_1296859.f_8))
		{
...
{
	if (func_53(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), vParam0, 1) < fParam5)
	{
...
Vector3 func_43(vector3 vParam0, float fParam3)
{
	...
	fVar14 = (MISC::ATAN2((func_99(vVar8, vVar0) / BUILTIN::VMAG(vVar8)), (func_99(vVar11, vVar0) / BUILTIN::VMAG(vVar11))) + 180f);
...
bool func_45(var uParam0, float fParam1)
{
	if (func_82(joaat("KIT_COLLECTOR_SPADE"), 1))
	{
		...
		if (func_20(uParam0, 2))
		{
			if (func_55(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) == joaat("WEAPON_KIT_METAL_DETECTOR") && func_53(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uParam0->f_7, 1) <= 1.6f)
			{
				return true;
			}
		}
...
int func_46(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 60)
	{
		if (func_101(iVar0, 2))
		{
			if (func_102(vParam2, Global_1951255[iVar0 /*23*/].f_6, 0.01f, 1) && iParam1 == Global_1951255[iVar0 /*23*/].f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	if (iVar1 != 0)
	{
		func_103(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216 /* Float: 1f */, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
bool func_58(var uParam0)
{
	...
	func_106(func_105(joaat("COLLECTIBLES_COLLECTED"), joaat("W_SHOVEL")), 1);
	if (func_20(uParam0, 2))
	{
		func_106(func_105(joaat("COLLECTIBLES_COLLECTED"), joaat("W_METAL_DETECTOR")), 1);
	}
	return true;
}
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_110());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_110());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_110());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_111(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
{
	if (func_117(iParam0, iParam1) && (!bParam2 || Global_1071686.f_22538.f_385[iParam0 /*11*/].f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
...
bool func_92()
{
	if (((((!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_34, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_34)) && !func_129(Global_34, 1369124074)) && !func_129(Global_34, 713668775)) && !TASK::_0xEC7E480FF8BD0BED(Global_34)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_34, false))
	{
		return true;
	}
	return false;
...
bool func_100(int iParam0)
{
	...
	if (!DATAFILE::_0x603AC35FD4602C76(func_134()))
	{
		return false;
	}
	Var0 = func_134();
...
bool func_104(int iParam0, var uParam1)
{
	...
	Var0.f_1 = 10;
	func_135(&Var0, joaat("LOOT_TYPE_NORMAL"));
...
int func_123(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (func_152(iParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_153(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_153(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
void func_131(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(Global_1951255[iParam0 /*23*/].f_3))
	{
		if (Global_1951255[iParam0 /*23*/].f_5 == 5 && !func_101(iParam0, 8))
		{
...
bool func_138(int iParam0, int iParam1)
{
	...
	{
		return func_162(&(Global_1100469[iParam1 /*53*/].f_4), iVar0, 5);
	}
	return false;
}
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_153(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_158(var uParam0)
{
	...
	if (func_174() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_153(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
struct<5> func_172(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iVar5)
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_180(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_180(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_181(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
struct<4> func_173(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_153(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_178(bool bParam0)
{
	...
	if (Global_1572887.f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				Global_1293346 = { func_173(joaat("CHARACTER"), func_186(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1293346.f_12 = { func_173(joaat("CHARACTER"), func_186(), -1591664384, 0) };
			}
			return Global_1293346.f_12;
		}
	}
	return func_173(joaat("CHARACTER"), func_186(), -1591664384, bParam0);
}
...
bool func_187()
{
	return (func_192(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_193(func_173(joaat("WARDROBE"), func_178(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_188(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_152(iParam0, joaat("DEFAULT")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_153(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_153(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_192(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_153(bParam1), iParam0, iParam3);
}
