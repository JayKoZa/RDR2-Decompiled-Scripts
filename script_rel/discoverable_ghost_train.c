...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 4:
			...
			{
				Local_14.f_1 = VEHICLE::_CREATE_MISSION_TRAIN(func_60(), func_61(0), true, false, true, false);
			}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_83("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
		}
...
bool func_53(var uParam0, struct<10> Param1, var uParam11)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(*uParam0))
	{
...
bool func_62(int iParam0, float fParam1, float fParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_65(int iParam0, float fParam1, float fParam2)
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_108(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	Var8 = { func_154(joaat("HONOR_CURRENT")) };
...
bool func_133(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_128(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_GET_CURRENT_VEHICLE_DRIVER(iVar0) == Global_35)
		{
			return false;
		}
	}
