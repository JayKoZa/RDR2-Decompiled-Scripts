...
void func_15(int iParam0, bool bParam1, vector3 vParam2, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (bParam1)
	{
		...
		func_29(8);
		func_30(Global_36, 1137180672 /* Float: 400f */);
	}
	if (bParam7)
	{
...
int func_26(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < func_118(iParam0))
	{
		...
		if (func_120(vVar1, vParam1, 1056964608 /* Float: 0.5f */, 1))
		{
			return iVar0;
		}
		iVar0++;
...
int func_153(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_238(bParam2), iParam0, 0);
	return uVar2;
}
...
bool func_173(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_257(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_174(int iParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(Global_1914319.f_3[iParam0 /*446*/].f_23))
	{
		...
		if (!VOLUME::_IS_POSITION_INSIDE_VOLUME(Global_1914319.f_3[iParam0 /*446*/].f_25, func_63(Global_1914319.f_3[iParam0 /*446*/].f_21)))
		{
			return false;
		}
		return true;
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_238(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
int func_240(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_234("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			else if ((!func_315(iParam1, 512) && func_316(Var4.f_4, &uVar19, &Var23, 1728382685 /* GXTEntry: "Right" */)) && !Var23.f_21)
			{
			}
			else if (!bVar18 || WEAPON::_0xF29A186ED428B552(Global_35, Var4.f_4))
			{
				if (((WEAPON::_IS_WEAPON_ONE_HANDED(Var4.f_4) && (!WEAPON::_IS_WEAPON_SHOTGUN(Var4.f_4) || func_315(iParam1, 32))) && (!WEAPON::_IS_WEAPON_PISTOL(Var4.f_4) || !func_315(iParam1, 16777216))) && (!WEAPON::_IS_WEAPON_REVOLVER(Var4.f_4) || !func_315(iParam1, 33554432)))
				{
...
bool func_248(int iParam0)
{
	...
	while (iVar48 < iVar0)
	{
		...
		{
			if (Var1.f_2 == joaat("COST_TYPE_CRAFT") && !func_320(iParam0, Var1, 1))
			{
				return true;
			}
		}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_238(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_320(int iParam0, var uParam1, bool bParam2)
{
	...
	if ((bParam2 && func_133() == 0) && !UNLOCK::_UNLOCK_IS_VISIBLE(iParam0))
	{
		return false;
	}
...
bool func_334(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_351(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
{
	return func_386(joaat("CHARACTER"), func_404(), -1591664384, bParam0);
}
