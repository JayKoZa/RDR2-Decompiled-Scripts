...
bool func_77(var uParam0)
{
	...
	func_164(uParam0, -0.96f, -3.36f, 0f, -111.15f, 5f, 5f, 5f, joaat("VOLCYLINDER"), 1);
	func_165(uParam0, -2.23f, -4.41f, 0f, 0f, 3.5f, 3.5f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_165(uParam0, 0.16f, -0.4f, 0f, -109.8f, 3.5f, 3.5f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
...
void func_355(int iParam0)
{
	...
	Var0 = { func_433(joaat("CAREER_CASH")) };
...
void func_356(int iParam0, char* sParam1, int iParam2)
{
	...
	func_434(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
struct<5> func_626(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_641(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_630(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_628(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_628(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_629(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_630(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_634(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_652(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
