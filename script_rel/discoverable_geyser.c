			...
			case 5:
				if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST((Local_14[iVar0 /*13*/])->f_11))
				{
					if (func_57(&((Local_14[iVar0 /*13*/])->f_8)) > func_60(iVar1))
					{
						...
						Local_14.f_41 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(-998484125, func_56(iVar0), -1082130432, -1082130432, -1082130432, -1082130432, -1082130432, 3, 1);
...
int func_94(int iParam0, int iParam1)
{
	...
	uVar0 = func_93(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_93(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_97()
{
	...
	if (!func_132(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
...
int func_124(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_119(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
