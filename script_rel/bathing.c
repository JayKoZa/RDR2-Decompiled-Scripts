...
int func_4(int iParam0)
{
	...
	iParam0->f_2 = -304640465; /* GXTEntry: "Bath House" */
	iParam0->f_6 = func_2();
	func_22(iParam0);
	return 1;
}
...
void func_6(int iParam0)
{
	...
	switch (iParam0->f_112)
	{
		...
		case 3:
			...
			{
				if ((func_43() && !PED::_0xA911EE21EDF69DAF(Global_35)) && iParam0->f_112 == 3)
				{
				...
				if ((((func_49(iParam0, 0) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iParam0->f_14, true, 0)) && func_43()) && iParam0->f_112 == 4) && !PED::_0xA911EE21EDF69DAF(Global_35))
				{
	...
	if (iLocal_15 == 1)
	{
		...
		if (iLocal_32 == 0)
		{
			if (iLocal_31 == 1 && (MISC::GET_GAME_TIMER() - iLocal_50) > 10000)
			{
				if (!func_28(iLocal_17))
				{
					iLocal_17 = func_118("BATH_CHAT", joaat("INPUT_CONTEXT_Y"), 2, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, joaat("SHORT_TIMED_EVENT"), 0);
					iLocal_33 = 1;
		...
		if (iLocal_31 == 0)
		{
			if (!func_28(iLocal_16))
			{
				iLocal_16 = func_118("BATH_NO_CHAT", joaat("INPUT_CONTEXT_Y"), 2, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, joaat("SHORT_TIMED_EVENT"), 0);
			}
			else
			{
				func_117(iParam0);
...
void func_34(int iParam0, bool bParam1)
{
	if (MAP::DOES_BLIP_EXIST(iParam0->f_41))
	{
		...
		{
			MAP::_0xB059D7BD3D78C16F(iParam0->f_41, 724623647);
			MAP::REMOVE_BLIP(&(iParam0->f_41));
		}
	}
}
...
void func_38(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	if (!MAP::DOES_BLIP_EXIST(iParam0->f_41))
	{
		iParam0->f_41 = MAP::_0x554D9D53F696D002(iParam0->f_1, vParam1);
...
{
	if (ANIMSCENE::_0x25557E324489393C(iParam0->f_69))
	{
		ANIMSCENE::_DELETE_ANIM_SCENE(iParam0->f_69);
	}
	iLocal_301 = 0;
...
void func_58(int iParam0)
{
	...
	else if (func_115(Global_35, 76834332))
	{
		...
		if (iParam0->f_15 == 1)
		{
			PLAYER::SET_PLAYER_CLOTH_PIN_FRAMES(iParam0->f_144, true);
		}
...
int func_59(var uParam0, char* sParam1, int iParam2, vector3 vParam3, int iParam6)
{
	...
	if (!func_160(vParam3))
	{
		if (!func_28(*uParam0))
		{
			...
			{
				*uParam0 = func_167(sParam1, iParam2, vParam3, 1.6f, 3, 0, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
	...
	if (!func_28(*uParam0))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			if (bParam6)
			{
				...
				{
					iVar0 = 7;
					*uParam0 = func_167(sParam1, iParam2, vParam3, 1f, 2, 1, 0, iVar0, 570, 0, 14, 2f, 0, joaat("SHORT_TIMED_EVENT"), 0);
				}
			}
			else if (!func_160(vParam3))
			{
				*uParam0 = func_167(sParam1, iParam2, vParam3, 1f, 2, 1, 0, 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
			}
			if (iParam8 == 0)
			{
...
int func_64(int iParam0, char* sParam1, bool bParam2)
{
	if (iParam0->f_15)
	{
		if (TASK::IS_TASK_MOVE_NETWORK_READY_FOR_TRANSITION(Global_35))
...
{
	if (ANIMSCENE::_0x25557E324489393C(iParam0->f_68))
	{
...
int func_82(int iParam0)
{
	...
	switch (iLocal_300)
	{
		...
		case 2:
			if (ANIMSCENE::_0x25557E324489393C(iParam0->f_68))
			{
				if (ANIMSCENE::_0x477122B8D05E7968(iParam0->f_68, 1, 0))
				{
					ANIMSCENE::_0xDF7B5144E25CD3FE(iParam0->f_68, &(iParam0->f_96));
					iLocal_300 = 3;
				}
				else if (ANIMSCENE::_0x59606519FF9D3EC2(iParam0->f_68, 1))
				{
				}
			}
			break;
		...
		case 6:
			...
			ANIMSCENE::_0xADF1D53F3B1FE0A7(iParam0->f_68, &uVar8, &uVar11, 2);
			iParam0->f_16 = 1;
			iParam0->f_134 = 0;
			iLocal_300 = 7;
			break;
		case 7:
			if (ANIMSCENE::_0xCDC5512A407CF08D(iParam0->f_68))
			{
			...
			if (!ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_68, 0) || (ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_68) > 0.95f && ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_68, 0)))
			{
				iLocal_300 = 8;
			}
			break;
...
int func_83(int iParam0)
{
	...
	switch (iLocal_301)
	{
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::_0x477122B8D05E7968(iParam0->f_69, 1, 0))
			{
		...
		case 6:
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_47) > 5000)
			{
				if (iParam0->f_112 < 19)
				{
					ANIMSCENE::SET_ANIM_SCENE_PAUSED(iParam0->f_69, 0);
					bLocal_329 = false;
				}
				else
				{
		...
		case 7:
			...
			if (!ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_69, 0) || (ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_69) > 0.95f && ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_69, 0)))
			{
				iLocal_301 = 8;
			}
			if (MISC::ARE_STRINGS_EQUAL(&(iParam0->f_104), "s_deluxe_intro") && ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_69) > 0.05f)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_64))
				{
					OBJECT::DELETE_OBJECT(&iLocal_64);
			...
			{
				if (ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_69) > 0f && ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_69, 0))
				{
					if (iLocal_28 == 0)
					{
			...
			if (MISC::ARE_STRINGS_EQUAL(&(iParam0->f_104), "s_deluxe_Outro") && (ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_69) > 0.5f && ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_69, 0)))
			{
				if (iLocal_30 == 0)
				{
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Global_35))
			...
			if (!bLocal_329)
			{
				if (ANIMSCENE::_0x3FBC3F51BF12DFBF(iParam0->f_69) > 0.5f && ANIMSCENE::_0xCBFC7725DE6CE2E0(iParam0->f_69, 0))
				{
					func_58(iParam0);
					bLocal_329 = true;
				}
...
int func_99(var uParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
...
int func_118(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar1 != 0)
	{
		func_241(iVar1, iParam1, sParam0, 1, iParam2, iParam3, 0f, 0f, 0f, 0f, 0, 0, 0, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 1065353216 /* Float: 1f */, 0, 0, 0, bParam10, bParam11);
		return iVar1;
	}
	return 0;
}
...
void func_142(int iParam0, char* sParam1, int iParam2)
{
	...
	func_262(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
int func_167(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	if (iVar1 != 0)
	{
		func_241(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216 /* Float: 1f */, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
int func_222(var uParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_225(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_334(&(uParam0->f_1[iVar0 /*3*/]), iVar5, uVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
int func_334(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	int iVar0;
...
void func_342(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_136() == -1)
	{
		...
		if ((bParam4 && iVar0 > 5) && func_403(Global_1946804->f_1497))
		{
