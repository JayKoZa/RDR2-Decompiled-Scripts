...
int func_11()
{
	uLocal_14 = ((*Global_1888801)[65 /*35*/])->f_4;
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_46())
		{
		...
		if (func_47(45))
		{
			POPULATION::_0xB56D41A694E42E86(uLocal_14, 10208, 0, 0, -1, -1, 0);
			POPULATION::_0x18262CAFEBB5FBE1(uLocal_14, 10208, 0, 0, -1, -1, 0);
		}
		else
		{
			POPULATION::_0x74C2B3DC0B294102(uLocal_14);
			POPULATION::_0xA1CFB35069D23C23(uLocal_14);
		}
	}
	return 1;
}
