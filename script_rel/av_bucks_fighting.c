					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 811542464))
							{
								...
								TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uParam0->f_20[0 /*14*/]), uParam0->f_483, 3, 0, -1082130432, -1, 0);
						...
						if (!&uParam0->f_469[5])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), 811542464))
							{
								...
								TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uParam0->f_20[1 /*14*/]), uParam0->f_483, 3, 0, -1082130432, -1, 0);
