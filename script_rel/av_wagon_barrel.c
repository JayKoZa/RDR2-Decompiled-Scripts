...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar0 = func_50(func_49());
	uVar1 = func_50(func_49());
	func_51(uParam0, 0, "MALE_A", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MALE_B", uVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 0, "BARREL", -1809418382, 0f, 0f, 0f, 0f, 1);
	...
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar1 /*14*/])))
			{
				...
				{
					TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[iVar1 /*14*/]), Global_35, -1f, -1, 0, 1077936128, 0);
					func_68(uParam0);
					if (!&uParam0->f_469[6])
					{
...
int func_109(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_110(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
void func_132(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
