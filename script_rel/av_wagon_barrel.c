...
{
	func_33(uParam0, 11061, 11177, 11752);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 27:
			func_46(uParam0, "AV_WAGON_LOAD_BARREL", "script@vignette@ambient@av_wagon@barrel_load@pl_action", vParam1, vParam4);
			func_47(uParam0, 1, "PL_LOAD_ACTION", "", 0);
			break;
		case 29:
			func_46(uParam0, "AV_WAGON_UNLOAD_BARREL", "script@vignette@ambient@av_wagon@barrel_unload@pl_action", vParam1, vParam4);
	...
	iVar0 = func_50(func_49());
	iVar1 = func_50(func_49());
	func_51(uParam0, 0, "MALE_A", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MALE_B", iVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_48(uParam0, 0, "BARREL", joaat("P_BARREL010X"), 0f, 0f, 0f, 0f, 1);
	func_48(uParam0, 1, "RAMP", joaat("P_WOODBOARD01X"), 0f, 0f, 0f, 0f, 1);
	func_52(uParam0, "WAGON", iLocal_38, vParam1, vParam4.z, 1, 1, 1, 0);
}
...
int func_18(var uParam0)
{
	...
	iLocal_41 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_GET_SCENARIO_POINT_COORDS(iLocal_39, true), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED1_SCENARIO");
	iLocal_42 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_GET_SCENARIO_POINT_COORDS(iLocal_40, true), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED2_SCENARIO");
	return 1;
}
...
bool func_28(var uParam0)
{
	...
	{
		POPULATION::_0xB56D41A694E42E86(iLocal_41, 10208, 0, 0, -1, -1, 0);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_42))
	{
		POPULATION::_0xB56D41A694E42E86(iLocal_42, 10208, 0, 0, -1, -1, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_453))
	{
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_453, 0f);
		return true;
	}
	return false;
}
...
{
	iLocal_39 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(-240.63f, 769.93f, 117.09f, joaat("WORLD_HUMAN_BARCUSTOMER_BEER"), 1f, 0, false);
	iLocal_40 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(-240.34f, 769.04f, 117.09f, joaat("WORLD_HUMAN_BARCUSTOMER_BEER"), 1f, 0, false);
	func_60(&uLocal_9, 0);
	func_61(&uLocal_9, 1);
	func_62(&uLocal_9, 1);
	func_63(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (func_67(uParam0->f_20[iVar1 /*14*/], 0, &uLocal_9, &uVar0, 0, 0))
				{
					TASK::TASK_SMART_FLEE_PED(uParam0->f_20[iVar1 /*14*/], Global_35, -1f, -1, 0, 1077936128 /* Float: 3f */, 0);
					func_68(uParam0);
					if (!uParam0->f_469[6])
					{
	...
	if (!uParam0->f_469[2])
	{
		if (func_70(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
		{
			func_68(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[6])
		{
			if (func_71(uParam0, fLocal_37, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				func_69(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
	...
	if (uParam0->f_469[2])
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
			{
				...
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], iLocal_39, 0, 0, true, false, 0, false, -1f, false);
		...
		if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
			{
				...
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], iLocal_40, 0, 0, true, false, 0, false, -1f, false);
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
void func_52(var uParam0, char* sParam1, int iParam2, vector3 vParam3, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
bool func_67(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_102(iParam0, uParam2, *uParam3);
				return true;
			}
		}
		if (Global_1935630.f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_104(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_102(iParam0, uParam2, *uParam3);
					return true;
		...
		if (Global_1935630.f_26 && func_106(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_107(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_108(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_102(iParam0, uParam2, *uParam3);
						return true;
				...
				{
					if (func_109(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_102(iParam0, uParam2, *uParam3);
						return true;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_110(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_102(iParam0, uParam2, *uParam3);
					return true;
			...
			else if (func_110(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_102(iParam0, uParam2, *uParam3);
				return true;
		...
		if (Global_1935630.f_30 || Global_1935630.f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_113(uParam2, 4000))
				{
					if ((func_114(iParam0, Global_1935630.f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_115(uParam2, iParam0)) && func_116(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_102(iParam0, uParam2, *uParam3);
						return true;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_114(iParam0, Global_1935630.f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_115(uParam2, iParam0)) && func_116(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_102(iParam0, uParam2, *uParam3);
					return true;
				...
				if (Global_1935630.f_40 == 0)
				{
					if (Global_1935630.f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_117(iParam0, Global_1935630.f_41))
							{
								func_118();
								*uParam3 = 2;
								func_102(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_119(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_120() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630.f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_121())
					{
						if (func_117(iParam0, Global_1935630.f_42))
						{
							func_118();
							*uParam3 = 2;
							func_102(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_123(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_102(iParam0, uParam2, *uParam3);
					return true;
...
void func_69(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	func_131(iParam0);
	func_132(iParam0, vParam1);
	Global_32074.f_2697.f_6[iParam0 /*6*/]++;
	Global_32074.f_2697.f_2++;
}

bool func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_136(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
			{
				...
				fVar8 = func_137(Global_35, uParam0->f_20[iVar0 /*14*/], 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_71(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_137(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_0x5102307CE88798EB(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_138(&(uParam0->f_490)))
							{
								func_142(&(uParam0->f_490), 0);
							}
...
bool func_77(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_91(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_157(iParam1))
		{
			func_158(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_100(var uParam0, bool bParam1, int iParam2)
{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_165(uParam0))
			{
				uParam0->f_15 = func_120();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_120() - uParam0->f_15) > 500)
			{
...
bool func_107(var uParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
bool func_108(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_109(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_110(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_128(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_120();
	}
	else if (func_120() - uParam1->f_4) > func_200(uParam1)
	{
		return func_201(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_131(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_202(0, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				func_202(1, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_202(60, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_132(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
float func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_203(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
bool func_147(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_170(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_190(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_220(iVar0, 0)))
		{
...
bool func_175(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_182(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_185(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_186(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_190(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_191(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_197(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
void func_202(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_222(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_224(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
