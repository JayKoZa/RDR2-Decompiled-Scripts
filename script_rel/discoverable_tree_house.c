		...
		case 1:
			...
			else if (func_128(iParam0, 3))
			{
				if (iParam0->f_109 < 1)
				{
					...
					MAP::_0x0C7A2289A5C4D7C9(1715123483, &(iParam0->f_103[0]));
				}
				iParam0->f_111 = 0;
...
int func_98(int iParam0, int iParam1)
{
	...
	uVar0 = func_97(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_97(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_101()
{
	...
	if (!func_156(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
...
int func_148(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_143(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
