...
void func_73()
{
	...
	{
		if (((!bLocal_351 && AUDIO::_0xBE28DB99556FF8D9(iVar1) != 0) && !func_162(iVar0, 0)) && PED::_IS_PED_USING_SCENARIO_HASH(iVar1, joaat("PROP_HUMAN_PIANO_SKETCHY")))
		{
		...
		else if (bLocal_351 && !PED::_IS_PED_USING_SCENARIO_HASH(iVar1, joaat("PROP_HUMAN_PIANO_SKETCHY")))
		{
			bLocal_351 = false;
		}
	}
