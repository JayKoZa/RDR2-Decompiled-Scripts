...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6125f, 0.95f, 0.125f, 0f, 4.9975f, 5.955f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, 2.975f, 9.725f, 0.075f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
...
void func_393(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_220(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_220(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_220(iParam5, 32), true);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
