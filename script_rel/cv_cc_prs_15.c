...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6125f, 0.95f, 0.125f, 0f, 4.9975f, 5.955f, 3.2075f, -1612834106, -1386303207, 1, 1, 1);
	func_151(uParam0, 2.975f, 9.725f, 0.075f, 0f, 1.2f, 1.2f, 3.2075f, -1612834106, -1689743484, 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@pearson_15@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@pearson_15@Action", 0, 0, 1, 0);
	func_154(uParam0, "CPS15AU");
	func_155(uParam0, iLocal_14, 3, -1489483851, 0, -1, 1);
	func_156(uParam0, iLocal_14, 3, -1489483851, 0, -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_204(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_206(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_207(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_207(iParam0, 0));
					func_208(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_244(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_251(func_148(uParam0), func_250(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
			Var0 = { func_252(func_148(uParam0), func_250(uParam0, iParam1), func_19(uParam0), 1) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_205((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
Vector3 func_251(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_252(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
						...
						case 310:
							...
							switch (iParam1)
							{
								...
								case 14:
									...
									{
										case 156:
											return func_322(2329.663f, 1347.464f, 104.5794f, 155.2611f);
										default:
											break;
									}
									break;
								case 1:
									switch (iParam2)
									{
										...
										case 156:
											return func_322(2330.225f, 1345.275f, 104.7174f, 21.2991f);
										default:
											break;
									}
									break;
							...
							switch (iParam1)
							{
								...
								case 4:
									...
									{
										case 669:
											return func_322(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
										default:
											break;
									}
									break;
...
struct<4> func_322(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
int func_357(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_237(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_205(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_202(vVar0)) && !func_203(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_205(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_393(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_220(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_220(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_220(iParam5, 32), 1);
...
int func_414(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_205(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(747937920, 1) && !func_385(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
