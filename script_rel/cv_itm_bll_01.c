...
int func_76(var uParam0)
{
	...
	func_161(uParam0, iLocal_14, 3, -1395525444, "PROP_HUMAN_SEAT_CHAIR_GROOMING_GROSS_MALE_B", uLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_209(var uParam0)
{
	...
	{
		iLocal_64 = func_326("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_378(-1780177928 /* GXTEntry: "Revolver Cartridges - High Velocity" */);
		...
		case 2:
			...
			uParam0->f_22 = func_378(1627068364 /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_378(-1635450397 /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_378(-755485480 /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_378(-951828978 /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_378(-2076104686 /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_378(1478239863 /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_378(338147422 /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_378(1483206625 /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_378(-898386032 /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_378(730856618 /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_378(230530039 /* GXTEntry: "Health Cure" */);
...
void func_317(int iParam0)
{
	...
	{
		case 9:
			if (func_379(1427759409 /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_380();
...
void func_318(var uParam0)
{
	...
	uVar1 = func_383(*uParam0);
	iVar2 = MISC::GET_HASH_KEY(func_384(uParam0->f_3));
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(9, uVar0, func_385(func_24()), 1307979820, func_386(*uParam0), 0);
		UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(9, uVar0, iVar2, 1997120069);
		UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(9, uVar0, uVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_387(1, 688258043 /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_387(2, -1477273558 /* GXTEntry: "Peppermint" */, 0);
			func_387(3, 128702355 /* GXTEntry: "Milkweed" */, 0);
			func_387(4, 1613651027 /* GXTEntry: "Hair Pomade" */, 0);
			func_387(5, 0, -998653403 /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_321(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_393(&uVar4, joaat("COLOR_PURE_WHITE"));
		sVar2 = func_394(uParam0->f_3, 0);
		func_388(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, MISC::_CREATE_VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_388(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, HUD::_GET_LABEL_TEXT_BY_HASH(iVar0), 0, bParam1, 0);
	}
}
...
int func_326(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_217(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_395(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_338()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_401(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_373(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_430(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_434(bool bParam0, int iParam1)
{
	...
	if (func_476(bParam0, 1399091007))
	{
		func_477(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
void func_477(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_481(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_515(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
{
	return func_517(joaat("character"), func_538(), -1591664384, bParam0);
}

struct<4> func_517(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_436(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_545(bParam0, &Var0, iVar5, 0))
			{
				...
				{
					Var29 = { func_517(bParam0, Var0, iVar5, 0) };
...
struct<5> func_543(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_433(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_517(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_517(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
int func_558(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_517(bParam0, Param1, iParam5, bParam6) };
...
int func_559(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_436(0);
	*uParam1 = { func_517(bParam0, func_479(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
