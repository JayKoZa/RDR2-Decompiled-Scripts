...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	...
	func_161(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_WRITE_NOTEBOOK"), "WORLD_HUMAN_WRITE_NOTEBOOK_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_218(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_256()
{
	...
	if (func_344(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_257()
{
	...
	if (func_344(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_263(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_346(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_283(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_284(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_301(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_306(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_365(joaat("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_365(joaat("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_365(joaat("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_365(joaat("CONSUMABLE_MEDICINE"));
...
void func_313(int iParam0)
{
	...
	{
		case 9:
			if (func_366(joaat("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_367();
...
void func_314(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_372(func_24()), 1307979820 /* GXTEntry: "Camp Item Request" */, func_373(*uParam0), 0);
...
bool func_322(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_349(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_375(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(8, func_369(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
			UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, iVar0);
			Global_1359489.f_361.f_194 = func_424("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_371(uParam0->f_3)), joaat("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", joaat("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
bool func_377(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
char* func_381(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_344(joaat("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
bool func_403(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_54(iParam0))
	{
		return false;
...
bool func_454(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return false;
...
void func_456(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_235(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_235(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_235(iParam5, 32), true);
...
bool func_457(int iParam0, int iParam1)
{
	...
	bVar0 = func_506(iParam0, iParam1);
	return bVar0;
}
...
struct<4> func_470(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_514(923904168, func_513(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_514(923904168, func_513(bParam0), -740156546, 0) };
		}
...
bool func_472(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_483(int iParam0, char* sParam1)
{
...
bool func_485(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_489(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_344(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_432(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_512(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(iVar0) || WEAPON::_IS_WEAPON_MELEE(iVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43891 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_532(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_532(iVar0))
		{
...
struct<4> func_514(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
		...
		while (iVar28 < 4)
		{
			...
			if (func_544(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_547(0))
				{
					...
					func_548(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_542(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_419(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_514(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_552(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_544(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_544(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_545(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_514(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_544(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_557(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_545(int iParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_558(iParam0, &uVar0, uParam1, iParam2))
	{
...
bool func_546(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_549(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_561(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	if (func_554(iParam0) == 1779021115)
	{
		return false;
	}
...
struct<4> func_553(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_514(271701509, func_513(bParam0), 12999093, 0) };
		}
...
int func_557(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
bool func_558(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_422(0);
	*uParam1 = { func_514(iParam0, func_470(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return false;
	}
