...
{
	func_33(uParam0, 10870, 10921, 11624);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "MOOSE_SLIPPING", "script@ambient@animal@moose_fall_on_ice@action", vParam1, vParam4);
	...
	iLocal_9 = joaat("A_C_MOOSE_01");
	func_49(uParam0, 0, "MOOSE", iLocal_9, 0f, 0f, 0f, 0f, iVar0, 1, 1, 1, iLocal_41, 1);
}
...
bool func_28(var uParam0)
{
	...
	PED::_0xF7EA250B9A919E03(515906784, uParam0->f_20[0 /*14*/]);
	if (!PED::_0x854BC9B1A1CCD034(-1918659017, uParam0->f_20[0 /*14*/]) || !PED::_0x854BC9B1A1CCD034(515906784, uParam0->f_20[0 /*14*/]))
	{
		return false;
	}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (func_64(uParam0, &uLocal_10, 0) || func_65(Global_35, uParam0->f_20[0 /*14*/], 1) <= 225f)
			{
				bLocal_42 = true;
			}
		}
	...
	if (!uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[5])
			{
				if (func_73(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[5] = 1;
				}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINRUN")))
							{
								...
								TASK::TASK_SMART_FLEE_COORD(uParam0->f_20[0 /*14*/], uParam0->f_20[0 /*14*/].f_5, -1f, -1, false, 2f);
...
int func_32(var uParam0, var uParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		PED::_0xAE6004120C18DF97(uParam0->f_20[0 /*14*/], 0, 1);
	}
...
bool func_64(var uParam0, var uParam1, bool bParam2)
{
