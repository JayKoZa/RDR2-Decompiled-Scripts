...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_65("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_65("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
		}
...
int func_78(int iParam0, int iParam1)
{
	...
	uVar0 = func_77(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_77(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_81()
{
	...
	if (!func_114(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
...
int func_106(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_101(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
...
int func_131(int iParam0, int iParam1)
{
	...
	if (!func_165(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
int func_172(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
