...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, 1.95f, 0f, 0f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_158(uParam0, iLocal_17, 2, joaat("STAND"), 0, -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, "BJCK5AU");
	iLocal_18 = func_160(uParam0, 0f, 5f, 0f, 0f, 0f, 0f, 8f, 7f, 5f, "volTrigger", joaat("VOLBOX"));
	func_161(uParam0, 1);
