...
{
	STREAMING::_0x66BC28E50E85270E(uLocal_19);
...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.4499f, 0.2499f, 0f, 86.5f, 3.06f, 3.405f, 5f, -1612834106, -1386303207, 1, 1, 1);
	...
	func_153(uParam0, 639063781, 0f, 0f, 0f, "MEAT", 0, 0, 1);
	iLocal_17 = func_153(uParam0, 1433326914, 5f, 5f, 5f, 0, 0, 0, 0);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(1939042559, 1, 0, 0);
	func_157(uParam0, iLocal_15, 3, -1137910248, "WORLD_ANIMAL_DOG_BEGGING", -1, 1);
...
{
	uLocal_19 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_14), 1939042559, 262145, 577766380);
	return 1;
}
...
{
	func_154(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
...
var func_160(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	var uVar0;
	vector3 vVar1;
		...
		case 1:
			switch (iParam0)
			{
				...
				case 10:
					...
					Jump @1186; //curOff = 746
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					Jump @1186; //curOff = 772
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar1[2] = -1862464078;
					iVar7 = 3;
