...
{
	func_33(uParam0, 11319, 11385, 11700);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar1 = func_48(joaat("HORSE_CLASS_RIDING"), 1);
	...
	{
		case 0:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			uParam0->f_19 = 4;
			break;
		case 1:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.75f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, -1f, 0f), (25f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			uParam0->f_19 = 5;
			break;
		case 2:
			func_50(uParam0, 0, "RNP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "RNP_MAN_2", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.75f, 1.25f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 2, "RNP_MAN_3", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1.75f, 0.75f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 3, "RNP_HORSE_1", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 4, "RNP_HORSE_2", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, -1f, 0f), (25f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 5, "RNP_HORSE_3", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2.75f, -1.6f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		TASK::_TASK_SMART_FLEE_STYLE_PED(0, Global_35, 1, 524288, -1082130432 /* Float: -1f */, -1, 0);
...
bool func_78(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_118(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_92(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_128(iParam1))
		{
			func_129(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_101(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_140(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_106(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
...
bool func_118(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_143(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
void func_164(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_118(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
