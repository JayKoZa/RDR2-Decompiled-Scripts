...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.45f, -0.6f, 0f, 0f, 1.15f, 1.18f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
