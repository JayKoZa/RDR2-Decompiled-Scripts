...
int func_18(var uParam0)
{
	...
	if (uParam0->f_489 == 0)
	{
		if (!STREAMING::HAS_MODEL_LOADED(1046022891))
		{
			return 0;
		}
	}
...
int func_30(var uParam0)
{
	if (uParam0->f_489 == 0)
	{
		STREAMING::REQUEST_MODEL(1046022891, false);
	}
	if (iLocal_43 != 0)
	{
...
int func_53(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	...
	uVar1 = func_98(uParam0, iParam1, uVar0, iParam2);
	func_5(uVar0);
	return uVar1;
}
...
int func_56(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!_NAMESPACE48::_0x800DF3FC913355F3(func_104(iParam0)))
	{
		func_107(iParam0, 0);
		return 0;
	}
	...
	if (!func_7(vVar0))
	{
		_NAMESPACE48::_0x59C7AD6FEA2AC449(func_104(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = _NAMESPACE48::_0x08FC896D2CB31FCC(func_104(iParam0), 0);
	}
	else
	{
		iVar3 = _NAMESPACE48::_0x0CADC3A977997472(func_104(iParam0), 0);
	}
	if (!func_7(vVar0))
	{
		_NAMESPACE48::_0xBB68908CD11AEBDC(func_104(iParam0));
	}
...
int func_98(var uParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_107(int iParam0, bool bParam1)
{
	...
	{
		func_156(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_99(iParam0)));
		if (func_96() == -1)
		{
			if (func_48(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_104(iParam0));
				func_145(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_104(iParam0));
		}
		return 0;
	}
	...
	func_156(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_99(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_104(iParam0));
	if (func_48(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_104(iParam0));
		func_145(iParam0, 2048);
...
bool func_108(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_104(iParam0));
}
...
int func_109(int iParam0)
{
	...
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_104(iParam0));
		if (!ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::_0x0CADC3A977997472(func_104(iParam0), 0)))
		{
			return 0;
		}
	}
...
int func_147(int iParam0, bool bParam1)
{
	...
	func_146(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_104(iParam0));
	func_156(iParam0, 0);
	return 1;
}
...
int func_219(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_236(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
