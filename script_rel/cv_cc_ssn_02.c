...
int func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		...
		{
			uLocal_42 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY((uParam0->f_1711[iLocal_19 /*15*/])->f_10, joaat("prop_human_seat_bench"), 0f, 0f, 0.5f, 160f, 0, 0, 0);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(func_48(uParam0, iLocal_14), 0, 1);
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), uLocal_42, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", 0, 0, true, 0, 0, -1082130432, 0);
...
{
	if (!PED::_0x9C54041BB66BCF9E(func_48(uParam0, iLocal_14), uLocal_42))
	{
		return 1;
	}
	return 0;
