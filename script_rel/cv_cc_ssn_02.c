...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.846151f, 0.412679f, 1.05988f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, -0.0243275f, 0.117172f, 0.549988f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	iLocal_40 = func_161(uParam0, 5.1001f, 1.0375f, 0f, 0f, 0f, 0f, 11.6375f, 3.7475f, 3f, "InitialTrigger", joaat("VOLBOX"));
	return true;
}
...
bool func_93(var uParam0)
{
	...
	if (bLocal_41)
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(func_48(uParam0, iLocal_14)))
		{
			...
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), iLocal_42, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", 0, false, true, 0, false, -1f, false);
...
{
	if (!PED::_IS_PED_USING_SCENARIO_POINT(func_48(uParam0, iLocal_14), iLocal_42))
	{
		return true;
	}
	return false;
...
bool func_194(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_262(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_335(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
void func_344(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_386(iParam1))
		{
			func_387(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_377(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_408(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_427(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_428(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_456(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_474(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_475(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_483(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_487(0))
				{
					...
					func_488(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_481(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_493(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_485(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_495(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_483(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_483(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_484(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_485(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_483(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_500(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_484(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_485(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_486(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_489(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_506(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_494(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_485(923904168, func_492(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_485(923904168, func_492(bParam0), -740156546, 0) };
		}
...
struct<4> func_496(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_485(271701509, func_492(bParam0), 12999093, 0) };
		}
...
bool func_499(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_501(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
