			...
			switch (iLocal_176)
			{
				case 1:
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_259))
					{
						...
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 16, 1);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 18, 1);
						bVar0 = true;
					}
					break;
				case 0:
	...
	if ((func_104(&iLocal_255, iLocal_17, func_103(), 119.5846f, 1, 0, 1) && func_106(&iLocal_257, iLocal_18, func_105(iLocal_18))) && func_106(&iLocal_258, iLocal_19, func_105(iLocal_19)))
	{
		if (func_36(iLocal_255, 0))
		{
			if (!func_8(iLocal_182, 16777216))
			{
				...
				ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iLocal_255, func_103(), 197.2573f, 1, 0, 1);
...
void func_25()
{
	...
	PED::_0x406CCF555B04FAD3(iLocal_255, 1, 1065353216);
	if (!func_8(iLocal_182, 131072))
	{
		...
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_278, 23, 1);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_278, 25, 1);
		func_116(&uLocal_268);
...
int func_156(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	var uVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		uVar5 = func_259(*iParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
			PED::SET_PED_CONFIG_FLAG(*iParam0, 178, false);
			return 1;
...
int func_254(var uParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	var uVar0;
	int iVar1;
	int iVar2;
