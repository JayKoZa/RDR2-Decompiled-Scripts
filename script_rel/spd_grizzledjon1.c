...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if ((iLocal_175 >= 3 && iLocal_175 <= 7) && !func_15(iLocal_255, 0))
		{
			...
			{
				func_16(&iLocal_255, &uLocal_195, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 5f, 5f);
			}
		}
	...
	else if (!func_8(iLocal_182, 4194304))
	{
		if (func_8(iLocal_182, 8388608))
		{
			if (MISC::GET_GAME_TIMER() >= iLocal_191 + 1800)
			{
				...
				{
					if (func_58(iLocal_255, "CHALLENGE_THREATEN", joaat("SPEECH_PARAMS_SHOUTED"), 0, 1, 0, 0, 1))
					{
	...
	if (func_8(iLocal_182, 128))
	{
		if (!func_8(iLocal_182, 16384))
		{
			if (PED::IS_PED_IN_COMBAT(iLocal_255, 0))
			{
				...
				if (!MAP::DOES_BLIP_EXIST(iLocal_256))
				{
					iLocal_256 = func_64(iLocal_255, joaat("BLIP_STYLE_ENEMY"), 1, 1);
				}
...
void func_19()
{
	...
	if ((((((HUD::_TEXT_DATABASE_HAS_LOADED("SPGJAU") && HUD::_TEXT_DATABASE_HAS_LOADED("SPGJ")) && STREAMING::HAS_MODEL_LOADED(iLocal_17)) && STREAMING::HAS_MODEL_LOADED(iLocal_18)) && STREAMING::HAS_MODEL_LOADED(iLocal_19)) && (iLocal_176 != 1 || STREAMING::HAS_MODEL_LOADED(iLocal_20))) && PED::_0x5C16855277819BBF() == 1)
	{
		if (iLocal_176 == 1)
		{
			if (iLocal_279 == 0)
		...
		if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_277))
		{
			switch (iLocal_176)
			{
				...
				case 0:
					if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_277))
					{
						iLocal_277 = TASK::CREATE_SCENARIO_POINT(joaat("SPECIAL_PED_GJ02_STAND_BAR_DRINKING"), -313.1921f, 809.0455f, 117.978f, -170f, 0, 0, 1);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 16, true);
						TASK::_SET_SCENARIO_POINT_FLAG(iLocal_277, 18, true);
						bVar0 = true;
					}
...
void func_20()
{
	if ((func_104(&iLocal_255, iLocal_17, func_103(), 119.5846f, 1, 0, 1) && func_106(&iLocal_257, iLocal_18, func_105(iLocal_18))) && func_106(&iLocal_258, iLocal_19, func_105(iLocal_19)))
	{
		if (func_36(iLocal_255, 0))
		{
			...
			{
				case 1:
					TASK::_TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_277, "SP_GJ01_SEAT_CHAIR_TABLE_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
				case 0:
					TASK::_TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_277, "SP_GJ02_STAND_BAR_DRINKING", 0, true, true, 0, false, -1f, false);
					break;
			}
			iLocal_177 = 0;
			iLocal_184 = MISC::GET_GAME_TIMER() + 4000;
			if (PED::_IS_PED_USING_SCENARIO_POINT(iLocal_255, iLocal_277))
			{
				func_57(3);
			}
		}
...
void func_24()
{
	...
	{
		if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_189, true, false) && func_119(&uLocal_274, 4f))
		{
			func_120();
	...
	{
		if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_189, false) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_189) > 0.9f)
		{
...
void func_25()
{
	...
	if (!func_8(iLocal_182, 131072))
	{
		...
		iLocal_278 = TASK::CREATE_SCENARIO_POINT(joaat("WORLD_HUMAN_DRUNK_PASSED_OUT_FLOOR"), -316.4402f, 805.7891f, 116.855f, -170f, 0, 0, 0);
	...
	else if (!func_8(iLocal_182, 524288))
	{
		...
		if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_255, 713668775, true) == 8 && MISC::GET_GAME_TIMER() >= iLocal_184)
		{
			func_120();
			PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_255, true);
			TASK::_TASK_USE_SCENARIO_POINT(iLocal_255, iLocal_278, 0, -1, true, false, 0, false, -1f, false);
...
void func_26()
{
	...
	if (PED::IS_PED_IN_COMBAT(iLocal_255, 0))
	{
		...
		if (!func_8(iLocal_182, 33554432))
		{
			...
			{
				LAW::_0xFFEBE5AA96BC2E4E(iLocal_255, joaat("CRIME_ASSAULT"), 1);
				LAW::_0xFFEBE5AA96BC2E4E(iLocal_255, joaat("CRIME_UNARMED_ASSAULT"), 1);
...
void func_27()
{
	...
	if (!PED::IS_PED_FLEEING(iLocal_255))
	{
		...
		TASK::_TASK_SMART_FLEE_STYLE_PED(iLocal_255, Global_35, 6, 128, -1082130432 /* Float: -1f */, -1, 0);
	}
	else if (!func_8(iLocal_182, 1073741824 /* Float: 2f */))
	{
		if (func_128(iLocal_255, "IGNORING_YOU", joaat("SPEECH_PARAMS_FORCE_SHOUTED"), 0, "GRIZZLED_JON", 0))
		{
...
void func_40(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (((ENTITY::HAS_ANIM_EVENT_FIRED(iLocal_255, iParam2) || ((bParam4 && TASK::_0x916B8E075ABC8B4E(iLocal_255, 1)) && MISC::GET_GAME_TIMER() >= iLocal_197)) || (!TASK::IS_PED_ACTIVE_IN_SCENARIO(iLocal_255, 0) && !TASK::_0x0C3CB2E600C8977D(iLocal_255, 0))) || iLocal_175 == 7)
		{
			if (ENTITY::IS_ENTITY_ATTACHED(iParam0))
			{
...
void func_113()
{
	...
	func_231(&(Local_140[1 /*17*/]), "INTERACT_INSULT", sVar0, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, iVar1);
...
bool func_302(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_37(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
void func_340(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_390(iParam1))
		{
			func_108(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_346(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_268(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_275(iParam1))
		{
			...
			iParam1->f_6 = func_398(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_268(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_398(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_402(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_408(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
