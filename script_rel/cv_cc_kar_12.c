...
int func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_14, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_203(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_205(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_206(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_206(iParam0, 0));
					func_207(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_243(iParam1) + Vector(fParam4, fParam3, fParam2) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_204((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
void func_185(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_281(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar2 /*113*/])->f_5, true, false));
				iVar1 = func_281((uParam0->f_107[iVar2 /*113*/])->f_96);
				if (iVar0 || iVar1)
				{
...
int func_352(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_236(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_204(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_201(vVar0)) && !func_202(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_204(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_388(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_219(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_219(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_219(iParam5, 32), 1);
...
int func_409(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_204(iParam0, 1));
