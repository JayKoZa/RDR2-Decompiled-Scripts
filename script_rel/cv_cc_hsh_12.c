...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.7301f, 0.5311f, 0.5295f, -0.2848f, 2.2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, -1.0257f, 0.9388f, 1.0341f, 0f, 0.72f, 0.72f, 3f, joaat("VOLCYLINDER"), 1);
