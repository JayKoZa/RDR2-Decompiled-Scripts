...
int func_72(var uParam0)
{
	...
	{
		func_161(uParam0, iLocal_15, 3, -442037069, "WORLD_HUMAN_SIT_BACK_EXHAUSTED_MALE_A", -1, 0, 100f, 1065353216 /* Float: 1f */, 1);
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_478(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_480(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_481(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
int func_490(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_507(bParam0, &uVar0, uParam1, iParam2))
	{
...
void func_495(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_512(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	if (func_503(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_514(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_507(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_509(0);
	*uParam1 = { func_491(bParam0, func_500(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
