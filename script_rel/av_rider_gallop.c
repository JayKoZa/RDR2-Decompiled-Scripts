...
{
	func_33(uParam0, 10740, 10749, 11147);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "RIDER_GALLOP", "", vParam1, vParam4);
	uVar0 = func_48(func_47(), 1, 1, 1, 1, 0, 1);
	uVar1 = func_49(997958153 /* GXTEntry: "Riding" */, 1);
	func_50(uParam0, 0, "RGP_HORSE", uVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "RGP_MAN", uVar0, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_58(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				...
				func_59(&(uParam0->f_20[0 /*14*/]), (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 2, 1073741824 /* Float: 2f */);
			...
			break;
		case 1:
			if (func_62(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					if (uParam0->f_489 == 1)
					{
						TASK::_TASK_MOVE_IN_TRAFFIC(&(uParam0->f_20[1 /*14*/]), 0.55f, 128, 0);
					}
					else
					{
						TASK::_TASK_MOVE_IN_TRAFFIC(&(uParam0->f_20[1 /*14*/]), 2.5f, 256, 0);
					}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_70(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar2 = func_75(*uParam0);
	iVar3 = func_76(*uParam0);
	iVar4 = func_77(*uParam0);
...
void func_50(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_51(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_82(&(Global_1898164->f_1[0 /*5*/]));
		if (func_83(iVar0) && func_84(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_54()
{
	return (Global_1894899 & 1 != 0 && func_68() != -1);
}
...
int func_58(var uParam0, int iParam1, int iParam2, int iParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
void func_59(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_88(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_89(iParam0))
	{
		if (func_90(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(iParam0);
		}
	}
	if (func_91(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_91(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_91(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_91(iParam5, 32), 1);
	...
	else if (func_91(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_91(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_91(iParam5, 64))
		{
...
int func_60(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return 0;
...
int func_62(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_95(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_96(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_67(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_70(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_71(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_104(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_72(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_104(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
bool func_87(vector3 vParam0, vector3 vParam3)
{
...
float func_96(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
void func_100(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_121(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_121(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_121(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_104((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
void func_121(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
