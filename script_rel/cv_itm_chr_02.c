...
int func_1(var uParam0)
{
	if (!bLocal_43)
	{
		if (uParam0->f_9 && TASK::_DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23))
		{
			...
			TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iLocal_14 /*113*/])->f_5, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_2, 0, 0, true, 0, 0, 1f, 0);
	...
	else if (uParam0->f_2248)
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			else if (TASK::_DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iVar0 /*113*/])->f_8.f_23))
			{
				...
				TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iVar0 /*113*/])->f_5, (uParam0->f_107[iVar0 /*113*/])->f_8.f_23, (uParam0->f_107[iVar0 /*113*/])->f_8.f_2, 0, 0, true, 0, 0, -1f, 0);
...
int func_269(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	if (!(uParam0->f_107[iParam1 /*113*/])->f_8.f_20)
	{
		if (func_140(&((uParam0->f_107[iParam1 /*113*/])->f_8.f_17)) >= (uParam0->f_107[iParam1 /*113*/])->f_8.f_15)
		{
			if (TASK::_DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iParam1 /*113*/])->f_8.f_23))
			{
				if (!PED::_0x9C54041BB66BCF9E((uParam0->f_107[iParam1 /*113*/])->f_5, (uParam0->f_107[iParam1 /*113*/])->f_8.f_23))
				{
					TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iParam1 /*113*/])->f_5, (uParam0->f_107[iParam1 /*113*/])->f_8.f_23, (uParam0->f_107[iParam1 /*113*/])->f_8.f_2, 0, 1, false, (uParam0->f_107[iParam1 /*113*/])->f_8.f_1, (uParam0->f_107[iParam1 /*113*/])->f_8.f_16, -1f, 0);
...
int func_290(var uParam0, int iParam1)
{
	...
	TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iParam1 /*113*/])->f_5, (uParam0->f_107[iParam1 /*113*/])->f_8.f_23, (uParam0->f_107[iParam1 /*113*/])->f_8.f_2, 0, 0, true, 0, 0, -1f, 0);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		...
		case 2:
			...
			uParam0->f_22 = func_369(1627068364 /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_369(-1635450397 /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_369(-755485480 /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_369(-951828978 /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_369(-2076104686 /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_369(1478239863 /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_369(338147422 /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_369(1483206625 /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_369(-898386032 /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_369(730856618 /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_369(230530039 /* GXTEntry: "Health Cure" */);
...
void func_319(var uParam0)
{
	...
	uVar0 = func_373(*uParam0);
	uVar1 = func_374(*uParam0);
	iVar2 = MISC::GET_HASH_KEY(func_375(uParam0->f_3));
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(9, uVar0, func_376(func_26()), 1307979820, func_377(*uParam0), 0);
		UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(9, uVar0, iVar2, 1997120069);
		UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(9, uVar0, uVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_378(1, 688258043 /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_378(2, -1477273558 /* GXTEntry: "Peppermint" */, 0);
			func_378(3, 128702355 /* GXTEntry: "Milkweed" */, 0);
			func_378(4, 1613651027 /* GXTEntry: "Hair Pomade" */, 0);
...
int func_423(bool bParam0, int iParam1)
{
	...
	if (func_470(bParam0, 1399091007))
	{
		func_471(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_442(var uParam0, int iParam1)
{
	...
	TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iParam1 /*113*/])->f_5, iVar7, 0, 0, 1, false, iVar19, 0, -1f, 0);
	return 1;
}
...
void func_459(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_127(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_127(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_127(iParam5, 32), 1);
...
void func_471(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_475(var uParam0, int iParam1, var uParam2, bool bParam3)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_535(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
struct<4> func_517(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_425(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
int func_537(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_547(bParam0, &Var0, iVar5, 0))
			{
				if (func_548(bParam0, &Var6, iVar5))
				{
					...
					func_549(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_550(0))
				{
					...
					func_551(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_552(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
void func_538(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
{
	return func_560(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_548(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_561(bParam0, &uVar0, uParam1, iParam2))
	{
...
int func_549(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_552(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_564(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_555(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_565(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_560(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_561(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_425(0);
	*uParam1 = { func_517(bParam0, func_473(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
