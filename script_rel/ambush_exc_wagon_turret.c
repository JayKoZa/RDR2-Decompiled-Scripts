...
void func_132()
{
	...
	ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(Local_15.f_49[0]), *(vVar3[0 /*3*/]), uVar10, 1, 0, 1);
}
		...
		case 1:
			if (func_47(Local_274.f_16[0 /*3*/], 0.5f) || func_293(Global_35, &(Local_15.f_182[1]), 0, 1))
			{
				...
				if (func_279(3))
				{
					...
					PED::_SET_PED_CROUCH_MOVEMENT(&(Local_15[3]), 0, 0, 0);
		...
		while (iVar28 < 4)
		{
			...
			if (func_451(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_455(0))
				{
					...
					func_456(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_457(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_402(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
