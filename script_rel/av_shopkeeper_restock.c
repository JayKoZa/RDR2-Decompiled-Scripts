...
int func_30(var uParam0)
{
	...
	func_62(uParam0, 0, "MALE_SKELETON", iLocal_41, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_63(&uLocal_12, 0);
	func_64(&uLocal_12, 1);
	func_65(&uLocal_12, 1);
	func_66(&uLocal_12, 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		...
		if (func_74(uParam0, 1065353216 /* Float: 1f */, 9f, 4, 6f, 1112014848 /* Float: 50f */))
		{
			func_71(uParam0);
	...
	if (uParam0->f_469[1])
	{
		if (!uParam0->f_469[3])
		{
			if (func_75(uParam0, 1.3f, 20f, 4, joaat("ACTION"), 0))
			{
				func_72(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
...
bool func_48(var uParam0)
{
	...
	if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(uParam0->f_3.f_1, "p_can01x", &Var0, false, 0, 2))
	{
		...
		{
			iLocal_54 = VOLUME::_CREATE_VOLUME_SPHERE(Var0.f_6, 0f, 0f, 0f, 0.3f, 0.4f, 0.3f);
...
bool func_58(var uParam0, vector3 vParam1)
{
	...
	if (func_110(iVar0, uParam0))
	{
		...
		*uParam0 = func_113(iLocal_40, 0, 0, 0, 1, 1);
		...
		{
			vLocal_50 = { TASK::_GET_SCENARIO_POINT_COORDS(iLocal_55, true) };
		}
		return true;
	}
	return false;
...
void func_59()
{
	iLocal_42[0] = joaat("S_CANCORN01X");
	iLocal_42[1] = joaat("S_CANPEACHES01X");
	iLocal_42[2] = joaat("S_CRACKERS01X");
	iLocal_42[3] = joaat("S_CANBEANS01X");
	iLocal_42[4] = joaat("S_WORMCAN01X");
	iLocal_42[5] = joaat("S_CANPEAS01X");
}
...
int func_204(int iParam0, var uParam1)
{
	...
	{
		return func_260(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_220(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_143(iVar2) != 0 && PERSCHAR::_0x800DF3FC913355F3(func_145(iVar2)))
		{
...
bool func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_249(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_269(iVar0, 0)))
		{
