...
int func_72(var uParam0)
{
	...
	func_158(uParam0, iLocal_14, 2, -195585558, "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, 30f, 1065353216 /* Float: 1f */, 1);
...
var func_356(int iParam0, var uParam1)
{
...
bool func_465(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_483(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_492(bParam0, &Var0, iVar5, 0))
			{
				if (func_493(bParam0, &Var6, iVar5))
				{
					Var29 = { func_494(bParam0, Var0, iVar5, 0) };
					func_495(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_496(0))
				{
					...
					func_497(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_484(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_490(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_502(bParam0))
	{
		...
		case joaat("weapon"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_492(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_492(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_493(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_492(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_509(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_493(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
int func_495(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_498(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_515(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_504(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_517(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_510(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_512(0);
	*uParam1 = { func_494(bParam0, func_503(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
