...
{
	func_33(uParam0, 10910, 10947, 11891);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 1, sVar0, iLocal_47, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_51)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 0.75f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
			...
			if (!uParam0->f_469[4])
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
					{
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 38142), vLocal_40, vLocal_43, true, false, false, false, 2, true, true, false);
						TASK::TASK_PLAY_ANIM(uParam0->f_20[1 /*14*/], sLocal_37, sLocal_39, 8f, -8f, -1, 1, 0f, false, 0, false, 0, false);
						TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_37, sLocal_38, 8f, -8f, -1, 65553, 0f, false, 0, false, "LegsOnlyBird_filter", false);
						uParam0->f_469[4] = 1;
						return 1;
					}
				}
...
bool func_60(var uParam0, var uParam1, bool bParam2)
{
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_142(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_145(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
void func_168(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
