...
void func_8(var uParam0)
{
	...
	switch (Local_24)
	{
		...
		case 8:
			...
			break;
		case 3:
			MISC::_0x59174F1AFE095B5A(joaat("fog"), false, true, true, 60f, false);
		...
		case 5:
			...
			MISC::_0x59174F1AFE095B5A(joaat("thunderstorm"), false, true, true, 60f, false);
			func_25(&(Local_24.f_2));
			func_25(&uLocal_21);
			func_49(&Local_24, 6);
			break;
...
int func_50(int iParam0)
{
	...
	while (iVar0 <= 3)
	{
		iVar1 = iVar0;
		Var2 = { func_101(iVar1) };
		if (!VOLUME::_0x92A78D0BEDB332A3(&(iParam0->f_12[iVar1])))
		{
...
int func_87(int iParam0, int iParam1)
{
	...
	uVar0 = func_86(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_86(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_90()
{
	...
	if (!func_125(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
...
int func_117(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_112(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
