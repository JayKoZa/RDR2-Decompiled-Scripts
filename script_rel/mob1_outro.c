...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_51(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_53(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_58(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_64(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_66(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_67(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_67(iParam0, 0));
					func_68(iParam0);
				}
			}
			else
