	...
	switch (iLocal_120)
	{
		case 0:
			...
			if (func_99(PLAYER::PLAYER_ID(), iLocal_15))
			{
				...
				{
					iLocal_117[0] = func_101("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
					func_102(iLocal_117[0], iLocal_15, 0, 0, 1);
				}
				if (!func_100(iLocal_117[1]))
				{
					iLocal_117[1] = func_101("INTERACT_INSULT", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
...
void func_200(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_216(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
