...
int func_21(var uParam0)
{
	...
	if (func_45(((*Global_1835011)[72 /*74*/])->f_1) == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_15))
		{
			...
			PED::_UPDATE_PED_VARIATION(iLocal_15, 1, 1, 1, 1, 0);
			return 0;
		}
		func_26(1);
		if (!func_47(512))
...
void func_75(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_60(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_60(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_60(iParam5, 32), 1);
...
int func_181(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_194(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_198(0))
				{
					...
					func_199(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
...
struct<4> func_196(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_213(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_197(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_200(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_216(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_205(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_219(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
