...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.2019f, -1.1267f, 0.5f, 0f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 1.1076f, -0.54f, 0.5f, 0f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_PASSED_OUT_TABLE"), "PROP_HUMAN_PASSED_OUT_TABLE_MALE_C", -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(70f, 120f), 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, 4, 5, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_VOMIT"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_199(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_246()
{
	...
	if (func_326(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_247()
{
	...
	if (func_326(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_258(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_329(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
void func_339(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_373(iParam1))
		{
			func_374(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_399(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
void func_401(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_225(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
...
bool func_402(int iParam0, int iParam1)
{
	...
	bVar0 = func_445(iParam0, iParam1);
	return bVar0;
}
...
bool func_420(int iParam0, char* sParam1)
{
...
bool func_422(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_451(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_469(iVar0))
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_480(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_484(0))
				{
					...
					func_485(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_478(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_490(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_482(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_492(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_480(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_480(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_481(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_482(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_486(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_503(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_491(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_482(923904168, func_489(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_482(923904168, func_489(bParam0), -740156546, 0) };
		}
...
struct<4> func_493(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_482(271701509, func_489(bParam0), 12999093, 0) };
		}
...
bool func_496(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_498(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
