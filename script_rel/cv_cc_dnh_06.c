...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3991f, 0.23f, 0f, 0f, 2.5f, 2.5f, 5f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_16 = func_152(uParam0, -437493635, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = func_152(uParam0, joaat("p_pencil01x"), 0f, 0f, 0f, "PENCIL", 0, 0, 1);
	func_153(uParam0, "script@vignette@dutch_and_hosea_6@base", 1, 1, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_a", 2, 0, 1, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_a_int_front", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_a_int_left", 2, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_a_int_back", 2, 0, 0, 1);
	iLocal_22 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_a_int_right", 2, 0, 0, 1);
	iLocal_23 = func_153(uParam0, "script@vignette@dutch_and_hosea_6@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CCDH6AU");
	func_155(uParam0, 844189981, -1491874417);
	func_156(uParam0, iLocal_23, -1, 0.9f);
	func_157(uParam0, iLocal_15, 2, -192175547, "PROP_HUMAN_SEAT_CHAIR_SKETCHING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_24 = { func_161(uParam0, -0.8992f, 0.8759f, 0.7524f, 100.44f, 8f, 0.4f, 0.4f) };
	Local_34 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, 172.5f, 8f, 0.4f, 0.4f) };
	Local_44 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, -115.4f, 8f, 0.8f, 0.4f) };
	Local_54 = { func_161(uParam0, -0.899f, 0.876f, 0.752f, 29.16f, 8f, 0.4f, 0.8f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_200(uParam0, Local_24, 1, 0))
		{
			func_191(uParam0, iLocal_19, 1);
		}
		else if (func_200(uParam0, Local_34, 1, 0))
		{
			func_191(uParam0, iLocal_20, 1);
		}
		else if (func_200(uParam0, Local_44, 1, 0))
		{
			func_191(uParam0, iLocal_21, 1);
		}
		else if (func_200(uParam0, Local_54, 1, 0))
		{
