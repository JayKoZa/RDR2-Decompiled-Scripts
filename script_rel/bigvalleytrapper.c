...
int func_84(int iParam0, bool bParam1)
{
	...
	if (func_136(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_140(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_140(iParam0)))
	{
...
char* func_106(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_185(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_140(iParam0));
	func_139(iParam0, 0);
	return 1;
}
...
void func_146(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_154(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_152(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_191(iVar1, 0);
	func_192(iVar1, 0);
	func_193(iVar1, 0);
	func_194(iVar1, 0);
	func_195(iVar1, iVar0);
	if (iParam4 != 0)
	{
...
bool func_197(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_140(iParam0));
}
