...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 5.1653f, 3.3586f, 0f, -10f, 1f, 1f, 5f, -1612834106, -1689743484, 1, 1, 1);
	func_151(uParam0, 0.6339f, -2.4567f, 0f, 3.7983f, 1f, 1f, 5f, -1612834106, -950285770, 1, 1, 1);
	...
	func_155(uParam0, iLocal_15, 3, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 1.8f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	func_153(uParam0, iLocal_15, 1, 3, 0, 0, 0);
	func_154(uParam0, iLocal_15, 3, -1);
	func_157(uParam0, "script@vignette@susan_3@base", 1, 1, 0, 0);
	iLocal_16 = func_157(uParam0, "script@vignette@susan_3@action_a", 2, 0, 1, 0);
	iLocal_17 = func_157(uParam0, "script@vignette@susan_3@action_b", 0, 0, 0, 0);
	iLocal_18 = func_157(uParam0, "script@vignette@susan_3@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = func_157(uParam0, "script@vignette@susan_3@action_b_alt_back", 0, 0, 0, 1);
	func_158(uParam0, "CSSN3AU");
	Local_20 = { func_159(uParam0, -0.0669f, 1.7103f, 1.0237f, -10.08f, 8f, 0.7f, 0.5f) };
	Local_30 = { func_159(uParam0, -0.2437f, 1.4726f, 1.0087f, 97.0791f, 8f, 0.8f, 0.5f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, Local_30, 1, 0))
		{
			func_189(uParam0, iLocal_19, 1);
		}
		else if (func_198(uParam0, Local_20, 1, 0))
		{
	...
	if (func_199(uParam0, iLocal_15))
	{
		...
		TASK::TASK_LOOK_AT_ENTITY(func_48(uParam0, iLocal_15), func_48(uParam0, iLocal_14), 2500, 16, 51, 1);
	}
	return 1;
}
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
...
int func_384(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_419(iParam0, func_280());
