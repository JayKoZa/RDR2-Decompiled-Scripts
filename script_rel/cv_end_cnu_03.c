...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.625f, 0.4125f, 0f, 0f, 2.4425f, 3.0175f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SHARPEN_AXE"), "PROP_HUMAN_SEAT_CHAIR_SHARPEN_AXE_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_C", iLocal_20, 0, 15f, 1065353216 /* Float: 1f */, 1);
...
int func_248()
{
	...
	if (func_325(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_249()
{
	...
	if (func_325(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_257(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_327(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_296(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_301(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_362(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_397(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
void func_399(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_227(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_227(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_227(iParam5, 32), true);
...
bool func_400(int iParam0, int iParam1)
{
	...
	bVar0 = func_443(iParam0, iParam1);
	return bVar0;
}
...
bool func_418(int iParam0, char* sParam1)
{
...
bool func_420(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_421(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_424(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_449(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_469(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_470(iParam0, &iVar0, &fVar25);
...
bool func_478(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
bool func_481(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_484(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_501(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_489(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_480(923904168, func_487(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_480(923904168, func_487(bParam0), -740156546, 0) };
		}
...
struct<4> func_491(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_480(271701509, func_487(bParam0), 12999093, 0) };
		}
...
bool func_494(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_496(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
