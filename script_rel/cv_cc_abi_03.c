...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, 6.1735f, 1.7607f, 0.9346f, 153.9932f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_BROOM_PUTDOWN"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_200(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_337(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_378(iParam1))
		{
			func_379(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
