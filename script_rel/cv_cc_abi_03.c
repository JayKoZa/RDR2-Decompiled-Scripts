...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, 6.1735f, 1.7607f, 0.9346f, 153.9932f, 1f, 1f, 3f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_16 = func_153(uParam0, joaat("p_broom02x"), 0f, 0f, 0f, "BROOM", 0, 0, 1);
	func_154(uParam0, "script@vignette@abigail_3@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@abigail_3@action", 0, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@abigail_3@base_exit", 1, 0, 0, 0);
	func_155(uParam0, "CAB3AUD");
	func_156(uParam0, iLocal_14, 3, 0);
	func_157(uParam0, iLocal_14, 3, 704531824, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_295(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
...
int func_200(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_201(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_303(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_207(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_200(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
void func_258(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_304(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_314()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_358(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_328(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_364(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_348(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_387(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_364(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_394(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
