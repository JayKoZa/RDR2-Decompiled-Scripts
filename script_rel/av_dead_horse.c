...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iLocal_9 = func_48(997958153 /* GXTEntry: "Riding" */, 1);
	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), joaat("WORLD_ANIMAL_DOG_SNIFFING_GROUND"), (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
