...
int func_89(var uParam0)
{
	...
	uLocal_24 = func_173(uParam0, joaat("p_chairfolding02x"), -0.570846f, 0.213419f, -0.438812f, 0, 1, 0, 1);
	...
	func_177(uParam0, iLocal_16, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", uLocal_24, 0);
	func_178(uParam0, iLocal_16, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", uLocal_24, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_133(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_144(iVar0, 0))
	{
		if (func_144(PED::_0xB676EFDA03DADA52(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_131(iParam0)) || func_70(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_238(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_240(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_241(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_241(iParam0, 0));
					func_242(iParam0);
				}
			}
			else
...
void func_177(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
void func_178(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_192(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_253(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_253(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_253(iParam5, 32), 1);
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_234((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_239((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
void func_225(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
int func_366(int iParam0, bool bParam1)
{
	...
	{
		func_257(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_153(iParam0)));
		if (func_249() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_239(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			{
				_NAMESPACE48::_0x63AA2B8EB087886A(func_239(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
int func_488(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_0xA00DF706C60173D1(func_239(iParam0, 1));
...
int func_489(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_511(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
int func_498(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_515(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_504(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_506(0);
	*uParam1 = { func_480(bParam0, func_497(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
