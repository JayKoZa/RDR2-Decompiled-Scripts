...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "DAP_CORPSE", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	if (*uParam0 == 239)
	{
		func_48(uParam0, 1, "DAP_LIVE_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	...
	switch (iLocal_38)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
				_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[0 /*14*/]), iLocal_52);
			...
			if (*uParam0 == 239)
			{
				...
				{
					TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[1 /*14*/]), 365448677, 0, 0, 0, -1082130432, 0);
...
void func_90(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_118((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
