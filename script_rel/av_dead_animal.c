...
{
	func_33(uParam0, 11144, 11216, 11838);
}
...
{
	func_46(uParam0, "DEAD_ANIMAL", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 145:
	...
	func_47(&vParam1, 50, 10, 0);
	func_48(uParam0, 0, "DAP_CORPSE", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 == 239)
	{
		func_48(uParam0, 1, "DAP_LIVE_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0f, 0f), (90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (*uParam0 == 239)
	{
		if (!uParam0->f_469[1])
		{
			if (func_64(uParam0, &uLocal_10, 0) || func_65(Global_35, uParam0->f_20[1 /*14*/], 1) < 144f)
			{
				func_66(uParam0);
				func_67(&(uParam0->f_20[1 /*14*/]), 0, 1);
				uParam0->f_469[1] = 1;
			}
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[0 /*14*/]))
			{
				if (ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					else if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
					{
						bVar0 = true;
					}
				}
...
int func_47(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
bool func_88(vector3 vParam0, vector3 vParam3)
{
...
int func_161(int iParam0, var uParam1)
{
	...
	else if (func_153() - uParam1->f_4) > func_208(uParam1)
	{
...
bool func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_198(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_213(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_219(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_221(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
