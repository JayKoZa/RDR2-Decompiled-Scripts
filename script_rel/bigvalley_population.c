...
void func_7()
{
	...
	if (func_27(8))
	{
		uVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(-1452704117);
		uVar1 = _NAMESPACE48::_0x112DDF56300BC6E5(-703427271);
	...
	{
		uVar2 = _NAMESPACE48::_0x112DDF56300BC6E5(-703427271);
		if (!_NAMESPACE48::_0x800DF3FC913355F3(uVar2))
		{
			return;
		}
		if (_NAMESPACE48::_0xEB98B38CA60742D7(uVar2))
		{
			if (!func_28(976539083))
			{
				if (!STREAMING::_0x73B40D97D7BAAD77(71064384, Global_36))
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	func_67(iParam0, iParam6);
	func_68(iParam0, iParam5);
	func_69(iParam0, iParam4);
