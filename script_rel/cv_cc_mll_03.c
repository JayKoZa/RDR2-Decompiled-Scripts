...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -4.5205f, 0.2751f, 0.8299f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	func_151(uParam0, -0.0006f, -0.0029f, 0.5041f, 0f, 1.5f, 2.02f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_155(uParam0, joaat("COMP_MLLCNV3"), joaat("PLAYER_MLLCNV3"));
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_POCKET_MIRROR"), "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_77(var uParam0)
{
	if (!bLocal_31)
	{
		uLocal_30 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_15), joaat("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), 5, joaat("PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B"));
		bLocal_31 = true;
	}
...
void func_338(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_381(iParam1))
		{
			func_382(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_376(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
