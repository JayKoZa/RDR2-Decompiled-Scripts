...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -4.5205f, 0.2751f, 0.8299f, 0f, 1.5f, 1.5f, 3f, -1612834106, -727195357, 1, 1, 1);
	...
	uLocal_19 = func_152(uParam0, joaat("s_caravancot01x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@molly_3@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@molly_3@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@molly_3@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@molly_3@action_b_alt", 0, 0, 0, 1);
	func_154(uParam0, "CCML3AU");
	func_155(uParam0, -274466369, -539055892);
	func_156(uParam0, iLocal_14, 3, -98992470, "WORLD_HUMAN_POCKET_MIRROR_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 1, 8, 0, 0, 0);
	func_158(uParam0, iLocal_14, 1, -1);
	func_159(uParam0, iLocal_15, 3, 343112864, "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", uLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_15, 0);
	Local_20 = { func_161(uParam0, 0f, 0f, 0.8f, 158.4f, 8f, 0.35f, 0.35f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	if (func_201(uParam0, iLocal_17) || func_201(uParam0, iLocal_18))
	{
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_201(uParam0, iVar1) || func_199(uParam0, iVar1))
			{
