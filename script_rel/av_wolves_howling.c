...
{
	func_33(uParam0, 10798, 10849, 11556);
}
...
{
	func_46(uParam0, "WOLVES_HOWLING", "", vParam1, vParam4);
	func_47(uParam0, 0, "WHP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "WHP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0.5f, 0f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WHP_WOLF_3", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				uLocal_12[0] = func_65(joaat("WORLD_ANIMAL_WOLF_HOWLING_SITTING"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[0 /*14*/], uLocal_12[0], 0, 0, false, true, 0, false, -1f, false);
				func_66(&(uParam0->f_20[0 /*14*/]), 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_64(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				uLocal_12[1] = func_65(joaat("WORLD_ANIMAL_WOLF_SNIFFING_GROUND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[1 /*14*/], uLocal_12[1], 0, 0, false, true, 0, false, -1f, false);
				func_66(&(uParam0->f_20[1 /*14*/]), 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
			{
				func_64(&(uParam0->f_20[2 /*14*/].f_5), 50, 10, 0);
				uLocal_12[2] = func_65(joaat("WORLD_ANIMAL_WOLF_EATING"), uParam0->f_20[2 /*14*/].f_5, uParam0->f_20[2 /*14*/].f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(uParam0->f_20[2 /*14*/], uLocal_12[2], 0, 0, false, true, 0, false, -1f, false);
				func_66(&(uParam0->f_20[2 /*14*/]), 1, 1);
			}
			iLocal_11 = 1;
			break;
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_63(uParam0);
				TASK::CLEAR_PED_TASKS(uParam0->f_20[2 /*14*/], true, false);
				TASK::TASK_LOOK_AT_ENTITY(uParam0->f_20[2 /*14*/], Global_35, -1, 0, 51, 0);
				TASK::_0xE7FA07624574B79A(uParam0->f_20[0 /*14*/], Global_35, 1, 1, 15f, 1, 0, 0, 0);
			...
			break;
		case 3:
			if (!func_69(uParam0->f_20[2 /*14*/], -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(uParam0->f_20[2 /*14*/], Global_35, 0, -1f, -1f, -1f);
			}
			if (func_70(uParam0->f_20[0 /*14*/], Global_35, 1) < 324f || func_71(&uLocal_19, 12.5f))
			{
...
bool func_61(var uParam0, var uParam1, bool bParam2)
{
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			func_66(&(uParam0->f_20[iVar0 /*14*/]), 0, 1);
		}
		iVar0++;
	}
}
...
var func_65(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_67(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_71(var uParam0, float fParam1)
{
	if (!func_110(uParam0))
	{
		return false;
...
bool func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (PED::_IS_PED_USING_SCENARIO_POINT(uParam0->f_20[iVar0 /*14*/], uLocal_12[iVar0]))
			{
				return false;
			}
		}
...
bool func_78(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_79(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_116(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_93(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_126(iParam1))
		{
			func_127(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_102(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_138(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_111(var uParam0, float fParam1)
{
...
bool func_116(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_139(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_141(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_159(int iParam0, var uParam1)
{
	...
	{
		return func_211(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_162(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_116(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_177(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_183(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_200(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_219(iVar0, 0)))
		{
...
bool func_185(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_188(bool bParam0, bool bParam1, bool bParam2)
{
...
bool func_192(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_195(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_196(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_201(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_207(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
void func_212(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_215(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_221(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_223(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
