...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "WHP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "WHP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0.5f, 0f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "WHP_WOLF_3", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				uLocal_12[0] = func_65(365448677, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				uLocal_12[1] = func_65(2120307236, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
			{
				...
				uLocal_12[2] = func_65(1974927641, (uParam0->f_20[2 /*14*/])->f_5, (uParam0->f_20[2 /*14*/])->f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[2 /*14*/]), &(uLocal_12[2]), 0, 0, 0, 1, 0, 0, -1082130432, 0);
...
int func_61(var uParam0, var uParam1, bool bParam2)
{
...
int func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			if (PED::_0x9C54041BB66BCF9E(&(uParam0->f_20[iVar0 /*14*/]), &(uLocal_12[iVar0])))
			{
				return 0;
			}
		}
