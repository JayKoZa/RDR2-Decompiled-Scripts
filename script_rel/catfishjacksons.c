...
int func_11()
{
	...
	uLocal_15 = VOLUME::_CREATE_VOLUME_SPHERE(1322.59f, -2285.19f, 51.316f, 0f, 0f, 0f, 0.25f, 0.25f, 0.25f);
	PED::_0x4C39C95AE5DB1329(uLocal_15, 0, 16);
	return 1;
}
	...
	if (!func_59(-2019549022 /* GXTEntry: "Letter to Nate from Momma" */, 1, 0))
	{
		if (!func_60(4))
		{
			if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_16))
			{
				...
				else if (TXD::_HAS_STREAMED_TXD_LOADED(-451886707))
				{
					if (DECORATOR::DECOR_SET_INT(iLocal_18, "letter_item", -2019549022))
					{
						OBJECT::_SET_APPLY_OBJECT_TXD(iLocal_18, -451886707, 0, 0);
						func_61(4);
					}
				}
			}
...
int func_116(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_194(bParam2), iParam0, 0);
	return uVar2;
}
