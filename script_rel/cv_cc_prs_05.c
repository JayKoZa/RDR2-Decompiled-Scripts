...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 4, joaat("WORLD_HUMAN_BUTCHER_RABBIT"), "WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_30 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_14), joaat("WORLD_HUMAN_BUTCHER_RABBIT"), 262145, joaat("WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP"));
	return true;
}
...
bool func_193(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
