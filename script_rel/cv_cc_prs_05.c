...
int func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_14, 4, 587350641, "WORLD_HUMAN_BUTCHER_RABBIT_MALE_A_RABBIT_CHOP", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_256(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_329(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
