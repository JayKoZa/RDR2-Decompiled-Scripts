...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3766f, -1.0093f, 1.0122f, -22.5144f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, -3.4501f, 4.1917f, 1.0412f, -108f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 0.9f, -0.6f, 0f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
...
bool func_216(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_253()
{
	...
	if (func_329(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	...
	if (func_329(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_263(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_331(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_334(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_377(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
...
bool func_404(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
void func_406(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_233(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_233(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_233(iParam5, 32), true);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		while (iVar28 < 4)
		{
			...
			if (func_479(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_483(0))
				{
					...
					func_484(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_477(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_489(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_481(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_491(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_479(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_479(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_480(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_481(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_479(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
struct<4> func_481(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_482(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_485(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_502(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_490(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_481(923904168, func_488(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_481(923904168, func_488(bParam0), -740156546, 0) };
		}
...
struct<4> func_492(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_481(271701509, func_488(bParam0), 12999093, 0) };
		}
...
bool func_495(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_497(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
