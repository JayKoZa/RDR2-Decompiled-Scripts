...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -1.7186f, -1.1304f, 0f, 0f, 2f, 2f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 1.8224f, 2.0627f, 0f, 0f, 3f, 3f, 5f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, "script@vignette@charles_2@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@charles_2@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@charles_2@action_b", 0, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@charles_2@ACTION_B_ALT_BACK", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@charles_2@ACTION_B_ALT_LEFT", 0, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@charles_2@ACTION_B_ALT_RIGHT", 0, 0, 0, 1);
	func_154(uParam0, "CCHR2AU");
	func_155(uParam0, 327775147, 1309451568);
	func_156(uParam0, iLocal_14, 2, -22664287, "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	...
	func_156(uParam0, iLocal_16, 2, 421625586, "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1);
	func_159(uParam0, iLocal_16, 2, 421625586, "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_16, 1, -1);
	Local_22 = { func_160(uParam0, 2.83f, 1.718f, 1.044f, -95.1299f, 8f, 0.5625f, 0.3825f) };
	Local_32 = { func_160(uParam0, 2.83f, 1.718f, 1.044f, -173f, 8f, 0.4775f, 0.4625f) };
	Local_42 = { func_160(uParam0, 2.83f, 1.718f, 1.044f, 8f, 7.73f, 0.47f, 0.2125f) };
	Local_52 = { func_160(uParam0, 2.83f, 1.718f, 1.044f, -38.75f, 3.4875f, 0.2925f, 0.0525f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, Local_22, 1, 0))
		{
			func_190(uParam0, iLocal_19, 1);
			func_200(uParam0, iLocal_14, 1.2f, 1065353216 /* Float: 1f */, 7f);
		}
		else if (func_199(uParam0, Local_32, 1, 0))
		{
			func_190(uParam0, iLocal_20, 1);
			func_200(uParam0, iLocal_14, 1.2f, 1065353216 /* Float: 1f */, 7f);
		}
		else if (func_199(uParam0, Local_42, 1, 0) || func_199(uParam0, Local_52, 1, 0))
		{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_256(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_270((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_200(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4)
{
...
int func_256(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_419(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_281(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
