...
int func_75(var uParam0)
{
	...
	func_161(uParam0, iLocal_14, 2, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 2f, 1);
	...
	func_161(uParam0, iLocal_15, 2, -393300674, "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_20 = STREAMING::_0xB223249B7798EEED(func_51(uParam0, iLocal_15), -393300674, 17, -1932751089);
	return 1;
}
...
int func_335(int iParam0, bool bParam1)
{
	...
	{
		func_244(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_136(iParam0)));
		if (func_232() == -1)
		{
