...
int func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_14, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_155(uParam0, iLocal_15, 2, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_16, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
var func_362(int iParam0, var uParam1)
{
...
bool func_471(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_487(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_489(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_498(bParam0, &Var0, iVar5, 0))
			{
				if (func_499(bParam0, &Var6, iVar5))
				{
					Var29 = { func_500(bParam0, Var0, iVar5, 0) };
					func_501(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_502(0))
				{
					...
					func_503(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_490(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_496(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_508(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_500(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_510(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_498(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_498(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_499(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_513(bParam0, -1823706425))
			{
				Var0 = { func_500(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_513(bParam0, -1483207246))
			{
				Var0 = { func_500(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_498(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_515(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_499(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_516(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_500(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_517(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_518(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_501(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_504(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_521(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	if (func_512(bParam0) == 1779021115)
	{
		return 0;
	}
...
int func_515(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_500(bParam0, Param1, iParam5, bParam6) };
...
int func_516(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_518(0);
	*uParam1 = { func_500(bParam0, func_509(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
