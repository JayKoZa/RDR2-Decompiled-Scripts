...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.7186f, -1.1304f, 0f, 0f, 2f, 2f, 5f, -1612834106, -1, 1, 1, 1);
	func_151(uParam0, -0.64f, 1.2f, 0f, -142.2f, 5f, 1.5f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, joaat("p_cs_arrow01x"), 0f, 0f, 0f, "ARROW", 0, 1, 1);
	uLocal_19 = func_152(uParam0, joaat("p_chair_crate02x"), -1.85942f, -0.832704f, -0.0209045f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@charles_1@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@charles_1@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@charles_1@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@charles_1@action_b_alt", 0, 0, 0, 1);
	func_154(uParam0, "CCHR1AU");
	func_155(uParam0, iLocal_14, 3, 665864199, "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", uLocal_19, 0);
	func_156(uParam0, iLocal_14, 3, 665864199, "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", uLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 2, -1);
	func_155(uParam0, iLocal_15, 3, -439112356, "WORLD_HUMAN_INSPECT_MALE_B", -1, 1);
	Local_20 = { func_158(uParam0, -1.8125f, -1.5801f, 0.988f, -55.8799f, 8f, 0.47f, 0.42f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, Local_20, 1, 0))
		{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_253(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_267((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_253(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_416(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_278(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
