...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.7186f, -1.1304f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -0.64f, 1.2f, 0f, -142.2f, 5f, 1.5f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH"), "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_244()
{
	...
	if (func_321(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_245()
{
	...
	if (func_321(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_253(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_292(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_297(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
