...
{
	TASK::_0x73F0D0327BFA0812(uLocal_35);
}
...
{
	if (TASK::_0x5E5D96BE25E9DF68(uLocal_35))
	{
		return 1;
	}
	return 0;
...
int func_17(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		if (bLocal_37)
		{
			iLocal_34 = TASK::_0x5B4BBE80AD5972DC(uLocal_35, vLocal_17, 0f, 0, &uVar0, -1);
		}
		else
		{
			iLocal_34 = TASK::_0x5B4BBE80AD5972DC(uLocal_35, vLocal_17, 0f, 1, &uVar0, -1);
		}
		return 1;
	}
	return 0;
...
int func_20(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	...
	uVar1 = func_36(uParam0, iParam1, uVar0, iParam2);
	func_37(uVar0);
	return uVar1;
}
...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_72(iParam0, 589988438))
		{
			if (func_93())
			{
				func_94(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -1185145312: /* GXTEntry: "Upgraded Off-Hand Holster" */
				...
				{
					func_107(PLAYER::PLAYER_PED_ID(), -1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_108(&iVar9, 0))
				{
			...
			case 1171350303: /* GXTEntry: "Upgraded Bandolier" */
				...
				{
					func_107(PLAYER::PLAYER_PED_ID(), 1171350303 /* GXTEntry: "Upgraded Bandolier" */, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_123(242, func_122(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_123(240, func_122(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_123(241, func_122(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
...
int func_36(var uParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_163(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_192(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_104(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_192(iVar7) && func_104(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
...
int func_85(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_104(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_93()
{
	if (((((func_214(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_214(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_214(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_214(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_214(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_214(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
...
void func_103(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_94(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_94(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_94(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_94(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_94(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -343824903: /* GXTEntry: "Money Clip" */
			func_94(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_94(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
void func_157(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (bParam2 || !func_191(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_55(iParam0, 0, 0) == 0))
		{
...
int func_215(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_104(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_216(int iParam0, char* sParam1, int iParam2)
{
	...
	func_278(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_217(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_278(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_278(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_277(int iParam0)
{
	...
	if (!func_414(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_297(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_161(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
void func_360(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_358())
	{
		func_278(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_278(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
int func_378(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_447(0);
	if (iParam2 != 0 && func_448(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_379(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_354(&(uParam0->f_1[iVar0 /*3*/]), iVar5, uVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_437()
{
	...
	func_489(0);
	func_490(7);
	func_491(-1623728698 /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_267() == 1160113249)
	{
		func_491(-763730846 /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_491(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_492(Global_35, &uVar0);
}
...
int func_448(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
var func_480(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_516(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_557(var uParam0, var uParam1, var uParam2)
{
	var uVar0;

	uVar0 = func_558(func_267());
	if (*uParam0)
	{
		func_556(uParam0);
	}
