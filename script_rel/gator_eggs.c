...
bool func_206(int iParam0, int iParam1, var uParam2)
{
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_355(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_224()
{
	...
	while (iVar1 < 30)
	{
		if (func_362(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_229()
{
	...
	while (iVar1 < 5)
	{
		if (func_368(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_246(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_377(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_377(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_379(iParam0, iParam2, iParam1, func_1() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_381(func_372(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
float func_257()
{
	...
	func_396(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_258()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_396(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_259()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_396(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
void func_266(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_408(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_409(iParam0, 6);
	if (bParam2)
	{
...
int func_277(int iParam0)
{
	...
	if (!func_415(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
{
	return func_196(joaat("CHARACTER"), func_423(), -1591664384, bParam0);
}
...
int func_321()
{
	...
	while (iVar1 < 30)
	{
		if (func_434(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_355(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_76(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_355(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_72(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_382(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_453(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_1() == -1)
	{
...
void func_388(struct<4> Param0)
{
	...
	if (func_457(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_457(20))
			{
				return;
			}
			iVar0++;
...
void func_404(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_403(iParam0))
	{
		...
		if ((!func_407() && !bParam1) && !func_22(0, 0, 1))
		{
			func_408(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_463(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
int func_428(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_476(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_476(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_431(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_483(iParam0));
	...
	func_183(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_486(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_438()
{
	...
	func_490(0);
	func_491(7);
	func_492(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_267() == 1160113249)
	{
		func_492(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_492(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
void func_444(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_494(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_494(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_495(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_453(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_1() == -1)
	{
		func_498(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_499(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_491(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		if (func_521(iVar2, 0))
		{
			func_522(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_500(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_499(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
		iVar0++;
	}
}
...
void func_520(var uParam0, int iParam1, int iParam2)
{
	...
	func_545(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_550(&(uParam0->f_1[iParam1 /*5*/]));
