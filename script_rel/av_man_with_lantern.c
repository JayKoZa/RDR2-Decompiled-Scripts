...
{
	func_33(uParam0, 10767, 10825, 11244);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "MAN_WITH_LANTERN", "", vParam1, vParam4);
	iVar0 = func_48(func_47(), 1, 1, 1, 1, 0, 1);
	iVar1 = func_49(joaat("HORSE_CLASS_RIDING"), 1);
	fVar2 = func_50(vParam1);
	func_51(uParam0, 0, "MWLP_MAN", iVar0, vParam1, fVar2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MWLP_HORSE", iVar1, vParam1, fVar2, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 0, "MWLO_LANTERN", joaat("S_INTERACT_LANTERN02X"), vParam1, 0f, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::_TASK_MOVE_IN_TRAFFIC(uParam0->f_20[0 /*14*/], 1f, 4, 0);
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
void func_68(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		func_105(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_106(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_107(iParam0))
	{
		if (func_108(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(iParam0);
		}
	}
	if (func_109(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_109(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_109(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_109(iParam5, 32), true);
	...
	else if (func_109(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_109(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_109(iParam5, 64))
		{
...
int func_70(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return 0;
...
bool func_78(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
float func_88(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_129(iParam1))
		{
			func_130(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_103(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_141(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_105(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
	{
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
bool func_119(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_140(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
bool func_142(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_144(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_162(int iParam0, var uParam1)
{
	...
	else if (func_154() - uParam1->f_4) > func_212(uParam1)
	{
...
void func_165(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_169(var uParam0, float fParam1)
{
	if (!func_115(uParam0))
	{
		return false;
