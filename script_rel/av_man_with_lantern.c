...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar2 = func_50(vParam1);
	func_51(uParam0, 0, "MWLP_MAN", uVar0, vParam1, uVar2, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MWLP_HORSE", uVar1, vParam1, uVar2, 1, 1, 1, 1, 41788943, 1);
	func_52(uParam0, 0, "MWLO_LANTERN", 1588362795, vParam1, 0f, 0);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_372[0 /*8*/]), &(uParam0->f_20[1 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[1 /*14*/]), 62111), -0.32f, 0.05f, -0.22f, 0f, 53f, 0f, 0, 0, 0, 0, 2, 1, 1, 0);
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_109(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_109(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_109(iParam5, 32), 1);
...
void func_165(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
