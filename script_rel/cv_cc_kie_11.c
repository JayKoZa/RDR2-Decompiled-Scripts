...
int func_72(var uParam0)
{
	...
	func_159(uParam0, iLocal_14, 3, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 2f, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_16), joaat("stand"), 45000, 0, 0, 1f, 0);
	}
	return 1;
}
