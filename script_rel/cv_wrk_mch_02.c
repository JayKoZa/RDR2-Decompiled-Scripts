...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, 0f, 0f, 0f, 5f, 5f, 5f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, 1f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
...
void func_406(int iParam0)
{
	...
	Var0 = { func_444(joaat("CAMP_FUNDS_CASH")) };
...
struct<5> func_510(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_522(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_512(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_512(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_513(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
void func_518(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_535(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
