		...
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iLocal_41 /*14*/])))
			{
				if (!TASK::_DOES_SCENARIO_POINT_EXIST(&(uLocal_12[iLocal_41])))
				{
					...
					TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[iLocal_41]), 23, 1);
					TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[iLocal_41]), 25, 1);
					if (*uParam0 == 93 || *uParam0 == 163)
					{
						TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[iLocal_41]), 20, 1);
						iVar2 = 0;
					}
					if (*uParam0 == 79)
					{
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(uLocal_39))
	{
		VOLUME::_DELETE_VOLUME(uLocal_39);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(uLocal_11))
	{
		VOLUME::_DELETE_VOLUME(uLocal_11);
	}
...
int func_59(var uParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_38) > 1000)
	{
		...
		if (!VOLUME::_DOES_VOLUME_EXIST(uLocal_39))
		{
			if (*uParam0 == 90)
			{
				uLocal_39 = VOLUME::_CREATE_VOLUME_SPHERE((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 6f, 6f, 10f);
			}
			else if (*uParam0 == 93)
			{
				uLocal_39 = VOLUME::_CREATE_VOLUME_SPHERE((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 20f, 20f, 10f);
			}
			else
			{
				uLocal_39 = VOLUME::_CREATE_VOLUME_SPHERE((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 25f, 25f, 10f);
			}
		}
		iVar0 = ENTITY::_0x886171A12F400B89(uLocal_39, iLocal_40, 1);
		iVar2 = 0;
		while (iVar2 < iVar0)
		{
			uVar1 = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iVar2, iLocal_40);
			iVar3 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(MISC::_GET_ENTITY_FROM_ITEM(uVar1));
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_95((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
