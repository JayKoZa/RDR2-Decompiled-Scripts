...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2199f, -0.4333f, 0.8367f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SLEEP_BED_PILLOW_RIGHT"), "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
