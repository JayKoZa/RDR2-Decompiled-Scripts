		...
		else
		{
			switch (Global_1898346[iVar0 /*6*/].f_3)
			{
				case 1:
					...
					if (BUILTIN::VDIST(func_334(iVar1), vParam0) < func_336(func_335(iVar1) == 0f, iParam3, func_335(iVar1)))
					{
						return 1;
					}
					break;
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_303(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
