...
{
	func_33(uParam0, 10897, 10948, 11591);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar0 = func_49(func_46());
	iVar1 = func_50();
	func_51(uParam0, "BARBER_SHAVING", "script@ambient@town@barber_shave@action", vParam1, vParam4);
	func_52(uParam0, 1, "pl_action", "", 0);
	func_53(uParam0, 0, "BARBER", iVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_53(uParam0, 1, "CUSTOMER", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	...
	if (!uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar1 /*14*/]))
			{
				...
				if (!uParam0->f_469[1])
				{
					if (func_76(uParam0, 2f, 15f, 4, 5f, 1112014848 /* Float: 50f */))
					{
						func_74(uParam0);
				...
				if (uParam0->f_469[1])
				{
					if (!uParam0->f_469[2])
					{
						if (func_77(uParam0, 1f, 15f, 4, joaat("ACTION"), 0))
						{
							func_75(*uParam0, uParam0->f_483, 1);
							uParam0->f_469[2] = 1;
						}
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_56(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((bParam4 && !func_78(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
bool func_73(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_129(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_79(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
bool func_85(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_114(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_185(iParam1))
		{
			func_186(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_130(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_150(int iParam0, var uParam1)
{
	...
	{
		return func_229(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_154(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_162(var uParam0, float fParam1)
{
...
bool func_173(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_201(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_247(iVar0, 0)))
		{
...
bool func_203(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_210(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_212(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_213(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_214(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_219(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
void func_230(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_244(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_248(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_249(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_251(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
