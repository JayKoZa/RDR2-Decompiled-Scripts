...
int func_19(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, float fParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			else
			{
				...
				{
					TASK::_0xCE4E669400E5F8AA(iParam3->f_1, func_24(iParam3->f_6));
				}
