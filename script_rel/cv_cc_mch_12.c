...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7703f, 0.8061f, 0.5545f, 56f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 8.5246f, 2.6798f, 1.0747f, 53f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_201(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_265(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_309(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_318(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_352(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_402(iParam1))
		{
			func_403(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_397(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
...
bool func_428(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_431(int iParam0, int iParam1)
{
	...
	bVar0 = func_470(iParam0, iParam1);
	return bVar0;
}
...
bool func_445(int iParam0, char* sParam1)
{
...
bool func_447(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_451(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_422(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_476(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_492(iVar0))
		{
	...
	{
		func_494(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_495(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_503(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_507(0))
				{
					...
					func_508(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_501(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_513(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_505(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_515(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_503(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_503(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_505(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_520(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_505(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_506(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_509(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_526(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_514(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_505(923904168, func_512(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_505(923904168, func_512(bParam0), -740156546, 0) };
		}
...
struct<4> func_516(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_505(271701509, func_512(bParam0), 12999093, 0) };
		}
...
bool func_519(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_521(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
