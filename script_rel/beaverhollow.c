...
int func_11()
{
	iLocal_0 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Beaver Hollow - m_volTown Agg");
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2345.187f, 1352.787f, 107.6561f, 0.036552f, 0f, 0f, 40.20085f, 40.78676f, 12.88943f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2357.265f, 1391.395f, 109.9775f, 2.692848f, 0f, 0f, 17.41357f, 20.79141f, 16.64382f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2318.457f, 1444.692f, 87.40137f, 179.4571f, 0f, 0f, 51.88874f, 33.18848f, 11.92861f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2347.961f, 1414.832f, 96.40656f, 0.534309f, -14.06188f, -34.73259f, 31.42639f, 14.92058f, 9.380316f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2255.09f, 1458.163f, 93.38544f, 0f, 0f, 0f, 21.93718f, 27.58467f, 4.980723f);
	VOLUME::_0xBCE668AAF83608BE(iLocal_0, 2272.888f, 1487.881f, 103.2379f, 11.51613f, 0f, 0f, 19.99748f, 13.49523f, 3.545758f);
	return 1;
}
...
int func_15(int iParam0)
{
	...
	{
		iLocal_1 = AUDIO::_0x0556C784FA056628("beaver_hollow", "es_camp_memory_sounds");
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
...
void func_65(int iParam0, bool bParam1)
{
	...
	func_109(func_108(-1532769513, joaat("areas")), 1);
...
char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
...
void func_147(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
