...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		...
		case 4:
			...
			{
				AUDIO::_PLAY_SOUND_FROM_POSITION("LIGHTENING_STRIKE", ENTITY::GET_ENTITY_COORDS(Global_35, true, false), "DSLIT_Sounds", 0, 0, 1, 0);
...
int func_54(var uParam0, var uParam1, vector3 vParam2, vector3 vParam5, vector3 vParam8, char* sParam11)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(*uParam0))
	{
...
int func_88(int iParam0, int iParam1)
{
	...
	uVar0 = func_87(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_87(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_91()
{
	...
	if (!func_127(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
...
int func_119(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_114(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
