...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.35f, 4.3625f, 0.8945f, 80f, 1f, 1f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.2875f, -0.625f, 0.832f, 92.5f, 2f, 5.8325f, 2.135f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
