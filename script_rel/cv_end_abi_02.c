...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -13.2467f, 14.6741f, 0.375f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, "script@vignette@beecher@abigail_2@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backleft", 2, 0, 0, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backright", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Front", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Left", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Right", 2, 0, 0, 1);
...
void func_187(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_284(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_284(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
bool func_189(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_206(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_252(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_321(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_273(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
