...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -13.2467f, 14.6741f, 0.375f, 0f, 1.5f, 1.5f, 3f, -1612834106, -2055224817, 1, 1, 1);
	func_153(uParam0, "script@vignette@beecher@abigail_2@base", 1, 1, 0, 0);
	uLocal_15 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backleft", 2, 0, 0, 1);
	uLocal_16 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Backright", 2, 0, 0, 1);
	uLocal_17 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Front", 2, 0, 0, 1);
	uLocal_18 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Left", 2, 0, 0, 1);
	uLocal_19 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_A_Right", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_B_Backleft", 2, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_B_Backright", 2, 0, 0, 1);
	iLocal_22 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_B_Front", 2, 0, 0, 1);
	iLocal_23 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_B_Left", 2, 0, 0, 1);
	iLocal_24 = func_153(uParam0, "script@vignette@beecher@abigail_2@Action_B_Right", 2, 0, 0, 1);
	iLocal_26 = func_153(uParam0, "script@vignette@beecher@abigail_2@Exit_Action", 0, 0, 0, 0);
	func_154(uParam0, "BABI2AU");
	func_155(uParam0, 849962316, 1793703982);
	func_156(uParam0, iLocal_14, 1, -1);
	Local_27 = { func_157(uParam0, -13.2325f, 14.8475f, 1.07f, 176.4f, 6.5f, 0.22f, 0.415f) };
	Local_37 = { func_157(uParam0, -13.233f, 14.848f, 1.07f, -144.42f, 6.5f, 0.3525f, 0.215f) };
	Local_47 = { func_157(uParam0, -13.233f, 14.848f, 1.07f, 44.58f, 6.5f, 0.1725f, 0.66f) };
	Local_57 = { func_157(uParam0, -13.233f, 14.848f, 1.07f, 119.16f, 6.5f, 0.22f, 0.6575f) };
	Local_67 = { func_157(uParam0, -13.233f, 14.848f, 1.07f, -34.66f, 6.5f, 0.22f, 0.8675f) };
	func_158(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	return 1;
}
...
int func_87(var uParam0)
{
	...
	else if (func_189(uParam0, Local_37, 1, 0))
	{
		iLocal_25 = uLocal_16;
		return 1;
	}
	else if (func_189(uParam0, Local_47, 1, 0))
	{
		iLocal_25 = uLocal_17;
		return 1;
	}
	else if (func_189(uParam0, Local_57, 1, 0))
	{
		iLocal_25 = uLocal_18;
		return 1;
	}
	else if (func_189(uParam0, Local_67, 1, 0))
	{
		iLocal_25 = uLocal_19;
		return 1;
	}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_252(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_266((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_288(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
int func_252(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_321(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_321(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_322(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
...
int func_327(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_415(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_277(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
