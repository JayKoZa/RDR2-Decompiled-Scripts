...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, 0.2625f, -1.4f, 1.15f, -24.94f, 2.7875f, 3.5725f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_162(uParam0, 1.2375f, 4.9625f, 1.15f, 6.81f, 1.1f, 1f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	...
	func_169(uParam0, iLocal_92, 1, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), 0, -1, 0, func_168(100f, 140f), 1065353216 /* Float: 1f */, 1);
	...
	func_169(uParam0, iLocal_93, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(iVar0, 0))
	{
		if (func_131(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
bool func_215(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_233(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_271()
{
	...
	if (func_358(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_272()
{
	...
	if (func_358(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_280(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_359(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_319(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_324(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_368(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_427(iParam1))
		{
			func_428(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_396(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
var func_398(var uParam0, var uParam1)
{
	char cVar0[64];
...
bool func_419(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_422(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_55(iParam0))
	{
		return false;
...
bool func_463(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_114(iParam0))
	{
		return false;
...
void func_465(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_250(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_250(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_250(iParam5, 32), true);
...
bool func_466(int iParam0, int iParam1)
{
	...
	bVar0 = func_513(iParam0, iParam1);
	return bVar0;
}
...
bool func_488(int iParam0, char* sParam1)
{
...
bool func_490(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_494(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_358(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_457(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_519(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(iVar0) || WEAPON::_IS_WEAPON_MELEE(iVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43891 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_536(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_536(iVar0))
		{
	...
	{
		func_538(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_539(iParam0, &iVar0, &fVar25);
...
int func_538(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
struct<4> func_549(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_567(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
void func_553(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_570(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_558(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_549(923904168, func_556(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_549(923904168, func_556(bParam0), -740156546, 0) };
		}
...
struct<4> func_560(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_549(271701509, func_556(bParam0), 12999093, 0) };
		}
...
bool func_565(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_567(0);
	*uParam1 = { func_549(iParam0, func_558(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return false;
	}
