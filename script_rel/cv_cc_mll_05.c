...
int func_347()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_407(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_491(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_522(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
void func_553(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_570(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
