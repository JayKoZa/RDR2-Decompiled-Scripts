...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -9.05752f, -6.47742f, 1.62065f, 0f, 3f, 3f, 3f, -1612834106, -1689743484, 1, 1, 1);
	func_152(uParam0, -17.3338f, -7.27841f, 1.59476f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1383943725, 1, 1, 1);
	func_153(uParam0, "script@vignette@susan_11@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@susan_11@Action", 0, 0, 1, 0);
	func_154(uParam0, "CSN11AU");
	func_155(uParam0, 1807574760, -918580694);
	func_156(uParam0, uLocal_16, -1, 0.93f);
	func_157(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 3, -1124614608, "WORLD_HUMAN_WAITING_IMPATIENT_MALE_A", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
