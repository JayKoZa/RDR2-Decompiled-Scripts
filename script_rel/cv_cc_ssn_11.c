...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -9.05752f, -6.47742f, 1.62065f, 0f, 3f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -17.3338f, -7.27841f, 1.59476f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_STRAUSS"), 1, 1, 1);
	func_153(uParam0, "script@vignette@susan_11@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_11@Action", 0, 0, 1, 0);
	...
	func_158(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_WAITING_IMPATIENT"), "WORLD_HUMAN_WAITING_IMPATIENT_MALE_A", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
