...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "DEER1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "DEER2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							if (!&uParam0->f_469[4])
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 811542464))
								{
									...
									{
										TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 3, 256, -1082130432, -1, 0);
									}
...
void func_109(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_121((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
