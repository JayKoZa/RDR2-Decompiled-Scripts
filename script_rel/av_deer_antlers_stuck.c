...
{
	func_33(uParam0, 10912, 10964, 11913);
}
...
{
	func_46(uParam0, "ANTLERS_STUCK", "script@ambient@animal@DEER_ANTLERS_STUCK@action", vParam1, vParam4);
	uParam0->f_16 = 1;
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[7])
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
		{
			iLocal_10 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[1 /*14*/].f_5, 1f, 1, 36, 0);
			iLocal_11 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[1 /*14*/].f_5, 1.5f, 2, -1, 0);
			PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_20[1 /*14*/], false);
			ENTITY::_0x18FF3110CF47115D(uParam0->f_20[1 /*14*/], 7, 0);
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_43 == 1)
		{
			if ((func_63(uParam0, &uLocal_15, 1) || func_64(Global_35, uParam0->f_483, 1) <= 400f) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				bLocal_43 = true;
			}
		}
	...
	if (!uParam0->f_469[0] && !bLocal_43)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (func_73(uParam0, 3f, 60f, 4, joaat("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							if (!uParam0->f_469[4])
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINRUN")))
								{
									...
									{
										TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
									}
							...
							if (uParam0->f_469[4])
							{
								ENTITY::_0x18FF3110CF47115D(uParam0->f_20[1 /*14*/], 7, 1);
								uParam0->f_469[3] = 1;
								func_74(&uLocal_12, 0);
								return 1;
							}
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_10 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_10, 1);
	}
	if (iLocal_11 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_11, 1);
	}
	return 1;
}
...
bool func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_121(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_131(iParam1))
		{
			func_132(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_103(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_143(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_109(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_121(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_121(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_143(var uParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
bool func_144(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_146(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
void func_169(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
