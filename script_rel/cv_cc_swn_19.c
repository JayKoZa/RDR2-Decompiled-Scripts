...
int func_72(var uParam0)
{
	...
	if (func_148(uParam0) != 6)
	{
		func_151(uParam0, -0.0311f, 3.79f, 0f, 18.25f, 0.7775f, 0.73f, 5f, -1612834106, -695792551, 1, 1, 1);
		func_151(uParam0, 0.7189f, 0.4275f, 0f, 4.75f, 1.3f, 0.8775f, 5f, -1612834106, 1243438920, 1, 1, 1);
	}
	else
	{
		func_151(uParam0, 0.7114f, 0.5001f, 0f, 4.75f, 1.3f, 1.105f, 5f, -1612834106, 1243438920, 1, 1, 1);
	}
	...
	if (func_148(uParam0) == 6)
	{
		func_153(uParam0, "script@vignette@swanson_19@Action_Swanson", 0, 0, 1, 0);
	}
	else
	{
		func_153(uParam0, "script@vignette@swanson_19@action", 0, 0, 1, 0);
	}
	func_154(uParam0, "CSW19AU");
	if (func_148(uParam0) != 6)
	{
		func_155(uParam0, iLocal_14, 4, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0);
		func_156(uParam0, iLocal_14, 2, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	else if (func_148(uParam0) == 6)
	{
		func_155(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0);
		func_156(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	if (func_148(uParam0) != 6)
	{
		func_155(uParam0, iLocal_15, 4, joaat("prop_human_seat_bench"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_15, 2, joaat("prop_human_seat_bench"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	if (!func_158() && func_148(uParam0) != 6)
	{
		iLocal_16 = func_150(uParam0, 22, 0);
		func_151(uParam0, 0.6564f, 3.9775f, 0f, 18.25f, 0.7775f, 0.73f, 5f, -1612834106, -950285770, 1, 1, 1);
		func_155(uParam0, iLocal_16, 3, 1002153075, "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_16, 3, 1002153075, "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1.2f, 1);
	}
	if (func_158())
	{
		func_159(uParam0);
...
{
	if (AUDIO::_0x54B187F111D9C6F8(func_48(uParam0, iLocal_14), 0))
	{
		return 0;
	}
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	func_162(uParam0, iParam1, fParam7);
}
...
void func_162(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_254(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_302(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_340(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_311()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_345(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_324(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_351(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_351(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_120(iVar0, 0)) || (bParam3 && !func_51(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_382(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_361(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_391(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_390(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_393(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_375(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_408(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_382(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_411(iParam0) && func_412(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_414(iParam0, vVar0, iParam6, iParam10))
				{
					return func_413();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_208(vVar0)) && !func_209(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_393(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_391(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_429(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_398(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_443(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_443(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_414(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_415(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_447(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_385(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_441(int iParam0)
{
	...
	func_460(iParam0, 1073741824 /* Float: 2f */);
}
...
bool func_443(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_461(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_463(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_464(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
bool func_472(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_489(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_473(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_490(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_474(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	if (!func_491(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_492(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
void func_478(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_495(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_474(joaat("character"), func_496(), -1591664384, bParam0);
}
...
{
	if (func_486(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_497(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_488(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_489(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_490(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_492(0);
	*uParam1 = { func_474(bParam0, func_483(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
