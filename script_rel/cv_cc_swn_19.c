...
bool func_72(var uParam0)
{
	...
	if (func_148(uParam0) != 6)
	{
		func_151(uParam0, -0.0311f, 3.79f, 0f, 18.25f, 0.7775f, 0.73f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
		func_151(uParam0, 0.7189f, 0.4275f, 0f, 4.75f, 1.3f, 0.8775f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	}
	else
	{
		func_151(uParam0, 0.7114f, 0.5001f, 0f, 4.75f, 1.3f, 1.105f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	}
	...
	if (func_148(uParam0) != 6)
	{
		...
		func_156(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	else if (func_148(uParam0) == 6)
	{
		...
		func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_157(uParam0, iLocal_14, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	if (func_148(uParam0) != 6)
	{
	...
	if (!func_158() && func_148(uParam0) != 6)
	{
		...
		func_151(uParam0, 0.6564f, 3.9775f, 0f, 18.25f, 0.7775f, 0.73f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
		func_155(uParam0, iLocal_16, 3, joaat("GENERIC_SEAT_BENCH_SCENARIO"), "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0);
		func_156(uParam0, iLocal_16, 3, joaat("GENERIC_SEAT_BENCH_SCENARIO"), "GENERIC_SEAT_BENCH_RF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1.2f, 1);
	}
	if (func_158())
	{
		func_159(uParam0);
...
bool func_304(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_333(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_365(iParam1))
		{
			func_366(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_360(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
...
bool func_386(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_391(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_394(int iParam0, int iParam1)
{
	...
	bVar0 = func_437(iParam0, iParam1);
	return bVar0;
}
...
bool func_412(int iParam0, char* sParam1)
{
...
bool func_414(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_443(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_461(iVar0))
		{
...
bool func_472(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
bool func_475(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_478(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_495(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_483(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_474(923904168, func_481(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_474(923904168, func_481(bParam0), -740156546, 0) };
		}
...
struct<4> func_485(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_474(271701509, func_481(bParam0), 12999093, 0) };
		}
...
bool func_488(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_490(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
