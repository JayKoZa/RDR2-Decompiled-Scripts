			...
			case joaat("KIT_WARDROBE"):
				...
				else
				{
					...
					if (bVar36 && !bVar35)
					{
						...
						func_58(MISC::_CREATE_VAR_STRING(0, -1680440926, Global_36559), 10000, 0, 0, 0, 1);
					}
					else if (!func_103(7))
					{
					...
					else if (!bVar35)
					{
						...
						else
						{
							...
							Global_36559 = MAP::_0x3E593DF9C2962EC6(joaat("BLIP_STYLE_PLAYER_HORSE"));
							MAP::_BLIP_SET_MODIFIER(Global_36559, 673950256);
							func_58(MISC::_CREATE_VAR_STRING(0, -482898802, Global_36559), 10000, 0, 0, 0, 1);
						}
					}
					else
					{
...
bool func_90(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("KIT_HANDHELD_CATALOG"):
			func_58(MISC::_CREATE_VAR_STRING(0, 163043886 /* GXTEntry: "You are not allowed to use Handheld Catalogue at the moment." */, Global_36559), 10000, 0, 0, 0, 1);
			break;
	}
	return true;
}
...
void func_467(int iParam0)
{
	...
	func_448(MISC::_CREATE_VAR_STRING(6, func_642(iParam0), fVar1), "itemtype_textures", func_643(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_473(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_56() == -1)
			{
				if (!func_523(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_653(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_480())
					{
...
void func_477(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_655(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_503()
{
	...
	while (iVar1 < 5)
	{
		if (func_671(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
float func_516()
{
	...
	func_682(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_517()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_682(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_518()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_682(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
int func_529(int iParam0)
{
	...
	if (!func_695(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
bool func_535(int iParam0, var uParam1)
{
	if (iParam0 == 90)
	{
		if (func_699(Global_1347702[iParam0 /*49*/].f_15) != 0)
		{
...
int func_560()
{
	...
	while (iVar1 < 30)
	{
		if (func_706(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	return func_710(BUILTIN::TO_FLOAT(iParam0), fParam1);
}
...
void func_604(var uParam0, int iParam1, int iParam2)
{
	...
	func_738(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
void func_609(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_740(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_740(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_741(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_620(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_56() == -1)
	{
		func_744(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_745(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_688(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_687(iParam0))
	{
		...
		if ((!func_689() && !bParam1) && !func_16(0, 0, 1))
		{
			func_58(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_773(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
bool func_697(int iParam0)
{
	switch (iParam0)
	{
		case 14:
		case 34:
			return !func_783(&(Global_1835011[iParam0 /*74*/]));
	}
	return false;
}
...
void func_717(int iParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = func_795(BUILTIN::CEIL(Global_40.f_11095[iParam0]));
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(Global_35, func_796(iParam0), iVar0);
	func_798(func_797(iParam0), (100f * (BUILTIN::TO_FLOAT(iVar0) / 100f)), 0);
	if (((fParam1 <= func_799(15) && iParam0 == 1) && PED::IS_PED_ON_FOOT(Global_35)) && !PED::IS_PED_SWIMMING(Global_35))
	{
		func_128(84, 1);
	}
	if (fParam1 <= -99.999f)
...
void func_720(int iParam0)
{
	...
	iVar1 = func_802(2);
	func_803(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_722(int iParam0)
{
	...
	iVar1 = func_805(2);
	func_806(BUILTIN::TO_FLOAT((iParam0 * iVar1)));
}
...
void func_723(int iParam0)
{
	...
	iVar1 = func_807(2);
	func_808(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_729(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_795(BUILTIN::CEIL(Global_40.f_11095.f_11[iParam0]));
...
bool func_748(int iParam0, int iParam1)
{
	...
	{
		return func_814(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
int func_755(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_819(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_819(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_758(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_826(iParam0));
	...
	func_378(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_829(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_834(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_789(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iVar0, func_796(iParam0), BUILTIN::CEIL(fParam1));
		return 1;
	}
	else
	{
...
void func_858(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_882(iParam1), fParam2, -1);
	}
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_811(&(uParam0->f_1[iParam1 /*5*/]));
