	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_35))
	{
		switch (iLocal_59)
		{
				...
				if (TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0) || ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1208591336))
				{
					if (!PLAYER::_0x3EE1F7A8C32F24E1(PLAYER::PLAYER_ID(), &uVar0, 0, 0) && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-92416669) == 0)
					{
						...
						if (!(func_14("simple_crafting") || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(-608558181) > 0))
						{
							...
							if ((func_21(0, 0) && (!func_22(Global_1392040->f_1, 1) || func_22(Global_1392040->f_1, 512))) && (func_15(-1838434463 /* GXTEntry: "Camp" */, 1, 0) || func_15(2019377485 /* GXTEntry: "Camp" */, 1, 0)))
							{
			...
			case 2:
				...
				{
					if ((func_15(-1838434463 /* GXTEntry: "Camp" */, 1, 0) && func_27(-1838434463 /* GXTEntry: "Camp" */, 0, 0, 0, 1, 0, 0)) || (func_15(2019377485 /* GXTEntry: "Camp" */, 1, 0) && func_27(2019377485 /* GXTEntry: "Camp" */, 0, 0, 0, 1, 0, 0)))
					{
						func_24();
						MISC::CLEAR_BIT(&(Global_1956578->f_1), 2);
					}
		...
		if ((!PED::IS_PED_USING_ANY_SCENARIO(Global_35) || (iLocal_59 > 1 && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 1))) || TASK::_GET_SCENARIO_POINT_PED_IS_USING(Global_35, 0) != iLocal_3)
		{
			iLocal_0 = 0;
		}
	}
				...
				else
				{
					...
					else
					{
						...
						if (!func_22(Global_1392040->f_1, 1) || func_22(Global_1392040->f_1, 512))
						{
							...
							else if (func_101(-1838434463 /* GXTEntry: "Camp" */))
							{
								if (func_118(1))
								{
									func_119(2);
								...
								else
								{
									...
									func_121(GANG::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID()));
								}
							}
						...
						func_127(iParam0, 1, 0, 562618531, 0);
						func_129(136579449 /* GXTEntry: "Beau\'s Bracelet" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
...
void func_92(int iParam0, struct<11> Param1, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, struct<2> Param17, var uParam19, var uParam20, var uParam21, var uParam22, var uParam23, var uParam24, var uParam25, var uParam26, int iParam27, bool bParam28, int iParam29)
{
	switch (iParam0)
	{
		...
		case -1952196650: /* GXTEntry: "Letter from the Mayor\'s Office" */
			if (func_169())
			{
				func_170(998229694 /* GXTEntry: "It ain\'t John Mark. It\'s Jean Marc, you fool. And he\'s now the mayor. I guess tha" +
    "t\'s good. Lemieux\'s done for." */, 0);
			}
			else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(998229694))
			{
				func_170(1610852701 /* GXTEntry: "It ain\'t John Mark. It\'s Jean Marc, Arthur.~n~~n~These fellas are French.~n~And h" +
    "e\'s now the mayor. I guess that\'s good. Sounds like Lemieux was pretty awful." */, 0);
		...
		case -1566711999: /* GXTEntry: "Letter from the Mayor\'s Office" */
			func_170(-1741315348 /* GXTEntry: "Jean Marc won.~n~~n~He\'s now the mayor and Lemieux is disgraced." */, 0);
			break;
		...
		case 466137807: /* GXTEntry: "Invitation from Francis Sinclair" */
			if ((func_173() && !func_174(50)) && !func_186(32))
			{
				...
				if (!func_189(((*Global_1347702)[50 /*49*/])->f_15, 1))
				{
					if (func_169() == 1)
					{
						func_170(-629995342 /* GXTEntry: "Sent him the location of those odd carvings. Now he wants me to go see him." */, 0);
					}
					else if (HUD::_JOURNAL_CAN_WRITE_ENTRY(-629995342))
					{
						func_170(-1367572831 /* GXTEntry: "Sent him the location of those odd carvings. Now he wants me to go see him." */, 0);
					}
				}
			}
			break;
...
int func_129(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_91(iParam0, 589988438))
		{
			if (func_292())
			{
				func_293(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_320(242, func_319(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_320(240, func_319(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_320(241, func_319(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
...
struct<5> func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_43(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_162(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_162(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_464(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_137(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_15(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_137(iVar7) && func_15(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
...
int func_285(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_15(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_292()
{
	if (((((func_492(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_492(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_492(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_492(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_492(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_492(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
...
void func_302(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_293(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_293(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_293(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_293(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_293(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -343824903: /* GXTEntry: "Money Clip" */
			func_293(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_293(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
int func_347(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_462(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
void func_459(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (bParam2 || !func_475(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_45(iParam0, 0, 0) == 0))
		{
...
int func_493(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_15(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_494(int iParam0, char* sParam1, int iParam2)
{
	...
	func_448(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_495(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_448(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_448(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_529(int iParam0)
{
	...
	if (!func_694(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_614(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_663(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_661())
	{
		func_448(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_448(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
float func_700(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return -1f;
...
void func_758()
{
	...
	func_830(0);
	func_831(7);
	func_227(-1623728698 /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_420() == 1160113249)
	{
		func_227(-763730846 /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_227(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_832(Global_35, &uVar0);
}
...
int func_788(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iVar0, func_795(iParam0), BUILTIN::CEIL(fParam1));
		return 1;
	}
	else
	{
...
void func_860(var uParam0, var uParam1, var uParam2)
{
	var uVar0;

	uVar0 = func_884(func_420());
	if (*uParam0)
	{
		func_859(uParam0);
	}
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(uVar0, uParam1, 0, func_56() != -1, uParam2);
	*uParam0 = 1;
}
