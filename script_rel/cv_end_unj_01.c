...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 37.025f, -10.025f, -2.675f, -2.75f, 3.005f, 5.265f, 5f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, joaat("p_feather01x"), 3f, 3f, 0f, "Feather", 0, 0, 1);
	func_153(uParam0, "script@vignette@beecher@uncle_and_jack_1@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@uncle_and_jack_1@action", 2, 0, 1, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@uncle_and_jack_1@exit_stand", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@beecher@uncle_and_jack_1@laugh", 0, 0, 0, 1);
	...
	func_156(uParam0, -1166841470, -1034913081);
	func_157(uParam0, iLocal_16, -1, 0.59f);
	func_158(uParam0, iLocal_14, 3, -1043454001, "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 0);
	func_159(uParam0, iLocal_14, 2, -1043454001, "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_15, 1, -1);
	Local_21 = { func_161(uParam0, 36.715f, -10.1275f, -3.975f, 180f, 7f, 0.7f, 0.744f) };
	func_162(uParam0, 1);
	return 1;
}
...
{
	return func_193(uParam0, Local_21, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	if (func_201(uParam0, iLocal_16))
	{
		...
		if (func_202(iVar0, Global_35, 1, 1) < 15f)
		{
			iVar1 = MISC::GET_RANDOM_INT_IN_RANGE(iLocal_19, iLocal_20 + 1);
			if (func_203(uParam0, iVar1, 1))
			{
...
float func_202(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_203(var uParam0, int iParam1, bool bParam2)
{
	...
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iVar5, 1, 0))
	{
		return 0;
	}
...
int func_300(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_202(Global_35, (uParam0->f_107[iVar1 /*113*/])->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_316()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_352(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_330(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_358(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_358(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
...
int func_368(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
int func_389(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_418(iParam0) && func_419(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_421(iParam0, vVar0, iParam6, iParam10))
				{
					return func_420();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
...
int func_398(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_436(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_405(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_450(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_450(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_421(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_450(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
