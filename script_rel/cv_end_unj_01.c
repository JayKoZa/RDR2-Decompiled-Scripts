...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 37.025f, -10.025f, -2.675f, -2.75f, 3.005f, 5.265f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_159(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_203(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;
...
bool func_401(int iParam0, int iParam1)
{
	...
	bVar0 = func_444(iParam0, iParam1);
	return bVar0;
}
...
bool func_421(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_450(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
