...
int func_73(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 3, 188888616, "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", uLocal_16, 0, 30f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	if (func_149(uParam0) == 1)
	{
		func_157(uParam0, iLocal_15, 4, -1858511014, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_158(uParam0, iLocal_15, 4, 0);
		func_159(uParam0, iLocal_15, iLocal_17, "p_mugCoffee01x_ph_r_hand", 0, 0);
	}
	uLocal_18 = func_160(uParam0, -0.0625f, -1.25f, 0f, 0f, 0f, 0f, 1.67f, 1.2775f, 6f, "GRIEF", -1612834106);
	return 1;
}
