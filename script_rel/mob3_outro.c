...
void func_1(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		...
		{
			func_13(&(iLocal_3[iVar0]), 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
	iVar1 = 0;
...
int func_24(int iParam0)
{
	...
	switch (&iLocal_9[iParam0])
	{
		...
		case 5:
			...
			break;
		case 6:
			func_60(&(uLocal_6[iParam0]), joaat("stand"), *(vLocal_12[iParam0 /*3*/]), 110.7f, 0, 1, 0, 0, -1082130432 /* Float: -1f */);
			iLocal_9[iParam0] = 7;
			break;
		case 7:
			return 1;
...
int func_49(int iParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
...
int func_50(var uParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, bool bParam7, int iParam8)
{
	if (*uParam0 == 0)
	{
		*uParam0 = func_79(vParam1, fParam4, iParam5, iParam6, bParam7, iParam8);
...
int func_52(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		if (bParam1 && func_80(iParam0, Global_35, 1) < 22500f)
		{
			return 0;
		}
...
void func_55(int iParam0)
{
	...
	else
	{
		...
		{
			func_83(&(uLocal_6[1]), iLocal_19, -1, 1065353216 /* Float: 1f */, -1, 1);
		}
		if (!func_81(&(uLocal_6[0]), iLocal_19, 0) && !func_82(&(uLocal_6[0]), -1794415470))
		{
			func_83(&(uLocal_6[1]), iLocal_19, 0, 1065353216 /* Float: 1f */, -1, 1);
		}
	}
}
...
int func_58(int iParam0, int iParam1)
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(iParam0, joaat("SCRIPT_TASK_LEAVE_VEHICLE"), 1) > 1)
	{
...
void func_60(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	TASK::TASK_START_SCENARIO_AT_POSITION(uParam0, iParam1, vParam2, fParam5, iParam6, iParam7, iParam8, iParam9, iParam10, 0);
}
...
int func_76(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (func_37(iVar0, 0))
	{
		if (func_37(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_73(iParam0)) || func_74(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_80(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_90(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_91(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_91(iParam0, 0));
					func_92(iParam0);
				}
			}
			else
...
int func_78(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_99(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_98(iParam0, 2);
			}
			break;
...
int func_79(vector3 vParam0, float fParam3, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_99(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_61(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_119(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_36(iParam0, 44, 1);
			}
...
void func_102(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_67(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_67(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_67(iParam5, 32), 1);
...
void func_109(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_137(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_137(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}

int func_110(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return 0;
...
int func_114(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3 && ENTITY::DOES_ENTITY_EXIST(func_69(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
void func_135(int iParam0)
{
	...
	func_156(iParam0, 1073741824 /* Float: 2f */);
}
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_157(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_160(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_170(bParam0, &Var0, iVar5, 0))
			{
				if (func_171(bParam0, &Var6, iVar5))
				{
					Var29 = { func_172(bParam0, Var0, iVar5, 0) };
					func_173(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_174(0))
				{
					...
					func_175(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_161(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_168(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_179(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_172(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_181(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_170(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_170(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_171(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_184(bParam0, -1823706425))
			{
				Var0 = { func_172(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_184(bParam0, -1483207246))
			{
				Var0 = { func_172(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_170(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_186(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_171(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_187(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_172(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_189(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_173(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_176(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_192(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_172(joaat("character"), func_194(), -1591664384, bParam0);
}
...
{
	if (func_183(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_195(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_185(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_186(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_172(bParam0, Param1, iParam5, bParam6) };
...
int func_187(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_189(0);
	*uParam1 = { func_172(bParam0, func_180(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
