...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0858085f, 4.47941f, 1f, 0f, 1f, 1f, 1f, joaat("VOLCYLINDER"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.6f, -0.5f, 0.99f, 0f, 1.5f, 1.5f, 1f, joaat("VOLCYLINDER"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, 0.6f, -0.5f, 0.99f, 0f, 1.5f, 1.5f, 1f, joaat("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_321()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_367(Global_35))
	{
		return true;
	}
	return false;
...
int func_357(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_396(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_403(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
