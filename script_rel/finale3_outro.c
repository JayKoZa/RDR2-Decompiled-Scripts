...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_9, 1, 0))
	{
		iVar0 = 0;
	}
...
void func_19(var uParam0)
{
	...
	uLocal_58[0] = VOLUME::_0x0EB78C2B156635B1(665633627, -1555.683f, -1417.174f, 90.1822f, 0f, 0f, -19.67098f, 2.626542f, 18.71136f, 3.681293f);
	uLocal_58[1] = VOLUME::_0x0EB78C2B156635B1(665633627, -1558.386f, -1430.378f, 93.68977f, 0f, 0f, -29.25712f, 1.25935f, 3.725714f, 1.587422f);
	uLocal_58[2] = VOLUME::_0x0EB78C2B156635B1(665633627, -1560.36f, -1436.362f, 93.68977f, 0f, 0f, -2.146133f, 1f, 3.464732f, 1.587422f);
	uLocal_58[3] = VOLUME::_0x0EB78C2B156635B1(665633627, -1572.138f, -1442.667f, 90.88407f, 0f, 0f, 126.3318f, 3.18645f, 15.24051f, 4.382712f);
	...
	switch (iLocal_41)
	{
		case 0:
			if (CAM::IS_SCREEN_FADING_IN() || CAM::IS_SCREEN_FADED_IN())
			{
				...
				func_67(Global_35, iLocal_11, &Var0, 0f, 0f, 0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
				func_68(iLocal_11, Global_35, &Var0, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 8, 0, 0, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
				iLocal_41++;
			}
			break;
		case 1:
			...
			else if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_10, 0) && CAM::_0xA2B1C7EF759A63CE() == 0f)
			{
				func_72(&uLocal_42);
				bLocal_63 = true;
			}
			if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_10, 0) && !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
			{
				PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 1, 0, 0);
			}
			if ((!ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_9, 0) && !ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_9, 0)) && func_73(&uLocal_64) >= 2f)
			{
				ANIMSCENE::START_ANIM_SCENE(iLocal_9);
			}
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_9, 0))
			{
				return 1;
			}
			break;
...
int func_88(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_38(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_124(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
bool func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_148(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_151(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
struct<4> func_169(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_187(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_170(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_173(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_190(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_179(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_193(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_184(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_185(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_187(0);
	*uParam1 = { func_169(bParam0, func_178(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
