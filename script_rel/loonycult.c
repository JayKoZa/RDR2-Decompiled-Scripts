...
void __EntryFunction__()
{
	...
	fLocal_8 = 1f;
	iLocal_223 = 20000;
	iLocal_226 = vScriptParam_0.x;
	iLocal_224 = vScriptParam_0.z;
	func_1();
	func_2();
	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_225)
		{
			...
			switch (iLocal_224)
			{
				...
				case 1:
					func_5(iLocal_226);
					if (func_7(func_6(iLocal_226)))
					{
						func_8(func_6(iLocal_226), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_226));
					iVar1 = func_10(iLocal_226);
					if (iVar1 != -1)
					{
				...
				case 2:
					...
					break;
				case 3:
					if (func_13(iLocal_226) || iLocal_227 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_226);
						iLocal_227 = (MISC::GET_GAME_TIMER() + iLocal_223);
						iLocal_224 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_226) || iLocal_227 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_226);
				...
				case 6:
					if (func_7(func_6(iLocal_226)))
					{
						if (func_17(func_6(iLocal_226), 4) && !iLocal_227 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_226) || iLocal_227 < MISC::GET_GAME_TIMER())
							{
								func_19(iLocal_226, 4);
								iLocal_227 = (iLocal_223 + MISC::GET_GAME_TIMER());
								iLocal_224 = 7;
							}
							Jump @788; //curOff = 456
							if (iLocal_227 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260.f_3790))
							{
								func_21(iLocal_226);
								func_22();
								if (!func_23(2057, 0))
							...
							func_34(iLocal_226, &Global_1898004);
							iLocal_224 = 10;
							Jump @788; //curOff = 597
							func_35(iLocal_226);
							if (func_20() != -1)
							...
							iLocal_224 = 11;
							Jump @788; //curOff = 667
							if (func_38(iLocal_226))
							{
								iLocal_225 = (1000 + MISC::GET_GAME_TIMER());
							}
							func_39(&Global_1898004, iLocal_226);
							func_40(iLocal_226);
							func_19(iLocal_226, 8);
							if (func_41())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(Global_1888801[iLocal_226 /*35*/].f_10);
							if (Global_1888801[iLocal_226 /*35*/].f_11 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(Global_1888801[iLocal_226 /*35*/].f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if (Global_1888801[iLocal_226 /*35*/].f_12 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(Global_1888801[iLocal_226 /*35*/].f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
{
	iParam0 = iParam0;
	return func_48(&uLocal_14, 2048, &uLocal_14, func_46(), 0, func_47(), 0, 0, 0);
}
...
bool func_42(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		func_19(iLocal_226, 2048);
		if (func_7(func_61()))
		{
			func_8(func_61(), 8);
		}
		func_73(iLocal_226, 4);
		func_73(iLocal_226, 8);
		func_68(0);
		if (func_20() == -1)
		{
			func_70(0);
