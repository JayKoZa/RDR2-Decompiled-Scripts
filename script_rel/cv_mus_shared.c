...
int func_97(var uParam0)
{
	...
	switch (func_20(uParam0))
	{
		...
		case 453:
			...
			{
				bLocal_158 = true;
				uLocal_159 = TASK::_0xF533D68FF970D190(func_229(uParam0, 3.73538f, 2.82993f, -0.2192f), -1147740400, 2.4f, 0, 0);
				if (TASK::_0x841475AC96E794D1(uLocal_159))
				{
					iLocal_160 = TASK::_0x295514F198EFD0CA(uLocal_159, "p_washboard01x_PH_L_HAND");
