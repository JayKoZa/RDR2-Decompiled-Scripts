...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -2.6485f, -2.2086f, 1.0827f, -80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, 7.5515f, -5.4211f, 0.7952f, -80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
...
int func_250(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_317(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_352(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_389(int iParam0, int iParam1)
{
	...
	bVar0 = func_432(iParam0, iParam1);
	return bVar0;
}
...
bool func_407(int iParam0, char* sParam1)
{
...
bool func_409(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_316(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_380(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_438(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_456(iVar0))
		{
	...
	{
		func_458(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_459(iParam0, &iVar0, &fVar25);
...
struct<5> func_465(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_477(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_469(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_479(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_467(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_467(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_468(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_469(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_484(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_469(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
void func_473(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_490(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_478(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_469(923904168, func_476(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_469(923904168, func_476(bParam0), -740156546, 0) };
		}
...
struct<4> func_480(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_469(271701509, func_476(bParam0), 12999093, 0) };
		}
...
bool func_483(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_485(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
