...
int func_72(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 2, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 38f, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	if (func_204(uParam0, iLocal_17))
	{
		...
		{
			TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_15), joaat("stand"), 45000, 0, 0, 1f, 0);
		}
	}
	return 1;
}
...
int func_425(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_284(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
