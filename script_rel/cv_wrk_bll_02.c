...
int func_72(var uParam0)
{
	...
	func_160(uParam0, iLocal_14, 3, 139049053, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", iLocal_17, 0, 85f, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_162(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_15, 3, 50699433, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", iLocal_18, 0, 100f, 1065353216 /* Float: 1f */, 1);
...
{
	uLocal_65 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_17), 139049053, 0f, 0f, 0.5f, -180f, 0, 0, 0);
	uLocal_66 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_172(uParam0, iLocal_18), 50699433, 0f, 0f, 0.5f, -180f, 0, 0, 0);
	TASK::_0x5AF19B6CC2115D34(uLocal_65, 23, 1);
	TASK::_0x5AF19B6CC2115D34(uLocal_65, 25, 1);
	TASK::_0x5AF19B6CC2115D34(uLocal_66, 23, 1);
	TASK::_0x5AF19B6CC2115D34(uLocal_66, 25, 1);
	return 1;
}
...
int func_84(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_65) && TASK::_0x841475AC96E794D1(uLocal_66))
	{
		return 1;
	}
	return 0;
...
int func_93(var uParam0)
{
	...
	{
		if (TASK::_0x841475AC96E794D1(uLocal_65))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), uLocal_65, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, 1, false, 0, 1, -1082130432, 0);
		}
		if (TASK::_0x841475AC96E794D1(uLocal_66))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_15), uLocal_66, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, 1, false, 0, 1, -1082130432, 0);
		}
...
int func_96(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_65))
	{
		if (!PED::_0x9C54041BB66BCF9E(func_213(3), uLocal_65))
		{
			TASK::_0x81948DFE4F5A0283(uLocal_65);
		}
		iVar0 = 0;
	}
	if (TASK::_0x841475AC96E794D1(uLocal_66))
	{
		if (!PED::_0x9C54041BB66BCF9E(func_213(9), uLocal_66))
		{
			TASK::_0x81948DFE4F5A0283(uLocal_66);
		}
		iVar0 = 0;
	}
	return iVar0;
