...
int func_78(var uParam0)
{
	...
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_65, 23, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_65, 25, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_66, 23, 1);
	TASK::_SET_SCENARIO_POINT_FLAG(iLocal_66, 25, 1);
	return 1;
}
...
int func_93(var uParam0)
{
	...
	if (func_202(uParam0, iLocal_20))
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_14), iLocal_65, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, 1, false, 0, 1, -1082130432, 0);
		}
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_66))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_15), iLocal_66, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, 1, false, 0, 1, -1082130432, 0);
		}
