		...
		while (iVar28 < 4)
		{
			...
			if (func_550(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_351(0))
				{
					...
					func_353(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_525(bParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0x959383DCD42040DA(bVar0))
			{
				...
				{
					func_352(bVar0, WEAPON::_0xD3750CCC00635FC2(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
void func_554(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_722(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
