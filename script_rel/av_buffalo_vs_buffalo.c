...
{
	func_33(uParam0, 10809, 10875, 11718);
}
...
int func_164(int iParam0, var uParam1)
{
	...
	{
		return func_214(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
bool func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_203(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_222(iVar0, 0)))
		{
...
bool func_188(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_195(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_199(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_204(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_219(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_223(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_224(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_226(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
