...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -4.131f, -7.1027f, 0.1523f, 0f, 1.2f, 1.2f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_32 = func_152(uParam0, -1.68f, -1.44f, 0.9987f, 0f, 1f, 1f, 2f, joaat("VOLCYLINDER"), 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_193(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_292(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_292(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
bool func_205(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
int func_261(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_281(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_299(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
