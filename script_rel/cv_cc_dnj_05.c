...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -4.131f, -7.1027f, 0.1523f, 0f, 1.2f, 1.2f, 4f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_32 = func_152(uParam0, -1.68f, -1.44f, 0.9987f, 0f, 1f, 1f, 2f, 665633627, 1);
	iLocal_16 = func_153(uParam0, joaat("p_cs_bookevelynmiller"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_154(uParam0, "script@vignette@dutch_and_john_5@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_and_john_5@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@dutch_and_john_5@action_a_int", 2, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@dutch_and_john_5@action_b", 2, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@dutch_and_john_5@action_c", 0, 0, 0, 0);
	iLocal_21 = func_154(uParam0, "script@vignette@dutch_and_john_5@action_c_alt", 0, 0, 0, 1);
	func_155(uParam0, "CDNJ5AU");
	func_156(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_162(uParam0, iLocal_15, 1.2f, 1065353216 /* Float: 1f */, 5f);
	Local_22 = { func_163(uParam0, -1.6682f, -0.3787f, 0.9199f, 180f, 7.5f, 0.4f, 0.4f) };
	func_164(uParam0, -1505064394, 1019450941);
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_203(uParam0, Local_22, 1, 0))
		{
...
void func_162(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4)
{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_261(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_275((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_194(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_296(uParam0, iVar1) || func_202(uParam0, iVar1))
			{
...
int func_261(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_390(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_425(iParam0, func_287());
...
int func_422(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_286(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_393(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
