...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 4.5375f, 3.1625f, 1f, 80f, 2.5f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
...
bool func_86(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_8(uParam0, iLocal_24)))
	{
		...
		PED::_SET_PED_BODY_COMPONENT(func_8(uParam0, iLocal_24), -1153495004);
