...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -7.594311f, 1.704786f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, -1.9018f, 0.9755f, 1.4875f, 42.75f, 2.92f, 1.1025f, 3.2075f, -1612834106, 1632043240, 1, 1, 1);
	func_153(uParam0, -2.08831f, 1.13359f, 0.50013f, 0f, 0.8f, 0.8f, 3.2075f, 665633627, 1);
	func_154(uParam0, "script@vignette@dutch_and_micah_3@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@dutch_and_micah_3@action", 0, 0, 1, 0);
	func_155(uParam0, "CDNK3AU");
	func_156(uParam0, iLocal_15, 1, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_15, iLocal_18, "p_cigar02x_PH_R_HAND", 0, 0);
	func_158(uParam0, iLocal_14, 3, 201363338, "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 2, 201363338, "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_17, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, -578114686, 835678190);
	return 1;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_207(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_209(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_210(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_210(iParam0, 0));
					func_211(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_247(iParam1) + Vector(fParam4, fParam3, fParam2) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_208((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_356(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_240(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_208(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_205(vVar0)) && !func_206(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_208(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_392(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_223(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_223(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_223(iParam5, 32), 1);
...
int func_413(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_208(iParam0, 1));
