...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 1, "RACCOON", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(-963073294, 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_REQUEST_SCENARIO_TYPE(-963073294, 1, 0, 0);
	func_57(&uLocal_11, 0);
	func_58(&uLocal_11, 1);
	func_59(&uLocal_11, 1);
	func_60(&uLocal_11, 1);
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
							{
								...
								TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), -963073294, Local_48.f_6, Local_48.f_9.f_2, 0, 0, 1, 0, -1082130432, 0);
...
int func_81(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_124(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
void func_123(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_124((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_149(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_228(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
