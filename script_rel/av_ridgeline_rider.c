...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_51(uParam0, 0, "RR_HORSE", iVar1, vParam1, (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "RR_MAN", iVar0, vParam1, (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
