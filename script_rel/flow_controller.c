...
int func_1004(int iParam0)
{
	...
	if (!func_1304(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
void func_1040(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_1309(BUILTIN::TO_FLOAT(*iParam0), fVar3);
	iVar1 = func_1310(BUILTIN::TO_FLOAT(*iParam1), fVar3);
	iVar2 = func_1311(BUILTIN::TO_FLOAT(*uParam2), fVar3);
...
void func_1046(int iParam0)
{
	...
	func_1312(Global_40.f_7731[iParam0 /*5*/].f_3, &uVar0, &uVar1, &iVar2, &iVar3, &iVar4, &iVar5);
	iVar3 = (iVar3 + (365 * iVar5));
	iVar3 = (iVar3 + (30 * iVar4));
	iVar2 = (iVar2 + (24 * iVar3));
	if (iVar2 > 168)
...
bool func_1083(int iParam0, int iParam1)
{
	...
	if (func_1338(Var14, iParam1))
	{
		...
		{
			if (func_1340(joaat("SLOTID_HORSE_HORN"), &iVar18))
			{
		...
		{
			if (func_1340(joaat("SLOTID_HORSE_HORN"), &iVar19))
			{
				if (func_1083(iVar19, 0))
				{
				}
			}
			if (func_1340(joaat("SLOTID_HORSE_STIRRUP"), &iVar20))
			{
...
int func_1086()
{
	...
	{
		iVar14 = func_1341(Var5, joaat("SLOTID_HORSE_SADDLE"), 0);
	}
...
void func_1093(var uParam0, int iParam1, int iParam2)
{
	...
	func_1345(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
void func_1109(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_1352(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_1277(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_555(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_1277(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_297(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_1111(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_1357(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_1113(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_1359(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_2() == -1)
	{
...
void func_1203()
{
	...
	if (bVar0)
	{
		...
		if (COLLECTION::_0xF83D3DDA4D3C8169(joaat("TREASURE_HUNT_LOOT_15")) > 0 && !func_1407(4))
		{
			func_595(4);
		}
		if (func_1407(0))
...
void func_1204()
{
	...
	if (INVENTORY::_0xB881CA836CC4B6D4(&Var1))
	{
		func_1410(joaat("COMPONENT_REVOLVER_DOUBLEACTION_GRIP_PEARL"), Var1, 1423542233);
		func_1410(joaat("COMPONENT_REVOLVER_DOUBLEACTION_BARREL_LONG"), Var1, -1264898804);
		func_1410(joaat("COMPONENT_SHORTARM_BARREL_MATERIAL_7"), Var1, 1592019450);
		func_1410(joaat("COMPONENT_SHORTARM_CYLINDER_MATERIAL_7"), Var1, 1117400455);
		func_1410(joaat("COMPONENT_SHORTARM_HAMMER_MATERIAL_7"), Var1, 1150213537);
		func_1410(joaat("COMPONENT_SHORTARM_SIGHT_MATERIAL_7"), Var1, 1598825281);
		func_1410(joaat("COMPONENT_SHORTARM_TRIGGER_MATERIAL_7"), Var1, -712527121);
		func_1410(joaat("COMPONENT_SHORTARM_FRAME_ENGRAVING_1"), Var1, 454332195);
		func_1410(joaat("COMPONENT_SHORTARM_FRAME_MATERIAL_7"), Var1, 256105670);
		func_1410(joaat("COMPONENT_SHORTARM_FRAME_ENGRAVING_MATERIAL_7"), Var1, -1328061889);
		func_1410(joaat("COMPONENT_SHORTARM_BARREL_ENGRAVING_1"), Var1, -782241404);
		func_1410(joaat("COMPONENT_SHORTARM_BARREL_ENGRAVING_MATERIAL_7"), Var1, 1669853467);
		func_1410(joaat("COMPONENT_SHORTARM_CYLINDER_ENGRAVING_1"), Var1, -1559225678);
		func_1410(joaat("COMPONENT_SHORTARM_CYLINDER_ENGRAVING_MATERIAL_7"), Var1, -266425508);
			...
			else
			{
				...
				if (bParam5)
				{
					...
					else
					{
						...
						{
							if (func_1413(iVar3) && func_1356(uParam0->f_1[iVar1 /*3*/], iVar3, &iVar0))
							{
...
int func_1219()
{
	...
	while (iVar1 < 5)
	{
		...
		if (!UNLOCK::_UNLOCK_IS_VISIBLE(func_1415(iVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_1220()
{
	...
	while (iVar0 < 5)
	{
		...
		if (!UNLOCK::_UNLOCK_IS_VISIBLE(func_1415(iVar1)))
		{
			UNLOCK::_UNLOCK_SET_VISIBLE(func_1415(iVar1), true);
		}
		iVar0++;
	}
}
...
void func_1223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	UILOG::_UILOG_SET_TOTAL_TAKE_SUMMARY(MISC::_CREATE_VAR_STRING(2, "MISSION_COMPLETE_TAKE_TOTAL", iParam1), MISC::_CREATE_VAR_STRING(2, "MISSION_COMPLETE_TAKE_TOTAL_GANG", func_1421()));
	if (!func_437(629))
	{
		func_293(629, 0);
	}
...
int func_1256()
{
	...
	while (iVar1 < 30)
	{
		if (func_1437(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_1350(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1480(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_1480(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_1481(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_1359(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_1484(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_1381()
{
	...
	fVar0 = 0f;
	fVar0 = (fVar0 + (0.9259259f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP1")))));
	fVar0 = (fVar0 + (0.2525252f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP2")))));
	fVar0 = (fVar0 + (0.2923976f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP3")))));
	fVar0 = (fVar0 + (0.462963f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP4")))));
	fVar0 = (fVar0 + (0.9259259f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP5")))));
	fVar0 = (fVar0 + (0.308642f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP6")))));
	fVar0 = (fVar0 + (5.555555f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP7")))));
	fVar0 = (fVar0 + (0.6944444f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP8")))));
	fVar0 = (fVar0 + (0.3703704f * BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("MISSIONS_CHP9")))));
	fVar0 = (fVar0 + (0.5f * func_1496(10f, BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("RC_STRANDS"))))));
	fVar0 = (fVar0 + (0.6f * func_1496(5f, BUILTIN::TO_FLOAT(func_1495(joaat("COMPLETED"), joaat("RC_STRANDS_BOUNTY"))))));
	fVar0 = (fVar0 + (0.2f * func_1496(25f, BUILTIN::TO_FLOAT(func_1323(joaat("UNIQUE_BEATS_COMPLETED"))))));
	fVar0 = (fVar0 + (2f * func_1496(1f, BUILTIN::TO_FLOAT(func_1323(joaat("GANG_AMBUSH_ENCOUNTERED"))))));
	fVar0 = (fVar0 + (0.3333333f * func_1496(6f, BUILTIN::TO_FLOAT(func_1323(joaat("GANG_HIDEOUT_COMPLETED"))))));
	fVar0 = (fVar0 + (3f * func_1496(1f, BUILTIN::TO_FLOAT(func_1323(joaat("DISCOVERABLE_FOUND"))))));
	iVar1 = func_1497();
	fVar0 = (fVar0 + (0.1111111f * func_1496(9f, BUILTIN::TO_FLOAT(iVar1))));
	...
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_AMERICANS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_AMERICANS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_ANIMALS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_ANIMALS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_ARTISTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_ARTISTS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_GIRLS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_GIRLS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_GUNSLINGERS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_GUNSLINGERS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_HORSES"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_HORSES")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_INVENTIONS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_INVENTIONS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_LANDMARKS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_LANDMARKS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_PLANTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_PLANTS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_SPORTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_SPORTS")))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_VEHICLES"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_VEHICLES")))));
	fVar0 = (fVar0 + func_1496(1f, fVar2));
	fVar0 = (fVar0 + (0.05f * func_1496(BUILTIN::TO_FLOAT(20), BUILTIN::TO_FLOAT(func_1499()))));
	if (func_83(40))
	{
		fVar0 = (fVar0 + (1f * 1f));
	}
	...
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 666607663)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 666607663))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), -220219788)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), -220219788))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 218622660)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 218622660))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 390004462)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 390004462))));
	fVar2 = func_1498(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 6410548)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 6410548))));
	fVar0 = (fVar0 + (1f * func_1496(1f, fVar2)));
	fVar0 = (fVar0 + (0.2f * func_1496(5f, BUILTIN::TO_FLOAT(func_1323(joaat("SHACK_FOUND"))))));
	fVar0 = (fVar0 + (0.2f * func_1496(5f, BUILTIN::TO_FLOAT(func_1495(joaat("KILLS"), joaat("LEGENDARY_ANIMALS"))))));
	...
	fVar0 = (fVar0 + (2f * func_1496((BUILTIN::TO_FLOAT(iVar3) / BUILTIN::TO_FLOAT(iVar4)), 1f)));
	fVar0 = (fVar0 + (2f * func_1496(1f, BUILTIN::TO_FLOAT(func_1501(joaat("HORSES_REACHED_MAX_BOND"))))));
	fVar5 = BUILTIN::TO_FLOAT(func_1502());
	fVar0 = (fVar0 + ((3f * fVar5) / BUILTIN::TO_FLOAT(9)));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ATTEMPTS"), joaat("BLACKJACK"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ATTEMPTS"), joaat("DOMINOES_HAND"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ATTEMPTS"), joaat("FIVE_FINGER"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ATTEMPTS"), joaat("POKER_HAND"))))));
	fVar0 = (fVar0 + (0.2f * func_1496(5f, BUILTIN::TO_FLOAT(func_1323(joaat("SPECIAL_PED_INTERACTION"))))));
	fVar0 = (fVar0 + (0.5f * func_1496(1f, BUILTIN::TO_FLOAT(func_1323(joaat("BATHS_TAKEN"))))));
	fVar0 = (fVar0 + (0.5f * func_1496(1f, BUILTIN::TO_FLOAT(func_1323(joaat("SHOWS_SEEN"))))));
	fVar0 = (fVar0 + (0.5f * func_1496(1f, BUILTIN::TO_FLOAT(func_1323(joaat("THEATRE_VISITS"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("AMMO"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("FOOD"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("HORSE_CARE"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("REMEDIES"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("WEAPONS"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("MADE_RECIPE_TYPE"), joaat("HUNTING"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ROB_COMPLETED"), joaat("COACH"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ROB_COMPLETED"), joaat("HOME"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ROB_COMPLETED"), joaat("SHOP"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_1496(1f, BUILTIN::TO_FLOAT(func_1495(joaat("ROB_COMPLETED"), joaat("TRAIN"))))));
...
int func_1396(int iParam0)
{
	...
	fVar1 = func_1506(MISC::ABSF(fVar1) < 1f, func_1506(fVar1 < 0f, -1f, 1f), fVar1);
...
{
	func_1507((MISC::GET_GAME_TIMER() + iParam2), !bParam1);
...
void func_1400(int iParam0)
{
	...
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1955569.f_5.f_2[0 /*36*/].f_20[2], func_1509(iParam0));
...
void func_1403(bool bParam0)
{
	...
	else
	{
		...
		while (iVar6 < 7)
		{
			if (func_1521(iVar6) == joaat("BREED_THOROUGHBRED_REVERSEDAPPLEBLACK"))
			{
...
void func_1406(bool bParam0)
{
	...
	else
	{
		...
		while (iVar0 < 7)
		{
			if (func_1521(iVar0) == joaat("BREED_ARDENNES_IRONGREYROAN"))
			{
...
void func_1412(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 39)
	{
		if (func_1531(&(uParam0->f_1[iVar0 /*3*/]), 2))
		{
...
void func_1420(int iParam0, char* sParam1)
{
	...
	{
		UILOG::_UILOG_ADD_TOTAL_TAKE_ENTRY(MISC::GET_HASH_KEY(func_1534(iParam0)), 1997120069, MISC::_CREATE_VAR_STRING(10, "MISSION_COMPLETE_TAKE_COMP", MISC::_CREATE_VAR_STRING(2, func_831(iParam0, 0))), MISC::_CREATE_VAR_STRING(2, "MISSION_COMPLETE_TAKE_AMOUNT", sParam1), 601389479);
	}
	else
	{
		UILOG::_UILOG_ADD_TOTAL_TAKE_ENTRY(MISC::GET_HASH_KEY(func_1534(iParam0)), 1997120069, MISC::_CREATE_VAR_STRING(10, "MISSION_COMPLETE_TAKE_COMP_NOS", MISC::_CREATE_VAR_STRING(2, func_831(iParam0, 0))), MISC::_CREATE_VAR_STRING(2, "MISSION_COMPLETE_TAKE_AMOUNT", sParam1), 601389479);
	}
}
...
int func_1430(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_1536(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_1536(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_1433(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_1543(iParam0));
	...
	func_807(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_1546(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_1454(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_1555(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_1461(int iParam0)
{
	...
	{
		return func_1557(Global_40.f_358[iParam0 /*12*/]);
	}
	return 0;
}
...
void func_1462(int iParam0, bool bParam1)
{
	if (bParam1)
	{
		MAP::_0x563FCB6620523917(func_1558(iParam0), -1482012664);
	}
	else if (MAP::_0xE38450DBCBC70E3D(func_1558(iParam0), -1305340593) || MAP::_0xE38450DBCBC70E3D(func_1558(iParam0), -1482012664))
	{
		MAP::_0x6786D7AFAC3162B3(func_1558(iParam0));
	}
}
...
int func_1465(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_1565(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_1567(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		...
		Var61.f_10 = iParam4;
		iVar0 = func_1569(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_1477(int iParam0)
{
	...
	while (iVar1 < 39)
	{
		if (func_1579(iVar1, Global_1946804.f_2535.f_43[iVar0 /*2*/].f_1))
		{
			func_1580(iVar1, Global_1946804.f_2535.f_43[iVar0 /*2*/].f_1);
		}
		iVar1++;
	}
...
bool func_1478(bool bParam0)
{
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			{
				func_1107(iVar0, 0);
				func_1481(&(Global_1946804.f_2589.f_2[(Global_1946804.f_2589 - 1) /*2*/]), 2, 6);
			}
			func_1112(iVar2, 3, 6);
...
void func_1485(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_1484(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
		iVar0++;
	}
}
		...
		while (iVar36 < iVar34)
		{
			if (uVar18[iVar36] == func_1211(iVar0[iVar36], iVar35))
			{
				...
				if (iVar35 == 0)
				{
					...
					while (iVar37 < 39)
					{
						if (!func_1531(&(Global_1946804.f_1616.f_1[iVar37 /*3*/]), 2))
						{
						}
						else
						{
	...
	if ((bVar16 || bVar17) || Global_40.f_7729 == func_995(iParam0))
	{
		if (!func_1089(8))
		{
			...
			if (bVar16 || Global_40.f_7729 == func_995(iParam0))
			{
				...
				{
					func_1594(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), Global_1905941, 1, 0, 0);
				}
			}
		}
	}
...
struct<6> func_1516()
{
	...
	if (func_1340(joaat("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_1340(joaat("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_1340(joaat("SLOTID_HORSE_HORN"), &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_1340(joaat("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_1340(joaat("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_1340(joaat("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
{
	*uParam0 = (*uParam0 - 1);
	func_1467(&(uParam0->f_1[iParam1 /*5*/]));
...
void func_1577()
{
	...
	TASK::TASK_PLAY_ANIM(Global_35, func_1655(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_1115(1);
	STREAMING::REMOVE_ANIM_DICT(func_1655());
}
...
int func_1584(vector3 vParam0)
{
	...
	return func_1656(vParam0, Global_1894052[iVar0 /*3*/].f_1, Global_1894052[iVar0 /*3*/].f_2, Global_1894052[iVar0 /*3*/], 4);
}
	...
	while (iVar0 < 39)
	{
		...
		else
		{
			...
			else
			{
				...
				else if ((func_1357(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946804.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_1667(iParam1, iVar1, bVar4, 1, uParam0->f_1[iVar1 /*3*/]);
							}
