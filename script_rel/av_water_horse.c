...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 54:
			...
			iLocal_39 = func_49(997958153 /* GXTEntry: "Riding" */, 1);
				...
				switch (iLocal_9)
				{
					case 0:
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
						{
							...
							TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), iLocal_44, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
						...
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
						{
							...
							if (*uParam0 == 54)
							{
								func_70(&(uParam0->f_20[0 /*14*/]), -1043454001, 0, 0, 0, -1082130432 /* Float: -1f */);
								PED::_0xF9CBD46433E36713(Global_35, &(uParam0->f_20[0 /*14*/]), 0f, 0f, 0f, 4f, 20f, 200f, -1f, "MPDHP_MAN");
							}
							else
							{
								TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sLocal_43, "respawn_loop", 1090519040, -1056964608, -1, 1, 0, 0, 0, 0, 0, 0);
							}
					...
					case 2:
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_35) && ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
						{
							if (func_77(&uLocal_40, func_76(*uParam0 == 54, 240f, fLocal_46)) || func_78(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 100f)
							{
								...
								if (*uParam0 != 54)
								{
									TASK::TASK_PLAY_ANIM(0, sLocal_43, "respawn_action", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
								}
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_142(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_142(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_142(iParam5, 32), 1);
