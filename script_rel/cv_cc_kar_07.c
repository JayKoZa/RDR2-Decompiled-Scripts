...
int func_72(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", uLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_19, "p_cs_sock01x_PH_L_HAND", 0, 0);
	func_157(uParam0, iLocal_15, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", uLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(-360309995, 0))
	{
		return 0;
	}
	return 1;
