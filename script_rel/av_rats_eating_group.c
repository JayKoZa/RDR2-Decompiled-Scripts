		...
		case 0:
			...
			while (iVar1 < 10)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar1 /*14*/])))
				{
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iVar1 /*14*/]), -1756372705, (uParam0->f_20[iVar1 /*14*/])->f_5, (uParam0->f_20[iVar1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
...
int func_168(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_185(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
