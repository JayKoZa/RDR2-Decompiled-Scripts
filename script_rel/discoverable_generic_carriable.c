	...
	switch (iLocal_62)
	{
		...
		case 10:
				...
				if (uParam0->f_4 == 2)
				{
					...
					if (!func_83(uParam0, 2))
					{
						...
						else if (OBJECT::DOES_PICKUP_EXIST(iLocal_16[0]) && OBJECT::HAS_PICKUP_BEEN_COLLECTED(iLocal_16[0]))
						{
							...
							func_73(func_88(uParam0), WEAPON::_GET_WEAPON_CLIP_SIZE(func_74(uParam0, 0)) * 4, 1, 0, 0, 752097756, 0, 0, 0, 0);
						}
					}
			...
			else if (*uParam0 == 247563739)
			{
				...
				{
					if ((!func_11(*uParam0, 8) && VOLUME::_DOES_VOLUME_EXIST(iLocal_14)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_14, true, 0))
					{
						func_91(uParam0);
					}
					if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_47[0]))
		...
		case 11:
			...
			else if (*uParam0 == 247563739)
			{
				...
				if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_47[0]))
				{
					...
					else if (((TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_47[0]) && !PED::_IS_PED_USING_SCENARIO_POINT(Global_35, iLocal_47[0])) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0)) && func_11(*uParam0, 16))
					{
						func_68(uParam0);
						func_69(uParam0);
						func_49(&iLocal_62, 13, 1);
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_48(*uParam0))
			{
				uParam0->f_6.f_8 = func_117("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_117("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_117("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_117("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("PLAYER_FOCUS_TIMING"), 0, 0);
		}
...
void func_62(var uParam0)
{
	...
	if (*uParam0 == 1284679164 || *uParam0 == -780455182)
	{
		...
		while (iVar0 <= (4 - 1))
		{
			...
			{
				if (TXD::_DOES_STREAMED_TXD_EXIST(func_160(uParam0, iVar0)))
				{
					TXD::_REQUEST_STREAMED_TXD(func_160(uParam0, iVar0), false);
				}
			}
			iVar0++;
		}
...
bool func_63(var uParam0)
{
	...
	if (*uParam0 == 1284679164 || *uParam0 == -780455182)
	{
		...
		while (iVar0 <= (4 - 1))
		{
			if (!func_160(uParam0, iVar0) == -1)
			{
				if (TXD::_DOES_STREAMED_TXD_EXIST(func_160(uParam0, iVar0)) && !TXD::_HAS_STREAMED_TXD_LOADED(func_160(uParam0, iVar0)))
				{
					return false;
				}
			}
	...
	if ((*uParam0 == 1335921989 || *uParam0 == -709811179) || *uParam0 == -780455182)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uLocal_66[0]))
		{
			...
			if (*uParam0 == -780455182)
			{
				...
				{
					if (TXD::_DOES_STREAMED_TXD_EXIST(func_160(uParam0, 0)))
					{
						OBJECT::_SET_APPLY_OBJECT_TXD(uLocal_66[0], func_160(uParam0, 0), 0, 0);
					}
				}
			}
		}
...
int func_73(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_199(iParam0, 589988438))
		{
			if (func_218())
			{
				func_219(joaat("REWARD_SMALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
...
void func_92(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	if (func_58(Global_35, func_86(uParam0, uParam0->f_4), 15f, 1, 1))
	{
		...
		else if (!DECORATOR::DECOR_EXIST_ON((*uParam2)[iParam3], "letter_item"))
		{
			...
			{
				if (TXD::_DOES_STREAMED_TXD_EXIST(func_160(uParam0, iParam3)))
				{
					OBJECT::_SET_APPLY_OBJECT_TXD((*uParam2)[iParam3], func_160(uParam0, iParam3), 0, 0);
				}
			}
			if (*uParam0 == 1284679164)
			{
...
void func_99(int iParam0, int iParam1, int iParam2)
{
	...
	UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iVar0, 0, MISC::_CREATE_VAR_STRING(0, func_276(iParam0), iParam1, iParam2), iParam1 == iParam2, false, false);
...
void func_100(char* sParam0)
{
	...
	func_280(MISC::_CREATE_VAR_STRING(2, "DISCO_DREAM"), sParam0, joaat("HUD_TOASTS"), joaat("TOAST_DREAMCATCHER"), joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, "COL_CTX_PLAYER_LOG"), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
	...
	if (*uParam0 == 1284679164 || *uParam0 == -780455182)
	{
		...
		while (iVar0 <= (4 - 1))
		{
			if (!func_160(uParam0, iVar0) == -1)
			{
				if (TXD::_DOES_STREAMED_TXD_EXIST(func_160(uParam0, iVar0)))
				{
					TXD::_SET_STREAMED_TXD_AS_NO_LONGER_NEEDED(func_160(uParam0, iVar0));
				}
			}
			iVar0++;
		}
...
void func_140(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	Var8 = { func_262(joaat("HONOR_CURRENT")) };
...
void func_197(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_280(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_280(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_211(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_89(joaat("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
...
void func_223(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_189(437, 0);
			func_189(440, 0);
			func_383(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_195(51, 0, 0, joaat("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_197(51, 0, 0, sVar0, func_340(joaat("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_375(1);
			func_55(-748969569, 0, 0);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_02"), 1);
			func_383(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_195(51, 0, 0, joaat("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_197(51, 0, 0, sVar0, func_340(joaat("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_375(8);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_03"), 1);
			func_383(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_195(51, 0, 0, joaat("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_197(51, 0, 0, sVar0, func_340(joaat("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_375(64);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_04"), 1);
			func_383(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_195(51, 0, 0, joaat("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_197(51, 0, 0, sVar0, func_340(joaat("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_375(512);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_05"), 1);
			func_189(438, 0);
			func_383(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_195(51, 0, 0, joaat("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_197(51, 0, 0, sVar0, func_340(joaat("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_375(32768);
			break;
		default:
			func_189(439, 0);
	...
	if (func_106() == -1)
	{
		...
		else if (func_199(iParam0, -1478961327))
		{
			...
			if (func_385() == 2)
			{
				...
				if (iParam0 == joaat("PROVISION_GATOR_EGG"))
				{
					if (!func_389(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("GATOR_EGGS"), 0)) >= 25)
					{
						func_390(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("GATOR_EGGS"), 0), 1);
						func_335(48);
					}
					if (func_387(iParam0) < func_388(iParam0))
					{
...
void func_228(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR"):
			func_219(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS"):
			func_219(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_TEN_DOLLARS"):
			func_219(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_BILLFOLD"):
			func_219(joaat("REWARD_BILLFOLD"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_BILLFOLD_SML"):
			func_219(joaat("REWARD_BILLFOLD_SML"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_BILLSTACK"):
			func_219(joaat("REWARD_BILLSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COIN"):
			func_219(joaat("REWARD_COIN"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINPURSE"):
			func_219(joaat("REWARD_COINPURSE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINSACK"):
			func_219(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINSTACK"):
			func_219(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_MONEYCLIP"):
			func_219(joaat("REWARD_MONEYCLIP"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_MONEYSTACK"):
			func_219(joaat("REWARD_MONEYSTACK"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_MONEYSTACK_LARGE"):
			if (!func_394())
			{
				func_219(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM"):
			func_219(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINCUP_LG"):
			func_219(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_CARD_SET_COMMON"):
			func_219(joaat("REWARD_CARD_SET_COMMON"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_RARE"):
			func_219(joaat("REWARD_CARD_SET_RARE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CARD_SET_ALL"):
			func_219(joaat("REWARD_CARD_SET_ALL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_RARE_FISH"):
			func_219(joaat("REWARD_RARE_FISH"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_1"):
			func_219(joaat("REWARD_TAXIDERMY_STAGE_1"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_2"):
			func_219(joaat("REWARD_TAXIDERMY_STAGE_2"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_3"):
			func_219(joaat("REWARD_TAXIDERMY_STAGE_3"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_4"):
			func_219(joaat("REWARD_TAXIDERMY_STAGE_4"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_TAXIDERMY_STAGE_5"):
			func_219(joaat("REWARD_TAXIDERMY_STAGE_5"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case joaat("MONEY_CALLOWAY_LETTER"):
			func_219(joaat("REWARD_CALLOWAY_LETTER"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_239(int iParam0, bool bParam1)
{
	...
	func_280(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar3), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_253(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == joaat("KIT_BANDANA") && func_418(81053684, 0) <= 0)
			{
...
int func_255(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_427(&Var4, joaat("LOOT_TYPE_NORMAL"));
...
void func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_435(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
...
void func_270(int iParam0, char* sParam1, int iParam2)
{
	...
	func_311(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_271(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_311(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_311(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
bool func_293(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_288(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_GET_CURRENT_VEHICLE_DRIVER(iVar0) == Global_35)
		{
			return false;
		}
	}
...
struct<5> func_326(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_198(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_358(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_358(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_345(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_348(func_498(iVar0))), func_348(func_498(iVar0)), bVar1, true, false);
		}
		if (iParam2 == joaat("DINO_BONES"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_501(iVar0)), func_501(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == -1531394072)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_504(iVar2)), func_504(iVar2), bVar1, true, false);
		}
		if (iParam2 == 1995362678)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_506(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_506(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
		if (iParam2 == joaat("ROCK_CARVINGS"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_507(iVar0)), func_507(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_509(iVar2)), func_509(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_353(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_106() == -1)
			{
				if (!func_425(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_520(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_15())
					{
...
bool func_367(int iParam0, int iParam1, var uParam2)
{
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_532(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_381()
{
	...
	while (iVar1 < 30)
	{
		if (func_536(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_385()
{
	...
	while (iVar1 < 5)
	{
		if (func_537(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_401(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	func_544(iParam2);
	func_545(iParam2, iVar5);
	if (Global_1946804.f_1378.f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && Global_1946804.f_57[iParam2 /*11*/].f_1 > 1)
	{
		func_546(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_546(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	func_547(&(Global_1946804.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946804.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_548(iParam0, iParam2, iParam1, func_106() != -1);
	if (bParam4)
	{
		func_549(&(Global_1946804.f_1378), 1, 3);
	}
	else
	{
		func_549(&(Global_1946804.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_550(func_541(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
void func_405()
{
	func_554(&(Global_1946804.f_2776));
	func_555(32768);
...
float func_412()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_564()));
	fVar7 = (func_559(2) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_565(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_566(3, fVar9, fVar9 > 100f);
	return func_567(fVar7, -100f, 100f);
}
...
float func_413()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_564()));
	fVar7 = (func_559(1) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_565(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_566(2, fVar9, fVar9 > 100f);
	return func_567(fVar7, -100f, 100f);
}
...
float func_414()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_564()));
	fVar7 = (func_559(0) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_565(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_566(1, fVar9, fVar9 > 100f);
...
void func_421(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_572(iParam0))
	{
		func_573(iParam0, 1, 0);
	}
	iVar0 = func_574(iParam0);
	if (iVar0 != 0 && !(iParam0 >= 0 && iParam0 <= 5))
	{
		if (func_575(iParam0, 512))
		{
			func_403(30, iVar0, 0, 0, 0);
		}
	}
	if ((!func_576() && !bParam1) && !func_577(0, 0, 1))
	{
...
{
	return func_418(iParam0, 0) < func_579(iParam0, bParam1);
}
...
int func_431(int iParam0)
{
	...
	if (!func_584(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	if (func_106() == -1)
	{
		if (func_188(43))
		{
			if (func_199(iParam0, 412399755))
			{
				...
				{
					func_37(0, 10);
					iVar0 = func_585(iParam0, iParam1, 1);
					if (((iParam0 == joaat("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == joaat("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == joaat("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_387(iParam0) < func_388(iParam0))
						{
		...
		if (func_188(44))
		{
			if (func_199(iParam0, 709057512))
			{
				...
				{
					func_37(0, 10);
					iVar0 = func_585(iParam0, iParam1, 2);
					if ((iParam0 == joaat("PROVISION_HERON_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_387(iParam0) < func_388(iParam0))
						{
		...
		if (!func_188(45))
		{
			if (func_199(iParam0, -1478961327))
			{
				...
				{
					func_37(0, 10);
					iVar0 = func_585(iParam0, iParam1, 4);
		...
		if (!func_188(46))
		{
			if (func_199(iParam0, -1238404098))
			{
				...
				{
					func_37(0, 10);
					iVar0 = func_585(iParam0, iParam1, 8);
					if (((iParam0 == joaat("PROVISION_SPOONBILL_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_387(iParam0) < func_388(iParam0))
						{
		...
		if (!func_188(47))
		{
			if (func_199(iParam0, 1160548794))
			{
				...
				{
					func_37(0, 10);
					iVar0 = func_585(iParam0, iParam1, 16);
					if (((iParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_387(iParam0) < func_388(iParam0))
						{
...
void func_444(int iParam0)
{
	...
	func_586((Global_40.f_4283.f_325 + iParam0));
}
...
void func_445(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_443())
	{
		func_311(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_311(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
bool func_453(int iParam0)
{
	...
	if (!func_589(Global_35))
	{
		return false;
	}
	if (!func_288(iParam0, 16) && !func_590(iVar0, 0))
	{
		return false;
	}
	return true;
...
bool func_470(int iParam0, var uParam1, var uParam2)
{
	if (!func_469(iParam0))
	{
		return false;
...
{
	return func_358(joaat("CHARACTER"), func_592(), -1591664384, bParam0);
}
...
bool func_478(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
{
	return func_594(Global_40.f_11095.f_11[iParam0]);
}
...
void func_484(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_595(iParam0) && func_596(iParam0))
	{
		if (!bParam2)
		{
			iVar3 = func_597(fVar1, fParam1);
			if (fParam1 > IntToFloat(func_598(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
				if (!HUD::IS_RADAR_HIDDEN() && !Global_16)
				{
					if (iVar2 > iVar0)
					{
						func_189(func_599(iParam0), 0);
					}
					func_600(iParam0, iVar2, iVar3);
					func_601(iParam0, 7000);
				}
...
int func_493()
{
	return func_603(Global_40.f_12019);
}
...
int func_495()
{
	...
	while (iVar1 < 30)
	{
		if (func_604(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_605(iParam0) && func_89(iParam0, 1, 0))
	{
		return true;
	}
	else if (func_606(iParam0) && func_607(iParam0))
	{
		return true;
	}
	return false;
...
void func_526(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar3 = func_612(*iParam0);
	iVar4 = func_613(*iParam0);
	...
	func_616(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
bool func_530(int iParam0, var uParam1)
{
	...
	iVar1 = func_400(func_617(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
{
	return func_618(iParam0, -1);
}

bool func_535(int iParam0, bool bParam1)
{
	return func_619(func_525(), iParam0, bParam1);
}
...
{
	func_620(&(Global_1946804.f_2589), iParam0);
}

void func_545(int iParam0, int iParam1)
{
	func_621(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
void func_547(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_622(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
		uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
		if (bParam4)
		{
			func_545(iVar1, iVar3);
		}
	}
	if (func_425(-1586649372) && func_622(iParam2, 524288))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_623(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_623(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_623(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/])
				{
					uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
				...
				func_623(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				{
					iVar1 = 35;
					if ((func_532(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_203(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_532(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_199(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
int func_548(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_624(0);
	if (iParam2 != 0 && func_625(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_626(iParam0, func_541(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_549(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_627(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_551(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_629(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_106() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_630(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_574(0))
		{
			if (Global_40.f_7157[Global_40.f_7729 /*3*/] & 512 != 0)
			{
				...
				Global_1946804.f_1497 = func_574(Global_40.f_7729);
				Global_1946804.f_1378 = func_574(Global_40.f_7729);
...
void func_565(int iParam0, char* sParam1, bool bParam2)
{
	char* sVar0;

	sVar0 = func_637(iParam0, 1, 0, 0);
	sVar0 = MISC::_CREATE_VAR_STRING(2, sVar0, sParam1);
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1955569.f_5.f_2[iParam0 /*36*/].f_12[1], sVar0);
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(Global_1955569.f_5.f_2[iParam0 /*36*/].f_16[1], bParam2);
}

void func_566(int iParam0, float fParam1, bool bParam2)
{
	char* sVar0;

	sVar0 = func_637(iParam0, 2, 0, 0);
...
float func_567(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_573(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_572(iParam0))
	{
		...
		if ((!func_576() && !bParam1) && !func_577(0, 0, 1))
		{
			func_452(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_639(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
bool func_577(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_641(Global_1898164.f_1[0 /*5*/]);
		if (func_315(iVar0) && func_642(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
void func_583(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
bool func_584(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_586(int iParam0)
{
	...
	Var0 = { func_262(joaat("GANG_SAVINGS_CASH")) };
...
float func_593(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50:
			...
			iVar5 = func_594(fVar3);
			iVar0 = iVar5;
			iVar6 = iVar0 + 1;
			iVar1 = (func_653(iVar6) - func_653(iVar5));
...
int func_597(float fParam0, float fParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	iVar0 = func_594(fParam0);
	fVar1 = BUILTIN::TO_FLOAT(func_653(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_653(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_600(int iParam0, int iParam1, int iParam2)
{
	...
	iVar3 = (iVar3 + func_656(iParam0));
	sVar4 = func_658(func_657(iVar3, iParam2));
	sVar6 = func_659(iParam0);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar6))
	{
		sVar5 = "HUD_Toast_Soundset";
	}
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_660(iParam0));
	iVar8 = func_661(iParam0);
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_662(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_280(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_663(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_607(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_664(&iVar0, 0, iVar95, &Var1) && !func_664(&iVar0, 1, iVar95, &Var1))
		{
		}
...
void func_608()
{
	...
	func_667(0);
	func_668(7);
	func_669(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_422() == 1160113249)
	{
		func_669(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_669(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_670(Global_35, &uVar0);
}

int func_609(int iParam0)
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_671(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_616(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_672(iParam0, iParam6);
	func_673(iParam0, iParam5);
	func_674(iParam0, iParam4);
	func_675(iParam0, iParam3);
...
int func_618(int iParam0, int iParam1)
{
	...
	func_672(&uVar6, iVar0);
	func_673(&uVar6, iVar1);
	func_674(&uVar6, iVar2);
	func_675(&uVar6, iVar3);
	func_676(&uVar6, iVar4);
	func_677(&uVar6, iVar5);
	return uVar6;
}
...
void func_623(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (uParam0->f_1[iVar3 /*3*/].f_1 == 1216705912 || uParam0->f_1[iVar3 /*3*/].f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_545(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_545(iVar3, iVar0);
		}
	}
...
void func_629(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_106() == -1)
	{
		func_683(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_684(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	func_685(&(Global_1946804.f_1378), iParam0);
	func_686(2, iParam0, 6);
	if (bParam1)
	{
		func_632(0, 1);
	}
...
float func_635(int iParam0)
{
	return Global_40.f_11095.f_11[iParam0];
}

int func_636(float fParam0)
{
	return BUILTIN::ROUND(((fParam0 / 100f) * BUILTIN::TO_FLOAT(10)));
}

char* func_637(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
int func_641(int iParam0)
{
	...
	return func_689(func_688(iParam0));
}
...
bool func_645(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_89(func_695(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
int func_656(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_300(0), joaat("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_300(0), joaat("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_300(0), joaat("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}

struct<4> func_657(int iParam0, int iParam1)
{
	char cVar0[32];
...
char* func_658(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_664(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;

	if (func_696(iParam1) && !func_697(iParam1))
	{
...
void func_665(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		func_701(iVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
		if (func_702(&(iParam1->f_1), iVar0, iParam1->f_7, iParam1->f_5))
		{
		}
	}
}
...
void func_668(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_705(&(Global_1946804.f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_706(iVar2, 0))
		{
			func_707(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_669(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_709(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_710(0))
	{
		func_711(iParam0, 1);
		if (func_422() == 1160113249)
		{
			func_711(func_710(-2125499975), 0);
		}
		else
		{
			func_711(func_710(1160113249), 0);
		}
	}
	func_712();
	if (func_713(iVar0))
...
int func_671(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
...
void func_674(int iParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_615(iVar0, iVar1))
	{
		return;
	}
...
bool func_678(int iParam0)
{
	...
	iVar2 = func_612(iParam0);
	if (iVar2 < 0 || iVar2 > 23)
	{
		return false;
	}
	iVar3 = func_609(iParam0);
	...
	if (iVar5 < 1 || iVar5 > func_615(iVar4, iVar3))
	{
		return false;
	}
	return true;
...
void func_701(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
bool func_702(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_703(int iParam0, bool bParam1, bool bParam2)
{
	bool bVar0;
	...
	{
		case -2061583405:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_728(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_705(var uParam0, int iParam1, int iParam2)
{
	...
	func_729(iParam2, *uParam0);
	func_730(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
int func_709(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	...
	if (func_731(iVar1, &uVar0))
	{
		return 0;
	}
	if (bParam3 && !func_706(iParam0, 0))
	{
		return 0;
	}
	...
	{
		func_705(&(Global_1946804.f_2657.f_26.f_26), iParam0, Global_1946804.f_2657.f_19);
	}
...
{
	return func_733(func_732(iParam0));
}
...
void func_730(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
void func_734(var uParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_737(iParam1);
	func_738(iParam1, iParam2);
	if (iVar1 >= 0 && uParam0->f_26 > 0)
	{
		func_739(&(uParam0->f_26), iVar1);
		if (func_740(uParam0->f_26, &iVar0))
		{
...
void func_736(var uParam0)
{
	...
	func_743(&(uParam0->f_3), *uParam0, uParam0->f_2);
}
...
void func_743(var uParam0, var uParam1, var uParam2)
{
	int iVar0;

	iVar0 = func_744(func_422());
	if (*uParam0)
	{
		func_742(uParam0);
	}
