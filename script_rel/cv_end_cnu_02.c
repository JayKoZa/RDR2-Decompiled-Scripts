...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -0.3f, 0.1f, 0f, -27f, 1.03f, 0.7f, 3f, 665633627, 1);
	...
	func_154(uParam0, "script@vignette@beecher@charles_and_uncle_2@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@beecher@charles_and_uncle_2@action", 0, 0, 1, 0);
	func_155(uParam0, "BCCU2AU");
	func_156(uParam0, 57653835, -633547353);
	func_157(uParam0, iLocal_14, 3, -2138878033, "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 2, -2138878033, "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, 1051693614, "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0);
	func_158(uParam0, iLocal_15, 3, 1051693614, "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
