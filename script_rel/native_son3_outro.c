...
void func_1(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		...
		{
			func_13(&(uLocal_5[iVar0]), 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
	iVar1 = 0;
...
int func_6(var uParam0)
{
	...
	switch (iLocal_4)
	{
		case 0:
			...
			else if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_8, 1, 0))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_LOADING(iLocal_8, 1))
				{
...
int func_24(var uParam0)
{
	...
	{
		case 0:
			if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_8, 0))
			{
				func_44(&uLocal_15);
				iLocal_3 = 1;
			}
		...
		case 1:
			...
			break;
		case 2:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_8, 0))
			{
				iLocal_3 = 3;
			}
			break;
...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_72(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_74(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_75(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_75(iParam0, 0));
					func_76(iParam0);
				}
			}
			else
