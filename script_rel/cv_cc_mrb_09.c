...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.15f, -0.0125f, 0.85f, -0.5f, 0.885f, 0.825f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_151(uParam0, -0.9125f, -1.625f, 0.85f, -14.5f, 1f, 1f, 3.2075f, -1612834106, -695792551, 1, 1, 1);
	...
	uLocal_21 = func_152(uParam0, joaat("p_chair_crate15x"), -0.93809f, -1.52663f, -0.00883484f, 0, 1, 0, 1);
	uLocal_22 = func_152(uParam0, joaat("p_chair_crate02x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@marybeth_9@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@marybeth_9@Action_A", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_BACKLEFT", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_BACKRIGHT", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_FRONT", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@marybeth_9@ACTION_B_ALT_RIGHT", 0, 0, 0, 1);
	func_154(uParam0, "CCMB9AU");
	func_155(uParam0, iLocal_15, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", uLocal_22, 0);
	func_156(uParam0, iLocal_15, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", uLocal_22, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_157(uParam0, iLocal_15, iLocal_24, "p_cs_sock01x_PH_L_HAND", 0, 0);
	func_155(uParam0, iLocal_14, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", uLocal_21, 0);
	func_156(uParam0, iLocal_14, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", uLocal_21, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_157(uParam0, iLocal_14, iLocal_23, "p_cs_sock01x_PH_L_HAND", 0, 0);
	Local_25 = { func_158(uParam0, -0.175f, -0.7325f, 0.564f, 67.5f, 6.6675f, 0.297f, 0.35f) };
	Local_35 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, 124.92f, 6.6675f, 0.176f, 0.35f) };
	Local_45 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, 165.96f, 6.6675f, 0.191f, 0.287f) };
	Local_55 = { func_158(uParam0, -0.175f, -0.733f, 0.564f, -146.52f, 6.6675f, 0.6125f, 0.35f) };
	STREAMING::_REQUEST_SCENARIO_TYPE(-360309995, 1, 0, 0);
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, Local_25, 1, 0))
		{
			func_188(uParam0, iLocal_17, 1);
		}
		else if (func_197(uParam0, Local_35, 1, 0))
		{
			func_188(uParam0, iLocal_18, 1);
		}
		else if (func_197(uParam0, Local_55, 1, 0))
		{
			func_188(uParam0, iLocal_20, 1);
		}
		else if (func_197(uParam0, Local_45, 1, 0))
		{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_208(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, float fParam8, int iParam9)
{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_254(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_268((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_301(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_253(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_302(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_254(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_324(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
float func_302(float fParam0, float fParam1)
{
...
int func_324(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_330(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_338(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_347(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_386(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_390(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_415(iParam0) && func_416(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_418(iParam0, vVar0, iParam6, iParam10))
				{
					return func_417();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_206(vVar0)) && !func_207(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
...
int func_399(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_433(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_406(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_447(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_447(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_418(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_279(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_419(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_449(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(747937920, 1) && !func_393(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_445(int iParam0)
{
	...
	func_462(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_465(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_474(bParam0, &Var0, iVar5, 0))
			{
				if (func_475(bParam0, &Var6, iVar5))
				{
					Var29 = { func_476(bParam0, Var0, iVar5, 0) };
					func_477(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_478(0))
				{
					...
					func_479(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_480(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
struct<5> func_472(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_484(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_476(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_486(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_474(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_474(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_475(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_489(bParam0, -1823706425))
			{
				Var0 = { func_476(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_489(bParam0, -1483207246))
			{
				Var0 = { func_476(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_474(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_491(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_475(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_492(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_476(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_493(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_494(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_477(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_480(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_497(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_476(joaat("character"), func_498(), -1591664384, bParam0);
}
...
int func_486(bool bParam0, bool bParam1)
{
	if (func_488(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_499(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_490(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_491(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_476(bParam0, Param1, iParam5, bParam6) };
...
int func_492(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_494(0);
	*uParam1 = { func_476(bParam0, func_485(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
