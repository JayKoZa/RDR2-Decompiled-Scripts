...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.2f, -3.325f, 0.832f, 87.12f, 2.81f, 5.97f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 2.6625f, 1.2125f, 0.8945f, 80f, 1f, 1f, 3f, -1612834106, 2017216891, 1, 1, 1);
	...
	uLocal_15 = func_152(uParam0, joaat("p_chairfolding02x"), 2.08997f, 1.19411f, 0.162041f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@dutch_29@base", 1, 1, 0, 0);
	uLocal_18 = func_153(uParam0, "script@vignette@dutch_29@action", 0, 0, 1, 0);
	func_154(uParam0, "CDT29AU");
	func_155(uParam0, -436255731, 1457978806);
	func_156(uParam0, uLocal_18, -1, 0.88f);
	func_157(uParam0, iLocal_14, 3, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", uLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	func_192(func_191(uParam0, iLocal_17), 0);
	return 1;
}
