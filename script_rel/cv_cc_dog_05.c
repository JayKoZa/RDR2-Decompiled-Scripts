...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0564f, -1.585f, 0f, -46.75f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.6186f, 2.04f, 0f, 39.5f, 1.55f, 1.11f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 0.24f, 2.24f, 0.9775f, 16.2f, 1f, 0.76f, 2f, joaat("VOLCYLINDER"), 1);
	...
	func_157(uParam0, iLocal_16, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_342(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_380(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
