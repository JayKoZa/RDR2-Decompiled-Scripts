...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.6f, 0f, 2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_201(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
