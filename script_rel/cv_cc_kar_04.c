...
{
	PED::_0xDE7B2B4144906CDF(585448480, func_8(uParam0, iLocal_14));
	return 1;
}
...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.6f, 0f, 2f, 2f, 3f, -1612834106, -695792551, 1, 1, 1);
	iLocal_17 = func_152(uParam0, joaat("p_bottlejd01x"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_153(uParam0, "script@vignette@karen_4@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@karen_4@action", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@karen_4@exit", 0, 0, 0, 0);
	func_154(uParam0, "CKAR4AU");
	func_155(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	func_156(uParam0, iLocal_14, 2, -1);
	func_157(uParam0, iLocal_14, 3, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	Local_19 = { func_159(uParam0, 0f, 0f, 0.7f, 0f, 6f, 0.5f, 0.5f) };
	func_160(uParam0, 1);
	func_161(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	return 1;
}
...
int func_77(var uParam0)
{
	...
	iVar0 = func_8(uParam0, iLocal_14);
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		PED::_0xF7EA250B9A919E03(585448480, iVar0);
		if (PED::_0x854BC9B1A1CCD034(585448480, iVar0))
		{
			return 1;
		}
	}
...
{
	return func_192(uParam0, Local_19, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		PED::_0x3BBDD6143FF16F98(func_8(uParam0, iLocal_14), func_202(uParam0, iLocal_17), "p_bottleJD01x_ph_r_hand", "WORLD_HUMAN_LEAN_BACK_WALL", 0, 1);
		bLocal_18 = true;
	}
	if (bLocal_18)
	{
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_257(func_148(uParam0), func_256(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
			Var0 = { func_258(func_148(uParam0), func_256(uParam0, iParam1), func_20(uParam0), 1) };
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_295(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
...
int func_390(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_425(iParam0, func_285());
