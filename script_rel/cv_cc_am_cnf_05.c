	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_224(&uLocal_98))
		{
			...
			else
			{
				...
				func_167(uParam0, iLocal_18, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_226(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_215(9);
			return 0;
...
int func_289(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_468(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_261(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_261(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_261(iParam5, 32), 1);
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_530(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_541(bParam0, &Var0, iVar5, 0))
			{
				...
				{
					Var29 = { func_543(bParam0, Var0, iVar5, 0) };
					func_544(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_545(0))
				{
					...
					func_546(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
struct<5> func_539(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_551(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_543(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_543(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
struct<4> func_543(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_544(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_558(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_543(bParam0, Param1, iParam5, bParam6) };
...
int func_559(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_561(0);
	*uParam1 = { func_543(bParam0, func_552(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
