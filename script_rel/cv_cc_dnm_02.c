...
bool func_78(var uParam0)
{
	...
	func_163(uParam0, -1.5876f, 0.8444f, 0.9953f, -90.72f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	iLocal_119 = func_167(uParam0, -1.36f, 0.24f, 0.703f, 0f, 0f, -90f, 2.5f, 2.5f, 2f, "volAntiGrief", joaat("VOLCYLINDER"));
	func_168(uParam0, iLocal_92, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_103, 0, 15f, 1065353216 /* Float: 1f */, 1);
	...
	func_168(uParam0, iLocal_93, 2, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", iLocal_104, 0, 10f, 1065353216 /* Float: 1f */, 1);
...
bool func_224(var uParam0)
{
	if (bLocal_128)
	{
		...
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(func_54(uParam0, iLocal_92), 242628503, true) == 8)
			{
				bLocal_128 = false;
				return true;
			}
...
bool func_239(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_277()
{
	...
	if (func_363(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_278()
{
	...
	if (func_363(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_284(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_364(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_304(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_321(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_367(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_373(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_432(iParam1))
		{
			func_433(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_391(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
bool func_427(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_56(iParam0))
	{
		return false;
...
bool func_468(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_115(iParam0))
	{
		return false;
...
void func_470(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_256(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_256(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_256(iParam5, 32), true);
...
bool func_471(int iParam0, int iParam1)
{
	...
	bVar0 = func_518(iParam0, iParam1);
	return bVar0;
}
...
bool func_493(int iParam0, char* sParam1)
{
...
bool func_495(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_499(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_363(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_462(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_524(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_541(iVar0))
		{
	...
	{
		func_543(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_544(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_552(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_556(0))
				{
					...
					func_557(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_550(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_562(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_554(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_554(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
{
	return func_569(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_554(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_555(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
struct<4> func_563(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_554(923904168, func_561(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_554(923904168, func_561(bParam0), -740156546, 0) };
		}
...
struct<4> func_565(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_554(271701509, func_561(bParam0), 12999093, 0) };
		}
...
bool func_568(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_570(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
