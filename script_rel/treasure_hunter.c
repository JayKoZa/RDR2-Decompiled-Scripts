...
int func_11(var uParam0)
{
	...
	if ((((uParam0->f_9 != 854119837 && uParam0->f_9 != -335460405) && uParam0->f_9 != 1809565830) && uParam0->f_9 != -628873767) && !TASK::_DOES_SCENARIO_POINT_EXIST(uParam0->f_7))
	{
		switch (uParam0->f_9)
		{
			case -1292544588:
		...
		{
			uParam0->f_7 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1), 202274149, 1.5f, 0, 0);
		}
		else
		{
			vVar1 = { TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1) };
			uParam0->f_7 = TASK::CREATE_SCENARIO_POINT(iVar18, vVar1, TASK::_GET_SCENARIO_POINT_HEADING(uParam0->f_6, 1), 0, 0, 0);
		}
		iVar0 = 0;
	}
	func_14(uParam0, 0);
	...
	else if (uParam0->f_9 == 1809565830 && func_13(uParam0->f_9))
	{
		...
		{
			uParam0->f_8 = func_50(MISC::_CREATE_VAR_STRING(2, "GENERIC_SEARCH"), joaat("INPUT_CONTEXT_X"), TASK::_GET_SCENARIO_POINT_COORDS(uParam0->f_6, 1), 1070386381 /* Float: 1.6f */, 1, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
			iVar0 = 0;
		}
...
void func_14(var uParam0, bool bParam1)
{
	if (TASK::_DOES_SCENARIO_POINT_EXIST(uParam0->f_7))
	{
		if (bParam1)
		{
			...
			{
				TASK::_SET_SCENARIO_POINT_ACTIVE(uParam0->f_7, 1);
			}
		}
		else if (TASK::_IS_SCENARIO_POINT_ACTIVE(uParam0->f_7))
		{
			TASK::_SET_SCENARIO_POINT_ACTIVE(uParam0->f_7, 0);
		}
	}
}
...
int func_18(var uParam0)
{
	switch (uParam0->f_9)
	{
		...
		case 1809565830:
			if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_1, 0))
			{
				return 1;
			}
			else if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_1, 0))
			{
...
int func_19(var uParam0)
{
	...
	if (iVar1 > 0)
	{
		...
		else if (uParam0->f_9 == -878376933)
		{
			if (!uParam0->f_21)
			{
				func_64(747460826 /* GXTEntry: "Special Horse Stimulant" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				uParam0->f_21 = 1;
				return 0;
			}
			if (!uParam0->f_22)
			{
				func_64(-1871448371 /* GXTEntry: "Special Horse Medicine" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				uParam0->f_22 = 1;
				return 0;
			}
			if (!uParam0->f_23)
			...
			if (!uParam0->f_24)
			{
				func_64(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				uParam0->f_24 = 1;
				return 1;
			}
		}
...
int func_63(int iParam0)
{
	...
	if (iVar1 != joaat("weapon_unarmed"))
	{
		...
		{
			WEAPON::_HIDE_PED_WEAPONS(iParam0, 2, 0);
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_35(iParam0) == joaat("clothing"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_35(iParam0) == joaat("weapon"))
		{
		...
		else if (func_35(iParam0) == joaat("ammo") && func_143(iParam0))
		{
		...
		else if (func_131(iParam0, 589988438))
		{
			if (func_150())
			{
				func_151(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -1185145312: /* GXTEntry: "Upgraded Off-Hand Holster" */
				...
				{
					func_163(PLAYER::PLAYER_PED_ID(), -1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_164(&iVar9, 0))
				{
			...
			case 1171350303: /* GXTEntry: "Upgraded Bandolier" */
				...
				{
					func_163(PLAYER::PLAYER_PED_ID(), 1171350303 /* GXTEntry: "Upgraded Bandolier" */, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_171(242, func_170(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_171(240, func_170(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_171(241, func_170(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
...
int func_101(var uParam0)
{
	...
	uParam0->f_14 = PHYSICS::_ADD_ROPE_2(func_201(), 0f, 0f, 0f, 7f, 6, 0, -1, -1082130432);
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_216(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_86(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_6(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_86(iVar7) && func_6(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
...
int func_144(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_6(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_150()
{
	if (((((func_260(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_260(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_260(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_260(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_260(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_260(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
...
void func_160(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_151(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_151(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_151(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_151(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_151(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -343824903: /* GXTEntry: "Money Clip" */
			func_151(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_151(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
void func_182(int iParam0, char* sParam1)
{
	...
	func_315(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_314(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_184(int iParam0, char* sParam1, int iParam2)
{
	...
	func_315(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_185(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_315(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_315(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		func_327(iParam0, iParam1, iParam2, uVar0);
	}
...
{
	return func_35(iParam0) == joaat("weapon");
}
...
void func_210(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_35(iParam0) != joaat("weapon"))
	{
		return;
	}
	iVar0 = func_137(iParam0, 0);
	...
	if (bParam2 || !func_239(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_37(iParam0, 0, 0) == 0))
		{
...
struct<5> func_212(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_35(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_243(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_243(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
void func_245(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_376(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_252(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_35(iParam1) != joaat("clothing"))
	{
		return 0;
	}
	bVar1 = func_66() != -1;
...
int func_261(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_6(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
int func_314(int iParam0)
{
	...
	if (!func_442(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
void func_323(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_321())
	{
		func_315(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_315(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
var func_327(int iParam0, int iParam1, int iParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
int func_330(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_214(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_335(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
int func_405(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_483(0);
	if (iParam2 != 0 && func_484(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_465()
{
	...
	func_529(0);
	func_530(7);
	func_531(-1623728698 /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_304() == 1160113249)
	{
		func_531(-763730846 /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_531(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_532(Global_35, &uVar0);
}
...
var func_520(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
void func_605(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = func_606(func_304());
	if (*uParam0)
	{
		func_604(uParam0);
	}
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(uVar0, uParam1, 0, func_66() != -1, uParam2);
	*uParam0 = 1;
}
