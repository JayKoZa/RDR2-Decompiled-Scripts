...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0326f, -1.1852f, 0.5177f, 0f, 2.5f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -9.0601f, -8.936f, 1.029f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	...
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_and_molly_3@action", 0, 0, 1, 0);
	...
	func_159(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_CIGAR"), "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
