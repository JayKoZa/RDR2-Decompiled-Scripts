...
int func_72(var uParam0)
{
	...
	func_159(uParam0, iLocal_14, 2, 1677569809, "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_164(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_260(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
