...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_37, 0))
	{
		return 0;
	}
	return 1;
...
int func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(&(uParam0->f_20[0 /*14*/]), 1) && !func_59(&(uParam0->f_20[0 /*14*/]), 993674639))
		{
			...
			TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), iLocal_37, 0, 0, iLocal_38, -1082130432, 0);
		}
	...
	if (!&uParam0->f_469[3])
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
			{
				...
				TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), iLocal_37, 15000, 0, iLocal_38, -1082130432, 0);
