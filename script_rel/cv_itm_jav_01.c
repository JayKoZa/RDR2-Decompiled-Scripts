...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	...
	func_161(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_97(var uParam0)
{
	...
	{
		PED::_0x2B02DB082258625F(func_9(uParam0, iLocal_14), func_209(uParam0, iLocal_18), "p_Javierknife_temp_PH_R_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
		PED::_0x2B02DB082258625F(func_9(uParam0, iLocal_14), iLocal_34, "p_cs_rag01x_PH_L_HAND", joaat("PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES"), "PROP_CAMP_SEAT_CHAIR_CRAFT_POISON_KNIVES_MALE_A_APPLY_POISON", 1);
	}
	return true;
}
...
int func_257()
{
	...
	if (func_347(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_258()
{
	...
	if (func_347(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_265(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_349(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_303(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_308(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_367(joaat("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_367(joaat("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_367(joaat("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_367(joaat("CONSUMABLE_MEDICINE"));
...
void func_315(int iParam0)
{
	...
	{
		case 9:
			if (func_368(joaat("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_369();
...
void func_316(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_374(func_24()), 1307979820 /* GXTEntry: "Camp Item Request" */, func_375(*uParam0), 0);
...
bool func_329(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_358(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_409(iParam1))
		{
			func_410(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_377(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(8, func_371(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
			UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, iVar0);
			Global_1359489.f_361.f_194 = func_425("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_373(uParam0->f_3)), joaat("PLAYER_MENU"), "INPUT_FEED_INTERACT_GENERIC", joaat("SP_MISSIONS"), 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
char* func_383(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_347(joaat("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
bool func_400(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_108(iParam0))
	{
		return false;
...
bool func_404(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_54(iParam0))
	{
		return false;
...
bool func_450(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_108(iParam0))
	{
		return false;
...
bool func_455(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return false;
...
struct<4> func_471(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_515(923904168, func_514(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_515(923904168, func_514(bParam0), -740156546, 0) };
		}
...
bool func_473(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_484(int iParam0, char* sParam1)
{
...
bool func_486(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_347(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_433(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_513(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_533(iVar0))
		{
	...
	{
		func_535(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_536(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_545(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_548(0))
				{
					...
					func_549(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_543(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_420(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_515(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_515(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_547(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_550(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_562(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_554(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_515(271701509, func_514(bParam0), 12999093, 0) };
		}
