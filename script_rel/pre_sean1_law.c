...
bool func_6()
{
	...
	while (iVar0 < 4)
	{
		...
		else if (!ENTITY::DOES_ENTITY_EXIST(iLocal_0[iVar0]) && bVar5)
		{
			...
			WEAPON::_GIVE_WEAPON_TO_PED_2(iLocal_0[iVar0], func_20(4194304, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */), 500, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
