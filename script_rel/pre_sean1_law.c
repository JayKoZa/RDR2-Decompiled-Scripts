			...
			case 3:
				...
				if (!bLocal_65)
				{
					...
					else
					{
						...
						while (iVar0 < 4)
						{
							if (MAP::DOES_BLIP_EXIST(&(uLocal_16[iVar0])))
							{
								if (MAP::IS_BLIP_ON_MINIMAP(&(uLocal_16[iVar0])))
								{
									func_8();
								}
							}
...
int func_135(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
