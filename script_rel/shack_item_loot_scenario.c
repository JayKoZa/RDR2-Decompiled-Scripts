...
void func_102(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((iParam1 == 1 || func_38(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_149(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_294(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
bool func_157(int iParam0, int iParam1, var uParam2)
{
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_302(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_175()
{
	...
	while (iVar1 < 30)
	{
		if (func_310(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_180()
{
	...
	while (iVar1 < 5)
	{
		if (func_316(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_197(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_327(iParam0, iParam2, iParam1, func_45() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_329(func_320(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
float func_208()
{
	...
	func_344(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_209()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_344(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_210()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_344(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
void func_217(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_357(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_358(iParam0, 6);
	if (bParam2)
	{
...
int func_228(int iParam0)
{
	...
	if (!func_364(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
{
	return func_147(joaat("CHARACTER"), func_366(), -1591664384, bParam0);
}
...
int func_264()
{
	...
	while (iVar1 < 30)
	{
		if (func_378(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_302(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_42(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_302(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_38(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_330(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_406(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_45() == -1)
	{
...
void func_336(struct<4> Param0)
{
	...
	if (func_410(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_410(20))
			{
				return;
			}
			iVar0++;
...
void func_352(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_351(iParam0))
	{
		...
		if ((!func_355() && !bParam1) && !func_356(0, 0, 1))
		{
			func_357(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_416(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
bool func_356(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_123(iVar0) && func_419(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
int func_371(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_429(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_429(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_374(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_436(iParam0));
	...
	func_134(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_439(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_382()
{
	...
	func_443(0);
	func_444(7);
	func_445(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_218() == 1160113249)
	{
		func_445(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_445(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
void func_397(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_455(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_455(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_456(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_406(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_460(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_444(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		if (func_482(iVar2, 0))
		{
			func_483(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_461(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_460(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
		iVar0++;
	}
}
...
void func_481(var uParam0, int iParam1, int iParam2)
{
	...
	func_506(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_511(&(uParam0->f_1[iParam1 /*5*/]));
...
void func_519(var uParam0, var uParam1, var uParam2)
{
	...
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(iVar0, uParam1, 0, func_45() != -1, uParam2);
	*uParam0 = 1;
}
