...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7125f, -2.1875f, 0.5445f, 80f, 4.7f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	func_151(uParam0, -0.55f, 5.525f, 0.5445f, 80f, 2f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_152(uParam0, 1.3873f, -2.8002f, 1.15f, -6.94f, 0.955f, 1.4525f, 2.685f, joaat("VOLCYLINDER"), 1);
	...
	func_160(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_203(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_250()
{
	...
	if (func_330(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_251()
{
	...
	if (func_330(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_263(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_333(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
void func_343(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_377(iParam1))
		{
			func_378(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_368(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_403(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_424(int iParam0, char* sParam1)
{
...
bool func_426(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_427(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_430(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_455(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_473(iVar0))
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_484(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_488(0))
				{
					...
					func_489(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_482(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_494(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_486(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_496(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_484(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_484(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_485(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_486(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_484(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_501(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_486(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_487(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_490(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_507(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_495(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_486(923904168, func_493(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_486(923904168, func_493(bParam0), -740156546, 0) };
		}
...
struct<4> func_497(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_486(271701509, func_493(bParam0), 12999093, 0) };
		}
...
bool func_500(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_502(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
