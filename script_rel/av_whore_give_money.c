		...
		if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				...
				if (bVar1)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
					{
						TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 32832, -1082130432 /* Float: -1f */, -1, 0);
					}
					func_68(uParam0);
					if (!uParam0->f_469[6])
					{
...
bool func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_74(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
