...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1188f, -1.318f, 1f, 0f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -2.1437f, -0.9055f, 1f, 0f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.685f, 0.1375f, 0f, 0f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_and_hosea_11@action", 0, 0, 1, 0);
	...
	func_158(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 0f, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
