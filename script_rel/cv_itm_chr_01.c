...
int func_1(var uParam0)
{
	if (!bLocal_55)
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iLocal_14 /*113*/])->f_5, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_2, 0, 0, true, 0, 0, -1082130432, 0);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		...
		case 2:
			...
			uParam0->f_22 = func_383(1627068364 /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_383(-1635450397 /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_383(-755485480 /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_383(-951828978 /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_383(-2076104686 /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_383(1478239863 /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_383(338147422 /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_383(1483206625 /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_383(-898386032 /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_383(730856618 /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_383(230530039 /* GXTEntry: "Health Cure" */);
...
void func_326(var uParam0)
{
	...
	uVar0 = func_387(*uParam0);
	uVar1 = func_388(*uParam0);
	iVar2 = MISC::GET_HASH_KEY(func_389(uParam0->f_3));
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(9, uVar0, func_390(func_25()), 1307979820, func_391(*uParam0), 0);
		UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(9, uVar0, iVar2, 1997120069);
		UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(9, uVar0, uVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_392(1, 688258043 /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_392(2, -1477273558 /* GXTEntry: "Peppermint" */, 0);
			func_392(3, 128702355 /* GXTEntry: "Milkweed" */, 0);
			func_392(4, 1613651027 /* GXTEntry: "Hair Pomade" */, 0);
...
int func_440(bool bParam0, int iParam1)
{
	...
	if (func_479(bParam0, 1399091007))
	{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_237(iParam0, 1), &uVar4);
				}
...
int func_552(bool bParam0, int iParam1, int iParam2)
{
	if (iParam1 < 1)
	{
		return 1;
...
int func_556(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_566(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_562(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_442(0);
	*uParam1 = { func_520(bParam0, func_482(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
