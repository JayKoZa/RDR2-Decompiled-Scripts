...
int func_1(var uParam0)
{
	...
	else if ((MISC::GET_GAME_TIMER() > iLocal_18 && ENTITY::IS_ENTITY_OCCLUDED(func_9(uParam0, iLocal_14))) && func_10(Global_35, func_9(uParam0, iLocal_14), 1) > 225f)
	{
		func_8(uParam0, "Micah cleanup timer over and he's not on screen - releasing him", 1, -1);
		PERSCHAR::_0x631CD2D77FDC0316(PERSCHAR::_0x32A1E3B83D501096(func_9(uParam0, iLocal_14)));
		PERSCHAR::_0xD4B614179BCD0654(PERSCHAR::_0x32A1E3B83D501096(func_9(uParam0, iLocal_14)));
		return 1;
	}
	return 0;
}
...
void func_8(var uParam0, char* sParam1, int iParam2, int iParam3)
{
...
float func_10(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_50(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_20(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (func_49((uParam0->f_107[iVar0 /*113*/])->f_7))
		{
			if (!func_53((uParam0->f_107[iVar0 /*113*/])->f_7))
			{
			}
			else
			{
				func_54((uParam0->f_107[iVar0 /*113*/])->f_5, (uParam0->f_107[iVar0 /*113*/])->f_7, 1, 0, 0);
				Jump @294; //curOff = 110
				if (func_49((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					...
					else if (TASK::_0x9FF5F9B24E870748((uParam0->f_107[iVar0 /*113*/])->f_5) && !func_47(uParam0))
					{
						...
						func_57((uParam0->f_107[iVar0 /*113*/])->f_1, 68, 1);
						func_58((uParam0->f_107[iVar0 /*113*/])->f_1, 0, 0, 0, fVar1, 1, 1, 0, 0, 0, 0);
					}
					else
					{
						func_58((uParam0->f_107[iVar0 /*113*/])->f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
int func_21(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (!func_59((uParam0->f_107[iVar0 /*113*/])->f_2))
		{
		}
		else if (!func_60((uParam0->f_107[iVar0 /*113*/])->f_2))
		{
		}
		else
		{
			func_61((uParam0->f_107[iVar0 /*113*/])->f_2, 0, 1, 0, 0);
		}
		iVar0++;
	}
	return 1;
...
{
	return MISC::GET_HASH_KEY(func_70(iParam0));
}
...
float func_50(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_52(var uParam0, int iParam1)
{
	...
	func_103((uParam0->f_107[iParam1 /*113*/])->f_1, 1, 1, 0);
	func_104((uParam0->f_107[iParam1 /*113*/])->f_1, 45, 1);
	func_104((uParam0->f_107[iParam1 /*113*/])->f_1, 46, 1);
...
void func_54(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	int iVar0;
...
void func_55(var uParam0, int iParam1, bool bParam2)
{
	...
	switch ((uParam0->f_107[iParam1 /*113*/])->f_32.f_55)
	{
		case 1:
			...
			{
				iVar3 = func_112((uParam0->f_107[iParam1 /*113*/])->f_1);
				if (iVar3 == 0)
				{
					return;
				}
...
void func_58(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	if (bParam10)
	{
		func_57(iParam0, 56, 1);
		func_117(&(Global_1359489->f_40), 1);
	}
	func_118(iParam0, 0);
	func_119(iParam0, 4, 0);
	func_120(iParam0);
	func_121(iParam0);
	func_104(iParam0, 37, 1);
	bVar0 = func_122(Global_1360165[iParam0 /*1157*/], 0);
	iVar1 = func_123(iParam0, 0);
	bVar2 = PERSCHAR::_0x800DF3FC913355F3(iVar1);
	if (PED::GET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, true) && Global_1359489->f_16 & 8388608 == 0)
	{
		PED::SET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, false);
	}
	if (func_124(iParam0, 64, 1))
	{
		func_104(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_104(iParam0, 33, 1);
		func_104(iParam0, 34, 1);
		func_125(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
		func_103(iParam0, 1, 1, 0);
		if (bParam6)
		{
			func_57(iParam0, 30, 1);
		}
		if (bParam7)
		{
			func_57(iParam0, 35, 1);
			if (bParam8)
			{
				func_57(iParam0, 62, 1);
			}
		}
		if (bVar0)
		{
	...
	else
	{
		...
		func_57(iParam0, 33, 1);
		func_103(iParam0, 0, 1, 0);
		if (fParam4 > 0f)
		{
			((*Global_1360165)[iParam0 /*1157*/])->f_133 = fParam4;
			func_117(&(((*Global_1360165)[iParam0 /*1157*/])->f_130), 1);
		}
		else
		{
	...
	if (bParam1 || bParam2)
	{
		...
		{
			func_128(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	if (func_124(iParam0, 45, 1))
	{
		func_104(iParam0, 45, 1);
	}
	func_129(iParam0, 16, 1);
	func_104(iParam0, 44, 1);
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_138(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_74(var uParam0)
{
	...
	func_153(uParam0, 0.0125f, -0.25f, 1.15f, 1.81f, 3.1925f, 3.055f, 2.685f, -1612834106, 1632043240, 1, 1, 1);
	func_153(uParam0, 3.4249f, 8.675f, 1.15f, 10.25f, 1.285f, 2.97f, 2.685f, -1612834106, 1877049591, 1, 1, 1);
	...
	func_155(uParam0, "script@vignette@uncle_7@base", 1, 1, 0, 0);
	uLocal_16 = func_155(uParam0, "script@vignette@uncle_7@action", 0, 0, 1, 0);
	func_156(uParam0, "CUNC7AU");
	func_157(uParam0, iLocal_15, 3, 1904532698, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_162(uParam0, uLocal_16, -1, 0.87f);
	return 1;
}
...
int func_87(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (func_49((uParam0->f_107[iVar0 /*113*/])->f_1))
		{
			func_57((uParam0->f_107[iVar0 /*113*/])->f_1, 46, 1);
		}
		iVar0++;
	}
	if (!uParam0->f_4)
	...
	func_180(uParam0);
	func_181(uParam0);
	func_182(uParam0, 1073741824 /* Float: 2f */);
	func_183(uParam0);
	func_184(uParam0);
	func_185(uParam0);
	func_186(uParam0);
...
int func_93(var uParam0)
{
	...
	iVar0 = func_195(func_22(uParam0));
	func_196(iVar0);
...
void func_103(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_104(iParam0, 50, 1);
		func_104(iParam0, 48, 1);
		func_104(iParam0, 49, 1);
		func_104(iParam0, 51, 1);
		func_104(iParam0, 52, 1);
		func_104(iParam0, 54, 1);
		func_104(iParam0, 55, 1);
	}
	else
	{
		func_57(iParam0, 50, 1);
		func_57(iParam0, 48, 1);
		func_57(iParam0, 49, 1);
		func_57(iParam0, 51, 1);
		if (bParam3)
		{
			func_57(iParam0, 54, 1);
		}
		else
		{
			func_104(iParam0, 54, 1);
		...
		if (!bParam2)
		{
			func_57(iParam0, 52, 1);
			if (bParam3)
			{
				func_57(iParam0, 55, 1);
			}
		}
		else
		{
...
int func_109(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_122(iVar0, 0))
	{
		if (func_122(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_107(iParam0)) || func_53(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_10(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_210(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_211(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_211(iParam0, 0));
					func_212(iParam0);
				}
			}
			else
...
{
	func_119(iParam0, 8, 0);
}

void func_121(int iParam0)
{
	func_57(iParam0, 36, 1);
}
...
int func_137(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_136(iParam0)))
	{
		return 1;
	}
	...
	func_133(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_136(iParam0));
	func_232(iParam0, 0);
	return 1;
}
...
int func_145(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_124((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_242((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
				{
					if (func_115((uParam0->f_107[iVar0 /*113*/])->f_1) && !func_56((uParam0->f_107[iVar0 /*113*/])->f_1))
					{
						func_36(func_22(uParam0), 30);
						return 1;
					}
...
void func_148(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (!func_49((uParam0->f_107[iVar0 /*113*/])->f_1))
		{
		}
...
void func_151(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	uParam0->f_23 = { func_248(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_255(func_150(uParam0), func_254(uParam0, iParam1), func_22(uParam0), 1) };
			break;
		default:
			Var0 = { func_256(func_150(uParam0), func_254(uParam0, iParam1), func_22(uParam0), 1) };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_257(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
...
void func_172(var uParam0)
{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_49((uParam0->f_107[iVar12 /*113*/])->f_1))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_271((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_59((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_272((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
				else if (func_49((uParam0->f_107[iVar12 /*113*/])->f_7))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_209((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_173(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				func_117(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_17), 0);
			}
		}
		iVar0++;
	}
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if ((uParam0->f_107[iVar3 /*113*/])->f_8.f_14)
		{
			...
			else if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1((uParam0->f_107[iVar3 /*113*/])->f_5, -1))
			{
				...
				{
					func_8(uParam0, "Create ped check - Ped is in an animscene", 30, iVar3);
					iVar1 = 0;
				}
				else
				{
					...
					if (func_207(vVar4))
					{
						func_8(uParam0, "Start location is zero?", 10, iVar3);
					}
					else
					{
...
void func_184(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (func_49((uParam0->f_107[iVar1 /*113*/])->f_1))
		{
			func_103((uParam0->f_107[iVar1 /*113*/])->f_1, 0, 0, bVar0);
		}
		iVar1++;
	}
}
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_114() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_283() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
		...
		else
		{
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_303(uParam0, iVar0))
				{
					...
					{
						func_103((uParam0->f_107[iVar0 /*113*/])->f_1, 1, 1, 0);
...
void func_253(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_324(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_257(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_326(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_259(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			if (func_49((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				if (func_53((uParam0->f_107[iVar1 /*113*/])->f_7) && !ENTITY::IS_ENTITY_DEAD((uParam0->f_107[iVar1 /*113*/])->f_5))
				{
				}
				else
				{
...
int func_277(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_111(&((uParam0->f_107[iParam1 /*113*/])->f_109)) < fVar4)
	{
...
int func_278(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_150(uParam0) == 3 || func_150(uParam0) == 8)
	{
	...
	fVar8 = (func_111(&((uParam0->f_107[iParam1 /*113*/])->f_106)) * fVar4);
	fVar9 = (fVar8 * fVar8);
	if (fVar9 < fVar7)
	{
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_343(uParam0, iParam1);
	}
	if (bParam2)
	{
		...
		{
			func_58((uParam0->f_107[iParam1 /*113*/])->f_1, 0, 0, 0, (uParam0->f_107[iParam1 /*113*/])->f_32.f_4, 1, 1, 0, 0, 1, 0);
		}
		else
		{
			func_58((uParam0->f_107[iParam1 /*113*/])->f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
int func_305(var uParam0, int iParam1)
{
	...
	fVar3 = func_111(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_52));
	if (fVar3 > fVar2)
	{
		return 1;
	}
...
int func_312()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_348(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_326(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_327(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
	...
	iVar1 = func_354(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
		...
		else if (func_22(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_360(iVar3, func_101(uParam0->f_7), 1))
					{
					}
					else if (func_362(&uVar2, func_361(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_363(iVar0, func_101(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_331(int iParam0, bool bParam1)
{
	...
	if (func_130(iParam0, 32) && !bParam1)
	{
		...
		if (func_220() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_136(iParam0));
...
int func_332(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((bParam4 && !func_60(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
float func_340(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_341(int iParam0)
{
	...
	iVar5 = func_64(iParam0);
	if (iVar5 < 1 || iVar5 > func_68(iVar4, iVar3))
	{
		return 0;
	}
	return 1;
...
int func_354(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	iVar0 = func_106(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_122(iVar0, 0)) || (bParam3 && !func_53(iParam1)))
	{
		if (bParam2)
		{
			if (func_209(iParam1, 1) != 0)
			{
				iVar0 = func_385(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && func_122(iVar0, 0))
	{
		*uParam0 = 2;
...
int func_360(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_241(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
...
int func_364(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	{
		case 0:
			if (func_124(iParam0, 2, 1))
			{
				func_104(iParam0, 2, 1);
			}
			if (func_213(iParam0, 16, 1))
			{
				if ((*Global_1360165)[iParam0 /*1157*/])->f_129 != SCRIPTS::GET_ID_OF_THIS_THREAD()
				{
					...
					{
						func_58(iParam0, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
		...
		case 1:
			...
			if (!func_124(iParam0, 44, 0))
			{
				func_57(iParam0, 44, 0);
			}
			if (func_394(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_393(iParam0, 2);
			}
			break;
		case 2:
			...
			func_104(iParam0, 18, 1);
			ENTITY::SET_ENTITY_VISIBLE(Global_1360165[iParam0 /*1157*/], true);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_1360165[iParam0 /*1157*/], 1030835986);
			POPULATION::_0xF74E134F40192884(Global_1360165[iParam0 /*1157*/], 0);
			PERSCHAR::_0x6759BEE6762E140B(((*Global_1360165)[iParam0 /*1157*/])->f_1);
			PED::SET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 130, false);
			func_103(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
			...
			func_104(iParam0, 33, 1);
			func_104(iParam0, 34, 1);
			func_104(iParam0, 29, 1);
			if (!func_207(vVar0) && bParam7)
			{
				func_393(iParam0, 3);
			}
			else if (iParam13 != 0)
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_396(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_397(iParam0, iParam13))
				{
					if (PED::_0xA0BC8FAED8CFEB3C(Global_1360165[iParam0 /*1157*/]))
					{
						...
						if (func_124(iParam0, 25, 0))
						{
							func_104(iParam0, 25, 0);
						}
						func_57(iParam0, 66, 0);
						func_393(iParam0, 5);
		...
		case 6:
			...
			func_393(iParam0, 7);
		case 7:
			func_103(iParam0, bParam9, bParam15, 0);
...
int func_366(int iParam0, bool bParam1)
{
	...
	if ((func_130(iParam0, 1) && !func_60(iParam0)) && func_131(iParam0))
	{
		return 0;
	}
	if (!func_130(iParam0, 2))
...
int func_385(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_414(iParam0) && func_415(iParam0, &uVar4))
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_209(iParam0, 1), &uVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_417(iParam0, vVar0, iParam6, iParam10))
				{
					return func_416();
				}
				if (func_122(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_207(vVar0)) && !func_208(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(((*Global_1360165)[iParam0 /*1157*/])->f_124))
				{
					ENTITY::DETACH_ENTITY(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, true);
				}
				func_396(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
				{
					if (func_124(iParam0, 39, 1))
					{
					}
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, true);
				}
				func_57(iParam0, 39, 1);
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_209(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
			((*Global_1360165)[iParam0 /*1157*/])->f_70 = ((*Global_1360165)[iParam0 /*1157*/])->f_124;
			((*Global_1360165)[iParam0 /*1157*/])->f_124 = 0;
			func_104(iParam0, 40, 0);
...
void func_387(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_421(func_106(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_422(iParam0);
...
void func_392(int iParam0, bool bParam1, char* sParam2)
{
	...
	iVar0 = func_226(iParam0);
	if (!func_49(iParam0) || ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		return;
	}
...
int func_394(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_105(iParam0))
	{
		return 0;
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				if (((*Global_1360165)[iParam0 /*1157*/])->f_63 != iParam4 && func_430(((*Global_1360165)[iParam0 /*1157*/])->f_63))
				{
					...
					{
						func_57(iParam0, 25, 0);
					}
				}
			}
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_432(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_104(iParam0, 44, 1);
			}
...
void func_396(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_224(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_224(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_224(iParam5, 32), 1);
...
void func_401(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_446(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_446(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_402(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_136(iParam0));
}
...
int func_417(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_209(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_282(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_418(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_122(iParam1, iVar0))
	{
		return 0;
	}
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_450(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
...
bool func_431(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_115(iParam0) || func_124(iParam0, 44, 1))
		{
			return false;
		}
	}
...
void func_444(int iParam0)
{
	...
	func_463(iParam0, 1073741824 /* Float: 2f */);
}
...
bool func_446(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_464(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_466(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_467(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
{
	return func_492(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_476(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_493(bParam0, &uVar0, uParam1, iParam2))
	{
...
{
	return func_477(joaat("character"), func_499(), -1591664384, bParam0);
}
...
{
	if (func_489(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_500(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_490(bool bParam0, int iParam1)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_491(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_492(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_493(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_495(0);
	*uParam1 = { func_477(bParam0, func_486(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
