...
bool func_74(var uParam0)
{
	...
	func_153(uParam0, 0.0125f, -0.25f, 1.15f, 1.81f, 3.1925f, 3.055f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, 3.4249f, 8.675f, 1.15f, 10.25f, 1.285f, 2.97f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	...
	iLocal_16 = func_155(uParam0, "script@vignette@uncle_7@action", 0, 0, 1, 0);
	func_156(uParam0, "CUNC7AU");
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_109(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_122(iVar0, 0))
	{
		if (func_122(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_191(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_289(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_289(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
bool func_208(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_245()
{
	...
	if (func_323(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_246()
{
	...
	if (func_323(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_257(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_326(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_277(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_329(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_336(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_368(iParam1))
		{
			func_369(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_394(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_105(iParam0))
	{
		return false;
...
bool func_397(int iParam0, int iParam1)
{
	...
	bVar0 = func_440(iParam0, iParam1);
	return bVar0;
}
...
bool func_415(int iParam0, char* sParam1)
{
...
bool func_417(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_421(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_388(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_446(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_466(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_467(iParam0, &iVar0, &fVar25);
...
{
	return func_492(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_486(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_477(923904168, func_484(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_477(923904168, func_484(bParam0), -740156546, 0) };
		}
...
struct<4> func_488(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_477(271701509, func_484(bParam0), 12999093, 0) };
		}
...
bool func_491(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_493(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
