		...
		else
		{
			if (uParam0->f_619 && uParam0->f_11 == 8)
			{
				if (func_21(Global_35) && ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_22(Global_35)) == uParam0->f_12)
				{
					...
					func_27(func_26(-212244724 /* GXTEntry: "Skinned 1 ~a~" */, func_24(*uParam0)), 1);
...
void func_25(int iParam0, int iParam1, vector3 vParam2, bool bParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_42(var uParam0)
{
	*uParam0 = 8;
	uParam0->f_1 = 2;
	uParam0->f_572[0] = 966898662;
	uParam0->f_572[1] = -1700886102;
	uParam0->f_572[2] = 467555029;
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 3;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
					...
					if ((fVar8 < 6.25f && !func_109()) && !bVar6)
					{
						...
						if (func_113((uParam0->f_31[iVar0 /*36*/])->f_16, 1))
						{
							...
							if (!PED::IS_PED_ON_MOUNT(Global_35))
							{
								...
								{
									PED::_SET_PED_CROUCH_MOVEMENT(Global_35, true, 0, 0);
								}
							}
...
int func_96(var uParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_157(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_100(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_169(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_101(var uParam0)
{
	...
	PED::_0xFCA8FB9E15FA80D3(uParam0->f_12, func_170());
...
int func_109()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_173(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_110(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_174(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_175(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_115(var uParam0, var uParam1)
{
	...
	if (uParam0->f_614 == 0)
	{
		...
		uParam0->f_5 = func_180(uParam0->f_4, 0, 0, 0);
		func_181(uParam0);
		if (!MAP::DOES_BLIP_EXIST(uParam0->f_6))
		{
...
void func_121(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_185(uParam0->f_12, uParam0->f_12.f_10, func_99(uParam0->f_615), 2, 1073741824 /* Float: 2f */);
...
void func_122(var uParam0)
{
	...
	iVar0 = func_187(0, func_186(), uParam0->f_616);
	uParam0->f_616 = iVar0;
...
int func_129(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	struct<37> Var0;
	int iVar47;
	...
	*iParam3 = Var0.f_3;
	...
	if (bParam4)
	{
		func_188(iParam0, iParam1, uParam2, *iParam3);
	}
	return 1;
}
...
{
	return func_132(joaat("character"), func_189(), -1591664384, bParam0);
}
...
int func_139(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (func_195(iParam0, uParam2, iParam3, bParam5, 0))
	{
		return 0;
	}
	if (!func_192(0))
...
Vector3 func_158(int iParam0, int iParam1)
{
	...
	{
		case 0:
			vVar0 = { func_201(1, iParam1) };
			break;
		case 1:
			vVar0 = { func_201(2, iParam1) };
			break;
		case 2:
			vVar0 = { func_201(3, iParam1) };
			break;
	}
	return vVar0;
}
...
var func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			uVar0 = func_202(1, iParam1);
			break;
		case 1:
			uVar0 = func_202(2, iParam1);
			break;
		case 2:
			uVar0 = func_202(3, iParam1);
			break;
	}
	return uVar0;
}
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_CO");
}
...
{
	return func_201(0, iParam0);
}

void func_169(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_170()
{
	return -734153718 /* GXTEntry: "Legendary Cougar" */;
}

bool func_171(vector3 vParam0, vector3 vParam3)
{
...
void func_175(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
	int iVar0;
...
void func_177(int iParam0, int iParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1945938)[iParam0 /*18*/])->f_3))
	{
		if (((*Global_1945938)[iParam0 /*18*/])->f_5 == 5 && !func_174(iParam0, 8))
		{
...
var func_180(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	var uVar0;
...
void func_185(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_223(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
			{
				...
				func_185(iVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_185(iVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
...
void func_188(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_195(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
...
Vector3 func_201(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -5969.762f, -2952.065f, -5.676f;
				case 1:
					return -5986.989f, -2991.729f, -2.5421f;
				case 2:
					return -5926.083f, -2912.082f, -9.2908f;
				case 3:
					return -5834.757f, -3004.499f, 5.3048f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 0:
					return -5864.64f, -3044.665f, 1.4876f;
				case 1:
					return -5929.088f, -2913.887f, -9.2588f;
				case 2:
					return -5900.4f, -3070.092f, 2.917f;
				case 3:
					return -5978.562f, -3055.332f, 1.1985f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 0:
					return -5878.279f, -2993.168f, -1.3802f;
				case 1:
					return -5923.116f, -2955.673f, -6.553f;
				case 2:
					return -5874.387f, -3020.011f, 0.047f;
				case 3:
					return -5983.962f, -2993.239f, -2.5363f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				...
				case 2:
					return -5894.69f, -2973.816f, -1.8362f;
				case 3:
					return -5944.325f, -2964.139f, -5.5828f;
			}
			break;
	}
	return 0f, 0f, 0f;
...
{
	if (func_190(iParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_136(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
struct<5> func_245(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_243(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_132(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_132(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
int func_249(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
