...
float func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			fVar0 = func_202(1, iParam1);
			break;
		case 1:
			fVar0 = func_202(2, iParam1);
			break;
		case 2:
			fVar0 = func_202(3, iParam1);
			break;
	}
	return fVar0;
}
...
var func_180(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	var uVar0;
...
bool func_195(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
