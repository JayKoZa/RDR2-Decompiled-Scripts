...
void func_24()
{
	...
	switch (func_80())
	{
		case joaat("FREEROAM"):
			...
			if (func_81(joaat("FOLLOW_INVITE")) || NETWORK::_0xFC4165C9165C166F())
			{
				Global_34 = 1;
			}
			else
...
bool func_76()
{
	...
	if (!bVar0)
	{
		if (((SCRIPTS::_IS_LOADING_SCREEN_ACTIVE() && !UIAPPS::_IS_APP_RUNNING_BY_HASH(joaat("LANDING_PAGE"))) && !NETWORK::_GET_LAUNCH_PARAM_EXISTS(func_253(joaat("MODE")))) && (MISC::_GAME_TRANSITION_MANAGER_GET_MODE() == 0 || MISC::_GAME_TRANSITION_MANAGER_GET_MODE() == 2101404901))
		{
...
int func_211()
{
	...
	if (MISC::IS_BIT_SET(Global_1956580.f_1, 6))
	{
		return 1;
	}
	if (func_48() == -2)
...
void func_218()
{
	...
	vVar19.f_1 = "SG_HDNG";
	vVar19.f_2 = func_330();
	Global_1572887.f_164.f_82 = _NAMESPACE77::_0x9F2CC2439A04E7BA(&Var0, &vVar19, 1);
	func_328(2);
	func_331(0);
}
...
void func_219()
{
	...
	if (_NAMESPACE77::_0xF8806EC3FF840FDC())
	{
...
void func_220()
{
	...
	{
		_NAMESPACE77::_0x00A15B94CBA4F76F(Global_1572887.f_164.f_82);
	}
	Global_1572887.f_164.f_82 = 0;
...
void func_235()
{
	...
	iVar0 = TASK::GET_SCRIPT_TASK_STATUS(Global_1225639.f_8, 501393341, true);
	if (iVar0 == 0 || iVar0 == 1)
	{
		return;
	}
...
void func_239()
{
	...
	{
		iVar1 = func_364(Global_262777[iVar0 /*74*/].f_1.f_59);
	}
	if (iVar1 == 10 || iVar1 == 1)
	{
		if (!func_367(-1, 0))
...
bool func_306(int iParam0)
{
	if (iParam0 == 255)
	{
		return (Global_1109400.f_4[Global_1109914[24 /*2*/]] && Global_1109914[24 /*2*/].f_1) == Global_1109914[24 /*2*/].f_1;
	}
...
void func_319(int iParam0)
{
	...
	{
		Var24.f_11 = MISC::_CREATE_VAR_STRING(42, "NT_INV_BODY_INFO", func_335(&(Var0.f_7), joaat("COLOR_PURE_WHITE")), "LANDING_FREEROAM_TITLE");
		Var24.f_25.f_3 = MISC::_CREATE_VAR_STRING(2, "NT_INV_FM_CONTENT");
		Var24.f_25.f_4 = MISC::_CREATE_VAR_STRING(2, "NM_TI_VIEW_INVITE");
	}
	else if (func_48() != -1)
	{
		iVar68 = func_397(MISC::GET_HASH_KEY(&(Var0.f_17)));
		if (iVar68 != -1)
		{
			...
			if (iVar69 == -504335712)
			{
				...
				Var24.f_25.f_4 = MISC::_CREATE_VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar70 = MISC::_CREATE_VAR_STRING(2, func_398(Global_265238.f_4[iVar68 /*62*/].f_44));
			}
			else if (iVar69 == 395262693)
			{
				Var24.f_25.f_3 = MISC::_CREATE_VAR_STRING(2, "NM_TI_VIEW_INVITE_DEATHMATCH");
				Var24.f_25.f_4 = MISC::_CREATE_VAR_STRING(2, "NM_TI_VIEW_INVITE");
				sVar70 = MISC::_CREATE_VAR_STRING(2, func_399(Global_265238.f_4[iVar68 /*62*/].f_44));
			}
	...
	{
		Var24.f_11 = MISC::_CREATE_VAR_STRING(42, "NT_INV_BODY_INFO", func_335(&(Var0.f_7), joaat("COLOR_PURE_WHITE")), "PRES_SET_MODE_MP");
		Var24.f_25.f_3 = MISC::_CREATE_VAR_STRING(2, "NT_INV_MP_PLAYER_JOIN");
		Var24.f_25.f_4 = MISC::_CREATE_VAR_STRING(2, "NM_TI_VIEW_INVITE");
	}
...
void func_323(int iParam0)
{
	...
	{
		if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&Var0, &Var17) && !func_403())
		{
			return;
		}
	}
	else if (NETWORK::NETWORK_ARE_HANDLES_THE_SAME(&(Var0.f_7), &Var17) && !func_403())
	{
		return;
	}
...
bool func_327()
{
	...
	if (Global_1572887.f_164.f_83 > 2)
	{
		...
		Var8 = { func_379(GANG::_0x4BE6C13A45CCA8EC(Global_1225639.f_14)) };
...
char* func_335(char* sParam0, int iParam1)
{
	...
	return func_414(MISC::_CREATE_VAR_STRING(10, "PLAYER_STRING", sParam0), iParam1);
}
...
{
	Global_262777[Global_1225639 /*74*/].f_72 = (Global_262777[Global_1225639 /*74*/].f_72 || iParam0);
}
...
bool func_391(int iParam0, int iParam1)
{
	...
	{
		return func_463(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
var func_402(struct<26> Param0, var uParam26, var uParam27, var uParam28, var uParam29, var uParam30, var uParam31, var uParam32, var uParam33, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43)
{
	...
	Global_1935689.f_1225.f_5[iVar0 /*30*/].f_29 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(Global_1935689.f_1225.f_5[iVar0 /*30*/], func_474(78), 0);
...
void func_505(var uParam0)
{
	...
	iVar0 = DATABINDING::_DATABINDING_READ_DATA_INT_FROM_PARENT(uParam0, func_474(83));
	if (func_508(iVar0))
	{
