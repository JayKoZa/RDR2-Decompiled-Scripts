...
bool func_77(var uParam0)
{
	...
	func_162(uParam0, -0.8881f, -2.4326f, 1.0273f, 119.8977f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_162(uParam0, -0.7068f, -3.5707f, 1.0109f, 68.9204f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_169(uParam0, iLocal_93, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_I", iLocal_94, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_174(uParam0, iLocal_92, 0.6f);
	func_175(uParam0, -1351.705f, 2439.949f, 307.5807f, -20f, 1.1f, 1.1f, 1f, joaat("VOLCYLINDER"), 0);
	if (func_176(0))
	{
...
struct<5> func_564(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_576(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_568(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_566(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_566(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_567(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_568(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_572(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_589(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
