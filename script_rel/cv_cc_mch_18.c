...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1484f, -1.8598f, 0.9909f, 38.16f, 1.3f, 1.3f, 3f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, -1.1415f, -1.4343f, 0.991f, 50.04f, 1.3f, 1.3f, 3f, -1612834106, 271759394, 1, 1, 1);
	func_152(uParam0, 0.295826f, -1.10821f, 0.980011f, 0f, 1.3f, 1.3f, 3f, 665633627, 1);
	...
	func_154(uParam0, "script@vignette@micah_18@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@micah_18@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@micah_18@action_b", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@micah_18@micah_trans_to", 0, 0, 0, 0);
	func_155(uParam0, "CCM18AU");
	func_156(uParam0, iLocal_14, 2, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, 1166046340, -1045609836);
	func_162(uParam0, iLocal_17, -1, 0.68f);
	Local_19 = { func_163(uParam0, 1.278f, -2.06f, 0.961f, 27.36f, 7f, 0.7f, 0.7f) };
	return 1;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_215(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_217(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_218(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_218(iParam0, 0));
					func_219(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_255(iParam1) + Vector(fParam4, fParam3, fParam2) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_216((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_193(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_298(uParam0, iVar1) || func_201(uParam0, iVar1))
			{
...
float func_215(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_320(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_247(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_328(&(Global_1898164->f_1[0 /*5*/]));
		if (func_329(iVar0) && func_330(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_250(int iParam0)
{
	...
	fVar0 = func_332(iParam0);
	fVar1 = func_333(iParam0);
...
int func_263(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_338(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_338(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_339(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
...
int func_344(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_352(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_390(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_248(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_216(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_213(vVar0)) && !func_214(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			sVar12 = func_446(iParam0, func_289());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_216(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_426(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_231(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_231(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_231(iParam5, 32), 1);
...
int func_443(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_216(iParam0, 1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_337(747937920, 1) && !func_418(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
