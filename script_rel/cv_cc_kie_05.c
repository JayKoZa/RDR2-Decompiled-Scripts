...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.3002f, -4.1348f, 0.9471f, 122.283f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_153(uParam0, "script@vignette@kieran_5@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@kieran_5@action", 0, 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_17 = func_163(uParam0, -2.6375f, -2.2877f, 1f, 0f, 0f, 0f, 4f, 9.9f, 5f, "TRIGGER", joaat("VOLBOX"));
	func_164(uParam0, 1);
...
int func_253()
{
	...
	if (func_331(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254()
{
	...
	if (func_331(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_313(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
