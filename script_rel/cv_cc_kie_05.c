...
int func_72(var uParam0)
{
	...
	func_153(uParam0, "script@vignette@kieran_5@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@kieran_5@action", 0, 0, 1, 1);
	func_154(uParam0, "KIE5AUD");
	func_155(uParam0, iLocal_14, 3, -1772467531, "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 2, -1772467531, "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
	...
	func_161(uParam0, -301968960, 1894830915);
	func_162(uParam0, uLocal_16, -1, 0.76f);
	iLocal_17 = func_163(uParam0, -2.6375f, -2.2877f, 1f, 0f, 0f, 0f, 4f, 9.9f, 5f, "TRIGGER", -1612834106);
	func_164(uParam0, 1);
...
{
	return func_197(Global_35, iLocal_17, 1, 0);
}
...
int func_93(var uParam0)
{
	if (!bLocal_18)
	{
		...
		{
			func_206(uParam0, iLocal_14, 0, 1);
			func_21();
			bLocal_18 = true;
		}
	}
	if (bLocal_18)
	{
		...
		{
			if (TASK::_DOES_SCENARIO_POINT_EXIST((uParam0->f_107[iLocal_14 /*113*/])->f_32.f_21))
			{
				TASK::_DELETE_SCENARIO_POINT((uParam0->f_107[iLocal_14 /*113*/])->f_32.f_21);
			}
			PERSCHAR::_0x631CD2D77FDC0316(PERSCHAR::_0x32A1E3B83D501096(func_48(uParam0, iLocal_14)));
			PERSCHAR::_0xD4B614179BCD0654(PERSCHAR::_0x32A1E3B83D501096(func_48(uParam0, iLocal_14)));
			func_56(10, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
	return 1;
}
...
int func_163(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
...
bool func_197(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_206(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_309(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_261(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_310(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_262(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_332(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_332(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_333(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
...
int func_338(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(747937920, 1) && !func_397(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
