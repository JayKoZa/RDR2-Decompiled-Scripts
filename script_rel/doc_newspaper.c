...
void __EntryFunction__()
{
	...
	while (func_3(&Var0, Global_1911866))
	{
		...
		if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(Var0.f_134) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(Var0.f_134, 1, 0))
		{
			if (CAM::_0xA24C1D341C6E0D53(1, 0, 0))
			{
				if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(Var0.f_134, 0))
				{
			...
			else if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(Var0.f_134, 0))
			{
			...
			if (func_47(iVar0) && !func_48(iVar0))
			{
				...
				if (!func_53(26, 32))
				{
					if ((((func_54(84, 0) || func_48(84)) && (func_54(86, 0) || func_48(86))) && (func_54(87, 0) || func_48(87))) && (func_54(88, 0) || func_48(88)))
					{
						...
						{
							uVar4 = func_57(0, &cVar1, 0, 0, -1, -1);
							func_58(26, &cVar1, uVar4, -1082130432 /* Float: -1f */);
							func_51(26, 32);
						}
					}
				}
	...
	switch (uParam1[0 /*9*/])
	{
		case 1193708294: /* GXTEntry: "Invitation from Mayor Lemieux" */
			if (func_47(109) && !func_48(109))
			{
				...
				{
					uVar3 = func_57(0, &cVar0, 0, 0, -1, -1);
					func_58(109, &cVar0, uVar3, -1082130432 /* Float: -1f */);
				}
			}
			break;
...
void func_25(int iParam0)
{
	switch (iParam0)
	{
		case 1048152290: /* GXTEntry: "Chick\'s Treasure Map" */
			func_77(((*Global_1392626)[7 /*32*/])->f_3, 1);
			break;
		case -2114196387: /* GXTEntry: "Bluewater Marsh Coach Tip" */
		case 1824375265: /* GXTEntry: "Bluewater Marsh Coach Tip" */
			func_49(129, 1);
			break;
		case -1030126569: /* GXTEntry: "Letter to Nigel from Tom" */
...
int func_35(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_31(iParam0, 589988438))
		{
			if (func_137())
			{
				func_138(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -1185145312: /* GXTEntry: "Upgraded Off-Hand Holster" */
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), -1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_151(&iVar9, 0))
				{
			...
			case 1171350303: /* GXTEntry: "Upgraded Bandolier" */
				...
				{
					func_150(PLAYER::PLAYER_PED_ID(), 1171350303 /* GXTEntry: "Upgraded Bandolier" */, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_166(242, func_165(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_166(240, func_165(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_166(241, func_165(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
			...
			case 299161628: /* GXTEntry: "Moonshine" */
				...
				{
					func_167(594, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case 1973952589: /* GXTEntry: "Bitters" */
				if (MISC::GET_GAME_TIMER() >= (Global_1935689->f_10197 + 60000))
				{
					func_167(594, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case 998010398: /* GXTEntry: "Opened Chewing Tobacco" */
				if (MISC::GET_GAME_TIMER() >= (Global_1935689->f_10197 + 60000))
				{
					func_167(594, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case 730856618: /* GXTEntry: "Potent Miracle Tonic" */
				if (MISC::GET_GAME_TIMER() >= (Global_1935689->f_10197 + 60000))
				{
					func_167(594, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case 1955751248: /* GXTEntry: "Roast Beef" */
				if (MISC::GET_GAME_TIMER() >= (Global_1935689->f_10197 + 60000))
				{
					func_167(595, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case -399865011: /* GXTEntry: "Regional Beef and Eggs Stew" */
				if (MISC::GET_GAME_TIMER() >= (Global_1935689->f_10197 + 60000))
				{
					func_167(595, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
int func_39(var uParam0, int iParam1)
{
	...
	else if (func_185(*uParam0, &uVar0, joaat("inventory"), -401018458, 0, 0))
	{
...
void func_80(int iParam0)
{
	switch (iParam0)
	{
		case -1260334554: /* GXTEntry: "North Scarlett Meadows Coach Tip" */
			Global_40.f_9146.f_94[4] = 1;
			break;
		case -1492175229: /* GXTEntry: "South Scarlett Meadows Coach Tip" */
			Global_40.f_9146.f_94[5] = 1;
			break;
		case 1585456486: /* GXTEntry: "Coach Convoy Tip" */
			Global_40.f_9146.f_94[6] = 1;
			break;
		case -884998428: /* GXTEntry: "Siltwater Strand Coach Tip" */
		...
		case 1824375265: /* GXTEntry: "Bluewater Marsh Coach Tip" */
			...
			break;
		case 667072496: /* GXTEntry: "Fort Riggs Coach Tip" */
			Global_40.f_9146.f_94[0] = 1;
			break;
		case 268535918: /* GXTEntry: "Appleseed Timber Coach Tip" */
			Global_40.f_9146.f_94[1] = 1;
			break;
		case -866909932: /* GXTEntry: "Owanjila Coach Tip" */
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_238(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_MELEE(iVar0))
			{
				...
				{
					func_125(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				iVar7 = func_279(Global_35, 2, 0, 1);
				if ((((func_268(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_61(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_268(iVar7) && func_61(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
...
int func_129(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_61(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_137()
{
	if (((((func_290(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_290(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_290(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_290(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_290(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_290(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
...
void func_142(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1369162587: /* GXTEntry: "Hunting Request" */
			...
			func_105(437, 0);
			func_105(440, 0);
			func_302(-949689219, 444160793 /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1610047510: /* GXTEntry: "Hunting Request" */
			...
			func_302(-1248968496, -1969404854 /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1317879106: /* GXTEntry: "Hunting Request" */
			...
			func_302(1706369307, -832850511 /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1062444751: /* GXTEntry: "Hunting Request" */
			...
			func_302(1520110311, -100913452 /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case 754186760: /* GXTEntry: "Hunting Request" */
			...
			func_105(438, 0);
			func_302(-1992824800, 905173572 /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_147(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_138(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_138(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_138(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_138(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_138(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -343824903: /* GXTEntry: "Money Clip" */
			func_138(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_138(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
int func_150(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != &Global_1946804->f_57[func_320(iParam3, 1) /*11*/])
			{
				func_323(31, 0, 0, 0, 0);
			}
			break;
...
void func_177(int iParam0, char* sParam1)
{
	...
	func_352(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_351(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_232(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (bParam2 || !func_267(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_98(iParam0, 0, 0) == 0))
		{
...
struct<5> func_234(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_115(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_272(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_270(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_270(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_271(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_272(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
int func_238(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_230(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_271(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return 0;
			}
			if (func_390(iParam0, 1))
			{
				if (!func_270(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return 0;
				}
				else if (func_271(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return 0;
				}
			}
...
void func_244(int iParam0)
{
	...
	func_352(MISC::_CREATE_VAR_STRING(6, func_405(iParam0), fVar1), "itemtype_textures", func_406(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_273(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_291(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_61(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_292(int iParam0, char* sParam1, int iParam2)
{
	...
	func_352(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_293(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_352(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_352(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_302(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_329(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_241(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_351(int iParam0)
{
	...
	if (!func_185(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
void func_363(int iParam0, int iParam1)
{
	...
	if (func_361(iParam0))
	{
		...
		if (func_522((Global_40.f_9479[iParam0 /*4*/])->f_1))
		{
			...
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar18, "Visible", true);
		}
		else
		{
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar18, "Visible", false);
		}
		if (func_522((Global_40.f_9479[iParam0 /*4*/])->f_2))
		{
			...
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar19, "Visible", true);
		}
		else
		{
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar19, "Visible", false);
		}
		...
		if ((Global_40.f_9479[iParam0 /*4*/])->f_3 != -1)
		{
			...
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar20, "Visible", true);
		}
		else
		{
			DATABINDING::_DATABINDING_ADD_DATA_BOOL(uVar20, "Visible", false);
		}
	}
}
...
void func_370(int iParam0, bool bParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(((*Global_1347702)[iParam0 /*49*/])->f_37))
	{
		...
		func_533(iParam0);
		if ((!func_534(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43890) || bParam1)
		{
...
void func_372(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	{
		((*Global_1347702)[iParam0 /*49*/])->f_37 = MAP::_BLIP_ADD_FOR_RADIUS(((*Global_1347702)[iParam0 /*49*/])->f_38, func_541(iParam0), ((*Global_1347702)[iParam0 /*49*/])->f_18);
		if (!MAP::DOES_BLIP_EXIST(((*Global_1347702)[iParam0 /*49*/])->f_37))
		{
			return;
		}
	...
	if (func_122() == -1)
	{
		...
		if (func_549(iParam0, bVar1, iVar0))
		{
			func_550(((*Global_1347702)[iParam0 /*49*/])->f_15, bVar2, bVar1, iVar0);
		}
	}
	if (bParam4)
	{
...
int func_375(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((bParam2 && func_122() == 0) && !UNLOCK::_UNLOCK_IS_VISIBLE(iParam0))
	{
		return 0;
	}
...
{
	return func_272(joaat("character"), func_559(), -1591664384, bParam0);
}
...
int func_390(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_236(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_393(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_395(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_241(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
void func_459(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_457())
	{
		func_352(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_352(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_478(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_452(&(uParam0->f_1[iVar0 /*3*/]), iVar5, uVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
int func_515(int iParam0)
{
	...
	if (iVar0 == joaat("money") && iParam0 != -1167047117)
	{
		return 0;
	}
	switch (iVar0)
...
{
	if (func_632(iParam0, bParam1, bParam2, bParam3))
	{
		return 1;
	}
	if (bParam1)
...
void func_550(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (func_640(iParam0))
	{
		case 1:
			...
			if (func_641(iVar0, bParam1, bParam2, iParam3) && Global_1357549->f_1709 > 1)
			{
		...
		case 8:
			...
			if (func_645(iVar1, bParam1, bParam2, iParam3) && Global_1357549->f_1709 > 1)
			{
...
char* func_558(int iParam0, int iParam1)
{
	switch (iParam1)
	{
		case 0:
...
void func_575()
{
	...
	func_660(0);
	func_661(7);
	func_662(-1623728698 /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_341() == 1160113249)
	{
		func_662(-763730846 /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_662(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_663(Global_35, &uVar0);
}
...
int func_632(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
{
	if (!bParam1 && func_704(iParam0, bParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
int func_645(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (!bParam1 && func_549(iParam0, bParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
void func_662(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_21), Global_1946804->f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_20), Global_1946804->f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_22), Global_1946804->f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_720(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
...
void func_712(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
...
int func_720(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
		...
		if (ITEMSET::IS_ITEMSET_VALID(iVar14))
		{
			...
			while (iVar16 < iVar15)
			{
				...
				else
				{
					...
					func_712(iVar24, &iVar18, &uVar19, &iVar17, &uVar20);
					if (func_713(&iVar13, iVar24, iVar17, iVar18))
					{
						if (iVar13 == iParam0)
						{
							if (bParam1)
...
int func_755(int iParam0)
{
	...
	func_712(iVar0, &iVar2, &uVar3, &iVar1, &uVar4);
	if (func_713(&uVar5, iVar0, iVar1, iVar2))
	{
	}
	return uVar5;
}
...
int func_756(int iParam0, bool bParam1)
{
	...
	Var3.f_1 = 1084182731;
	iVar31 = func_764(0);
	if (ENTITY::DOES_ENTITY_EXIST(iVar31) && func_765(INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iVar31), &Var3, &iVar0, &iVar1))
	{
		iVar2 = 0;
		iVar2 = 0;
		while (iVar2 < iVar1)
...
int func_764(int iParam0)
{
	...
	if (func_775(iParam0))
	{
		...
		{
			iVar0 = PED::_GET_LAST_MOUNT(func_776());
		}
	}
	else if (func_122() == -1)
	{
...
int func_765(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
void func_773(var uParam0, var uParam1, var uParam2)
{
	var uVar0;

	uVar0 = func_782(func_341());
	if (*uParam0)
	{
		func_772(uParam0);
	}
		...
		else
		{
			...
			else
			{
				if (ENTITY::IS_ENTITY_A_PED(iVar2))
				{
					...
					func_712(iVar9, &iVar6, &uVar7, &iVar5, &uVar8);
					func_713(&iVar0, iVar9, iVar5, iVar6);
					if (!func_83(iVar0, 0))
					{
...
struct<5> func_792(int iParam0)
{
	...
	Var0 = { func_793(iParam0, joaat("character"), func_559(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_793(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_799(int iParam0)
{
	...
	func_712(iParam0, &iVar1, &uVar2, &iVar0, &uVar3);
	func_713(&iVar4, iParam0, iVar0, iVar1);
	if (iVar4 != 0)
	{
		return iVar4;
	}
...
int func_805(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<12> Var0;
...
int func_807(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam1))
	{
		return 0;
