...
int func_18(var uParam0)
{
	...
	{
		iLocal_11 = VEHICLE::_CREATE_MISSION_TRAIN(1054492269, VEHICLE::_0x6DE03BCC15E81710(uParam0->f_483), 1, 0, 1, 1);
	}
...
void func_87(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
