...
{
	func_33(uParam0, 10723, 10739, 10893);
}
...
int func_18(var uParam0)
{
	...
	{
		iLocal_11 = VEHICLE::_CREATE_MISSION_TRAIN(1054492269, VEHICLE::_GET_NEAREST_TRAIN_TRACK_POSITION(uParam0->f_483), true, false, true, true);
	}
...
bool func_61(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_62(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_98(iParam1))
		{
			func_99(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_84(var uParam0, float fParam1)
{
...
void func_87(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_88(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_106(var uParam0, float fParam1)
{
	if (!func_82(uParam0))
	{
		return false;
...
void func_107(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
