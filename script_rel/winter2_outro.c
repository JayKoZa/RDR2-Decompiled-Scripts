...
int func_6(var uParam0)
{
	...
	if (((STREAMING::_0xCF45DF50C7775F2A() && STREAMING::_0x0909F71B5C070797()) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_4, 1, 0)) || func_23(&uLocal_8) > 15f)
	{
		func_22(&uLocal_5, 0);
		return 1;
	}
...
void func_19(var uParam0)
{
	...
	if (!PED::IS_PED_INJURED(Global_35))
	{
		...
		ENTITY::_SET_ENTITY_COORDS_AND_HEADING(Global_35, -1357.369f, 2443.642f, 307.4198f, 281.8427f, 1, 0, 1);
	}
}
...
int func_24(var uParam0)
{
	...
	{
		if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_4) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_4, 1, 0))
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(Global_35, 1, 1);
			WEAPON::_HIDE_PED_WEAPONS(Global_35, 2, 1);
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(Global_35, 1, 1);
...
bool func_26(var uParam0)
{
	...
	if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_4))
	{
		if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_4, 0))
		{
			if (!PED::IS_PED_INJURED(Global_35))
			{
		...
		{
			if (ANIMSCENE::_0xF94692EB9DC15D74(iLocal_4, 0) || ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_4, 0))
			{
				func_62(1);
...
void func_30(var uParam0, int iParam1)
{
	...
	{
		func_70(Global_35, -383172193 /* GXTEntry: "No Neckwear" */, 0, 1742327865, 0, 1, 0, 0, 1, 0);
		func_71(-1623728698 /* GXTEntry: "Bandana" */, 0);
	}
...
void func_71(bool bParam0, int iParam1)
{
	...
	Var0 = { func_119(bParam0, 0, 0) };
	Var5 = { func_131(bParam0, Var0, Var0.f_4, 0) };
	if (func_132(bParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return;
	}
...
int func_86(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_39(iVar0, 0))
	{
		if (func_39(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
void func_101(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_172(bVar3) && WEAPON::_0x705BE297EEBDB95D(bVar3))
			{
				if (bParam0)
				{
...
void func_102()
{
	...
	bVar0 = func_174(Global_35, 9, 1, 0);
	if (func_172(bVar0))
	{
		return;
	}
	bVar0 = func_174(Global_35, 7, 1, 0);
	if (func_172(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 8, false, false);
	}
	bVar0 = func_174(Global_35, 0, 1, 0);
	if (func_172(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	}
	bVar0 = func_174(Global_35, 1, 1, 0);
	if (func_172(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	}
	bVar0 = func_174(Global_35, 18, 1, 0);
	if (func_172(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	...
	if (func_172(bVar0))
	{
		...
		{
			func_176(Global_35, bVar0, 1, 0, 9, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
		}
		else
		{
			WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
...
int func_116(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	var uVar0;
...
struct<5> func_119(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_190(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_131(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_192(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_193(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_193(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_194(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_131(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
struct<4> func_131(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_132(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_131(bParam0, Param1, iParam5, bParam6) };
...
bool func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_172(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
{
	if (func_196(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_238(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_198(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_207(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_244(0);
	if (iParam2 != 0 && func_245(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_208(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_247(&(uParam0->f_1[iVar0 /*3*/]), iVar5, uVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
int func_230(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_193(bParam0, &Var0, iVar5, 0))
			{
				if (func_194(bParam0, &Var6, iVar5))
				{
					Var29 = { func_131(bParam0, Var0, iVar5, 0) };
					func_257(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_258(0))
				{
					...
					func_259(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_260(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
int func_233(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_262("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) && (!WEAPON::_IS_WEAPON_SHOTGUN(Var4.f_4) || func_261(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(Var4.f_4) || func_261(iParam1, 4))) && (!func_264(Var4.f_4) || func_261(iParam1, 8)))
				{
...
int func_239(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_133(0);
	*uParam1 = { func_131(bParam0, func_191(0), iParam3, 0) };
...
int func_245(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
int func_257(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_260(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_283(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_262(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_267(int iParam0, bool bParam1, bool bParam2, char* sParam3)
{
...
void func_295(int iParam0, char* sParam1, bool bParam2)
{
	char* sVar0;
