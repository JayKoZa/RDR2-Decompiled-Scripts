...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			uLocal_75 = VOLUME::_CREATE_VOLUME_SPHERE(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 8f, 10f, 0f), 0f, 0f, 0f, 20f, 20f, 20f);
