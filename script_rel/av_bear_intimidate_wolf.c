...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			uLocal_75 = VOLUME::_0xB3FB80A32BAE3065(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 8f, 10f, 0f), 0f, 0f, 0f, 20f, 20f, 20f);
			POPULATION::_0xB56D41A694E42E86(uLocal_75, 2016, 16384, 0, -1, -1, 0);
			POPULATION::_0x18262CAFEBB5FBE1(uLocal_75, 2016, 16384, 0, -1, -1, 0);
			iLocal_13 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(513747494, uParam0->f_483, -1082130432, -1082130432, -1082130432, -1082130432, -1082130432, -1, -1);
			iLocal_11 = 1;
			break;
		case 1:
		...
		case 4:
			if (!func_75(&(uParam0->f_20[1 /*14*/]), 1227113341))
			{
				if (func_74(&uLocal_18, 4.5f))
				{
					...
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE@IDLE_VARIATION@ACTION_IDLE_A", "idle", 4f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE@IDLE_VARIATION@ACTION_IDLE_C", "idle", 4f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "creatures_mammal@bear@action_standing@transition@action_to_standing", "idle_transition", 4f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION_STANDING@IDLE@IDLE_VARIATION@ROAR", "idle", 8f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION_STANDING@TRANSITION@STANDING_TO_IDLE", "idle_transition", 8f, -8f, -1, 0, 0, 0, 0, 0, 0, 0);
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(uLocal_75))
	{
		POPULATION::_0x74C2B3DC0B294102(uLocal_75);
		POPULATION::_0xA1CFB35069D23C23(uLocal_75);
		VOLUME::_0x43F867EF5C463A53(uLocal_75);
	}
	if (iLocal_13 != 0)
	{
		EVENT::REMOVE_SHOCKING_EVENT(iLocal_13);
