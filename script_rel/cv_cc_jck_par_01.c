...
int func_72(var uParam0)
{
	...
	iLocal_29 = func_151(uParam0, 1050043779, 0f, 0f, 0f, "GUITAR", 0, 0, 1);
	...
	iLocal_27 = func_152(uParam0, "script@vignette@party@jack_1@action_a", 2, 1, 0, 0);
	iLocal_28 = func_152(uParam0, "script@vignette@party@jack_1@action_b", 0, 0, 0, 0);
	func_153(uParam0, iLocal_16, 2, -1736764430, "WORLD_HUMAN_SIT_GUITAR_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_16, iLocal_29, "p_guitar01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_17, 2, -1133174268, "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_18, 2, 830847823, "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_19, 2, joaat("world_human_drinking"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_19, iLocal_32, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_23, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_24, 2, -1539374245, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_24, iLocal_33, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_25, 3, 139049053, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_25, iLocal_31, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_26, 2, 1051693614, "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	func_195(func_194(uParam0, iLocal_34), 0);
	return 1;
}
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	func_158(uParam0, iParam1, fParam7);
}
...
void func_155(var uParam0, int iParam1, char* sParam2)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
	{
...
{
	func_153(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
...
void func_158(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_258(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_188(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_289(uParam0, uParam0->f_1976.f_1), 1, func_291(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_387(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_422(iParam0, func_285());
