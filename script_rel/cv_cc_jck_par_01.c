...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, iLocal_16, 2, joaat("WORLD_HUMAN_SIT_GUITAR"), "WORLD_HUMAN_SIT_GUITAR_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_16, iLocal_29, "p_guitar01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_17, 2, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_18, 2, joaat("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_153(uParam0, iLocal_23, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_153(uParam0, iLocal_24, 2, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_24, iLocal_33, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_25, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_154(uParam0, iLocal_25, iLocal_31, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_153(uParam0, iLocal_26, 2, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_WHISKEY_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_192(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_293(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_293(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
