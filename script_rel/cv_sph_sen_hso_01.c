...
bool func_93(var uParam0)
{
	...
	if (!bLocal_62)
	{
		if (func_203(uParam0, iLocal_14, 0.32f))
		{
			...
			{
				TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_21), iLocal_67, "WORLD_HUMAN_STAND_WAITING_MALE_A", 0, true, false, 0, false, -1f, false);
			}
			bLocal_62 = true;
		}
	}
	if (!bLocal_63)
	{
		if (func_203(uParam0, iLocal_14, 0.36f))
		{
			...
			{
				TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_27), iLocal_68, "WORLD_HUMAN_STAND_DRINK_FEMALE_A", 0, true, false, 0, false, -1f, false);
			}
			bLocal_63 = true;
		}
	}
