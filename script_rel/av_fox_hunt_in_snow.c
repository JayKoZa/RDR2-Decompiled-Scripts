...
{
	func_33(uParam0, 10772, 10823, 11561);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_38)
	{
		...
		if (uParam0->f_469[1])
		{
			if (!uParam0->f_469[3])
			{
				if (func_70(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_65(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[3] = 1;
				}
							...
							if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_3.f_1, false) || ANIMSCENE::_IS_ANIM_SCENE_ACTIVE(uParam0->f_3.f_1))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									if (!ENTITY::IS_ENTITY_DEAD(Global_35))
									{
										...
										TASK::TASK_SMART_FLEE_PED(uParam0->f_20[0 /*14*/], Global_35, -1f, -1, 0, 1077936128 /* Float: 3f */, 0);
									}
