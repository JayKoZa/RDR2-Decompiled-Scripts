...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7428f, 4.9238f, 1.0241f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.3647f, -2.9108f, 0.1498f, 0f, 3.06f, 1.6f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
	func_152(uParam0, 0.417129f, -2.53877f, 1.10634f, 0f, 0.6f, 0.6f, 3f, joaat("VOLCYLINDER"), 1);
...
void func_405(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_228(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_228(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_228(iParam5, 32), true);
