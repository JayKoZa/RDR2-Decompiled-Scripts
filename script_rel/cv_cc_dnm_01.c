...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7428f, 4.9238f, 1.0241f, 0f, 1.5f, 1.5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 0.3647f, -2.9108f, 0.1498f, 0f, 3.06f, 1.6f, 3f, -1612834106, -727195357, 1, 1, 1);
	func_152(uParam0, 0.417129f, -2.53877f, 1.10634f, 0f, 0.6f, 0.6f, 3f, 665633627, 1);
	...
	func_154(uParam0, "script@vignette@dutch_and_molly_1@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_and_molly_1@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@dutch_and_molly_1@action_b", 0, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@dutch_and_molly_1@action_b_alt", 2, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@dutch_and_molly_1@action_c", 0, 0, 0, 0);
	...
	func_156(uParam0, iLocal_15, 3, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 2, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1, 35f, 0f, 1);
	func_159(uParam0, iLocal_15, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_160(uParam0, iLocal_15, 4, 3, 0, 0, 0);
	Local_22 = { func_161(uParam0, -0.3525f, -3.355f, 0.564f, -23.04f, 6.9025f, 0.679f, 0.14f) };
	Local_32 = { func_161(uParam0, -0.3525f, -3.355f, 0.564f, -59.4f, 5.49f, 0.2625f, 0.306f) };
	return 1;
}
...
{
	func_193(func_192(uParam0, iLocal_42), 0);
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_202(uParam0, Local_22, 1, 0) || func_202(uParam0, Local_32, 1, 0))
		{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_212(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_214(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_215(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_215(iParam0, 0));
					func_216(iParam0);
				}
			}
			else
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_213((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_213(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_210(vVar0)) && !func_211(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			sVar12 = func_429(iParam0, func_288());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_213(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_405(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_228(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_228(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_228(iParam5, 32), 1);
...
int func_426(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_213(iParam0, 1));
