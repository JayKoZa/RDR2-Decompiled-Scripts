...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 2.24f, 1.65f, 1f, 0f, 2f, 7f, 3f, -1612834106, 1418411488, 1, 1, 1);
	func_152(uParam0, 0.05f, -0.45f, 1f, 0f, 1.5f, 1.5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_153(uParam0, "script@vignette@sean_11@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@sean_11@action", 0, 0, 1, 0);
	func_154(uParam0, "CSE11AU");
	func_155(uParam0, 1576468335, -78265818);
	func_156(uParam0, uLocal_16, -1, 0.8f);
	func_157(uParam0, iLocal_14, 2, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_158(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_160(uParam0, iLocal_15, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return 1;
}
