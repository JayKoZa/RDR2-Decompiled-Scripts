...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 2.24f, 1.65f, 1f, 0f, 2f, 7f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, 0.05f, -0.45f, 1f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_153(uParam0, "script@vignette@sean_11@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@sean_11@action", 0, 0, 1, 0);
	...
	func_160(uParam0, iLocal_15, 2, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return true;
}
