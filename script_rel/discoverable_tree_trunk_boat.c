...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	uLocal_18 = ScriptParam_0;
	Local_19.f_1 = ScriptParam_0.f_1;
...
{
	func_9(uParam0);
	SCRIPTS::_0xE7282390542F570D(uLocal_18);
...
int func_3(var uParam0)
{
	...
	if (Local_19 == 0)
	{
		...
		Local_19 = func_10(iVar0);
		return 0;
	}
	if (func_11(Local_19, 4) || Global_40.f_8863.f_156)
	{
		func_1(uParam0);
		return 0;
	}
...
void func_8(var uParam0)
{
	...
	switch (vLocal_14.x)
	{
		case 0:
			...
			break;
		case 1:
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_14.y))
			{
				vLocal_14.f_1 = VEHICLE::CREATE_VEHICLE(func_51(), func_52(0), func_53(0), true, true, false, false);
				return;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(vLocal_14.y))
			{
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(vLocal_14.y))
			{
				ENTITY::FREEZE_ENTITY_POSITION(vLocal_14.y, true);
				vLocal_14.f_2 = 1;
			}
			func_50(&vLocal_14, 3);
			break;
		case 3:
			if (!func_49(func_48()))
			{
				if (ENTITY::DOES_ENTITY_EXIST(vLocal_14.y) && PED::IS_PED_IN_VEHICLE(Global_35, vLocal_14.y, false))
				{
					if (vLocal_14.z)
					{
						vLocal_14.f_2 = 0;
						ENTITY::FREEZE_ENTITY_POSITION(vLocal_14.y, false);
					}
					func_54(uParam0);
					func_50(&vLocal_14, 4);
				}
...
void func_9(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(vLocal_14.y))
	{
		if (vLocal_14.z)
		{
			func_55(&(vLocal_14.f_1), 0);
		}
		else
		{
			func_55(&(vLocal_14.f_1), 1);
		}
	}
}
...
bool func_11(int iParam0, int iParam1)
{
	...
	return (Global_40.f_8863[func_57(iParam0, 1)] && iParam1) != 0;
}
...
int func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, 1) > (uParam0->f_6.f_1 + 0.5f) || !func_71(Global_35, uParam0->f_6.f_2, 0))
		{
			return 1;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, 1) <= uParam0->f_6.f_1 && func_71(Global_35, uParam0->f_6.f_2, 0))
		{
			return 1;
		}
	}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_49(*uParam0))
			{
				uParam0->f_6.f_8 = func_72("DISCO_FOCUS", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_72("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
		}
		func_73(uParam0->f_6.f_8, 13, 1, 1);
...
void func_32(int iParam0, int iParam1)
{
	...
	Global_40.f_8863[func_57(iParam0, 1)] = (Global_40.f_8863[func_57(iParam0, 1)] || iParam1);
}
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = func_84(*uParam0, func_83(), uParam0->f_4);
	}
	else
	{
		iVar0 = func_85(*uParam0, uParam0->f_4);
	}
	if (iVar0 != 0)
	{
		if (bParam1)
...
int func_46(var uParam0)
{
	...
	{
		func_93(*uParam0, &Var0);
		if (FIRE::_GET_ENTITY_INSIDE_EXPLOSION_AREA(-1, Var0, Var0.f_3, Var0.f_6) == func_94(Global_35))
		{
			return 1;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, bool bParam7)
{
	...
	if ((Global_36615 && func_95(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_97(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, bParam7);
	}
	else
	{
		iVar1 = -1;
		...
		if (iVar1 >= 0)
		{
			func_98(iVar1, iVar0, iParam0, iParam1, iParam4, bParam5);
		}
		else
		{
			func_97(iVar0, 1, iParam0, iParam1, sParam3, iParam4, bParam5, 0);
		}
	}
}
...
Vector3 func_52(int iParam0)
{
	...
	{
		case 0:
			return 1567.333f, -921.6094f, 40.2737f;
		default:
			break;
	}
	return 0f, 0f, 0f;
...
Vector3 func_58(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case 2000209669:
...
Vector3 func_59(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case -780455182:
...
void func_64(var uParam0)
{
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::_DOES_VOLUME_EXIST(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_105(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::_DOES_VOLUME_EXIST(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_105(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
int func_69(var uParam0)
{
	...
	{
		case -1300082860:
			if (func_109(Global_35, func_101(uParam0, 0), 3f, 1, 1))
			{
				return 1;
			}
			break;
...
int func_70(var uParam0, int iParam1)
{
	...
	if (!func_110(iParam1, 2048) && !func_114(0))
	{
		return 0;
	}
	...
	else if (func_117(Global_35, 713668775))
	{
		return 0;
	}
	return 1;
...
int func_72(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_118(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_119(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_77(int iParam0, int iParam1)
{
	...
	{
		if (((*Global_1945938)[iParam0 /*18*/])->f_5 == 5 && !func_118(iParam0, 8))
		{
...
int func_85(int iParam0, int iParam1)
{
	...
	uVar0 = func_84(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
	uVar0 = func_84(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(uVar0))
	{
		return uVar0;
	}
...
int func_88()
{
	...
	if (!func_123(-569063887 /* GXTEntry: "Journal" */, 1, 0))
	{
	...
	if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_35, -1) || func_117(Global_35, 1369124074))
	{
		return 0;
	}
	...
	if (INVENTORY::_0x3D10D7179D7034AF(func_125(0), iVar0, 0))
	{
		return 0;
	}
...
int func_93(var uParam0, var uParam1)
{
	...
	vVar0 = { VOLUME::_0x3E2A25B2416DD67E(uParam0) };
	uParam1->f_6 = vVar0.y;
	vVar0 = { vVar0 * Vector(0.5f, 0.5f, 0.5f) };
	vVar3 = { VOLUME::_0xF70F00013A62F866(uParam0) };
	vVar6 = { VOLUME::_0x18675BC914891122(uParam0) };
	fVar9 = vVar6.z;
...
void func_97(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar6 = func_131(iVar1);
		func_133(func_132(), 0, 4000);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				{
					sParam4 = func_138(iParam3);
				}
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_139(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, joaat("COLOR_PURE_WHITE"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_137(func_136(-1636809477), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_139(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_139(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, joaat("COLOR_RED"), "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_136(-1990689970) };
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam0, 0, 0))
		{
			if (!VEHICLE::IS_VEHICLE_SEAT_FREE(*iParam0, iVar12))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(iVar1[iVar0])))
				{
					...
					func_142(&(iVar1[iVar0]), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(*iParam0, 3f, 3f, 0f), ENTITY::GET_ENTITY_HEADING(*iParam0), 2, 1073741824 /* Float: 2f */);
				}
			}
		}
		iVar0++;
		...
		case -35775921:
			switch (iParam1)
			{
				case 0:
					...
					Jump @2820; //curOff = 2811
					return 0f, 0f, 0f;
				}

Vector3 func_102(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case -777592153:
...
int func_109(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_148(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return 1;
	}
	return 0;
...
int func_115(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_110(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
...
var func_139(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, int iParam8)
{
	struct<4> Var0;
	struct<7> Var13;
	var uVar20;
...
int func_140(int iParam0, int iParam1)
{
	...
	if (!func_176(iParam0, &iVar0, &uVar1))
	{
		return 0;
	}
...
void func_141(int iParam0)
{
	if (!func_11(iParam0, 32))
	{
		...
		if (func_177(iParam0))
		{
			func_137(func_136(795577402), 1);
		}
	}
}

void func_142(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == func_94(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_178(iParam0))
	{
		if (func_179(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
	...
	if (func_39(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
			{
				...
				func_142(iVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_142(iVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_39(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_39(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_39(iParam5, 32), 1);
...
{
	return (func_182(iParam0, 4) || func_182(iParam0, 5));
}
...
int func_153(int iParam0)
{
	...
	if (!func_110(iParam0, 16) && !func_184(iVar0, 0))
	{
		return 0;
	}
	return 1;
...
int func_160(int iParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_186("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_187(&Var4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_188(Var4.f_4))
			{
			}
...
int func_185(int iParam0, int iParam1)
{
	...
	if (func_194(iParam0, 1399091007))
	{
		func_195(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_186(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
int func_187(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return 0;
...
int func_190(int iParam0, bool bParam1)
{
	...
	Var0 = { func_196(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_198(&Var0, func_197(0));
	}
	if (!func_199(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_189(iVar14);
...
struct<14> func_196(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
struct<4> func_197(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_203(923904168, func_202(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_203(923904168, func_202(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_203(923904168, func_202(bParam0), -740156546, 0);
}

void func_198(var uParam0, struct<4> Param1)
{
...
int func_199(var uParam0, var uParam1, var uParam2, bool bParam3)
{
...
{
	return func_203(joaat("character"), func_204(), -1591664384, bParam0);
}
