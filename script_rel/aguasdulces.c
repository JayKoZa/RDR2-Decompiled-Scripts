...
void func_56(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_100(iParam0))
	{
		...
		if (bParam3)
		{
			func_101(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_101(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_100(iParam0))
	{
...
bool func_188(vector3 vParam0, int iParam3)
{
	...
	func_202(iParam3, &vVar0, &Var3, &uVar6);
	if (func_203(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
