		...
		else if (func_58(uParam0->f_107[iVar0 /*113*/].f_7))
		{
			...
			else
			{
				...
				if (func_58(uParam0->f_107[iVar0 /*113*/].f_1))
				{
					...
					{
						func_64(uParam0->f_107[iVar0 /*113*/].f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
void func_53(var uParam0, var uParam1)
{
	...
	if (func_113(iVar0, joaat("SCRIPT_TASK_FOLLOW_AND_CONVERSE_WITH_PED")))
	{
...
bool func_80(var uParam0)
{
	...
	iLocal_98 = func_167(uParam0, joaat("S_INV_POCKETWATCH01X"), 0f, 0f, 0f, "POCKETWATCH", 0, 1, 1);
	...
	func_177(uParam0, joaat("COMP_SWNCNV18"), joaat("PLAYER_SWNCNV18"));
	iLocal_100 = 0;
	return true;
}
	...
	switch (iLocal_100)
	{
		case 0:
			...
			if (func_222(uParam0, iLocal_94))
			{
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(func_56(uParam0, iLocal_92), Global_35, -1, -1f, -1f, -1f);
				if (!func_48(iLocal_109))
				{
					iLocal_109 = func_224("INPUT_FRONTEND_ACCEPT", joaat("INPUT_CONTEXT_Y"), iVar0, 1, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		...
		case 1:
			...
			{
				func_8(&iLocal_109);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(func_56(uParam0, iLocal_92), Global_35, 0, -1f, -1f, -1f);
		...
		case 3:
			...
			{
				if (!func_232(joaat("PROVISION_POCKET_WATCH_PLATINUM")))
				{
					func_233(joaat("PROVISION_POCKET_WATCH_PLATINUM"), 1, 0, 0, 0);
				}
				else
				{
					func_234(joaat("PROVISION_POCKET_WATCH_PLATINUM"), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				}
				func_212(uParam0, &uLocal_18);
			}
			if (func_222(uParam0, iLocal_95))
			{
				TASK::CLEAR_PED_TASKS(func_56(uParam0, iLocal_92), true, false);
				func_235(uParam0);
				func_226(5);
			}
			break;
...
int func_123(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_136(iVar0, 0))
	{
		...
		if ((bParam1 || !func_121(iParam0)) || func_59(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_254(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_256(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_257(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_257(iParam0, 0));
					func_258(iParam0);
				}
			}
			else
...
int func_151(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_150(iParam0)))
	{
		return 1;
	}
	...
	func_147(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_150(iParam0));
	func_278(iParam0, 0);
	return 1;
}
...
{
	func_295(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_300(uParam0->f_33[iVar0], 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_314(uParam0->f_107[iVar12 /*113*/].f_1));
				}
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_255(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
void func_207(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_336(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_336(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_350(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
int func_224(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_357(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_358(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
float func_229(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_233(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_363())
	{
		func_364(iParam0, iParam1, bParam2, bParam4);
		return;
	}
	bVar0 = false;
	...
	else
	{
		...
		else if (bParam2 && func_366(iParam0, 2097152))
		{
	...
	else if (!func_368(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	sVar15 = func_370(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, func_369(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_371(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
		sVar15 = MISC::_CREATE_VAR_STRING(0, func_369(iParam0));
	}
	func_372(sVar15, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}

int func_234(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_367(iParam0) == joaat("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_367(iParam0) == joaat("WEAPON"))
		{
		...
		else if (func_367(iParam0) == joaat("AMMO") && func_403(iParam0))
		{
		...
		{
			func_408(func_407(joaat("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == joaat("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_408(func_409(joaat("COLLECTED"), joaat("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		else if (func_371(iParam0, 1192444843))
		{
			switch (iParam0)
			{
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_LAKE"):
					if (!func_423(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0))
					{
						func_234(215778062 /* GXTEntry: "Special Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_RIVER"):
					if (!func_423(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0))
					{
						func_234(670273567 /* GXTEntry: "Special River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LEG_LURE_SWAMP"):
					if (!func_423(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0))
					{
						func_234(-967317137 /* GXTEntry: "Special Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_LAKE"):
					if (!func_423(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0))
					{
						func_234(526074061 /* GXTEntry: "Lake Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_RIVER"):
					if (!func_423(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0))
					{
						func_234(-1045488665 /* GXTEntry: "River Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
				case joaat("UPGRADE_FSH_BAIT_LURE_SWAMP"):
					if (!func_423(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0))
					{
						func_234(471514780 /* GXTEntry: "Swamp Lure Handbill" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
					}
					break;
			}
		}
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_426(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER"), 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 0);
				}
				if (func_427(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER"):
				...
				{
					func_426(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER"), 0, joaat("MP_COMPONENT_TYPE_LOADOUT_1"), 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case joaat("DOCUMENT_TREASURE_MAP_01"):
				func_433(499813453, joaat("TREASURE_HUNT_LOOT_01"), 0);
				func_434(499813453, 0);
				func_435(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_02"):
				func_433(499813453, joaat("TREASURE_HUNT_LOOT_02"), 0);
				func_434(499813453, 0);
				func_435(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_03"):
				func_433(499813453, joaat("TREASURE_HUNT_LOOT_03"), 0);
				func_434(499813453, 0);
				func_435(4);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_04"):
				func_433(666607663, joaat("TREASURE_HUNT_LOOT_05"), 0);
				func_434(666607663, 0);
				func_436(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_05"):
				func_433(666607663, joaat("TREASURE_HUNT_LOOT_06"), 0);
				func_434(666607663, 0);
				func_436(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_06"):
				func_433(666607663, joaat("TREASURE_HUNT_LOOT_07"), 0);
				func_434(666607663, 0);
				func_436(4);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_07"):
				func_433(-220219788, joaat("TREASURE_HUNT_LOOT_09"), 0);
				func_434(-220219788, 0);
				func_437(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_08"):
				func_433(-220219788, joaat("TREASURE_HUNT_LOOT_10"), 0);
				func_434(-220219788, 0);
				func_437(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_09"):
				func_433(-220219788, joaat("TREASURE_HUNT_LOOT_11"), 0);
				func_434(-220219788, 0);
				func_437(4);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_10"):
				func_433(218622660, joaat("TREASURE_HUNT_LOOT_13"), 0);
				func_434(218622660, 0);
				func_438(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_11"):
				func_433(218622660, joaat("TREASURE_HUNT_LOOT_14"), 0);
				func_434(218622660, 0);
				func_438(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_13"):
				func_433(390004462, joaat("TREASURE_HUNT_LOOT_16"), 0);
				func_434(390004462, 0);
				func_439(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_14"):
				func_433(390004462, joaat("TREASURE_HUNT_LOOT_17"), 0);
				func_434(390004462, 0);
				func_439(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_15"):
				func_433(390004462, joaat("TREASURE_HUNT_LOOT_18"), 0);
				func_434(390004462, 0);
				func_439(4);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_16"):
				func_433(6410548, joaat("TREASURE_HUNT_LOOT_20"), 0);
				func_434(6410548, 0);
				func_440(1);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_17"):
				func_433(6410548, joaat("TREASURE_HUNT_LOOT_21"), 0);
				func_434(6410548, 0);
				func_440(2);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_18"):
				func_433(6410548, joaat("TREASURE_HUNT_LOOT_22"), 0);
				func_434(6410548, 0);
				func_440(4);
				break;
			case joaat("DOCUMENT_TREASURE_MAP_19"):
				func_433(6410548, joaat("TREASURE_HUNT_LOOT_23"), 0);
				func_434(6410548, 0);
				func_440(8);
				break;
			case joaat("CONSUMABLE_AGED_PIRATE_RUM"):
				func_441(242, func_369(joaat("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER"):
				func_441(240, func_369(joaat("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT"):
				func_441(241, func_369(joaat("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
...
void func_238(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_453(uParam0, iParam1);
	}
	if (bParam2)
	{
		...
		{
			func_64(uParam0->f_107[iParam1 /*113*/].f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
bool func_253(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_291()
{
	...
	if (func_475(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_292()
{
	...
	if (func_475(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_300(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_479(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_317(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool func_318(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_322(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_323(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_343(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
void func_344(var uParam0, var uParam1)
{
	...
	func_501(Global_35, iVar0, &Var1, 0f, 0f, 0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_247(1);
}
...
void func_345(var uParam0, var uParam1)
{
	...
	Var1.f_19 = -1;
	Var1.f_26 = -1082130432;
	func_502(iVar0, Global_35, &Var1, -1082130432 /* Float: -1f */, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
}
...
struct<5> func_359(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_367(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_520(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_522(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_523(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_523(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_524(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_520(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
int func_361(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_362(iParam0, 0))
	{
		return 0;
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_528(bParam3), iParam0);
}
...
bool func_368(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_373(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_266() == -1)
	{
		...
		{
			func_532(iParam0, iParam1, 1, &bParam2, iParam3);
			return false;
		}
	}
...
bool func_374(int iParam0, int iParam1, int iParam2)
{
	...
	*iParam1 = iParam2;
	...
	if (func_535(iParam0, &Var0, *iParam1, 0, 0))
	{
		if (iVar6 < iVar5)
		{
			*iParam1 = (iVar5 - iVar6);
...
int func_376(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_528(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_390(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7)
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
	...
	if (func_553(iParam0, iVar13, iVar14, iParam3, iParam1, iParam6, iVar9, iParam2, iVar10, bParam5))
	{
	}
...
void func_392(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_556(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_556(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
bool func_399(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_528(bParam0));
}
...
bool func_400(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_523(iParam0, &Var0, iVar5, 0))
			{
				if (func_524(iParam0, &Var6, iVar5))
				{
					Var29 = { func_520(iParam0, Var0, iVar5, 0) };
					func_567(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_399(0))
				{
					...
					func_401(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
bool func_402(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	var uVar1;
	int iVar6;
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_535(iParam0, &uVar1, 1, 0, 0))
		{
			func_532(iParam0, 1, 0, bParam2, iParam1);
			iVar6 = func_570(iVar0);
			...
			{
				if (iVar0 == joaat("WEAPON_MELEE_KNIFE_JOHN") && !func_328())
				{
					return false;
				}
				...
				{
					func_400(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				iVar7 = func_572(Global_35, 2, 0, 1);
				if ((((func_565(iVar7) && !Global_43891) && iVar7 != iVar0) && !func_393(24)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				bVar8 = true;
				if (func_565(iVar7) && func_393(24))
				{
...
bool func_404(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_423(joaat("PROVISION_TRINKET_CROW_BEAK"), 1, 0) && iParam2 == -897553835)
	{
	...
	{
		func_441(func_573(iParam0), func_369(iParam0), 1);
		return false;
	}
	...
	if (func_399(0))
	{
		if (func_401(iParam0, iVar0, iParam2))
		{
			*iParam1 = iVar0;
			return true;
		}
...
void func_405(int iParam0)
{
	...
	if ((iParam0 == joaat("PROVISION_TALISMAN_EAGLE_TALON") && !func_574()) || iParam0 != joaat("PROVISION_TALISMAN_EAGLE_TALON"))
	{
		if (func_575(Global_35, iParam0, &uVar0))
		{
			func_426(PLAYER::PLAYER_PED_ID(), iParam0, 0, -358215195, 1, 1, 1, 0, 1, 1);
		}
	}
	switch (iParam0)
	{
...
void func_411(int iParam0)
{
	...
	bVar0 = func_371(iParam0, -2017733358);
	if (func_579() < 3)
	{
		if (bVar0)
		{
			if (func_581(func_580(iParam0), iParam0))
			{
				func_441(79, func_369(func_580(iParam0)), 1);
			}
			else
			{
				func_441(78, func_369(func_580(iParam0)), 1);
			}
		}
		else
		{
			func_441(80, func_369(func_582(iParam0)), 1);
		}
	}
}
...
bool func_412()
{
	if (((((func_583(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_1"), 400) || func_583(joaat("DOCUMENT_ARTHUR_MINOR_BOUNTY_2"), 400)) || func_583(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_583(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_583(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_583(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return true;
	}
	return false;
...
void func_414(int iParam0)
{
	switch (iParam0)
	{
		case joaat("DOCUMENT_LETTER_TAXIDERMY"):
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_04"), 0, 0, 4, 0);
			func_392(51, 0, 0, 0, 0, -1, 0);
			func_587(8192);
			break;
		case joaat("DOCUMENT_NOTE_TAXIDERMY"):
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_05"), 0, 0, 1, 0);
			func_392(51, 0, 0, 0, 0, -1, 0);
			func_587(524288);
			break;
		...
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_01"):
			func_390(43, 0, 0, joaat("EXOTIC_STAGE_01"), func_591(1), 0, -1, 0);
			func_592(1);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_02"):
			func_390(43, 0, 0, joaat("EXOTIC_STAGE_02"), func_591(2), 0, -1, 0);
			func_592(2);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_03"):
			func_390(43, 0, 0, joaat("EXOTIC_STAGE_03"), func_591(4), 0, -1, 0);
			func_592(4);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_04"):
			func_390(43, 0, 0, joaat("EXOTIC_STAGE_04"), func_591(8), 0, -1, 0);
			func_592(8);
			break;
		case joaat("DOCUMENT_NOTE_EXOTICS_STAGE_05"):
			func_390(43, 0, 0, joaat("EXOTIC_STAGE_05"), func_591(16), 0, -1, 0);
			func_592(16);
			break;
	}
}
...
void func_417(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("DOCUMENT_TAXIDERMY_ORDER_1"):
			...
			func_383(437, 0);
			func_383(440, 0);
			func_595(joaat("TAXIDERMY_ORDER_01"), joaat("PROVISION_ANIMAL_CARCASS_SQUIRREL_PERFECT"), &sVar0, 1, 0, 0);
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_01"), sVar0, 0, -1, 0);
			func_392(51, 0, 0, sVar0, func_548(joaat("TAXIDERMY_ORDER_01"), 20), 1, 0);
			func_587(1);
			func_596(-748969569, 0, 0);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_2"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_02"), 1);
			func_595(joaat("TAXIDERMY_ORDER_02"), joaat("PROVISION_ANIMAL_CARCASS_CARDINAL_PERFECT"), &sVar0, 1, 0, 0);
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_02"), sVar0, 0, -1, 0);
			func_392(51, 0, 0, sVar0, func_548(joaat("TAXIDERMY_ORDER_02"), 20), 1, 0);
			func_587(8);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_3"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_03"), 1);
			func_595(joaat("TAXIDERMY_ORDER_03"), joaat("PROVISION_ANIMAL_CARCASS_CHIPMUNK_PERFECT"), &sVar0, 1, 0, 0);
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_03"), sVar0, 0, -1, 0);
			func_392(51, 0, 0, sVar0, func_548(joaat("TAXIDERMY_ORDER_03"), 20), 1, 0);
			func_587(64);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_4"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_04"), 1);
			func_595(joaat("TAXIDERMY_ORDER_04"), joaat("PROVISION_ANIMAL_CARCASS_SONGBIRD_PERFECT"), &sVar0, 1, 0, 0);
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_04"), sVar0, 0, -1, 0);
			func_392(51, 0, 0, sVar0, func_548(joaat("TAXIDERMY_ORDER_04"), 20), 1, 0);
			func_587(512);
			break;
		case joaat("DOCUMENT_TAXIDERMY_ORDER_5"):
			COLLECTION::_0x3EA62E56F386C997(joaat("TAXIDERMY_ORDER_05"), 1);
			func_383(438, 0);
			func_595(joaat("TAXIDERMY_ORDER_05"), joaat("PROVISION_ANIMAL_CARCASS_CEDARWAXWING_PERFECT"), &sVar0, 1, 0, 0);
			func_390(51, 0, 0, joaat("TAXIDERMY_ORDER_05"), sVar0, 0, -1, 0);
			func_392(51, 0, 0, sVar0, func_548(joaat("TAXIDERMY_ORDER_05"), 20), 1, 0);
			func_587(32768);
			break;
		default:
			func_383(439, 0);
...
void func_419(int iParam0, int iParam1)
{
	...
	if (func_266() == -1)
	{
		...
		else if (func_371(iParam0, 412399755))
		{
			func_597(joaat("EXOTIC_STAGE_01"));
			if (func_598() == 0)
			{
				func_542(0, 10);
				iVar1 = func_599(iParam0, iParam1, 1);
				if (((iParam0 == joaat("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == joaat("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == joaat("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					if (func_600(iParam0) < func_601(iParam0))
					{
						func_390(43, iParam0, iParam1, joaat("EXOTIC_STAGE_01"), iVar1, 0, -1, 0);
		...
		else if (func_371(iParam0, 709057512))
		{
			func_597(joaat("EXOTIC_STAGE_02"));
			if (func_598() == 1)
			{
				func_542(0, 10);
				iVar1 = func_599(iParam0, iParam1, 2);
				if ((iParam0 == joaat("PROVISION_HERON_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_600(iParam0) < func_601(iParam0))
					{
						func_390(43, iParam0, iParam1, joaat("EXOTIC_STAGE_02"), iVar1, 0, -1, 0);
		...
		else if (func_371(iParam0, -1478961327))
		{
			func_597(joaat("EXOTIC_STAGE_03"));
			if (func_598() == 2)
			{
				func_542(0, 10);
				iVar1 = func_599(iParam0, iParam1, 4);
				if (iParam0 == joaat("PROVISION_GATOR_EGG"))
				{
					if (!func_602(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("GATOR_EGGS"), 0)) >= 25)
					{
						func_603(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("GATOR_EGGS"), 0), 1);
						func_541(48);
					}
					if (func_600(iParam0) < func_601(iParam0))
					{
						func_390(43, iParam0, iParam1, joaat("EXOTIC_STAGE_03"), iVar1, 0, -1, 0);
		...
		else if (func_371(iParam0, -1238404098))
		{
			func_597(joaat("EXOTIC_STAGE_04"));
			if (func_598() == 3)
			{
				func_542(0, 10);
				iVar1 = func_599(iParam0, iParam1, 8);
				if (((iParam0 == joaat("PROVISION_SPOONBILL_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_600(iParam0) < func_601(iParam0))
					{
						func_390(43, iParam0, iParam1, joaat("EXOTIC_STAGE_04"), iVar1, 0, -1, 0);
		...
		else if (func_371(iParam0, 1160548794))
		{
			func_597(joaat("EXOTIC_STAGE_05"));
			if (func_598() == 4)
			{
				func_542(0, 10);
				iVar1 = func_599(iParam0, iParam1, 16);
				if (((iParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_600(iParam0) < func_601(iParam0))
					{
						func_390(43, iParam0, iParam1, joaat("EXOTIC_STAGE_05"), iVar1, 0, -1, 0);
...
void func_421(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar1 < 5)
	{
		...
		if (func_423(func_604(iVar0, 10), 1, 0))
		{
			if (bParam2)
			{
				func_605(iParam0, iVar0, sVar2, iParam1, bParam2);
			}
			else
			{
				func_606(iParam0, iVar0, bParam3);
			}
		}
		iVar1++;
	}
...
void func_422(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case joaat("MONEY_ONE_DOLLAR"):
			func_413(joaat("REWARD_BILL"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_FIVE_DOLLARS"):
			func_413(joaat("REWARD_FIVE_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_TEN_DOLLARS"):
			func_413(joaat("REWARD_TEN_DOLLARS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case joaat("MONEY_COINSACK"):
			func_413(joaat("REWARD_BOUNTYHUNTING_MEDIUM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINSTACK"):
			func_413(joaat("REWARD_COINS"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case joaat("MONEY_MONEYSTACK_LARGE"):
			if (!func_607())
			{
				func_413(joaat("REWARD_MONEYSTACK_LARGE"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case joaat("MONEY_COINCUP_SM"):
			func_413(joaat("REWARD_COINCUP_SM"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("MONEY_COINCUP_LG"):
			func_413(joaat("REWARD_COINCUP_LG"), 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
bool func_423(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_376(iParam0, 0, bParam2) >= iParam1;
}
...
void func_424(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_01"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_02"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_03"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_04"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_05"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_06"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_PERCH_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_07"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_08"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_09"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_10"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_11"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_12"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_13"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_542(0, 10);
			break;
		case joaat("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_609(joaat("LEGENDARY_FISH_14"));
			func_610(joaat("LEGENDARY_FISHING_SPOT_14"));
			func_611(joaat("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
int func_426(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	struct<5> Var0;
	int iVar5;
	...
	if (!func_615(iParam1, iParam2, func_614(iParam3, 1), bParam4, bParam9))
	{
		return 0;
	}
	func_616(1, (func_266() == -1 && bParam5), 1);
	switch (iParam3)
	{
		case 1145151482:
		case 1742327865:
			if (bParam8 && iParam1 != Global_1946804.f_57[func_614(iParam3, 1) /*11*/])
			{
				func_617(31, 0, 0, 0, 0);
			}
			break;
		case 1108822547:
			if (func_618(32768) && iParam1 != Global_1946804.f_57[func_614(iParam3, 1) /*11*/])
			{
				func_619();
...
void func_434(int iParam0, bool bParam1)
{
	...
	func_556(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar3), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_446(int iParam0, int iParam1, int iParam2)
{
	...
	Var0 = { func_359(iParam0, 0, 1) };
	Var5 = { func_520(iParam0, Var0, Var0.f_4, 0) };
	return func_631(iParam0, &Var5, &Var0, iParam1, iParam2, 0);
}
...
void func_447(int iParam0)
{
	...
	{
		case 81053684:
			if (iParam0 == joaat("KIT_BANDANA") && func_632(81053684, 0) <= 0)
			{
				func_617(32, iParam0, 0, 0, 0);
			}
			break;
		case -2061583405:
	...
	{
		if (!func_639(joaat("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
			func_426(Global_35, iParam0, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
		}
		func_394(24);
		if (func_427(&iVar2, 0))
		{
...
{
	if (func_371(iParam0, 943695443))
	{
		func_640(0, iParam0);
	}
	else if (func_371(iParam0, -2096528786))
	{
		func_640(1, iParam0);
	}
	else if (func_371(iParam0, -1094167013))
	{
		func_640(2, iParam0);
	}
	else if (func_371(iParam0, 1936654645))
	{
		func_640(3, iParam0);
	}
	else if (func_371(iParam0, 1306489306))
	{
		func_640(4, iParam0);
	}
	else if (func_371(iParam0, 435762317))
	{
		func_640(5, iParam0);
	}
	else if (func_371(iParam0, 1259363210))
	{
		func_640(6, iParam0);
	}
	else if (func_371(iParam0, 881398259))
	{
		func_640(7, iParam0);
	}
	else if (func_371(iParam0, -541549214))
	{
		func_640(8, iParam0);
	}
	else if (func_371(iParam0, 130796156))
	{
		func_640(-1, iParam0);
	}
}
...
int func_449(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_641(&Var4, joaat("LOOT_TYPE_NORMAL"));
...
struct<2> func_450(int iParam0)
{
	...
	if (func_371(iParam0, -305066475))
	{
		if (func_266() == -1)
		{
			if (func_371(iParam0, -537818634))
			{
				return func_643(joaat("MEDICINE_AND_DEADEYE_ITEMS"));
			}
			else
			{
				return func_643(joaat("DEADEYE_ITEMS"));
			}
		}
	}
	else if (func_371(iParam0, -537818634))
	{
		return func_643(joaat("MEDICINE_ITEMS"));
	}
	if (func_371(iParam0, 2084895747))
	{
		return func_643(joaat("LOCK_BREAKER_ITEMS"));
	}
	return Var2;
}
...
void func_452(int iParam0, char* sParam1)
{
	...
	func_372(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_646(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_464()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_662(Global_35))
	{
		return true;
	}
	return false;
...
void func_476(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_454(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_479(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_480(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
	...
	iVar1 = func_668(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_484(int iParam0, bool bParam1)
{
	...
	{
		func_278(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_148(iParam0)));
		if (func_266() == -1)
		{
			if (func_144(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_150(iParam0));
...
int func_485(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((bParam4 && !func_66(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
bool func_493(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<15> Var0;
...
void func_496(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_684(iParam1))
		{
			func_685(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_501(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
...
void func_502(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> Var0;
...
bool func_510(var uParam0, var uParam1)
{
	...
	if (!func_48(uParam1->f_47.f_3))
	{
		uParam1->f_47.f_3 = func_224("INTERACT_WNT_DISMISS", joaat("INPUT_INTERACT_LOCKON_NEG"), iVar0, 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
bool func_511(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
{
	return func_520(joaat("CHARACTER"), func_698(), -1591664384, bParam0);
}

struct<4> func_520(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_521(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_520(923904168, func_519(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_520(923904168, func_519(bParam0), -740156546, 0) };
		}
...
{
	if (func_395(iParam0) == 1779021115)
	{
		return false;
	}
...
bool func_523(int iParam0, var uParam1, int iParam2, bool bParam3)
{
...
struct<4> func_525(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_520(271701509, func_519(bParam0), 12999093, 0) };
		}
...
bool func_527(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
{
	return func_367(iParam0) == joaat("WEAPON");
}
...
void func_532(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;

	if (func_367(iParam0) != joaat("WEAPON"))
	{
		return;
	}
	iVar0 = func_397(iParam0, 0);
	...
	if (bParam2 || !func_564(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, false) && func_376(iParam0, 0, 0) == 0))
		{
			if (!*bParam3 && !iParam4 == 1248274121)
			{
				func_233(iParam0, iParam1, 0, 0, 0);
...
bool func_535(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
	...
	if (func_530(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_521(0) };
			...
			else if (func_524(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return false;
			}
			if (func_522(iParam0, 1))
			{
				if (!func_523(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return false;
				}
				else if (func_524(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return false;
				}
			}
		}
		else if (!func_703(iParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
	}
	iVar27 = func_361(iParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return false;
	}
	...
	{
		iVar28 = INVENTORY::_0xE787F05DFC977BDE(func_528(bParam4), iParam0, 0);
	}
...
int func_537(int iParam0, int iParam1)
{
	...
	if (func_371(iParam0, 1399091007))
	{
...
int func_538(int iParam0, bool bParam1)
{
	...
	Var0 = { func_704(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
...
void func_541(int iParam0)
{
	...
	func_372(MISC::_CREATE_VAR_STRING(6, func_712(iParam0), fVar1), "itemtype_textures", func_713(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
bool func_544(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
bool func_551(int iParam0, int iParam1, vector3 vParam2, char* sParam5, char* sParam6)
{
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(3, iParam1))
	{
...
bool func_552(int iParam0, int iParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6, int iParam7)
{
...
bool func_553(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_557(func_726(iVar0))), func_557(func_726(iVar0)), bVar1, true, false);
		}
		if (iParam2 == joaat("DINO_BONES"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_729(iVar0)), func_729(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == -1531394072)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_732(iVar2)), func_732(iVar2), bVar1, true, false);
		}
		if (iParam2 == 1995362678)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_734(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_734(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
		if (iParam2 == joaat("ROCK_CARVINGS"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_735(iVar0)), func_735(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_737(iVar2)), func_737(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
bool func_554(int iParam0, int iParam1, int iParam2, int iParam3)
{
	bool bVar0;
...
bool func_555(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_562(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if ((!Global_1879534 && func_386()) && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2))
			{
				func_558("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			...
			break;
		case 3:
			if ((!Global_1879534 && func_386()) && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3))
			{
				func_558("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			...
			break;
		case 4:
			if ((!Global_1879534 && func_386()) && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 4))
			{
				func_558("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
			...
			break;
		case 5:
			if ((!Global_1879534 && func_386()) && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 5))
			{
				func_558("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), 1963346246, -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_266() == -1)
			{
				if (!func_639(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_747(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_328())
					{
					...
					func_426(Global_35, iVar0, 0, joaat("MP_COMPONENT_TYPE_LOADOUT_3"), 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
bool func_567(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_568(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_750(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
bool func_575(int iParam0, int iParam1, var uParam2)
{
	var uVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_367(iParam1) != joaat("CLOTHING"))
	{
		return false;
	}
	bVar1 = func_266() != -1;
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_756(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_579()
{
	...
	while (iVar1 < 26)
	{
		if (func_423(func_758(iVar1), 1, 0))
		{
			iVar0++;
		}
		iVar1++;
...
int func_584(int iParam0, bool bParam1, int iParam2)
{
	float fVar0;
	struct<13> Var1;
	int iVar24;
	...
	fVar0 = 1f;
	if (bParam1 && func_423(joaat("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_585(int iParam0, char* sParam1, int iParam2)
{
	...
	func_372(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_586(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_372(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_372(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_408(func_643(joaat("CAREER_CASH")), iVar1);
	}
}
...
int func_593()
{
	...
	while (iVar1 < 30)
	{
		if (func_764(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_595(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_598()
{
	...
	while (iVar1 < 5)
	{
		if (func_770(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_615(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<5> Var0;
	int iVar5;
	int iVar6;
	...
	func_777(iParam2);
	func_778(iParam2, iVar5);
	if (Global_1946804.f_1378.f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && Global_1946804.f_57[iParam2 /*11*/].f_1 > 1)
	{
		func_779(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_779(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	func_780(&(Global_1946804.f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1;
	}
	Global_1946804.f_1378.f_1[iParam2 /*3*/] = iParam0;
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_781(iParam0, iParam2, iParam1, func_266() != -1);
	if (bParam4)
	{
		func_782(&(Global_1946804.f_1378), 1, 3);
	}
	else
	{
		func_782(&(Global_1946804.f_1378), 1, 0);
	}
	if (bParam3)
	{
		iVar6 = 0;
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_783(func_774(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
{
	func_784(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}

void func_617(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<4> Var0;
...
void func_619()
{
	func_787(&(Global_1946804.f_2776));
	func_788(32768);
	func_783(1108822547, 8, 6);
}
...
bool func_623(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_528(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_624(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return false;
...
int func_631(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_362(iParam0, 0))
	{
	}
	...
	if (func_535(iParam0, uParam2, iParam3, bParam5, 0))
	{
		return 0;
	}
	if (!func_399(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_528(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_635(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((!func_809() && !bParam1) && !func_286(0, 0, 1))
	{
		func_810(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_811(iParam0, 6);
	if (bParam2)
	{
...
{
	return func_632(iParam0, 0) < func_812(iParam0, bParam1);
}
...
{
	if (func_371(iParam1, 130796156))
	{
		func_813(iParam1, 0);
	}
	else if (func_371(iParam1, 930141731))
	{
		func_813(iParam1, 1);
		func_814(iParam0);
	}
...
int func_646(int iParam0)
{
	...
	if (!func_817(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
void func_648(var uParam0, int iParam1)
{
	...
	func_818(sVar1, uVar2, uVar3, iVar4);
}
...
void func_651(var uParam0, int iParam1)
{
	...
	func_819(uParam0->f_107[iParam1 /*113*/].f_1, uParam0->f_107[iParam1 /*113*/].f_32.f_39);
}
...
int func_652(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_821(fVar9) };
			vVar13 = { func_822(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
{
	return (func_824(iParam0, 4) || func_824(iParam0, 5));
}
...
int func_668(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_136(iVar0, 0)) || (bParam3 && !func_59(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_826(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && func_136(iVar0, 0))
	{
		*uParam0 = 2;
		...
		func_827(iParam1, iVar0);
		func_828(iParam1, bParam13, bParam14, 1);
		return iVar0;
	}
	else
	{
...
bool func_674(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_287(iParam0, 1073741824 /* Float: 2f */))
	{
		return true;
	}
	iVar0 = func_831(iParam1);
...
bool func_677(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_58(iParam0))
	{
		return false;
...
int func_678(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		case 0:
			...
			if (func_259(iParam0, 16, 1))
			{
				if (Global_1360165[iParam0 /*1157*/].f_129 != SCRIPTS::GET_ID_OF_THIS_THREAD())
				{
					...
					{
						func_64(iParam0, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
			...
			if (func_136(Global_1360165[iParam0 /*1157*/], 0))
			{
				...
				if (PED::IS_PED_RAGDOLL(Global_1360165[iParam0 /*1157*/]))
				{
					if (bParam1)
					{
						func_832(iParam0, 1, "Stealing, but companion is a ragdoll");
					}
					else
					{
						return 0;
		...
		case 1:
			...
			if (func_834(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_833(iParam0, 2);
			}
			break;
		case 2:
			...
			if (bParam22)
			{
				func_835(iParam0, 0, 0, 1);
			}
			func_118(iParam0, 33, 1);
			func_118(iParam0, 34, 1);
			func_118(iParam0, 29, 1);
			if (!func_252(vVar0) && bParam7)
			{
				func_833(iParam0, 3);
			}
			else if (iParam13 != 0)
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[iParam0 /*1157*/]))
				{
					...
					{
						func_832(iParam0, 1, "Teleporting a stolen companion using a scenario.");
					}
					else
					{
				...
				func_836(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
		...
		case 4:
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_837(iParam0, iParam13))
				{
					if (PED::_0xA0BC8FAED8CFEB3C(Global_1360165[iParam0 /*1157*/]))
					{
						func_838(iParam0, iParam13, 0);
						func_839(iParam0, Global_1360165[iParam0 /*1157*/], iParam13, 1);
		...
		case 7:
			...
			func_841(iParam0, Global_1360165[iParam0 /*1157*/]);
...
int func_701(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	struct<37> Var0;
...
bool func_703(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	while (iVar29 < 4)
	{
		iVar5 = func_566((386 + iVar29), 1);
		if (func_523(iParam0, &Var0, iVar5, 0))
		{
			bVar28 = func_524(iParam0, &Var6, iVar5);
...
bool func_706(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_528(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
{
	return func_850(Global_40.f_11095.f_11[iParam0]);
}
...
void func_711(int iParam0, float fParam1, bool bParam2)
{
	...
	if (func_851(iParam0) && func_852(iParam0))
	{
		if (!bParam2)
		{
			iVar3 = func_853(fVar1, fParam1);
			if (fParam1 > IntToFloat(func_854(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
				if (!HUD::IS_RADAR_HIDDEN() && !Global_16)
				{
					if (iVar2 > iVar0)
					{
						func_383(func_855(iParam0), 0);
					}
					func_856(iParam0, iVar2, iVar3);
					func_857(iParam0, 7000);
				}
...
int func_721()
{
	return func_859(Global_40.f_12019);
}
...
int func_723()
{
	...
	while (iVar1 < 30)
	{
		if (func_860(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_861(iParam0) && func_423(iParam0, 1, 0))
	{
		return true;
	}
	else if (func_862(iParam0) && func_863(iParam0))
	{
		return true;
	}
	return false;
...
char* func_737(int iParam0)
{
	...
	return HUD::_GET_LABEL_TEXT_BY_HASH(func_369(iParam0));
}
...
void func_748()
{
	if (!UNLOCK::_UNLOCK_IS_UNLOCKED(joaat("SP_ENDLESS_SUMMER_WEAPONS")))
	{
		...
		func_398(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"));
		func_446(joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), 1, 752097756);
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, joaat("WEAPON_REVOLVER_CATTLEMAN_JOHN"), true, 2, false, false);
		func_398(joaat("WEAPON_MELEE_KNIFE_JOHN"));
...
bool func_754(int iParam0, var uParam1)
{
	...
	iVar1 = func_614(func_865(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
int func_755(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946804.f_57[func_614(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
void func_762(int iParam0)
{
	...
	func_868((Global_40.f_4283.f_325 + iParam0));
}

void func_763(int iParam0, char* sParam1, int iParam2)
{
	if (iParam0 == 0)
	{
		return;
	...
	if (func_761())
	{
		func_372(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_372(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
{
	func_783(iParam0, 8, 6);
}

void func_777(int iParam0)
{
	func_870(&(Global_1946804.f_2589), iParam0);
}

void func_778(int iParam0, int iParam1)
{
	func_871(&(Global_1946804.f_2589), iParam0, iParam1);
}
...
void func_780(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_872(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
		uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
		if (bParam4)
		{
			func_778(iVar1, iVar3);
		}
	}
	if (func_639(-1586649372) && func_872(iParam2, 524288))
	{
		iVar1 = 33;
		uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
		uParam0->f_1[iVar1 /*3*/].f_1 = 0;
	...
	switch (iVar2)
	{
		case 698653232:
			...
			func_873(uParam0, (1 && bParam4), (1 && bParam4), (1 && bParam4), bParam3);
			break;
		case 688587926:
			func_873(uParam0, 0, (1 && bParam4), (1 && bParam4), bParam3);
			iVar1 = 22;
			...
			else
			{
				...
				func_873(uParam0, (1 && bParam4), (1 && bParam4), 0, bParam3);
				iVar1 = 22;
				if (uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/])
				{
					uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
				...
				func_873(uParam0, (1 && bParam4), 0, 1, bParam3);
				...
				{
					iVar1 = 35;
					if ((func_756(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_395(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_756(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_371(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
int func_781(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_874(0);
	if (iParam2 != 0 && func_875(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_876(iParam0, func_774(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_782(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_784(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	while (iVar0 < *uParam0)
	{
		func_879(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_266() == -1)
	{
		if ((Global_40.f_7729 != 0 || !func_880(2, Global_26796.f_776)) || Global_1946804.f_1497 != func_807(0))
		{
...
void func_790(struct<4> Param0)
{
	...
	if (func_883(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_883(20))
			{
				return;
			}
			iVar0++;
...
void func_798(int iParam0, char* sParam1, bool bParam2)
{
	char* sVar0;

	sVar0 = func_887(iParam0, 1, 0, 0);
...
float func_800(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_806(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_805(iParam0))
	{
		...
		if ((!func_809() && !bParam1) && !func_286(0, 0, 1))
		{
			func_810(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_889(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
var func_810(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
{
	func_641(uParam0, joaat("MULTIPLAYER_GAME"));
	if (Global_1946804.f_1 == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_641(uParam0, joaat("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_641(uParam0, joaat("LOOTER_PED_IS_FEMALE"));
	}
}

void func_816(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
bool func_817(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_818(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_821(float fParam0)
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_822(vector3 vParam0, vector3 vParam3, float fParam6)
{
	return func_900(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
int func_826(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_902(iParam0) && func_903(iParam0, &uVar4))
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_255(iParam0, 1), &uVar4);
				}
		...
		case 1:
			if (!Global_1359489.f_12)
			{
				...
				if (!func_905(iParam0, vVar0, iParam6, iParam10))
				{
					return func_904();
				}
				if (func_136(Global_1360165[iParam0 /*1157*/].f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_906(iParam0, Global_1360165[iParam0 /*1157*/].f_124, 1))
				{
					return func_904();
				}
			}
			if ((bParam2 && !func_252(vVar0)) && !func_253(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(Global_1360165[iParam0 /*1157*/].f_124))
				{
					ENTITY::DETACH_ENTITY(Global_1360165[iParam0 /*1157*/].f_124, true, true);
				}
				func_836(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(Global_1360165[iParam0 /*1157*/].f_124))
			...
			func_907(Global_1360165[iParam0 /*1157*/].f_124, iParam0);
			if (bParam8)
			{
				POPULATION::_0xF74E134F40192884(Global_1360165[iParam0 /*1157*/].f_124, 1);
			}
			sVar12 = func_908(iParam0, func_328());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_255(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_828(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (!func_58(iParam0))
	{
		return;
	...
	if (bParam3)
	{
		func_909(func_120(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_910(iParam0);
...
bool func_829(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_119(iParam0))
	{
		return false;
...
bool func_834(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_119(iParam0))
	{
		return false;
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_914(iParam0, iParam9, bParam7, 1);
				}
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_915(Global_1360165[iParam0 /*1157*/].f_4.f_2) || func_546(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
					iParam4 = Global_1360165[iParam0 /*1157*/].f_4.f_1;
				}
				else
				{
					iParam4 = func_914(iParam0, Global_40.f_4283, bParam7, 1);
				}
				if (Global_1360165[iParam0 /*1157*/].f_63 != iParam4 && func_916(Global_1360165[iParam0 /*1157*/].f_63))
				{
					if (!func_917(iParam0, 0))
					{
						func_63(iParam0, 25, 0);
					}
				}
			}
			Global_1360165[iParam0 /*1157*/].f_4 = { func_918(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_118(iParam0, 44, 1);
			}
...
void func_836(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_923(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_924(iParam0))
	{
		if (func_925(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
	...
	if (func_270(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_270(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_270(iParam5, 32), true);
...
bool func_837(int iParam0, int iParam1)
{
	...
	bVar0 = func_926(iParam0, iParam1);
	return bVar0;
}
...
void func_841(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_932(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_932(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_842(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_276(iParam0)))
	{
		return false;
	}
	return !PERSCHAR::_0xEB98B38CA60742D7(func_150(iParam0));
}
...
float func_849(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50:
			...
			iVar5 = func_850(fVar3);
			iVar0 = iVar5;
			iVar6 = iVar0 + 1;
			iVar1 = (func_934(iVar6) - func_934(iVar5));
...
int func_853(float fParam0, float fParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	iVar0 = func_850(fParam0);
	fVar1 = BUILTIN::TO_FLOAT(func_934(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_934(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_856(int iParam0, int iParam1, int iParam2)
{
	...
	iVar3 = (iVar3 + func_937(iParam0));
	sVar4 = func_939(func_938(iVar3, iParam2));
	sVar6 = func_940(iParam0);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar6))
	{
		sVar5 = "HUD_Toast_Soundset";
	}
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_941(iParam0));
	iVar8 = func_942(iParam0);
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_943(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_556(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_944(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_863(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_945(&iVar0, 0, iVar95, &Var1) && !func_945(&iVar0, 1, iVar95, &Var1))
		{
		}
...
void func_864()
{
	...
	func_948(0);
	func_949(7);
	func_950(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_636() == 1160113249)
	{
		func_950(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_950(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_951(Global_35, &uVar0);
}
...
void func_868(int iParam0)
{
	...
	Var0 = { func_643(joaat("GANG_SAVINGS_CASH")) };
...
void func_870(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_952(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_952(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_953(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_873(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (uParam0->f_1[iVar3 /*3*/].f_1 == 1216705912 || uParam0->f_1[iVar3 /*3*/].f_1 == 654181853)
	{
		...
		if (bParam2)
		{
			func_778(iVar1, iVar0);
		}
		if (bParam1)
		{
			func_778(iVar3, iVar0);
		}
	}
...
void func_879(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_266() == -1)
	{
		func_956(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_957(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_881(int iParam0, bool bParam1, int iParam2)
{
	func_958(&(Global_1946804.f_1378), iParam0);
	func_959(2, iParam0, 6);
	if (bParam1)
	{
		func_882(0, 1);
	}
...
char* func_887(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_892(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_423(func_966(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
void func_894()
{
	...
	func_446(joaat("UPGRADE_STAMINA_TANK_1"), 1, 752097756);
	iVar0 = func_710(1);
	func_856(1, iVar0, 0);
}
...
void func_896()
{
	...
	func_446(joaat("UPGRADE_DEADEYE_TANK_1"), 1, 752097756);
	iVar0 = func_710(2);
	func_856(2, iVar0, 0);
}
...
void func_897()
{
	...
	func_446(joaat("UPGRADE_HEALTH_TANK_1"), 1, 752097756);
	iVar0 = func_710(0);
	func_856(0, iVar0, 0);
}
...
Vector3 func_900(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
bool func_903(int iParam0, char* sParam1)
{
...
bool func_905(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_255(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
				Global_1360165[iParam0 /*1157*/].f_124 = func_327(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_906(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_968(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_907(int iParam0, int iParam1)
{
	...
	func_688(iParam0, func_969(iParam1));
	...
	func_828(iParam1, func_967(iParam1, 8192), func_967(iParam1, 16384), 1);
}

char* func_908(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 3:
...
void func_909(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_914(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_475(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_410(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
	...
	if (bParam3 && ENTITY::DOES_ENTITY_EXIST(func_272(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
struct<7> func_918(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> Var0;
...
int func_928(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_977(296923297, iParam1);
			return func_978(iVar0);
		case -2040275819:
			return 464906090;
		case -1114682645:
			return 744097966;
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_977(1237718549, iParam1);
			return func_978(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_929(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1 > 0 && func_843(iParam1, 860729266))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4096 > 0 && func_843(iParam1, 879715242))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 128 > 0 && func_843(iParam1, 1606325429))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 256 > 0 && func_843(iParam1, 1743550585))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 512 > 0 && func_843(iParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1024 > 0 && func_843(iParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2048 > 0 && func_843(iParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & -2147483648 > 0 && func_843(iParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 65536 > 0 && func_843(iParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16384 > 0 && func_843(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 262144 > 0 && func_843(iParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 524288 > 0 && func_843(iParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1048576 > 0 && func_843(iParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2097152 > 0 && func_843(iParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 32768 > 0 && func_843(iParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 131072 > 0 && func_843(iParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4194304 > 0 && func_843(iParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8388608 > 0 && func_843(iParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16777216 > 0 && func_843(iParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 33554432 > 0 && func_843(iParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 67108864 > 0 && func_843(iParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 134217728 > 0 && func_843(iParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 268435456 > 0 && func_843(iParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 536870912 > 0 && func_843(iParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1073741824 > 0 && func_843(iParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8192 > 0 && func_843(iParam1, 1544915253))
	{
...
void func_930(int iParam0)
{
	...
	func_979(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_932(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_565(iVar0))
		{
...
int func_937(int iParam0)
{
	...
	{
		case 0:
			return INVENTORY::_0xE787F05DFC977BDE(func_528(0), joaat("UPGRADE_HEALTH_TANK_1"), 0);
		case 1:
			return INVENTORY::_0xE787F05DFC977BDE(func_528(0), joaat("UPGRADE_STAMINA_TANK_1"), 0);
		case 2:
			return INVENTORY::_0xE787F05DFC977BDE(func_528(0), joaat("UPGRADE_DEADEYE_TANK_1"), 0);
	}
	return 0;
}

struct<4> func_938(int iParam0, int iParam1)
{
	char cVar0[32];
...
char* func_939(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_945(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;

	if (func_981(iParam1) && !func_982(iParam1))
	{
...
void func_949(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		if (func_990(iVar2, 0))
		{
			func_991(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}

void func_950(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
...
void func_958(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_957(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
		iVar0++;
	}
}
...
void func_980(int iParam0, int iParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
void func_987(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_1013(iParam0, &(Global_1946804.f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_989(var uParam0, int iParam1, int iParam2)
{
	...
	func_1014(iParam2, *uParam0);
	func_1015(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
{
	return func_1018(func_1017(iParam0));
}
...
void func_1015(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
void func_1019(var uParam0, int iParam1, int iParam2)
{
	...
	iVar1 = func_1022(iParam1);
	func_1023(iParam1, iParam2);
	if (iVar1 >= 0 && uParam0->f_26 > 0)
	{
		func_1024(&(uParam0->f_26), iVar1);
		if (func_1025(uParam0->f_26, &iVar0))
		{
			func_1026(iVar0, iVar1);
		}
	}
}
...
void func_1021(var uParam0)
{
	...
	func_1028(&(uParam0->f_3), *uParam0, uParam0->f_2);
}

var func_1022(int iParam0)
{
...
bool func_1025(int iParam0, var uParam1)
{
	*uParam1 = 0;
	*uParam1 = 0;
	while (*uParam1 < Global_1946804.f_2657.f_19)
...
void func_1028(var uParam0, var uParam1, var uParam2)
{
	int iVar0;

	iVar0 = func_1029(func_636());
	if (*uParam0)
	{
		func_1027(uParam0);
	}
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(iVar0, uParam1, 0, func_266() != -1, uParam2);
	*uParam0 = 1;
}
