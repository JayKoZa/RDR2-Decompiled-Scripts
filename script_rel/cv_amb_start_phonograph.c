...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.45f, 1.21f, 0f, 0f, 2.5f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	if (bVar0)
	{
		func_154(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 0);
	}
	else
	{
		func_154(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
...
bool func_193(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
int func_250(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_290(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_387(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
