...
int func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_14, 2, joaat("prop_human_seat_bench"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", uLocal_31, 0, 20f, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, 1, 12, 0, 0, 0);
	func_156(uParam0, iLocal_15, 2, 343112864, "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
