		...
		while (iVar28 < 4)
		{
			...
			if (func_462(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_466(0))
				{
					...
					func_467(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
int func_413(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_374(*uParam1, 2))
	{
		...
		else if ((func_186(iParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_LAST_MOUNT(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(PED::_GET_LAST_MOUNT(iParam0))))
		{
...
void func_468(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_415(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
void func_592(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_627(func_626(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_628())
	{
...
int func_644(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_645(iVar2) != 0 && PERSCHAR::_0x800DF3FC913355F3(func_646(iVar2)))
		{
