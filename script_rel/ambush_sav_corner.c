...
int func_16()
{
	...
	Local_274.f_61[iVar0] = PED::_0xEAF682A14F8E5F53(&(Local_274.f_13[iVar0]), vVar1, uVar4, 1, 1, 1, 0);
...
int func_20()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			func_131(&(uLocal_15[iVar0]), joaat("weapon_melee_knife"), 1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
			switch (iVar0)
			{
				case 0:
...
int func_92(int iParam0)
{
	if (&uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_256(997958153 /* GXTEntry: "Riding" */, 1);
		}
		else
		{
...
void func_132(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	func_131(iParam0, iParam1, -1, iParam3, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
}
...
void func_139(bool bParam0)
{
	...
	{
		if (func_47(Local_274.f_25[1 /*3*/], 0.1f) || bParam0)
		{
...
void func_149()
{
	...
	if (uLocal_15.f_227)
	{
		...
		{
			if (func_304(&(uLocal_15[0]), 273784715, "bLineHola", func_303(), 1067030938 /* Float: 1.2f */, 1))
			{
	...
	{
		if (func_304(&(uLocal_15[0]), 1700452288, "bLineYell", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&Local_274, 0, 2);
		}
	}
	...
	if (!func_302(&Local_274, 0, 2))
	{
		if (func_304(&(uLocal_15[0]), 1611840838, "bLineBypass", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&Local_274, 0, 2);
		}
	}
...
void func_151()
{
	...
	if (func_61(&(uLocal_15[4]), 0, 1))
	{
		...
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(uLocal_15[4]), func_282(&Local_274, 4), 2f, 0, false, 0);
	}
	if (func_61(&(uLocal_15[5]), 0, 1))
	{
		...
		PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(uLocal_15[5]), func_309(&Local_274, 5), 2f, 0, false, 0);
	}
...
void func_169()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				func_301(&(uLocal_15[iVar0]), 0, "AMBUSH_SCR_ADJUST", -1082130432 /* Float: -1f */, 1, 1744022339);
...
void func_171()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			if (MISC::ARE_STRINGS_EQUAL(cVar2, "0257_G_M_M_UniMountainMen_02_WHITE_01") || MISC::ARE_STRINGS_EQUAL(cVar2, "0258_G_M_M_UniMountainMen_02_WHITE_02"))
			{
				func_301(&(uLocal_15[iVar0]), 0, "AMBUSH_SCR_ADVANCE", -1082130432 /* Float: -1f */, 1, 1744022339);
...
void func_172()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			if (MISC::ARE_STRINGS_EQUAL(cVar2, "0257_G_M_M_UniMountainMen_02_WHITE_01") || MISC::ARE_STRINGS_EQUAL(cVar2, "0258_G_M_M_UniMountainMen_02_WHITE_02"))
			{
				func_301(&(uLocal_15[iVar0]), 0, "AMBUSH_SCR_FLEE", -1082130432 /* Float: -1f */, 1, 1744022339);
...
int func_175()
{
	...
	if (WEAPON::_0xF29A186ED428B552(&(uLocal_15[Local_274.f_68]), joaat("weapon_melee_knife")))
	{
		iVar0 = joaat("weapon_melee_knife");
	}
	else if (WEAPON::_0xF29A186ED428B552(&(uLocal_15[Local_274.f_68]), joaat("weapon_melee_hatchet_meleeonly")))
	{
...
{
	if (func_366(iParam1, 1114636288 /* Float: 60f */) || func_368(iParam1, 1, 1) <= 30f)
	{
		return 0;
	}
	return 1;
...
void func_254(var uParam0, float fParam1)
{
	...
	func_382(uParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432 /* Float: -1f */);
	vVar0 = { uParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { uParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_369(vVar0, vVar3, 0) };
	vVar9 = { func_370(vVar0, vVar3, 0) };
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_0x959383DCD42040DA(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_399(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
void func_288(var uParam0, int iParam1, char[4] cParam2, bool bParam3)
{
	func_405(&(uParam0->f_63[iParam1]), cParam2, bParam3, func_404(uParam0, iParam1));
}
	...
	if (bVar1 && uParam0->f_182.f_17 & 1 != 0)
	{
		if (!func_406(&(uParam0->f_182), 2))
		{
			...
			else
			{
				...
				{
					bVar4 = func_413(Global_35, &(uParam0->f_182.f_6), uParam0->f_182.f_5, 0, 0, 1084227584 /* Float: 5f */, 100, 0, 0);
				}
				if (bVar4)
				{
...
void func_291()
{
	if (!func_116(&Local_274, 32768))
	{
		...
		{
			if (func_301(&(uLocal_15[3]), Global_35, "ARRIVAL_ENTER_TRAP", -1082130432 /* Float: -1f */, 1, 1744022339))
			{
...
int func_294(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_306(var uParam0, int iParam1, int iParam2, char[4] cParam3, int iParam4)
{
	if (func_425(iParam2, &(uParam0->f_63[iParam1]), cParam3, iParam4, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
bool func_321(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_430(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
int func_333(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
int func_382(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_453(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
void func_390(int iParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (ANIMSCENE::_0x477122B8D05E7968(&(iParam0->f_63[iParam1]), 1, 0))
	{
		return;
	}
...
void func_392(int iParam0, int iParam1, var uParam2)
{
	func_454(&(iParam0->f_63[iParam1]), uParam2, func_404(iParam0, iParam1));
}

int func_393(int iParam0, int iParam1, var uParam2)
{
	if (func_455(&(iParam0->f_63[iParam1]), uParam2, func_404(iParam0, iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_400(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_462(bParam0, &Var0, iVar5, 0))
			{
				if (func_463(bParam0, &Var6, iVar5))
				{
					Var29 = { func_464(bParam0, Var0, iVar5, 0) };
					func_465(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_466(0))
				{
					...
					func_467(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
					func_468(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
void func_401(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
int func_413(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_374(*uParam1, 2))
	{
		...
		else if ((func_186(iParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_0x4C8B59171957BCF7(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_0xD806CD2A4F2C2996(PED::_0x4C8B59171957BCF7(iParam0))))
		{
	...
	{
		if (!func_186(iParam2, 2) && PLAYER::_0xB16223CB7DA965F0(PLAYER::GET_PLAYER_INDEX()))
		{
	...
	if (bVar3)
	{
		...
		PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_HORSE_SPRINT"), false);
		if (((TASK::IS_PED_SPRINTING(iVar2) || (TASK::IS_PED_RUNNING(iVar2) && func_186(iParam2, 1024))) || func_186(iParam2, 8)) && !func_374(*uParam1, 5632))
		{
			TASK::TASK_HORSE_ACTION(iVar2, 1, 0, 0);
			func_472(uParam1, 32);
		}
		else if ((TASK::IS_PED_RUNNING(iVar2) && func_186(iParam2, 4096)) && !func_374(*uParam1, 5632))
		{
			TASK::TASK_HORSE_ACTION(iVar2, 8, 0, 0);
			func_472(uParam1, 2048);
			func_472(uParam1, 4096);
		}
		else if (((TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(iVar2) <= 1.5f && TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(iVar2) >= 1.001f) && func_186(iParam2, 32)) && !func_374(*uParam1, 5632))
		{
...
int func_416(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_481(iParam2, 1065353216 /* Float: 1f */))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
int func_425(int iParam0, var uParam1, char* sParam2, int iParam3, float fParam4, bool bParam5, int iParam6)
{
	if (func_512(iParam0, uParam1, sParam2, iParam3, fParam4, bParam5, iParam6 == 0))
	{
		return 1;
	}
	return 0;
...
void func_435(var uParam0, int iParam1, int iParam2)
{
	...
	{
		uVar6 = 1;
		iVar8 = func_513(&uVar1, &uVar6, 4, ENTITY::GET_ENTITY_COORDS(uParam0[iParam1], true, false), 10f, 0, 1, 1, -1061153684, 1, 0, -1082130432 /* Float: -1f */, 0, 0);
		iVar9 = 0;
		while (iVar9 < iVar8)
		{
	...
	if (func_61(iVar0, 0, 1))
	{
		TASK::TASK_MOUNT_ANIMAL(0, iVar0, -1, -1, 1073741824, 1, 0, 0);
	}
	TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
	...
	{
		func_308(uParam0[iParam1], uParam0->f_22[iParam1], joaat("BLIP_STYLE_ENEMY"), 580546400, 0, 0);
	}
}
...
void func_454(var uParam0, var uParam1, char* sParam2)
{
	if (!ANIMSCENE::_0x25557E324489393C(uParam0))
	{
		return;
	}
	if (ANIMSCENE::_0x0DF57F86FE71DBE5(uParam0, uParam1) || ANIMSCENE::_0x23E33CB9F4A3F547(uParam0, uParam1))
	{
		return;
	}
	ANIMSCENE::_0xDF7B5144E25CD3FE(uParam0, uParam1);
}

int func_455(var uParam0, var uParam1, char* sParam2)
{
	if (!ANIMSCENE::_0x25557E324489393C(uParam0))
	{
		return 0;
	}
	return ANIMSCENE::_0x23E33CB9F4A3F547(uParam0, uParam1);
}
...
struct<5> func_460(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_524(bParam0))
	{
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_526(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_462(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_462(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_463(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_462(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_531(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_463(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_532(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_464(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	if (!func_533(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_534(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_465(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_468(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_415(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_542(1) || *iParam0 & 8192 != 0))
				{
...
bool func_507(var uParam0, float fParam1, int iParam2)
{
	...
	return func_577(&iVar0, uParam0->f_209, fParam1, 0, 0, 1084227584 /* Float: 5f */, bVar6, iParam2);
}
...
var func_510(int iParam0, var uParam1)
{
...
int func_512(int iParam0, var uParam1, char* sParam2, int iParam3, float fParam4, bool bParam5, bool bParam6)
{
...
int func_513(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	int iVar0;
	var uVar1;
	...
	uVar1 = func_587(uParam0, iParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_588(iVar0);
	return uVar1;
}
...
{
	return func_464(joaat("character"), func_603(), -1591664384, bParam0);
}
...
{
	if (func_528(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_604(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_530(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_531(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_532(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_534(0);
	*uParam1 = { func_464(bParam0, func_525(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_553(int iParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_562(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_563(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_564(int iParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_577(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, int iParam9)
{
	...
	{
		iVar12 = func_618(&iVar0, iParam0, iVar0, vParam1, iParam4);
	}
	iVar13 = 0;
	while (iVar13 < iVar12)
	{
...
int func_587(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11)
{
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_623(iVar2, bParam4, bParam6, bParam8, bParam9, bParam10) && !DECORATOR::DECOR_EXIST_ON(iVar2, "bIgnoreThisPed"))
				{
					if (!func_364(iVar2, iParam1))
					{
						bVar3 = false;
...
void func_592(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_627(func_626(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_628())
	{
...
int func_618(int iParam0, int iParam1, int iParam2, vector3 vParam3, int iParam6)
{
	int iVar0;
	int iVar1;

	iVar0 = VOLUME::_0xB3FB80A32BAE3065(vParam3, 0f, 0f, 0f, iParam6, iParam6, iParam6);
	iVar1 = func_617(iParam0, iParam1, iVar0, iParam2);
	func_588(iVar0);
	return iVar1;
}
...
int func_623(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam3 && ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return 0;
...
int func_640(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_643(iParam1, &iVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_644(iParam0, iVar0, iVar1, bParam2);
}
...
int func_643(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
