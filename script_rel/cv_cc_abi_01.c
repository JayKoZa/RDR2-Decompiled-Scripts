...
bool func_89(var uParam0)
{
	...
	func_161(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	iLocal_16 = func_163(uParam0, "script@vignette@abigail_1@action", 0, 0, 1, 0);
	func_164(uParam0, "CCABAUD");
	func_165(uParam0, joaat("COMP_ABICNV1"), joaat("PLAYER_ABICNV1"));
	func_166(uParam0, iLocal_16, -1, 0.8f);
	func_167(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_168(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	func_169(uParam0, iLocal_14, 1, -1);
	func_167(uParam0, iLocal_15, 1, joaat("WORLD_HUMAN_STARE_STOIC"), 0, -1, 0, 90f, 1065353216 /* Float: 1f */, 1);
...
int func_258(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_325(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_328(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_335(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_366(iParam1))
		{
			func_367(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_392(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_118(iParam0))
	{
		return false;
...
void func_394(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_140(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_140(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_140(iParam5, 32), true);
...
bool func_395(int iParam0, int iParam1)
{
	...
	bVar0 = func_438(iParam0, iParam1);
	return bVar0;
}
...
bool func_413(int iParam0, char* sParam1)
{
...
bool func_415(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_444(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_462(iVar0))
		{
	...
	{
		func_464(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_465(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_473(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_477(0))
				{
					...
					func_478(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_471(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_483(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_475(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_485(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_473(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_473(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_474(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_475(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_473(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_490(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_474(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_475(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_476(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_479(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_496(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_484(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_475(923904168, func_482(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_475(923904168, func_482(bParam0), -740156546, 0) };
		}
...
struct<4> func_486(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_475(271701509, func_482(bParam0), 12999093, 0) };
		}
...
bool func_489(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_491(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
