...
int func_74(var uParam0)
{
	...
	func_161(uParam0, iLocal_15, 2, 458213947, "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_88(var uParam0)
{
	...
	INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_44, "bee_01_house_chair", 1);
	return 1;
}
...
int func_340(int iParam0, bool bParam1)
{
	...
	{
		func_239(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_134(iParam0)));
		if (func_227() == -1)
		{
