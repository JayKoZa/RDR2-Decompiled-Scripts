...
int func_85(int iParam0, bool bParam1)
{
	...
	if (func_123(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_87(iParam0));
				func_127(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_87(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_87(iParam0)))
	{
		func_127(iParam0, 128);
		return 1;
	}
	func_126(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_125(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_87(iParam0));
	if (func_123(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_87(iParam0));
		func_127(iParam0, 2048);
...
bool func_86(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_87(iParam0));
}
...
char* func_92(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	char* sVar0;
...
int func_124(int iParam0, bool bParam1)
{
	...
	func_157(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_87(iParam0));
	func_126(iParam0, 0);
	return 1;
}
