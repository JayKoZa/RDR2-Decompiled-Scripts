...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_78 = func_1(joaat("HORSE_CLASS_RIDING"), 1);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
	...
	switch (uParam0->f_464)
	{
		case 0:
			...
			if (bVar0)
			{
				...
				if (fVar2 > 0f)
				{
					uParam0->f_496 = func_14(uParam0->f_483, fVar2, "AMB_VIG", 1, 0, 8, 0, -1082130432 /* Float: -1f */);
				}
...
{
	func_34(uParam0, 11122, 11267, 12271);
}
...
int func_9(bool bParam0, int iParam1, bool bParam2, bool bParam3, float fParam4)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	{
		bVar3 = func_36(bParam0);
		bVar3 = (bVar3 * bVar3);
		bVar4 = func_37(bParam0);
		bVar4 = (bVar4 * bVar4);
		iVar0 = Global_1415419.f_19[bParam0 /*12*/].f_8;
		while (iVar0 <= Global_1415419.f_19[bParam0 /*12*/].f_9)
		{
			*iParam1++;
			if (!func_38(bParam0, Global_1415419.f_2996[iVar0 /*7*/]))
			{
			}
			else
			{
				...
				{
					iVar5 = func_39(Global_35, Global_1415419.f_2996[iVar0 /*7*/], 1060437492 /* Float: 0.707f */);
					if (iVar5 == 1)
					{
					}
					else if (fVar6 < fVar2)
					{
						if (func_40(Global_1415419.f_2996[iVar0 /*7*/], fVar6, (bParam0 <= 33 || bParam0 == 72), fParam4, bVar3, bVar4, bParam0))
						{
							iVar1 = iVar0;
							fVar2 = fVar6;
							if (bParam3)
...
void func_11(int iParam0, vector3 vParam1, int iParam4)
{
	...
	func_42(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, 1, 0, 0, 0, 0);
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar2 = func_1(joaat("HORSE_CLASS_WORK"), 1);
	if (*uParam0 == 52)
	{
		if (func_49())
		{
		...
		func_52(uParam0, 0, "RWP_HORSE", iLocal_78, vParam1, fVar1, iVar0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		func_52(uParam0, 2, "RWP_HORSE_2", iVar2, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, fVar1, 0f, -4.5f, 0f), fVar1, iVar0, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
	else
	{
		if (uParam0->f_489 == 1)
	...
	func_52(uParam0, 1, "RWP_MAN", iLocal_77, vParam1, fVar1, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_32(var uParam0)
{
	if (*uParam0 == 52)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]) && !ENTITY::IS_ENTITY_DEAD(uParam0->f_20[2 /*14*/]))
		{
			...
			if (!bLocal_110)
			{
				if (PED::_IS_PED_LASSOED(uParam0->f_20[2 /*14*/]))
				{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				func_76(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 2, 1073741824 /* Float: 2f */);
			...
			break;
		case 1:
			if (func_81(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_74(uParam0);
				iLocal_9 = 2;
			}
...
bool func_38(bool bParam0, vector3 vParam1)
{
	switch (bParam0)
	{
		case 58:
...
bool func_40(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if (Global_1415419.f_19[iVar0 /*12*/].f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_41() > Global_32074.f_2697.f_6[iVar0 /*6*/].f_5)
					{
						Global_32074.f_2697.f_6[iVar0 /*6*/].f_5 = func_41();
					}
					func_42(&(Global_32074.f_2697.f_6[iVar0 /*6*/].f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
...
bool func_73(var uParam0, var uParam1, bool bParam2)
{
...
void func_76(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_126(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_126(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_126(iParam5, 32), true);
...
void func_78(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
...
void func_80(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, bool bParam8, int iParam9, int iParam10, float fParam11, float fParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> Var0;
	...
	{
		TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(iParam0, iParam1, iParam4, iParam5, iParam6, fParam7, iParam9, iParam10, fParam11, fParam12, iParam13);
	}
	if (bParam19)
	{
		PED::_SET_PED_CROUCH_MOVEMENT(iParam0, false, 0, false);
...
bool func_81(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_88(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_89(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_105(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_144(iParam1))
		{
			func_145(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_119(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_121(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	func_42(&(Global_32074.f_2697.f_6[iParam0 /*6*/].f_5), 0, 0, Global_1415419.f_19[iParam0 /*12*/].f_7, 0, 0, 0, 0);
	if (bParam4)
	{
		if (iParam0 <= 74)
		{
...
void func_187(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_241(iVar0, 0)))
		{
...
void func_234(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_237(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_242(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_243(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
