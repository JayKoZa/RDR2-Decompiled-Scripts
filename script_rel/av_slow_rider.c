...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_78 = func_1(997958153 /* GXTEntry: "Riding" */, 1);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar2 = func_1(-311956671 /* GXTEntry: "Work" */, 1);
	if (*uParam0 == 52)
	{
		if (func_49())
		{
		...
		func_52(uParam0, 2, "RWP_HORSE_2", iVar2, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, fVar1, 0f, -4.5f, 0f), fVar1, iVar0, 1, 1, 1, 41788943, 1);
	}
	else
	{
		if (uParam0->f_489 == 1)
			...
			if (*uParam0 == 52)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
					{
						...
						PED::_UPDATE_PED_VARIATION(&(uParam0->f_20[2 /*14*/]), 0, 1, 1, 1, 0);
					}
...
int func_38(bool bParam0, vector3 vParam1)
{
	switch (bParam0)
	{
		case 58:
...
int func_40(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
...
void func_52(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_73(var uParam0, var uParam1, bool bParam2)
{
...
void func_76(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_126(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_126(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_126(iParam5, 32), 1);
...
void func_187(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_134((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_245(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
