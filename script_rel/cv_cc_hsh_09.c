...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.8728f, 0.6017f, 0.5052f, 34.7662f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -0.254f, -0.9561f, 0.6086f, -27.0658f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, -1.06f, -0.34f, 1.0005f, 0f, 0.6f, 0.8f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_360(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_395(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_389(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_447(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_467(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_468(iParam0, &iVar0, &fVar25);
...
bool func_476(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_493(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
bool func_479(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_482(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_499(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_487(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_478(923904168, func_485(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_478(923904168, func_485(bParam0), -740156546, 0) };
		}
...
struct<4> func_489(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_478(271701509, func_485(bParam0), 12999093, 0) };
		}
...
bool func_492(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_494(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
