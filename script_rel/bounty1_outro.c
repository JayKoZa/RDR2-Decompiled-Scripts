...
int func_82(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_81(iParam0)))
	{
		return 1;
	}
	...
	func_77(iParam0, 129);
	func_78(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_81(iParam0));
	func_122(iParam0, 0);
	return 1;
}
...
int func_94(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_41(iVar0, 0))
	{
		if (func_41(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_91(iParam0)) || func_92(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_126(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_128(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_129(iParam0, 0));
...
int func_98(int iParam0)
{
	...
	{
		if (!NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(PERSCHAR::_0x31C70A716CAE1FEE(func_81(iParam0))))
		{
			return 1;
		}
	}
	iVar0 = PERSCHAR::_0x31C70A716CAE1FEE(func_81(iParam0));
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (!ENTITY::_0x88AD6CC10D8D35B2(iVar0))
		{
	...
	PERSCHAR::_0x7B204F88F6C3D287(func_81(iParam0));
	return 1;
}
...
int func_117(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	vector3 vVar0[24];
	int iVar3;
	...
	iParam3 = iParam3;
	iParam4 = iParam4;
	if (!ENTITY::IS_ENTITY_DEAD(iParam2) && (func_149(iParam2, iParam3, 1, 1) < 70f || bParam5))
	{
...
int func_136(int iParam0, bool bParam1)
{
	...
	if (func_54(iParam0, 32) && !bParam1)
	{
		...
		if (func_95() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_81(iParam0));
...
int func_137(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (bParam5)
	{
		iVar3 = PERSCHAR::_0x08FC896D2CB31FCC(func_81(iParam0), 0);
	}
	else
	{
		iVar3 = PERSCHAR::_0x0CADC3A977997472(func_81(iParam0), 0);
	}
	if (!func_162(vVar0))
	{
...
bool func_160(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_81(iParam0));
}
...
int func_161(int iParam0)
{
	...
	{
		PERSCHAR::_0x49A8C2CD97815215(func_81(iParam0));
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_0x0CADC3A977997472(func_81(iParam0), 0)))
		{
			return 0;
		}
	}
