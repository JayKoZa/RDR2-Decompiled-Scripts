...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 43:
			iVar0 = func_49(997958153 /* GXTEntry: "Riding" */, 1);
			func_50(uParam0, 1, "FRP_HORSE", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -5f, -2f, 0f), (35f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			if (uParam0->f_489 == 1)
			{
				iLocal_11 = -1283346351;
			}
			else
			{
				iLocal_11 = 197929875;
		...
		case 44:
			...
			func_50(uParam0, 1, "FRP_DOG", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, -1.35f, 0f), (-18f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
	}
	func_50(uParam0, 0, "FRP_FISHERMAN", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	if ((uParam0->f_20[0 /*14*/])->f_8 < 0f)
	{
		(uParam0->f_20[0 /*14*/])->f_8 = ((uParam0->f_20[0 /*14*/])->f_8 + 360f);
	}
	func_50(uParam0, 2, "FRP_FISH", joaat("a_c_fishbluegil_01_sm"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 33f, -0.5f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
		...
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (*uParam0 == 43)
				{
					...
					TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[1 /*14*/]), iLocal_11, 0, 0, 0, -1082130432, 0);
				}
				if (*uParam0 == 44)
				{
					PED::_0xB8B6430EAD2D2437(&(uParam0->f_20[1 /*14*/]), joaat("guard_dog"));
					PED::_0x24C82EF607105FAA(&(uParam0->f_20[1 /*14*/]), -1909898637);
...
int func_37(bool bParam0, vector3 vParam1)
{
	switch (bParam0)
	{
		case 58:
...
int func_39(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
...
int func_66(var uParam0, var uParam1, bool bParam2)
{
...
void func_74(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_119(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_119(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_119(iParam5, 32), 1);
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
				{
					if (ENTITY::DOES_ENTITY_EXIST(Local_42.f_12))
					{
						if (func_76(Local_42.f_12, &(uParam0->f_20[2 /*14*/]), 1, 1) < 1f)
						{
							...
							TASK::CLEAR_PED_TASKS_IMMEDIATELY(&(uParam0->f_20[2 /*14*/]), 0, 1);
...
int func_80(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_81(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_86(vector3 vParam0, float fParam3)
{
	int iVar0;
...
int func_87(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_110(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_112(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_76(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_209(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_211(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_218(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_219(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_220(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_224(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_230(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
int func_247(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
