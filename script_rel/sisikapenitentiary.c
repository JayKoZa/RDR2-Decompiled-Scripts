	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_28)
		{
			...
			switch (iLocal_27)
			{
				...
				case 1:
					func_5(iLocal_29);
					if (func_7(func_6(iLocal_29)))
					{
						func_8(func_6(iLocal_29), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_29));
					iVar1 = func_10(iLocal_29);
					if (iVar1 != -1)
					{
				...
				case 2:
					...
					break;
				case 3:
					if (func_13(iLocal_29) || iLocal_30 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_29);
						iLocal_30 = (MISC::GET_GAME_TIMER() + iLocal_26);
						iLocal_27 = 4;
				...
				case 6:
					if (func_7(func_6(iLocal_29)))
					{
						if (func_17(func_6(iLocal_29), 4) && !iLocal_30 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_29) || iLocal_30 < MISC::GET_GAME_TIMER())
							{
								func_19(iLocal_29, 4);
								iLocal_30 = (iLocal_26 + MISC::GET_GAME_TIMER());
								iLocal_27 = 7;
							...
							Jump @791; //curOff = 459
							if (iLocal_30 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_29);
								func_22();
								if (!func_23(2057, 0))
							...
							func_39(Global_1898004, iLocal_29);
							func_40(iLocal_29);
							func_19(iLocal_29, 8);
							if (func_41())
							{
...
int func_11()
{
	...
	uLocal_16 = ((*Global_1888801)[32 /*35*/])->f_4;
...
void func_54()
{
	...
	{
		bLocal_25 = true;
		LAW::_0x75CBF20BA47E4F89(Global_36, -306254848);
	}
}
...
bool func_61(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_96(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (!func_99(iParam4))
	{
		if (func_52(iParam0))
		{
			iParam4 = func_100(func_6(iParam0));
		}
		else
		{
	...
	Global_1934266->f_148 = func_111(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_66(int iParam0, bool bParam1)
{
	...
	func_116(func_115(-1532769513, joaat("areas")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_116(func_115(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_116(func_115(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_116(func_115(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_116(func_115(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_116(func_115(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_116(func_115(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_67()
{
	return (Global_1894899 & 1 != 0 && func_117() != -1);
}
...
void func_69(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_118(iVar1) && !func_121(iVar1, iParam2)) && (!bParam3 || !func_122(iVar1))) && (!bParam4 || !func_123(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_124(iVar0);
...
void func_79(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_129(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
{
	func_139(iParam0, 1, 0, 0, 0, 0, 0, 0);
}

int func_96(int iParam0)
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_140())
	{
		return 1;
	}
	if (iParam0 == 61)
...
char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_142(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_144(func_143(Global_36));
	}
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_147(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_113(int iParam0)
{
	...
	if (func_148())
	{
		if (!func_149(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_153((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_154((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_127(int iParam0)
{
	...
	{
		func_157((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_158((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_129(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
void func_139(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_163(iParam0))
	{
		...
		if (bParam3)
		{
			func_168(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
var func_142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_168(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_163(iParam0))
	{
