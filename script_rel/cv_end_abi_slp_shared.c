...
struct<4> func_571(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_587(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
void func_575(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_590(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_571(joaat("CHARACTER"), func_591(), -1591664384, bParam0);
}
...
bool func_584(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_587(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
