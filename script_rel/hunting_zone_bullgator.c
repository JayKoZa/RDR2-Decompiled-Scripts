...
int func_99(var uParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
var func_182(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	var uVar0;
...
int func_231(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_139(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
struct<5> func_246(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_244(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_135(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_135(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
