...
{
	func_33(uParam0, 10800, 10851, 11489);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2] && !uParam0->f_469[3])
		{
			if (!uParam0->f_469[5])
			{
				if (func_67(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_65(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[5] = 1;
				}
...
bool func_66(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_67(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_73(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_114(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_87(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_124(iParam1))
		{
			func_125(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_96(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_136(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_99(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_114(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_135(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
bool func_139(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_157(int iParam0, var uParam1)
{
	...
	{
		return func_210(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_159(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_179(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_199(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_184(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_191(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_195(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_199(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_200(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_206(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
