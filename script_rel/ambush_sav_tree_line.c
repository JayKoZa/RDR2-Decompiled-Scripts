...
void func_163()
{
	if (!func_320(&Local_274, 0, 2))
	{
		...
		{
			if (PED::_IS_PED_HOGTIED(&(uLocal_15[0])))
			{
	...
	if (!func_320(&Local_274, 1, 2))
	{
		...
		{
			if (PED::_IS_PED_HOGTIED(&(uLocal_15[1])))
			{
...
int func_285(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_377(*uParam1, 2))
	{
		...
		else if ((func_182(iParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_LAST_MOUNT(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(PED::_GET_LAST_MOUNT(iParam0))))
		{
...
void func_394(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	...
	if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(&(uParam0->f_43[iParam1]), 1, 0))
	{
		return;
	}
		...
		while (iVar28 < 4)
		{
			...
			if (func_464(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_468(0))
				{
					...
					func_469(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_470(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_419(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
