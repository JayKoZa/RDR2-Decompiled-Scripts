...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "MJFP_MAN", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		...
		case 2:
			if (!uParam0->f_469[2])
			{
				if (func_67(uParam0, 0.1f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
				{
					func_64(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
...
bool func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
