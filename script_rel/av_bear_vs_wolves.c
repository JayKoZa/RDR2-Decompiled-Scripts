...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "WOLF1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "WOLF2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 2, "WOLF3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 3, "BEAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 4, "carcass", joaat("a_c_deer_01"), vParam1, vParam4.z, 1, 0, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	...
	if (!STREAMING::_0x9427C94D2E4094A4(2075717199, 0))
	{
		return 0;
	}
...
int func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[4 /*14*/])))
	{
		...
		PED::_0xCE6B874286D640BB(&(uParam0->f_20[4 /*14*/]), 0);
		TASK::TASK_PLAY_ANIM(&(uParam0->f_20[4 /*14*/]), sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
		MISC::_0x674B90BE1115846D(&(uParam0->f_20[4 /*14*/]), 1);
		_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[4 /*14*/]), iLocal_45);
...
int func_30(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(2075717199, 1, joaat("a_c_bear_01"), 0);
	func_58(&uLocal_11, 0);
	func_59(&uLocal_11, 1);
	func_60(&uLocal_11, 1);
	func_61(&uLocal_11, 1);
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							if (!&uParam0->f_469[3])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), -1795669989))
									{
										...
										TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[3 /*14*/]), 2, 256, -1082130432, -1, 0);
							...
							if (!&uParam0->f_469[4])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), 811542464))
									{
										...
										{
											TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[3 /*14*/]), 3, 256, -1082130432, -1, 0);
										}
							...
							if (!&uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[2 /*14*/])->f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[2 /*14*/]), 811542464))
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[3 /*14*/])))
										{
											TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[2 /*14*/]), &(uParam0->f_20[3 /*14*/]), 3, 256, -1082130432, -1, 0);
										}
							...
							if (!&uParam0->f_469[6])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[3 /*14*/]), 2075717199, 30000, 0, 0, 0.25f, 0);
							...
							if ((((uParam0->f_469[3] && uParam0->f_469[4]) // PointerArith && uParam0->f_469[5]) // PointerArith && uParam0->f_469[6]) // PointerArith)
							{
								uParam0->f_469[7] = 1;
								return 1;
							}
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_125((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
