...
{
	func_33(uParam0, 11241, 11330, 12637);
}
...
{
	func_46(uParam0, "BEAR_VS_WOLVES", "script@ambient@animal@bear_vs_wolves@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	...
	func_48(uParam0, 4, "carcass", joaat("A_C_DEER_01"), vParam1, vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
bool func_28(var uParam0)
{
	...
	PED::_0xF7EA250B9A919E03(-1918659017, uParam0->f_20[2 /*14*/]);
	if ((!PED::_0x854BC9B1A1CCD034(-1918659017, uParam0->f_20[0 /*14*/]) || !PED::_0x854BC9B1A1CCD034(-1918659017, uParam0->f_20[1 /*14*/])) || !PED::_0x854BC9B1A1CCD034(-1918659017, uParam0->f_20[2 /*14*/]))
	{
		return false;
	}
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[4 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[4 /*14*/], sLocal_39, sLocal_40, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
		MISC::_0x674B90BE1115846D(uParam0->f_20[4 /*14*/], 1);
	...
	while (iVar0 <= 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			PLAYER::_0xA3DB37EDF9A74635(PLAYER::GET_PLAYER_INDEX(), uParam0->f_20[iVar0 /*14*/], 26, 0, 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_41 == 1)
		{
			if (func_67(uParam0, &uLocal_11, 1) || func_68(Global_35, uParam0->f_483, 1) <= 625f)
			{
				bLocal_41 = true;
			}
		}
	...
	if (!uParam0->f_469[0] && !bLocal_41)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[8])
			{
				if (func_77(uParam0, 1.5f, 80f, 4, joaat("ACTION"), 1))
				{
					func_71(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[8] = 1;
				}
				...
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							while (iVar0 <= 2)
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[iVar0 /*14*/], 1935919182))
								{
									TASK::_0x2E1D6D87346BB7D2(uParam0->f_20[iVar0 /*14*/], uParam0->f_20[3 /*14*/], 0, 0);
								}
								iVar0++;
							}
							if (!uParam0->f_469[3])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINWALK")))
									{
										...
										TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], uParam0->f_20[3 /*14*/], 2, 256, -1082130432 /* Float: -1f */, -1, 0);
							...
							if (!uParam0->f_469[4])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[1 /*14*/], joaat("ENDSINRUN")))
									{
										...
										{
											TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[3 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
										}
							...
							if (!uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[2 /*14*/].f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[2 /*14*/], joaat("ENDSINRUN")))
									{
										...
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
										{
											TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[2 /*14*/], uParam0->f_20[3 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
										}
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(uParam0->f_20[2 /*14*/], 2f);
										func_57(&(uParam0->f_20[2 /*14*/]), 0, 1);
							...
							if (!uParam0->f_469[6])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[3 /*14*/].f_1))
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_20[3 /*14*/], joaat("WORLD_ANIMAL_BEAR_EAT_CARCASS"), 30000, false, 0, 0.25f, false);
									PED::_0x2208438012482A1A(uParam0->f_20[3 /*14*/], false, false);
...
bool func_67(var uParam0, var uParam1, bool bParam2)
{
...
float func_68(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
void func_73(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			if (!func_112(uParam0->f_20[iVar0 /*14*/], 518218985))
			{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[3 /*14*/]))
	{
		if (!func_112(uParam0->f_20[3 /*14*/], 780511057))
		{
...
void func_75(var uParam0)
{
	...
	while (iVar0 <= 2)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
		{
			func_57(&(uParam0->f_20[iVar0 /*14*/]), 0, 1);
		}
		iVar0++;
	}
}
...
bool func_76(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_117(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
			{
				...
				fVar8 = func_118(Global_35, uParam0->f_20[iVar0 /*14*/], 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_77(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_118(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_0x5102307CE88798EB(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_69(&(uParam0->f_490)))
							{
...
bool func_82(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_83(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_125(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_125(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
void func_98(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_135(iParam1))
		{
			func_136(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_106(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_147(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_125(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_144(int iParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_145(int iParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_146(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
int func_168(int iParam0, var uParam1)
{
	...
	{
		return func_217(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
bool func_183(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_206(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_191(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_198(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_202(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_206(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_207(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
