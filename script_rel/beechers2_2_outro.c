...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::_0x477122B8D05E7968(&(iLocal_4[0]), 1, 0))
	{
		iVar0 = 0;
	}
	if (!HUD::_0xD0976CC34002DB57(func_21()))
	{
		iVar0 = 0;
	}
	return iVar0;
...
void func_19(var uParam0)
{
	...
	HUD::_0xF66090013DE648D5(func_21());
}
...
int func_24(var uParam0)
{
	...
	switch (iLocal_3)
	{
		...
		case 1:
			if (PED::_0x5C16855277819BBF() >= PED::_0x62DE46F061CAA468())
			{
				if (STREAMING::HAS_MODEL_LOADED(iLocal_112))
				{
					...
					{
						iLocal_111 = func_50(joaat("a_c_bluejay_01"), -1648.3f, -1387f, 83.1f, -150f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			if (ANIMSCENE::_0x477122B8D05E7968(&(iLocal_4[1]), 1, 0) && ENTITY::DOES_ENTITY_EXIST(iLocal_111))
			{
		...
		case 3:
			...
			if (ANIMSCENE::_0xCDC5512A407CF08D(&(iLocal_4[0])))
			{
		...
		case 4:
			...
			if ((ANIMSCENE::_0x005E6F28DD7ED58D(&(iLocal_4[1]), "player") || ANIMSCENE::_0xF94692EB9DC15D74(&(iLocal_4[1]), 0)) || ANIMSCENE::_0xD8254CB2C586412B(&(iLocal_4[1]), 0))
			{
				if (iLocal_113 == 2)
				{
					iLocal_113 = 3;
...
void func_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_63(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_65(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_49()
{
	...
	if (!bLocal_110)
	{
		...
		if (iVar1 == 2)
		{
			ENTITY::_0x203BEFFDBE12E96A(iVar0, -1643.34f, -1377.769f, 84.0527f, -26.81f, 1, 0, 1);
		...
		if ((bParam1 || !func_67(iParam0)) || func_68(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_80(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_82(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_83(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_83(iParam0, 0));
					func_84(iParam0);
				}
			}
			else
...
int func_186(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	struct<12> Var0;
	struct<4> Var14;
	...
	if (!INVENTORY::_0xDCCAA7C3BFD88862(func_231(0), &Param0, &Param4, iParam8, Var0.f_11, &Var14))
	{
		return 0;
	}
	if (bParam9)
...
int func_187(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	var uVar28;
	...
	uVar28 = func_231(0);
	if (!INVENTORY::_0xF2753D691BCDA314(uVar28, &Param0, &Param4))
	{
		return 0;
	}
	if (!INVENTORY::_0x734311E2852760D0(uVar28, &Param0, (Var14.f_10 || iParam8)))
	{
	}
	if (!INVENTORY::_0x734311E2852760D0(uVar28, &Param4, (Var0.f_10 || iParam8)))
	{
	}
	return 1;
}
...
struct<4> func_221(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_231(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

int func_222(struct<4> Param0, int iParam4)
{
	struct<11> Var0;
	...
	if (!INVENTORY::_0x734311E2852760D0(func_231(0), &Param0, iParam4))
	{
		return 0;
	}
	return 1;
...
{
	return func_221(joaat("character"), func_253(), -1591664384, iParam0);
}

int func_225(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	var uVar0;

	uVar0 = func_231(bParam7);
	if (INVENTORY::_0x033EE4B89F3AC545(uVar0, &uParam0, iParam4) <= iParam6)
	{
		return 0;
	}
	if (!INVENTORY::_0xBE012571B25F5ACA(uVar0, &uParam0, iParam4, iParam6, uParam5))
	{
		return 0;
	}
	return 1;
...
int func_226(var uParam0, var uParam1)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_231(0), uParam0, uParam1, 29, 1))
	{
		return 0;
	}
	return 1;
...
int func_227(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_231(bParam0));
}
...
int func_229(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_231(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
void func_234(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_259(func_258(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_193())
	{
...
float func_239(int iParam0)
{
	...
	fVar10 = (fVar8 - fVar7);
	fVar11 = (fVar9 / fVar10);
	uVar12 = func_261(fVar3, fVar4, fVar11);
	return uVar12;
}
...
int func_248(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
	...
	if (!INVENTORY::_0x22E590F108289A9D(func_231(bParam6), &uParam0, iParam4, &Var0))
	{
		return 0;
	}
...
int func_251(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("horse"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_264(joaat("update"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("clothing"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_266(joaat("update"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_255(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_256(joaat("update"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return INVENTORY::_0x033EE4B89F3AC545(func_231(bParam2), uParam0, iParam1);
}
...
int func_254(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_231(bParam6), &Var0, 0);
	return uVar4;
}
...
char* func_259(char* sParam0, int iParam1)
{
	...
	return func_269(MISC::_CREATE_VAR_STRING(10, "PLAYER_STRING", sParam0), iParam1);
}
...
struct<28> func_263(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_231(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var28) };
...
struct<17> func_265(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_231(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_255(&Var17) };
...
int func_268(int iParam0, int iParam1)
{
	...
	{
		return func_270(&(((*Global_1108178)[iParam1 /*37*/])->f_4), iVar0, 5);
	}
	return 0;
}
