...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, -0.4f, 0f, -14.04f, 1f, 1f, 5f, -1612834106, -1495061186, 1, 1, 1);
	func_151(uParam0, -0.2f, -1.35f, 0f, -11.88f, 1f, 1f, 5f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, -1.96f, 3.59f, 0f, -11.88f, 1.4f, 1.2f, 5f, -1612834106, -2055224817, 1, 1, 1);
	...
	if (!func_154(14))
	{
		func_155(uParam0, "script@vignette@john_1@base", 1, 1, 0, 0);
	}
	iLocal_21 = func_155(uParam0, "script@vignette@john_1@action_a", 2, 0, 1, 0);
	iLocal_22 = func_155(uParam0, "script@vignette@john_1@action_b", 2, 0, 0, 0);
	iLocal_23 = func_155(uParam0, "script@vignette@john_1@action_b_alt", 2, 0, 0, 1);
	iLocal_24 = func_155(uParam0, "script@vignette@john_1@action_c", 2, 0, 0, 0);
	iLocal_25 = func_155(uParam0, "script@vignette@john_1@action_d", 2, 0, 0, 0);
	iLocal_26 = func_155(uParam0, "script@vignette@john_1@action_d_alt", 2, 0, 0, 1);
	iLocal_27 = func_155(uParam0, "script@vignette@john_1@exit", 0, 0, 0, 0);
	func_156(uParam0, "CJN1AUD");
	func_157(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	func_157(uParam0, iLocal_15, 1061142135 /* Float: 0.749f */);
	func_158(uParam0, iLocal_16, 2, 1, 0, 0, 0);
	Local_28 = { func_159(uParam0, -0.3877f, -1.1076f, 0.4898f, -97.2f, 9.5f, 0.5f, 0.78f) };
	if (func_154(14))
	{
		func_160(uParam0, iLocal_14, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", uLocal_18, 0);
		func_160(uParam0, iLocal_15, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", uLocal_17, 0);
...
int func_93(var uParam0)
{
	...
	{
		if (func_206(uParam0, Local_28, 1, 0))
		{
			func_197(uParam0, iLocal_23, 1);
		}
		else
		{
			func_197(uParam0, iLocal_22, 1);
		}
	}
	if (func_205(uParam0, iLocal_22) || func_205(uParam0, iLocal_23))
	{
		func_197(uParam0, iLocal_24, 1);
	}
	if (func_205(uParam0, iLocal_24))
	{
		if (func_207(Global_35, func_48(uParam0, iLocal_14), 0, 0) < 6f)
		{
			func_197(uParam0, iLocal_26, 1);
		}
		else
		{
			func_197(uParam0, iLocal_25, 1);
		}
	}
	if (func_205(uParam0, iLocal_25) || func_205(uParam0, iLocal_26))
	{
		func_208(uParam0, iLocal_14, 1, 1);
		func_208(uParam0, iLocal_16, 1, 1);
		func_197(uParam0, iLocal_27, 1);
	}
	return 1;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_218(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_220(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_221(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_221(iParam0, 0));
					func_222(iParam0);
				}
			}
			else
...
{
	func_259(uParam0, 663.2041f, -1266.61f, 42.8666f, 0f, 0f, 31.32f);
	uLocal_18 = func_153(uParam0, joaat("p_chair_crate15x"), 1.40122f, -0.443811f, -0.00283051f, "SEAT_JOHN", 1, 0, 1);
	uLocal_17 = func_153(uParam0, joaat("p_chair_crate02x"), -0.258479f, -1.47156f, 0.00315094f, "SEAT_BILL", 1, 0, 1);
	func_153(uParam0, -1870850622, -2.02149f, 4.18722f, -0.0580559f, "", 0, 0, 1);
}
...
void func_161(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
{
	func_263(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_219((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_197(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_300(uParam0, iVar1) || func_205(uParam0, iVar1))
			{
...
float func_207(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_208(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_311(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_258(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	uParam0->f_23 = { func_334(iParam1) + Vector(fParam4, fParam3, fParam2) };
	uParam0->f_26 = { func_335(iParam1) };
}

void func_259(var uParam0, vector3 vParam1, vector3 vParam4)
{
...
void func_263(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
int func_264(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_337(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_322()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_369(Global_35))
	{
		return 1;
	}
	return 0;
...
void func_336(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_312(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_337(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_338(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
	...
	iVar1 = func_375(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_343(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_359(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_398(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_375(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_120(iVar0, 0)) || (bParam3 && !func_51(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_402(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_381(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_251(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
...
int func_385(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_411(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_410(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_413(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_402(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_427(iParam0) && func_428(iParam0, &uVar4))
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_219(iParam0, 1), &uVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_430(iParam0, vVar0, iParam6, iParam10))
				{
					return func_429();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_216(vVar0)) && !func_217(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				if (ENTITY::IS_ENTITY_ATTACHED(((*Global_1360165)[iParam0 /*1157*/])->f_124))
				{
					ENTITY::DETACH_ENTITY(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, true);
				}
				func_413(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
			...
			sVar12 = func_433(iParam0, func_290());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_219(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
int func_411(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_445(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_413(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_234(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_234(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_234(iParam5, 32), 1);
...
int func_430(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_219(iParam0, 1));
...
int func_431(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_461(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(747937920, 1) && !func_405(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_457(int iParam0)
{
	...
	func_474(iParam0, 1073741824 /* Float: 2f */);
}
...
bool func_459(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_475(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_503(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_487(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_504(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_488(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_506(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
void func_492(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_509(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_488(joaat("character"), func_510(), -1591664384, bParam0);
}
...
{
	if (func_500(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_511(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_503(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_504(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_506(0);
	*uParam1 = { func_488(bParam0, func_497(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_505(bool bParam0, int iParam1)
{
	if (bParam0 == 0)
	{
		return 0;
