...
int func_73(var uParam0)
{
	...
	func_157(uParam0, iLocal_14, 2, -2118813809, 0, -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	STREAMING::_REQUEST_SCENARIO_TYPE(-2118813809, 1, 0, 0);
	Local_22 = { func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7f, 0.629f, 0.5f) };
	uLocal_32 = func_161(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", 665633627);
	return 1;
}
...
var func_161(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	var uVar0;
	vector3 vVar1;
