...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else
		{
			...
			if (VOLUME::_DOES_VOLUME_EXIST(iLocal_179) && func_8(Global_35, iLocal_179, 1, 0))
			{
			...
			{
				if (VOLUME::_DOES_VOLUME_EXIST(Global_1396257[27 /*638*/][1 /*48*/].f_47) && !ENTITY::IS_ENTITY_IN_VOLUME(Global_35, Global_1396257[27 /*638*/][1 /*48*/].f_47, true, 0))
				{
			...
			if (iLocal_22 == 28 || (((iLocal_22 >= 6 && iLocal_22 <= 27) && ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, false)) && ANIMSCENE::_0x8D81E7824B7753F7(iLocal_188, "s_base_end", 1)))
			{
				if (bLocal_279)
				{
					...
					{
						if ((VOLUME::_DOES_VOLUME_EXIST(iLocal_178) && !ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_178, true, 0)) && !ENTITY::IS_ENTITY_ON_SCREEN(uLocal_173[0]))
						{
							func_1(1, 1);
						}
					}
			...
			switch (iLocal_22)
			{
				...
				case 2:
					if (((func_61(&(uLocal_173[0]), iLocal_169, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_62(&iLocal_175, iLocal_171, 2644.251f, -1208.702f, 53.5354f)) && func_62(&iLocal_176, iLocal_171, 2643.541f, -1208.416f, 53.1764f)) && func_62(&iLocal_177, iLocal_170, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(uLocal_173[0], 0))
						{
							...
							func_64(&(uLocal_173[0]), &uLocal_15, joaat("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 3600f);
				...
				case 3:
					...
					else if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_188))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, false) && ENTITY::HAS_ANIM_EVENT_FIRED(uLocal_173[0], -1527527524))
						{
				...
				case 28:
					if (func_19(iLocal_190, 524288))
					{
						...
						else if (func_72(&uLocal_165) > 2f)
						{
							...
							if (!func_19(iLocal_190, 1048576))
							{
								...
								{
									if (func_74(uLocal_173[0], sVar2, -417894478, Global_35, 1, "TIMOTHY_DONAHUE", 0, 1))
									{
								...
								{
									if (func_74(uLocal_173[0], sVar2, -417894478, Global_35, 1, "TIMOTHY_DONAHUE", iVar3, 1))
									{
					...
					if (func_19(iLocal_190, 2) && !func_19(iLocal_190, 4))
					{
						if (func_19(iLocal_190, 16))
						{
							...
							func_77(1);
							if (func_80(uLocal_173[0], iLocal_189, func_78(), func_79(), 1, 1056964608 /* Float: 0.5f */, 20000) && func_19(iLocal_190, 131072))
							{
								if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_188))
								{
									if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, false))
				...
				case 31:
					...
					if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(Global_35))
					{
						...
						if (ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_189) >= 0.92f)
						{
				...
				case 32:
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_189))
					{
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_189, false))
						{
							PLAYER::_0xC67A4910425F11F1(PLAYER::GET_PLAYER_INDEX(), "TimothyBubble");
							func_81(iLocal_184);
				...
				case 33:
					...
					{
						func_109(uLocal_173[0], 1073741824 /* Float: 2f */);
						if (!func_19(iLocal_190, 128))
						{
							...
							{
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", 0, 1065353216 /* Float: 1f */, 1056964608 /* Float: 0.5f */, 1);
								func_21(&iLocal_190, 128);
							}
							else
							{
								TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(uLocal_173[0], 2.1f, 0, -1082130432 /* Float: -1f */, 0);
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", 1, 1065353216 /* Float: 1f */, 0.9f, 1);
							}
						}
						else
						{
							...
							{
								TASK::_TASK_SMART_FLEE_STYLE_PED(uLocal_173[0], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
...
{
	PLAYER::_0xC67A4910425F11F1(PLAYER::GET_PLAYER_INDEX(), "TimothyBubble");
	func_111(&(uLocal_173[0]), &uLocal_15, joaat("EVENT_SHOCKING_BEAT_INTERESTING_NEW"), 5f, 1);
	...
	if (PED::_0x91A5F9CBEBB9D936(uLocal_185))
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_185, false);
	}
	...
	{
		VOLUME::_DELETE_VOLUME(iLocal_183);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(Global_1396257[27 /*638*/][1 /*48*/].f_47))
	{
		VOLUME::_DELETE_VOLUME(Global_1396257[27 /*638*/][1 /*48*/].f_47);
	}
...
bool func_5(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		if ((!ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, false) && !ENTITY::_IS_ENTITY_FROZEN(uLocal_173[0])) && !bParam5)
		{
			ANIMSCENE::START_ANIM_SCENE(*iParam0);
		}
		if (bParam5 && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, false))
		{
			...
			if ((!ANIMSCENE::_0x1F0E401031E20146(*iParam0, sParam1) && ANIMSCENE::_0x23E33CB9F4A3F547(*iParam0, sParam1)) && !ENTITY::_IS_ENTITY_FROZEN(uLocal_173[0]))
			{
...
void func_30()
{
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_178))
	{
		iLocal_178 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(2644.527f, -1208.351f, 52.287f, 0f, 0f, 0f, 32f, 32f, 32f, "RandomEventBlock");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_180))
	{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_184))
	{
		iLocal_184 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
...
void func_66()
{
	...
	func_186(&(Local_217[1 /*17*/]), Var0, sVar2, Var0.f_1, 0, 0, 0, 1, iVar3);
	iLocal_252 = func_149(3, 0, 0);
	func_150(&iLocal_196, 0);
	func_21(&iLocal_190, 262144);
}
...
bool func_152()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_247())
	{
		return true;
	}
	return false;
...
bool func_213(int iParam0, vector3 vParam1, int iParam4)
{
...
void func_250(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_345(Global_35, *uParam2, sVar1, "", -1082130432 /* Float: -1f */, uVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
bool func_294(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_312(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
...
bool func_336(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((PED::_IS_PED_CARRYING(Global_35) || func_394(Global_35)) || func_395(Global_35)) || func_396(Global_35));
	fVar12 = -1f;
...
void func_423(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (!func_199(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_403(iParam1))
		{
			...
			iParam1->f_6 = func_438(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_199(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_438(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_324(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_442(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
