		...
		else
		{
			...
			switch (iLocal_22)
			{
				...
				case 2:
					if (((func_61(uLocal_173[0], iLocal_169, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_62(&iLocal_175, iLocal_171, 2644.251f, -1208.702f, 53.5354f)) && func_62(&iLocal_176, iLocal_171, 2643.541f, -1208.416f, 53.1764f)) && func_62(&iLocal_177, iLocal_170, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(&(uLocal_173[0]), 0))
						{
							...
							ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(uLocal_173[0]), 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1);
				...
				case 3:
					...
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, 0) && ENTITY::HAS_ANIM_EVENT_FIRED(&(uLocal_173[0]), -1527527524))
						{
				...
				case 32:
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_189))
					{
						...
						if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_189, 0))
						{
							PLAYER::_0xC67A4910425F11F1(PLAYER::GET_PLAYER_INDEX(), "TimothyBubble");
							func_81(iLocal_184);
				...
				case 33:
					if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_173[0])) && !ENTITY::IS_ENTITY_DEAD(Global_35))
					{
						...
						if (!func_19(iLocal_190, 128))
						{
							...
							{
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", 0, 1065353216, 1056964608, 1);
...
int func_5(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		if ((!ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, 0) && !ENTITY::_0x083D497D57B7400F(&(uLocal_173[0]))) && !bParam5)
		{
			ANIMSCENE::START_ANIM_SCENE(*iParam0);
		}
		if (bParam5 && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, 0))
		{
...
int func_31(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_166(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
bool func_108(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_202(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
void func_109(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(iParam0, iParam1, 0, -1082130432, 0);
		}
	}
}
...
int func_142(var uParam0, int iParam1, float fParam2, int iParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_153(var uParam0, int iParam1, float fParam2, int iParam3)
{
	var uVar0;
	vector3 vVar1;
	vector3 vVar4;
...
var func_192(int iParam0, var uParam1)
{
...
var func_202(int iParam0, int iParam1, var uParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
int func_213(int iParam0, vector3 vParam1, int iParam4)
{
...
int func_214(int iParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_329(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	var uVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		uVar5 = func_387(*uParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
...
int func_391(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
int func_401(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
