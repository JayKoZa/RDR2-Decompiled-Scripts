...
void __EntryFunction__()
{
	...
	while (true)
	{
		if (((PED::IS_PED_FALLING(Global_35) || PED::_IS_PED_FALLING_2(Global_35)) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::GET_PLAYER_INDEX(), true)) || func_9())
		{
			func_10(0);
		}
			...
			case joaat("KIT_WARDROBE"):
				...
				else
				{
					...
					if (bVar36 && !bVar35)
					{
						...
						func_123(MISC::_CREATE_VAR_STRING(0, -1680440926, Global_36559), 10000, 0, 0, 0, 1);
					}
					else if (!func_125(7))
					{
					...
					else if (!bVar35)
					{
						...
						else
						{
							...
							Global_36559 = MAP::_0x3E593DF9C2962EC6(joaat("BLIP_STYLE_PLAYER_HORSE"));
							MAP::_BLIP_SET_MODIFIER(Global_36559, 673950256);
							func_123(MISC::_CREATE_VAR_STRING(0, -482898802, Global_36559), 10000, 0, 0, 0, 1);
						}
					}
					else
					{
...
bool func_110(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case joaat("KIT_HANDHELD_CATALOG"):
			func_123(MISC::_CREATE_VAR_STRING(0, 163043886 /* GXTEntry: "You are not allowed to use Handheld Catalogue at the moment." */, Global_36559), 10000, 0, 0, 0, 1);
			break;
	}
	return true;
}
...
void func_284(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_570(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_570(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_572(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, func_571(func_379(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_570(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
...
void func_421(int iParam0, bool bParam1)
{
	...
	func_570(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar3), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_438(int iParam0, char* sParam1)
{
	...
	func_637(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_719(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
int func_447(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_725(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
Vector3 func_539(var uParam0)
{
	...
	if (!func_789(uParam0, &vVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
char* func_574(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		...
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_DB_FOUND_OBJ", func_688(), 30);
			}
			break;
		case -1531394072:
			if (iParam2 == 7)
		...
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_RC_FOUND_OBJ", func_689(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ", sParam4, func_573(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_578(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_571(func_806(iVar0))), func_571(func_806(iVar0)), bVar1, true, false);
		}
...
bool func_590(int iParam0)
{
	...
	if (func_521(Global_35, iParam0, 0, 1) < 2f && PED::_0xD543D3A8FDE4F185(Global_35, iParam0))
	{
		return true;
	}
	return false;
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_852(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_121(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_852(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_111(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_623(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			{
				iVar4 = func_857(uParam0->f_1[iVar0 /*3*/], iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_624(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	while (iVar0 < *uParam0)
	{
		func_859(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_62() == -1)
	{
...
bool func_653(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_647(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_440(0) };
...
void func_656(int iParam0)
{
	...
	func_637(MISC::_CREATE_VAR_STRING(6, func_880(iParam0), fVar1), "itemtype_textures", func_881(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_662(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_62() == -1)
			{
				if (!func_713(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_891(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_670())
					{
...
bool func_675(int iParam0, int iParam1, var uParam2)
{
	...
	switch (iVar4)
	{
		...
		case 1788623170:
			...
			else
			{
				...
				iVar9 = func_857(Global_1946804.f_1497.f_1[iVar5 /*3*/], iVar4, iVar2, bVar1);
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_852(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
float func_706()
{
	...
	func_920(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_707()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_920(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_708()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_920(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
bool func_743(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 2)
	{
		if (func_947(iVar0))
		{
			if (BUILTIN::VDIST(func_948(iVar0), vParam0) < fParam3)
			{
				return true;
			}
		}
...
bool func_744(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < Global_40.f_450)
	{
		...
		{
			if (BUILTIN::VDIST(func_949(Global_40.f_450[iVar0]), vParam0) < fParam3)
			{
				return true;
			}
		}
...
void func_766(int iParam0)
{
	...
	Var1 = func_956(iVar0);
	func_541(-1715238242, iParam0, &Var1, func_957(iParam0), 1, 0, 0, joaat("COLOR_PURE_WHITE"));
	Global_1935689.f_19.f_203++;
...
int func_803()
{
	...
	while (iVar1 < 30)
	{
		if (func_970(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	return func_975(BUILTIN::TO_FLOAT(iParam0), fParam1);
}
...
void func_845(var uParam0, int iParam1, int iParam2)
{
	...
	func_1001(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
void func_848(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1003(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_1003(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_1004(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_859(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_62() == -1)
	{
		func_1007(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_1008(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_926(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_925(iParam0))
	{
		...
		if ((!func_927() && !bParam1) && !func_470(0, 0, 1))
		{
			func_123(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_1032(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_934(int iParam0)
{
	...
	if (func_1043(ENTITY::GET_ENTITY_MODEL(iVar0), iVar2))
	{
...
void func_937(int iParam0, int iParam1, int iParam2)
{
	...
	Global_40.f_1095.f_1[iParam0 /*436*/].f_298[iVar1] = func_1049(Global_40.f_1095.f_1[iParam0 /*436*/].f_298[iVar1], 0, 10);
}
...
struct<5> func_943(int iParam0)
{
	...
	Var0 = { func_944(iParam0, joaat("CHARACTER"), func_720(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
...
int func_947(int iParam0)
{
	...
	return func_1052(Global_1835011[iParam0 /*74*/].f_1);
}
...
void func_982(int iParam0, float fParam1, bool bParam2)
{
	...
	iVar0 = func_1071(BUILTIN::CEIL(Global_40.f_11095[iParam0]));
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(Global_35, func_1072(iParam0), iVar0);
	func_1074(func_1073(iParam0), (100f * (BUILTIN::TO_FLOAT(iVar0) / 100f)), 0);
	if (((fParam1 <= func_1075(15) && iParam0 == 1) && PED::IS_PED_ON_FOOT(Global_35)) && !PED::IS_PED_SWIMMING(Global_35))
	{
		func_150(84, 1);
	}
	if (fParam1 <= -99.999f)
...
void func_985(int iParam0)
{
	...
	iVar1 = func_1078(2);
	func_1079(BUILTIN::TO_FLOAT((iParam0 * iVar1)), 0);
}
...
void func_987(int iParam0)
{
	...
	iVar1 = func_1081(2);
	func_1082(BUILTIN::TO_FLOAT((iParam0 * iVar1)));
}
...
void func_994(int iParam0, float fParam1)
{
	...
	if (iParam0 == 12)
	{
		...
		iVar0 = func_1071(BUILTIN::CEIL(Global_40.f_11095.f_11[iParam0]));
...
bool func_1011(int iParam0, int iParam1)
{
	...
	{
		return func_1090(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
int func_1018(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_1095(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_1095(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_1021(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_1102(iParam0));
	...
	func_570(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_1105(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
bool func_1054(int iParam0, var uParam1)
{
	if (iParam0 == 90)
	{
		if (func_1121(Global_1347702[iParam0 /*49*/].f_15) != 0)
		{
...
int func_1065(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iVar0, func_1072(iParam0), BUILTIN::CEIL(fParam1));
		return 1;
	}
	else
	{
...
bool func_1119(int iParam0)
{
	switch (iParam0)
	{
		case 14:
		case 34:
			return !func_1151(&(Global_1835011[iParam0 /*74*/]));
	}
	return false;
}
...
void func_1127(int iParam0, int iParam1, float fParam2)
{
	...
	{
		PED::_SET_PED_BLACKBOARD_FLOAT(iParam0, func_1154(iParam1), fParam2, -1);
	}
}
...
void func_1130(var uParam0, var uParam1, var uParam2)
{
	...
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(iVar0, uParam1, 0, func_62() != -1, uParam2);
	*uParam0 = 1;
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_1087(&(uParam0->f_1[iParam1 /*5*/]));
