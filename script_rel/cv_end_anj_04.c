...
bool func_72(var uParam0)
{
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_MALE_C", -1, 1, 1f, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	func_155(uParam0, iLocal_16, 3, joaat("WORLD_ANIMAL_DOG_SLEEPING"), "WORLD_ANIMAL_DOG_SLEEPING", -1, 1);
	func_157(uParam0, iLocal_16, 2, joaat("WORLD_ANIMAL_DOG_SLEEPING"), "WORLD_ANIMAL_DOG_SLEEPING", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_251(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_300(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
