...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -11.581f, 7.1445f, 0f, -68.75f, 1.0625f, 1.0275f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	func_154(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS"), "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_154(uParam0, iLocal_14, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 0f, 1);
...
int func_246()
{
	...
	if (func_322(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_247()
{
	...
	if (func_322(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_255(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	iVar6 = func_323(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_294(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_299(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
