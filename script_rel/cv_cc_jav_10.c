...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -11.581f, 7.1445f, 0f, -68.75f, 1.0625f, 1.0275f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, -1612834106, 271759394, 1, 1, 1);
	func_151(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_20 = func_152(uParam0, 245507163, 0f, 0f, 0f, "BRUSH", 0, 0, 1);
	...
	func_154(uParam0, iLocal_15, 3, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_18, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_155(uParam0, iLocal_15, 2, 4, 0, 0, 0);
	func_156(uParam0, iLocal_15, 1);
	func_153(uParam0, iLocal_16, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0);
	func_154(uParam0, iLocal_16, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_16, iLocal_20, "p_cs_rag02x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_16, 1, 1, 0, 0, 0);
	func_153(uParam0, iLocal_14, 3, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0);
	func_154(uParam0, iLocal_14, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_156(uParam0, iLocal_14, 1);
	func_158(uParam0, "script@vignette@javier_10@base", 1, 1, 0, 0);
	iLocal_21 = func_158(uParam0, "script@vignette@javier_10@action", 2, 0, 1, 0);
	iLocal_22 = func_158(uParam0, "script@vignette@javier_10@idle_a", 0, 0, 0, 0);
...
int func_93(var uParam0)
{
	...
	{
		func_199(uParam0, iLocal_22, "b_LoopBool", 1);
	}
	return 1;
}
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, float fParam8, int iParam9)
{
...
void func_188(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_287(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar2 /*113*/])->f_5, true, false));
				iVar1 = func_287((uParam0->f_107[iVar2 /*113*/])->f_96);
				if (iVar0 || iVar1)
				{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_32 > -1)
			{
				...
				func_297((uParam0->f_107[iVar0 /*113*/])->f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_300(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_199(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
void func_254(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_301(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_255(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_323(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_323(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_324(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
...
int func_329(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
int func_344(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_383(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_416(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_446(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_390(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_442(int iParam0)
{
	...
	func_459(iParam0, 1073741824 /* Float: 2f */);
}
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_460(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_462(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_471(bParam0, &Var0, iVar5, 0))
			{
				if (func_472(bParam0, &Var6, iVar5))
				{
					Var29 = { func_473(bParam0, Var0, iVar5, 0) };
					func_474(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_475(0))
				{
					...
					func_476(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
struct<5> func_469(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	Var0.f_4 = 1084182731;
	switch (func_481(bParam0))
	{
		case joaat("clothing"):
			if (!INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, 1034665895))
			{
				Var0 = { func_473(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_483(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_471(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_471(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_472(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_486(bParam0, -1823706425))
			{
				Var0 = { func_473(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_486(bParam0, -1483207246))
			{
				Var0 = { func_473(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_471(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_488(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_472(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_489(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_473(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_490(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_491(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_474(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_477(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_494(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_473(joaat("character"), func_495(), -1591664384, bParam0);
}
...
{
	if (func_485(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_496(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_486(bool bParam0, int iParam1)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_487(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_488(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_473(bParam0, Param1, iParam5, bParam6) };
...
int func_489(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_491(0);
	*uParam1 = { func_473(bParam0, func_482(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
