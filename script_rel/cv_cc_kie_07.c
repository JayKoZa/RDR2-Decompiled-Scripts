...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, 2.2f, 0f, -35f, 5f, 4f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	func_151(uParam0, -1f, 8.5f, 0f, 0f, 3.5f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, joaat("WORLD_CAMP_KIERAN_TREE_TIED"), "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216 /* Float: 1f */, 1);
		...
		if ((bParam1 || !func_105(iParam0)) || func_51(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_209(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_224(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_225(iParam0, 0));
...
{
	func_155(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID(uParam0->f_107[iVar12 /*113*/].f_3))
			{
				...
				{
					uParam0->f_107[iVar12 /*113*/].f_3 = PERSCHAR::_0xA00DF706C60173D1(func_223(uParam0->f_107[iVar12 /*113*/].f_7, 1));
				}
			}
...
bool func_381(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_255(iParam0, 1073741824 /* Float: 2f */))
	{
		return true;
	}
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_223(iParam0, 1), &uVar4);
				}
...
bool func_430(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489.f_12) || (bParam5 && Global_1359489.f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_223(iParam0, 1));
