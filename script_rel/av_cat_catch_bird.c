...
{
	func_33(uParam0, 10777, 10821, 12011);
}
...
{
	func_46(uParam0, "CAT_CATCH_BIRD", "script@ambient@animal@cat_catch_bird@action", vParam1, vParam4);
	uParam0->f_16 = 1;
...
int func_31(var uParam0)
{
	...
	sVar0 = "script_amb@animal@cat_catch_bird";
	sVar1 = "cat_exit";
	sVar2 = "pigeon_exit";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	...
	if (!uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (func_61(uParam0, &uLocal_9, 1) || func_62(Global_35, uParam0->f_20[0 /*14*/], 1) <= 100f)
			{
				bLocal_42 = true;
			}
		}
		if (bLocal_42)
		{
			if ((!ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], 725039534) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/])) || ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				if (!uParam0->f_469[6])
				{
					func_66(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
				func_67(uParam0);
				func_68(uParam0);
	...
	if (!uParam0->f_469[0] && !bLocal_42)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 40f, 4, joaat("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
									{
										...
										TASK::TASK_PLAY_ANIM(uParam0->f_20[1 /*14*/], sVar0, sVar2, 8f, -8f, -1, 1, 0f, false, 0, false, 0, false);
										TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sVar0, sVar1, 8f, -8f, -1, 65553, 0f, false, 0, false, "FacialWithPHJaw_filter", false);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 61276), vVar3, vVar6, true, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_20[0 /*14*/], joaat("ENDSINWALK")))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
									...
									func_74(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_CAT_RESTING"), vLocal_39, 0f, 60000, 1, 0, 0, -1082130432 /* Float: -1f */);
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !uParam0->f_469[5]) && func_62(uParam0->f_20[iVar2 /*14*/], Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
float func_62(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
bool func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_116(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
			{
				...
				fVar8 = func_62(Global_35, uParam0->f_20[iVar0 /*14*/], 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_62(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_0x5102307CE88798EB(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_63(&(uParam0->f_490)))
							{
...
Vector3 func_73(var uParam0)
{
	...
	vVar4[1 /*3*/] = { 1823.751f, -1248.367f, 41.491f };
	iVar14 = 0;
...
void func_74(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7, bool bParam8, char* sParam9, float fParam10)
{
...
bool func_81(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_123(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_95(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_133(iParam1))
		{
			func_134(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_104(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_145(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_110(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_123(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_142(int iParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_148(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_166(int iParam0, var uParam1)
{
	...
	{
		return func_215(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_171(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_204(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_223(iVar0, 0)))
		{
...
bool func_189(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_196(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_198(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_200(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_205(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_211(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_224(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_227(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
