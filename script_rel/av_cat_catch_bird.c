...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 1, "PIGEON", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), -1795669989))
							{
								if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
								{
									...
									func_74(&(uParam0->f_20[0 /*14*/]), -75130390, vLocal_39, 0f, 60000, 1, 0, 0, -1082130432 /* Float: -1f */);
...
void func_74(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_110(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_123((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_227(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
