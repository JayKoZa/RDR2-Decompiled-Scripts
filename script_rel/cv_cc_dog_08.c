...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -4.6375f, -7.4f, 0.907f, 80f, 1.7975f, 3.355f, 2.025f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER"), "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
