...
int func_287(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_369(*uParam1, 2))
	{
		...
		else if ((func_190(iParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_LAST_MOUNT(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(PED::_GET_LAST_MOUNT(iParam0))))
		{
...
void func_327(int iParam0)
{
	...
	if (func_61(&(uLocal_15[iParam0]), 0, 0))
	{
		...
		ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(uLocal_15[iParam0]), vVar0, uVar3, 0, 0, 1);
		...
		while (iVar28 < 4)
		{
			...
			if (func_486(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_490(0))
				{
					...
					func_491(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
int func_502(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_575(iVar0, 0)))
		{
...
void func_596(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_619(func_618(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_620())
	{
