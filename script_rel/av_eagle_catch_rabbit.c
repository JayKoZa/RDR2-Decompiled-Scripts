...
{
	func_33(uParam0, 10737, 10782, 12072);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[6])
			{
				if (func_72(uParam0, 1065353216 /* Float: 1f */, 100f, 4, joaat("ACTION"), 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20[1 /*14*/]))
									{
										...
										TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sVar0, sVar1, 8f, -8f, -1, 65553, 0f, false, 0, false, "LegsOnlyBird_filter", false);
										PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_20[1 /*14*/], false);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], PED::GET_PED_BONE_INDEX(uParam0->f_20[0 /*14*/], 38142), vVar3, vVar6, false, false, false, false, 2, true, true, false);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
...
bool func_62(var uParam0, var uParam1, bool bParam2)
{
...
void func_69(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
	{
		iVar1 = joaat("MOTIONSTATE_SPRINT");
		...
		else
		{
			...
			{
				iVar1 = joaat("MOTIONSTATE_IDLE");
			}
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_FORCE_MOTION_STATE(0, iVar1, false);
			TASK::_TASK_SMART_FLEE_STYLE_PED(0, Global_35, 3, 256, -1082130432 /* Float: -1f */, -1, 0);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
...
bool func_72(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
