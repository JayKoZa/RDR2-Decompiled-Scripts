...
int func_11()
{
	uLocal_14 = ((*Global_1888801)[37 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(uLocal_14, 9);
	return 1;
}
...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_89(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_101(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_101(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_101(&cVar6, joaat("COLOR_PURE_WHITE")), func_101(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_63(int iParam0, bool bParam1)
{
	...
	func_107(func_106(-1532769513, joaat("areas")), 1);
...
char* func_89(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
int func_160(vector3 vParam0, int iParam3)
{
	...
	func_177(iParam3, &vVar0, &Var3, &uVar6);
	if (func_178(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
