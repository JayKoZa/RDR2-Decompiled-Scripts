...
void func_144(int iParam0)
{
	...
	if (bVar5)
	{
		...
		{
			func_243(0, joaat("HONOR_EVENT_TRAMPLED_INNOCENT"), 0, 0, iVar4, 0, 1065353216 /* Float: 1f */, 0);
		}
	}
...
void func_413(int iParam0)
{
	...
	if (!func_76(2048))
	{
		if (bVar1)
		{
			if (!func_458(iParam0, joaat("HONOR_EVENT_STEAL_DONKEY")))
			{
		...
		{
			if (!func_458(iParam0, joaat("HONOR_EVENT_STEAL_MULE")))
			{
				iVar3 = joaat("HONOR_EVENT_STEAL_MULE");
			}
		}
		else if (!func_458(iParam0, joaat("HONOR_EVENT_STEAL_HORSE")))
		{
...
bool func_684(int iParam0, var uParam1)
{
	...
	*uParam1 = func_917(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
bool func_685(int iParam0, var uParam1)
{
	...
	*uParam1 = func_917(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_284(*uParam1, 0))
	{
		return false;
	}
...
void func_732(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_945(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
...
void func_742(int iParam0, int iParam1)
{
	...
	fVar3 = (BUILTIN::TO_FLOAT(func_961(iVar2)) + (48f * 60f));
...
void func_874(int iParam0)
{
	...
	{
		case joaat("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_01"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_02"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_03"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_04"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_05"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_06"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_PERCH_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_07"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_08"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_09"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_10"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_11"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_12"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_13"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_1055(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_853(0, 10);
			break;
		case joaat("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_1053(joaat("LEGENDARY_FISH_14"));
			func_1054(joaat("LEGENDARY_FISHING_SPOT_14"));
...
void func_920(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		...
		{
			func_1076(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
	...
	switch (*iParam3)
	{
		case 0:
			...
			else
			{
				...
				{
					TASK::_0xCE4E669400E5F8AA(iParam3->f_1, func_1081(iParam3->f_6));
				}
...
void func_984(int iParam0, int iParam1)
{
	...
	func_812(sVar2, MISC::_CREATE_VAR_STRING(2, "HORSE_BONDING_LEVEL", iParam1), joaat("HUD_TOASTS"), -961843223, -2, "HUD_Toast_Soundset", "horse_bonding", 0, 0, 1, 1);
}
...
bool func_1008(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		func_1100(&(Global_1946804.f_1378.f_1[iParam2 /*3*/]), 4, 6);
		func_1100(&(Global_1946804.f_1497.f_1[iParam2 /*3*/]), 4, 6);
	}
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_1102(iParam0, iParam2, iParam1, func_2() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_1104(func_1094(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
bool func_1028(int iParam0, var uParam1, var uParam2)
{
	if (!func_1027(iParam0))
	{
		return false;
...
bool func_1038(int iParam0)
{
	...
	return func_1119(Global_1347702[iParam0 /*49*/].f_15);
}
...
char* func_1040(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case -2076669067:
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ", func_1121(), 12);
			}
			else
			{
		...
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_DB_POSTED_OBJ", func_1124(), 30);
			}
			else
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_DB_FOUND_OBJ", func_1123(), 30);
			}
			break;
		case -1531394072:
			if (iParam2 == 7)
		...
		case 1995362678:
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_LF_CAUGHT_OBJ", func_1125(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_RC_POSTED_OBJ", func_1127(), 10);
			}
			else
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_RC_FOUND_OBJ", func_1126(), 10);
			}
			break;
...
bool func_1044(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1131(func_1128(iVar0))), func_1131(func_1128(iVar0)), bVar1, true, false);
		}
		...
		if (iParam2 == 1995362678)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1136(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_1136(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1139(iVar2)), func_1139(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
void func_1048(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1140(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1140(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_812(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, func_1131(func_1141(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_1140(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
	...
	if (fParam8 == -0.01f)
	{
		switch (iParam5)
		{
			...
			case 36:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(10f, 40f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(30f, 60f, 5f, iParam1));
			...
			case 37:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(40f, 80f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(50f, 90f, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 10f);
			...
			case 38:
				TASK::_0x2EB977293923C723(*uParam0, 30f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(30f, 60f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(50f, 80f, 5f, iParam1));
			...
			case 39:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(0f, 10f, 1f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(5f, 15f, 1f, iParam1));
			...
			case 40:
				...
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(60f, 120f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(100f, 130f, 5f, iParam1));
			...
			case 41:
				TASK::_0x2EB977293923C723(*uParam0, 10f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(10f, 35f, 5f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(25f, 50f, 5f, iParam1));
			...
			case 45:
				TASK::_0x2EB977293923C723(*uParam0, 40f);
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(50f, 80f, 10f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(75f, 95f, 5f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 15f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
			case 43:
				TASK::_0x2EB977293923C723(*uParam0, func_1151(95f, 90f, 80f, iParam1));
				TASK::_0x954451EA2D2120FB(*uParam0, func_1151(95f, 90f, 80f, iParam1));
				TASK::_0x0F4F6C4CE471259D(*uParam0, func_1151(125f, 115f, 100f, iParam1));
				TASK::_0x450080DDEDB91258(*uParam0, 5f);
				TASK::_0xBC3F847AE2C3DC65(*uParam0, 10f);
				TASK::_0x885D19AC2B6FBFF4(*uParam0, 0);
				break;
...
void func_1101(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_1154(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_1156(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_1070(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_1156(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_431(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_1103(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_1160(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
				iVar4 = func_1161(uParam0->f_1[iVar0 /*3*/], iVar5, iVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
void func_1111(struct<4> Param0)
{
	...
	if (func_1168(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_1168(20))
			{
				return;
			}
			iVar0++;
...
void func_1114(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		{
			func_1174(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
int func_1123()
{
	...
	while (iVar1 < 30)
	{
		if (func_1185(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1124()
{
	...
	while (iVar1 < 30)
	{
		if (func_1186(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_1152(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1190(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_1190(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_1191(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_1163(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_2() == -1)
	{
		func_1194(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_1195(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
void func_1196(var uParam0, int iParam1)
{
	...
	if (func_2() == -1)
	{
		...
		while (iVar0 < 39)
		{
			func_1194(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
			iVar0++;
		}
		return;
	}
...
{
	*uParam0 = (*uParam0 - 1);
	func_1208(&(uParam0->f_1[iParam1 /*5*/]));
