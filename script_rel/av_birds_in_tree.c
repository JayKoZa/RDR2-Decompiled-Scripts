	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iLocal_42 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iLocal_42 /*14*/]), joaat("stand"), (uParam0->f_20[iLocal_42 /*14*/])->f_5, (uParam0->f_20[iLocal_42 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
			}
			iLocal_42++;
			if (iLocal_42 >= 12)
			{
