...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.62f, -1.09f, 1f, 0f, 3f, 4f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL"), "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
