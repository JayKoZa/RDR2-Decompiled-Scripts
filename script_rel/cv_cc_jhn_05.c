...
int func_72(var uParam0)
{
	...
	func_156(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_A", -1, 1, 30f, 1065353216 /* Float: 1f */, 1);
...
int func_431(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_463(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
...
int func_479(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_488(bParam0, &Var0, iVar5, 0))
			{
				if (func_489(bParam0, &Var6, iVar5))
				{
					Var29 = { func_490(bParam0, Var0, iVar5, 0) };
					func_491(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_492(0))
				{
					...
					func_493(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_494(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
struct<5> func_486(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_498(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_490(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_500(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_488(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_488(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_489(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_490(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
bool func_488(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_505(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_489(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_506(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_490(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_508(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_491(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_494(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_511(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	if (func_502(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_513(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_505(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_490(bParam0, Param1, iParam5, bParam6) };
...
int func_506(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_508(0);
	*uParam1 = { func_490(bParam0, func_499(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
