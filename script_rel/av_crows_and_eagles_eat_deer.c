...
{
	func_33(uParam0, 11174, 11247, 11640);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 7, "DEER", iLocal_11, vParam1, (-90f + vParam4.z), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
bool func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[7 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[7 /*14*/], "SCRIPT_AMB@ANIMAL@SCAVENGERS@CROWS_AND_EAGLES_EATING_DEER_CARCASS_A", "LOOP_DEER", 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
...
int func_31(var uParam0)
{
	...
	{
		if (func_69(uParam0, 1.5f, 40f, 4, joaat("ACTION"), 1))
		{
...
bool func_113(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
