...
int func_78(var uParam0)
{
	...
	uLocal_53 = func_167(uParam0, 2.7376f, -2.875f, 0f, 0f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, "GRIEF", -1612834106);
	return 1;
}
...
void func_408(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_237(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_237(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_237(iParam5, 32), 1);
