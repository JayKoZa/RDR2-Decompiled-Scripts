...
int func_79(var uParam0)
{
	...
	func_168(uParam0, iLocal_18, 2, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
	func_169(uParam0, iLocal_18, 1);
	func_170(uParam0, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(-1074764191, 1, 0, 1381680021);
	func_171(uParam0, 1);
...
int func_82(var uParam0)
{
	...
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(-1074764191, 0))
	{
		return 0;
	}
...
int func_94(var uParam0)
{
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_94))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_50(uParam0, iLocal_38)))
		{
			...
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_94, 23, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_94, 25, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_94, 8, 1);
		}
		return 0;
	}
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return 0;
...
int func_115(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_128(iVar0, 0))
	{
		if (func_128(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	Var16 = { func_290(-1756227506, joaat("human")) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_308((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_211(int iParam0, int iParam1, var uParam2, var uParam3)
{
	if (!func_51(*iParam0))
	{
		*iParam0 = func_330("GREET_ACC", joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
		func_331(*iParam0, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_8(uParam2, *uParam3)), 0, 1);
	}
	if (!func_51(*iParam1))
	{
		*iParam1 = func_330("GREET_REJ", joaat("INPUT_INTERACT_LOCKON_NEG"), func_8(uParam2, *uParam3), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
void func_229()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, iLocal_94, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
...
void func_234(var uParam0)
{
	...
	{
		iLocal_53 = func_330("VIG_LEAVE_CONVERSATION", joaat("INPUT_GAME_MENU_CANCEL"), func_8(uParam0, iLocal_18), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
...
void func_291(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_357(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_292(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_386(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_330(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_244(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_400(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_365(var uParam0, int iParam1)
{
	...
	iVar0 = &uParam0->f_1984[iParam1];
	if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iVar0) || ANIMSCENE::_IS_ANIM_SCENE_LOADING(iVar0, 1))
	{
		return 0;
	}
...
int func_374()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_425(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_413(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_456(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_469(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_111(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_503(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_110(iParam0, 44, 1);
			}
...
bool func_517(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_544(bParam0, &Var0, iVar5, 0))
			{
				...
				{
					Var29 = { func_546(bParam0, Var0, iVar5, 0) };
...
struct<5> func_542(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_554(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_546(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_546(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
struct<4> func_546(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
{
	return func_546(joaat("character"), func_568(), -1591664384, bParam0);
}
...
int func_561(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_546(bParam0, Param1, iParam5, bParam6) };
...
int func_562(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_564(0);
	*uParam1 = { func_546(bParam0, func_555(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
