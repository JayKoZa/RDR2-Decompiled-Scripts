...
bool func_79(var uParam0)
{
	...
	func_159(uParam0, -0.73f, -0.92f, 0f, -96.48f, 3.955f, 4.8675f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
...
bool func_94(var uParam0)
{
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_94))
	{
		...
		{
			iLocal_94 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_38), joaat("PROP_PLAYER_SEAT_CHAIR_GENERIC"), 0f, 0f, 0.5f, -180f, 0, 0, 0);
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, joaat("PROP_CAMP_FIRE_SEAT_BENCH"), "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216 /* Float: 1f */, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return false;
...
int func_165(int iParam0, int iParam1, int iParam2)
{
	...
	iVar12 = 0;
	Var16 = { func_289(joaat("NUM_PEDS_HURT")) };
	STATS::STAT_ID_GET_INT(&Var16, &iVar13);
	Var16 = { func_290(joaat("KILLS"), joaat("HUMAN")) };
	STATS::STAT_ID_GET_INT(&Var16, &iVar14);
	Var16 = { func_289(joaat("HOLD_UPS")) };
...
struct<5> func_542(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_554(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_546(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_546(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
