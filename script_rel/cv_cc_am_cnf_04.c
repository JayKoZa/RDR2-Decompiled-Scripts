...
int func_1(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_94))
	{
		TASK::_0x81948DFE4F5A0283(uLocal_94);
	}
...
int func_94(var uParam0)
{
	...
	if (!TASK::_0x841475AC96E794D1(uLocal_94))
	{
		...
		{
			uLocal_94 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_38), -229964281, 0f, 0f, 0.5f, -180f, 0, 0, 0);
			TASK::_0x5AF19B6CC2115D34(uLocal_94, 23, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_94, 25, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_94, 8, 1);
		}
		return 0;
	}
...
void func_229()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, uLocal_94, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
