...
int func_72(var uParam0)
{
	...
	func_158(uParam0, iLocal_15, 2, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	iLocal_18 = WEAPON::_CREATE_WEAPON_OBJECT(joaat("weapon_melee_knife"), 1, uParam0->f_23, 1, 1065353216);
