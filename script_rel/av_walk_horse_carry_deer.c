...
void __EntryFunction__()
{
	...
	iLocal_70 = func_1(997958153 /* GXTEntry: "Riding" */, 1);
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					...
					if (*uParam0 == 71)
					{
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
						{
							...
							PED::_UPDATE_PED_VARIATION(&(uParam0->f_20[0 /*14*/]), 0, 1, 1, 1, 0);
...
int func_75(int iParam0, int iParam1)
{
	...
	uVar0 = INVENTORY::_INVENTORY_GET_PED_INVENTORY_ID(iParam0);
...
int func_146(var uParam0, int iParam1, int iParam2)
{
	...
	Var0 = { func_222(uParam0) };
	Var5 = { func_223(uParam0, iParam1, Var0, Var0.f_4) };
	if (INVENTORY::_0xCB5D11F9508A928D(uParam0, &Var5, &Var0, iParam1, Var0.f_4, iParam2, 752097756))
	{
...
struct<5> func_222(var uParam0)
{
	...
	Var0 = { func_223(uParam0, joaat("character"), func_253(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_223(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
