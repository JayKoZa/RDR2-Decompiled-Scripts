...
void __EntryFunction__()
{
	...
	func_2(&Local_9, &uScriptParam_0);
	while (!func_3(&Local_9))
	{
		func_4(&Local_9);
		switch (func_5(Local_9))
		{
			case 0:
				if (func_6(&Local_9))
				{
...
int func_21(var uParam0)
{
	...
	PLAYER::START_PLAYER_TELEPORT(PLAYER::GET_PLAYER_INDEX(), ((*Global_1835011)[4 /*74*/])->f_18, 0f, 0, 1, 1, 0);
	func_25(&uLocal_3, 0);
	MISC::SET_BIT(&(Global_1956578->f_1), 5);
	return 1;
}
...
int func_23(var uParam0)
{
	...
	if (PLAYER::_HAS_PLAYER_TELEPORT_FINISHED(PLAYER::GET_PLAYER_INDEX()) && !func_46(&uLocal_6))
	{
		func_25(&uLocal_6, 0);
	}
...
int func_61(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_69(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				iVar1 = func_70(iParam0, 1);
				if (iVar1 != 0)
				{
					if (!ENTITY::_0x88AD6CC10D8D35B2(iVar0))
					{
					...
					func_71(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_72(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_72(iParam0, 0));
					func_73(iParam0);
				}
			}
			else
...
float func_69(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_78(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_70(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_127 = func_79(iParam0);
		return ((*Global_1360165)[iParam0 /*1157*/])->f_127;
	}
	return 0;
}
...
int func_72(int iParam0, bool bParam1)
{
	...
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_126 = func_80(iParam0);
	}
