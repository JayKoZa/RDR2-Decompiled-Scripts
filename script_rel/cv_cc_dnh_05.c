...
bool func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 8.88f, 3.18f, 1.2f, 7.068f, 1.5f, 1.5f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
		func_154(uParam0, 0.6f, -0.8f, 1f, 2f, 1.75f, 2.5f, 2f, joaat("VOLBOX"), 2076113919, 1, 1, 1);
		func_155(uParam0, 0.625f, -0.0377f, 1.15f, 38.56f, 1f, 1f, 2.685f, joaat("VOLCYLINDER"), 1);
	}
	...
	func_162(uParam0, iLocal_14, 1, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_160(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
bool func_210(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_257()
{
	...
	if (func_334(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_258()
{
	...
	if (func_334(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_267(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_336(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_288(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_305(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
void func_346(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_380(iParam1))
		{
			func_381(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_371(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_375(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
...
bool func_406(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
void func_408(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_236(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_236(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_236(iParam5, 32), true);
...
bool func_409(int iParam0, int iParam1)
{
	...
	bVar0 = func_452(iParam0, iParam1);
	return bVar0;
}
...
bool func_427(int iParam0, char* sParam1)
{
...
bool func_429(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_433(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		while (iVar28 < 4)
		{
			...
			if (func_487(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_491(0))
				{
					...
					func_492(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_485(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_497(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_489(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_487(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_487(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_488(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_489(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_487(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_504(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
bool func_490(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_493(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_510(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_498(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_489(923904168, func_496(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_489(923904168, func_496(bParam0), -740156546, 0) };
		}
...
struct<4> func_500(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_489(271701509, func_496(bParam0), 12999093, 0) };
		}
...
bool func_503(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_505(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
