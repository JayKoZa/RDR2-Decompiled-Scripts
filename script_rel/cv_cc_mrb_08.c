...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, -7.4375f, 10.3875f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, -0.890535f, -1.80463f, 1.00638f, 0f, 1.1f, 1.1f, 3.2f, joaat("VOLCYLINDER"), 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_391(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
