...
{
	func_33(uParam0, 12050, 12115, 12500);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 9, "DEER", iLocal_11, vParam1, (fVar6 + vParam4.z), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
bool func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[9 /*14*/]))
	{
		...
		TASK::TASK_PLAY_ANIM(uParam0->f_20[9 /*14*/], sLocal_13, sLocal_14, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		...
		{
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_68(uParam0, &uLocal_18, 1))
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
	...
	{
		if (func_70(uParam0, 1.5f, 40f, 4, joaat("ACTION"), 1))
		{
...
bool func_70(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_113(var uParam0, float fParam1)
{
...
bool func_115(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_174(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
