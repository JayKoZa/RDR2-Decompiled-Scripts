		...
		if (MISC::GET_GAME_TIMER() > iLocal_229)
		{
			...
			switch (iLocal_228)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_230));
					iVar1 = func_10(iLocal_230);
					if (iVar1 != -1)
					{
				...
				case 6:
					if (func_7(func_6(iLocal_230)))
					{
						...
						else
						{
							...
							Jump @788; //curOff = 456
							if (iLocal_231 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260.f_3790))
							{
								func_21(iLocal_230);
								func_22();
								if (!func_23(2057, 0))
...
{
	iParam0 = iParam0;
	return func_48(&uLocal_14, 8, &uLocal_14, func_46(), 0, func_47(), 0, 0, 0);
}
...
{
	func_170(Global_1935369.f_5[iParam0 /*11*/].f_6, 1);
	func_171(Global_1935369.f_5[iParam0 /*11*/].f_6, 0);
...
void func_131(int iParam0)
{
	...
	{
		func_174(Global_1914319.f_3[iParam0 /*446*/].f_21, 0, 1, 0, 0);
	}
	...
	func_175(Global_1914319.f_3[iParam0 /*446*/].f_10, 0);
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	func_188(iVar1, 0);
	func_189(iVar1, 0);
	func_190(iVar1, iVar0);
	if (iParam4 != 0)
	{
		func_191(iVar1, iParam4);
	}
	return iVar1;
}
...
bool func_149(int iParam0, int iParam1, float fParam2)
{
	...
	if (func_196(iParam0, fParam2))
	{
		*fParam2 = func_197(iParam0);
		return true;
	}
	return false;
}
...
float func_150()
{
	...
	iVar6 = func_110();
	iVar4 = func_198(iVar6);
	iVar5 = func_199(iVar6);
	iVar3 = func_200(iVar5, iVar4);
	iVar2 = func_201(iVar6);
...
void func_169(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		func_210(&(Local_73.f_99[iVar0 /*12*/]));
		iVar0++;
	}
	func_211(&(Local_73.f_146));
	func_212(Local_73.f_153);
}
...
void func_174(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_227(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_200(int iParam0, int iParam1)
{
	...
	if (iVar1 > 0)
	{
		...
		while (iVar0 < iVar1)
		{
			iVar2 = (iVar2 + func_228(iVar1, iParam1));
			iVar0++;
		}
	}
	return iVar2;
...
void func_208(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_231(iParam0) == 3 || (func_231(iParam0) == 1 && STATS::_0x01F4D242765C6B24(func_232(iParam0))))
	{
		func_234(func_233(iParam0), func_232(iParam0), iParam2);
		if ((!func_140(Global_1572864.f_8) && !func_84(0, 1, 0)) && !func_55(Global_1935630, 32768))
		{
...
int func_235(int iParam0)
{
	...
	switch (func_233(iParam0))
	{
		...
		case 8:
			...
			if (func_139(Global_1347702[iVar1 /*49*/].f_12, 1))
			{
				return func_254(iVar1);
			}
			break;
	}
	return -1;
...
void func_236(bool bParam0)
{
	...
	if ((Global_1898077.f_2 == 4 && Global_1898077.f_12 != Global_1898077.f_13) && !bParam0)
	{
		...
		func_255(iVar0, Global_1898077.f_12);
	}
	else
	{
...
int func_237()
{
	if (!func_165(Global_1835011[4 /*74*/].f_1, 1))
	{
		return 0;
	}
	else if (!func_165(Global_1347702[66 /*49*/].f_15, 1))
	{
		return 1;
	}
	else if (!func_165(Global_1347702[67 /*49*/].f_15, 1))
	{
		return 2;
	}
	else if (!func_165(Global_1835011[38 /*74*/].f_1, 1))
	{
		return 3;
	}
	else if (!func_165(Global_1347702[68 /*49*/].f_15, 1))
	{
		return 4;
	}
	else if (!func_165(Global_1835011[59 /*74*/].f_1, 1))
	{
		return 5;
	}
	else if (!func_165(Global_1835011[67 /*74*/].f_1, 1))
	{
		return 7;
	}
	else
