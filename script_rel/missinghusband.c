...
int func_15(int iParam0)
{
	...
	iVar0 = func_48(func_46(8192), 0, 3, func_47(8192));
	func_49(&iVar0, &uVar1);
	bVar3 = func_50(8192, &fVar2);
	if (!func_51(uVar1, 8))
	{
		if (!func_51(uVar1, 4) || (bVar3 && (func_52() - fVar2) >= 24f))
		{
...
bool func_50(int iParam0, float fParam1)
{
	int iVar0;
...
int func_55(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(func_102(iParam3)))
	{
		return 0;
	}
	...
	if ((bParam6 && func_106(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_129(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_129(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_129(&cVar6, joaat("COLOR_PURE_WHITE")), func_129(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_88(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_152(iVar1, 0);
	func_153(iVar1, 0);
	func_154(iVar1, 0);
...
bool func_105(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	int iVar0[4];
	int iVar5[4];
...
bool func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_115(int iParam0, bool bParam1)
{
	...
	if (func_149(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_170(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_170(iParam0)))
	{
...
int func_150(int iParam0, bool bParam1)
{
	...
	func_199(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_170(iParam0));
	func_169(iParam0, 0);
	return 1;
}
...
bool func_167(int iParam0, int iParam1, float fParam2)
{
	...
	if (func_204(iParam0, fParam2))
	{
		*fParam2 = func_205(iParam0);
		return true;
	}
	return false;
}
...
var func_175(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
bool func_206(vector3 vParam0, int iParam3)
{
	...
	func_224(iParam3, &vVar0, &Var3, &uVar6);
	if (func_225(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return true;
	}
	return false;
