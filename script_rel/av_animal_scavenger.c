...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "AS_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.8f, 0f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 0, "AS_CORPSE", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sLocal_12, sLocal_13, 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), iLocal_14, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				func_65(uParam0->f_20[1 /*14*/], 0, 1);
...
void func_83(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_174(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_176(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_183(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_187(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_192(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_198(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
