...
void __EntryFunction__()
{
	...
	sLocal_13 = "dead_r";
	iLocal_14 = joaat("WORLD_ANIMAL_COYOTE_EATING_GROUND");
...
{
	func_33(uParam0, 10816, 10880, 11391);
}
...
{
	func_46(uParam0, "ANIMAL_SCAVENGER", "", vParam1, vParam4);
	func_47(uParam0, 1, "AS_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.8f, 0f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 0, "AS_CORPSE", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		if (func_63(uParam0, &uLocal_16, 0) || func_64(uParam0->f_20[1 /*14*/], Global_35, 1) < 225f)
		{
			func_65(&(uParam0->f_20[1 /*14*/]), 0, 1);
			PED::_0xEEED8FAFEC331A70(uParam0->f_20[1 /*14*/], Global_36, 0);
			func_66(uParam0);
			iLocal_11 = 2;
			uParam0->f_469[0] = 1;
		}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_12, sLocal_13, 1000f, -1000f, -1, 131072, 0f, false, 0, false, 0, false);
				...
				iLocal_44 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[0 /*14*/].f_5, 1f, 1, 36, 0);
				iLocal_45 = GRAPHICS::_0xFA50F79257745E74(uParam0->f_20[0 /*14*/].f_5, 1.5f, 2, -1, 0);
			}
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				func_67(&(uParam0->f_20[1 /*14*/].f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[1 /*14*/], iLocal_14, uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, false, true, 0, -1f, false);
				func_65(&(uParam0->f_20[1 /*14*/]), 0, 1);
			...
			break;
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_66(uParam0);
				iLocal_11 = 2;
			}
			break;
		case 2:
			if (!PED::_IS_PED_USING_SCENARIO_HASH(uParam0->f_20[1 /*14*/], iLocal_14))
			{
				return 1;
			}
			break;
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_44 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_44, 1);
	}
	if (iLocal_45 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_45, 1);
	}
	return 1;
}
...
float func_64(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_98(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_66(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		func_100(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}
...
bool func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_72(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_73(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
float func_82(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
	...
	return func_98(vVar0, vParam1);
}

void func_83(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_97(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_132(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_100(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > Global_32074.f_2697.f_6[iParam0 /*6*/].f_5)
	{
		Global_32074.f_2697.f_6[iParam0 /*6*/].f_5 = func_40();
...
bool func_108(var uParam0, float fParam1)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_165(1) || *uParam0 & 8192 != 0))
				{
...
bool func_126(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case joaat("EVENT_DEAD_PED_FOUND"):
			...
			if (!func_168(iParam0, uParam1, iVar2))
			{
				return false;
			}
			if (func_169(iParam0, iVar2) <= func_170(uParam1))
			{
				return true;
			}
			break;
...
bool func_128(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_174(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_175(uParam1);
			if (func_176(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
bool func_129(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_178(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_175(uParam2);
		if (func_176(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_177(uParam2)
				{
					func_172(uParam2, 1);
					return true;
				}
...
bool func_130(int iParam0, var uParam1)
{
	...
	if (func_168(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_177(uParam1)
		{
			fVar3 = func_175(uParam1);
...
bool func_133(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_134(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_181(uParam2)))
	{
...
bool func_135(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_183(iParam1, vVar0, vVar4))
					{
						func_172(uParam2, 1);
						return true;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_183(iParam1, vVar0, vVar7))
					{
						func_172(uParam2, 1);
						return true;
					}
...
bool func_136(int iParam0, var uParam1)
{
	...
	{
		if (!func_168(iParam0, uParam1, Global_1935630.f_34[iVar0]) || iParam0 == Global_1935630.f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_184(Global_1935630.f_34[iVar0]);
			...
			if (func_185(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_186(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_187(uParam1, iParam0, fVar1, iVar0))
			{
				vVar2[0 /*3*/] = { ENTITY::GET_ENTITY_COORDS(Global_1935630.f_34[iVar0], false, false) };
				vVar2[1 /*3*/] = { vVar9 };
				uParam1->f_10 = iParam0;
...
bool func_144(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_192(iVar0, iParam1, vVar1))
		{
...
bool func_147(var uParam0, int iParam1)
{
	...
	fVar0 = func_170(uParam0);
	if (uParam0->f_12 > func_194(uParam0) && uParam0->f_12 > fVar0)
	{
		return false;
	}
	iVar2 = func_195(iParam1);
	iVar1 = func_196(uParam0->f_14);
...
int func_148(int iParam0, int iParam1, var uParam2)
{
	...
	return func_197(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_199(uParam1, iParam0))
					{
						if (func_193(iVar4, Global_36, 1) < 7f)
						{
							return true;
						}
					}
...
int func_153(int iParam0, var uParam1)
{
	...
	else if (func_145() - uParam1->f_4) > func_201(uParam1)
	{
		return func_202(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_155(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_203(0, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				func_203(1, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_203(60, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
bool func_171(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_174(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_191(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_214(iVar0, 0)))
		{
...
bool func_176(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_183(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_187(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_191(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_192(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_193(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_197(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
bool func_198(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_199(uParam1, iVar0))
					{
						return true;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_199(uParam1, iVar1))
				{
					if (func_193(iVar1, Global_36, 1) < 5f)
					{
						return true;
					}
				}
...
int func_202(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_203(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
