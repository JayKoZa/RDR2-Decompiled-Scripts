...
bool func_76(var uParam0)
{
	...
	func_156(uParam0, 0.4036f, -11.4034f, 0.5303f, 42.05f, 8f, 8f, 5f, joaat("VOLCYLINDER"), 1);
	func_157(uParam0, 0.5439f, -4.9805f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_157(uParam0, 5.7064f, -14.868f, 0f, 0f, 3.155f, 2.9725f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
...
{
	TASK::TASK_ENTER_ANIM_SCENE(Global_35, uParam0->f_1984[iLocal_17], "JOHN", func_324(uParam0, iLocal_27), 1069379748 /* Float: 1.48f */, 1, 0, 20000, -1082130432 /* Float: -1f */);
}
...
bool func_226(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_264()
{
	...
	if (func_348(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_265()
{
	...
	if (func_348(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_273(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_293(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_294(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_312(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_328(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_422(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_108(iParam0))
	{
		return false;
...
bool func_427(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return false;
...
void func_429(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_243(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_243(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_243(iParam5, 32), true);
...
bool func_430(int iParam0, int iParam1)
{
	...
	bVar0 = func_469(iParam0, iParam1);
	return bVar0;
}
...
bool func_444(int iParam0, char* sParam1)
{
...
bool func_446(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_348(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_421(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_475(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_491(iVar0))
		{
	...
	{
		func_493(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_494(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_502(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_506(0))
				{
					...
					func_507(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_500(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_512(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_504(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_514(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_502(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_502(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_503(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_504(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_502(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_519(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
struct<4> func_504(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_505(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_508(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_525(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_513(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_504(923904168, func_511(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_504(923904168, func_511(bParam0), -740156546, 0) };
		}
...
struct<4> func_515(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_504(271701509, func_511(bParam0), 12999093, 0) };
		}
...
bool func_518(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_520(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
