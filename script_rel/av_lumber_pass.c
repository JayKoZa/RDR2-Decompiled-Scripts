...
{
	func_33(uParam0, 10887, 10969, 11825);
}
...
{
	func_46(uParam0, "LUMBER_PASS_BALCONY", "script@ambient@town@LUMBER_PASS_BALCONY@action", vParam1, vParam4);
	uParam0->f_17 = 1;
	switch (*uParam0)
	{
		case 10:
...
bool func_28(var uParam0)
{
	if (*uParam0 == 10)
	{
		...
		{
			PED::_0xF7EA250B9A919E03(835253196, uParam0->f_20[0 /*14*/]);
			if (PED::_0x854BC9B1A1CCD034(835253196, uParam0->f_20[0 /*14*/]))
			{
				return true;
			}
		}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1])
	{
		...
		{
			if (func_68(uParam0, 0.5f, fLocal_37, 4, fLocal_38, 1112014848 /* Float: 50f */))
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
	...
	if (uParam0->f_469[2] && !uParam0->f_469[3])
	{
		if (!uParam0->f_469[7])
		{
			if (func_69(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				func_67(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[7] = 1;
			}
			...
			if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
			{
				if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_372[0 /*8*/].f_1))
				{
					if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_372[0 /*8*/]))
					{
						if (*uParam0 == 10)
						{
							PED::_0x3BBDD6143FF16F98(uParam0->f_20[0 /*14*/], uParam0->f_372[0 /*8*/], "p_lumber09_piece01x_PH_R_HAND", "WORLD_HUMAN_LUMBER_PUT_DOWN_1", 0, 1);
							bLocal_39 = true;
						}
						else
						{
				...
				if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
				{
					...
					{
						TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 5000, false, joaat("WORLD_HUMAN_CROUCH_INSPECT_MALE_C"), 0.3f, false);
...
int func_32(var uParam0, var uParam1)
{
	if (*uParam0 == 10)
	{
		...
		{
			PED::_0xDE7B2B4144906CDF(835253196, uParam0->f_20[0 /*14*/]);
		}
	}
...
bool func_65(var uParam0, var uParam1, bool bParam2)
{
	if ((MISC::GET_FRAME_COUNT() % 3) == 0 || bParam2)
	{
		if (func_98(uParam0->f_20[uParam0->f_501 /*14*/], 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return true;
		}
		uParam0->f_501++;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
			{
				...
				fVar8 = func_106(Global_35, uParam0->f_20[iVar0 /*14*/], 1);
				if (fVar8 < fVar1)
				{
					return true;
				}
...
bool func_69(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[iVar0 /*14*/]))
				{
					...
					{
						if ((func_106(Global_35, uParam0->f_20[iVar0 /*14*/], 1) < fParam2 && PED::_0x5102307CE88798EB(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(uParam0->f_20[iVar0 /*14*/]))
						{
							if (!func_107(&(uParam0->f_490)))
							{
								func_111(&(uParam0->f_490), 0);
							}
...
bool func_74(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_100(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_161(0, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				func_161(1, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_161(60, 1, 0, 0, (Global_1415419.f_19[iParam0 /*12*/].f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
bool func_114(var uParam0, float fParam1)
{
	if (!func_107(uParam0))
	{
		return false;
...
int func_159(int iParam0, var uParam1)
{
	...
	{
		return func_212(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
bool func_184(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_186(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_193(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_202(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_208(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_217(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
