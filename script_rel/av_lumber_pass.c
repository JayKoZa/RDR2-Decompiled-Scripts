...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 0, "Male01", joaat("a_m_m_vallaborer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "male", joaat("a_m_m_vallaborer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(1546182539, 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_REQUEST_SCENARIO_TYPE(1546182539, 5, 0, -2144819164);
	func_57(&uLocal_9, 0);
	func_58(&uLocal_9, 1);
	func_59(&uLocal_9, 1);
	func_60(&uLocal_9, 1);
...
int func_31(var uParam0)
{
			...
			if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
			{
				...
				if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
				{
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
					{
						...
						if (*uParam0 == 10)
						{
							TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, -297.13f, 816.86f, 117.82f, 0.5f, 1000, 1, 1, 0, 0);
						}
						TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(0, -300.2f, 817.09f, 117.63f, 0.5f, 90000, 1, 1, 0, 0);
				...
				if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
				{
					...
					{
						TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[1 /*14*/]), 1546182539, 5000, 0, -2144819164, 0.3f, 0);
	...
	if (((uParam0->f_469[5] && uParam0->f_469[6]) // PointerArith && uParam0->f_469[4]) // PointerArith)
	{
		uParam0->f_469[3] = 1;
	}
	if (&uParam0->f_469[3])
...
int func_65(var uParam0, var uParam1, bool bParam2)
{
...
int func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_116((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_217(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
