...
{
	func_33(uParam0, 10741, 10792, 11606);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "SWCMP_WOLF", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -18.5f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "SWCMP_ANIMAL", iLocal_10, vParam1, vParam4.z, 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_MOOSE_M_001"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			{
				uLocal_12[0] = func_63(joaat("STAND"), uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, 0, 0);
				...
				TASK::SET_PED_PATH_PREFER_TO_AVOID_WATER(uParam0->f_20[0 /*14*/], false, 1f);
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				...
				uLocal_12[1] = func_63(joaat("STAND"), uParam0->f_20[1 /*14*/].f_5, uParam0->f_20[1 /*14*/].f_8, 0, 0, 0);
			...
			break;
		case 1:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_62(uParam0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
				{
					...
					TASK::_TASK_SMART_FLEE_STYLE_PED(0, uParam0->f_20[0 /*14*/], 3, 256, -1082130432 /* Float: -1f */, -1, 0);
				...
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					func_64(&(uParam0->f_20[0 /*14*/]), 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, uParam0->f_20[1 /*14*/], 0f, 5f, 0f, 2f, 12000, 1036831949 /* Float: 0.1f */, 1, 1, 0, 1, 1);
					func_67(0, joaat("WORLD_ANIMAL_WOLF_RESTING"), vLocal_15, uParam0->f_20[1 /*14*/].f_8, 45000, 1, 0, 0, -1082130432 /* Float: -1f */);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
...
var func_63(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_65(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
void func_67(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7, bool bParam8, char* sParam9, float fParam10)
{
...
bool func_76(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_111(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_121(iParam1))
		{
			func_122(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_99(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_133(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_135(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_154(int iParam0, var uParam1)
{
	...
	{
		return func_206(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_157(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_111(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_175(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_195(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_215(iVar0, 0)))
		{
...
bool func_180(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_187(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_191(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_195(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_196(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_202(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_211(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_217(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_219(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
