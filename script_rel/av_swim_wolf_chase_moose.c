	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[0]), 20, 1);
				TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[0]), 25, 1);
				TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[0]), 23, 1);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::_SET_SCENARIO_POINT_FLAG(&(uLocal_12[1]), 20, 1);
		...
		case 1:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					...
					func_67(0, 1588806187, vLocal_15, (uParam0->f_20[1 /*14*/])->f_8, 45000, 1, 0, 0, -1082130432 /* Float: -1f */);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
...
void func_67(int iParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_157(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_111((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
