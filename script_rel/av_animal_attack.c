...
void __EntryFunction__()
{
	...
	sLocal_13 = "action";
	iLocal_15 = joaat("AR_BEAR_CHALLENGE_SHORT_KILL");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 10864, 10941, 11629);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 36:
			...
			break;
		case 45:
			iLocal_15 = joaat("AR_ALLIGATOR_LEG_GRAB_CHALLENGE");
			sLocal_12 = "AMB_CREATURES_REPTILE@GATOR@GRAPPLE@STREAMED_CORE";
			iVar0 = joaat("A_C_ALLIGATOR_01");
			break;
	}
	func_49(uParam0, 0, "AAP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "AAP_ANIMAL", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 4f, 0f), (180f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				else
				{
					...
					TASK::TASK_PLAY_ANIM(uParam0->f_20[0 /*14*/], sLocal_10, sLocal_11, 4f, -4f, -1, 1, 0f, false, 0, false, 0, false);
				}
			}
			...
			break;
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_68(uParam0, &uLocal_16, 0))
			{
				if (!uParam0->f_469[1])
				{
					func_69(*uParam0, 0);
		...
		case 3:
			if (!uParam0->f_469[2])
			{
				if (func_71(uParam0, 1065353216 /* Float: 1f */, 105f, 4, joaat("ACTION"), 0))
				{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, var uParam12, var uParam13)
{
...
int func_66(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
bool func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_130(iParam1))
		{
			func_131(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_110(var uParam0, float fParam1)
{
...
bool func_112(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_119(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_120(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
