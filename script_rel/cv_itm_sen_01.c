...
int func_88(var uParam0)
{
	if (func_180(uParam0))
	{
		...
		iLocal_37 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(&(uLocal_22[0]), iLocal_38, 0f, -0.07f, 0.5f, -180f, 0, 0, 0);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_37, 23, 1);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_37, 25, 1);
	}
	return 1;
}
...
int func_90(var uParam0)
{
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_37) && ENTITY::DOES_ENTITY_EXIST(func_9(uParam0, iLocal_15)))
	{
		...
		TASK::_TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), iLocal_37, sLocal_39, 0, 0, true, 0, 0, -1082130432, 0);
	}
	return 1;
}
...
int func_172()
{
	...
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_38, 0))
	{
		return 0;
	}
	iVar0 = 0;
