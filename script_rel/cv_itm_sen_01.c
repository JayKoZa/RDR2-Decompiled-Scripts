...
int func_1(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(uLocal_22[iVar0]);
		}
		iVar0++;
	}
	PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), sLocal_52);
...
int func_88(var uParam0)
{
	if (func_180(uParam0))
	{
		...
		uLocal_37 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(&(uLocal_22[0]), iLocal_38, 0f, -0.07f, 0.5f, -180f, 0, 0, 0);
...
{
	if (TASK::_0x841475AC96E794D1(uLocal_37) && ENTITY::DOES_ENTITY_EXIST(func_9(uParam0, iLocal_15)))
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_22[1])))
		{
			PED::_0x2B02DB082258625F(func_9(uParam0, iLocal_15), &(uLocal_22[1]), "p_bottleJD01x_ph_r_hand", iLocal_38, 0, 1);
		}
		TASK::_TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), uLocal_37, sLocal_39, 0, 0, true, 0, 0, -1082130432, 0);
	}
	return 1;
}
...
int func_91(var uParam0)
{
	...
	{
		uLocal_22[1] = PED::_0x4D0D2E3D8BC000EB(func_9(uParam0, iLocal_15), "p_bottleJD01x_ph_r_hand", 1);
		func_202(&(uLocal_22[1]), &(uParam0->f_1984[iLocal_14]), &(sLocal_32[1]));
		return 1;
	}
	return 0;
}
...
int func_97(var uParam0)
{
	...
	{
		PED::_0x2B02DB082258625F(func_9(uParam0, iLocal_15), &(uLocal_22[1]), "p_bottleJD01x_ph_r_hand", iLocal_38, sLocal_39, 1);
		TASK::_TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), uLocal_37, sLocal_39, 0, 0, true, 0, 0, -1082130432, 0);
...
int func_100(var uParam0)
{
	if (TASK::_0x841475AC96E794D1(uLocal_37))
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_9(uParam0, iLocal_15)))
		{
			if (PED::_0x9C54041BB66BCF9E(func_9(uParam0, iLocal_15), uLocal_37))
			{
				return 0;
			}
			else
			{
				TASK::_0x81948DFE4F5A0283(uLocal_37);
			}
		}
	}
	return 1;
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_223(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_225(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_226(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_226(iParam0, 0));
					func_227(iParam0);
				}
			}
			else
...
void func_131(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_241(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_243(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_224((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_180(var uParam0)
{
	...
	while (iVar0 < 4)
	{
		uLocal_22[iVar0] = func_287(iLocal_21, &(iLocal_27[iVar0]), 0);
		if (!ENTITY::DOES_ENTITY_EXIST(&(uLocal_22[iVar0])))
		{
		}
		else
		{
			...
			while (iVar1 < uParam0->f_1984)
			{
				...
				{
					func_202(&(uLocal_22[iVar0]), &(uParam0->f_1984[iVar1]), &(sLocal_32[iVar0]));
				}
				iVar1++;
			}
		}
...
int func_199(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_220(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_305(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_287(int iParam0, var uParam1, int iParam2)
{
	...
	uVar2 = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iParam2, iVar0);
	uVar3 = MISC::_0x18013392501CE5DC(uVar2);
...
int func_352(int iParam0, bool bParam1)
{
	...
	{
		func_247(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_137(iParam0)));
		if (func_235() == -1)
		{
...
int func_368(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_419(bParam2), iParam0, 0);
	return uVar2;
}
...
void func_377(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5)
{
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		...
		if (bParam4)
		{
			...
			Global_1359489->f_361.f_194 = func_421("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_373(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
int func_417(bool bParam0, int iParam1)
{
	...
	if (func_464(bParam0, 1399091007))
	{
		func_465(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_224(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			{
				_NAMESPACE48::_0x63AA2B8EB087886A(func_224(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_453(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_239(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_239(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_239(iParam5, 32), 1);
...
void func_465(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_469(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_482(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_0xA00DF706C60173D1(func_224(iParam0, 1));
...
void func_484(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_241(iParam1), iParam0, 0);
...
void func_486(int iParam0, float fParam1, int iParam2)
{
	int iVar0;
...
void func_506(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4096 > 0 && func_460(iParam1, 879715242))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 512 > 0 && func_460(iParam1, 1064646155))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1024 > 0 && func_460(iParam1, -536694793))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2048 > 0 && func_460(iParam1, -1304053509))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & -2147483648 > 0 && func_460(iParam1, 718939204))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 65536 > 0 && func_460(iParam1, -972364774))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16384 > 0 && func_460(iParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 262144 > 0 && func_460(iParam1, 1153596794))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 524288 > 0 && func_460(iParam1, 1016389820))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1048576 > 0 && func_460(iParam1, -726966617))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2097152 > 0 && func_460(iParam1, 1365901568))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 32768 > 0 && func_460(iParam1, -1658942149))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 131072 > 0 && func_460(iParam1, -1980913856))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4194304 > 0 && func_460(iParam1, 491764525))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8388608 > 0 && func_460(iParam1, -76015264))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16777216 > 0 && func_460(iParam1, 622113465))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 33554432 > 0 && func_460(iParam1, 781533162))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 67108864 > 0 && func_460(iParam1, -271415321))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 134217728 > 0 && func_460(iParam1, -1683207356))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 268435456 > 0 && func_460(iParam1, -254794762))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 536870912 > 0 && func_460(iParam1, 609066278))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1073741824 > 0 && func_460(iParam1, -1712783565))
	{
		PED::_0x1902C4CFCC5BE57C(iParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8192 > 0 && func_460(iParam1, 1544915253))
	{
...
bool func_509(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_531(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_532(iParam0, &bVar0, &fVar25);
...
struct<4> func_511(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_419(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
int func_531(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_541(bParam0, &Var0, iVar5, 0))
			{
				if (func_542(bParam0, &Var6, iVar5))
				{
					Var29 = { func_511(bParam0, Var0, iVar5, 0) };
					func_543(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_544(0))
				{
					...
					func_545(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
...
void func_532(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_539(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_416(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_511(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_549(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_541(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_541(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_542(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_552(bParam0, -1823706425))
			{
				Var0 = { func_511(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_552(bParam0, -1483207246))
			{
				Var0 = { func_511(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_541(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_554(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_542(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_555(bParam0, &uVar0, uParam1, iParam2))
	{
...
int func_543(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_545(bool bParam0, int iParam1, int iParam2)
{
	if (iParam1 < 1)
	{
		return 1;
...
void func_546(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_558(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
...
{
	if (func_551(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_559(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_554(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_511(bParam0, Param1, iParam5, bParam6) };
...
int func_555(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_419(0);
	*uParam1 = { func_511(bParam0, func_467(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
