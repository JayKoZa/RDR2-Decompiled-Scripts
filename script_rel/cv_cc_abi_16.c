...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1.2112f, -0.373f, 1.0018f, 70.397f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, -0.5889f, -1.3602f, 0.6039f, -53.7594f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, 0.5611f, 1.2023f, 0.6039f, -25.2594f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, 4.0922f, -2.2747f, 1.0018f, 41.6379f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
...
struct<5> func_502(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_514(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_506(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_504(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_504(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_505(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_506(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_510(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_527(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
