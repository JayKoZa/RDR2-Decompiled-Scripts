...
int func_93(var uParam0)
{
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_96))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_49(uParam0, iLocal_39)))
		{
			...
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_96, 23, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_96, 25, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_96, 8, 1);
		}
		return 0;
	}
...
int func_114(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_127(iVar0, 0))
	{
		if (func_127(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
void func_231()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, iLocal_96, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
