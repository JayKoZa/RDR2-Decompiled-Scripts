...
int func_1(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_96))
	{
		TASK::_0x81948DFE4F5A0283(uLocal_96);
	}
...
int func_78(var uParam0)
{
	...
	func_167(uParam0, iLocal_18, 2, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_38, 0, 110f, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	if (!TASK::_0x841475AC96E794D1(uLocal_96))
	{
		...
		{
			uLocal_96 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_49(uParam0, iLocal_39), -229964281, 0f, 0f, 0.5f, -180f, 0, 0, 0);
			TASK::_0x5AF19B6CC2115D34(uLocal_96, 23, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_96, 25, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_96, 8, 1);
		}
		return 0;
	}
...
void func_231()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, uLocal_96, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
...
int func_292(int iParam0)
{
	...
	Var7 = { func_393(-1756227506, joaat("animal")) };
...
int func_297(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_479(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_265(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_265(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_265(iParam5, 32), 1);
...
bool func_525(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
