...
struct<4> func_66(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_95(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_70(int iParam0, int iParam1, int iParam2)
{
	...
	if (WEAPON::_GET_PED_WEAPON_INVENTORY_UID(Global_35, iParam2, &uVar50) && func_31(func_30(Global_35, iParam2, 1, 0)))
	{
...
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_95(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
bool func_102(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (func_112(Var22.f_6, &iVar44))
		{
			...
			func_114(MISC::_CREATE_VAR_STRING(42, "WL_TICKER_EQUIPPED_TO", &cVar45, &cVar53), -2, 0, 0, 0, 1);
		}
	}
	return true;
}
...
bool func_109(var uParam0, var uParam1)
{
	...
	DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(*uParam0, func_120(15), &(uParam1->f_10));
...
bool func_145(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_95(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
