...
{
	func_33(uParam0, 11042, 11165, 11591);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "PASSENGER", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4.5f, 1.5f, 0f), (vParam4.z - 75f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "WAGON_DRIVER", joaat("S_M_M_COACHTAXIDRIVER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, 1.5f, 0f), (vParam4.z + 110f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (func_72(uParam0, 1065353216 /* Float: 1f */, 80f, 4, 60f, 1112014848 /* Float: 50f */))
		{
			func_70(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[6])
		{
			if (func_73(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
			{
				func_71(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
...
void func_58(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
...
void func_69(var uParam0)
{
	...
	while (iVar0 < 6)
	{
		...
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(uParam0->f_20[iVar0 /*14*/], false, true);
...
void func_104(var uParam0, int iParam1)
{
	...
	{
		TASK::TASK_SMART_FLEE_PED(uParam0->f_20[iParam1 /*14*/], Global_35, -1f, -1, 0, 1077936128 /* Float: 3f */, 0);
	}
}
...
bool func_120(var uParam0, float fParam1)
{
	if (!func_113(uParam0))
	{
		return false;
...
void func_167(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_223(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
