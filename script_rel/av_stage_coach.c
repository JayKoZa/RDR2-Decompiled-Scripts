...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "PASSENGER", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4.5f, 1.5f, 0f), (vParam4.z - 75f), 1, 0, 1, 1, 41788943, 1);
...
int func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		...
		func_58(&(uParam0->f_20[1 /*14*/]), -22664287, 0, 0, 1317331863, -1082130432 /* Float: -1f */);
	}
...
void func_58(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
