...
int func_72(var uParam0)
{
	...
	func_158(uParam0, iLocal_14, 2, 201363338, "PROP_HUMAN_SEAT_CHAIR_SMOKING_FEMALE_A", uLocal_16, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_14, iLocal_18, "p_cigarette_cs01x_PH_R_HAND", 0, 0);
	func_160(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", uLocal_17, 0);
	func_158(uParam0, iLocal_15, 2, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", uLocal_17, 0, -1f, 1065353216 /* Float: 1f */, 1);
