...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, -3.1201f, 0.72f, 1.1079f, -6.33f, 2.5f, 2.5f, 2.5f, joaat("VOLCYLINDER"), -1, 1, 1, 1);
	...
	iLocal_15 = func_159(uParam0, -2.19f, 3.84f, 0f, 0f, 0f, -32.72f, 8f, 8f, 5f, "volTrigger", joaat("VOLBOX"));
	func_160(uParam0, 1);
...
{
	return func_192(uParam0, &iLocal_15, 1);
}
...
bool func_192(var uParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	return func_294(Global_35, *iParam1, 1, 0);
}
