...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.056f, -1.5225f, 0.5926f, 43.701f, 1.2f, 1.2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, 1.2237f, -1.9219f, 0.4796f, 34.7593f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_152(uParam0, 0.0925846f, -1.14187f, 0.979996f, 0f, 1.5f, 1.5f, 3f, joaat("VOLCYLINDER"), 1);
...
struct<5> func_492(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_504(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_494(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_494(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_495(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
void func_500(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_517(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
