...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 5.2264f, -6.6722f, 0.5193f, 170.3144f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, 0.4954f, -2.8251f, 0.6547f, -90.36f, 1.5f, 1.8f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_392(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
