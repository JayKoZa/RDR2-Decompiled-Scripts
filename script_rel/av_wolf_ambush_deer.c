...
{
	if (!STREAMING::_HAS_SCENARIO_TYPE_LOADED(1974927641, 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_REQUEST_SCENARIO_TYPE(1974927641, 1, 0, 0);
	func_57(&uLocal_28, 0);
	func_58(&uLocal_28, 1);
	func_59(&uLocal_28, 1);
	func_60(&uLocal_28, 1);
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
							{
								...
								TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), 1974927641, Local_11.f_6, Local_11.f_9.f_2, 0, 0, 1, 0, -1082130432, 0);
