...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else
		{
			...
			if (VOLUME::_DOES_VOLUME_EXIST(iLocal_178) && func_8(Global_35, iLocal_178, 1, 0))
			{
			...
			if (iLocal_22 == 28 || (((iLocal_22 >= 6 && iLocal_22 <= 27) && ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, 0)) && ANIMSCENE::_0x8D81E7824B7753F7(iLocal_188, "s_base_end", 1)))
			{
				if (bLocal_296)
				{
					if (func_16(&uLocal_271))
					{
						if ((VOLUME::_DOES_VOLUME_EXIST(iLocal_177) && !ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_177, true, 0)) && !ENTITY::IS_ENTITY_ON_SCREEN(&(uLocal_171[0])))
						{
							func_1(1, 1);
						}
					}
			...
			switch (iLocal_22)
			{
				case 0:
					...
					if (!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_188))
					{
					...
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_188) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_189))
					{
						if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_188, 1, 0) || !ANIMSCENE::_IS_ANIM_SCENE_LOADING(iLocal_188, 1))
						{
							ANIMSCENE::LOAD_ANIM_SCENE(iLocal_188);
						}
						if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_189, 1, 0) || !ANIMSCENE::_IS_ANIM_SCENE_LOADING(iLocal_189, 1))
						{
						...
						POPULATION::_0xB56D41A694E42E86(iLocal_180, 2500607, 0, 0, -1, -1, 10);
						POPULATION::_0x18262CAFEBB5FBE1(iLocal_180, 0, 0, 0, -1, -1, 0);
				...
				case 1:
					bVar1 = true;
					if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_188, 1, 0))
					{
						bVar1 = false;
					}
					if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_189, 1, 0))
					{
						bVar1 = false;
					}
				...
				case 2:
					if ((((func_62(uLocal_171[0], iLocal_166, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_63(&iLocal_173, iLocal_168, 2644.251f, -1208.702f, 53.5354f)) && func_63(&iLocal_174, iLocal_168, 2643.541f, -1208.416f, 53.1764f)) && func_63(&iLocal_175, iLocal_169, 2644.625f, -1208.099f, -108.1324f)) && func_63(&iLocal_176, iLocal_167, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(&(uLocal_171[0]), 0))
						{
							...
							ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(uLocal_171[0]), 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1);
							PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), &(uLocal_171[0]), "SPECIAL_PED_LIGHTWEIGHT_1_1", 0f, 0f, 0f, 0, "TimothyBubble");
							PED::_0x7C00CFC48A782DC0(iLocal_183, &(uLocal_171[0]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
					...
					if (func_18(iLocal_190, 2) && !func_18(iLocal_190, 4))
					{
						if ((func_18(iLocal_190, 16) || func_18(iLocal_190, 32)) || func_18(iLocal_190, 1024))
						{
							...
							if (func_80(&(uLocal_171[0]), iLocal_189, func_78(), func_79(), 0, 1056964608 /* Float: 0.5f */, 20000))
							{
								if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_188))
								{
									if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_188, 0))
									{
				...
				case 4:
					...
					else if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_189))
					{
				...
				case 32:
					...
					if (ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_79()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_189) > 0.95f)
					{
						func_61(34);
					}
					else if ((ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_79()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_189) > 0.65f) && !func_18(iLocal_190, 256))
					{
				...
				case 33:
					...
					if (ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_115()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_189) > 0.9f)
					{
						ANIMSCENE::RESET_ANIM_SCENE(iLocal_188, func_4());
						func_111(1);
...
void func_1(bool bParam0, bool bParam1)
{
	...
	if (PED::_0x91A5F9CBEBB9D936(uLocal_184))
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_184, false);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_177))
	{
		func_123(iLocal_177);
		VOLUME::_DELETE_VOLUME(iLocal_177);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_181))
	{
		VOLUME::_DELETE_VOLUME(iLocal_181);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_180))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_180);
		POPULATION::_0xA1CFB35069D23C23(iLocal_180);
		VOLUME::_DELETE_VOLUME(iLocal_180);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_178))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_178);
		POPULATION::_0xA1CFB35069D23C23(iLocal_178);
		VOLUME::_DELETE_VOLUME(iLocal_178);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_179))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_179);
		POPULATION::_0xA1CFB35069D23C23(iLocal_179);
		VOLUME::_DELETE_VOLUME(iLocal_179);
	}
...
int func_5(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	{
		bVar0 = ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, 0);
...
void func_17()
{
	...
	if (bLocal_18)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_173))
		{
			...
			ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_173, 1, 0f, 0f, 0.5f, 0f, 0f, -0.1f, 0, true, true, true, false, true);
		}
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_174))
		{
			...
			ENTITY::APPLY_FORCE_TO_ENTITY(iLocal_174, 1, 0f, 0f, 0.5f, 0f, 0f, -0.1f, 0, true, true, true, false, true);
		}
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "TimothyConvo");
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "TimothyBubble");
		TASK::_TASK_SMART_FLEE_STYLE_PED(&(uLocal_171[0]), Global_35, 3, 0, -1082130432, -1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_171[0]), 17, true);
...
void func_25(int iParam0)
{
	...
	if (fLocal_17 < 15f)
	{
		if (func_18(iLocal_190, 16384))
		{
			...
			{
				PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "TimothyBubble");
				PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), &(uLocal_171[0]), "SPECIAL_PED_GENERIC_INTERACT_FOCUS", 0f, 0f, 0f, 0, "TimothyConvo");
...
void func_31()
{
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_177))
	{
		iLocal_177 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(2644.527f, -1208.351f, 52.287f, 0f, 0f, 0f, 32f, 32f, 32f, "RandomEventBlock");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_178))
	{
		iLocal_178 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2644.405f, -1210.138f, 53.7178f, 0f, 0f, 0f, 2f, 3f, 3f, "Trigger");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_179))
	{
		iLocal_179 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2644.642f, -1210.8f, 61.5079f, 0f, 0f, 0f, 7f, 3f, 10f, "Notice");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_180))
	{
		iLocal_180 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2644.397f, -1208.503f, 53.77906f, 0f, 0f, 0f, 6f, 2f, 4f, "StayAway");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_181))
	{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_183))
	{
		iLocal_183 = VOLUME::_0x0EB78C2B156635B1(665633627, 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
		VOLUME::_0xBE551C2CC421185D(iLocal_183, 1);
		VOLUME::_0x5B23DFF8E0948BB2(iLocal_183, 0);
	}
}
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		func_196(iParam0, iParam1, iParam2, uVar0);
	}
...
int func_80(int iParam0, int iParam1, char* sParam2, char* sParam3, bool bParam4, float fParam5, int iParam6)
{
	...
	if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(iParam1, sParam2, &vVar1, false, sParam3, 2))
	{
		...
		else if ((bParam4 && !func_206(Global_35, 242628503)) || (((!bParam4 && ENTITY::IS_ENTITY_AT_COORD(Global_35, vVar1, 2.5f, 2.5f, 3f, false, true, 0)) && !AUDIO::IS_ANY_SPEECH_PLAYING(Global_35)) && !AUDIO::IS_ANY_SPEECH_PLAYING(iParam0)))
		{
			bLocal_14 = false;
			return 1;
		}
...
int func_81(int iParam0)
{
	...
	bVar0 = ANIMSCENE::_IS_ANIM_SCENE_LOADED(*iParam0, 1, 0);
	bVar1 = ANIMSCENE::_IS_ANIM_SCENE_STARTED(*iParam0, 0);
	if (bVar0 || bVar1)
	{
		return 1;
	}
	bVar3 = ANIMSCENE::_DOES_ANIM_SCENE_EXIST(*iParam0);
	bVar2 = ANIMSCENE::_IS_ANIM_SCENE_LOADING(*iParam0, 1);
...
int func_113(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_174(iParam0) == joaat("ammo") && func_255(iParam0))
		{
		...
		else if (func_243(iParam0, 589988438))
		{
			if (func_264())
			{
				func_265(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -1185145312: /* GXTEntry: "Upgraded Off-Hand Holster" */
				...
				{
					func_277(PLAYER::PLAYER_PED_ID(), -1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_278(&iVar9, 0))
				{
			...
			case 1171350303: /* GXTEntry: "Upgraded Bandolier" */
				...
				{
					func_277(PLAYER::PLAYER_PED_ID(), 1171350303 /* GXTEntry: "Upgraded Bandolier" */, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_293(242, func_292(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_293(240, func_292(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_293(241, func_292(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
...
int func_155(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_169()
{
	...
	{
		PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "TimothyConvo");
		PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), &(uLocal_171[0]), "SPECIAL_PED_LIGHTWEIGHT_1_1", 0f, 0f, 0f, 0, "TimothyBubble");
...
int func_176(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_369(bParam2), iParam0, 0);
	return iVar2;
}
...
var func_196(int iParam0, int iParam1, int iParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
var func_203(int iParam0, var uParam1)
{
		...
		if (iVar0 > uParam0->f_9)
		{
				...
				if (!HUD::_UIPROMPT_HAS_HOLD_AUTO_FILL_MODE(((*Global_1945938)[uParam0->f_5 /*18*/])->f_3))
				{
					...
					if ((fVar2 == 0f || fVar2 < uParam0->f_16) && (fVar3 == 0f || fVar3 < uParam0->f_17))
					{
						...
						if (uParam0->f_12 > 0)
						{
							...
							uParam0->f_5 = func_390(uParam0->f_7, joaat("INPUT_INTERACT_LOCKON_POS"), 6, 600, iVar1, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 1);
						}
						else
						{
			...
			else if (!HUD::_UIPROMPT_HAS_HOLD_AUTO_FILL_MODE(((*Global_1945938)[uParam0->f_6 /*18*/])->f_3))
			{
				...
				if ((fVar2 == 0f || fVar2 < uParam0->f_16) && (fVar3 == 0f || fVar3 < uParam0->f_17))
				{
					...
					{
						iVar1 = ((uParam0->f_11 + uParam0->f_12) - iVar0 + 20);
						uParam0->f_6 = func_390(uParam0->f_8, joaat("INPUT_INTERACT_LOCKON_NEG"), 6, 600, iVar1, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 1);
					}
					else
					{
...
bool func_216(int iParam0, int iParam1)
{
	...
	{
		uVar0 = func_195(iParam0);
		return func_196(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
void func_223(int iParam0, char* sParam1, int iParam2)
{
	...
	func_394(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_421(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, 1433015236, MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_421(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, 1433015236, MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
int func_252(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
int func_254(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_403(iParam0, &uVar1, 1, 0, 0))
		{
			...
			{
				if (iVar0 == joaat("weapon_melee_knife_john") && !func_39())
				{
					return 0;
				}
				...
				{
					func_252(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				iVar7 = func_439(Global_35, 2, 0, 1);
				if ((((func_366(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_27(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_366(iVar7) && func_27(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
					if (!func_252(iVar0, iVar6, bParam3, bParam4, 3, 1, iParam1, 0))
					{
						return 0;
					}
				}
				else if (!func_252(iVar0, iVar6, bParam3, bParam4, 0, 1, iParam1, 0))
				{
					return 0;
				}
			}
...
int func_256(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_27(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_264()
{
	if (((((func_450(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_450(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_450(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_450(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_450(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_450(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
	...
	if (func_184() == -1)
	{
		...
		else if (func_243(iParam0, -1478961327))
		{
			...
			if (func_465() == 2)
			{
				...
				if (iParam0 == 2116770557)
				{
					if (!func_469(COLLECTION::_0x126CBEBBA46693CF(iVar0, 2114735110, 0)) >= 25)
					{
						func_470(COLLECTION::_0x126CBEBBA46693CF(iVar0, 2114735110, 0), 1);
						func_407(48);
					}
					if (func_467(iParam0) < func_468(iParam0))
					{
...
void func_274(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		...
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_265(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_265(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_265(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_265(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_265(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -343824903: /* GXTEntry: "Money Clip" */
			func_265(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_265(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
...
int func_277(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	...
	switch (iParam3)
	{
		...
		case 1742327865:
			...
			break;
		case 1108822547:
			if (func_484(32768) && iParam1 != &Global_1946804->f_57[func_480(iParam3, 1) /*11*/])
			{
				func_485();
...
void func_285(int iParam0, bool bParam1)
{
	...
	func_421(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), 1433015236, MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_304(int iParam0, char* sParam1)
{
	...
	func_394(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_508(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_305(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	sVar15 = func_513(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, func_292(iParam0)), iVar1), iVar12);
	if (((((iParam1 == 1 || func_243(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
		sVar15 = MISC::_CREATE_VAR_STRING(0, func_292(iParam0));
	}
...
int func_319(int iParam0, vector3 vParam1, int iParam4)
{
...
int func_320(int iParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_332(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_333(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_400(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_369(bParam3), iParam0);
}
...
int func_401(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_369(bParam1), iParam0, 0);
}
...
int func_403(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar28 = INVENTORY::_0xE787F05DFC977BDE(func_369(bParam4), iParam0, 0);
	}
...
int func_418(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_422(func_634(iVar0))), func_422(func_634(iVar0)), bVar1, 1, 0);
		}
		if (iParam2 == -440187297)
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_637(iVar0)), func_637(iVar0), bVar1, 1, 0);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == -1531394072)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_640(iVar2)), func_640(iVar2), bVar1, 1, 0);
		}
		if (iParam2 == 1995362678)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_642(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_642(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, 1, 0);
		}
		if (iParam2 == 2103522376)
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_643(iVar0)), func_643(iVar0), bVar1, 1, 0);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == 678508515)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_645(iVar2)), func_645(iVar2), bVar1, 1, 0);
		}
		iVar0++;
	}
	return 1;
...
struct<4> func_433(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_369(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_434(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_369(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_442(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_243(iParam1, 866047851))
	{
		...
		if (func_663(&(Global_1946804->f_1497)) >= 2 && &Global_1946804->f_1497.f_1[iVar5 /*3*/] != iVar8)
		{
	...
	switch (iVar4)
	{
		...
		case -1944638739:
			iVar5 = 35;
			if (&Global_1946804->f_1497.f_1[iVar5 /*3*/] != &Global_1946804->f_57[iVar5 /*11*/] && func_243(iParam1, -1638171711))
			{
    ...
    "" */
				...
				iVar5 = 36;
				iVar6 = 35;
				if (iParam1 != &Global_1946804->f_57[iVar6 /*11*/] && func_243(&(Global_1946804->f_1497.f_1[iVar5 /*3*/]), -1638171711))
				{
...
int func_451(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_27(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_452(int iParam0, char* sParam1, int iParam2)
{
	...
	func_394(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_453(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_394(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_394(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_460()
{
	...
	while (iVar1 < 30)
	{
		if (func_672(COLLECTION::_0x126CBEBBA46693CF(iVar1, -440187297, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_462(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_481(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((func_484(32768) && iParam2 == 10) && iParam0 != &Global_1946804->f_57[iParam2 /*11*/])
	{
	...
	func_688(&(Global_1946804->f_1378), iParam0, iParam2, bParam4, 1);
	if (iParam1 == 0)
	{
		iParam1 = (Global_1946804->f_1378.f_1[iParam2 /*3*/])->f_1;
	}
	Global_1946804->f_1378.f_1[iParam2 /*3*/] = iParam0;
	(Global_1946804->f_1378.f_1[iParam2 /*3*/])->f_1 = func_689(iParam0, iParam2, iParam1, func_184() != -1);
	if (bParam4)
	{
...
int func_494(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_369(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_498(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_719(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_720(iParam0, 6);
	if (bParam2)
	{
...
int func_508(int iParam0)
{
	...
	if (!func_726(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_524(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_530(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_548(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_733(iVar0, 0)))
		{
			if (func_734(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_534(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_733(iVar0, 0)))
		{
			if (func_735(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
{
	if (func_736(iParam0, vParam4, 0.5f))
	{
...
int func_546(int iParam0, int iParam1)
{
	...
	if (func_739(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
...
int func_564(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		uVar5 = func_744(*uParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
...
{
	return func_764(iParam0, iParam1, sParam2, sParam3, fParam4, uParam5, bParam6, bParam7, iParam8, bParam9, bParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
int func_614(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
{
	if (func_784(iParam0) && func_27(iParam0, 1, 0))
	{
		return 1;
	}
	else if (func_785(iParam0) && func_786(iParam0))
	{
		return 1;
	}
	return 0;
...
char* func_645(int iParam0)
{
	...
	return HUD::_GET_LABEL_TEXT_BY_HASH(func_292(iParam0));
}
...
int func_655(int iParam0)
{
	...
	return &(Global_1946804->f_1497.f_1[func_480(iParam0, 1) /*3*/]);
}
...
int func_657(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
void func_671(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_669())
	{
		func_394(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_394(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
void func_688(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_689(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_804(0);
	if (iParam2 != 0 && func_805(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
	if (func_806(iParam0, func_682(iParam1, 1), &iParam2))
	{
		return iParam2;
	}
	return 0;
...
void func_690(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_807(iVar5, 6) || &uParam0->f_1[iVar0 /*3*/] == &Global_1946804->f_57[iVar0 /*11*/])
			{
			}
			else
			{
				iVar4 = func_665(&(uParam0->f_1[iVar0 /*3*/]), iVar5, uVar7, bVar6);
				if ((iVar1 + iVar4) > 31)
				{
					iVar3 = iVar2;
				}
...
int func_726(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_733(int iParam0, int iParam1)
{
	var uVar0;
...
int func_734(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_735(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
bool func_736(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_739(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
int func_764(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	bool bVar0;
	float fVar1;
	int iVar2;
	...
	if (bParam9)
	{
		if (iParam0 != Global_35 && iParam1 != Global_35)
		{
			if (!ENTITY::IS_ENTITY_DEAD(iParam0))
			{
				if (func_846(iParam0, 1, 1) > fParam4)
				{
					return -1;
				}
			}
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			if (!bVar0 && bParam10)
			{
				...
				if (func_847(iParam0, iParam1, fVar1, bParam13))
				{
...
void func_779(int iParam0, int iParam1, int iParam2)
{
	...
	func_421(sVar7, sVar1, uVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_858(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
float func_846(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return -1f;
...
int func_847(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return 0;
...
void func_860(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		func_897(iVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
		if (func_898(&(iParam1->f_1), iVar0, iParam1->f_7, iParam1->f_5))
		{
		}
	}
}
...
void func_863(int iParam0)
{
	...
	while (iVar0 < Global_1946804->f_2657.f_19)
	{
		...
		{
			func_901(&(Global_1946804->f_2657.f_26.f_26), iVar2, iVar0);
		}
		if (func_902(iVar2, 0))
		{
			func_903(iVar2, &Global_1946804->f_1497.f_1[iVar1 /*3*/] == &Global_1946804->f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_864(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_21), Global_1946804->f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_20), Global_1946804->f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_22), Global_1946804->f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_905(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
	...
	if (func_909(iVar0))
	{
		INVENTORY::_0x766315A564594401(func_369(0), iParam0, 0);
	}
	func_903(iParam0, bParam3);
	if (bParam2)
	{
		func_812(0, 0);
	}
...
int func_889(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_514(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_605(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_897(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
void func_899(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case -2061583405:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_21));
			break;
		case 81053684:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_23));
			break;
		case -999503751:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_20));
			break;
		case -525676072:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_22));
			break;
		case -1719060085:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_24));
			break;
		case -413129408:
			bVar0 = func_924(iParam0, &(Global_1946804->f_2657.f_25));
			break;
	}
	if (!bVar0)
	{
...
void func_901(var uParam0, int iParam1, int iParam2)
{
	...
	func_926(uParam0->f_1[*uParam0 /*5*/], iParam1, -1, 1, 0);
	*uParam0++;
}
...
int func_905(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	...
	if (func_927(iVar1, &uVar0))
	{
		return 0;
	}
	if (bParam3 && !func_902(iParam0, 0))
	{
		return 0;
	}
	...
	{
		func_901(&(Global_1946804->f_2657.f_26.f_26), iParam0, Global_1946804->f_2657.f_19);
	}
...
void func_926(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
...
void func_939(var uParam0, var uParam1, var uParam2)
{
	var uVar0;

	uVar0 = func_940(func_499());
	if (*uParam0)
	{
		func_938(uParam0);
	}
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(uVar0, uParam1, 0, func_184() != -1, uParam2);
	*uParam0 = 1;
}
