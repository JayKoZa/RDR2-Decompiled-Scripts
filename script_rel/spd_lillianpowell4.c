					...
					case 2:
						if (((func_66(&iLocal_253, iLocal_249, 2636.429f, -1229.537f, 52.3795f, 358.7895f, 2, bLocal_385, !bLocal_385) && func_67(&iLocal_256, iLocal_251, 2636.611f, -1230.318f, 52.8894f)) && func_67(&iLocal_257, iLocal_252, 2637.884f, -1230.344f, 53.1922f)) && func_67(&iLocal_255, iLocal_250, 2637.932f, -1230.235f, 53.2323f))
						{
							if (func_4(iLocal_253, 0))
							{
								...
								func_70(&iLocal_253, &uLocal_273, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
...
void func_1()
{
	...
	func_172(&iLocal_253, &uLocal_273, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
...
void func_72(int iParam0, int iParam1, char[4] cParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_245(&(Local_317[iParam0 /*58*/].f_21[iParam1 /*17*/]), cParam2, sParam3, iParam4, iParam5, iParam6, 0, 1, 0);
	if (bParam7)
	{
...
bool func_409(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_179(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
