...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_253))
		{
			...
			{
				if ((((func_5(iLocal_272, 32768) && func_5(iLocal_272, 1048576)) && !bLocal_311) && !func_5(iLocal_272, 4194304)) && iLocal_14 != 84)
				{
					func_6();
				}
		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				{
					func_20(16, 3, &iLocal_253, &uLocal_245, &uLocal_279, 0, 1097859072 /* Float: 15f */, 0);
				}
				...
				if ((((ENTITY::DOES_ENTITY_EXIST(iLocal_253) && !ENTITY::IS_ENTITY_DEAD(iLocal_253)) && iLocal_14 != 84) && VOLUME::_DOES_VOLUME_EXIST(iLocal_266)) && func_28(Global_35, iLocal_266, 1, 0))
				{
				...
				switch (iLocal_14)
				{
					...
					case 2:
						if (((func_66(&iLocal_253, iLocal_249, 2636.429f, -1229.537f, 52.3795f, 358.7895f, 2, bLocal_385, !bLocal_385) && func_67(&iLocal_256, iLocal_251, 2636.611f, -1230.318f, 52.8894f)) && func_67(&iLocal_257, iLocal_252, 2637.884f, -1230.344f, 53.1922f)) && func_67(&iLocal_255, iLocal_250, 2637.932f, -1230.235f, 53.2323f))
						{
							if (func_4(iLocal_253, 0))
							{
								...
								func_70(&iLocal_253, &uLocal_273, 161068336, 20f, -1082130432 /* Float: -1f */);
								...
								func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 54:
						...
						if ((func_5(iLocal_272, 2) && func_5(iLocal_272, 256)) && !func_5(iLocal_272, 4))
						{
							...
							func_102(1);
							func_103(iLocal_253, 1.2f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1);
					...
					case 4:
						...
						else
						{
							if (!func_5(iLocal_272, 1024))
							{
								func_101(&iLocal_261, &iLocal_387, &uLocal_388);
								func_102(1);
								if (func_103(iLocal_253, 1.2f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1))
								{
					...
					case 76:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_151()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_271) >= func_154(76))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 77:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_155()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_271) >= func_154(77))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
					...
					case 79:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_156()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_271) >= func_154(79))
						{
							func_102(0);
							func_152();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
...
void func_1()
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(((*(*Global_1396257)[16 /*638*/])[3 /*48*/])->f_47))
	{
		VOLUME::_DELETE_VOLUME(((*(*Global_1396257)[16 /*638*/])[3 /*48*/])->f_47);
	}
...
int func_7(float fParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (bParam5)
	{
		bVar1 = func_180(&uLocal_213, &iLocal_241, &iLocal_253, &uLocal_389, 1101004800 /* Float: 20f */);
	}
	else
	{
...
int func_30(int iParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_224(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
void func_70(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		return;
	...
	switch (iLocal_309)
	{
		...
		case 10:
			if (iLocal_307 != -1)
			{
				...
				{
					func_255(&iLocal_307, cLocal_268);
				}
...
int func_103(int iParam0, float fParam1, float fParam2, int iParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8)
{
	vector3 vVar0;
	int iVar3;
...
int func_212()
{
	if (fLocal_258 <= 8f && func_5(iLocal_272, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	return 0;
...
int func_213(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_329(&iLocal_253, Local_317[iParam0 /*58*/], 8f, &((Local_317[iParam0 /*58*/])->f_21), 0f, 2, 1, iVar1, (Local_317[iParam0 /*58*/])->f_56, 0, 0, 2, -1082130432 /* Float: -1f */);
	if (func_330())
	{
...
int func_214()
{
	...
	if (!func_5(iLocal_272, 2) && func_331(0, &iVar0))
	{
		...
		func_24(&iLocal_272, 1073741824 /* Float: 2f */);
...
int func_318(int iParam0, var uParam1)
{
	...
	{
		return func_437(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_322(var uParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_445(iParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
...
int func_330()
{
	if ((((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630->f_12) && VOLUME::_DOES_VOLUME_EXIST(iLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_260, true, 0)) && func_178(Global_35, iLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_316)) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_253)) || func_455())) && iLocal_14 != 82) && iLocal_14 != 6) && iLocal_14 != 7) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return 1;
	}
...
bool func_343(int iParam0, bool bParam1)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_467(iParam0)))
	{
		return false;
	}
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_467(iParam0));
}
...
int func_442(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	var uVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		uVar5 = func_506(*iParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
			PED::SET_PED_CONFIG_FLAG(*iParam0, 178, false);
			return 1;
...
int func_456()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_524())
	{
		return 1;
	}
	return 0;
...
int func_510(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
int func_548(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_527(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_552(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
