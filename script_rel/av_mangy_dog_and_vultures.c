...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[1] && !bLocal_48)
	{
		...
		if (!bLocal_47)
		{
			...
			{
				iLocal_12 = VOLUME::_CREATE_VOLUME_CYLINDER(vVar1, 0f, 0f, 0f, 30f, 30f, 30f);
				POPULATION::_0xB56D41A694E42E86(iLocal_12, 224, 0, 0, -1, -1, 0);
				POPULATION::_0x18262CAFEBB5FBE1(iLocal_12, 224, 0, 0, -1, -1, 0);
			}
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_12))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_12);
		POPULATION::_0xA1CFB35069D23C23(iLocal_12);
		func_5(iLocal_12);
	}
	return 1;
}
