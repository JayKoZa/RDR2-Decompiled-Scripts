...
{
	func_33(uParam0, 10881, 10960, 11991);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_51)
	{
		if (!uParam0->f_469[1])
		{
			...
			{
				if (func_74(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (func_76(uParam0, 1.5f, 80f, 4, joaat("ACTION"), 1))
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
					...
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[0 /*14*/].f_1))
							{
								...
								TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_BIG_CAT_EATING"), Local_11.f_6, Local_11.f_9.f_2, 0, false, true, 0, -1f, false);
			...
			else if (!uParam0->f_469[4])
			{
				...
				{
					if (PED::_IS_PED_USING_SCENARIO_HASH(uParam0->f_20[0 /*14*/], joaat("WORLD_ANIMAL_BIG_CAT_EATING")))
					{
...
bool func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_76(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_86(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_108(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_149(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_114(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_127(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_151(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_152(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
