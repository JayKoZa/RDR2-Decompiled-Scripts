					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						...
						if (!&uParam0->f_469[5])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
							{
								...
								func_72(&(uParam0->f_20[1 /*14*/]), -22664287, 60000, 0, -1409704321, 0.7f);
...
int func_40(bool bParam0, vector3 vParam1)
{
	switch (bParam0)
	{
		case 58:
...
int func_42(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
...
void func_72(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, float fParam5)
{
	TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0, iParam1, iParam2, iParam3, iParam4, fParam5, 0);
}
