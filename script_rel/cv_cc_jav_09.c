...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -0.875f, -3.4125f, 0.9f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_152(uParam0, 4.3625f, -1.225f, 0.7625f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_152(uParam0, 13.3375f, -6.3875f, 1.075f, -24.25f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_153(uParam0, 3.6f, -2.56f, 1.0889f, 16.2f, 2f, 1.2f, 2f, joaat("VOLCYLINDER"), 1);
	func_154(uParam0, "script@vignette@javier_9@base", 1, 1, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@javier_9@action", 0, 0, 1, 0);
	...
	func_159(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 20f, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
