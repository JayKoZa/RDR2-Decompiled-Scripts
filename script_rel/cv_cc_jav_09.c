...
{
	if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(iLocal_24))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_24, true);
	}
	return 1;
}
...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 6:
			...
			vLocal_21 = { 2346.25f, 1350.42f, 105.1f };
			break;
		default:
			return 0;
	}
	...
	func_151(uParam0, 2038152081, 0f, 0f, 0f, "BASIN", 0, 1, 1);
	func_151(uParam0, joaat("p_cigarette_cs01x"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	func_152(uParam0, -0.875f, -3.4125f, 0.9f, 2f, 1.7725f, 1.54f, 2.685f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, 4.3625f, -1.225f, 0.7625f, 2f, 1.7725f, 1.54f, 2.685f, -1612834106, 1877049591, 1, 1, 1);
	func_152(uParam0, 13.3375f, -6.3875f, 1.075f, -24.25f, 1.7725f, 1.54f, 2.685f, -1612834106, 271759394, 1, 1, 1);
	func_153(uParam0, 3.6f, -2.56f, 1.0889f, 16.2f, 2f, 1.2f, 2f, 665633627, 1);
	func_154(uParam0, "script@vignette@javier_9@base", 1, 1, 0, 0);
	uLocal_20 = func_154(uParam0, "script@vignette@javier_9@action", 0, 0, 1, 0);
	func_155(uParam0, "CJAV9AU");
	func_156(uParam0, iLocal_16, 1, -1);
	func_157(uParam0, 857413448, -1838104853);
	func_158(uParam0, iLocal_14, 3, -1119935472, "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1);
	func_159(uParam0, iLocal_14, 2, -1119935472, "WORLD_HUMAN_SIT_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_14, iLocal_19, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 3, -1147740400, "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 20f, 1065353216 /* Float: 1f */, 1);
	...
	func_162(uParam0, uLocal_20, -1, 0.85f);
	return 1;
}
...
int func_86(var uParam0)
{
	if (TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(iLocal_24))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_24, false);
	}
	return 1;
}
...
int func_95(var uParam0)
{
	...
	iVar0 = (uParam0->f_107[iLocal_15 /*113*/])->f_32.f_21;
	iVar1 = func_48(uParam0, iLocal_15);
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_21, 2f))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_24, true);
		return 1;
	}
...
int func_383(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_418(iParam0, func_282());
