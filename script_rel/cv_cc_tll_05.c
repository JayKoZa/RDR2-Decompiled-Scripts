...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.505f, 7.6925f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 8.1249f, 2.6499f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, 1);
	...
	func_158(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_A", -1, 0, 50f, 1065353216 /* Float: 1f */, 1);
...
bool func_86(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			TASK::TASK_GO_STRAIGHT_TO_COORD(Global_1357549.f_1675[iVar0 /*5*/].f_3, 2371.127f, 1340.22f, 106.0719f, 1f, 20000, 1193033728 /* Float: 40000f */, 1056964608 /* Float: 0.5f */, 0);
		}
		iVar0++;
	}
	return true;
...
void func_189(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_291(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_291(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
int func_259(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_330(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_280(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_333(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
void func_340(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_374(iParam1))
		{
			func_375(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_369(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (!func_50(iParam0))
	{
		return false;
...
bool func_400(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_403(int iParam0, int iParam1)
{
	...
	bVar0 = func_446(iParam0, iParam1);
	return bVar0;
}
...
bool func_421(int iParam0, char* sParam1)
{
...
bool func_423(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_427(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_452(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_472(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_473(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_481(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_485(0))
				{
					...
					func_486(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_479(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_491(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_483(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_493(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_481(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_481(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_482(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_483(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_481(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_498(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_482(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_483(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_484(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_487(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_504(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_492(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_483(923904168, func_490(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_483(923904168, func_490(bParam0), -740156546, 0) };
		}
...
struct<4> func_494(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_483(271701509, func_490(bParam0), 12999093, 0) };
		}
...
bool func_497(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_499(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
