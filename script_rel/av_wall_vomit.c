...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_53(uParam0, 0, "ped", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
bool func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		{
			if (func_65(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, 10f, 1112014848 /* Float: 50f */))
			{
...
bool func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_210(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
