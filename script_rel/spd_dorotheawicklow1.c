...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		{
			bLocal_250 = (((func_20(8, iLocal_163, 1, 1) || fLocal_155 >= 60f) && iLocal_14 > 3) && iLocal_322 == 0);
			...
			else
			{
				...
				if (iLocal_14 >= 3 && !func_19(iLocal_182, 128))
				{
					...
					{
						if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0) && iLocal_14 < 38)
						{
				...
				if (iLocal_14 > 3 && !func_19(iLocal_182, 128))
				{
					func_25(8, 0, &iLocal_163, &uLocal_149, &uLocal_328, fLocal_156, 1097859072 /* Float: 15f */, 0);
					func_26();
				...
				switch (iLocal_14)
				{
					case 0:
						...
						func_31();
						func_32(iLocal_169, "SP_DorotheaWicklow1_Block", 1, 0, 0, 0, -1082130432 /* Float: -1f */);
					...
					case 1:
						...
						if (((((((HUD::_TEXT_DATABASE_HAS_LOADED("SPDEF") && HUD::_TEXT_DATABASE_HAS_LOADED("SPDWAU")) && STREAMING::HAS_MODEL_LOADED(iLocal_158)) && STREAMING::HAS_MODEL_LOADED(iLocal_159)) && STREAMING::HAS_MODEL_LOADED(iLocal_160)) && STREAMING::HAS_MODEL_LOADED(iLocal_162)) && STREAMING::HAS_MODEL_LOADED(iLocal_161)) && PED::_0x5C16855277819BBF() == 4)
						{
							func_65(2);
						}
						...
						if (!STREAMING::HAS_MODEL_LOADED(iLocal_162))
						{
						}
						if (!STREAMING::HAS_MODEL_LOADED(iLocal_161))
						{
						}
						...
						break;
					case 2:
						if (func_66(&iLocal_163, iLocal_158, 2547.377f, -1216.046f, 53.3068f, 358.7895f, 2, bLocal_321, !bLocal_321))
						{
							if (func_5(iLocal_163, 0))
							{
								if (bLocal_321)
					...
					case 3:
						...
						if (((func_68(&iLocal_168, iLocal_159, 2547.9f, -1215.18f, 52.3135f) && func_71(uLocal_164[0], iLocal_160, &iVar0, func_69(0), func_70(0), 2, 0, 1)) && func_71(uLocal_164[1], iLocal_161, &iVar0, func_69(1), func_70(1), 1, 0, 1)) && func_71(uLocal_164[2], iLocal_162, &iVar0, func_69(2), func_70(2), 2, 0, 1))
						{
							if (((func_5(iLocal_163, 0) && func_5(&(uLocal_164[0]), 0)) && func_5(&(uLocal_164[1]), 0)) && func_5(&(uLocal_164[2]), 0))
							{
								...
								PED::_0x24C82EF607105FAA(iLocal_163, joaat("timid"));
								...
								ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iLocal_163, 2547.377f, -1216.046f, 53.3068f, 87.45f, 1, 0, 1);
								...
								func_79(&iLocal_163, &uLocal_183, 161068336, 20f, -1082130432 /* Float: -1f */);
								if (func_64())
								{
					...
					case 4:
						...
						else if ((func_13(&uLocal_216) && func_15(&uLocal_216) >= 10f) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0))
						{
							bLocal_252 = false;
							func_16(&uLocal_216);
							func_65(43);
					...
					case 5:
						...
						{
							func_84(&iLocal_170, &iLocal_326, &uLocal_327);
							func_85(1);
							bLocal_249 = true;
							func_86(iLocal_163, 1.5f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1);
					...
					case 38:
						...
						if (!func_19(iLocal_182, 8))
						{
							...
							func_85(1);
							bLocal_249 = true;
							if (func_86(iLocal_163, 1.5f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1))
							{
								func_9(&iLocal_182, 8);
							}
						}
						...
						if (((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_181) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_181, 1, 0)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_181, func_120())) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_181) >= func_122(38))
						{
							func_85(0);
							func_121();
							func_9(&iLocal_182, 2097152);
					...
					case 39:
						...
						if (((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_181) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_181, 1, 0)) && ANIMSCENE::_0x1F0E401031E20146(iLocal_181, func_120())) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_181) >= func_122(39))
						{
							func_85(0);
							func_121();
							func_9(&iLocal_182, 2097152);
					...
					case 43:
						...
						if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_163) && !func_19(iLocal_182, 256))
						{
							func_123();
							func_9(&iLocal_182, 256);
						}
						else if ((func_19(iLocal_182, 256) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_163)) && func_19(iLocal_182, 4096))
						{
...
void func_1()
{
	...
	{
		func_136(iLocal_169);
		VOLUME::_DELETE_VOLUME(iLocal_169);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_171))
	{
		POPULATION::_0x74C2B3DC0B294102(iLocal_171);
		POPULATION::_0xA1CFB35069D23C23(iLocal_171);
		VOLUME::_DELETE_VOLUME(iLocal_171);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_170))
	{
		...
		VOLUME::_DELETE_VOLUME(iLocal_170);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_172))
	{
		VOLUME::_DELETE_VOLUME(iLocal_172);
	}
...
void func_2()
{
	...
	{
		fLocal_155 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iLocal_163, true, false), func_140(PLAYER::GET_PLAYER_INDEX()), true);
...
int func_8(float fParam0, int iParam1, int iParam2, float fParam3, float fParam4)
{
	...
	if (bVar0)
	{
		if ((((((((((PED::IS_PED_INJURED(iLocal_163) || PED::IS_PED_RAGDOLL(iLocal_163)) || TASK::IS_PED_GETTING_UP(iLocal_163)) || PED::_IS_PED_LASSOED(iLocal_163)) || PED::IS_PED_BEING_STEALTH_KILLED(iLocal_163)) || PED::_0xEF3A8772F085B4AA(iLocal_163)) || PED::IS_PED_BEING_STUNNED(iLocal_163, 0)) || PED::_0x3E592D0486DEC0F6(iLocal_163)) || PED::_IS_PED_HOGTIED(iLocal_163)) || TASK::_0xF330A5C062B29BED(iLocal_163)) || PED::IS_PED_PRONE(iLocal_163))
		{
			*iParam2 = 0;
		}
		else
	...
	switch (iLocal_245)
	{
		...
		case 10:
			if (iLocal_243 != -1)
			{
				...
				else if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_243) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_243, 1, 0))
				{
		...
		case 11:
			...
			if (bLocal_189)
			{
				...
				else if (func_19(iLocal_182, 64) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_163))
				{
					bLocal_189 = false;
					iLocal_245 = 12;
				}
...
void func_31()
{
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_169))
	{
		iLocal_169 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(2547.416f, -1215.948f, 52.332f, 0f, 0f, 0f, 40f, 40f, 40f, "RandomEventBlock");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_170))
	{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_173))
	{
		iLocal_173 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2547.214f, -1215.096f, 54.23258f, 0f, 0f, 0f, 3f, 3f, 6f, "LookIKVolume");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_174))
	{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_176))
	{
...
int func_71(var uParam0, int iParam1, int iParam2, vector3 vParam3, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	if (*iParam2)
	{
		return 0;
	...
	if (!bParam8)
	{
		*uParam0 = func_198(iParam1, vParam3, iParam6, 0, 1, bParam7, 1, 1, 1, 0, 0, 0, 0);
	}
	else
	{
		*uParam0 = func_198(iParam1, vParam3, iParam6, 0, 1, bParam7, 1, 1, bParam9, 1, 1, 0, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*iParam2 = 1;
...
void func_75(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_79(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		return;
...
int func_86(int iParam0, float fParam1, float fParam2, int iParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8)
{
	vector3 vVar0;
	int iVar3;
	...
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam0, true, false) + func_215(ENTITY::GET_ENTITY_COORDS(Global_35, true, false) - ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1) };
	}
...
void func_131()
{
	func_227(&iLocal_163, Local_256[0 /*59*/], &((Local_256[0 /*59*/])->f_21), 1, 1);
}
...
int func_147(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_150()
{
	...
	while (iVar3 < iVar4)
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar2))
		{
			if (((PED::IS_PED_HUMAN(iVar2) && !PED::IS_PED_A_PLAYER(iVar2)) && iVar2 != iLocal_163) && PED::_IS_PED_USING_SCENARIO_HASH(iVar2, 2087366558))
			{
...
int func_163(int iParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
...
void func_171(int iParam0, int iParam1)
{
	...
	{
		case 0:
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(*iParam0, "cs_doroetheawicklow", iLocal_163, 0);
			break;
		case 1:
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(*iParam0, "cs_doroetheawicklow", iLocal_163, 0);
			if (func_64())
...
int func_174()
{
	if (((((func_19(iLocal_182, 262144) && func_19(iLocal_182, 524288)) && iLocal_14 >= 31) && iLocal_14 <= 36) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_253)) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_253) >= 0.1f)
	{
		func_80(&iLocal_182, 524288);
		bLocal_242 = true;
		return 1;
...
int func_177(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_286(&iLocal_163, Local_256[iParam0 /*59*/], 12f, &((Local_256[iParam0 /*59*/])->f_21), 0f, 2, (Local_256[iParam0 /*59*/])->f_57, iVar1, (Local_256[iParam0 /*59*/])->f_56, 0, 0, 2, -1082130432 /* Float: -1f */);
	if (func_287())
	{
...
int func_183(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
var func_220(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
int func_259(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_276(int iParam0, var uParam1)
{
	...
	{
		return func_387(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_279(int iParam0, vector3 vParam1, int iParam4)
{
...
int func_280(int iParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_286(int iParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		fVar8 = func_390(fParam12 >= 0f, fParam12, BUILTIN::VDIST(Global_36, ENTITY::GET_ENTITY_COORDS(*iParam0, true, false)));
		...
		switch (iParam1->f_2)
		{
			...
			case 1:
				...
				if (func_395(iParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
...
int func_287()
{
	if (((((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630->f_12) && VOLUME::_DOES_VOLUME_EXIST(iLocal_170)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_170, true, 0)) && func_404(Global_35, iLocal_163, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_245 >= 11 && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_253)) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_253) >= 0.8f) && iLocal_14 != 44) || (iLocal_14 >= 31 && iLocal_14 <= 36))) && !func_19(iLocal_182, 2)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, true)) && !PED::IS_PED_ON_MOUNT(Global_35)) && !func_162(&iLocal_163, &iLocal_324, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_405(&iLocal_163, &iLocal_325, 1071644672 /* Float: 1.75f */, 1074790400 /* Float: 2.25f */)) && !func_406())
	{
		if (func_407(0) != 1)
		{
			func_408(0, 1, 1);
...
int func_359(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_445(iVar0, 0)))
		{
...
int func_361(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_363(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_445(iVar0, 0)))
		{
			if (func_447(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_368(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_371(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_373(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_377(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_392(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	var uVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*iParam0))
	{
		...
		uVar5 = func_453(*iParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
			PED::SET_PED_CONFIG_FLAG(*iParam0, 178, false);
			return 1;
...
bool func_398(int iParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		func_463(*iParam0, (*uParam4)[iVar0 /*17*/], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (MISC::IS_BIT_SET(uParam4[iVar0 /*17*/], 20))
		{
			bVar3 = true;
		}
		if (func_464(*iParam0, iParam1, (*uParam4)[iVar0 /*17*/], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
...
int func_405(int iParam0, int iParam1, float fParam2, int iParam3)
{
	var uVar0;
	vector3 vVar1;
	vector3 vVar4;
...
int func_446(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_447(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_499(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_475(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_503(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, uParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
