...
bool func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 1.66677f, -0.70263f, 1f, 80f, 2f, 2f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
		func_154(uParam0, -0.07f, -5.018f, 1.0999f, 0f, 2.4f, 2.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	}
	...
	func_162(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DRINKING"), "PROP_HUMAN_SEAT_CHAIR_DRINKING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
