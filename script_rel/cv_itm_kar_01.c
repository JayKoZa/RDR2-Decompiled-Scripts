...
int func_72(var uParam0)
{
	...
	func_162(uParam0, iLocal_14, 3, -1647035096, "PROP_HUMAN_SEAT_CHAIR_DRINKING_FEMALE_A", uLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_261(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_330(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
