...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2f, -1f, 0f, -7.92f, 5f, 5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	iLocal_20 = func_155(uParam0, 4.475f, 3.5762f, 2.4264f, 0f, 0f, 169.265f, 16.4725f, 17.09f, 5f, "Start_Trigger", joaat("VOLBOX"));
	func_156(uParam0, 1);
