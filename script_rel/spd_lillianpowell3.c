...
int func_331()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630->f_12) && VOLUME::_0x92A78D0BEDB332A3(iLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_260, true, 0)) && func_177(Global_35, iLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::_0x25557E324489393C(iLocal_316)) && ANIMSCENE::_0x3FBC3F51BF12DFBF(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_253)) || func_455())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return 1;
	}
