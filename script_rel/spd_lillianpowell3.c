...
void func_1()
{
	...
	func_171(&iLocal_253, &uLocal_273, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
...
void func_73(int iParam0, int iParam1, char[4] cParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	if (!func_243(iParam0))
	{
		return;
...
bool func_409(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_178(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
