	...
	while (true)
	{
		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				{
					func_20(16, 2, &iLocal_253, &uLocal_245, &uLocal_279, 0, 1097859072 /* Float: 15f */, 0);
				}
				...
				switch (iLocal_14)
				{
					...
					case 29:
						...
						else if ((func_5(iLocal_272, 2) && func_5(iLocal_272, 256)) && !func_5(iLocal_272, 4))
						{
							...
							func_124(1);
							func_125(iLocal_253, 1.2f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1);
					...
					case 4:
						...
						else
						{
							if (!func_5(iLocal_272, 1024))
							{
								func_123(&iLocal_261, &iLocal_387, &uLocal_388);
								func_124(1);
								if (func_125(iLocal_253, 1.2f, 1056964608 /* Float: 0.5f */, 12000, 1, 1, 256, 0, 1))
								{
					...
					case 76:
						...
						if (ANIMSCENE::_0x1F0E401031E20146(iLocal_271, func_156()) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_271) >= func_155(76))
						{
							func_124(0);
							func_154();
							func_8(&iLocal_272, 1073741824 /* Float: 2f */);
...
int func_7(float fParam0, bool bParam1, bool bParam2, float fParam3, float fParam4, bool bParam5)
{
	...
	if (bParam5)
	{
		bVar1 = func_179(&uLocal_213, &iLocal_241, &iLocal_253, &uLocal_389, 1101004800 /* Float: 20f */);
	}
	else
	{
	...
	if (bVar0)
	{
		...
		func_182(iLocal_378, uLocal_379);
		func_152(16);
		return 1;
	}
	return 0;
...
int func_81(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, float fParam12)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
int func_125(int iParam0, float fParam1, float fParam2, int iParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8)
{
	vector3 vVar0;
	int iVar3;
...
int func_323(var uParam0, int iParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_331()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630->f_12) && VOLUME::_DOES_VOLUME_EXIST(iLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_260, true, 0)) && func_177(Global_35, iLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(iLocal_316)) && ANIMSCENE::_GET_ANIM_SCENE_PROGRESS(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iLocal_253)) || func_455())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return 1;
	}
