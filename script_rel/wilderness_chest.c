...
int func_7(var uParam0)
{
	switch (func_15(uParam0))
	{
		case 0:
			iLocal_33 = func_16(func_3(), 5);
			iLocal_34 = func_24(fLocal_27);
			uLocal_41 = func_31(iLocal_34, 21);
			func_18(uParam0, 1);
			break;
		case 1:
			if (func_19(iLocal_34) || func_20(iLocal_33, 1, 0))
			...
			{
				if (func_20(539615708 /* GXTEntry: "Sketched Map" */, 1, 0))
				{
					func_18(uParam0, 14);
				}
				else
		...
		case 9:
			...
			uLocal_37 = ENTITY::_0x6F3068258A499E52(func_17(iLocal_34, 2), func_25(iLocal_34, 28), 1 | iLocal_39);
			func_18(uParam0, 10);
			break;
		case 10:
...
int func_22(int iParam0)
{
	switch (iParam0)
	{
		...
		case 807302083: /* GXTEntry: "Special Snake Oil Pamphlet" */
			return -223790555 /* GXTEntry: "Special Snake Oil" */;
		case -1375947476: /* GXTEntry: "Special Horse Medicine Pamphlet" */
			return -1871448371 /* GXTEntry: "Special Horse Medicine" */;
		...
		case -1704241585: /* GXTEntry: "Special Horse Reviver Pamphlet" */
			return -1795542128 /* GXTEntry: "Special Horse Reviver" */;
		...
		case -1740272183: /* GXTEntry: "Homing Tomahawk Pamphlet" */
			return -1411922943 /* GXTEntry: "Tomahawk - Homing" */;
...
int func_33(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (func_47(iParam0) == joaat("clothing"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_47(iParam0) == joaat("weapon"))
		{
		...
		else if (func_47(iParam0) == joaat("ammo") && func_88(iParam0))
		{
		...
		else if (func_76(iParam0, 589988438))
		{
			if (func_97())
			{
				func_98(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
		...
		switch (iParam0)
		{
			...
			case -1185145312: /* GXTEntry: "Upgraded Off-Hand Holster" */
				...
				{
					func_110(PLAYER::PLAYER_PED_ID(), -1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_111(&iVar9, 0))
				{
			...
			case 1171350303: /* GXTEntry: "Upgraded Bandolier" */
				...
				{
					func_110(PLAYER::PLAYER_PED_ID(), 1171350303 /* GXTEntry: "Upgraded Bandolier" */, 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_126(242, func_125(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_126(240, func_125(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_126(241, func_125(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
...
int func_52(int iParam0, var uParam1, bool bParam2)
{
	var uVar0[10];
	int iVar11;
	int iVar12;
	...
	if ((bParam2 && func_1() == 0) && !UNLOCK::_UNLOCK_IS_VISIBLE(iParam0))
	{
		return 0;
	}
...
void func_57(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		func_152(iParam0, iParam1, iParam2, uVar0);
	}
		...
		while (iVar28 < 4)
		{
			...
			if (func_189(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_84(0))
				{
					...
					func_86(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_161(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_MELEE(iVar0))
			{
				...
				{
					func_85(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				iVar7 = func_198(Global_35, 2, 0, 1);
				if ((((func_146(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_20(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_146(iVar7) && func_20(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1, 0))
				{
...
int func_89(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_20(611073244 /* GXTEntry: "Crow Beak Trinket" */, 1, 0) && iParam2 == -897553835)
	{
...
int func_97()
{
	if (((((func_209(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_209(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_209(623353496 /* GXTEntry: "Bounty Hunter\'s Orders" */, 400)) || func_209(-344413337 /* GXTEntry: "Poster of a Violent Criminal" */, 400)) || func_209(-1664948962 /* GXTEntry: "Bounty Hunter\'s Letter" */, 400)) || func_209(1795228059 /* GXTEntry: "Bounty Page" */, 400))
	{
		return 1;
	}
	return 0;
...
void func_102(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1369162587: /* GXTEntry: "Hunting Request" */
			...
			func_67(437, 0);
			func_67(440, 0);
			func_221(-949689219, 444160793 /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1610047510: /* GXTEntry: "Hunting Request" */
			...
			func_221(-1248968496, -1969404854 /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1317879106: /* GXTEntry: "Hunting Request" */
			...
			func_221(1706369307, -832850511 /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1062444751: /* GXTEntry: "Hunting Request" */
			...
			func_221(1520110311, -100913452 /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case 754186760: /* GXTEntry: "Hunting Request" */
			...
			func_67(438, 0);
			func_221(-1992824800, 905173572 /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_107(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case 489075255: /* GXTEntry: "$1.00" */
			func_98(-949580860, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1394529493: /* GXTEntry: "$5.00" */
			func_98(-1171997683, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1262623627: /* GXTEntry: "$10.00" */
			func_98(-2140931002, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1124867377: /* GXTEntry: "Bill Fold" */
			func_98(-1116228267, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1790920086: /* GXTEntry: "Small Bill Fold" */
			func_98(2112896861, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -2001202686: /* GXTEntry: "Bill Stack" */
			func_98(-1915150712, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1111063991: /* GXTEntry: "Coin" */
			func_98(994220262, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1576210101: /* GXTEntry: "Coin Purse" */
			func_98(-1388440107, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 675090918: /* GXTEntry: "Coin Sack" */
			func_98(-1531790128, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 355838765: /* GXTEntry: "Coin Stack" */
			func_98(1351791770, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -343824903: /* GXTEntry: "Money Clip" */
			func_98(-161493966, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1142684684: /* GXTEntry: "Money Stack" */
			func_98(668131102, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1243851340: /* GXTEntry: "Money Pile" */
			if (!func_232())
			{
				func_98(1330954593, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case -525490740: /* GXTEntry: "Change Cup" */
			func_98(817681514, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1736635264: /* GXTEntry: "Coin Cup" */
			func_98(1404311868, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1302860970: /* GXTEntry: "$50.00" */
			func_98(-175152067, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1027115192: /* GXTEntry: "$100.00" */
			func_98(-526915387, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1064332555: /* GXTEntry: "$200.00" */
			func_98(101362741, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1954478446: /* GXTEntry: "$45.00" */
			func_98(1458818027, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -518592739: /* GXTEntry: "$50.00" */
			func_98(-1957208512, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -2010073778: /* GXTEntry: "$70.00" */
			func_98(2066857461, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -700133011: /* GXTEntry: "$100.00" */
			func_98(803940201, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1415414735: /* GXTEntry: "$120.00" */
			func_98(-1717765429, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 2045548742: /* GXTEntry: "$150.00" */
			func_98(1379920914, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 830381058: /* GXTEntry: "$350.00" */
			func_98(447209691, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_137(int iParam0, char* sParam1)
{
	...
	func_268(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_267(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
var func_152(int iParam0, int iParam1, int iParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
{
	return func_47(iParam0) == joaat("weapon");
}
...
void func_155(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_47(iParam0) != joaat("weapon"))
	{
		return;
	}
	iVar0 = func_82(iParam0, 0);
	...
	if (bParam2 || !func_187(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_49(iParam0, 0, 0) == 0))
		{
...
struct<5> func_157(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_47(iParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_191(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_189(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_189(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_190(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_191(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
int func_161(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_153(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			...
			else if (func_190(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return 0;
			}
			if (func_287(iParam0, 1))
			{
				if (!func_189(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return 0;
				}
				else if (func_190(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return 0;
				}
			}
...
void func_193(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_331(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_201(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_47(iParam1) != joaat("clothing"))
	{
		return 0;
	}
	bVar1 = func_1() != -1;
...
int func_210(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_20(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_211(int iParam0, char* sParam1, int iParam2)
{
	...
	func_268(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_212(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_268(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_268(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_221(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_267(int iParam0)
{
	...
	if (!func_400(iParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_287(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_159(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_292(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_345(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_343())
	{
		func_268(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_268(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
int func_363(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_436(0);
	if (iParam2 != 0 && func_437(iParam0, uVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_417()
{
	...
	func_478(0);
	func_479(7);
	func_480(-1623728698 /* GXTEntry: "Bandana" */, 1, 1, 0);
	if (func_257() == 1160113249)
	{
		func_480(-763730846 /* GXTEntry: "John\'s Classic Hat" */, 1, 1, 1);
		func_480(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_481(Global_35, &uVar0);
}
...
int func_437(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
var func_469(var uParam0, var uParam1, var uParam2, var uParam3)
{
	return HUD::_0xD8402B858F4DDD88(&uParam0, HUD::GET_LENGTH_OF_LITERAL_STRING(&uParam0));
}
...
void func_480(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		case -2061583405:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_21), Global_1946804->f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_20), Global_1946804->f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_22), Global_1946804->f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_520(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
...
bool func_513(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_520(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
