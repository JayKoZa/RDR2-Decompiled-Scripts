...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 0f, 1103626240 /* Float: 25f */);
	func_151(uParam0, 0.0202455f, 1.08015f, 0.533295f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	func_158(uParam0, iLocal_14, 2, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
