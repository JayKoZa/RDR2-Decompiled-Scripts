...
bool func_73(var uParam0)
{
	...
	func_153(uParam0, 1.625f, -0.675f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_153(uParam0, 0.6125f, -2.2125f, 0.85f, -8.5f, 1.6325f, 1.1875f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, -3.7875f, -0.8125f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TRELAWNY"), 1, 1, 1);
	func_154(uParam0, 1.05f, -1.65f, 0f, -30f, 1f, 1.54f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_163(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_GROUND_READING_JOURNAL"), "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_163(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_202(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_389(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
