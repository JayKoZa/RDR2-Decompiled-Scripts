...
int func_73(var uParam0)
{
	...
	func_153(uParam0, 1.625f, -0.675f, 0.85f, 0f, 1f, 1f, 3.2075f, -1612834106, -695792551, 1, 1, 1);
	func_153(uParam0, 0.6125f, -2.2125f, 0.85f, -8.5f, 1.6325f, 1.1875f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_153(uParam0, -3.7875f, -0.8125f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, 1833688716, 1, 1, 1);
	func_154(uParam0, 1.05f, -1.65f, 0f, -30f, 1f, 1.54f, 3f, 665633627, 1);
	...
	func_156(uParam0, "script@vignette@trelawny_1@base", 1, 1, 0, 0);
	iLocal_18 = func_156(uParam0, "script@vignette@trelawny_1@Action", 0, 0, 1, 0);
	func_157(uParam0, "CTRL1AU");
	func_158(uParam0, -1867177551, -1098659425);
	func_159(uParam0, iLocal_18, -1, 0.88f);
	func_160(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	func_161(uParam0, iLocal_16, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_B", -1, 1);
	func_162(uParam0, iLocal_16, 1, -1);
	func_161(uParam0, iLocal_15, 3, -25074136, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_163(uParam0, iLocal_15, 2, -25074136, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_164(uParam0, iLocal_15, iLocal_21, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	func_162(uParam0, iLocal_15, 1, -1);
	func_161(uParam0, iLocal_14, 3, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0);
	func_163(uParam0, iLocal_14, 3, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_94(var uParam0)
{
	...
	if (!bLocal_22)
	{
		if (func_202(uParam0, iLocal_18, 0.457f))
		{
			...
			ENTITY::SET_ENTITY_COORDS(func_47(uParam0, iLocal_17), ENTITY::GET_ENTITY_COORDS(func_203(uParam0, iLocal_21), true, false) + Vector(0.2f, 0f, 0f), true, false, true, true);
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_260(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_274((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_207(var uParam0)
{
	...
	iVar0 = func_47(uParam0, uParam0->f_2271);
...
int func_252(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_47(uParam0, iVar1)))
		{
		}
		else if (!ENTITY::IS_ENTITY_OCCLUDED(func_47(uParam0, iVar1)))
		{
			iVar0 = 0;
		}
		else
...
int func_260(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_306(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_344(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_314()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_349(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_328(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_355(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_361(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_363(&uVar2, func_362(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_364(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_355(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_121(iVar0, 0)) || (bParam3 && !func_52(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_386(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_365(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_395(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_394(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_397(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_386(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_211(vVar0)) && !func_212(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_397(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
			...
			sVar12 = func_421(iParam0, func_286());
...
void func_388(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_422(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_423(iParam0);
...
int func_395(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_104(iParam0))
	{
		return 0;
...
int func_418(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_285(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_419(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_451(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_389(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_445(int iParam0)
{
	...
	func_464(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_467(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_476(bParam0, &Var0, iVar5, 0))
			{
				if (func_477(bParam0, &Var6, iVar5))
				{
					Var29 = { func_478(bParam0, Var0, iVar5, 0) };
					func_479(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_480(0))
				{
					...
					func_481(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_482(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
void func_468(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_474(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	Var0.f_4 = 1084182731;
	switch (func_486(bParam0))
	{
		case joaat("clothing"):
			if (!INVENTORY::_INVENTORY_FITS_SLOT_ID(bParam0, 1034665895))
			{
				Var0 = { func_478(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_488(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_476(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_476(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_477(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_491(bParam0, -1823706425))
			{
				Var0 = { func_478(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_491(bParam0, -1483207246))
			{
				Var0 = { func_478(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_476(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_493(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_477(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_478(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_495(bParam0, 0))
	{
		return Var0;
	}
...
int func_479(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_482(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_499(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_478(joaat("character"), func_500(), -1591664384, bParam0);
}
...
{
	if (func_490(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_501(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_492(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_493(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_478(bParam0, Param1, iParam5, bParam6) };
...
int func_494(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_496(0);
	*uParam1 = { func_478(bParam0, func_487(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
