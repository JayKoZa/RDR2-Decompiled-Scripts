...
int func_11()
{
	...
	uLocal_221 = ((*Global_1888801)[22 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(uLocal_221, 5);
	return 1;
}
...
int func_66()
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_223) && VOLUME::_0xF256A75210C5C0EB(iLocal_223, Global_36))
	{
...
int func_285(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	int iVar0;
	int iVar1;
