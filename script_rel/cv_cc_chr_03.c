...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5266f, -1.2093f, 0.5026f, -22.5144f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	func_151(uParam0, 0.5733f, 1.1645f, 0.4966f, 155.6634f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
