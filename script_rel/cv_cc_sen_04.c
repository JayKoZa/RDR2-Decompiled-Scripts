...
bool func_72(var uParam0)
{
	...
	func_154(uParam0, 0.8755f, 1.4219f, 0.9428f, 0f, 2.5f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_155(uParam0, 1);
...
bool func_93(var uParam0)
{
	...
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_15), joaat("STAND"), 25000, false, 0, -1f, false);
	}
	return true;
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
