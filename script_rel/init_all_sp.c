...
void func_135()
{
	...
	if (INVENTORY::_0xB881CA836CC4B6D4(&Var1))
	{
		...
		if (!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_35, -1) && !func_427())
		{
...
int func_146(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
void func_518(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	sVar15 = func_746(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, func_655(iParam0)), iVar1), iVar12);
	...
	{
		sVar15 = MISC::_CREATE_VAR_STRING(0, func_655(iParam0));
	}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_571(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
...
void func_615(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_856(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_856(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
			func_858(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, func_857(func_609(iParam6))), iVar5, iVar4, -2, 0, 0, 0, 0, 1, 1);
			func_856(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else
		{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_839(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_MELEE(iVar0))
			{
				...
				{
					func_425(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
void func_649(int iParam0, bool bParam1)
{
	...
	func_856(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar3), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_666(int iParam0, char* sParam1)
{
	...
	func_747(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_919(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_668(int iParam0, char* sParam1, int iParam2)
{
	...
	func_747(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_669(int iParam0, char* sParam1, int iParam2)
{
	...
	func_747(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_670(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_747(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_747(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
void func_678(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_926(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_749(int iParam0, bool bParam1)
{
	...
	if (!func_565(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_566(iVar14);
...
bool func_758(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_571(bParam5), &uParam0, uParam4, !bParam6))
	{
		return false;
	}
	return true;
...
bool func_797(int iParam0, int iParam1)
{
	...
	Var0 = { func_579() };
	*iParam1 = func_976(Var0, iParam0, 0);
	if (!func_332(*iParam1, 0))
	{
		return false;
	}
...
{
	return INVENTORY::_0x033EE4B89F3AC545(func_571(bParam2), uParam0, iParam1);
}
...
bool func_839(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_832(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
		{
			Var0 = { func_750(0) };
		...
		else if (!func_986(iParam0, &uVar26, 0))
		{
			return false;
		}
		return true;
...
void func_843(int iParam0)
{
	...
	fVar1 = func_988(iParam0);
	if ((Global_1347477.f_117 || !func_429(31)) || !func_989(iVar0))
	{
		return;
	}
	if (fVar1 <= 0f)
	...
	func_991(iVar0, (Global_40.f_11095.f_11[iVar0] + fVar1), 0);
	func_747(MISC::_CREATE_VAR_STRING(6, func_992(iParam0), fVar1), "itemtype_textures", func_993(iVar0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
char* func_849(int iParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, int iParam6)
{
	switch (iParam1)
	{
		case -2076669067:
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_CC_CARD_POSTED_OBJ", func_999(), 12);
			}
			else
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_CC_CARD_FOUND_OBJ", func_1000(), 12);
			}
			break;
		case joaat("DINO_BONES"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_DB_POSTED_OBJ", func_1001(), 30);
			}
			else
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_DB_FOUND_OBJ", func_883(), 30);
			}
			break;
		case -1531394072:
			if (iParam2 == 7)
		...
		case 1995362678:
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_LF_CAUGHT_OBJ", func_1002(), 13);
			}
			break;
		case joaat("ROCK_CARVINGS"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_RC_POSTED_OBJ", func_1003(), 10);
			}
			else
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_RC_FOUND_OBJ", func_884(), 10);
			}
			break;
		case joaat("TAXIDERMY"):
			...
			{
				sParam3 = MISC::_CREATE_VAR_STRING(2, "COL_TX_CARCASS_COLLECTED_OBJ", sParam4, func_848(iParam6, 20));
			}
			break;
	}
	return sParam3;
...
bool func_853(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == -2076669067)
		{
			...
			{
				bVar1 = (func_418(iVar2, 1, 0) || func_1006(func_1005(iVar2)));
			}
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_857(func_1004(iVar0))), func_857(func_1004(iVar0)), bVar1, true, false);
		}
		...
		{
			iVar2 = func_893(iParam3, func_1008(iVar0));
			if (iParam5 == 8)
			{
				bVar1 = true;
			}
			else if (bParam9)
			{
				if (iParam4 == iVar2)
				{
					bVar1 = (func_889(iVar2) - iParam7) >= func_848(iParam3, func_1009(iVar0));
				}
				else
				{
					bVar1 = func_889(iVar2) >= func_848(iParam3, func_1009(iVar0));
				}
			}
		...
		{
			if (func_1011(COLLECTION::_0x126CBEBBA46693CF(iVar0, 1995362678, 0)))
			{
				bVar1 = true;
			}
			else if (iParam5 == 8)
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1012(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_1012(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
		if (iParam2 == joaat("ROCK_CARVINGS"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1013(iVar0)), func_1013(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == joaat("TAXIDERMY"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1015(iVar2)), func_1015(iVar2), bVar1, true, false);
		}
		iVar0++;
	}
	return true;
...
{
	if (func_289(func_506(0)) && ((func_1016(0) == 1 || func_1016(0) == 8) || func_1016(0) == 6))
	{
		iParam3 = 7;
	}
...
void func_860(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 24:
			...
			if (func_115() == -1)
			{
				if (!func_544(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_1025(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_814())
					{
...
int func_871()
{
	...
	while (iVar1 < 26)
	{
		if (func_418(func_1029(iVar1), 1, 0))
		{
			iVar0++;
		}
		iVar1++;
...
int func_883()
{
	...
	while (iVar1 < 30)
	{
		if (func_1032(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_885(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if (iParam0 == joaat("TAXIDERMY_ORDER_02"))
	{
		...
		if (func_1014(iVar0) && func_1014(iVar1))
		{
			return true;
		}
	}
	else if (iParam0 == joaat("TAXIDERMY_ORDER_03"))
	{
		...
		if ((func_1014(iVar0) && func_1014(iVar1)) && func_1014(iVar2))
		{
			return true;
		}
	}
	else
	{
		...
		if (((func_1014(iVar0) && func_1014(iVar1)) && func_1014(iVar2)) && func_1014(iVar3))
		{
			return true;
		}
	}
...
int func_887()
{
	...
	while (iVar1 < 5)
	{
		if (func_1033(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	func_1037(&(Global_1946804.f_2589), bParam0, bParam1, bParam2);
}

void func_901()
{
	func_1038(&(Global_1946804.f_2776));
	func_513(32768);
...
float func_905()
{
	...
	fVar0 = (fVar0 * fVar5);
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_1047()));
	fVar7 = (func_1042(2) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_1048(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_1049(3, fVar9, fVar9 > 100f);
	return func_1050(fVar7, -100f, 100f);
}
...
float func_906()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_1047()));
	fVar7 = (func_1042(1) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_1048(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_1049(2, fVar9, fVar9 > 100f);
	return func_1050(fVar7, -100f, 100f);
}
...
float func_907()
{
	...
	fVar6 = (200f / fVar0);
	fVar6 = (fVar6 * (30f / func_1047()));
	fVar7 = (func_1042(0) - fVar6);
	iVar8 = BUILTIN::ROUND(((fVar0 / 60f) * BUILTIN::TO_FLOAT(7)));
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_1048(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
	func_1049(1, fVar9, fVar9 > 100f);
...
void func_911(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((!func_1057() && !bParam1) && !func_394(0, 0, 1))
	{
		func_1058(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_503(iParam0, 6);
	if (bParam2)
	{
...
{
	return func_910(iParam0, 0) < func_1059(iParam0, bParam1);
}
...
int func_916(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	Var1 = iParam3;
	Var1.f_2 = { *uParam1 };
	func_1063(uParam2, iParam0, Var1);
	return 1;
}
...
int func_919(int iParam0)
{
	...
	if (!func_1064(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
void func_922(int iParam0)
{
	...
	func_1065((Global_40.f_4283.f_325 + iParam0));
}
...
void func_923(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_921())
	{
		func_747(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_747(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
int func_927(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	{
		Var16 = { func_1066(Param0, 1) };
		Var16.f_10 = iParam4;
		iVar0 = func_1067(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var44 = { func_1068(Param0, 1) };
		Var44.f_10 = iParam4;
		iVar0 = func_1069(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var61 = { func_1070(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_1071(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_928(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_1072(iParam0, iParam1, &Var0, &iVar21, bParam2))
	{
		if (!bParam2)
		{
		}
...
int func_938(int iParam0, int iParam1)
{
	...
	if (!func_1078(iParam0, &iVar0, &iVar1))
	{
		return 0;
	}
...
bool func_939(int iParam0)
{
	...
	return MISC::IS_BIT_SET(Global_40.f_4283.f_307, func_1080(iParam0, 1));
}
...
void func_940(int iParam0)
{
	...
	MISC::SET_BIT(&(Global_40.f_4283.f_307), func_1080(iParam0, 1));
}
...
void func_963(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_1081(BUILTIN::TO_FLOAT(*uParam0), fVar3);
	iVar1 = func_1082(BUILTIN::TO_FLOAT(*uParam1), fVar3);
	iVar2 = func_1083(BUILTIN::TO_FLOAT(*uParam2), fVar3);
...
void func_964(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_1084(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_1084(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_1085(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_967(var uParam0, var uParam1, var uParam2)
{
	int iVar0;

	iVar0 = func_1087(func_339());
	if (*uParam0)
	{
		func_966(uParam0);
	}
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(iVar0, uParam1, 0, func_115() != -1, uParam2);
	*uParam0 = 1;
}
...
void func_971()
{
	...
	TASK::TASK_PLAY_ANIM(Global_35, func_1088(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_513(1);
	STREAMING::REMOVE_ANIM_DICT(func_1088());
}
...
void func_973(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	{
		func_1089(&(Global_1946804.f_1497), iParam1, 1, -1, 1, 1, 1);
	}
}
...
bool func_977(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	var uVar2;
					...
					else
					{
						...
						if (iVar11 == joaat("SLOTID_HORSE_STIRRUP"))
						{
							...
							else
							{
								...
								{
									if (!func_979(iVar14) && func_1091(iVar21))
									{
										bVar15 = true;
									}
								}
...
bool func_986(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
{
	return func_1094(Global_40.f_11095.f_11[iParam0]);
}

void func_991(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if (func_1095(iParam0) && func_1096(iParam0))
	{
		if (!bParam2)
		{
			iVar3 = func_1097(fVar1, fParam1);
			if (fParam1 > IntToFloat(func_1098(iParam0)) && (iVar2 > iVar0 || iVar3 != 0))
			{
				if (!HUD::IS_RADAR_HIDDEN() && !Global_16)
				{
					if (iVar2 > iVar0)
					{
						func_607(func_1099(iParam0), 0);
					}
					func_1100(iParam0, iVar2, iVar3);
					func_1101(iParam0, 7000);
				}
...
bool func_998(int iParam0, var uParam1)
{
...
int func_999()
{
	return func_1103(Global_40.f_12019);
}
...
int func_1000()
{
	...
	while (iVar1 < 12)
	{
		...
		if (func_418(iVar2, 1, 0) || func_1006(func_1005(iVar2)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1001()
{
	...
	while (iVar1 < 30)
	{
		if (func_1104(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1002()
{
	...
	while (iVar1 < 14)
	{
		if (func_1011(COLLECTION::_0x126CBEBBA46693CF(iVar1, 1995362678, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
{
	if (func_1105(iParam0) && func_418(iParam0, 1, 0))
	{
		return true;
	}
	else if (func_1106(iParam0) && func_1107(iParam0))
	{
		return true;
	}
	return false;
...
char* func_1015(int iParam0)
{
	...
	return HUD::_GET_LABEL_TEXT_BY_HASH(func_655(iParam0));
}
...
bool func_1028(int iParam0, var uParam1)
{
	...
	iVar1 = func_338(func_1109(iParam0), 1);
	if (iVar1 >= 39)
	{
		return false;
	}
...
{
	return func_1111(func_457(), iParam0, bParam1);
}
...
void func_1037(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	while (iVar0 < *uParam0)
	{
		func_1112(uParam0->f_2[iVar0 /*2*/], bParam1, bParam2);
		iVar0++;
	}
	if (func_115() == -1)
	{
...
void func_1040(struct<4> Param0)
{
	int iVar0;
	int iVar1;
...
void func_1048(int iParam0, char* sParam1, bool bParam2)
{
	char* sVar0;

	sVar0 = func_1115(iParam0, 1, 0, 0);
	sVar0 = MISC::_CREATE_VAR_STRING(2, sVar0, sParam1);
	DATABINDING::_DATABINDING_WRITE_DATA_STRING(Global_1955569.f_5.f_2[iParam0 /*36*/].f_12[1], sVar0);
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(Global_1955569.f_5.f_2[iParam0 /*36*/].f_16[1], bParam2);
}

void func_1049(int iParam0, float fParam1, bool bParam2)
{
	char* sVar0;

	sVar0 = func_1115(iParam0, 2, 0, 0);
...
void func_1056(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_1055(iParam0))
	{
		...
		if ((!func_1057() && !bParam1) && !func_394(0, 0, 1))
		{
			func_1058(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_1117(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
var func_1058(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
void func_1063(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;

	if (!func_1126(uParam0))
	{
		return;
	}
...
bool func_1064(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
struct<28> func_1066(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<28> Var0;
	struct<29> Var28;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_571(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_1070(&Var28) };
...
int func_1067(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
...
struct<17> func_1068(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<17> Var0;
	struct<15> Var17;
	...
	Var17.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_571(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_1070(&Var17) };
	Var0.f_16 = Var17.f_14;
	return Var0;
}

int func_1069(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
...
struct<16> func_1070(var uParam0)
{
	struct<16> Var0;
...
bool func_1072(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	struct<5> Var0;
	int iVar25;
...
bool func_1078(int iParam0, int iParam1, int iParam2)
{
	if (!func_1077(iParam0))
	{
		return false;
...
int func_1081(float fParam0, float fParam1)
{
...
bool func_1084(var uParam0, int iParam1)
{
	return (uParam0->f_1 && iParam1) != 0;
}

void func_1085(var uParam0, int iParam1, int iParam2)
{
	uParam0->f_1 = (uParam0->f_1 || iParam1);
}
...
void func_1089(var uParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		{
			func_1129(iParam1, 29, bVar4, 1, 0);
			func_1129(iParam1, 31, bVar4, 1, 0);
			func_1129(iParam1, 30, bVar4, 1, 0);
			func_1129(iParam1, 22, bVar4, 1, 0);
			func_1129(iParam1, 37, bVar4, 1, 0);
		}
	}
	if ((func_765(32768) && func_539(1108822547, 8)) && func_538(10, iParam3))
	{
		func_1130(iParam1, 0, 1);
	}
	iVar0 = 0;
	while (iVar0 < 39)
	{
			...
			else
			{
				...
				else if ((func_539(iVar3, 6) || uParam0->f_1[iVar1 /*3*/] == Global_1946804.f_57[iVar1 /*11*/]) || uParam0->f_1[iVar1 /*3*/].f_1 == 289238755)
				{
					if (!func_539(iVar3, 1) || bParam2)
					{
						...
						if (!bParam6)
						{
							func_1129(iParam1, iVar1, bVar4, 1, 0);
						}
				...
				else
				{
					if (!bParam6)
					{
						...
						else
						{
							...
							{
								func_1129(iParam1, iVar1, bVar4, 1, uParam0->f_1[iVar1 /*3*/]);
							}
...
bool func_1092(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	struct<14> Var2;
	...
	if (func_565(&Var2, &iVar0, &iVar1, 0))
	{
		...
		while (iVar30 < iVar1)
		{
			if (func_673(&Var16, iVar30, iVar0, iVar1))
			{
				...
				{
					if (bParam2 && func_1091(Var16.f_4))
					{
					}
					else
					{
...
float func_1093(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 50:
			...
			iVar5 = func_1094(fVar3);
			iVar0 = iVar5;
			iVar6 = iVar0 + 1;
			iVar1 = (func_1131(iVar6) - func_1131(iVar5));
...
int func_1097(float fParam0, float fParam1)
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	iVar0 = func_1094(fParam0);
	fVar1 = BUILTIN::TO_FLOAT(func_1131(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_1131(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_1100(int iParam0, int iParam1, int iParam2)
{
	...
	iVar3 = (iVar3 + func_1134(iParam0));
	sVar4 = func_1136(func_1135(iVar3, iParam2));
	sVar6 = func_1137(iParam0);
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar6))
	{
		sVar5 = "HUD_Toast_Soundset";
	}
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_1138(iParam0));
	iVar8 = func_1139(iParam0);
	...
	if (bVar2)
	{
		...
		Var10.f_2 = iVar8;
		Var10.f_4 = 1;
		Var10.f_5 = func_1140(iParam0);
		UILOG::_UILOG_POST_NOTIFICATION(&Var10);
	}
	func_856(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_1141(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
int func_1107(int iParam0)
{
	...
	while (iVar95 < 3)
	{
		if (!func_1142(&iVar0, 0, iVar95, &Var1) && !func_1142(&iVar0, 1, iVar95, &Var1))
		{
		}
		else if (STREAMING::IS_MODEL_A_PED(Var1))
		{
			func_1143(iVar0, &Var1);
...
void func_1108()
{
	...
	func_93(0);
	func_106(7);
	func_1145(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_339() == 1160113249)
	{
		func_1145(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_1145(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
	func_1146(Global_35, &uVar0);
}
...
bool func_1111(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_1147(iParam1) || !func_1147(iParam0))
		{
			return true;
		}
	}
...
void func_1112(int iParam0, bool bParam1, bool bParam2)
{
	if (bParam1)
	{
...
int func_1114(float fParam0)
{
	return BUILTIN::ROUND(((fParam0 / 100f) * BUILTIN::TO_FLOAT(10)));
}

char* func_1115(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
int func_1118(int iParam0)
{
	...
	else if (func_1149(iParam0))
	{
		iVar0 = 1;
	}
	else if (func_1150(iParam0))
	{
		iVar0 = 2;
	}
	else if (func_1151(iParam0))
	{
		iVar0 = 3;
	}
	return iVar0;
...
bool func_1119(int iParam0)
{
	...
	while (iVar0 < 9)
	{
		if (func_418(func_1152(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
bool func_1120(int iParam0)
{
	...
	while (iVar0 < 4)
	{
		if (func_418(func_1153(iVar0, iParam0), 1, 0))
		{
			iVar1++;
		}
		iVar0++;
...
void func_1129(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_1130(int iParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	...
	if (func_539(1108822547, 6))
	{
		if (bParam2)
		{
			func_1129(iParam0, iVar0, func_115() != -1, 0, 0);
...
struct<4> func_1135(int iParam0, int iParam1)
{
	char cVar0[32];
...
char* func_1136(var uParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_1142(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;

	if (func_1156(iParam1) && !func_1157(iParam1))
	{
...
void func_1143(int iParam0, int iParam1)
{
	...
	{
		func_1161(iVar0, &(iParam1->f_5), &(iParam1->f_6), &(iParam1->f_7), &(iParam1->f_4));
		if (func_1162(&(iParam1->f_1), iVar0, iParam1->f_7, iParam1->f_5))
		{
		}
	}
}
...
void func_1145(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	...
	{
		case -2061583405:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_21), Global_1946804.f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_20), Global_1946804.f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_22), Global_1946804.f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_1164(iParam0, &(Global_1946804.f_2657.f_24), 1, bParam1);
			break;
	...
	if (iParam0 == func_1165(0))
	{
		func_1166(iParam0, 1);
		if (func_339() == 1160113249)
		{
			func_1166(func_1165(-2125499975), 0);
		}
		else
		{
			func_1166(func_1165(1160113249), 0);
		}
	}
	func_515();
	if (func_1167(iVar0))
...
void func_1161(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
...
bool func_1162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_1164(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
...
{
	return func_1181(func_732(iParam0));
}
