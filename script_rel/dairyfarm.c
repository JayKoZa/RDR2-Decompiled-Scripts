...
void func_56(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!PERSCHAR::_0x800DF3FC913355F3(PERSCHAR::_0x112DDF56300BC6E5(func_96(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				PERSCHAR::_0x187D65F3AEC5D679(func_96(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_0x31C70A716CAE1FEE(PERSCHAR::_0x112DDF56300BC6E5(func_96(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
void func_57()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(-1110918177);
	iVar1 = PERSCHAR::_0x112DDF56300BC6E5(1297060780);
	iVar2 = 936;
	iVar3 = 937;
	iVar4 = func_93(iVar2);
	iVar5 = func_93(iVar3);
...
void func_65(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_120(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_120(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_120(&cVar6, joaat("COLOR_PURE_WHITE")), func_120(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_89(int iParam0, bool bParam1)
{
	...
	if (func_141(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_144(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_144(iParam0)))
	{
...
int func_142(int iParam0, bool bParam1)
{
	...
	func_176(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_144(iParam0));
	func_143(iParam0, 0);
	return 1;
}
...
bool func_177(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_144(iParam0));
}
