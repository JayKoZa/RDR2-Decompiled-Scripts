...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -5.1125f, 0.4f, 1.4875f, 44.64f, 2f, 4.5f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -0.1751f, -1.225f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	...
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_30@action", 0, 0, 1, 0);
	func_154(uParam0, "CDT30AU");
	func_155(uParam0, joaat("COMP_DTCCNV30"), joaat("PLAYER_DTCCNV30"));
	func_156(uParam0, iLocal_17, -1, 0.92f);
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKING"), "PROP_HUMAN_SEAT_CHAIR_SMOKING_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_249()
{
	...
	if (func_336(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_250()
{
	...
	if (func_336(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_302(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_313(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
bool func_318(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_348(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_396(iParam1))
		{
			func_397(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_417(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_422(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_425(int iParam0, int iParam1)
{
	...
	bVar0 = func_464(iParam0, iParam1);
	return bVar0;
}
...
bool func_439(int iParam0, char* sParam1)
{
...
bool func_441(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_445(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_336(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_416(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_470(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_486(iVar0))
		{
	...
	{
		func_488(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_489(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_497(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_501(0))
				{
					...
					func_502(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_495(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_507(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_499(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_497(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_497(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_498(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_499(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_497(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_514(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_498(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_499(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_500(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_503(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_520(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_508(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_499(923904168, func_506(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_499(923904168, func_506(bParam0), -740156546, 0) };
		}
...
struct<4> func_510(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_499(271701509, func_506(bParam0), 12999093, 0) };
		}
...
bool func_513(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
