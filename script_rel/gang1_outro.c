...
void func_92()
{
	...
	if (func_167(bVar0) && WEAPON::_0x0556E9D2ECF39D01(bVar0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_386(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_420(0))
				{
					...
					func_421(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
...
void func_409(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_494(func_493(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_177())
	{
