...
int func_6(var uParam0)
{
	...
	iVar0 = 1;
	if (!ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_16, 1, 0))
	{
		iVar0 = 0;
	}
...
int func_21(var uParam0)
{
	...
	func_53(0, 0);
	func_54(1);
	if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(iLocal_16, 1, 0) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_16, "PBL_1"))
	{
		...
		if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_16, 0) && !ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_16, 0))
		{
			func_55();
			func_56(100f, 0, 0, 1);
			func_57(100f, 0, 0, 1);
...
int func_23(var uParam0)
{
	...
	if (!bLocal_18)
	{
		if (ANIMSCENE::_IS_ANIM_SCENE_STARTED(iLocal_16, 0) && !CAM::IS_SCREEN_FADING_IN())
		{
...
void func_61()
{
	...
	if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(iLocal_16, 0) && !bLocal_18)
	{
...
void func_63(int iParam0, int iParam1)
{
	...
	if (func_149(*iParam0, 32))
	{
		...
		func_152(-1623728698 /* GXTEntry: "Bandana" */, 0);
	}
...
void func_91(bool bParam0, bool bParam1)
{
	...
	while (iVar2 < 29)
	{
		...
		{
			if (func_167(bVar3) && WEAPON::_0x705BE297EEBDB95D(bVar3))
			{
				if (bParam0)
				{
...
void func_92()
{
	...
	bVar0 = func_169(Global_35, 9, 1, 0);
	if (func_167(bVar0))
	{
		return;
	}
	bVar0 = func_169(Global_35, 7, 1, 0);
	if (func_167(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 8, false, false);
	}
	bVar0 = func_169(Global_35, 0, 1, 0);
	if (func_167(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	}
	bVar0 = func_169(Global_35, 1, 1, 0);
	if (func_167(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	}
	bVar0 = func_169(Global_35, 18, 1, 0);
	if (func_167(bVar0) && WEAPON::_IS_WEAPON_TWO_HANDED(bVar0))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
		return;
	...
	if (func_167(bVar0))
	{
		...
		{
			func_171(Global_35, bVar0, 1, 0, 9, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
		}
		else
		{
			WEAPON::SET_CURRENT_PED_WEAPON(Global_35, bVar0, true, 9, false, false);
...
void func_152(bool bParam0, int iParam1)
{
	...
	Var0 = { func_269(bParam0, 0, 0) };
	Var5 = { func_280(bParam0, Var0, Var0.f_4, 0) };
	if (func_281(bParam0, Var0, Var0.f_4, 0) <= 0)
	{
		return;
	}
...
bool func_171(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_167(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_229(int iParam0)
{
	switch (iParam0)
	{
		...
		case 43:
			return -1841822177 /* GXTEntry: "Arrow - Improved" */;
		case 5:
		...
		case 37:
			return 1222378998 /* GXTEntry: "Improved Throwing Knife" */;
		case 38:
		...
		case 42:
			return -834103244 /* GXTEntry: "Tomahawk - Improved" */;
		case 44:
			return 2113196069;
		default:
			break;
...
struct<5> func_269(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_383(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_280(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_385(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_386(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_386(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_387(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_390(bParam0, -1823706425))
			{
				Var0 = { func_280(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_390(bParam0, -1483207246))
			{
				Var0 = { func_280(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
struct<4> func_280(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_281(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_280(bParam0, Param1, iParam5, bParam6) };
...
int func_300(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_386(bParam0, &Var0, iVar5, 0))
			{
				if (func_387(bParam0, &Var6, iVar5))
				{
					Var29 = { func_280(bParam0, Var0, iVar5, 0) };
					func_419(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
...
void func_304(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		uVar2 = func_428(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_429(1, bVar1, 1, uVar2);
...
int func_314(int iParam0, bool bParam1)
{
	...
	Var29 = { func_280(bParam1, Var0, 1415981582, 0) };
...
int func_315(int iParam0, bool bParam1)
{
	...
	Var29 = { func_280(bParam1, Var0, -2119169513, 0) };
	return func_435(Var29, 1);
}
...
{
	if (func_389(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_476(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_387(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_477(bParam0, &uVar0, uParam1, iParam2))
	{
...
int func_419(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_477(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_282(0);
	*uParam1 = { func_280(bParam0, func_384(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
