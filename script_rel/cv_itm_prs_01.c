...
int func_76(var uParam0)
{
	...
	func_162(uParam0, iLocal_14, 4, -717884433, "PROP_HUMAN_FOODPREP_STEW_RESTING_MALE_D", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	{
		iLocal_28 = func_201("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_8(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_112(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_224(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_226(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_227(iParam0, 0));
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_225((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_273(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_357(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_377(-1780177928 /* GXTEntry: "Revolver Cartridges - High Velocity" */);
		...
		case 2:
			...
			uParam0->f_22 = func_377(1627068364 /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_377(-1635450397 /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_377(-755485480 /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_377(-951828978 /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_377(-2076104686 /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_377(1478239863 /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_377(338147422 /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_377(1483206625 /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_377(-898386032 /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_377(730856618 /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_377(230530039 /* GXTEntry: "Health Cure" */);
...
void func_322(int iParam0)
{
	...
	{
		case 9:
			if (func_378(1427759409 /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_379();
...
void func_323(var uParam0)
{
	...
	uVar0 = func_381(*uParam0);
	uVar1 = func_382(*uParam0);
	iVar2 = MISC::GET_HASH_KEY(func_383(uParam0->f_3));
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(9, uVar0, func_384(func_24()), 1307979820, func_385(*uParam0), 0);
		UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(9, uVar0, iVar2, 1997120069);
		UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(9, uVar0, uVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_386(1, 688258043 /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_386(2, -1477273558 /* GXTEntry: "Peppermint" */, 0);
			func_386(3, 128702355 /* GXTEntry: "Milkweed" */, 0);
			func_386(4, 1613651027 /* GXTEntry: "Hair Pomade" */, 0);
			func_386(5, 0, -998653403 /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
...
void func_326(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_392(&uVar4, joaat("COLOR_PURE_WHITE"));
		sVar2 = func_393(uParam0->f_3, 0);
		func_387(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, MISC::_CREATE_VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_387(uParam0, 1896170705 /* GXTEntry: "Find ~1~ some ~2~." */, HUD::_GET_LABEL_TEXT_BY_HASH(iVar0), 0, bParam1, 0);
	}
}
...
int func_343()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_399(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_378(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_428(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_426(bool bParam0, int iParam1)
{
	...
	if (func_473(bParam0, 1399091007))
	{
...
int func_445(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_485(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_225(iParam0, 1), &uVar4);
				}
...
int func_460(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return 0;
...
void func_462(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_240(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_240(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_240(iParam5, 32), 1);
...
void func_474(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_478(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_428(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_491(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_225(iParam0, 1));
...
{
	return func_520(joaat("character"), func_543(), -1591664384, bParam0);
}
...
struct<4> func_520(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_428(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_550(bParam0, &Var0, iVar5, 0))
			{
				if (func_551(bParam0, &Var6, iVar5))
				{
					...
					func_552(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_553(0))
				{
					...
					func_554(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
int func_552(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_554(bool bParam0, int iParam1, int iParam2)
{
	if (iParam1 < 1)
	{
		return 1;
...
int func_564(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_428(0);
	*uParam1 = { func_520(bParam0, func_476(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
