...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_99(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_99(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_99(&cVar6, joaat("COLOR_PURE_WHITE")), func_99(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_62(int iParam0, bool bParam1)
{
	...
	func_105(func_104(-1532769513, joaat("areas")), 1);
