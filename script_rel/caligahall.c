...
int func_11()
{
	uLocal_14 = ((*Global_1888801)[95 /*35*/])->f_4;
	return 1;
}
...
{
	iParam0 = iParam0;
	func_54(95, uLocal_14, &uLocal_15);
	if (func_20() == -1)
	{
		if (!func_55(0, 0, 1))
		{
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_130(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_130(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_130(&cVar6, joaat("COLOR_PURE_WHITE")), func_130(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_97(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1 || bParam2)
	{
		if (VOLUME::_0x666C2F53ABEFC952(uParam0) == 1030835986)
		{
			VOLUME::_0xFD010A2154B40676(uParam0, 623901053);
		}
		return 0;
	}
	else if (VOLUME::_0xF256A75210C5C0EB(uParam0, Global_36))
	{
		switch (Global_1935630->f_44)
		{
			case joaat("weapon_unarmed"):
			case joaat("weapon_kit_camera"):
			case 191707516: /* GXTEntry: "Electrostatic Detector" */
				if (VOLUME::_0x666C2F53ABEFC952(uParam0) != 1030835986)
				{
					VOLUME::_0xFD010A2154B40676(uParam0, 1030835986);
				}
				break;
...
void func_111(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	if (func_110(iParam0))
	{
...
void func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
