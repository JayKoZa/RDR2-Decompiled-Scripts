...
void func_56(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_110(iParam0))
	{
		...
		if (bParam3)
		{
			func_111(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_97(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam1 || bParam2)
	{
		if (VOLUME::_0x666C2F53ABEFC952(iParam0) == joaat("REL_GANG_DUTCHS"))
		{
			VOLUME::_0xFD010A2154B40676(iParam0, joaat("REL_NO_RELATIONSHIP"));
		}
		return 0;
	}
	else if (VOLUME::_IS_POSITION_INSIDE_VOLUME(iParam0, Global_36))
	{
		switch (Global_1935630.f_44)
		{
			...
			case joaat("WEAPON_KIT_DETECTOR"):
				if (VOLUME::_0x666C2F53ABEFC952(iParam0) != joaat("REL_GANG_DUTCHS"))
				{
					VOLUME::_0xFD010A2154B40676(iParam0, joaat("REL_GANG_DUTCHS"));
				}
				break;
...
void func_111(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_110(iParam0))
	{
