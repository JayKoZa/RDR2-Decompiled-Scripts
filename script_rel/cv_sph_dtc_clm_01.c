...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3f, -2.0004f, 0f, 0f, 4.5f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, vLocal_22, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_26, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_151(uParam0, vLocal_30, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
	...
	func_154(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_335(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_405(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_402(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
