...
bool func_319(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_190(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_GET_CURRENT_VEHICLE_DRIVER(iVar0) == Global_35)
		{
			return false;
		}
	}
...
bool func_430(int iParam0, int iParam1, var uParam2)
{
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_610(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_447()
{
	...
	while (iVar1 < 30)
	{
		if (func_617(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_451()
{
	...
	while (iVar1 < 5)
	{
		if (func_618(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_468(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_629(iParam0, iParam2, iParam1, func_108() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_631(func_622(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
float func_479()
{
	...
	func_646(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_480()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_646(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_481()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_646(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
int func_498(int iParam0)
{
	...
	if (!func_665(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_679(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
{
	return func_421(joaat("CHARACTER"), func_693(), -1591664384, bParam0);
}
...
void func_628(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_716(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_610(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_224(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_610(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_220(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_630(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_721(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_638(struct<4> Param0)
{
	...
	if (func_727(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_727(20))
			{
				return;
			}
			iVar0++;
...
void func_654(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_653(iParam0))
	{
		...
		if ((!func_657() && !bParam1) && !func_658(0, 0, 1))
		{
			func_524(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_733(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
bool func_658(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_735(Global_1898164.f_1[0 /*5*/]);
		if (func_342(iVar0) && func_736(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
...
bool func_675()
{
	if (ATTRIBUTE::GET_ATTRIBUTE_POINTS(Global_35, 22) > 7500 || func_749(func_290(joaat("BATHS_TAKEN"))) < 1)
	{
		return true;
	}
	return false;
...
int func_698(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_756(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_756(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_701(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_763(iParam0));
	...
	func_410(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_766(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_723(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_108() == -1)
	{
		func_779(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_780(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_831(&(uParam0->f_1[iParam1 /*5*/]));
