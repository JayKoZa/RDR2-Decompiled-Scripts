...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_27 = joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY");
	iLocal_28 = joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER");
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
{
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_27, false))
	{
		STREAMING::_0x4EDDD9E9CA5AF985(iLocal_27);
	}
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_28, false))
	{
	...
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_44))
	{
...
bool func_73(var uParam0)
{
	...
	func_156(uParam0, vVar0, fVar6, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 0, 1, 1);
	func_156(uParam0, vVar3, fVar7, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 0, 1, 1);
	func_156(uParam0, 0.5f, 0f, 0f, 0f, 4f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_157(uParam0, vLocal_37, 0f, 4f, 4f, 3f, joaat("VOLCYLINDER"), 0);
	...
	func_159(uParam0, iLocal_20, 3, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS"), "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_20, iLocal_17, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_161(uParam0, iLocal_20, 1);
	func_159(uParam0, iLocal_19, 3, joaat("PROP_HUMAN_SEAT_CHAIR_GUITAR"), "PROP_HUMAN_SEAT_CHAIR_GUITAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_19, iLocal_16, "p_guitar01x_PH_R_HAND", 0, 0);
	func_162(uParam0, iLocal_19, 1);
	func_161(uParam0, iLocal_19, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_27, 15, 0, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D"));
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_28, 15, 0, joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A"));
	return true;
}
...
{
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_27, false) && STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_28, false))
	{
		return true;
	}
	return false;
...
bool func_87(var uParam0)
{
	...
	iLocal_44 = TASK::CREATE_SCENARIO_POINT(iLocal_28, vLocal_33, fLocal_36, 0, 0, 0);
	iLocal_43 = TASK::CREATE_SCENARIO_POINT(iLocal_27, vLocal_29, fLocal_32, 0, 0, 0);
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_44) && TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_43))
	{
...
bool func_94(var uParam0)
{
	...
	{
		if ((!bLocal_22 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19))) && TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_43))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_19), iLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, true, false, 0, true, -1f, false);
			ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1984[iLocal_15], vLocal_37, vLocal_40, 2);
			func_116(&uLocal_24, 0);
			bLocal_22 = true;
		}
		if ((!bLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_44))
		{
			if (func_110(&uLocal_24) > 1.2f)
			{
				TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_20), iLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, true, false, 0, true, -1f, false);
				bLocal_23 = true;
			}
		}
	}
	if (bLocal_23 && bLocal_22)
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19)) && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20)))
		{
			...
			{
				iLocal_45 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_GET_SCENARIO_POINT_ENTITY(iLocal_44, "p_bottleBeer01x_PH_R_HAND"));
				iLocal_46 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_GET_SCENARIO_POINT_ENTITY(iLocal_43, "p_bottleJD01x_ph_r_hand"));
				...
				func_204(func_203(uParam0, iLocal_20), 1061142135 /* Float: 0.749f */);
				func_204(func_203(uParam0, iLocal_19), 1061142135 /* Float: 0.749f */);
			}
		}
	}
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_302(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
