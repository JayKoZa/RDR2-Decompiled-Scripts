...
int func_1(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_44))
	{
		TASK::_0x81948DFE4F5A0283(uLocal_44);
	}
	return 1;
}
...
int func_87(var uParam0)
{
	...
	uLocal_44 = TASK::CREATE_SCENARIO_POINT(iLocal_28, vLocal_33, fLocal_36, 0, 0, 0);
	uLocal_43 = TASK::CREATE_SCENARIO_POINT(iLocal_27, vLocal_29, fLocal_32, 0, 0, 0);
	if (TASK::_0x841475AC96E794D1(uLocal_44) && TASK::_0x841475AC96E794D1(uLocal_43))
	{
		TASK::_0x5AF19B6CC2115D34(uLocal_44, 23, 1);
		TASK::_0x5AF19B6CC2115D34(uLocal_44, 25, 1);
...
int func_94(var uParam0)
{
	...
	{
		if ((!bLocal_22 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19))) && TASK::_0x841475AC96E794D1(uLocal_43))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_19), uLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, 1, false, 0, 1, -1082130432, 0);
			ANIMSCENE::SET_ANIM_SCENE_ORIGIN(&(uParam0->f_1984[iLocal_15]), vLocal_37, vLocal_40, 2);
			func_116(&uLocal_24, 0);
			bLocal_22 = true;
		}
		if ((!bLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::_0x841475AC96E794D1(uLocal_44))
		{
			if (func_110(&uLocal_24) > 1.2f)
			{
				TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_20), uLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, 1, false, 0, 1, -1082130432, 0);
				bLocal_23 = true;
			}
		}
	}
	if (bLocal_23 && bLocal_22)
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_19)) && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20)))
		{
			...
			{
				iLocal_45 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_0x295514F198EFD0CA(uLocal_44, "p_bottleBeer01x_PH_R_HAND"));
				iLocal_46 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_0x295514F198EFD0CA(uLocal_43, "p_bottleJD01x_ph_r_hand"));
