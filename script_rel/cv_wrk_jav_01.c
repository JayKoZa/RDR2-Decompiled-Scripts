...
{
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_27, 0))
	{
		STREAMING::_0x4EDDD9E9CA5AF985(iLocal_27);
	}
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_28, 0))
	{
...
int func_73(var uParam0)
{
	...
	func_159(uParam0, iLocal_20, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_20, iLocal_17, "p_bottleBeer01x_PH_R_HAND", 0, 0);
	func_161(uParam0, iLocal_20, 1);
	func_159(uParam0, iLocal_19, 3, -920826181, "PROP_HUMAN_SEAT_CHAIR_GUITAR_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_160(uParam0, iLocal_19, iLocal_16, "p_guitar01x_PH_R_HAND", 0, 0);
	func_162(uParam0, iLocal_19, 1);
	func_161(uParam0, iLocal_19, 1);
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_27, 15, 0, -1196912204);
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_28, 15, 0, 1851339470);
	return 1;
}
...
{
	if (STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_27, 0) && STREAMING::_HAS_SCENARIO_TYPE_LOADED(iLocal_28, 0))
	{
		return 1;
	}
	return 0;
...
int func_87(var uParam0)
{
	...
	{
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_44, 23, 1);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_44, 25, 1);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_43, 23, 1);
		TASK::_SET_SCENARIO_POINT_FLAG(iLocal_43, 25, 1);
		func_193(uParam0);
		return 1;
	}
	return 0;
...
int func_94(var uParam0)
{
	if (func_201(uParam0, iLocal_14))
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_19), iLocal_43, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_WHISKEY_MALE_D", 0, 1, false, 0, 1, -1082130432, 0);
		...
		if ((!bLocal_23 && !ENTITY::IS_ENTITY_DEAD(func_49(uParam0, iLocal_20))) && TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_44))
		{
			...
			{
				TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_20), iLocal_44, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_BEER_MALE_A", 0, 1, false, 0, 1, -1082130432, 0);
				bLocal_23 = true;
			}
		}
	}
