...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -1.2548f, -4.3769f, 1.2774f, 137.8534f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.72f, -0.97f, 1f, 90f, 3f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_CROUCH_INSPECT"), "WORLD_HUMAN_CROUCH_INSPECT_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_196(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
bool func_296(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
