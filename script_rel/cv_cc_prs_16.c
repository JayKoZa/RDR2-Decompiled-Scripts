...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 3.9375f, -2.925f, 0.8945f, 88.25f, 1f, 1f, 2.2325f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, -1.025f, -0.7875f, 0.832f, 87.12f, 4.0325f, 2.4025f, 2.135f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL_DRINKING"), "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_393(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
