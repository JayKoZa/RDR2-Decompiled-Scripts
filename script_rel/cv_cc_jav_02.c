...
int func_72(var uParam0)
{
	...
	uLocal_21 = func_152(uParam0, joaat("p_stoolfolding01x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_14, 3, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", uLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_199(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
