...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_52(uParam0, 0, "IG_GenStoryMale", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 1, "IG_GenStoryMale^1", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
