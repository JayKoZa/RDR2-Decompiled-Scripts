...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2186f, -6.6304f, 1f, 0f, 1f, 1f, 2.75f, -1612834106, 211687389, 1, 1, 1);
	func_151(uParam0, -0.44f, -0.875f, 0f, 65f, 2.765f, 1.745f, 4f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, -0.345f, -0.872f, 1.311f, 54.769f, 1.595358f, 1.221463f, 1.711148f, 665633627, 1);
	...
	func_154(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_A", -1, 1);
	func_155(uParam0, iLocal_14, 2, 2, 0, 0, 0);
	func_154(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_16, 0);
	func_156(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_15, iLocal_17, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_158(uParam0, "script@vignette@kieran_12@base", 1, 1, 0, 0);
	func_158(uParam0, "script@vignette@kieran_12@action", 0, 0, 1, 0);
