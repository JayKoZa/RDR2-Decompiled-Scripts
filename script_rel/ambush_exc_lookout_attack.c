		...
		if (func_61(&(Local_15[iVar0]), 0, 0))
		{
			...
			switch (iVar0)
			{
				case 0:
					...
					func_131(&(Local_15[iVar0]), -1101297303, -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				case 3:
					func_131(&(Local_15[iVar0]), -1101297303, -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				case 1:
					func_131(&(Local_15[iVar0]), -1101297303, -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				default:
					func_131(&(Local_15[iVar0]), -594562071, -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
			}
...
int func_67(var uParam0)
{
	...
	while (iVar0 < uParam0->f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uParam0[iVar0]))
		{
			...
			{
				if (func_217(uParam0[iVar0], Global_36, 1) < (70f * 70f) || func_218(uParam0[iVar0], 70f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					return 1;
				}
			}
...
void func_75()
{
	...
	if (Local_15.f_19 < Local_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(Local_15[iVar0])))
		{
			...
			{
				if (func_218(&(Local_15[iVar0]), 200f, -1082130432 /* Float: -1f */, &(Local_15.f_9[iVar0]), -1082130432 /* Float: -1f */))
				{
	...
	else if (Local_15.f_19 < (Local_15.f_215 + Local_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(Local_15.f_40[iVar0])))
		{
			...
			{
				if (func_218(&(Local_15.f_40[iVar0]), 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
	...
	else if (Local_15.f_19 < ((Local_15.f_215 + Local_15.f_216) + Local_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(Local_15.f_49[iVar0])))
		{
			if (!func_225(&Local_15, iVar0, 8))
			{
				...
				{
					if (func_226(&(Local_15.f_49[iVar0]), 200f, -1082130432 /* Float: -1f */))
					{
...
int func_92(int iParam0)
{
	if (&Local_15.f_57[iParam0] == 0)
	{
		...
		{
			Local_15.f_57[iParam0] = func_250(997958153 /* GXTEntry: "Riding" */, 1);
		}
		else
		{
...
void func_138()
{
	...
	while (iVar0 < Local_15.f_215)
	{
		if (func_61(&(Local_15[iVar0]), 0, 1))
		{
			...
			{
				func_277(&(Local_15[iVar0]), Global_35, "CALLOUT_JUST_KILL_EM_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
				func_278(&(Local_15[iVar0]), Local_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
...
void func_147()
{
	AUDIO::_PLAY_SOUND_FROM_ENTITY("ALERT_WHISTLE_02", &(Local_15[0]), "GAROA_Sounds", 0, 0, 0);
...
void func_149()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(Local_15[iVar0]), 0, 1))
		{
			...
			{
				if (PED::IS_PED_SHOOTING(&(Local_15[iVar0])) || func_218(&(Local_15[iVar0]), 1116471296 /* Float: 70f */, 10f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					func_278(&(Local_15[iVar0]), Local_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
				}
			}
	...
	if (bVar1 && uParam0->f_182.f_17 & 1 != 0)
	{
		if (!func_289(&(uParam0->f_182), 2))
		{
			...
			else
			{
				...
				{
					bVar4 = func_297(Global_35, &(uParam0->f_182.f_6), uParam0->f_182.f_5, 0, 0, 1084227584 /* Float: 5f */, 100, 0, 0);
				}
				if (bVar4)
				{
...
int func_151()
{
	switch (Local_274.f_5)
	{
		...
		case 1:
			...
			{
				func_277(&(Local_15[0]), Global_35, "ITS_MALE_EXTREME", -1073741824 /* Float: -2f */, 1, -500314840, 1);
...
void func_166()
{
	...
	{
		vVar0 = { func_283(Global_35, 1065353216 /* Float: 1f */) };
...
{
	if (func_353(iParam1, 1114636288 /* Float: 60f */) || func_355(iParam1, 1, 1) <= 30f)
	{
		return 0;
	}
	return 1;
...
void func_248(var uParam0, float fParam1)
{
	...
	func_368(uParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432 /* Float: -1f */);
	vVar0 = { uParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { uParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_356(vVar0, vVar3, 0) };
	vVar9 = { func_357(vVar0, vVar3, 0) };
...
var func_256(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return STREAMING::_REQUEST_SCENARIO_TYPE(iParam0, uParam1, iParam2, iParam3);
}
...
int func_275(var uParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_297(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, float fParam5, int iParam6, float fParam7, float fParam8)
{
	...
	if (func_361(*uParam1, 2))
	{
		...
		else if ((func_181(iParam2, 128) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_LAST_MOUNT(iParam0))) && ENTITY::DOES_ENTITY_EXIST(PED::_GET_FIRST_ENTITY_PED_IS_CARRYING(PED::_GET_LAST_MOUNT(iParam0))))
		{
...
void func_300()
{
	...
	while (iVar3 <= 4)
	{
		if (func_61(&(Local_15[iVar3]), 0, 0))
		{
			...
			if (!bVar5)
			{
				func_277(&(Local_15[iVar3]), Global_35, "MOVE_IN", -1073741824 /* Float: -2f */, 1, 1808677283, 2);
				bVar5 = true;
			}
...
bool func_312(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_413(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
int func_349(var uParam0, int iParam1)
{
	...
	{
		if (func_218(iParam1, 200f, (30f * 3f), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
		{
			return 0;
		}
	}
	else if (func_218(iParam1, 200f, 30f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
	{
		return 0;
	}
	if (!PED::IS_PED_HUMAN(iParam1))
...
int func_385(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_434(bParam0, &Var0, iVar5, 0))
			{
				if (func_435(bParam0, &Var6, iVar5))
				{
					Var29 = { func_436(bParam0, Var0, iVar5, 0) };
					func_437(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_438(0))
				{
					...
					func_439(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_440(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
void func_386(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
int func_389(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_390(var uParam0, var uParam1)
{
	...
	if (*uParam1)
	{
		if (bVar0 && !func_426(((*Global_1835011)[4 /*74*/])->f_1, 1))
		{
			if (func_469(5))
			{
				func_470(5);
	...
	if ((bVar0 && func_426(((*Global_1835011)[37 /*74*/])->f_1, 1)) && !func_426(((*Global_1835011)[43 /*74*/])->f_1, 1))
	{
		*uParam0 = 1;
		return 0;
	}
	if ((bVar0 && func_426(((*Global_1835011)[43 /*74*/])->f_1, 1)) && !func_426(((*Global_1835011)[44 /*74*/])->f_1, 1))
	{
		if (uParam1->f_10 == 0)
		{
			*uParam0 = 1;
...
void func_407(bool bParam0)
{
	...
	while (iVar0 < Local_15.f_216)
	{
		if (func_61(&(Local_15.f_40[iVar0]), 0, 0))
		{
			if (!bParam0)
			{
				if (PED::_GET_RIDER_OF_MOUNT(&(Local_15.f_40[iVar0]), 1) != 0)
				{
				}
				else
				{
...
struct<5> func_432(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_514(bParam0))
	{
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_516(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_434(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_434(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_435(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_434(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_521(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_435(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_522(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_436(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	if (!func_523(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_524(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_437(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_440(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_388(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_529(1) || *iParam0 & 8192 != 0))
				{
...
int func_445(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_542(iParam1, !*iParam2 & 268435456 != 0, !*iParam2 & 536870912 != 0, !*iParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_540(iParam2, iParam0, fVar0, fVar1))
		{
			...
			if (iParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - iParam2->f_2) > func_541(iParam2)
				{
					func_536(iParam2, 1);
					return 1;
				}
...
int func_446(int iParam0, int iParam1)
{
	...
	if (func_532(iParam0, iParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - iParam1->f_3) > func_541(iParam1)
		{
...
int func_467(int iParam0, int iParam1)
{
	...
	{
		return func_563(iParam0, iParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_495(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_603(func_602(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_500(var uParam0, float fParam1, int iParam2)
{
	...
	return func_604(&iVar0, uParam0->f_209, fParam1, 0, 0, 1084227584 /* Float: 5f */, bVar6, iParam2);
}
...
{
	return func_436(joaat("character"), func_623(), -1591664384, bParam0);
}
...
int func_516(bool bParam0, bool bParam1)
{
	if (func_518(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_624(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_520(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_521(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_436(bParam0, Param1, iParam5, bParam6) };
...
int func_522(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_524(0);
	*uParam1 = { func_436(bParam0, func_515(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_540(int iParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_549(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_550(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_551(int iParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_604(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, int iParam9)
{
	...
	{
		iVar12 = func_675(&iVar0, iParam0, iVar0, vParam1, iParam4);
	}
	iVar13 = 0;
	while (iVar13 < iVar12)
	{
...
void func_613(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_684(func_683(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_649())
	{
...
int func_633(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_640(int iParam0, bool bParam1)
{
	...
	Var29 = { func_436(bParam1, Var0, 1415981582, 0) };
...
int func_641(int iParam0, bool bParam1)
{
	...
	Var29 = { func_436(bParam1, Var0, -2119169513, 0) };
	return func_689(Var29, 1);
}
...
int func_669(struct<4> Param0, int iParam4, int iParam5)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_699(Param0, iParam4, &Var0, iParam5))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_670(bool bParam0, int iParam1)
{
	...
	if (bParam0 != 0)
	{
		iVar5 = func_518(bParam0);
		if (iVar5 != 0)
		{
			iVar6 = func_700(bParam0);
			iVar0 = 0;
			while (iVar0 < iVar6)
			{
...
var func_673(int iParam0, var uParam1)
{
...
int func_675(int iParam0, int iParam1, int iParam2, vector3 vParam3, int iParam6)
{
	int iVar0;
	int iVar1;

	iVar0 = VOLUME::_CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, iParam6, iParam6, iParam6);
	iVar1 = func_674(iParam0, iParam1, iVar0, iParam2);
	func_677(iVar0);
	return iVar1;
}
...
int func_691(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_693(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> Var0;
	int iVar14;
	int iVar15;
...
int func_694(var uParam0, bool bParam1)
{
...
int func_695(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	struct<16> Var28;
...
int func_699(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
	...
	if (!INVENTORY::_0x22E590F108289A9D(func_524(bParam6), &uParam0, iParam4, &Var0))
	{
		return 0;
	}
...
int func_704(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("horse"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_712(joaat("update"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("clothing"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_714(joaat("update"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_706(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_707(joaat("update"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<28> func_711(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<28> Var0;
	struct<29> Var28;
...
struct<17> func_713(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<17> Var0;
	struct<15> Var17;
