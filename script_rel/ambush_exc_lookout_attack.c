...
{
	return STREAMING::_0x19A6BE7D9C6884D3(iParam0, uParam1, iParam2, iParam3);
}
		...
		while (iVar28 < 4)
		{
			...
			if (func_434(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_438(0))
				{
					...
					func_439(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
...
void func_440(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_388(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
...
void func_613(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_684(func_683(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_649())
	{
