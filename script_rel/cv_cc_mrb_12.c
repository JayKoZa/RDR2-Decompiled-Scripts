...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		...
		case 3:
			...
			break;
		case 6:
			func_150(uParam0, 2354.204f, 1347.875f, 104.8036f, 0f, 0f, -119.51f);
			break;
		default:
			return 0;
	}
	...
	func_152(uParam0, 1.4424f, -0.6369f, 0.6758f, 0f, 1.1f, 1.1f, 2f, -1612834106, -1689743484, 1, 1, 1);
	func_152(uParam0, -0.053f, -0.2284f, 0.5413f, 0f, 1.1f, 1.1f, 2f, -1612834106, -1377448058, 1, 1, 1);
	func_153(uParam0, 0.759933f, -0.612731f, 1.00159f, 0f, 1.1f, 1.1f, 2f, 665633627, 1);
	...
	uLocal_16 = func_154(uParam0, joaat("p_chair_crate15x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_155(uParam0, iLocal_14, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", uLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_FEMALE_A", uLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	func_158(uParam0, iLocal_15, 3, 0);
	func_156(uParam0, iLocal_15, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_15, 1.3f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	func_161(uParam0, "script@vignette@marybeth_12@base", 1, 1, 0, 0);
	func_161(uParam0, "script@vignette@marybeth_12@Action", 0, 0, 1, 0);
...
{
	return STREAMING::_HAS_SCENARIO_TYPE_LOADED(-38747227, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		func_202(uParam0, iLocal_15, 1, 1);
	}
	return 1;
}
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_306(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_258(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_307(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_318()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_361(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_332(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_367(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_352(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_390(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_367(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
...
int func_377(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
		...
		case 1:
			...
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(747937920, 1) && !func_397(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
