...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 1.4424f, -0.6369f, 0.6758f, 0f, 1.1f, 1.1f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -0.053f, -0.2284f, 0.5413f, 0f, 1.1f, 1.1f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_153(uParam0, 0.759933f, -0.612731f, 1.00159f, 0f, 1.1f, 1.1f, 2f, joaat("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	func_158(uParam0, iLocal_15, 3, 0);
	func_156(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", -1, 0, 120f, 1065353216 /* Float: 1f */, 1);
		...
		case 1:
			...
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
