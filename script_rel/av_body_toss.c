...
{
	func_33(uParam0, 10786, 10844, 11622);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "MALE_A", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "MALE_B", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 2, "MALE_DEAD", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[2])
	{
		if (func_68(uParam0, 1065353216 /* Float: 1f */, 50f, 4, 25f, 1112014848 /* Float: 50f */))
		{
			func_66(uParam0);
	...
	if (uParam0->f_469[2])
	{
		if (!uParam0->f_469[7])
		{
			if (func_69(uParam0, fLocal_37, 50f, 4, joaat("ACTION"), 1))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[7] = 1;
			}
...
bool func_65(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_105(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_75(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_145(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_89(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_155(iParam1))
		{
			func_156(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_102(int iParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
bool func_107(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_108(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_126(int iParam0, var uParam1)
{
	...
	{
		return func_199(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_130(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_145(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_145(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_165(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_168(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
bool func_171(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_218(iVar0, 0)))
		{
...
bool func_173(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_175(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_180(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_189(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_195(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
bool func_214(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_220(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
