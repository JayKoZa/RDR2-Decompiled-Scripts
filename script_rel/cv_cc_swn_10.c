...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, 4.8939f, -0.71f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_152(uParam0, 3.7439f, -4.0725f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, 25f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	return func_167(uParam0, vLocal_20, joaat("WORLD_HUMAN_FIRE_COFFEE_KETTLE"), &iLocal_24, "p_boiler02x_PH_L_HAND", 0);
}
...
int func_167(var uParam0, vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	...
	{
		*iParam5 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(vParam1, iParam4, 1f, 0, false);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
...
void func_190(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_285(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_285(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
bool func_207(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_245()
{
	...
	if (func_320(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_246()
{
	...
	if (func_320(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_254(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_322(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_274(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_293(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
void func_332(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_364(iParam1))
		{
			func_365(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_390(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_393(int iParam0, int iParam1)
{
	...
	bVar0 = func_436(iParam0, iParam1);
	return bVar0;
}
...
bool func_411(int iParam0, char* sParam1)
{
...
bool func_413(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_384(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_442(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_460(iVar0))
		{
	...
	{
		func_462(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		...
		while (iVar28 < 4)
		{
			...
			if (func_471(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_475(0))
				{
					...
					func_476(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_469(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_481(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_483(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_471(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_471(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_472(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_471(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_488(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_472(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
bool func_474(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_477(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_494(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_482(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_473(923904168, func_480(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_473(923904168, func_480(bParam0), -740156546, 0) };
		}
...
struct<4> func_484(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_473(271701509, func_480(bParam0), 12999093, 0) };
		}
...
bool func_487(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_489(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
