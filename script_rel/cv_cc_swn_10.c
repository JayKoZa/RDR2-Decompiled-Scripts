...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_20 = { -133.89f, -17.48f, 95.14f };
			break;
		case 2:
			func_150(uParam0, 673.066f, -1266.676f, 42.93f, 0f, 0f, 142.755f);
			vLocal_20 = { 672.5f, -1261.14f, 42.98f };
			break;
		case 3:
			func_150(uParam0, 1881.889f, -1874.921f, 41.752f, 0f, 0f, -180f);
			vLocal_20 = { 1878.09f, -1870.85f, 41.81f };
			break;
	}
	iLocal_15 = func_151(uParam0, 21, 0);
	iLocal_14 = func_151(uParam0, 5, 0);
	func_152(uParam0, 4.8939f, -0.71f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, 1243438920, 1, 1, 1);
	func_152(uParam0, 3.7439f, -4.0725f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, 1267380940, 1, 1, 1);
	...
	iLocal_16 = func_154(uParam0, "script@vignette@swanson_10@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@swanson_10@action", 0, 0, 1, 0);
	func_155(uParam0, "CSW10AU");
	func_156(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 2, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, 25f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_159(uParam0, iLocal_15, 1, 2, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, -1489483851, 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	return func_167(uParam0, vLocal_20, -144572502, &iLocal_24, "p_boiler02x_PH_L_HAND", 0);
}
...
{
	func_174(iLocal_23, &(uParam0->f_1984[iLocal_16]), "BOILER");
	func_174(iLocal_23, &(uParam0->f_1984[iLocal_17]), "BOILER");
	return 1;
}
...
{
	if (ANIMSCENE::_0x005E6F28DD7ED58D(&(uParam0->f_1984[iLocal_17]), "BOILER"))
	{
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_24))
		{
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_23))
			{
				if (TASK::_0x8360C47380B6F351(iLocal_24, iLocal_23, "p_boiler02x_PH_L_HAND", 1))
				{
				}
			}
		}
...
int func_167(var uParam0, vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		return 1;
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(*iParam5))
	{
		*iParam5 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(vParam1, iParam4, 1f, 0, 0);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		iLocal_23 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_GET_SCENARIO_POINT_ENTITY(*iParam5, sParam6));
	}
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_174((uParam0->f_1711[iVar0 /*15*/])->f_10, &(uParam0->f_1984[iVar6]), (uParam0->f_1711[iVar0 /*15*/])->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_174((uParam0->f_1967[iVar1 /*4*/])->f_3, &(uParam0->f_1984[iVar2]), (uParam0->f_1967[iVar1 /*4*/])->f_2);
						}
						iVar2++;
					}
				}
...
void func_253(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_321(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_254(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_322(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
void func_300(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_339(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_309()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_344(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_322(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_323(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	var uVar0;
	int iVar1;
	...
	iVar1 = func_350(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_328(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_336(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_350(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_120(iVar0, 0)) || (bParam3 && !func_51(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_381(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_360(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_390(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_389(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_392(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_381(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_410(iParam0) && func_411(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_413(iParam0, vVar0, iParam6, iParam10))
				{
					return func_412();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_206(vVar0)) && !func_207(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_392(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_390(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_428(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_397(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_442(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_442(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_413(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_423(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1[5];
	int iVar7;
...
bool func_442(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
