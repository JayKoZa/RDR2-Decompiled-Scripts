...
{
	return func_167(uParam0, vLocal_20, -144572502, &uLocal_24, "p_boiler02x_PH_L_HAND", 0);
}
...
int func_93(var uParam0)
{
	if (ANIMSCENE::_0x005E6F28DD7ED58D(&(uParam0->f_1984[iLocal_17]), "BOILER"))
	{
		if (TASK::_0x841475AC96E794D1(uLocal_24))
		{
			...
			{
				if (TASK::_0x8360C47380B6F351(uLocal_24, iLocal_23, "p_boiler02x_PH_L_HAND", 1))
				{
				}
			}
		}
...
int func_167(var uParam0, vector3 vParam1, int iParam4, int iParam5, char* sParam6, bool bParam7)
{
	...
	if (!TASK::_0x841475AC96E794D1(*iParam5))
	{
		*iParam5 = TASK::_0xF533D68FF970D190(vParam1, iParam4, 1f, 0, 0);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
