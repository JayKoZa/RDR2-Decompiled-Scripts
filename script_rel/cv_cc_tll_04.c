...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 1.75f, 2.9675f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_151(uParam0, 0.0625f, -0.275f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.3125f, -0.8375f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, 0.75f, -0.5f, 0f, -18f, 1.53f, 0.8f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_WASHBOARD"), "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_16, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", iLocal_22, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_95(var uParam0)
{
	...
	if (PED::_IS_PED_USING_SCENARIO_POINT(iVar1, iVar0))
	{
		return false;
	}
...
void func_190(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_288(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_288(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
int func_247()
{
	...
	if (func_324(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_248()
{
	...
	if (func_324(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_295(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_300(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_396(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_399(int iParam0, int iParam1)
{
	...
	bVar0 = func_442(iParam0, iParam1);
	return bVar0;
}
...
bool func_417(int iParam0, char* sParam1)
{
...
bool func_419(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_390(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_448(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_466(iVar0))
		{
	...
	{
		func_468(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_469(iParam0, &iVar0, &fVar25);
		...
		while (iVar28 < 4)
		{
			...
			if (func_477(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_481(0))
				{
					...
					func_482(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_475(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_487(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_489(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_477(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_477(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_478(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_477(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_494(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_478(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
bool func_480(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_483(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_500(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_488(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_479(923904168, func_486(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_479(923904168, func_486(bParam0), -740156546, 0) };
		}
...
struct<4> func_490(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_479(271701509, func_486(bParam0), 12999093, 0) };
		}
...
bool func_493(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_495(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
