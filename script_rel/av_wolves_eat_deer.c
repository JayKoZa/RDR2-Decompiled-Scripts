	...
	switch (iLocal_12)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), 1974927641, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[2 /*14*/]), -1369415261, (uParam0->f_20[2 /*14*/])->f_5, (uParam0->f_20[2 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[3 /*14*/]), 1974927641, (uParam0->f_20[3 /*14*/])->f_5, (uParam0->f_20[3 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
...
int func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_193(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
