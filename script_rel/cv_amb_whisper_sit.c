...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 3f, -1612834106, -1, 1, 1, 1);
	uLocal_16 = func_152(uParam0, joaat("p_chairfolding02x"), 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_17 = func_153(uParam0, "script@ambient@town@whisper@sit@action", 0, 0, 0, 0);
	iLocal_18 = func_154(uParam0, iLocal_17, "PBL_ACTION", 1);
	func_155(uParam0, iLocal_15, 3, 1858605558, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", uLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, -130f, 1);
	func_157(uParam0, iLocal_14, 1.15f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	return 1;
}
...
{
	func_196(uParam0, iLocal_17, "Loop", 1);
	return 1;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_206(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_208(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_209(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_209(iParam0, 0));
					func_210(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_246(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
void func_156(var uParam0, int iParam1, float fParam2, bool bParam3)
{
	if (bParam3)
	{
...
void func_157(var uParam0, int iParam1, float fParam2, int iParam3, int iParam4)
{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_207((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_196(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
int func_355(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_239(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_207(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_204(vVar0)) && !func_205(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_207(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_391(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_222(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_222(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_222(iParam5, 32), 1);
...
int func_412(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_207(iParam0, 1));
