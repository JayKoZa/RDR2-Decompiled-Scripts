...
int func_95(var uParam0)
{
	...
	uLocal_124 = TASK::CREATE_SCENARIO_POINT(830847823, -104.84f, -11.56f, 94.51f, -106.129f, 0, 0, 0);
	TASK::_0x5AF19B6CC2115D34(uLocal_124, 23, 1);
	TASK::_0x5AF19B6CC2115D34(uLocal_124, 25, 1);
...
int func_98(var uParam0)
{
	if (!bLocal_123)
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_92), uLocal_124, 0, -1, 1, false, 0, 0, -1082130432, 0);
			return 1;
		}
		...
		while (iVar28 < 4)
		{
			...
			if (func_565(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_569(0))
				{
					...
					func_570(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
