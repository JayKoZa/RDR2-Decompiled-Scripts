...
void func_8(var uParam0)
{
	...
	TASK::TASK_GO_STRAIGHT_TO_COORD(0, -56.5706f, 20.6479f, 92.1539f, 2f, -1, 1193033728 /* Float: 40000f */, 1056964608 /* Float: 0.5f */, 0);
	...
	TASK::_TASK_MOVE_IN_TRAFFIC_2(0, -228.4251f, 633.0844f, 112.218f, 1073741824 /* Float: 2f */, func_51(1.25f, 1.75f, 0.4f), 0, 0);
...
bool func_81(var uParam0)
{
	...
	func_166(uParam0, 3.6852f, -4.1639f, 0.9639f, 8.4934f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_166(uParam0, 3.99f, 18.41f, 1.3566f, 137.0659f, 12.96f, 14.92f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	iLocal_127 = joaat("A_C_HORSE_MORGAN_FLAXENCHESTNUT");
	...
	iLocal_107 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), -96.7767f, -15.1897f, 95.8847f, 0f, 0f, 0f, 3.5f, 3.5f, 2.5f);
...
bool func_95(var uParam0)
{
	...
	iLocal_124 = TASK::CREATE_SCENARIO_POINT(joaat("WORLD_HUMAN_STARE_STOIC"), -104.84f, -11.56f, 94.51f, -106.129f, 0, 0, 0);
...
bool func_98(var uParam0)
{
	if (!bLocal_123)
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_49(uParam0, iLocal_92), iLocal_124, 0, -1, true, false, 0, false, -1f, false);
			return true;
		}
...
int func_122(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_135(iVar0, 0))
	{
		if (func_135(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_209(var uParam0, int iParam1, char* sParam2)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		{
			func_319(iParam1, uParam0->f_1984[iVar0], sParam2);
		}
		iVar0++;
	}
}
...
int func_284()
{
	...
	if (func_377(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_285()
{
	...
	if (func_377(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_377(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_479(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
struct<5> func_563(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_575(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_567(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_565(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_565(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_566(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_567(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_571(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_588(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
