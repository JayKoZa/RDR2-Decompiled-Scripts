...
void func_8(bool bParam0, bool bParam1)
{
	...
	if (((func_49() && STREAMING::_0xCF45DF50C7775F2A() == 0) && func_61(0) == ((*Global_1835011)[4 /*74*/])->f_1 == 0) && func_62())
	{
		...
		{
			if (((((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[0])) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[0]), 1, 0)) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[1]))) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[1]), 1, 0)) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(&(Global_1357549->f_1713[2]))) && ANIMSCENE::_IS_ANIM_SCENE_LOADED(&(Global_1357549->f_1713[2]), 1, 0))
			{
				if (((func_74(16) != 1 && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(&(Global_1357549->f_1713[0]), 0)) && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(&(Global_1357549->f_1713[1]), 0)) && !ANIMSCENE::_IS_ANIM_SCENE_STARTED(&(Global_1357549->f_1713[2]), 0))
				{
...
int func_52()
{
	...
	{
		if ((PED::_IS_PED_USING_SCENARIO_HASH(func_130(0), 49488831) && TASK::IS_PED_ACTIVE_IN_SCENARIO(func_130(0), 1)) && func_131(func_130(0), &(Global_1357549->f_1663[0]), 1, 0))
		{
			return 1;
		}
		else
...
int func_56()
{
	if (ENTITY::DOES_ENTITY_EXIST(func_130(1)))
	{
		if (VOLUME::_DOES_VOLUME_EXIST(&(Global_1357549->f_1663[1])))
		{
			...
			{
				if ((PED::_IS_PED_USING_SCENARIO_HASH(func_130(1), 640190094) || PED::_IS_PED_USING_SCENARIO_HASH(func_130(1), 343112864)) || PED::_IS_PED_USING_SCENARIO_HASH(func_130(1), 1774730608))
				{
					return 1;
				}
			}
...
int func_124(var uParam0)
{
	...
	if (func_274(uParam0, iLocal_17))
	{
		...
		if (bLocal_155)
		{
			...
			{
				AUDIO::PAUSE_SCRIPTED_CONVERSATION(&vLocal_143, 0, 0, 0, 0);
				func_189(&uLocal_156);
			}
...
int func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_185(iVar0, 0))
	{
		if (func_185(PED::_GET_RIDER_OF_MOUNT(iVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
int func_440(bool bParam0, int iParam1)
{
	...
	iVar0 = func_495(bParam0, iParam1);
	Var4.f_9 = -1591664384;
...
int func_495(bool bParam0, int iParam1)
{
	...
	if (func_544(bParam0, 1399091007))
	{
		func_545(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_500(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_546(bParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
...
void func_545(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_546(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
int func_549(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
void func_561(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_326(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_326(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_326(iParam5, 32), 1);
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_498(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
		...
		while (iVar28 < 4)
		{
			...
			if (func_621(bParam0, &Var0, iVar5, 0))
			{
				if (func_622(bParam0, &Var6, iVar5))
				{
					...
					func_623(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_624(0))
				{
					...
					func_625(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_626(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
{
	return func_634(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_623(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
{
	if (func_631(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_639(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_634(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_635(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_437(0);
	*uParam1 = { func_436(bParam0, func_547(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
