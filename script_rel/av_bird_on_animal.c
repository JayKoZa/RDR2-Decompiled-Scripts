...
void __EntryFunction__()
{
	...
	iLocal_11 = joaat("WORLD_ANIMAL_ELK_GRAZING");
...
{
	func_33(uParam0, 11068, 11127, 11681);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 116:
			iLocal_11 = joaat("STAND");
			iLocal_9 = joaat("A_C_ALLIGATOR_01");
			break;
		case 117:
			iLocal_11 = joaat("WORLD_ANIMAL_DEER_GRAZING");
			iLocal_9 = joaat("A_C_BUCK_01");
			break;
		case 118:
			iLocal_11 = joaat("WORLD_ANIMAL_BUFFALO_GRAZING");
			iLocal_9 = joaat("A_C_BUFFALO_01");
			break;
		case 119:
			iLocal_11 = joaat("WORLD_ANIMAL_COW_GRAZING");
		...
		case 121:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_MOOSE_GRAZING");
			if (bVar1)
			{
				iVar0 = 0;
	...
	func_48(uParam0, 1, "BOA_BIRD_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	...
	switch (iLocal_13)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(uParam0->f_20[0 /*14*/], iLocal_11, uParam0->f_20[0 /*14*/].f_5, uParam0->f_20[0 /*14*/].f_8, 0, false, true, 0, -1f, false);
			...
			break;
		case 1:
			if (uParam0->f_469[1] || func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_70(uParam0);
		...
		case 2:
			if (func_73(uParam0->f_20[0 /*14*/], 0))
			{
				if (*uParam0 != 119)
				{
					TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
				}
				else
				{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, var uParam12, var uParam13)
{
...
bool func_63(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_110(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
bool func_107(int iParam0, int iParam1, var uParam2)
{
	float fVar0;
	float fVar1;
...
int func_109(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
bool func_111(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_112(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_113(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
void func_229(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
