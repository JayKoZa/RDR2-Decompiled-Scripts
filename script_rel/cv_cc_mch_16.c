...
int func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_15, 3, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, 0);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	func_155(uParam0, iLocal_14, 2, 109450878, "WORLD_HUMAN_LEAN_CHECK_PISTOL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_175(var uParam0, int iParam1, bool bParam2)
{
	...
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iParam1), bParam2, 0, 0))
		{
			func_286(func_48(uParam0, iParam1), bParam2, 1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
		}
		else
		{
			WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iParam1), bParam2, true, 0, false, false);
		}
	}
	if (func_287(func_48(uParam0, iParam1), 0, 1, 0) == bParam2)
	{
		return 1;
	}
	return 0;
...
bool func_286(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	return func_353(iParam0, bParam1, bVar0, bVar1, iParam4, bVar2, bVar3, iParam5, iParam6, iParam2, bVar4, bVar5, bParam7, bVar6);
}
...
bool func_353(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_404(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
var func_369(int iParam0, var uParam1)
{
...
int func_406(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_446(bParam0, &Var0, iVar5, 0))
			{
				if (func_447(bParam0, &Var6, iVar5))
				{
					Var29 = { func_448(bParam0, Var0, iVar5, 0) };
					func_449(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_450(0))
				{
					...
					func_451(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_452(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
struct<5> func_444(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_493(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_448(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_446(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_446(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_447(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_448(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
bool func_446(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_500(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_447(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_448(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_449(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_500(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_448(bParam0, Param1, iParam5, bParam6) };
...
int func_501(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_503(0);
	*uParam1 = { func_448(bParam0, func_494(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
