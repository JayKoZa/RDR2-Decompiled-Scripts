...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -7.7064f, -0.6208f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_150(uParam0, -1f, -1f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -1.10969f, -0.976567f, 1.03409f, 0f, 1.3f, 1.3f, 5f, joaat("VOLCYLINDER"), 1);
...
void func_185(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_282(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_282(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
int func_242()
{
	...
	if (func_318(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_243()
{
	...
	if (func_318(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_251(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_271(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_272(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_289(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_384(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
