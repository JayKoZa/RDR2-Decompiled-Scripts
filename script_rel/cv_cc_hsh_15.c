...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -7.7064f, -0.6208f, 0f, 0f, 2f, 2f, 5f, -1612834106, 1267380940, 1, 1, 1);
	func_150(uParam0, -1f, -1f, 0f, 0f, 3f, 3f, 5f, -1612834106, -676766751, 1, 1, 1);
	func_151(uParam0, -1.10969f, -0.976567f, 1.03409f, 0f, 1.3f, 1.3f, 5f, 665633627, 1);
	...
	func_154(uParam0, "script@vignette@hosea_15@base", 1, 1, 0, 0);
	iLocal_14 = func_154(uParam0, "script@vignette@hosea_15@action_a", 2, 0, 1, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@hosea_15@action_b", 2, 0, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@hosea_15@action_b_alt", 2, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@hosea_15@hosea_exit", 0, 0, 0, 0);
	func_155(uParam0, "CH15AUD");
	Local_18 = { func_156(uParam0, -0.2275f, -1.2232f, 0.712f, 117f, 8f, 0.5f, 0.5f) };
	return 1;
}
...
{
	uParam0->f_23 = { func_245(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
struct<10> func_156(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_248(uParam0, (fParam4 + (fParam6 * 90f)));
	fVar1 = func_248(uParam0, (fParam4 - (fParam7 * 90f)));
	Var2 = { func_247(uParam0, vParam1) };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_251(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_265((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_186(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_286(uParam0, iVar1) || func_194(uParam0, iVar1))
			{
...
int func_251(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_413(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_276(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
