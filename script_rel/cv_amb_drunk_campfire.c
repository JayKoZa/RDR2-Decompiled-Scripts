...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, joaat("VOLCYLINDER"), 1);
	func_151(uParam0, 0.7058f, 2.1098f, 0f, 49.32f, 1.2f, 1.26f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, -1.59f, -0.7f, 0f, 14.4f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_DRINK_DRUNK"), "WORLD_HUMAN_SIT_GROUND_DRINK_DRUNK_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL"), "PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, 1);
	return true;
}
...
void func_329(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_361(iParam1))
		{
			func_362(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_382(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_387(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_390(int iParam0, int iParam1)
{
	...
	bVar0 = func_433(iParam0, iParam1);
	return bVar0;
}
...
bool func_408(int iParam0, char* sParam1)
{
...
bool func_410(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_317(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_381(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_439(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	return func_485(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
void func_474(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_491(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_479(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_470(923904168, func_477(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_470(923904168, func_477(bParam0), -740156546, 0) };
		}
...
struct<4> func_481(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_470(271701509, func_477(bParam0), 12999093, 0) };
		}
...
bool func_484(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_486(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
