...
int func_11()
{
	iLocal_0 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(668.9086f, -1260.756f, 45.237f, 0f, 0f, -15.99999f, 58.82726f, 39.94f, 50f, "Clemens - m_volTown");
	return 1;
}
...
int func_15(int iParam0)
{
	...
	{
		iLocal_1 = AUDIO::_0x0556C784FA056628("clemens_point", "es_camp_memory_sounds");
