...
bool func_72(var uParam0)
{
	...
	{
		func_155(uParam0, 1.9376f, -0.875f, 1.4875f, 0f, 2.1625f, 2.2275f, 3.2075f, joaat("VOLBOX"), -1, 1, 1, 1);
	}
	...
	func_162(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_168(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_263(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
