...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 2.475f, 2.75f, 0.5445f, 80f, 1.7f, 1.7f, 1.5f, joaat("VOLCYLINDER"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT"), "WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
