...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2.475f, 2.75f, 0.5445f, 80f, 1.7f, 1.7f, 1.5f, 665633627, -1386303207, 1, 1, 1);
	iLocal_15 = func_152(uParam0, joaat("p_bottlejd01x"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_153(uParam0, "script@vignette@pearson_14@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@pearson_14@action", 0, 0, 1, 1);
	func_154(uParam0, "CPR14AU");
	func_155(uParam0, iLocal_14, iLocal_15, "p_bottleJD01x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_14, 2, -202451008, "WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 1, 6, 0, 0, 0);
	func_158(uParam0, iLocal_14, 3, -1);
	Local_16 = { func_159(uParam0, 2.3925f, 3.045f, 0.564f, 51.75f, 6.6675f, 0.905f, 0.43f) };
	func_160(uParam0, 1);
...
{
	return func_192(uParam0, Local_16, 1, 0);
}
