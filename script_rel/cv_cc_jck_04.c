...
bool func_72(var uParam0)
{
	...
	func_153(uParam0, 0f, 0f, 1.3625f, 80f, 5f, 5f, 1.5f, joaat("VOLCYLINDER"), 1);
	func_154(uParam0, 3.1875f, -0.3125f, 0.782f, 80f, 5.8675f, 4.0925f, 2.505f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_154(uParam0, -4.325f, 5.45f, 0.782f, 80f, 1.1f, 1f, 2.505f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, 1);
	...
	iLocal_20 = func_157(uParam0, "script@vignette@jack_4@action", 0, 0, 1, 0);
	func_158(uParam0, "CJCK4AU");
	func_159(uParam0, iLocal_20, -1, 0.86f);
	func_160(uParam0, iLocal_16, 3, joaat("WORLD_HUMAN_HORSE_TEND_BRUSH_LINK"), "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 50f, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_93(var uParam0)
{
	...
	{
		iLocal_21 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(-113.32f, -15.6f, 94.89f, joaat("PROP_HITCHINGPOST"), 0.25f, 0, false);
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_21))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_17), iLocal_21, 0, 0, false, true, 0, false, -1f, false);
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if (uParam0->f_107[iVar0 /*113*/].f_32.f_32 > -1)
			{
				...
				func_306(uParam0->f_107[iVar0 /*113*/].f_1, iVar1, iVar3, iVar2, 0, 0, 1);
			}
...
bool func_213(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_312(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_402(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_230(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_230(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_230(iParam5, 32), true);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
