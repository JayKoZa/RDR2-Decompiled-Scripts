...
int func_72(var uParam0)
{
	...
	func_160(uParam0, iLocal_16, 3, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 50f, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_14, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, iLocal_15, 3, 240644744, "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	{
		iLocal_21 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(-113.32f, -15.6f, 94.89f, -1805387726, 0.25f, 0, 0);
		if (TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_21))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_17), iLocal_21, 0, 0, 0, true, 0, 0, -1082130432, 0);
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_214(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_216(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_217(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_217(iParam0, 0));
					func_218(iParam0);
				}
			}
			else
...
int func_143(var uParam0)
{
	...
	{
		PERSCHAR::_0xD4B614179BCD0654(func_121(10, 0));
		PERSCHAR::_0xD4B614179BCD0654(func_217(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
...
{
	uParam0->f_23 = { func_254(iParam1) + Vector(fParam4, fParam3, fParam2) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_215((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
int func_366(int iParam0, int iParam1, bool bParam2)
{
	...
	if (func_247(iParam0, 1073741824 /* Float: 2f */))
	{
		return 1;
	}
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					PERSCHAR::_0x187D65F3AEC5D679(func_215(iParam0, 1), &uVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_212(vVar0)) && !func_213(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
			...
			{
				PERSCHAR::_0x63AA2B8EB087886A(func_215(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_402(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_230(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_230(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_230(iParam5, 32), 1);
...
int func_423(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = PERSCHAR::_0xA00DF706C60173D1(func_215(iParam0, 1));
