...
bool func_76(var uParam0)
{
	...
	func_155(uParam0, -3.0885f, 0.0336f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
...
struct<5> func_544(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_421(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_516(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_546(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_546(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_547(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_516(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
void func_551(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_563(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
