...
int func_76(var uParam0)
{
	...
	func_160(uParam0, iLocal_14, 3, -491224884, "WORLD_HUMAN_HAMMER_WALL_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_198(var uParam0)
{
	...
	{
		iLocal_30 = func_304("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), func_9(uParam0, iLocal_14), 3, 0, 0, 0, 0, 6f, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
...
int func_264(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	...
	uVar6 = func_348(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
int func_368(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_424(bParam2), iParam0, 0);
	return uVar2;
}
...
int func_422(bool bParam0, int iParam1)
{
	...
	if (func_469(bParam0, 1399091007))
	{
		func_470(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_441(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_481(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_456(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return 0;
...
void func_470(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_424(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_487(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
int func_488(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_521(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
...
void func_512(int iParam0)
{
	...
	func_533(iParam0, 1073741824 /* Float: 2f */);
}
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_534(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
{
	return func_516(joaat("character"), func_539(), -1591664384, bParam0);
}

struct<4> func_516(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_424(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
int func_536(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_546(bParam0, &Var0, iVar5, 0))
			{
				if (func_547(bParam0, &Var6, iVar5))
				{
					Var29 = { func_516(bParam0, Var0, iVar5, 0) };
...
void func_537(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_544(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_421(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_516(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_546(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_546(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_547(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
			...
			{
				Var0 = { func_516(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
bool func_546(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_559(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_547(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
void func_551(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_563(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_554(bool bParam0, bool bParam1)
{
	...
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_564(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_559(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_516(bParam0, Param1, iParam5, bParam6) };
...
int func_560(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_424(0);
	*uParam1 = { func_516(bParam0, func_472(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
