...
int func_67(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, var uParam4)
{
	...
	switch (func_183(uParam4))
	{
		...
		case 3:
			...
			if ((ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam4->f_156) && ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam4->f_156, false)) && (ANIMSCENE::_0xEF324E9550A394D5(uParam4->f_156) || func_113(uParam4, 512)))
			{
...
{
	if ((!func_113(uParam0, 32768) && ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_156)) && ANIMSCENE::_IS_ANIM_SCENE_METADATA_LOADED(uParam0->f_156, false))
	{
		func_257(uParam0);
		func_258(uParam0, 0);
...
void func_184(var uParam0)
{
	...
	if (((!ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_156) || !ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_156, false)) || ANIMSCENE::_0xEF324E9550A394D5(uParam0->f_156)) || func_113(uParam0, 512))
	{
...
void func_185(var uParam0, char* sParam1)
{
	...
	func_190(1, 0);
	func_122(uParam0);
	if (func_349() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_156, func_250(Global_35)))
	{
		TASK::CLEAR_PED_TASKS_IMMEDIATELY(Global_35, false, true);
	}
...
void func_258(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 11)
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_13[iVar0 /*12*/]) || func_363(&(uParam0->f_13[iVar0 /*12*/]), 2))
		{
			if (func_363(&(uParam0->f_13[iVar0 /*12*/]), 1) || ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_156, &(uParam0->f_13[iVar0 /*12*/].f_1)))
			{
...
bool func_294(int iParam0, var uParam1)
{
	...
	*uParam1 = func_446(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
bool func_295(int iParam0, var uParam1)
{
	...
	*uParam1 = func_446(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_395(*uParam1, 0))
	{
		return false;
	}
...
bool func_340(bool bParam0, bool bParam1)
{
	if (!func_504(Global_43801))
	{
		Global_43801 = func_508("CUTSCENE_SKIP", joaat("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("LONG_TIMED_EVENT"), 0);
...
bool func_352()
{
	return func_506(UIFEED::_0xC17F69E1418CD11F(3));
}
...
void func_358(var uParam0)
{
	...
	if (func_113(uParam0, 2048) && !func_103(func_519(uParam0)))
	{
		...
		if ((!ENTITY::IS_ENTITY_DEAD(iVar1) && ((bVar0 && ENTITY::IS_ENTITY_IN_VOLUME(iVar1, uParam0->f_4, true, 0)) || func_113(uParam0, -2147483648))) && PED::GET_MOUNT(Global_35) != iVar1)
		{
			...
			func_306(iVar1, func_519(uParam0), func_520(uParam0), iVar2, 1073741824 /* Float: 2f */);
		}
		...
		{
			func_306(iVar3, func_519(uParam0), func_520(uParam0), 2, 1073741824 /* Float: 2f */);
		}
	}
}
...
void func_359(var uParam0)
{
	...
	if ((func_113(uParam0, 268435456) && !func_103(func_519(uParam0))) && PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar0))
		{
			...
			func_306(iVar0, vVar1, func_521(vVar1, Global_36, 1), 2, 1073741824 /* Float: 2f */);
...
{
	return func_216(joaat("CHARACTER"), func_525(), -1591664384, bParam0);
}
...
int func_404(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_548("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if ((((((WEAPON::_IS_WEAPON_TWO_HANDED(Var4.f_4) || func_550(Var4.f_4)) && (!WEAPON::_IS_WEAPON_SHOTGUN(Var4.f_4) || func_547(iParam1, 16))) && (!WEAPON::_IS_WEAPON_SNIPER(Var4.f_4) || func_547(iParam1, 4))) && (!func_550(Var4.f_4) || func_547(iParam1, 8))) && (!WEAPON::_IS_WEAPON_REPEATER(Var4.f_4) || !func_547(iParam1, 8388608))) && (!WEAPON::_IS_WEAPON_RIFLE(Var4.f_4) || !func_547(iParam1, 1048576)))
				{
...
float func_642()
{
	...
	func_668(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_643()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_668(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_644()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_668(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
int func_645(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_673(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_675(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_647(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_648(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
char* func_651(char* sParam0, int iParam1)
{
	...
	return func_678(MISC::_CREATE_VAR_STRING(10, "PLAYER_STRING", sParam0), iParam1);
}
...
void func_658(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, int iParam5)
{
	...
	iVar0 = func_680(BUILTIN::TO_FLOAT(*uParam0), fVar3);
	iVar1 = func_681(BUILTIN::TO_FLOAT(*uParam1), fVar3);
	iVar2 = func_682(BUILTIN::TO_FLOAT(*uParam2), fVar3);
...
bool func_677(int iParam0, int iParam1)
{
	...
	{
		return func_687(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
