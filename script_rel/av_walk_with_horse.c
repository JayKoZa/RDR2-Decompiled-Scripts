	...
	switch (*uParam0)
	{
		case 30:
			...
			*(vLocal_41[0 /*3*/]) = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 0f, 0f) };
			...
			uLocal_38[1] = func_49(997958153 /* GXTEntry: "Riding" */, 1);
			*(vLocal_41[1 /*3*/]) = { vParam1 };
			...
			func_51(uParam0, 0, "WWH_MAN", &(uLocal_38[0]), *(vLocal_41[0 /*3*/]), &(uLocal_48[0]), 1, 1, 1, 1, 41788943, 1);
			func_51(uParam0, 1, "WWH_HORSE", &(uLocal_38[1]), *(vLocal_41[1 /*3*/]), &(uLocal_48[1]), 1, 1, 1, 1, 41788943, 1);
			break;
	}
}
...
bool func_28(var uParam0)
{
	...
	{
		TASK::TASK_ANIMAL_INTERACTION(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 554992710, 0, 0);
			...
			if (!func_60(&(uParam0->f_20[0 /*14*/]), 985146578))
			{
				if (iLocal_74 < Local_51)
				{
					if (!func_7((Local_51[iLocal_74 /*11*/])->f_1))
					{
						TASK::CLEAR_PED_TASKS(&(uParam0->f_20[0 /*14*/]), 1, 0);
						TASK::CLEAR_PED_TASKS(&(uParam0->f_20[1 /*14*/]), 1, 0);
						TASK::TASK_LEAD_AND_CONVERSE(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), Local_51[iLocal_74 /*11*/], 1, 5f, 2.5f, 1070386381, 1092616192, 1065353216);
				...
				TASK::CLEAR_PED_TASKS(&(uParam0->f_20[0 /*14*/]), 1, 0);
				TASK::CLEAR_PED_TASKS(&(uParam0->f_20[1 /*14*/]), 1, 0);
				TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(&(uParam0->f_20[0 /*14*/]), *(vLocal_76[0 /*3*/]), 2f, 65000, 0, 1, 0, 0);
				TASK::TASK_WANDER_IN_AREA(&(uParam0->f_20[1 /*14*/]), *(vLocal_76[1 /*3*/]), fLocal_75, 1077936128, 1086324736, 1);
...
void func_102(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
