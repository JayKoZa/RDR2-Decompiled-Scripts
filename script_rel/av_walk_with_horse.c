#region Local Var
	...
	var uLocal_48[2] = { 0, 0 };
	struct<11> Local_51[2];
	int iLocal_74 = 0;
	float fLocal_75 = 0f;
	vector3 vLocal_76[2] = {{ 0f, 0f, 0f }, { 0f, 0f, 0f } };
...
{
	func_33(uParam0, 11430, 11488, 12098);
}
...
{
	func_46(uParam0, "WALK_WITH_HORSE", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 30:
			iLocal_38[0] = func_48(func_47());
			vLocal_41[0 /*3*/] = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 0f, 0f) };
			uLocal_48[0] = vParam4.z;
			iLocal_38[1] = func_49(joaat("HORSE_CLASS_RIDING"), 1);
			vLocal_41[1 /*3*/] = { vParam1 };
			uLocal_48[1] = vParam4.z;
			switch (func_50())
			{
				case 76:
					Local_51[0 /*11*/] = 0;
					Local_51[0 /*11*/].f_1 = { -357.702f, 777.595f, 115.227f };
					Local_51[1 /*11*/] = 0;
					Local_51[1 /*11*/].f_1 = { -375.986f, 774.763f, 115.194f };
					vLocal_76[0 /*3*/] = { -380.609f, 783.655f, 115.017f };
					vLocal_76[1 /*3*/] = { -392.294f, 780.579f, 114.735f };
					fLocal_75 = 10f;
					break;
				case 115:
					Local_51[0 /*11*/] = 0;
					Local_51[0 /*11*/].f_1 = { -5563.068f, -2989.857f, -1.3539f };
					Local_51[1 /*11*/] = 0;
					Local_51[1 /*11*/].f_1 = { -5539.921f, -3039.74f, -2.288f };
					vLocal_76[0 /*3*/] = { -5547.972f, -3041.581f, -2.1309f };
					vLocal_76[1 /*3*/] = { -5542.16f, -3040.963f, -2.2175f };
					fLocal_75 = 5f;
					break;
				case 5:
					Local_51[0 /*11*/] = 0;
					Local_51[0 /*11*/].f_1 = { 2536.916f, -1474.124f, 45.058f };
					Local_51[1 /*11*/] = 0;
					Local_51[1 /*11*/].f_1 = { 2574.454f, -1465.209f, 45.3529f };
					vLocal_76[0 /*3*/] = { 2680.171f, -1413.008f, 45.4999f };
					vLocal_76[1 /*3*/] = { 2680.171f, -1413.008f, 45.4999f };
					fLocal_75 = 5f;
					break;
				default:
					Local_51[0 /*11*/] = 0;
			...
			func_51(uParam0, 0, "WWH_MAN", iLocal_38[0], vLocal_41[0 /*3*/], uLocal_48[0], 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_51(uParam0, 1, "WWH_HORSE", iLocal_38[1], vLocal_41[1 /*3*/], uLocal_48[1], 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
...
int func_31(var uParam0)
{
	if (!uParam0->f_469[0])
	{
		if (func_68(uParam0, &uLocal_10, 0))
		{
			uParam0->f_469[0] = 1;
	...
	if (!uParam0->f_469[1])
	{
		if (iLocal_9 > 2)
		{
			if (func_71(uParam0, 2f, 80f, 4, joaat("ACTION"), 0))
			{
				func_70(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_9)
	{
		...
		case 2:
			...
			{
				if (iLocal_74 < Local_51)
				{
					if (!func_7(Local_51[iLocal_74 /*11*/].f_1))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
						TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
						TASK::TASK_LEAD_AND_CONVERSE(uParam0->f_20[0 /*14*/], uParam0->f_20[1 /*14*/], &(Local_51[iLocal_74 /*11*/]), 1, 5f, 2.5f, 1070386381 /* Float: 1.6f */, 1092616192 /* Float: 10f */, 1065353216 /* Float: 1f */);
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(uParam0->f_20[1 /*14*/], uParam0->f_20[0 /*14*/], 0, 0, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 32, 1.5f, -0.5f, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */);
						iLocal_74++;
						return 0;
					}
				}
				TASK::CLEAR_PED_TASKS(uParam0->f_20[0 /*14*/], true, false);
				TASK::CLEAR_PED_TASKS(uParam0->f_20[1 /*14*/], true, false);
				TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(uParam0->f_20[0 /*14*/], vLocal_76[0 /*3*/], 2f, 65000, false, true, false, false);
				TASK::TASK_WANDER_IN_AREA(uParam0->f_20[1 /*14*/], vLocal_76[1 /*3*/], fLocal_75, 1077936128 /* Float: 3f */, 1086324736 /* Float: 6f */, 1);
...
void func_51(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
bool func_55()
{
	return (Global_1894899 & 1 != 0 && func_50() != -1);
}
...
bool func_77(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
void func_91(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_127(iParam1))
		{
			func_128(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_100(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630.f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_139(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_102(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
float func_104(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_163(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
bool func_139(var uParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
bool func_140(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
bool func_141(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
bool func_142(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_160(int iParam0, var uParam1)
{
	...
	{
		return func_213(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
float func_163(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
bool func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_202(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_221(iVar0, 0)))
		{
...
bool func_187(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_194(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_196(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_197(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
bool func_198(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_203(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
bool func_209(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_218(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_223(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_225(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
