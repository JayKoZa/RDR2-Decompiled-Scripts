...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 3.25f, 6.55f, 1.1379f, 11.6f, 1.28f, 2.22f, 3f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, 1.22f, -0.5099f, 1.0675f, -167.4f, 1.5f, 1.5f, 3f, -1612834106, 1877049591, 1, 1, 1);
	...
	uLocal_18 = func_152(uParam0, joaat("p_chair02x"), 0f, 0f, 0f, "p_chair02x", 0, 0, 1);
	func_153(uParam0, "script@vignette@beecher@abigail_7@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@abigail_7@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@abigail_7@action_b", 2, 0, 0, 1);
	func_154(uParam0, "BABI7AU");
	func_155(uParam0, -634899381, -469290393);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, joaat("world_human_drinking"), "WORLD_HUMAN_STAND_DRINK_MALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 3, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", uLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	Local_19 = { func_159(uParam0, 2.7225f, 6.545f, 0.988f, -76.6299f, 7.4275f, 1f, 0.9975f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, Local_19, 1, 0))
		{
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
{
	func_158(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
