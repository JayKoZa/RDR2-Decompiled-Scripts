...
bool func_537(int iParam0, int iParam1, var uParam2)
{
    ...
    "" */
				...
				{
					if (iParam1 != Global_1946804.f_57[iVar6 /*11*/] && func_718(Global_1946804.f_1497.f_1[iVar5 /*3*/]))
					{
						*uParam2 = -357399012; /* GXTEntry: "Your boots do not support this." */
						return false;
					}
...
int func_555()
{
	...
	while (iVar1 < 30)
	{
		if (func_726(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_560()
{
	...
	while (iVar1 < 5)
	{
		if (func_732(COLLECTION::_0x126CBEBBA46693CF(iVar1, -1531394072, 0)))
		{
			iVar0++;
		}
		iVar1++;
...
bool func_577(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	Global_1946804.f_1378.f_1[iParam2 /*3*/].f_1 = func_743(iParam0, iParam2, iParam1, func_242() != -1);
	if (bParam4)
	{
	...
	if (bParam3)
	{
		...
		while (iVar6 < Global_1946804.f_2589)
		{
			if (Global_1946804.f_2589.f_2[iVar6 /*2*/] >= 0 && Global_1946804.f_2589.f_2[iVar6 /*2*/] < 39)
			{
				...
				func_745(func_736(Global_1946804.f_2589.f_2[iVar6 /*2*/], 1), 1, 6);
			}
			iVar6++;
		}
	}
...
float func_588()
{
	...
	func_760(3, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_589()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_760(2, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
float func_590()
{
	...
	fVar9 = (100f * (BUILTIN::TO_FLOAT(90) / BUILTIN::TO_FLOAT(iVar8)));
	fVar10 = ((fVar7 + 100f) / 200f);
	func_760(1, BUILTIN::ROUND((BUILTIN::TO_FLOAT(iVar8) * fVar10)), 0);
...
void func_597(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		func_772(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_DONE", MISC::_CREATE_VAR_STRING(0, iVar0)), 10000, 0, 0, 0, 1);
	}
	func_773(iParam0, 6);
	if (bParam2)
	{
...
int func_608(int iParam0)
{
	...
	if (!func_779(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_804(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_805(iParam0, iParam13))
				{
					if (PED::_0xA0BC8FAED8CFEB3C(Global_1360165[iParam0 /*1157*/]))
					{
						...
						func_807(iParam0, Global_1360165[iParam0 /*1157*/], iParam13, 1);
		...
		case 7:
			...
			func_809(iParam0, Global_1360165[iParam0 /*1157*/]);
...
{
	return func_528(joaat("CHARACTER"), func_815(), -1591664384, bParam0);
}
...
int func_684()
{
	...
	while (iVar1 < 30)
	{
		if (func_827(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
void func_742(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_839(iParam2, 65536) && uParam0->f_1[iVar1 /*3*/] == -452402570)
	{
	...
	switch (iVar2)
	{
		...
		case 688587926:
			...
			else
			{
				...
				{
					iVar1 = 35;
					if ((func_718(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_365(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_718(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_361(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
...
void func_744(var uParam0, bool bParam1, int iParam2)
{
	...
	while (iVar2 < 39)
	{
		...
		else
		{
			...
			else if (func_844(iVar5, 6) || uParam0->f_1[iVar0 /*3*/] == Global_1946804.f_57[iVar0 /*11*/])
			{
			}
			else
			{
...
void func_752(struct<4> Param0)
{
	...
	if (func_850(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_850(20))
			{
				return;
			}
			iVar0++;
...
void func_768(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_767(iParam0))
	{
		...
		if ((!func_771() && !bParam1) && !func_262(0, 0, 1))
		{
			func_772(MISC::_CREATE_VAR_STRING(10, "OUT_JOURN_ADD", func_856(iParam0)), 10000, 0, 0, 0, 1);
		}
	}
}
...
void func_785(var uParam0, int iParam1)
{
	...
	func_867(uParam0->f_107[iParam1 /*113*/].f_1, uParam0->f_107[iParam1 /*113*/].f_32.f_39);
}
...
int func_786(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_870(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_794(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_70.f_12)
	{
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_877(iParam0, Global_1360165[iParam0 /*1157*/].f_124, 1))
				{
					return func_875();
				}
			}
			if ((bParam2 && !func_228(vVar0)) && !func_229(vVar0, ENTITY::GET_ENTITY_COORDS(Global_1360165[iParam0 /*1157*/].f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_804(Global_1360165[iParam0 /*1157*/].f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(Global_1360165[iParam0 /*1157*/].f_124))
			...
			func_878(Global_1360165[iParam0 /*1157*/].f_124, iParam0);
			if (bParam8)
			{
	...
	switch (Global_1360165[iParam0 /*1157*/].f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				...
				else if ((Global_1360165[iParam0 /*1157*/].f_4.f_2 != 0 && Global_1360165[iParam0 /*1157*/].f_4.f_2 == Global_40.f_4942[iParam0 /*60*/].f_59) && (func_886(Global_1360165[iParam0 /*1157*/].f_4.f_2) || func_505(Global_1360165[iParam0 /*1157*/].f_4.f_2)))
				{
				...
				if (Global_1360165[iParam0 /*1157*/].f_63 != iParam4 && func_887(Global_1360165[iParam0 /*1157*/].f_63))
				{
			...
			Global_1360165[iParam0 /*1157*/].f_4 = { func_889(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, Global_40.f_4942[iParam0 /*60*/].f_59, bParam11) };
			if (!bParam6)
			{
				func_107(iParam0, 44, 1);
			}
...
void func_804(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_894(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_895(iParam0))
	{
		if (func_896(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
...
void func_809(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_903(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_903(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_820(float fParam0, float fParam1)
{
	...
	fVar1 = BUILTIN::TO_FLOAT(func_904(iVar0));
	fVar2 = BUILTIN::TO_FLOAT(func_904(iVar0 + 1));
	fVar3 = (fVar2 - fVar1);
...
void func_823(int iParam0, int iParam1, int iParam2)
{
	...
	sVar7 = MISC::_CREATE_VAR_STRING(10, sVar0, func_911(iParam0));
	...
	func_515(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_914(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_831()
{
	...
	func_918(0);
	func_919(7);
	func_920(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_598() == 1160113249)
	{
		func_920(joaat("CLOTHING_P3_PLAYER_THREE_MS1_HAT_000_000"), 1, 1, 1);
		func_920(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
void func_837(var uParam0, int iParam1)
{
	...
	while (iVar0 < 10)
	{
		if (iVar0 < *uParam0)
		{
			if ((func_922(&(uParam0->f_2[iVar0 /*2*/]), 2) || uParam0->f_2[iVar0 /*2*/] == iParam1) || uParam0->f_2[iVar0 /*2*/] == 39)
			{
				uParam0->f_2[iVar0 /*2*/] = { Var2 };
			}
			else
			{
				if (func_922(&(uParam0->f_2[iVar0 /*2*/]), 1))
				{
					func_923(&(uParam0->f_2[iVar0 /*2*/]), 2, 6);
				}
...
void func_846(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (func_242() == -1)
	{
		func_926(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_26796.f_776);
	}
	else
	{
		func_927(&(Global_1946804.f_1497.f_1[iParam0 /*3*/]), iParam0, Global_36638.f_45.f_350.f_1011);
	}
}
...
bool func_877(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_940(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, false, true, true, true, false);
...
void func_900(int iParam0, int iParam1, bool bParam2)
{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1 > 0 && func_811(iParam1, 860729266))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 860729266);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4096 > 0 && func_811(iParam1, 879715242))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 879715242);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 128 > 0 && func_811(iParam1, 1606325429))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1606325429);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 256 > 0 && func_811(iParam1, 1743550585))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1743550585);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 512 > 0 && func_811(iParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1064646155);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1024 > 0 && func_811(iParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -536694793);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2048 > 0 && func_811(iParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1304053509);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & -2147483648 > 0 && func_811(iParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 718939204);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 65536 > 0 && func_811(iParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -972364774);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16384 > 0 && func_811(iParam1, -1100875244))
	{
	...
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 262144 > 0 && func_811(iParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1153596794);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 524288 > 0 && func_811(iParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1016389820);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1048576 > 0 && func_811(iParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -726966617);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 2097152 > 0 && func_811(iParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 1365901568);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 32768 > 0 && func_811(iParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1658942149);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 131072 > 0 && func_811(iParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1980913856);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 4194304 > 0 && func_811(iParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 491764525);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8388608 > 0 && func_811(iParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -76015264);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 16777216 > 0 && func_811(iParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 622113465);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 33554432 > 0 && func_811(iParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 781533162);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 67108864 > 0 && func_811(iParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -271415321);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 134217728 > 0 && func_811(iParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1683207356);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 268435456 > 0 && func_811(iParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -254794762);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 536870912 > 0 && func_811(iParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, 609066278);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 1073741824 > 0 && func_811(iParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(iParam1, -1712783565);
	}
	if (Global_40.f_4942[iParam0 /*60*/].f_5 & 8192 > 0 && func_811(iParam1, 1544915253))
	{
...
void func_901(int iParam0)
{
	...
	func_951(iParam0, 1073741824 /* Float: 2f */);
}
...
void func_919(int iParam0)
{
	...
	while (iVar0 < Global_1946804.f_2657.f_19)
	{
		...
		if (func_962(iVar2, 0))
		{
			func_963(iVar2, Global_1946804.f_1497.f_1[iVar1 /*3*/] == Global_1946804.f_2657[iVar0]);
		}
		iVar0++;
	}
}
...
void func_928(var uParam0, int iParam1)
{
	...
	while (iVar0 < 39)
	{
		func_927(&(uParam0->f_1[iVar0 /*3*/]), iVar0, iParam1);
		iVar0++;
	}
}
...
void func_961(var uParam0, int iParam1, int iParam2)
{
	...
	func_987(&(uParam0->f_1[*uParam0 /*5*/]), iParam1, -1, 1, 0);
	*uParam0++;
}
...
{
	*uParam0 = (*uParam0 - 1);
	func_992(&(uParam0->f_1[iParam1 /*5*/]));
...
void func_1000(var uParam0, var uParam1, var uParam2)
{
	...
	uParam0->f_1 = PED::_0xF6D9E1F3560CBF8E(iVar0, uParam1, 0, func_242() != -1, uParam2);
	*uParam0 = 1;
}
