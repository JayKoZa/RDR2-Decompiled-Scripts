		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_105(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_67(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (iParam1 && func_113(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_114(bVar25, 0) && func_115(bVar25, -1921346699))
			{
				return BUILTIN::CEIL((IntToFloat(&Var1.f_12[iVar24]) * fVar0));
			}
		}
...
bool func_68(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_117(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
int func_108(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_181(bParam0, &Var0, iVar5, 0))
			{
				if (func_182(bParam0, &Var6, iVar5))
				{
					Var29 = { func_183(bParam0, Var0, iVar5, 0) };
					func_184(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_185(0))
				{
					...
					func_186(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_109(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
bool func_113(bool bParam0, int iParam1, bool bParam2)
{
	...
	return func_191(bParam0, 0, bParam2) >= iParam1;
}
...
struct<5> func_179(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_189(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_183(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_248(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_181(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_181(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_182(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_251(bParam0, -1823706425))
			{
				Var0 = { func_183(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_251(bParam0, -1483207246))
			{
				Var0 = { func_183(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_181(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_253(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_182(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_254(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_183(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_255(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_184(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_187(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_258(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
int func_190(bool bParam0, int iParam1)
{
	...
	iVar0 = func_259(bParam0, iParam1);
	Var4.f_9 = -1591664384;
...
int func_191(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		return func_263(bParam0, 0);
	}
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_255(bParam2), bParam0, 0);
	return uVar2;
}
...
{
	if (func_250(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_278(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_253(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_183(bParam0, Param1, iParam5, bParam6) };
...
int func_254(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_255(0);
	*uParam1 = { func_183(bParam0, func_247(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_259(bool bParam0, int iParam1)
{
	...
	if (func_115(bParam0, 1399091007))
	{
		func_279(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
int func_263(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_280(bParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
...
int func_278(bool bParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_255(bParam1), bParam0, 0);
}

void func_279(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_280(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
int func_282(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_255(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
