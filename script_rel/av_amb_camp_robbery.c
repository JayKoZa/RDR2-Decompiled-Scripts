...
int func_31(var uParam0)
{
	...
	if (!bLocal_43)
	{
		if (func_61(uParam0, &uLocal_15, 0))
		{
			...
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[1 /*14*/], Global_35, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
			}
			if (!bLocal_44)
			{
...
bool func_79(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
var func_117(int iParam0, int iParam1, var uParam2, int iParam3)
{
	struct<13> Var0;
	int iVar23;
...
struct<5> func_179(int iParam0, bool bParam1, bool bParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
...
int func_191(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_255(bParam2), iParam0, 0);
	return uVar2;
}
...
struct<4> func_247(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_183(923904168, func_246(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_183(923904168, func_246(bParam0), -740156546, 0) };
		}
...
struct<4> func_249(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_183(271701509, func_246(bParam0), 12999093, 0) };
		}
...
int func_263(int iParam0, bool bParam1)
{
	...
	Var0 = { func_279(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_280(&Var0, func_247(0));
	}
...
struct<14> func_279(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
