...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 1, "MALE_B", iVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (uParam0->f_469[2])
	{
		...
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, uParam0->f_20[1 /*14*/].f_1))
		{
			...
			{
				func_73(uParam0->f_20[1 /*14*/], joaat("PROP_CAMP_FIRE_SEAT_CHAIR"), 60000, 0, joaat("PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C"), -1082130432 /* Float: -1f */);
