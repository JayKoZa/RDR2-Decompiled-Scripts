...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_71(uParam0, 1065353216 /* Float: 1f */, 60f, 4, 40f, 1112014848 /* Float: 50f */))
		{
			func_69(uParam0);
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[7])
		{
			if (func_72(uParam0, 1.1f, 1116471296 /* Float: 70f */, 4, joaat("action"), 1))
			{
				func_70(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[7] = 1;
			}
	...
	if (&uParam0->f_469[2])
	{
		...
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
		{
			...
			{
				func_73(&(uParam0->f_20[1 /*14*/]), 1858605558, 60000, 0, 43618282, -1082130432 /* Float: -1f */);
...
void func_68(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[iVar0 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			...
			TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[iVar0 /*14*/]), Global_35, -1f, -1, 0, 1077936128, 0);
...
void func_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
