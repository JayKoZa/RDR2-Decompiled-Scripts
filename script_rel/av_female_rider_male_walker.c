...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	iLocal_51 = func_1(997958153 /* GXTEntry: "Riding" */, 1);
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar1 = func_1(356361174 /* GXTEntry: "Race" */, 1);
	if (*uParam0 == 62)
	{
...
void func_74(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_124(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_124(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_124(iParam5, 32), 1);
