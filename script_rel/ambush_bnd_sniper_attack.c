...
int func_92(int iParam0)
{
	if (&uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_250(997958153 /* GXTEntry: "Riding" */, 1);
		}
		else
		{
...
int func_141()
{
	if (VOLUME::_0x92A78D0BEDB332A3(&(Local_274.f_23[1])))
	{
...
bool func_312(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_421(iParam0, 2084597891 /* GXTEntry: "Money" */, iParam1, uVar0);
	}
...
bool func_392(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
bool func_447(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_530(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_531(iParam0, &bVar0, &fVar25);
...
int func_530(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_531(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
int func_544(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_371(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
void func_617(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_696(func_695(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_661())
	{
...
{
	return func_708(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_631(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_709(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_632(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	if (!func_682(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_710(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}
...
void func_636(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_393(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
...
int func_652(int iParam0, bool bParam1)
{
	...
	Var29 = { func_632(bParam1, Var0, 1415981582, 0) };
...
int func_653(int iParam0, bool bParam1)
{
	...
	Var29 = { func_632(bParam1, Var0, -2119169513, 0) };
	return func_714(Var29, 1);
}
...
int func_683(bool bParam0, int iParam1)
{
	...
	if (bParam0 != 0)
	{
		iVar5 = func_705(bParam0);
		if (iVar5 != 0)
		{
			iVar6 = func_725(bParam0);
			iVar0 = 0;
			while (iVar0 < iVar6)
			{
...
{
	if (func_705(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_730(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_708(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
...
int func_709(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_710(0);
	*uParam1 = { func_632(bParam0, func_702(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
