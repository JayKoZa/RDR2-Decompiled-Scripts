...
bool func_31()
{
	...
	switch (Local_274.f_4)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_171(&iLocal_15, &(Local_274.f_34), &(iLocal_15.f_241), "COMBAT_FLEE", 1092616192 /* Float: 10f */))
			{
...
bool func_67(int iParam0)
{
	...
	while (iVar0 < iParam0->f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST((*iParam0)[iVar0]))
		{
			...
			{
				if (func_218((*iParam0)[iVar0], Global_36, 1) < (70f * 70f) || func_219((*iParam0)[iVar0], 70f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					return true;
				}
			}
...
void func_75()
{
	...
	if (iLocal_15.f_19 < iLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15[iVar0]))
		{
			...
			{
				if (func_219(iLocal_15[iVar0], 200f, -1082130432 /* Float: -1f */, iLocal_15.f_9[iVar0], -1082130432 /* Float: -1f */))
				{
	...
	else if (iLocal_15.f_19 < (iLocal_15.f_215 + iLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15.f_40[iVar0]))
		{
			...
			{
				if (func_219(iLocal_15.f_40[iVar0], 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
	...
	else if (iLocal_15.f_19 < ((iLocal_15.f_215 + iLocal_15.f_216) + iLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_15.f_49[iVar0]))
		{
			if (!func_226(&iLocal_15, iVar0, 8))
			{
				...
				{
					if (func_227(iLocal_15.f_49[iVar0], 200f, -1082130432 /* Float: -1f */))
					{
...
void func_248(int iParam0, float fParam1)
{
	...
	func_375(iParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432 /* Float: -1f */);
	vVar0 = { iParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { iParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_361(vVar0, vVar3, 0) };
	vVar9 = { func_362(vVar0, vVar3, 0) };
...
void func_298()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(iLocal_15[iVar0], 0, 1))
		{
			...
			{
				if (func_219(iLocal_15[iVar0], 80f, 30f, iLocal_15.f_9[iVar0], -1082130432 /* Float: -1f */))
				{
					func_275(&iLocal_15, iVar0, joaat("BLIP_STYLE_ENEMY"), 0);
				}
			}
...
int func_506(int iParam0, float fParam1, int iParam2)
{
	...
	return func_607(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584 /* Float: 5f */, bVar6, iParam2);
}
	...
	while (iVar16 < iVar18)
	{
		...
		if (iVar27 != 0 && iVar27 != Global_35)
		{
			...
			if (!func_69(vVar21))
			{
				...
				{
					if (func_365(vVar21, vVar24, 5f, 0) && PED::IS_PED_HEADING_TOWARDS_POSITION(iVar27, iParam0->f_209, 40f))
					{
						iVar19 = 1;
						iVar20 = 1;
					}
...
bool func_727(int iParam0, int iParam1)
{
	...
	{
		return func_735(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
int func_730(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_738(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_740(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_732(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_733(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
