...
int func_96(var uParam0)
{
	...
	{
		case 540:
			iLocal_95 = func_54(uParam0, iLocal_18);
			PLAYER::_0x3D9DA5C9EFD20D88(PLAYER::PLAYER_ID(), &iLocal_95);
			break;
		case 531:
		case 532:
		case 588:
...
bool func_101(var uParam0)
{
	...
	{
		case 526:
			func_229(joaat("CSTAG_HR_PRHMA_VISIT_POST"), 1, 0);
			break;
		case 527:
			func_229(joaat("CSTAG_SP_SWAMP_WEIRDO_POST"), 1, 0);
			break;
		case 498:
			func_230(9, 14, 1);
			break;
		...
		case 506:
			...
			break;
		case 596:
			func_229(joaat("CSTAG_VIG_RHMRO_WNT"), 1, 0);
		...
		case 622:
			...
			break;
		case 592:
			func_229(joaat("CSTAG_VIG_NTV2_HONOR_HIGH"), 1, 0);
			break;
		case 507:
			func_230(21, 4, 1);
			break;
		...
		case 589:
		case 590:
			if (func_234(joaat("CSTAG_PLAYER_AWAY"), 1))
			{
				func_229(joaat("CSTAG_PLAYER_AWAY"), 1, 0);
			}
			break;
		case 547:
			func_35(548, 5000);
...
int func_119(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_132(iVar0, 0))
	{
		if (func_132(PED::_GET_RIDER_OF_MOUNT(iVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
bool func_162(var uParam0)
{
	...
	switch (func_8(uParam0))
	{
		...
		case 616:
			...
			{
				case 1:
					iVar0 = joaat("WORLD_HUMAN_SMOKE_NERVOUS_STRESSED");
					break;
				case 2:
					iVar0 = joaat("PROP_HUMAN_SEAT_BENCH_TIRED");
					break;
				case 3:
					iVar0 = joaat("WORLD_HUMAN_SIT_BACK_EXHAUSTED");
					break;
			}
...
void func_203(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				iVar0 = func_349(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iVar2 /*113*/].f_5, true, false));
				iVar1 = func_349(uParam0->f_107[iVar2 /*113*/].f_96);
				if (iVar0 || iVar1)
				{
...
bool func_218(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_233(int iParam0, bool bParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
	{
		...
		func_394(iParam0);
		if ((!func_395(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43891) || bParam1)
		{
...
bool func_242(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_279()
{
	...
	if (func_234(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_280()
{
	...
	if (func_234(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_309(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
	...
	iVar6 = func_429(vVar0, vVar3.x, iParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return iVar6;
}
...
bool func_329(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_330(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_334(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
bool func_335(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
bool func_357(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_484(joaat("AMMO_REVOLVER_AMMOBOX_HIGH_VELOCITY"));
		...
		case 2:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_HORSE_REVIVER"));
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_PREDATOR_BAIT"));
		...
		case 7:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_POTENT_MEDICINE"));
		...
		case 8:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_CHOCOLATE_BAR"));
		...
		case 11:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_HORSE_STIMULANT"));
		...
		case 13:
			...
			uParam0->f_22 = func_484(joaat("PROVISION_GOLDRING"));
			break;
		case 14:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_CIGAR"));
		...
		case 16:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_RUM"));
		...
		case 17:
			...
			uParam0->f_22 = func_484(joaat("KIT_GUN_OIL"));
		...
		case 19:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_POTENT_TONIC"));
		...
		case 20:
			...
			uParam0->f_22 = func_484(joaat("CONSUMABLE_MEDICINE"));
...
void func_381(int iParam0)
{
	...
	{
		case 9:
			if (func_485(joaat("PROVISION_JACKS_THIMBLE"), 0, 0) < 1)
			{
				func_486();
...
void func_382(var uParam0)
{
	...
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(8, iVar0, func_491(func_24()), 1307979820 /* GXTEntry: "Camp Item Request" */, func_492(*uParam0), 0);
...
bool func_395(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
void func_404(int iParam0, bool bParam1)
{
	...
	UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(4, func_514(iParam0), iVar8, joaat("SP_MISSIONS_20"));
	UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(4, func_514(iParam0), iVar6, iVar7);
	UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(4, func_514(iParam0), iVar1, sVar0, false, false, false);
	if (bParam1)
	{
		return;
	}
	func_516(sVar2, 0, iVar7, iVar6, joaat("PLAYER_MENU"), 0, -1, -2, func_9(), "robbery_tip_wipe_on", 0, 0, 1, 1, 1);
...
bool func_432(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_443(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
...
bool func_444(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<15> Var0;
...
void func_446(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_545(iParam1))
		{
			func_546(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_473(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
var func_475(var uParam0, var uParam1)
{
	char cVar0[64];
...
void func_494(var uParam0, int iParam1, char* sParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(8, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(8, func_488(*uParam0), iParam1, sParam2, bParam3, bParam5, false);
		if (bParam4)
		{
...
bool func_496(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
char* func_500(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		...
		case 12:
			...
			else if (func_234(joaat("CSTAG_FLOW_DOG_IN_CAMP_POST"), 1))
			{
				return "COMP_CAIN";
			}
			return "COMP_DOG";
...
bool func_533(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_115(iParam0))
	{
		return false;
...
int func_571(int iParam0, int iParam1)
{
	...
	if (func_638(iParam0, 1399091007))
	{
...
bool func_596(int iParam0, bool bParam1, int iParam2)
{
...
bool func_615(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_115(iParam0))
	{
		return false;
...
void func_617(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_259(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_259(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_259(iParam5, 32), true);
...
bool func_618(int iParam0, int iParam1)
{
	...
	bVar0 = func_681(iParam0, iParam1);
	return bVar0;
}
...
struct<4> func_641(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_690(923904168, func_689(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_690(923904168, func_689(bParam0), -740156546, 0) };
		}
...
bool func_643(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
bool func_652(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
bool func_656(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
bool func_658(int iParam0, char* sParam1)
{
	switch (Global_40.f_4283)
	{
		case 0:
...
bool func_660(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_661(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
void func_664(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_234(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_422(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_687(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(iVar0) || WEAPON::_IS_WEAPON_MELEE(iVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43891 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_709(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_709(iVar0))
		{
	...
	{
		func_711(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_712(iParam0, &iVar0, &fVar25);
...
struct<4> func_690(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_573(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
bool func_692(int iParam0, bool bParam1, int iParam2)
{
	if (iParam0 == 18)
	{
		return false;
...
int func_711(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			iVar5 = func_720((386 + iVar28), 1);
			if (func_721(iParam0, &Var0, iVar5, 0))
			{
				if (func_722(iParam0, &Var6, iVar5))
				{
					Var29 = { func_690(iParam0, Var0, iVar5, 0) };
					func_723(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_724(0))
				{
					...
					func_725(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_719(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_570(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_690(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_721(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_721(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_722(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_690(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_721(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_736(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_722(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
bool func_723(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_726(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_740(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_732(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_690(271701509, func_689(bParam0), 12999093, 0) };
		}
...
int func_736(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	Var0 = { func_690(iParam0, Param1, iParam5, bParam6) };
...
bool func_737(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_573(0);
	*uParam1 = { func_690(iParam0, func_641(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return false;
	}
