...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "DCRP_HORSE", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					...
					else
					{
						...
						func_74(&(uParam0->f_20[1 /*14*/]), 1546182539, 0, 0, 0, -1082130432 /* Float: -1f */);
...
bool func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_73(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_121(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_121(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_121(iParam5, 32), 1);
...
void func_74(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_114(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_185(bParam0, &Var0, iVar5, 0))
			{
				if (func_186(bParam0, &Var6, iVar5))
				{
					Var29 = { func_187(bParam0, Var0, iVar5, 0) };
					func_188(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_189(0))
				{
					...
					func_190(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
...
void func_115(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
int func_133(int iParam0, bool bParam1, int iParam2)
{
	...
	if (!func_131(bParam1, 0))
	{
		return 0;
	}
	Var0 = { func_199(iParam0) };
	Var5 = { func_200(iParam0, bParam1, Var0, Var0.f_4) };
	if (INVENTORY::_0xCB5D11F9508A928D(iParam0, &Var5, &Var0, bParam1, Var0.f_4, iParam2, 752097756))
	{
		if (func_201(bParam1, -839724752) && func_202(bParam1, 4))
		{
			if (!func_203(42))
			{
				func_204(bParam1);
...
void func_182(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
struct<5> func_183(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_252(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_187(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_254(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_185(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_185(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_186(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_257(bParam0, -1823706425))
			{
				Var0 = { func_187(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_257(bParam0, -1483207246))
			{
				Var0 = { func_187(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_185(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_259(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_186(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_187(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_131(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_261(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_188(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_191(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_264(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
struct<4> func_200(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
{
	if (func_256(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_286(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_258(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_259(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_187(bParam0, Param1, iParam5, bParam6) };
...
int func_260(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_261(0);
	*uParam1 = { func_187(bParam0, func_253(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_281(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
