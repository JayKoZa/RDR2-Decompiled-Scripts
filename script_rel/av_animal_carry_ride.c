...
{
	func_33(uParam0, 11007, 11085, 12751);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "DCRP_HORSE", iVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "DCRP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1.5f, -2f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 2, "DCRP_DEER", iVar2, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3f, -2f, 0f), (10f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
		...
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[1 /*14*/]))
			{
				if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
				{
					...
					func_69(uParam0->f_20[1 /*14*/], joaat("WEAPON_REPEATER_CARBINE"), 0, 0, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
					...
					else
					{
						...
						func_74(uParam0->f_20[1 /*14*/], joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0, 0, 0, -1082130432 /* Float: -1f */);
			...
			break;
		case 6:
			if (func_76(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
...
int func_67(var uParam0, var uParam1, bool bParam2)
{
...
int func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_113(joaat("WEAPON_REPEATER_CARBINE")))
				{
	...
	{
		func_114(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_115(iParam0, &iVar0, &fVar25);
...
int func_72(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
void func_73(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_121(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_121(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_121(iParam5, 32), true);
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
...
bool func_76(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
bool func_85(vector3 vParam0, float fParam3)
{
	int iVar0;
...
bool func_86(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136(vParam0, Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, 1f, 0))
			{
				return true;
			}
		}
...
bool func_108(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
		...
		while (iVar28 < 4)
		{
			...
			if (func_185(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_189(0))
				{
					...
					func_190(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
bool func_128(var uParam0, float fParam1)
{
...
int func_157(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		return func_226(bParam1, bParam2, bParam3);
	}
	if (Global_1572887.f_12 != -1)
	{
...
int func_179(int iParam0, var uParam1)
{
	...
	{
		return func_249(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_182(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_136(Global_32074.f_2697.f_1495[iVar0 /*4*/].f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
struct<5> func_183(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_252(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_187(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_254(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_185(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_185(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_186(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_187(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_185(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_259(iParam0, *uParam1, iParam2, iParam3) > 0;
}

bool func_186(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_187(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_188(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
bool func_189(bool bParam0)
{
	...
	return INVENTORY::_INVENTORY_ARE_LOCAL_CHANGES_ALLOWED(func_261(bParam0));
}
...
void func_191(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_264(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
void func_196(int iParam0, var uParam1, var uParam2, int iParam3, var uParam4)
{
...
int func_198(int iParam0)
{
	...
	func_196(iParam0, &iVar1, &uVar2, &iVar0, &uVar3);
	func_197(&iVar4, iParam0, iVar0, iVar1);
	if (iVar4 != 0)
	{
		return iVar4;
	}
...
struct<5> func_199(int iParam0)
{
	...
	Var0 = { func_200(iParam0, joaat("CHARACTER"), func_265(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_200(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
void func_204(int iParam0)
{
	...
	switch (iParam0)
	{
		case joaat("PROVISION_FISH_BULLHEAD_CATFISH_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_01"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_01"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_02"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_02"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_LAKE_STURGEON_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_03"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_03"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_LARGEMOUTH_BASS_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_04"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_04"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_LONGNOSE_GAR_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_05"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_05"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_MUSKIE_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_06"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_06"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_PERCH_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_07"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_07"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_REDFIN_PICKEREL_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_08"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_08"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_ROCK_BASS_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_09"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_09"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_SMALLMOUTH_BASS_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_10"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_10"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_SOCKEYE_SALMON_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_11"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_11"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_12"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_12"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_BLUEGILL_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_13"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_13"));
			func_271(0, 10);
			break;
		case joaat("PROVISION_FISH_NORTHERN_PIKE_LEGENDARY"):
			func_268(joaat("LEGENDARY_FISH_14"));
			func_269(joaat("LEGENDARY_FISHING_SPOT_14"));
			func_270(joaat("LEGENDARY_FISHING_SPOT_14"));
			break;
	}
}
...
bool func_215(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_238(iVar0, iParam0, 1, 1) <= 4f)
		{
			return true;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_277(iVar0, 0)))
		{
...
bool func_223(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
bool func_225(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
bool func_230(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
bool func_236(int iParam0, int iParam1)
{
	...
	if (func_283(iParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return false;
	}
...
void func_250(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_285(iParam0) == 1 && bParam7)
	{
		return;
	}
	if (bParam6)
...
{
	return func_187(joaat("CHARACTER"), func_265(), -1591664384, bParam0);
}
...
struct<4> func_253(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_187(923904168, func_251(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_187(923904168, func_251(bParam0), -740156546, 0) };
		}
...
struct<4> func_255(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_187(271701509, func_251(bParam0), 12999093, 0) };
		}
...
bool func_258(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_274(bool bParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
...
bool func_278(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_279(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_281(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_289(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	if (iParam1 < 0 || iParam1 > 21)
	{
		return false;
	}
	if (func_298(iParam1, iParam2))
	{
		if (!bParam3)
		{
			return false;
	...
	if ((Global_1898164.f_163 && !func_301(iParam0, 1)) || func_302(32768))
	{
		if (!func_301(iParam0, 262144) || !Global_1905944.f_5696)
		{
			return false;
		}
	}
...
bool func_300(int iParam0)
{
	...
	if (!func_301(iParam0, 65536) && !func_301(iParam0, 32768))
	{
		return false;
	}
	iVar0 = 0;
	while (iVar0 < Global_40.f_7756)
	{
		if (Global_40.f_7756[iVar0 /*3*/].f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_301(iParam0, 32768))
			{
				return true;
			}
		}
