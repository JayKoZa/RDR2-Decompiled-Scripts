...
bool func_76(var uParam0)
{
	...
	func_154(uParam0, -0.48f, -3.06f, 0f, 0f, 2f, 2f, 5f, joaat("VOLCYLINDER"), 1);
	func_155(uParam0, 0.335f, -1.85f, 0f, -23.72f, 1.1175f, 1.7375f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, -0.67f, -2.95f, 0f, 0f, 1.3f, 1.3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_156(uParam0, -0.2575f, -2.62f, 0f, -33.5f, 1f, 1f, 5f, joaat("VOLCYLINDER"), 1);
	...
	switch (iLocal_59)
	{
		case 0:
			if (func_207(uParam0, iLocal_17))
			{
				...
				TASK::_TASK_START_SCENARIO_IN_PLACE(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, 1f, true);
			}
			else
			{
				return true;
		...
		case 1:
			TASK::_TASK_START_SCENARIO_IN_PLACE(func_9(uParam0, iLocal_14), iLocal_25, 0, false, 0, 0.8f, false);
			bLocal_23 = true;
			iLocal_59 = 3;
		...
		case 4:
			...
			{
				TASK::_TASK_START_SCENARIO_IN_PLACE(func_9(uParam0, iLocal_14), joaat("STAND"), 0, false, 0, 0.8f, true);
				...
				TASK::_TASK_START_SCENARIO_IN_PLACE(func_9(uParam0, iLocal_15), iLocal_26, 0, false, 0, -1f, false);
...
void func_333(int iParam0)
{
	...
	Var0 = { func_391(joaat("CAREER_CASH")) };
...
void func_334(int iParam0, char* sParam1, int iParam2)
{
	...
	func_392(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
void func_337(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, bool bParam7)
{
	...
	Var8 = { func_391(joaat("HONOR_CURRENT")) };
...
bool func_458(int iParam0, var uParam1, var uParam2)
{
	if (!func_456(iParam0))
	{
		return false;
...
struct<5> func_546(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_454(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_550(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_550(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
