...
int func_1(var uParam0)
{
	...
	if (TASK::_0x841475AC96E794D1(uLocal_95))
	{
		TASK::_0x81948DFE4F5A0283(uLocal_95);
	}
...
int func_79(var uParam0)
{
	...
	func_169(uParam0, iLocal_18, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_38, 0, 110f, 1065353216 /* Float: 1f */, 1);
...
int func_94(var uParam0)
{
	...
	if (!TASK::_0x841475AC96E794D1(uLocal_95))
	{
		...
		{
			uLocal_95 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(func_50(uParam0, iLocal_39), -229964281, 0f, 0f, 0.5f, -180f, 0, 0, 0);
			TASK::_0x5AF19B6CC2115D34(uLocal_95, 23, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_95, 25, 1);
			TASK::_0x5AF19B6CC2115D34(uLocal_95, 8, 1);
		}
		return 0;
	}
...
void func_228()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, uLocal_95, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
...
int func_289(int iParam0)
{
	...
	Var7 = { func_387(-1756227506, joaat("animal")) };
...
int func_292(int iParam0)
{
	...
	Var2 = { func_387(-1756227506, joaat("human")) };
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_549(bParam0, &Var0, iVar5, 0))
			{
				...
				{
					Var29 = { func_551(bParam0, Var0, iVar5, 0) };
...
struct<5> func_547(bool bParam0, bool bParam1, int iParam2)
{
	...
	switch (func_559(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_551(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case -2130996531:
			...
			{
				Var0 = { func_551(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
...
{
	return func_566(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_550(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_567(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_551(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_568(bParam0, 0))
	{
		return Var0;
	}
...
void func_555(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_572(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	if (func_563(bParam0) == 1779021115)
	{
		return 0;
	}
...
int func_566(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_551(bParam0, Param1, iParam5, bParam6) };
...
int func_567(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_569(0);
	*uParam1 = { func_551(bParam0, func_560(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
