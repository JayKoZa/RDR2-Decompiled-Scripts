...
int func_94(var uParam0)
{
	...
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(iLocal_95))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_50(uParam0, iLocal_39)))
		{
			...
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_95, 23, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_95, 25, 1);
			TASK::_SET_SCENARIO_POINT_FLAG(iLocal_95, 8, 1);
		}
		return 0;
	}
...
void func_228()
{
	TASK::_TASK_USE_SCENARIO_POINT(Global_35, iLocal_95, "PROP_PLAYER_SEAT_CHAIR_GENERIC", 0, 1, false, 0, 0, -1082130432, 0);
}
