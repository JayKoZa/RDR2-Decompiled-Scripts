...
bool func_73(var uParam0)
{
	...
	func_154(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_154(uParam0, 0.0375f, -0.425f, 0.85f, 0f, 3.345f, 3.345f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
