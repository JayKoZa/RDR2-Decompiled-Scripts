...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, -0.8875f, 1.15f, 6.81f, 2.6575f, 2.31f, 2.685f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_151(uParam0, -4.1f, 0.1f, 1.15f, 0f, 1.285f, 1.735f, 2.685f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), 0, -1, 0, 60f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 0, 70f, 1065353216 /* Float: 1f */, 1);
...
int func_260(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_375(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_409(int iParam0, int iParam1)
{
	...
	bVar0 = func_448(iParam0, iParam1);
	return bVar0;
}
...
bool func_423(int iParam0, char* sParam1)
{
...
bool func_425(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_429(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_400(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_454(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
