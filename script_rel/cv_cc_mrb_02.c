...
int func_73(var uParam0)
{
	...
	uLocal_21 = func_157(uParam0, 2.82f, -0.137f, 1f, 0f, 0f, 90f, 5f, 6f, 3f, "TRIGGER", -1612834106);
	...
	func_159(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
...
{
	if (func_202(uParam0, &uLocal_21, 1))
	{
...
int func_202(var uParam0, var uParam1, bool bParam2)
{
	...
	return func_311(Global_35, *uParam1, 1, 0);
}
...
int func_272(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
