...
int func_90(var uParam0)
{
	...
	func_167(uParam0, iLocal_14, 2, -38747227, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_21, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_166(uParam0, iLocal_15, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_G", iLocal_20, 0);
	func_167(uParam0, iLocal_15, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_G", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	if (!func_8(4))
	{
		...
		func_167(uParam0, iLocal_16, 2, 1446817251, "WORLD_CAMP_FIRE_SIT_GROUND_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_166(uParam0, iLocal_17, 2, -2138878033, "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_B", -1, 0);
		func_167(uParam0, iLocal_17, 2, -2138878033, "WORLD_CAMP_FIRE_SIT_GROUND_RECLINE_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		func_166(uParam0, iLocal_18, 2, -38747227, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_A", iLocal_19, 0);
		func_167(uParam0, iLocal_18, 2, -38747227, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	}
	if (func_8(4))
	{
...
int func_270(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_414(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_123(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_123(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, 1, func_123(iParam5, 32), 1);
