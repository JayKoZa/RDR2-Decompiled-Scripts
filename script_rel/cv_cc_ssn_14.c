...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2251f, 1.2273f, 0f, -29f, 1.1f, 1.1f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.742f, -0.362f, 1.03f, 0f, 6f, 6f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_LEAN_BACK_WALL"), "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_311(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_409(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_412(int iParam0, int iParam1)
{
	...
	bVar0 = func_454(iParam0, iParam1);
	return bVar0;
}
...
bool func_431(int iParam0, char* sParam1)
{
...
bool func_433(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_403(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_460(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_477(iVar0))
		{
	...
	{
		func_479(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_480(iParam0, &iVar0, &fVar25);
