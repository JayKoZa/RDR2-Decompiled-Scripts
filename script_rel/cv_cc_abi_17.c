...
bool func_72(var uParam0)
{
	...
	func_150(uParam0, -0.792594f, -0.612121f, 0.981384f, 3f, 0.9f, 0.9f, 2.5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_150(uParam0, -0.0645018f, -0.121576f, 0.728058f, 3f, 0.8f, 2f, 2f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 13, 0);
	iLocal_15 = func_151(uParam0, 1, 0);
	iLocal_16 = func_152(uParam0, -1.95f, -0.0001f, 1.03f, 0f, 0f, 0f, 5.5f, 5.94f, 2f, "CCABI_17_CABIN", joaat("VOLBOX"));
	...
	func_158(uParam0, iLocal_15, 4, joaat("WORLD_CAMP_JOHN_RECOVER"), "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
...
bool func_205(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_262(int iParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	int iVar6;
...
bool func_282(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_300(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
bool func_305(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
void func_341(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_375(iParam1))
		{
			func_376(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
bool func_367(int iParam0, int iParam1, bool bParam2)
{
	int iVar0;
...
bool func_401(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_404(int iParam0, int iParam1)
{
	...
	bVar0 = func_447(iParam0, iParam1);
	return bVar0;
}
...
bool func_422(int iParam0, char* sParam1)
{
...
bool func_424(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
...
void func_428(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_395(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_453(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar28 < 4)
		{
			...
			if (func_482(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_486(0))
				{
					...
					func_487(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
struct<5> func_480(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_492(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_484(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_494(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_482(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_482(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_483(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_484(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_482(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_499(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
void func_488(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_505(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
struct<4> func_493(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1224215 = { func_484(923904168, func_491(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1224223 = { func_484(923904168, func_491(bParam0), -740156546, 0) };
		}
...
struct<4> func_495(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1224219 = { func_484(271701509, func_491(bParam0), 12999093, 0) };
		}
...
bool func_498(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
bool func_500(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
