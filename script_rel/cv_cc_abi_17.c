...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -0.792594f, -0.612121f, 0.981384f, 3f, 0.9f, 0.9f, 2.5f, -1612834106, -2055224817, 1, 1, 1);
	func_150(uParam0, -0.0645018f, -0.121576f, 0.728058f, 3f, 0.8f, 2f, 2f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_14 = func_151(uParam0, 13, 0);
	iLocal_15 = func_151(uParam0, 1, 0);
	iLocal_16 = func_152(uParam0, -1.95f, -0.0001f, 1.03f, 0f, 0f, 0f, 5.5f, 5.94f, 2f, "CCABI_17_CABIN", -1612834106);
	...
	if (!func_153(1) && !func_153(2))
	{
		func_155(uParam0, "script@vignette@abigail_17@base", 1, 1, 0, 0);
	}
	iLocal_17 = func_155(uParam0, "script@vignette@abigail_17@action_a", 2, 0, 1, 0);
	iLocal_18 = func_155(uParam0, "script@vignette@abigail_17@action_b", 2, 0, 0, 0);
	iLocal_21 = func_155(uParam0, "script@vignette@abigail_17@action_b_int_back", 2, 0, 0, 1);
	iLocal_19 = func_155(uParam0, "script@vignette@abigail_17@action_b_int_left", 2, 0, 0, 1);
	iLocal_20 = func_155(uParam0, "script@vignette@abigail_17@action_b_int_right", 2, 0, 0, 1);
	iLocal_23 = func_155(uParam0, "script@vignette@abigail_17@exit", 0, 0, 0, 0);
	func_156(uParam0, "CAB17AU");
	func_157(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0);
	func_158(uParam0, iLocal_15, 4, -1675060673, "WORLD_CAMP_JOHN_RECOVER_MALE_A", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_15, 4, 1);
	func_160(uParam0, 8f, 12f);
	Local_24 = { func_161(uParam0, -0.7741f, -0.6255f, 0.9816f, 83.939f, 4f, 0.2f, 0.3f) };
	Local_34 = { func_161(uParam0, -0.7741f, -0.6255f, 0.9816f, 29.689f, 4f, 0.3f, 0.3f) };
	Local_44 = { func_161(uParam0, -0.7741f, -0.6255f, 0.9816f, 138f, 3f, 0.7125f, 0.4f) };
	if (func_153(1) || func_153(2))
	{
		func_162(uParam0);
		func_163(uParam0);
...
int func_93(var uParam0)
{
	...
	{
		if (func_205(uParam0, Local_24, 1, 0))
		{
			iLocal_22 = iLocal_21;
		}
		else if (func_205(uParam0, Local_34, 1, 0))
		{
			iLocal_22 = iLocal_19;
		}
		else if (func_205(uParam0, Local_44, 1, 0) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, iLocal_16, true, 0))
		{
			iLocal_22 = iLocal_20;
		}
		else
...
int func_96(var uParam0)
{
	...
	{
		PED::_0xEC6935EBE0847B90(func_48(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(func_48(uParam0, iLocal_14), -1f, -1f, 0f));
	}
	return 1;
}
...
int func_152(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
...
void func_164(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_261(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_165(var uParam0, int iParam1, char* sParam2)
{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_262(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432 /* Float: -1f */);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = PERSCHAR::_0xA00DF706C60173D1(func_276((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_195(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_204(uParam0, iVar1) || func_203(uParam0, iVar1))
			{
...
int func_262(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_310(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		bVar0 = func_350(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_318()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_355(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_332(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, int iParam16)
{
	...
	iVar1 = func_361(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, iParam12, bParam13, bParam14, bParam15, bParam6, iParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_361(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_120(iVar0, 0)) || (bParam3 && !func_51(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_392(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_371(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_401(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_400(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_403(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
...
int func_385(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_418(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_392(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	vector3 vVar0;
	int iVar3;
	var uVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_421(iParam0) && func_422(iParam0, &uVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_424(iParam0, vVar0, iParam6, iParam10))
				{
					return func_423();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_213(vVar0)) && !func_214(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
				...
				func_403(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_401(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_439(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_102(iParam0, 44, 1);
			}
...
void func_408(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_453(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_453(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_424(int iParam0, vector3 vParam1, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_287(iVar0, vParam1, iParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_425(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(iParam1, func_457(iParam0));
	PED::_UPDATE_PED_VARIATION(iParam1, 0, 1, 1, 1, 0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_329(747937920, 1) && !func_395(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_451(int iParam0)
{
	...
	func_470(iParam0, 1073741824 /* Float: 2f */);
}
...
bool func_453(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_IS_WEAPON_MELEE(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_471(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
int func_473(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_482(bParam0, &Var0, iVar5, 0))
			{
				if (func_483(bParam0, &Var6, iVar5))
				{
					Var29 = { func_484(bParam0, Var0, iVar5, 0) };
					func_485(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_486(0))
				{
					...
					func_487(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), iParam1, iParam6);
					func_488(bParam0, iParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
				{
...
struct<5> func_480(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_492(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_484(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_494(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_482(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_482(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_483(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_497(bParam0, -1823706425))
			{
				Var0 = { func_484(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_497(bParam0, -1483207246))
			{
				Var0 = { func_484(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_482(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_499(bParam0, *uParam1, iParam2, iParam3) > 0;
}

int func_483(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_500(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_484(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;

	if (!func_501(bParam0, 0))
	{
		return Var0;
	}
	INVENTORY::_0x886DFD3E185C8A89(func_502(bParam6), &uParam1, bParam0, iParam5, &Var0);
	return Var0;
}

int func_485(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_488(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_505(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), iParam1);
...
{
	return func_484(joaat("character"), func_506(), -1591664384, bParam0);
}
...
{
	if (func_496(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(bParam0))
	{
		if (bParam1)
		{
			return func_507(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0) > 0;
		}
		else
		{
			return 1;
...
int func_497(bool bParam0, int iParam1)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_498(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_499(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_484(bParam0, Param1, iParam5, bParam6) };
...
int func_500(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_502(0);
	*uParam1 = { func_484(bParam0, func_493(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
