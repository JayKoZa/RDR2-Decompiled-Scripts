...
bool func_72(var uParam0)
{
	...
	func_152(uParam0, -1.26f, -1.2004f, 0f, 0f, 4f, 4f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_152(uParam0, vLocal_32, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_36, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
	func_152(uParam0, vLocal_40, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), -1, 0, 1, 1);
...
int func_361(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_397(ENTITY::GET_ENTITY_COORDS(uParam0->f_107[iParam1 /*113*/].f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
