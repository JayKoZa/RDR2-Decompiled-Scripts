...
int func_42(var uParam0)
{
	*uParam0 = 3;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = 1715129248;
	uParam0->f_572[1] = -1699999934;
	uParam0->f_572[2] = -1710660654;
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 4;
	uParam0->f_588[0] = 0;
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_BS");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_BS");
}
...
int func_171()
{
	return -597119687 /* GXTEntry: "Legendary White Bison" */;
}
...
var func_181(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	var uVar0;
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -1904.635f, 1743.795f, 237.12f;
				case 1:
					return -1843.005f, 1810.343f, 234.7091f;
				case 2:
					return -1685.485f, 1749.683f, 238.5458f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 0:
					return -1784.116f, 1758.255f, 234.5248f;
				case 1:
					return -1795.752f, 1672.417f, 234.2808f;
				case 2:
					return -1814.928f, 1779.967f, 234.7679f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 0:
					return -1782.719f, 1705.608f, 238.4491f;
				case 1:
					return -1803.55f, 1709.577f, 236.2907f;
				case 2:
					return -1773.52f, 1768.746f, 239.968f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 0:
					return -1820.111f, 1660.451f, 235.5432f;
				case 1:
					return -1776.996f, 1762.623f, 237.2977f;
				case 2:
					return -1743.529f, 1753.779f, 234.3225f;
			}
			break;
	}
	return 0f, 0f, 0f;
