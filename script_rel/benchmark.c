...
void __EntryFunction__()
{
	...
	{
		while (UIAPPS::_IS_APP_ACTIVE_BY_HASH(joaat("PAUSE_MENU")))
		{
	...
	func_4(&Local_14);
	while ((PED::IS_PED_FALLING(Global_35) || PED::IS_PED_RAGDOLL(Global_35)) && func_5(&Local_14) < 10f)
	{
	...
	if (func_7())
	{
		...
		func_4(&Local_14);
		while (ENTITY::IS_ENTITY_DEAD(Global_35) && func_5(&Local_14) < 10f)
		{
			BUILTIN::WAIT(0);
		}
		...
		func_4(&Local_14);
		while (MISC::_0x1B065A2BF7953815(0) == 1 && func_5(&Local_14) < 10f)
		{
			BUILTIN::WAIT(0);
		}
		if (func_5(&Local_14) >= 10f)
...
void func_1(var uParam0, bool bParam1)
{
	...
	UISTATEMACHINE::_UISTATEMACHINE_DESTROY(uParam0->f_136);
...
void func_6(var uParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if ((func_52() || Global_1956584) || Global_1357549.f_1641 > 1)
	{
		func_47(uParam0, 4);
	}
	...
	if (func_57(Global_43890) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("PAUSE_MENU_REPLAY_LAUNCHER")) > 0)
	{
		func_47(uParam0, 8);
	}
	func_47(uParam0, 0);
...
bool func_12()
{
	...
	while (iVar1 < 80)
	{
		if (func_59(iVar1))
		{
			...
			func_61(&(Global_1835011[iVar1 /*74*/].f_3), 4096);
		}
		iVar1++;
	}
	iVar2 = 0;
					...
					case 1:
						if (!Global_1835011[iVar0 /*74*/].f_71)
						{
							...
							if (func_59(iVar0))
							{
								...
								func_76(iVar0);
								if (bVar3 && !func_77(&(Global_1835011[iVar0 /*74*/]), 32768))
								{
									func_78(&(Global_1835011[iVar0 /*74*/]), 32768);
...
bool func_15(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (Global_1898164.f_1[0 /*5*/].f_2 == 8)
	{
		...
		if (func_62(iVar0) && func_93(Global_1347702[iVar0 /*49*/].f_12, 131072))
		{
			return false;
		}
	}
		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
		{
			switch (func_108(uParam0))
			{
				case 0:
					...
					{
						func_110(0, 0);
						Global_2621440[0 /*12066*/].f_9.f_7 = { Global_36 };
					...
					else
					{
						...
						{
							case 1:
								Global_2621440[0 /*12066*/].f_9.f_7 = { func_114(func_113(uParam0->f_9)) };
								break;
							case 8:
								if (func_115(uParam0->f_9) == 83)
								{
									Global_2621440[0 /*12066*/].f_9.f_7 = { 3009.713f, 477.2592f, 40.8661f };
									Global_2621440[0 /*12066*/].f_9.f_13 = 104.9475f;
								}
								else
								{
									Global_2621440[0 /*12066*/].f_9.f_7 = { func_116(func_115(uParam0->f_9)) };
								}
								break;
							default:
								Global_2621440[0 /*12066*/].f_9.f_7 = { Global_36 };
				...
				case 7:
					...
					if (func_127(uParam0))
					{
						...
						else
						{
							...
							uParam0->f_546 = func_130("MO_GFX_BENCHMARK_EXIT", joaat("INPUT_FRONTEND_CANCEL"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
							func_17(uParam0, 10);
						}
					}
					break;
...
{
	if (PED::_0x91A5F9CBEBB9D936(uParam0->f_544))
	{
		PED::REMOVE_SCENARIO_BLOCKING_AREA(uParam0->f_544, false);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(uParam0->f_545))
	{
		VOLUME::_DELETE_VOLUME(uParam0->f_545);
	}
}
...
void func_60(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_167(iParam0) == 3 || (func_167(iParam0) == 1 && STATS::_0x01F4D242765C6B24(func_166(iParam0))))
	{
...
void func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (func_93(Global_1347702[iParam0 /*49*/].f_12, 1024))
	{
		func_178(&(Global_1347702[iParam0 /*49*/].f_12), 1024);
	}
	if (iParam1 == 1)
	{
		func_85(iParam0, 0);
...
void func_74(int iParam0, bool bParam1)
{
	...
	if (func_77(&(Global_1835011[iParam0 /*74*/]), 8192))
	{
		bVar0 = true;
	}
...
void func_75(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4, float fParam5, bool bParam6)
{
	...
	if ((SCRIPTS::IS_THREAD_ACTIVE(Global_1835011[iParam0 /*74*/].f_16, false) && !func_192(iParam0)) && !func_72(iParam1, 1024))
	{
...
void func_85(int iParam0, bool bParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
	{
		...
		if ((!func_205(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43891) || bParam1)
		{
			...
			func_86(&(Global_1347702[iParam0 /*49*/].f_13), 4096);
...
void func_87()
{
	...
	if (MAP::DOES_BLIP_EXIST(Global_1357549.f_1711))
	{
		...
		{
			func_212(Global_1888801[iVar0 /*35*/].f_13, 1560611276);
		}
...
void func_101()
{
	...
	TASK::TASK_PLAY_ANIM(Global_35, func_219(), sVar0, 8f, -8f, -1, 67108880, 0f, false, 0, false, "Satchel_and_ik_hand_helpers_filter", false);
	func_220(1);
...
void func_104(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (func_218(32768) && Global_1946804.f_1378.f_1[10 /*3*/] != Global_1946804.f_57[10 /*11*/])
	{
		func_224();
	}
...
void func_117(var uParam0)
{
	...
	uParam0->f_133 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(uParam0->f_131, "showEndscreen", 0);
	...
	if (func_235() || PED::_0x50F124E6EF188B22(Global_35))
	{
		func_236(1);
	}
	...
	if (!func_34(uParam0->f_546))
	{
		uParam0->f_546 = func_130("MO_GFX_BENCHMARK_STOP", joaat("INPUT_FRONTEND_CANCEL"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
	}
...
bool func_120(var uParam0)
{
	...
	func_33(uParam0);
	uParam0->f_545 = VOLUME::_CREATE_VOLUME_CYLINDER(vVar0, vVar3, 10f, 10f, 10f);
...
bool func_121(var uParam0)
{
	...
	Var0.f_4 = 1;
	Var0.f_5 = 1;
	MISC::_COPY_MEMORY(&(uParam0->f_113), &Var0, 14);
	func_259();
	MISC::_SET_WEATHER_TYPE(func_260(uParam0), true, true, false, 0f, false);
	MISC::SET_WIND_SPEED(-1f);
	MISC::SET_WIND_DIRECTION(-1f);
	MISC::_SET_SNOW_LEVEL(-1f);
	...
	switch (func_274(uParam0))
	{
		...
		case 3:
			...
			while (iVar1 <= (1 - 1))
			{
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_67[iVar1]))
				{
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_67[iVar1], func_281(), 1f, -1, 0.25f, 0, 40000f);
				}
				iVar1++;
			}
			func_275(uParam0, 4);
	...
	switch (func_283(uParam0))
	{
		case 0:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_16) || !PED::_0xA0BC8FAED8CFEB3C(uParam0->f_16))
				{
					return false;
				}
		...
		case 1:
			SCRIPTS::SHUTDOWN_LOADING_SCREEN();
			if ((((((((((TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(1))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(2))) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(func_280(3))) && STREAMING::HAS_MODEL_LOADED(joaat("A_C_HORSE_KENTUCKYSADDLE_BLACK"))) && STREAMING::HAS_MODEL_LOADED(joaat("P_CS_BILLSINGLE01BX"))) && STREAMING::HAS_MODEL_LOADED(joaat("POLICEWAGON01X"))) && STREAMING::HAS_MODEL_LOADED(joaat("S_M_M_AMBIENTSDPOLICE_01"))) && PED::_0x5E420FF293EE5472()) && !SCRIPTS::_IS_LOADING_SCREEN_ACTIVE()) && AICOVERPOINT::_0x8CBE916CFC64AD5C(uParam0->f_16))
			{
				...
				PLAYER::START_PLAYER_TELEPORT(PLAYER::GET_PLAYER_INDEX(), func_288(0), 0f, true, true, true, false);
				func_285(uParam0, 2);
			}
			break;
		case 2:
		...
		case 3:
			...
			if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_31))
			{
				...
				if (PED::_HAS_PED_EMOTIONAL_PRESET_LOADED(uParam0->f_31, "TaskIntimidated_OnFoot"))
				{
					...
					func_292(uParam0);
					func_293(uParam0->f_16, joaat("WEAPON_REVOLVER_CATTLEMAN"), 1, 0, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
		...
		case 6:
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_16, -76381094, true) == 8 && func_267(uParam0) >= 4f)
			{
				TASK::TASK_FOLLOW_WAYPOINT_RECORDING(uParam0->f_16, func_280(0), 0, 4194818, -1, 0, 0, -1);
		...
		case 7:
			...
			if (iVar29 != 1)
			{
				TASK::TASK_FOLLOW_WAYPOINT_RECORDING(uParam0->f_16, func_280(0), 0, 4194818, -1, 0, 1, -1);
			}
			else if (iVar29 == 1)
			{
		...
		case 8:
			if (TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(uParam0->f_16, 0))
			{
				...
				if (iVar30 >= 14)
				{
					...
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(uParam0->f_16, 3f, 0, -1082130432 /* Float: -1f */, 0);
				...
				else
				{
					...
					TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(uParam0->f_16, 1.5f, 0, -1082130432 /* Float: -1f */, 0);
			...
			if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_16, 658540077, true) == 8 || func_300(uParam0->f_16, uParam0->f_20.f_6, 4.5f, 1, 1))
			{
		...
		case 10:
			if (PED::IS_PED_ON_MOUNT(uParam0->f_16))
			{
				...
				TASK::TASK_FOLLOW_WAYPOINT_RECORDING(uParam0->f_16, func_280(1), 0, 134217728, -1, 0, 0, -1);
		...
		case 11:
			...
			{
				TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(uParam0->f_16, 2.5f, 0, -1082130432 /* Float: -1f */, 0);
			}
			func_303(uParam0);
			func_304(uParam0);
			if (func_305(uParam0))
...
void func_133(var uParam0)
{
	...
	if (uParam0->f_130)
	{
		if (func_311(func_310(uParam0)))
		{
			...
			DATABINDING::_DATABINDING_WRITE_DATA_STRING(uParam0->f_132, MISC::_0x2B6846401D68E563(uParam0->f_80, 1));
		}
	}
	else if (UISTATEMACHINE::_UIFLOWBLOCK_IS_LOADED(uParam0->f_134))
	{
		UISTATEMACHINE::_UIFLOWBLOCK_ENTER(uParam0->f_134, 0);
		UISTATEMACHINE::_UISTATEMACHINE_CREATE(uParam0->f_136, uParam0->f_134);
		uParam0->f_130 = 1;
	}
}
...
bool func_136()
{
	return func_317(UIFEED::_0xC17F69E1418CD11F(3));
}
...
int func_190(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_44();
	if ((bParam4 && func_355(&(Global_1835011[iParam0 /*74*/].f_29), 512)) && !func_355(&(Global_1835011[iParam0 /*74*/].f_29), 1024))
	{
		if (func_137())
		{
			return 0;
	...
	if (!MAP::DOES_BLIP_EXIST(Global_1835011[iParam0 /*74*/].f_27))
	{
		...
		if (func_188(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_77(&(Global_1835011[iParam0 /*74*/]), 2))
			{
				if (func_354(iParam0))
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(1673015813, func_358(iParam0));
					bVar2 = true;
				}
				else
				{
					Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(1673015813, func_233(iParam0));
				}
			}
			else if (func_354(iParam0))
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_AREA(1673015813, func_358(iParam0), func_359(iParam0), func_360(iParam0));
				bVar2 = true;
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_RADIUS(1673015813, func_361(iParam0), func_362(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_354(iParam0))
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(1673015813, func_363(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(1673015813, func_358(iParam0));
		...
		else if (func_364(iParam0))
		{
			if (iParam0 == 7)
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(-1337945352, func_233(iParam0));
			}
			else
			{
				Global_1835011[iParam0 /*74*/].f_27 = MAP::_BLIP_ADD_FOR_COORD(1673015813, func_233(iParam0));
	...
	if (bVar1)
	{
		...
		if (!func_355(&(Global_1835011[iParam0 /*74*/].f_29), 1024) && !func_364(iParam0))
		{
			MAP::_BLIP_SET_MODIFIER(Global_1835011[iParam0 /*74*/].f_27, 580546400);
			func_365(&(Global_1835011[iParam0 /*74*/].f_29), 1024);
		}
	}
	if (iVar0 != -1)
	{
	...
	if (((((((func_355(&(Global_1835011[iParam0 /*74*/].f_29), 4096) && !func_355(&(Global_1835011[iParam0 /*74*/].f_29), 8192)) && IntToFloat(func_357()) >= 10f) && !Global_1935630.f_12) && !Global_16) && !func_371(Global_35, joaat("PROP_PLAYER_SLEEP_TENT_A_FRAME"))) && !PED::_IS_PED_USING_SCENARIO_HASH(Global_35, joaat("PROP_PLAYER_SLEEP_BED"))) && !PED::_IS_PED_USING_SCENARIO_HASH(Global_35, joaat("WORLD_PLAYER_SLEEP_BEDROLL")))
	{
		if (!func_188(iParam0, iVar0) || (fParam1 >= (func_372(iParam0) * func_372(iParam0)) && !Global_1835011[iParam0 /*74*/].f_70))
		{
			...
			func_365(&(Global_1835011[iParam0 /*74*/].f_29), 8192);
		}
	}
	return 1;
}
...
void func_202(int iParam0)
{
	...
	func_378(&(Global_1392626[iParam0 /*32*/].f_9), 4096);
}
...
void func_207(int iParam0, int iParam1)
{
	...
	func_383(&(Global_1347702[iParam0 /*49*/].f_12), 16384);
...
void func_208(int iParam0, bool bParam1, vector3 vParam2)
{
	...
	func_386(&(Global_1347702[iParam0 /*49*/].f_13), 4096);
}
...
bool func_248(var uParam0)
{
	...
	bVar0 = DATAFILE::_0x7907969497EA92F5(uParam0->f_142);
	if (!bVar0)
	{
		uParam0->f_142 = DATAFILE::_0xCA56DD6AB7A39F64(MISC::GET_HASH_KEY("benchmark_poi_data"));
	}
	bVar1 = DATAFILE::_0x603AC35FD4602C76(uParam0->f_142);
	if (!bVar1)
	{
		return false;
	}
	...
	while (iVar2 < 20)
	{
		...
		if (func_427(uParam0, 0))
		{
			...
			{
				uParam0->f_147[func_119(uParam0) /*19*/].f_13 = MISC::GET_HASH_KEY(&uVar3);
			}
			else
			{
	...
	DATAFILE::_DATAFILE_UNLOAD(uParam0->f_142);
...
{
	return BUILTIN::FLOOR((uParam0->f_147[func_119(uParam0) /*19*/].f_18 * 1000f));
}
...
void func_290(var uParam0)
{
	...
	{
		iVar1 = iVar0;
		uParam0->f_43[iVar0] = VOLUME::_CREATE_VOLUME_BOX(func_299(iVar1), func_458(iVar1), func_459(iVar1));
...
void func_292(var uParam0)
{
	...
	iVar3[0] = TASK::_GET_SCENARIO_POINT_ENTITY(uParam0->f_38, "OXOO");
	iVar3[1] = TASK::_GET_SCENARIO_POINT_ENTITY(uParam0->f_38, "OOXO");
...
int func_303(var uParam0)
{
	...
	switch (func_466(uParam0))
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_65))
			{
				uParam0->f_65 = func_279(joaat("S_M_M_AMBIENTSDPOLICE_01"), 2645.527f, -1130.605f, 50.23997f, 0f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			else if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_66))
			{
				uParam0->f_66 = func_279(joaat("S_M_M_AMBIENTSDPOLICE_01"), 2645.527f, -1132.605f, 50.23997f, 0f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			else
			{
				func_467(uParam0, 3);
		...
		case 6:
			if (func_471(uParam0->f_16, uParam0->f_41, 1, 0))
			{
				...
				TASK::_TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING_2(uParam0->f_63, func_280(2), 0, 0, 0, -1, -1082130432 /* Float: -1f */, 0, 1073741824 /* Float: 2f */, 0);
				func_467(uParam0, 7);
			}
			break;
		case 7:
...
int func_304(var uParam0)
{
	...
	switch (func_476(uParam0))
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_69))
			{
				uParam0->f_69 = func_279(joaat("S_M_M_AMBIENTSDPOLICE_01"), 2507.447f, -1265.594f, 48.22205f, 0f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			else if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_70))
			{
				uParam0->f_70 = func_279(joaat("S_M_M_AMBIENTSDPOLICE_01"), 2508.36f, -1254.875f, 48.18809f, 0f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			else
			{
				func_478(uParam0, 3);
		...
		case 5:
			...
			break;
		case 6:
			TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uParam0->f_69, uParam0->f_64, func_280(3), 524295, 0, 25610, -1, -1082130432 /* Float: -1f */, 0, 1073741824 /* Float: 2f */, 0);
			func_478(uParam0, 7);
			break;
		case 7:
		...
		case 9:
			...
			break;
		case 10:
			if (FIRE::IS_EXPLOSION_IN_SPHERE(25, func_479(), 10f))
			{
...
bool func_305(var uParam0)
{
	...
	switch (func_477(uParam0))
	{
		...
		case 1:
			...
			{
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(uParam0->f_16, func_474(), 2.5f, 20000, 0.25f, 0, 40000f);
				func_481(uParam0, 2);
			}
			else
			{
		...
		case 3:
			...
			if (!PED::IS_PED_ON_MOUNT(uParam0->f_16))
			{
				...
				{
					TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_18, uParam0->f_16, 3, 0, -1082130432 /* Float: -1f */, -1, 0);
				}
				TASK::TASK_PUT_PED_DIRECTLY_INTO_COVER(uParam0->f_16, 2514.341f, -1134.775f, 48.86838f, -1, 0, 0f, 0, 1, uParam0->f_99, 1, 0, 0);
				PED::_0x2208438012482A1A(uParam0->f_16, false, false);
				func_481(uParam0, 4);
			}
			break;
		case 4:
			...
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(uParam0->f_16, func_482(0), 2f, 1, 0, 0);
			AICOVERPOINT::_0x1A7A802B2301EDC0(uParam0->f_16);
			func_481(uParam0, 5);
			break;
		case 5:
		...
		case 9:
			...
			if ((!func_483(uParam0->f_16, -2017877118) || func_472(&(uParam0->f_104)) >= 1.5f) || ENTITY::_GET_ENTITY_ANIM_CURRENT_TIME(uParam0->f_16, "AI_COMBAT@AIM_INTRO@AMBIENT@SURPRISED@UNHOLSTERED@BASE@1H", "back_right_135") >= 0.5f)
			{
		...
		case 14:
			...
			break;
		case 15:
			if ((TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_16, -1388855549, true) == 8 || TASK::_0xA710DC5D25F8B942(uParam0->f_16, -1388855549) > 8f) && func_472(&(uParam0->f_104)) > 8f)
			{
		...
		case 16:
			...
			break;
		case 17:
			TASK::TASK_VEHICLE_FOLLOW_WAYPOINT_RECORDING(uParam0->f_16, uParam0->f_63, func_280(1), 524311, 146, 26130, -1, -1082130432 /* Float: -1f */, 0, 1073741824 /* Float: 2f */, 0);
			func_45(&(uParam0->f_104));
			func_481(uParam0, 18);
			break;
		case 18:
			if (func_472(&(uParam0->f_104)) > 3f && ENTITY::GET_ENTITY_SPEED(uParam0->f_63) < 1f)
			{
				func_45(&(uParam0->f_104));
				func_481(uParam0, 17);
				return false;
...
char* func_316(int iParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)
{
	...
	return MISC::_CREATE_VAR_STRING(2, func_489(sParam1));
}
...
{
	*uParam1 = MAP::_BLIP_ADD_FOR_COORD(func_521(iParam0), vParam2);
...
void func_385(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	{
		Global_1347702[iParam0 /*49*/].f_37 = MAP::_BLIP_ADD_FOR_RADIUS(Global_1347702[iParam0 /*49*/].f_38, func_384(iParam0), Global_1347702[iParam0 /*49*/].f_18);
		if (!MAP::DOES_BLIP_EXIST(Global_1347702[iParam0 /*49*/].f_37))
		{
			return;
		}
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 1 == 0)
	{
		...
		if (((!func_525(iParam0) || func_93(Global_1347702[iParam0 /*49*/].f_12, 1)) || func_93(Global_1347702[iParam0 /*49*/].f_12, 512)) || func_83(Global_1347702[iParam0 /*49*/].f_13, 2048))
		{
	...
	if (Global_1347702[iParam0 /*49*/].f_13 & 32768 == 0)
	{
		...
		{
			func_386(&(Global_1347702[iParam0 /*49*/].f_13), 32768);
		}
	}
	if (Global_1347702[iParam0 /*49*/].f_12 & 8 != 0 && Global_40.f_490.f_402[iParam0] & 2 == 0)
	{
		...
		else
		{
			...
			Global_1347702[iParam0 /*49*/].f_40 = func_312(MISC::_CREATE_VAR_STRING(2, &cVar3, sVar6), 10000, 0, 0, 0, 1);
		}
		func_531(iParam0, 2);
	}
}
			...
			else
			{
				...
				if (bParam5)
				{
					...
					if (bVar2)
					{
						...
						{
							func_539(uParam0, uParam0->f_1[Global_1946804.f_2612[iVar1] /*3*/], Global_1946804.f_2612[iVar1], 0, 0);
							iVar1++;
						}
					}
					if (bParam4)
...
{
	Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 = (Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 - (Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 && iParam1));
}
...
void func_403(struct<4> Param0)
{
	...
	if (func_546(Param0))
	{
		...
		while (iVar0 < Global_1946804.f_852)
		{
			...
			if (Global_1946804.f_769[iVar1 /*4*/] == 34 && func_546(20))
			{
				return;
			}
			iVar0++;
...
{
	return (Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 && iParam1) != 0;
}
...
{
	Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 = (Global_1946804.f_57[func_536(iParam0, 1) /*11*/].f_10 || iParam1);
}
...
void func_416(vector3 vParam0, var uParam3, var uParam4)
{
	...
	{
		if (!func_554(Global_40.f_2, 0f, 0f, 0f, 1056964608 /* Float: 0.5f */, 1))
		{
...
void func_418()
{
	...
	fVar0 = 0f;
	fVar0 = (fVar0 + (0.9259259f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP1")))));
	fVar0 = (fVar0 + (0.2525252f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP2")))));
	fVar0 = (fVar0 + (0.2923976f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP3")))));
	fVar0 = (fVar0 + (0.462963f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP4")))));
	fVar0 = (fVar0 + (0.9259259f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP5")))));
	fVar0 = (fVar0 + (0.308642f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP6")))));
	fVar0 = (fVar0 + (5.555555f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP7")))));
	fVar0 = (fVar0 + (0.6944444f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP8")))));
	fVar0 = (fVar0 + (0.3703704f * BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("MISSIONS_CHP9")))));
	fVar0 = (fVar0 + (0.5f * func_556(10f, BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("RC_STRANDS"))))));
	fVar0 = (fVar0 + (0.6f * func_556(5f, BUILTIN::TO_FLOAT(func_555(joaat("COMPLETED"), joaat("RC_STRANDS_BOUNTY"))))));
	fVar0 = (fVar0 + (0.2f * func_556(25f, BUILTIN::TO_FLOAT(func_557(joaat("UNIQUE_BEATS_COMPLETED"))))));
	fVar0 = (fVar0 + (2f * func_556(1f, BUILTIN::TO_FLOAT(func_557(joaat("GANG_AMBUSH_ENCOUNTERED"))))));
	fVar0 = (fVar0 + (0.3333333f * func_556(6f, BUILTIN::TO_FLOAT(func_557(joaat("GANG_HIDEOUT_COMPLETED"))))));
	fVar0 = (fVar0 + (3f * func_556(1f, BUILTIN::TO_FLOAT(func_557(joaat("DISCOVERABLE_FOUND"))))));
	iVar1 = func_558();
	fVar0 = (fVar0 + (0.1111111f * func_556(9f, BUILTIN::TO_FLOAT(iVar1))));
	...
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_AMERICANS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_AMERICANS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_ANIMALS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_ANIMALS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_ARTISTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_ARTISTS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_GIRLS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_GIRLS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_GUNSLINGERS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_GUNSLINGERS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_HORSES"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_HORSES")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_INVENTIONS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_INVENTIONS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_LANDMARKS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_LANDMARKS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_PLANTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_PLANTS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_SPORTS"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_SPORTS")))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(-2076669067, joaat("CARD_SET_VEHICLES"))) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(-2076669067, joaat("CARD_SET_VEHICLES")))));
	fVar0 = (fVar0 + func_556(1f, fVar2));
	fVar0 = (fVar0 + (0.05f * func_556(BUILTIN::TO_FLOAT(20), BUILTIN::TO_FLOAT(func_560()))));
	if (func_561(40))
	{
		fVar0 = (fVar0 + (1f * 1f));
	}
	...
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 666607663)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 666607663))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), -220219788)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), -220219788))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 218622660)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 218622660))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 390004462)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 390004462))));
	fVar2 = func_559(fVar2, (BUILTIN::TO_FLOAT(COLLECTION::_0x5461C821D00FE15A(joaat("TREASURE_HUNTER"), 6410548)) / BUILTIN::TO_FLOAT(COLLECTION::_0x62CAB7DB62EAD434(joaat("TREASURE_HUNTER"), 6410548))));
	fVar0 = (fVar0 + (1f * func_556(1f, fVar2)));
	fVar0 = (fVar0 + (0.2f * func_556(5f, BUILTIN::TO_FLOAT(func_557(joaat("SHACK_FOUND"))))));
	fVar0 = (fVar0 + (0.2f * func_556(5f, BUILTIN::TO_FLOAT(func_555(joaat("KILLS"), joaat("LEGENDARY_ANIMALS"))))));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("ANIMALS")), 50)) / BUILTIN::TO_FLOAT(50)));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("EQUIPMENT")), 10)) / BUILTIN::TO_FLOAT(10)));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("FISH")), 10)) / BUILTIN::TO_FLOAT(10)));
	fVar0 = (fVar0 + COMPENDIUM::_0x725D52F21A5E9E22(joaat("GANGS")));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("HERBS")), 20)) / BUILTIN::TO_FLOAT(20)));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("HORSES")), 10)) / BUILTIN::TO_FLOAT(10)));
	fVar0 = (fVar0 + (BUILTIN::TO_FLOAT(func_562(COMPENDIUM::_0x729D52F61A5A9E22(joaat("WEAPONS")), 48)) / BUILTIN::TO_FLOAT(48)));
	func_563(&iVar3, &iVar4);
	fVar0 = (fVar0 + (2f * func_556((BUILTIN::TO_FLOAT(iVar3) / BUILTIN::TO_FLOAT(iVar4)), 1f)));
	fVar0 = (fVar0 + (2f * func_556(1f, BUILTIN::TO_FLOAT(func_564(joaat("HORSES_REACHED_MAX_BOND"))))));
	fVar5 = BUILTIN::TO_FLOAT(func_565());
	fVar0 = (fVar0 + ((3f * fVar5) / BUILTIN::TO_FLOAT(9)));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ATTEMPTS"), joaat("BLACKJACK"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ATTEMPTS"), joaat("DOMINOES_HAND"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ATTEMPTS"), joaat("FIVE_FINGER"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ATTEMPTS"), joaat("POKER_HAND"))))));
	fVar0 = (fVar0 + (0.2f * func_556(5f, BUILTIN::TO_FLOAT(func_557(joaat("SPECIAL_PED_INTERACTION"))))));
	fVar0 = (fVar0 + (0.5f * func_556(1f, BUILTIN::TO_FLOAT(func_557(joaat("BATHS_TAKEN"))))));
	fVar0 = (fVar0 + (0.5f * func_556(1f, BUILTIN::TO_FLOAT(func_557(joaat("SHOWS_SEEN"))))));
	fVar0 = (fVar0 + (0.5f * func_556(1f, BUILTIN::TO_FLOAT(func_557(joaat("THEATRE_VISITS"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("AMMO"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("FOOD"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("HORSE_CARE"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("REMEDIES"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("WEAPONS"))))));
	fVar0 = (fVar0 + ((0.5f / 6f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("MADE_RECIPE_TYPE"), joaat("HUNTING"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ROB_COMPLETED"), joaat("COACH"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ROB_COMPLETED"), joaat("HOME"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ROB_COMPLETED"), joaat("SHOP"))))));
	fVar0 = (fVar0 + ((1f / 4f) * func_556(1f, BUILTIN::TO_FLOAT(func_555(joaat("ROB_COMPLETED"), joaat("TRAIN"))))));
	Var6 = { func_566(joaat("TOTAL_PROGRESS_MADE")) };
	fVar8 = func_567(Var6);
...
void func_425(var uParam0)
{
	...
	while (iVar0 < 13)
	{
		DATAFILE::_DATAFILE_REGISTER_QUERY(uParam0->f_142, iVar0, func_571(iVar0));
		iVar0++;
	}
}
...
bool func_427(var uParam0, int iParam1)
{
	...
	uVar0 = DATAFILE::_DATAFILE_GET_DATA_NODE_INDEX(&(uParam0->f_142.f_1), &(uParam0->f_142));
	return uVar0;
}
...
int func_428(var uParam0, int iParam1, var uParam2)
{
	...
	uParam0->f_142.f_2 = iParam1;
	bVar0 = DATAFILE::_DATAFILE_GET_VECTOR(uParam2, &(uParam0->f_142));
	if (bVar0)
	{
		return 1;
	}
...
int func_429(var uParam0, int iParam1, var uParam2)
{
	...
	uParam0->f_142.f_2 = iParam1;
	bVar0 = DATAFILE::_DATAFILE_GET_FLOAT(uParam2, &(uParam0->f_142));
	if (bVar0)
	{
		return 1;
	}
...
int func_430(var uParam0, int iParam1, var uParam2)
{
	...
	uParam0->f_142.f_2 = iParam1;
	bVar0 = DATAFILE::_DATAFILE_GET_INT(uParam2, &(uParam0->f_142));
	if (bVar0)
	{
		return 1;
	}
...
bool func_431(var uParam0, int iParam1, var uParam2)
{
	...
	uParam0->f_142.f_2 = iParam1;
	bVar0 = DATAFILE::_DATAFILE_GET_STRING(uParam2, &(uParam0->f_142));
	if (bVar0)
	{
		return true;
	}
...
{
	return func_576(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
void func_448(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_591(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_480(var uParam0)
{
	if (func_609(Global_35))
	{
		...
		{
			TASK::TASK_FOLLOW_WAYPOINT_RECORDING(Global_35, func_280(1), 0, 4194304, -1, 0, 0, -1);
		}
		...
		case 688587926:
			...
			else
			{
				...
				if (iParam1 == Global_1946804.f_57[iParam2 /*11*/])
				{
					...
					iVar1 = 35;
					if (-923693316 == func_494(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				{
					iVar1 = 35;
					if ((func_631(iParam1) && uParam0->f_1[iVar1 /*3*/] != Global_1946804.f_57[iVar1 /*11*/]) && -923693316 == func_494(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				if (uParam0->f_1[iParam2 /*3*/] != Global_1946804.f_57[iParam2 /*11*/] && (func_631(Global_1946804.f_1497.f_1[iVar1 /*3*/]) || func_632(Global_1946804.f_1497.f_1[iVar1 /*3*/], -1638171711)))
				{
					uParam0->f_1[iParam2 /*3*/] = Global_1946804.f_57[iParam2 /*11*/];
					uParam0->f_1[iParam2 /*3*/].f_1 = 0;
					if (bParam4)
			...
			switch (func_494(iParam1))
			{
				case 81053684:
					iVar1 = 10;
					if (-525676072 == func_494(uParam0->f_1[iVar1 /*3*/]))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
				...
				case -525676072:
					iVar1 = 12;
					if (81053684 == func_494(uParam0->f_1[iVar1 /*3*/]) || func_632(uParam0->f_1[iVar1 /*3*/], 866047851))
					{
						uParam0->f_1[iVar1 /*3*/] = Global_1946804.f_57[iVar1 /*11*/];
						uParam0->f_1[iVar1 /*3*/].f_1 = 0;
						if (bParam4)
...
int func_541(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (iParam0 == Global_1946804.f_57[func_536(iParam1, 1) /*11*/])
	{
		return 0;
	}
	iVar0 = 0;
...
var func_576(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_661(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
bool func_582(int iParam0, int iParam1)
{
	...
	{
		return func_665(&(Global_1108178[iParam1 /*37*/].f_4), iVar0, 5);
	}
	return false;
}
...
struct<5> func_599(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_675(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_603(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_601(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_601(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_602(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_603(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
bool func_629(int iParam0)
{
	...
	return Global_1946804.f_1497.f_1[func_536(iParam0, 1) /*3*/] != Global_1946804.f_57[func_536(iParam0, 1) /*11*/];
}
...
int func_641(int iParam0, bool bParam1, bool bParam2)
{
	...
	uVar2 = INVENTORY::_0xE787F05DFC977BDE(func_493(bParam2), iParam0, 0);
	return uVar2;
}
...
{
	return func_603(joaat("CHARACTER"), func_704(), -1591664384, bParam0);
}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_493(bParam3), uParam0, uParam2);
	if (*iParam1 >= 0)
	{
		return true;
	}
