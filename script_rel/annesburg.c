...
void func_56()
{
	...
	Local_117[0 /*45*/].f_43 = 18887;
	Local_117[0 /*45*/].f_44 = 19390;
	...
	Local_117[1 /*45*/].f_43 = 19467;
	Local_117[1 /*45*/].f_44 = 19390;
	func_131(&(Local_117[1 /*45*/]), 512);
	uVar14 = 5;
	func_128(&Local_117, 384, &uVar14, 2, 0);
	Local_117[2 /*45*/].f_43 = 20087;
	Local_117[2 /*45*/].f_44 = 19390;
...
void func_96(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_220(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_220(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_220(&cVar6, joaat("COLOR_PURE_WHITE")), func_220(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
