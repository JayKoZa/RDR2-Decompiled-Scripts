...
{
	if (!ANIMSCENE::_IS_ANIM_SCENE_STARTED(uParam0->f_2, 0) && !ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_2, 0))
	{
...
int func_60(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (func_32(iVar0, 0))
	{
		...
		if ((bParam1 || !func_57(iParam0)) || func_58(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_66(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_68(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_69(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_69(iParam0, 0));
					func_70(iParam0);
				}
			}
			else
