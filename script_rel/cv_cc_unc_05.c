...
int func_72(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 2f, 1.7725f, 1.54f, 2.685f, -1612834106, 1877049591, 1, 1, 1);
	func_156(uParam0, "script@vignette@uncle_5@base", 1, 1, 0, 0);
	func_156(uParam0, "script@vignette@uncle_5@action", 0, 0, 1, 0);
	func_157(uParam0, -1952213960, 550713520);
	func_158(uParam0, iLocal_14, 3, -1701759345, "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1);
	func_159(uParam0, iLocal_14, 2, -1701759345, "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1, 100f, 1065353216 /* Float: 1f */, 1);
...
void func_248(var uParam0, vector3 vParam1, vector3 vParam4)
{
