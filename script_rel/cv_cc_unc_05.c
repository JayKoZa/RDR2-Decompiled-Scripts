...
bool func_72(var uParam0)
{
	...
	func_155(uParam0, 0f, 0f, 0f, 2f, 1.7725f, 1.54f, 2.685f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	...
	func_159(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND_READ_NEWSPAPER"), "WORLD_HUMAN_SIT_GROUND_READING_NEWSPAPER_MALE_A", -1, 1, 100f, 1065353216 /* Float: 1f */, 1);
