...
bool func_72(var uParam0)
{
	...
	func_149(uParam0, -0.381f, -1.1475f, 0f, -5.25f, 5.3775f, 2.475f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_149(uParam0, 6.6439f, -6.21f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	iLocal_19 = func_152(uParam0, "script@vignette@dutch_speech_shadybelle_1@action", 0, 0, 1, 0);
	...
	func_158(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_389(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
