...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, -5.2375f, -15.9001f, 2.56f, -5.76f, 6.48f, 8.135f, 3.885f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -0.55f, -2.7625f, 2.8f, -32.04f, 4.155f, 7.955f, 2.585f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_INSPECT"), "WORLD_HUMAN_INSPECT_FEMALE_D", -1, 0, 40f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_MALE_D", -1, 0, 20f, 1065353216 /* Float: 1f */, 1);
...
int func_248()
{
	...
	if (func_328(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_249()
{
	...
	if (func_328(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
bool func_397(int iParam0, bool bParam1, bool bParam2)
{
	if (!func_103(iParam0))
	{
		return false;
...
bool func_402(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_103(iParam0))
	{
		return false;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_396(Global_1347702[1 /*49*/].f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
