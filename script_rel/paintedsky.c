...
int func_190(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319->f_17371 || func_231(func_54(*uParam0), 1, 1, 1, 0)) || PED::_IS_PED_HOGTIED(func_54(*uParam0)))
	{
		func_226(uParam0);
		return uParam0->f_30;
	}
...
int func_192(int iParam0)
{
	...
	return func_215(iParam0, 1073741824 /* Float: 2f */);
}

void func_193(int iParam0)
{
	func_217(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_201(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	int iVar0;
	int iVar1;
...
{
	func_216(iParam0, 1073741824 /* Float: 2f */);
}
...
int func_233()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_270(Global_35))
	{
		return 1;
	}
	return 0;
