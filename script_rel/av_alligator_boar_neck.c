...
{
	func_33(uParam0, 10828, 10886, 11576);
}
...
int func_31(var uParam0)
{
	...
	if (!uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (uParam0->f_469[2])
		{
			if (!uParam0->f_469[5])
			{
				if (func_73(uParam0, 2f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
			...
			if (!uParam0->f_469[3])
			{
				if (ANIMSCENE::_DOES_ANIM_SCENE_EXIST(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_IS_ANIM_SCENE_LOADED(uParam0->f_3.f_1, true, false))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_IS_ANIM_SCENE_FINISHED(uParam0->f_3.f_1, false) || ANIMSCENE::_IS_ANIM_SCENE_ACTIVE(uParam0->f_3.f_1))
							{
								if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
								{
...
void func_70(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_20[0 /*14*/]))
	{
		...
		{
			TASK::_TASK_SMART_FLEE_STYLE_PED(uParam0->f_20[0 /*14*/], Global_35, 2, 256, -1082130432 /* Float: -1f */, -1, 0);
