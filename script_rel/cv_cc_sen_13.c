...
bool func_72(var uParam0)
{
	...
	func_151(uParam0, 4.115f, 2.36f, 1.1875f, -44f, 1.0975f, 1.145f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_151(uParam0, -0.0675f, 2.0425f, 1.1875f, 16f, 3.4425f, 1.2525f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
