...
int func_76(var uParam0)
{
	...
	func_161(uParam0, iLocal_14, 3, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 18f, 1065353216 /* Float: 1f */, 1);
...
int func_97(var uParam0)
{
	...
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(func_9(uParam0, iLocal_15), joaat("stand"), 25000, 0, 0, -1082130432, 0);
	}
	return 1;
}
...
int func_148(var uParam0)
{
	...
	{
		_NAMESPACE48::_0xD4B614179BCD0654(func_126(10, 0));
		_NAMESPACE48::_0xD4B614179BCD0654(func_226(10, 0));
		func_37(uParam0);
		return 1;
	}
	return 0;
...
int func_180(int iParam0, int iParam1)
{
	...
	PED::_0xA2F8B3B5FEDFC100(iParam1, func_292(iParam0));
...
{
	return func_330(iParam0, ENTITY::GET_ENTITY_COORDS(iParam1, true, false));
}
...
int func_268(var uParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_309(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_220(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_368(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		...
		case 2:
			...
			uParam0->f_22 = func_373(1627068364 /* GXTEntry: "Horse Reviver" */);
			break;
		case 4:
		...
		case 6:
			...
			uParam0->f_22 = func_373(-1635450397 /* GXTEntry: "Predator Bait" */);
		...
		case 7:
			...
			uParam0->f_22 = func_373(-755485480 /* GXTEntry: "Potent Health Cure" */);
		...
		case 8:
			...
			uParam0->f_22 = func_373(-951828978 /* GXTEntry: "Chocolate Bar" */);
		...
		case 11:
			...
			uParam0->f_22 = func_373(-2076104686 /* GXTEntry: "Horse Stimulant" */);
		...
		case 13:
			...
			uParam0->f_22 = func_373(1478239863 /* GXTEntry: "Gold Wedding Ring" */);
			break;
		case 14:
			...
			uParam0->f_22 = func_373(338147422 /* GXTEntry: "Cigar" */);
		...
		case 16:
			...
			uParam0->f_22 = func_373(1483206625 /* GXTEntry: "Guarma Rum" */);
		...
		case 17:
			...
			uParam0->f_22 = func_373(-898386032 /* GXTEntry: "Gun Oil" */);
		...
		case 19:
			...
			uParam0->f_22 = func_373(730856618 /* GXTEntry: "Potent Miracle Tonic" */);
		...
		case 20:
			...
			uParam0->f_22 = func_373(230530039 /* GXTEntry: "Health Cure" */);
...
void func_321(var uParam0)
{
	...
	uVar0 = func_377(*uParam0);
	uVar1 = func_378(*uParam0);
	iVar2 = MISC::GET_HASH_KEY(func_379(uParam0->f_3));
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_ENTRY_HASH(9, uVar0, func_380(func_24()), 1307979820, func_381(*uParam0), 0);
		UILOG::_UILOG_SET_ENTRY_ICON_TEXTURE(9, uVar0, iVar2, 1997120069);
		UILOG::_UILOG_SET_ENTRY_BRIEF_TEXTURE(9, uVar0, uVar1, 404961913);
		if (*uParam0 == 21)
		{
			func_382(1, 688258043 /* GXTEntry: "Kentucky Bourbon" */, 0);
			func_382(2, -1477273558 /* GXTEntry: "Peppermint" */, 0);
			func_382(3, 128702355 /* GXTEntry: "Milkweed" */, 0);
			func_382(4, 1613651027 /* GXTEntry: "Hair Pomade" */, 0);
...
void func_383(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5)
{
	var uVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(9, uVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(9, func_377(*uParam0), iParam1, sParam2, iParam3, iParam5, 0);
		if (bParam4)
		{
			UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, uVar0);
			Global_1359489->f_361.f_194 = func_431("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_379(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
int func_427(bool bParam0, int iParam1)
{
	...
	if (func_474(bParam0, 1399091007))
	{
		func_475(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}
...
void func_475(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
int func_479(var uParam0, int iParam1, var uParam2, bool bParam3)
{
...
int func_493(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_292(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_0x959383DCD42040DA(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_537(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
...
struct<4> func_521(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_539(bool bParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_549(bParam0, &Var0, iVar5, 0))
			{
				if (func_550(bParam0, &Var6, iVar5))
				{
					Var29 = { func_521(bParam0, Var0, iVar5, 0) };
					func_551(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_552(0))
				{
					...
					func_553(WEAPON::_0x5C2EA6C44F515F34(bParam0), iParam1, iParam6);
...
void func_540(int iParam0, bool bParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_547(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_426(bParam0))
	{
		case joaat("clothing"):
			...
			{
				Var0 = { func_521(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
		...
		case joaat("weapon"):
			...
			if (iParam2 && func_557(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_549(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_549(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_550(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_560(bParam0, -1823706425))
			{
				Var0 = { func_521(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_560(bParam0, -1483207246))
			{
				Var0 = { func_521(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
...
bool func_549(bool bParam0, var uParam1, int iParam2, int iParam3)
{
	return func_562(bParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_550(bool bParam0, var uParam1, int iParam2)
{
	...
	if (func_563(bParam0, &uVar0, uParam1, iParam2))
	{
...
int func_551(bool bParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_554(bool bParam0, int iParam1)
{
	...
	{
		iVar1 = func_566(WEAPON::_0xD3750CCC00635FC2(bParam0), iParam1);
...
{
	if (func_559(bParam0) == 1779021115)
	{
		return 0;
	}
...
int func_562(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_521(bParam0, Param1, iParam5, bParam6) };
...
int func_563(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_429(0);
	*uParam1 = { func_521(bParam0, func_477(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
